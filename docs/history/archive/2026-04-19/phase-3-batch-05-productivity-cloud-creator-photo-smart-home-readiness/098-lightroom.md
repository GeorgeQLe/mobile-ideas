...
## Overview
Build an original mobile product inspired by Lightroom's user-facing workflow, not its brand identity or proprietary implementation.
The clone target is: Photo library, editing controls, presets, masking-like workflow, before/after, export, and cloud sync.
...
- Implement the app-specific focus: Photo library, editing controls, presets, masking-like workflow, before/after, export, and cloud sync.
...
## Non-Goals
- Do not copy Lightroom branding, trade dress, logos, app icons, screenshots, marketing copy, or proprietary media.
...
## Research Sources
- App Store source-discovery link: https://apps.apple.com/us/search?term=Lightroom
- Google Play source-discovery link: https://play.google.com/store/search?q=Lightroom&c=apps
- Official help/privacy source-discovery link: https://www.google.com/search?q=Lightroom%20official%20app%20help%20privacy
