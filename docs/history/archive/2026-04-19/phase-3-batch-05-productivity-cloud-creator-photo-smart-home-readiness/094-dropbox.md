...
## Overview
Build an original mobile product inspired by Dropbox's user-facing workflow, not its brand identity or proprietary implementation.
The clone target is: File browser, upload, preview, sharing links, offline files, scan documents, and sync status.
...
- Implement the app-specific focus: File browser, upload, preview, sharing links, offline files, scan documents, and sync status.
...
## Non-Goals
- Do not copy Dropbox branding, trade dress, logos, app icons, screenshots, marketing copy, or proprietary media.
...
## Research Sources
- App Store source-discovery link: https://apps.apple.com/us/search?term=Dropbox
- Google Play source-discovery link: https://play.google.com/store/search?q=Dropbox&c=apps
- Official help/privacy source-discovery link: https://www.google.com/search?q=Dropbox%20official%20app%20help%20privacy
