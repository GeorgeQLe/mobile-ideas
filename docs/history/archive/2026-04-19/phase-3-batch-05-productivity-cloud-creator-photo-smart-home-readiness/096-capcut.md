...
## Overview
Build an original mobile product inspired by CapCut's user-facing workflow, not its brand identity or proprietary implementation.
The clone target is: Mobile video editor with timeline, templates, effects, captions, audio, export settings, and project library.
...
- Implement the app-specific focus: Mobile video editor with timeline, templates, effects, captions, audio, export settings, and project library.
...
## Non-Goals
- Do not copy CapCut branding, trade dress, logos, app icons, screenshots, marketing copy, or proprietary media.
...
## Research Sources
- App Store source-discovery link: https://apps.apple.com/us/search?term=CapCut
- Google Play source-discovery link: https://play.google.com/store/search?q=CapCut&c=apps
- Official help/privacy source-discovery link: https://www.google.com/search?q=CapCut%20official%20app%20help%20privacy
