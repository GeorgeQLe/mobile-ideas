...
## Overview
Build an original mobile product inspired by Evernote's user-facing workflow, not its brand identity or proprietary implementation.
The clone target is: Notes, notebooks, tags, web clips, attachments, OCR-like search, tasks, and sync conflict handling.
...
- Implement the app-specific focus: Notes, notebooks, tags, web clips, attachments, OCR-like search, tasks, and sync conflict handling.
...
## Non-Goals
- Do not copy Evernote branding, trade dress, logos, app icons, screenshots, marketing copy, or proprietary media.
...
## Research Sources
- App Store source-discovery link: https://apps.apple.com/us/search?term=Evernote
- Google Play source-discovery link: https://play.google.com/store/search?q=Evernote&c=apps
- Official help/privacy source-discovery link: https://www.google.com/search?q=Evernote%20official%20app%20help%20privacy
