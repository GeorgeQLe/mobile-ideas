...
## Overview
Build an original mobile product inspired by Headspace's user-facing workflow, not its brand identity or proprietary implementation.
The clone target is: Meditation library, daily sessions, sleepcasts, course progress, reminders, mood check-ins, and subscription.
...
## Goals
- Deliver a mobile-first wellness experience with complete onboarding, core action, settings, and recovery flows.
- Implement the app-specific focus: Meditation library, daily sessions, sleepcasts, course progress, reminders, mood check-ins, and subscription.
...
## Non-Goals
- Do not copy Headspace branding, trade dress, logos, app icons, screenshots, marketing copy, or proprietary media.
...
## Research Sources
- App Store source-discovery link: https://apps.apple.com/us/search?term=Headspace
- Google Play source-discovery link: https://play.google.com/store/search?q=Headspace&c=apps
- Official help/privacy source-discovery link: https://www.google.com/search?q=Headspace%20official%20app%20help%20privacy
...
## Detailed Design
- Onboarding: support guest, signup, returning-user, permission-primer, and blocked-region or blocked-account states as appropriate for wellness.
