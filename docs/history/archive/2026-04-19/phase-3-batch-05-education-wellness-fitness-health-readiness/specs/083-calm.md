...
## Overview
Build an original mobile product inspired by Calm's user-facing workflow, not its brand identity or proprietary implementation.
The clone target is: Meditation, sleep stories, music, breathing exercises, daily calm, favorites, and premium library access.
...
- Implement the app-specific focus: Meditation, sleep stories, music, breathing exercises, daily calm, favorites, and premium library access.
...
## Non-Goals
- Do not copy Calm branding, trade dress, logos, app icons, screenshots, marketing copy, or proprietary media.
...
## Research Sources
- App Store source-discovery link: https://apps.apple.com/us/search?term=Calm
- Google Play source-discovery link: https://play.google.com/store/search?q=Calm&c=apps
- Official help/privacy source-discovery link: https://www.google.com/search?q=Calm%20official%20app%20help%20privacy
