...
## Overview
Build an original mobile product inspired by Flo's user-facing workflow, not its brand identity or proprietary implementation.
The clone target is: Cycle tracking, predictions, symptoms, insights, reminders, pregnancy mode, and privacy controls.
...
- Implement the app-specific focus: Cycle tracking, predictions, symptoms, insights, reminders, pregnancy mode, and privacy controls.
...
## Non-Goals
- Do not copy Flo branding, trade dress, logos, app icons, screenshots, marketing copy, or proprietary media.
...
## Research Sources
- App Store source-discovery link: https://apps.apple.com/us/search?term=Flo
- Google Play source-discovery link: https://play.google.com/store/search?q=Flo&c=apps
- Official help/privacy source-discovery link: https://www.google.com/search?q=Flo%20official%20app%20help%20privacy
