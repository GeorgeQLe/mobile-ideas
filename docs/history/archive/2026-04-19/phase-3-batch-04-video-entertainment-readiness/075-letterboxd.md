...
## Overview
Build an original mobile product inspired by Letterboxd's user-facing workflow, not its brand identity or proprietary implementation.
The clone target is: Film diary, watchlist, reviews, ratings, lists, activity feed, and movie detail pages.
...
## Goals
- Deliver a mobile-first entertainment social experience with complete onboarding, core action, settings, and recovery flows.
- Implement the app-specific focus: Film diary, watchlist, reviews, ratings, lists, activity feed, and movie detail pages.
...
## Non-Goals
- Do not copy Letterboxd branding, trade dress, logos, app icons, screenshots, marketing copy, or proprietary media.
...
## Research Sources
- App Store source-discovery link: https://apps.apple.com/us/search?term=Letterboxd
- Google Play source-discovery link: https://play.google.com/store/search?q=Letterboxd&c=apps
- Official help/privacy source-discovery link: https://www.google.com/search?q=Letterboxd%20official%20app%20help%20privacy
...
## Detailed Design
- Onboarding: support guest, signup, returning-user, permission-primer, and blocked-region or blocked-account states as appropriate for entertainment social.
