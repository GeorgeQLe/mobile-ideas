...
## Overview
Build an original mobile product inspired by YouTube's user-facing workflow, not its brand identity or proprietary implementation.
The clone target is: Home feed, subscriptions, creator channels, video watch page, comments, playlists, shorts entry point, and upload.
...
## Goals
- Deliver a mobile-first video platform experience with complete onboarding, core action, settings, and recovery flows.
- Implement the app-specific focus: Home feed, subscriptions, creator channels, video watch page, comments, playlists, shorts entry point, and upload.
...
## Non-Goals
- Do not copy YouTube branding, trade dress, logos, app icons, screenshots, marketing copy, or proprietary media.
...
## Research Sources
- App Store source-discovery link: https://apps.apple.com/us/search?term=YouTube
- Google Play source-discovery link: https://play.google.com/store/search?q=YouTube&c=apps
- Official help/privacy source-discovery link: https://www.google.com/search?q=YouTube%20official%20app%20help%20privacy
...
## Detailed Design
- Onboarding: support guest, signup, returning-user, permission-primer, and blocked-region or blocked-account states as appropriate for video platform.
