...
## Overview
Build an original mobile product inspired by Duolingo's user-facing workflow, not its brand identity or proprietary implementation.
The clone target is: Gamified language lessons, streaks, hearts, XP, leagues, placement test, daily quests, and subscription gating.
...
- Implement the app-specific focus: Gamified language lessons, streaks, hearts, XP, leagues, placement test, daily quests, and subscription gating.
...
## Non-Goals
- Do not copy Duolingo branding, trade dress, logos, app icons, screenshots, marketing copy, or proprietary media.
...
## Research Sources
- App Store source-discovery link: https://apps.apple.com/us/search?term=Duolingo
- Google Play source-discovery link: https://play.google.com/store/search?q=Duolingo&c=apps
- Official help/privacy source-discovery link: https://www.google.com/search?q=Duolingo%20official%20app%20help%20privacy
