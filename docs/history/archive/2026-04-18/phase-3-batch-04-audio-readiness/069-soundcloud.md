...
## Overview
Build an original mobile product inspired by SoundCloud's user-facing workflow, not its brand identity or proprietary implementation.
The clone target is: Creator uploads, tracks, comments on waveform positions, reposts, likes, playlists, and creator profiles.
...
- Implement the app-specific focus: Creator uploads, tracks, comments on waveform positions, reposts, likes, playlists, and creator profiles.
...
## Non-Goals
- Do not copy SoundCloud branding, trade dress, logos, app icons, screenshots, marketing copy, or proprietary media.
...
## Research Sources
- App Store source-discovery link: https://apps.apple.com/us/search?term=SoundCloud
- Google Play source-discovery link: https://play.google.com/store/search?q=SoundCloud&c=apps
- Official help/privacy source-discovery link: https://www.google.com/search?q=SoundCloud%20official%20app%20help%20privacy
