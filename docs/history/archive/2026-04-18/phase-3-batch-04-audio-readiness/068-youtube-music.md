...
## Overview
Build an original mobile product inspired by YouTube Music's user-facing workflow, not its brand identity or proprietary implementation.
The clone target is: Video/audio switching, mixes, radio, downloads, lyrics, artist pages, and YouTube-linked history concepts.
...
- Implement the app-specific focus: Video/audio switching, mixes, radio, downloads, lyrics, artist pages, and YouTube-linked history concepts.
...
## Non-Goals
- Do not copy YouTube Music branding, trade dress, logos, app icons, screenshots, marketing copy, or proprietary media.
...
## Research Sources
- App Store source-discovery link: https://apps.apple.com/us/search?term=YouTube%20Music
- Google Play source-discovery link: https://play.google.com/store/search?q=YouTube%20Music&c=apps
- Official help/privacy source-discovery link: https://www.google.com/search?q=YouTube%20Music%20official%20app%20help%20privacy
