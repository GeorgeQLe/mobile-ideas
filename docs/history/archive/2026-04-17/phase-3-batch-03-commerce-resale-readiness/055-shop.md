...
## Overview
Build an original mobile product inspired by Shop's user-facing workflow, not its brand identity or proprietary implementation.
The clone target is: Package tracking, shop discovery, saved payment identity, order history, and merchant follow feed.
...
## Goals
- Deliver a mobile-first shopping utility experience with complete onboarding, core action, settings, and recovery flows.
- Implement the app-specific focus: Package tracking, shop discovery, saved payment identity, order history, and merchant follow feed.
...
## Non-Goals
- Do not copy Shop branding, trade dress, logos, app icons, screenshots, marketing copy, or proprietary media.
...
## Research Sources
- App Store source-discovery link: https://apps.apple.com/us/search?term=Shop
- Google Play source-discovery link: https://play.google.com/store/search?q=Shop&c=apps
- Official help/privacy source-discovery link: https://www.google.com/search?q=Shop%20official%20app%20help%20privacy
...
## Detailed Design
- Onboarding: support guest, signup, returning-user, permission-primer, and blocked-region or blocked-account states as appropriate for shopping utility.
