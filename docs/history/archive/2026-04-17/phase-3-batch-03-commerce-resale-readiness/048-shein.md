...
## Overview
Build an original mobile product inspired by SHEIN's user-facing workflow, not its brand identity or proprietary implementation.
The clone target is: Fast-fashion catalog, style filters, haul-like discovery, reviews with photos, wishlists, and promotions.
...
- Implement the app-specific focus: Fast-fashion catalog, style filters, haul-like discovery, reviews with photos, wishlists, and promotions.
...
## Non-Goals
- Do not copy SHEIN branding, trade dress, logos, app icons, screenshots, marketing copy, or proprietary media.
...
## Research Sources
- App Store source-discovery link: https://apps.apple.com/us/search?term=SHEIN
- Google Play source-discovery link: https://play.google.com/store/search?q=SHEIN&c=apps
- Official help/privacy source-discovery link: https://www.google.com/search?q=SHEIN%20official%20app%20help%20privacy
