...
## Overview
Build an original mobile product inspired by Depop's user-facing workflow, not its brand identity or proprietary implementation.
The clone target is: Social fashion resale, seller profiles, image-first listings, likes, offers, messaging, and trend discovery.
...
- Implement the app-specific focus: Social fashion resale, seller profiles, image-first listings, likes, offers, messaging, and trend discovery.
...
## Non-Goals
- Do not copy Depop branding, trade dress, logos, app icons, screenshots, marketing copy, or proprietary media.
...
## Research Sources
- App Store source-discovery link: https://apps.apple.com/us/search?term=Depop
- Google Play source-discovery link: https://play.google.com/store/search?q=Depop&c=apps
- Official help/privacy source-discovery link: https://www.google.com/search?q=Depop%20official%20app%20help%20privacy
