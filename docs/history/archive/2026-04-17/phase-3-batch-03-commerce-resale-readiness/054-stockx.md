...
## Overview
Build an original mobile product inspired by StockX's user-facing workflow, not its brand identity or proprietary implementation.
The clone target is: Bid/ask marketplace, product authentication workflow, market price history, portfolio tracking, and order status.
...
- Implement the app-specific focus: Bid/ask marketplace, product authentication workflow, market price history, portfolio tracking, and order status.
...
## Non-Goals
- Do not copy StockX branding, trade dress, logos, app icons, screenshots, marketing copy, or proprietary media.
...
## Research Sources
- App Store source-discovery link: https://apps.apple.com/us/search?term=StockX
- Google Play source-discovery link: https://play.google.com/store/search?q=StockX&c=apps
- Official help/privacy source-discovery link: https://www.google.com/search?q=StockX%20official%20app%20help%20privacy
