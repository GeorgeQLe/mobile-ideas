...
## Overview
Build an original mobile product inspired by Etsy's user-facing workflow, not its brand identity or proprietary implementation.
The clone target is: Handmade/vintage marketplace, shop pages, custom orders, favorites, cart, seller messaging, and reviews.
...
- Implement the app-specific focus: Handmade/vintage marketplace, shop pages, custom orders, favorites, cart, seller messaging, and reviews.
...
## Non-Goals
- Do not copy Etsy branding, trade dress, logos, app icons, screenshots, marketing copy, or proprietary media.
...
## Research Sources
- App Store source-discovery link: https://apps.apple.com/us/search?term=Etsy
- Google Play source-discovery link: https://play.google.com/store/search?q=Etsy&c=apps
- Official help/privacy source-discovery link: https://www.google.com/search?q=Etsy%20official%20app%20help%20privacy
