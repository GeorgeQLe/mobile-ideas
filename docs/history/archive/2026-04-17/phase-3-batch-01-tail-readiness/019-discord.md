...
## Overview
Build an original mobile product inspired by Discord's user-facing workflow, not its brand identity or proprietary implementation.
The clone target is: Servers, channels, roles, voice rooms, DMs, moderation tools, events, and notification granularity.
...
## Goals
- Deliver a mobile-first community chat experience with complete onboarding, core action, settings, and recovery flows.
- Implement the app-specific focus: Servers, channels, roles, voice rooms, DMs, moderation tools, events, and notification granularity.
...
## Non-Goals
- Do not copy Discord branding, trade dress, logos, app icons, screenshots, marketing copy, or proprietary media.
...
## Research Sources
- App Store source-discovery link: https://apps.apple.com/us/search?term=Discord
- Google Play source-discovery link: https://play.google.com/store/search?q=Discord&c=apps
- Official help/privacy source-discovery link: https://www.google.com/search?q=Discord%20official%20app%20help%20privacy
...
## Detailed Design
- Onboarding: support guest, signup, returning-user, permission-primer, and blocked-region or blocked-account states as appropriate for community chat.
