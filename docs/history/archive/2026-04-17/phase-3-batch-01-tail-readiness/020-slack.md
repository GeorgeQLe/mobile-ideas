...
## Overview
Build an original mobile product inspired by Slack's user-facing workflow, not its brand identity or proprietary implementation.
The clone target is: Workspace channels, threads, mentions, files, search, status, integrations, and enterprise notification settings.
...
## Goals
- Deliver a mobile-first workplace chat experience with complete onboarding, core action, settings, and recovery flows.
- Implement the app-specific focus: Workspace channels, threads, mentions, files, search, status, integrations, and enterprise notification settings.
...
## Non-Goals
- Do not copy Slack branding, trade dress, logos, app icons, screenshots, marketing copy, or proprietary media.
...
## Research Sources
- App Store source-discovery link: https://apps.apple.com/us/search?term=Slack
- Google Play source-discovery link: https://play.google.com/store/search?q=Slack&c=apps
- Official help/privacy source-discovery link: https://www.google.com/search?q=Slack%20official%20app%20help%20privacy
...
## Detailed Design
- Onboarding: support guest, signup, returning-user, permission-primer, and blocked-region or blocked-account states as appropriate for workplace chat.
