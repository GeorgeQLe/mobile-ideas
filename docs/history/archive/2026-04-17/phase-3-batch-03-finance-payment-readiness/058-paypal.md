...
## Overview
Build an original mobile product inspired by PayPal's user-facing workflow, not its brand identity or proprietary implementation.
The clone target is: Wallet, send/request money, merchant checkout history, cards/banks, disputes, crypto-like modules, and security center.
...
- Implement the app-specific focus: Wallet, send/request money, merchant checkout history, cards/banks, disputes, crypto-like modules, and security center.
...
## Non-Goals
- Do not copy PayPal branding, trade dress, logos, app icons, screenshots, marketing copy, or proprietary media.
...
## Research Sources
- App Store source-discovery link: https://apps.apple.com/us/search?term=PayPal
- Google Play source-discovery link: https://play.google.com/store/search?q=PayPal&c=apps
- Official help/privacy source-discovery link: https://www.google.com/search?q=PayPal%20official%20app%20help%20privacy
