...
## Overview
Build an original mobile product inspired by Venmo's user-facing workflow, not its brand identity or proprietary implementation.
The clone target is: Social payments, friends feed, payment notes, split requests, groups, card, and privacy controls.
...
- Implement the app-specific focus: Social payments, friends feed, payment notes, split requests, groups, card, and privacy controls.
...
## Non-Goals
- Do not copy Venmo branding, trade dress, logos, app icons, screenshots, marketing copy, or proprietary media.
...
## Research Sources
- App Store source-discovery link: https://apps.apple.com/us/search?term=Venmo
- Google Play source-discovery link: https://play.google.com/store/search?q=Venmo&c=apps
- Official help/privacy source-discovery link: https://www.google.com/search?q=Venmo%20official%20app%20help%20privacy
