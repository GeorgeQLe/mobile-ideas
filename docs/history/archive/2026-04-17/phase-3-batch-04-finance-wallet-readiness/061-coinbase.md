...
## Overview
Build an original mobile product inspired by Coinbase's user-facing workflow, not its brand identity or proprietary implementation.
The clone target is: Crypto portfolio, asset pages, buy/sell/convert, staking-like rewards, alerts, identity verification, and security.
...
## Goals
- Deliver a mobile-first crypto experience with complete onboarding, core action, settings, and recovery flows.
- Implement the app-specific focus: Crypto portfolio, asset pages, buy/sell/convert, staking-like rewards, alerts, identity verification, and security.
...
## Non-Goals
- Do not copy Coinbase branding, trade dress, logos, app icons, screenshots, marketing copy, or proprietary media.
...
## Research Sources
- App Store source-discovery link: https://apps.apple.com/us/search?term=Coinbase
- Google Play source-discovery link: https://play.google.com/store/search?q=Coinbase&c=apps
- Official help/privacy source-discovery link: https://www.google.com/search?q=Coinbase%20official%20app%20help%20privacy
...
## Detailed Design
- Onboarding: support guest, signup, returning-user, permission-primer, and blocked-region or blocked-account states as appropriate for crypto.
