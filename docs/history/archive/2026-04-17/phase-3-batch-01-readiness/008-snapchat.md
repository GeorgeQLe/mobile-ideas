...
## Overview
Build an original mobile product inspired by Snapchat's user-facing workflow, not its brand identity or proprietary implementation.
The clone target is: Camera-first launch, ephemeral messaging, stories, friend map, AR lenses, streaks, and privacy-first retention rules.
...
## Goals
- Deliver a mobile-first camera social experience with complete onboarding, core action, settings, and recovery flows.
- Implement the app-specific focus: Camera-first launch, ephemeral messaging, stories, friend map, AR lenses, streaks, and privacy-first retention rules.
...
## Non-Goals
- Do not copy Snapchat branding, trade dress, logos, app icons, screenshots, marketing copy, or proprietary media.
...
## Research Sources
- App Store source-discovery link: https://apps.apple.com/us/search?term=Snapchat
- Google Play source-discovery link: https://play.google.com/store/search?q=Snapchat&c=apps
- Official help/privacy source-discovery link: https://www.google.com/search?q=Snapchat%20official%20app%20help%20privacy
...
## Detailed Design
- Onboarding: support guest, signup, returning-user, permission-primer, and blocked-region or blocked-account states as appropriate for camera social.
