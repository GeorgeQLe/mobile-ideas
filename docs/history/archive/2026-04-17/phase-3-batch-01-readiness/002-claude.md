...
## Overview
Build an original mobile product inspired by Claude's user-facing workflow, not its brand identity or proprietary implementation.
The clone target is: Long-form assistant for writing, analysis, artifacts, project knowledge, document upload, and careful conversation organization.
...
- Implement the app-specific focus: Long-form assistant for writing, analysis, artifacts, project knowledge, document upload, and careful conversation organization.
...
## Non-Goals
- Do not copy Claude branding, trade dress, logos, app icons, screenshots, marketing copy, or proprietary media.
...
## Research Sources
- App Store source-discovery link: https://apps.apple.com/us/search?term=Claude
- Google Play source-discovery link: https://play.google.com/store/search?q=Claude&c=apps
- Official help/privacy source-discovery link: https://www.google.com/search?q=Claude%20official%20app%20help%20privacy
