...
## Overview
Build an original mobile product inspired by Instagram's user-facing workflow, not its brand identity or proprietary implementation.
The clone target is: Home feed, stories, reels, DMs, creator profile grid, explore, likes/comments, and account privacy settings.
...
- Implement the app-specific focus: Home feed, stories, reels, DMs, creator profile grid, explore, likes/comments, and account privacy settings.
...
## Non-Goals
- Do not copy Instagram branding, trade dress, logos, app icons, screenshots, marketing copy, or proprietary media.
...
## Research Sources
- App Store source-discovery link: https://apps.apple.com/us/search?term=Instagram
- Google Play source-discovery link: https://play.google.com/store/search?q=Instagram&c=apps
- Official help/privacy source-discovery link: https://www.google.com/search?q=Instagram%20official%20app%20help%20privacy
