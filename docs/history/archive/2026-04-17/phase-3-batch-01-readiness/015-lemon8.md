...
## Overview
Build an original mobile product inspired by Lemon8's user-facing workflow, not its brand identity or proprietary implementation.
The clone target is: Magazine-like creator posts, templates, lifestyle categories, saved collections, and hashtag-driven browsing.
...
## Goals
- Deliver a mobile-first lifestyle social experience with complete onboarding, core action, settings, and recovery flows.
- Implement the app-specific focus: Magazine-like creator posts, templates, lifestyle categories, saved collections, and hashtag-driven browsing.
...
## Non-Goals
- Do not copy Lemon8 branding, trade dress, logos, app icons, screenshots, marketing copy, or proprietary media.
...
## Research Sources
- App Store source-discovery link: https://apps.apple.com/us/search?term=Lemon8
- Google Play source-discovery link: https://play.google.com/store/search?q=Lemon8&c=apps
- Official help/privacy source-discovery link: https://www.google.com/search?q=Lemon8%20official%20app%20help%20privacy
...
## Detailed Design
- Onboarding: support guest, signup, returning-user, permission-primer, and blocked-region or blocked-account states as appropriate for lifestyle social.
