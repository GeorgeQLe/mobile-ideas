...
## Overview
Build an original mobile product inspired by Apple Maps's user-facing workflow, not its brand identity or proprietary implementation.
The clone target is: Place cards, guides, route planning, turn-by-turn navigation, Look Around-like browsing, and privacy-preserving search UX.
...
## Goals
- Deliver a mobile-first maps/navigation experience with complete onboarding, core action, settings, and recovery flows.
- Implement the app-specific focus: Place cards, guides, route planning, turn-by-turn navigation, Look Around-like browsing, and privacy-preserving search UX.
...
## Non-Goals
- Do not copy Apple Maps branding, trade dress, logos, app icons, screenshots, marketing copy, or proprietary media.
...
## Research Sources
- App Store source-discovery link: https://apps.apple.com/us/search?term=Apple%20Maps
- Google Play source-discovery link: https://play.google.com/store/search?q=Apple%20Maps&c=apps
- Official help/privacy source-discovery link: https://www.google.com/search?q=Apple%20Maps%20official%20app%20help%20privacy
...
## Detailed Design
- Onboarding: support guest, signup, returning-user, permission-primer, and blocked-region or blocked-account states as appropriate for maps/navigation.
