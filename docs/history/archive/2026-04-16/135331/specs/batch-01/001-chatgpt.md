...
## Overview
Build an original mobile product inspired by ChatGPT's user-facing workflow, not its brand identity or proprietary implementation.
The clone target is: Multimodal assistant with chat history, voice mode, file/image attachments, memory settings, model picker, and shared conversations.
...
## Goals
- Deliver a mobile-first ai assistant experience with complete onboarding, core action, settings, and recovery flows.
- Implement the app-specific focus: Multimodal assistant with chat history, voice mode, file/image attachments, memory settings, model picker, and shared conversations.
...
## Non-Goals
- Do not copy ChatGPT branding, trade dress, logos, app icons, screenshots, marketing copy, or proprietary media.
...
## Research Sources
- App Store source-discovery link: https://apps.apple.com/us/search?term=ChatGPT
- Google Play source-discovery link: https://play.google.com/store/search?q=ChatGPT&c=apps
- Official help/privacy source-discovery link: https://www.google.com/search?q=ChatGPT%20official%20app%20help%20privacy
...
## Detailed Design
- Onboarding: support guest, signup, returning-user, permission-primer, and blocked-region or blocked-account states as appropriate for ai assistant.
