...
> - Category: Automated investing and cash management
...
> - Manual verification blockers: KYC/AML onboarding, cash account eligibility, program-bank sweep, advisory questionnaire, tax-loss harvesting, direct indexing, bond ladder orders, debit card/ATM behavior, and account aggregation require advisory/banking/compliance owners.
...
Build an original mobile automated investing and cash management app inspired by Wealthfront's public workflow: automated ETF portfolios, cash account, program-bank sweep, direct indexing, tax-loss harvesting, US Treasury bond ladder, stock investing, account linking, Path-style planning, and advisory disclosures. The clone must not copy Wealthfront branding, protected UI artwork, screenshots, copy, private APIs, partner contracts, proprietary datasets, or regulated operating status.
...
- Deliver the core automated investing and cash management jobs documented by the official app listings and first-party support/legal pages.
...
- Do not build a Wealthfront-branded app or imply affiliation, endorsement, banking status, broker-dealer status, RIA status, publisher status, money-transmitter status, or insurance status.
- Do not scrape Wealthfront, reuse private APIs, replay app traffic, copy article text, reproduce proprietary algorithms, or use unlicensed market/account/card/payment data.
...
|---|---|---|---|
| Apple App Store | https://apps.apple.com/us/app/wealthfront-save-and-invest/id816020992 | Official iOS listing, device support, age rating, privacy label, feature claims, subscriptions or account disclosures where listed | Verified 2026-05-01 |
| Google Play | https://play.google.com/store/apps/details?id=com.wealthfront | Official Android listing, feature claims, content rating, data safety, developer contact, partner/risk disclosures where listed | Verified 2026-05-01 |
| Wealthfront website | https://www.wealthfront.com | First-party product orientation and non-affiliation boundary for a lawful functional-parity clone | Verified 2026-05-01 |
| Wealthfront help/support | https://support.wealthfront.com | Support taxonomy, account-management concepts, troubleshooting paths, and user-facing escalation expectations | Verified 2026-05-01 |
| Wealthfront Privacy Policy | https://www.wealthfront.com/legal/privacy | Personal, financial, device, location, analytics, support, retention, sharing, deletion, and privacy-rights obligations | Verified 2026-05-01 |
| Wealthfront Terms | https://www.wealthfront.com/legal/terms | Eligibility, account rules, prohibited conduct, subscription/payment terms, risk language, user responsibilities, and dispute path | Verified 2026-05-01 |
| Wealthfront legal/disclosures | https://www.wealthfront.com/legal | Finance, banking, brokerage, advisory, market-data, partner-bank, FDIC/SIPC, risk, or product-specific disclosures | Verified 2026-05-01 |

## Detailed Design

### Source-Backed Product Requirements

- The V1 must center on automated ETF portfolios, cash account, program-bank sweep, direct indexing, tax-loss harvesting, US Treasury bond ladder, stock investing, account linking, Path-style planning, and advisory disclosures, while using original product names, copy, visual design, data contracts, and content.
- The public app listings and first-party pages support cash APY disclosures, program-bank FDIC framing, automated investing, direct indexing, tax-loss harvesting, bond ladder, self-directed stocks, planning tools, and non-advice/tax disclaimers; any deeper account, paid, native, or regulated behavior remains blocked until hands-on verification.
...
- Tax and planning projections must be framed as educational estimates and blocked from launch until compliance and tax-review copy is approved.
...
- New user installs the app, reviews original onboarding, sees non-affiliation and automated investing and cash management disclosures, and chooses sign-up or read-only exploration where permitted.
...
- `AuditEvent`: append-only record for Wealthfront-inspired auth, consent, disclosure, privacy, support, regulated-action, and admin changes.
...
- `GET /dashboard`: returns the Wealthfront-inspired home summary with stale-data labels and feature flags.
