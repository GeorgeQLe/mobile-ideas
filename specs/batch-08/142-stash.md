...
> - Category: Investing and banking
...
> - Manual verification blockers: KYC/AML onboarding, RIA suitability, managed portfolio algorithm, debit rewards, subscription restore, custodial account setup, tax documents, and bank-card flows require advisory/banking/compliance owners and sandbox evidence.
...
Build an original mobile investing and banking app inspired by Stash's public workflow: managed portfolios, self-directed stocks/ETFs, Auto-Stash recurring transfers, Stock-Back debit rewards, retirement, custodial accounts, money coaching, subscription tiers, and banking partner disclosures. The clone must not copy Stash branding, protected UI artwork, screenshots, copy, private APIs, partner contracts, proprietary datasets, or regulated operating status.
...
- Deliver the core investing and banking jobs documented by the official app listings and first-party support/legal pages.
...
- Do not build a Stash-branded app or imply affiliation, endorsement, banking status, broker-dealer status, RIA status, publisher status, money-transmitter status, or insurance status.
- Do not scrape Stash, reuse private APIs, replay app traffic, copy article text, reproduce proprietary algorithms, or use unlicensed market/account/card/payment data.
...
|---|---|---|---|
| Apple App Store | https://apps.apple.com/us/app/stash-investing-made-easy/id1017148055 | Official iOS listing, device support, age rating, privacy label, feature claims, subscriptions or account disclosures where listed | Verified 2026-05-01 |
| Google Play | https://play.google.com/store/apps/details?id=com.stash.stashinvest | Official Android listing, feature claims, content rating, data safety, developer contact, partner/risk disclosures where listed | Verified 2026-05-01 |
| Stash website | https://www.stash.com | First-party product orientation and non-affiliation boundary for a lawful functional-parity clone | Verified 2026-05-01 |
| Stash help/support | https://ask.stash.com | Support taxonomy, account-management concepts, troubleshooting paths, and user-facing escalation expectations | Verified 2026-05-01 |
| Stash Privacy Policy | https://www.stash.com/privacy-policy | Personal, financial, device, location, analytics, support, retention, sharing, deletion, and privacy-rights obligations | Verified 2026-05-01 |
| Stash Terms | https://www.stash.com/terms-and-conditions | Eligibility, account rules, prohibited conduct, subscription/payment terms, risk language, user responsibilities, and dispute path | Verified 2026-05-01 |
| Stash legal/disclosures | https://www.stash.com/disclosurelibrary | Finance, banking, brokerage, advisory, market-data, partner-bank, FDIC/SIPC, risk, or product-specific disclosures | Verified 2026-05-01 |

## Detailed Design

### Source-Backed Product Requirements

- The V1 must center on managed portfolios, self-directed stocks/ETFs, Auto-Stash recurring transfers, Stock-Back debit rewards, retirement, custodial accounts, money coaching, subscription tiers, and banking partner disclosures, while using original product names, copy, visual design, data contracts, and content.
- The public app listings and first-party pages support RIA framing, managed portfolios, self-directed investments, Auto-Stash, Stock-Back debit card, Stride Bank/FDIC banking services, subscriptions, and 18+ US eligibility; any deeper account, paid, native, or regulated behavior remains blocked until hands-on verification.
...
- Money Coach and portfolio guidance must avoid unreviewed personalized advice unless an RIA/advisory compliance model is in place.
...
- New user installs the app, reviews original onboarding, sees non-affiliation and investing and banking disclosures, and chooses sign-up or read-only exploration where permitted.
...
- `AuditEvent`: append-only record for Stash-inspired auth, consent, disclosure, privacy, support, regulated-action, and admin changes.
...
- `GET /dashboard`: returns the Stash-inspired home summary with stale-data labels and feature flags.
