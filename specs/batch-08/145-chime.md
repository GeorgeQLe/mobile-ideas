...
> - Manual verification blockers: KYC/AML onboarding, direct deposit timing, overdraft eligibility, credit builder reporting, card issuance, cash deposits, ATM network, disputes, and support SLAs require banking/security/compliance owners and sponsor-bank sandbox evidence.
...
Build an original mobile mobile banking app inspired by Chime's public workflow: checking, savings, early direct deposit, overdraft coverage, credit builder, ATM locator, cash deposits, card controls, live support, security alerts, and banking partner disclosures. The clone must not copy Chime branding, protected UI artwork, screenshots, copy, private APIs, partner contracts, proprietary datasets, or regulated operating status.
...
- Deliver the core mobile banking jobs documented by the official app listings and first-party support/legal pages.
...
- Do not build a Chime-branded app or imply affiliation, endorsement, banking status, broker-dealer status, RIA status, publisher status, money-transmitter status, or insurance status.
- Do not scrape Chime, reuse private APIs, replay app traffic, copy article text, reproduce proprietary algorithms, or use unlicensed market/account/card/payment data.
...
|---|---|---|---|
| Apple App Store | https://apps.apple.com/us/app/chime-mobile-banking/id836215269 | Official iOS listing, device support, age rating, privacy label, feature claims, subscriptions or account disclosures where listed | Verified 2026-05-01 |
| Google Play | https://play.google.com/store/apps/details?id=com.onedebit.chime | Official Android listing, feature claims, content rating, data safety, developer contact, partner/risk disclosures where listed | Verified 2026-05-01 |
| Chime website | https://www.chime.com | First-party product orientation and non-affiliation boundary for a lawful functional-parity clone | Verified 2026-05-01 |
| Chime help/support | https://help.chime.com | Support taxonomy, account-management concepts, troubleshooting paths, and user-facing escalation expectations | Verified 2026-05-01 |
| Chime Privacy Policy | https://www.chime.com/policies/privacy-policy/ | Personal, financial, device, location, analytics, support, retention, sharing, deletion, and privacy-rights obligations | Verified 2026-05-01 |
| Chime Terms | https://www.chime.com/policies/ | Eligibility, account rules, prohibited conduct, subscription/payment terms, risk language, user responsibilities, and dispute path | Verified 2026-05-01 |
| Chime legal/disclosures | https://www.chime.com/policies/ | Finance, banking, brokerage, advisory, market-data, partner-bank, FDIC/SIPC, risk, or product-specific disclosures | Verified 2026-05-01 |

## Detailed Design

### Source-Backed Product Requirements

- The V1 must center on checking, savings, early direct deposit, overdraft coverage, credit builder, ATM locator, cash deposits, card controls, live support, security alerts, and banking partner disclosures, while using original product names, copy, visual design, data contracts, and content.
- The public app listings and first-party pages support fintech-not-a-bank disclosure, Bancorp Bank/Stride Bank FDIC banking services, checking, savings, early pay, overdraft/SpotMe-style coverage, credit builder, fee-free ATMs, card controls, and 24/7 support; any deeper account, paid, native, or regulated behavior remains blocked until hands-on verification.
...
- Every deposit, card, overdraft, and credit-reporting surface must show fintech-not-bank and sponsor-bank disclosures where applicable.
...
- New user installs the app, reviews original onboarding, sees non-affiliation and mobile banking disclosures, and chooses sign-up or read-only exploration where permitted.
...
- `AuditEvent`: append-only record for Chime-inspired auth, consent, disclosure, privacy, support, regulated-action, and admin changes.
...
- `GET /dashboard`: returns the Chime-inspired home summary with stale-data labels and feature flags.
