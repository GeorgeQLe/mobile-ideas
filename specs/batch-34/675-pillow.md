...
> - Manual verification blockers: Apple Health permissions, microphone/audio recording consent, on-device sleep/audio analysis claims, subscription restore, watch sync, alarm reliability, sleep-apnea disclaimer, and CSV export behavior.
...
Build an original mobile product inspired by Pillow's public health and medical workflow. The V1 clone focuses on sleep tracking with Apple Watch/iPhone/iPad, sleep stages, smart alarm, snore/sleep audio recording, insights, sleep aid library, mood/notes, trends, Apple Health comparison, and Premium gates.
...
- Preserve the functional job behind Pillow while using original product naming, original UI, original sample data, and licensed integrations.
...
- Do not copy Pillow branding, logos, screenshots, marketing copy, private APIs, proprietary datasets, plan names, UI trade dress, clinical content, nutrition databases, provider directories, or protected media.
...
|---|---|---|---|
| Apple App Store | https://apps.apple.com/us/app/pillow-sleep-tracker/id878691772 | iOS listing, privacy labels, accessibility claims, subscription details, and feature claims | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
| Google Play | Platform blocker: no verified first-party Google Play listing for Pillow Sleep Tracker | Android parity is blocked until a first-party listing is verified | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
| Official product site | https://pillow.app/ | Sleep tracking, smart alarm, audio, insights, Apple Health, and Premium positioning | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
| Official support | https://support.pillow.app/ | Setup, Apple Watch, audio, subscriptions, export, privacy, and support docs | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
| Privacy policy | https://pillow.app/pillow-privacy-policy-en | Privacy and data handling disclosures linked from public listing | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
| Terms | https://pillow.app/pillow-privacy-policy-en | Terms/subscription/privacy text linked from public app listing | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
...
- Manual blockers must remain launch-blocking until verified: Apple Health permissions, microphone/audio recording consent, on-device sleep/audio analysis claims, subscription restore, watch sync, alarm reliability, sleep-apnea disclaimer, and CSV export behavior.

## Core User Journeys

- User creates or restores a Pillow-style account, completes consent and eligibility checks, and reaches a privacy-forward dashboard.
...
- Monetization model: use original free/trial/paid/sponsored/benefit entitlement logic; do not copy exact pricing, plan names, bundle names, promotional copy, employer offers, or partner offers from Pillow.
...
- Manual verification tests for Apple Health permissions, microphone/audio recording consent, on-device sleep/audio analysis claims, subscription restore, watch sync, alarm reliability, sleep-apnea disclaimer, and CSV export behavior.
...
- Phase 4: Add app-specific safety controls for sleep tracking with Apple Watch/iPhone/iPad, sleep stages, smart alarm, snore/sleep audio recording, insights, sleep aid library, mood/notes, trends, Apple Health comparison, and Premium gates.
...
- Confirm legal/privacy retention behavior for Pillow-style sensitive records and update API contracts before downstream implementation.
