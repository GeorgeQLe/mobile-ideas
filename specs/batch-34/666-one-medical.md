...
> - Manual verification blockers: membership eligibility, Amazon/One Medical account states, office markets, insurance billing, provider messaging, prescription renewals, child/family account handling, Apple Health sync, and urgent-care availability.
...
Build an original mobile product inspired by One Medical's public health and medical workflow. The V1 clone focuses on membership-based primary care, appointment scheduling, Treat Me Now, urgent video chat, secure provider messaging, prescription renewals, health records, bills, insurance, office search, and Apple Health sync.
...
- Preserve the functional job behind One Medical while using original product naming, original UI, original sample data, and licensed integrations.
...
- Do not copy One Medical branding, logos, screenshots, marketing copy, private APIs, proprietary datasets, plan names, UI trade dress, clinical content, nutrition databases, provider directories, or protected media.
...
|---|---|---|---|
| Apple App Store | https://apps.apple.com/us/app/one-medical/id393507802 | iOS listing, privacy labels, release notes, membership language, and support links | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
| Google Play | https://play.google.com/store/apps/details?id=com.onemedical.android | Android listing, data safety, feature claims, and support links | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
| Official product site | https://www.onemedical.com/ | Membership, primary care, virtual care, offices, benefits, and service model | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
| Official help | https://www.onemedical.com/help/ | Membership, account, appointments, billing, insurance, records, and support docs | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
| Privacy policy | https://www.onemedical.com/privacy-policy/ | Health, account, payment, insurance, location, analytics, and sharing disclosures | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
| Terms | https://www.onemedical.com/terms-of-use/ | Membership terms, accounts, care limits, billing, and service boundaries | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
...
- Manual blockers must remain launch-blocking until verified: membership eligibility, Amazon/One Medical account states, office markets, insurance billing, provider messaging, prescription renewals, child/family account handling, Apple Health sync, and urgent-care availability.

## Core User Journeys

- User creates or restores a One Medical-style account, completes consent and eligibility checks, and reaches a privacy-forward dashboard.
...
- Monetization model: use original free/trial/paid/sponsored/benefit entitlement logic; do not copy exact pricing, plan names, bundle names, promotional copy, employer offers, or partner offers from One Medical.
...
- Manual verification tests for membership eligibility, Amazon/One Medical account states, office markets, insurance billing, provider messaging, prescription renewals, child/family account handling, Apple Health sync, and urgent-care availability.
...
- Phase 4: Add app-specific safety controls for membership-based primary care, appointment scheduling, Treat Me Now, urgent video chat, secure provider messaging, prescription renewals, health records, bills, insurance, office search, and Apple Health sync.
...
- Confirm legal/privacy retention behavior for One Medical-style sensitive records and update API contracts before downstream implementation.
