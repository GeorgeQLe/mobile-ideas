...
> - Manual verification blockers: employer/health-plan sponsorship, pay-as-you-go availability, specialist availability, reproductive-health privacy, care advocate routing, prescriptions, benefits referrals, and international/regional care limits.
...
Build an original mobile product inspired by Maven Clinic's public health and medical workflow. The V1 clone focuses on women and family virtual clinic onboarding, sponsored benefit activation, fertility/pregnancy/parenting/menopause care journeys, provider messaging/video, care advocate, classes, articles, and health binder.
...
- Preserve the functional job behind Maven Clinic while using original product naming, original UI, original sample data, and licensed integrations.
...
- Do not copy Maven Clinic branding, logos, screenshots, marketing copy, private APIs, proprietary datasets, plan names, UI trade dress, clinical content, nutrition databases, provider directories, or protected media.
...
|---|---|---|---|
| Apple App Store | https://apps.apple.com/us/app/maven-clinic/id942543121 | iOS listing, privacy labels, release notes, care categories, and support links | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
| Google Play | https://play.google.com/store/apps/details?id=com.mavenclinic.android.member | Android listing, data safety, device-security requirements, and support links | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
| Official product site | https://www.mavenclinic.com/ | Family health, fertility, maternity, parenting, menopause, benefits, and virtual-care positioning | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
| Official support | https://support.mavenclinic.com/ | Account, benefits, appointments, providers, billing, and technical support | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
| Privacy policy | https://www.mavenclinic.com/privacy-policy | Health, reproductive, family, account, employer/plan, analytics, and sharing disclosures | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
| Terms | https://www.mavenclinic.com/terms | Service terms, clinical limits, account, benefits, content, and payment boundaries | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
...
- Manual blockers must remain launch-blocking until verified: employer/health-plan sponsorship, pay-as-you-go availability, specialist availability, reproductive-health privacy, care advocate routing, prescriptions, benefits referrals, and international/regional care limits.

## Core User Journeys

- User creates or restores a Maven Clinic-style account, completes consent and eligibility checks, and reaches a privacy-forward dashboard.
...
- Monetization model: use original free/trial/paid/sponsored/benefit entitlement logic; do not copy exact pricing, plan names, bundle names, promotional copy, employer offers, or partner offers from Maven Clinic.
...
- Manual verification tests for employer/health-plan sponsorship, pay-as-you-go availability, specialist availability, reproductive-health privacy, care advocate routing, prescriptions, benefits referrals, and international/regional care limits.
...
- Phase 4: Add app-specific safety controls for women and family virtual clinic onboarding, sponsored benefit activation, fertility/pregnancy/parenting/menopause care journeys, provider messaging/video, care advocate, classes, articles, and health binder.
...
- Confirm legal/privacy retention behavior for Maven Clinic-style sensitive records and update API contracts before downstream implementation.
