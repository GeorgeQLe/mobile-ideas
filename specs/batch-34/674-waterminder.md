...
> - Manual verification blockers: HealthKit permission behavior, hydration-estimate safety, reminder scheduling, widget/watch sync, subscription restore, unit conversions, drink database customization, and no-medical-advice copy.
...
Build an original mobile product inspired by WaterMinder's public health and medical workflow. The V1 clone focuses on hydration goal setup, water/drink logging, smart reminders, visual fill progress, custom cups, history charts, HealthKit read/write, widgets, watch support, and Premium gates.
...
- Preserve the functional job behind WaterMinder while using original product naming, original UI, original sample data, and licensed integrations.
...
- Do not copy WaterMinder branding, logos, screenshots, marketing copy, private APIs, proprietary datasets, plan names, UI trade dress, clinical content, nutrition databases, provider directories, or protected media.
...
|---|---|---|---|
| Apple App Store | https://apps.apple.com/us/app/water-tracker-by-waterminder/id653031147 | iOS listing, privacy labels, accessibility claims, in-app purchases, and HealthKit note | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
| Google Play | https://play.google.com/store/apps/details?id=com.funnmedia.waterminder | Android listing, data safety, feature claims, and support links | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
| Official product site | https://waterminder.com/ | Hydration tracking, reminders, widgets, watch support, and Premium positioning | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
| Official support | https://waterminder.com/support.html | Setup, reminders, sync, subscriptions, and app support | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
| Privacy policy | https://www.iubenda.com/privacy-policy/7803420 | App privacy disclosures linked from public listing | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
| Terms | https://waterminder.com/terms.html | Terms, subscriptions, app use, and support boundaries | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
...
- Manual blockers must remain launch-blocking until verified: HealthKit permission behavior, hydration-estimate safety, reminder scheduling, widget/watch sync, subscription restore, unit conversions, drink database customization, and no-medical-advice copy.

## Core User Journeys

- User creates or restores a WaterMinder-style account, completes consent and eligibility checks, and reaches a privacy-forward dashboard.
...
- Monetization model: use original free/trial/paid/sponsored/benefit entitlement logic; do not copy exact pricing, plan names, bundle names, promotional copy, employer offers, or partner offers from WaterMinder.
...
- Manual verification tests for HealthKit permission behavior, hydration-estimate safety, reminder scheduling, widget/watch sync, subscription restore, unit conversions, drink database customization, and no-medical-advice copy.
...
- Phase 4: Add app-specific safety controls for hydration goal setup, water/drink logging, smart reminders, visual fill progress, custom cups, history charts, HealthKit read/write, widgets, watch support, and Premium gates.
...
- Confirm legal/privacy retention behavior for WaterMinder-style sensitive records and update API contracts before downstream implementation.
