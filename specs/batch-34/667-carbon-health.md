...
> - Manual verification blockers: clinic/service availability, insurance eligibility, telehealth states, lab ordering/results, prescription authority, billing/refund outcomes, provider messaging, and market-specific support paths.
...
Build an original mobile product inspired by Carbon Health's public health and medical workflow. The V1 clone focuses on hybrid urgent/primary care onboarding, appointment booking, clinic search, telehealth, labs, prescriptions, records, messaging, billing, and care-plan follow-up.
...
- Preserve the functional job behind Carbon Health while using original product naming, original UI, original sample data, and licensed integrations.
...
- Do not copy Carbon Health branding, logos, screenshots, marketing copy, private APIs, proprietary datasets, plan names, UI trade dress, clinical content, nutrition databases, provider directories, or protected media.
...
|---|---|---|---|
| Apple App Store | https://apps.apple.com/us/app/carbon-health/id1152807572 | iOS listing, privacy labels, release notes, and support links | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
| Google Play | https://play.google.com/store/apps/details?id=com.carbonhealth.patient | Android listing, data safety, install requirements, and support links | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
| Official product site | https://carbonhealth.com/ | Urgent care, primary care, virtual care, locations, insurance, and service model | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
| Official support | https://support.carbonhealth.com/ | Account, appointments, billing, insurance, labs, records, and support docs | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
| Privacy policy | https://carbonhealth.com/privacy-policy | Health, account, payment, insurance, location, communication, and analytics disclosures | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
| Terms | https://carbonhealth.com/terms-of-use | Service terms, care boundaries, accounts, payments, and acceptable-use terms | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
...
- Manual blockers must remain launch-blocking until verified: clinic/service availability, insurance eligibility, telehealth states, lab ordering/results, prescription authority, billing/refund outcomes, provider messaging, and market-specific support paths.

## Core User Journeys

- User creates or restores a Carbon Health-style account, completes consent and eligibility checks, and reaches a privacy-forward dashboard.
...
- Monetization model: use original free/trial/paid/sponsored/benefit entitlement logic; do not copy exact pricing, plan names, bundle names, promotional copy, employer offers, or partner offers from Carbon Health.
...
- Manual verification tests for clinic/service availability, insurance eligibility, telehealth states, lab ordering/results, prescription authority, billing/refund outcomes, provider messaging, and market-specific support paths.
...
- Phase 4: Add app-specific safety controls for hybrid urgent/primary care onboarding, appointment booking, clinic search, telehealth, labs, prescriptions, records, messaging, billing, and care-plan follow-up.
...
- Confirm legal/privacy retention behavior for Carbon Health-style sensitive records and update API contracts before downstream implementation.
