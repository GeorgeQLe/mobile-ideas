...
> - Manual verification blockers: subscription plans, medication eligibility, coaching scope, AI food logging accuracy, body-scan privacy, eating-disorder safety, device sync, ad tracking, and refund/cancellation behavior.
...
Build an original mobile product inspired by Noom's public health and medical workflow. The V1 clone focuses on behavior-change onboarding, weight and health goals, food logging with AI/photo/barcode/text, lessons, coaching, step tracking, GLP-1 eligibility gates, body scans, subscriptions, and progress insights.
...
- Preserve the functional job behind Noom while using original product naming, original UI, original sample data, and licensed integrations.
...
- Do not copy Noom branding, logos, screenshots, marketing copy, private APIs, proprietary datasets, plan names, UI trade dress, clinical content, nutrition databases, provider directories, or protected media.
...
|---|---|---|---|
| Apple App Store | https://apps.apple.com/us/app/noom-weight-loss-food-tracker/id634598719 | iOS listing, privacy labels, release notes, in-app purchases, and support links | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
| Google Play | https://play.google.com/store/apps/details?id=com.wsl.noom | Android listing, data safety, subscription/medication claims, and support links | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
| Official product site | https://www.noom.com/ | Behavior change, food logging, coaching, medication, movement, and subscription positioning | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
| Official support | https://support.noom.com/ | Account, subscription, billing, coaching, food logging, medication, and technical support | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
| Privacy policy | https://www.noom.com/privacy-policy/ | Health, weight, food, payment, location, advertising, analytics, and sharing disclosures | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
| Terms | https://www.noom.com/terms-and-conditions-of-use/ | Subscription, content, coaching, medication, account, and acceptable-use boundaries | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
...
- Manual blockers must remain launch-blocking until verified: subscription plans, medication eligibility, coaching scope, AI food logging accuracy, body-scan privacy, eating-disorder safety, device sync, ad tracking, and refund/cancellation behavior.

## Core User Journeys

- User creates or restores a Noom-style account, completes consent and eligibility checks, and reaches a privacy-forward dashboard.
...
- Monetization model: use original free/trial/paid/sponsored/benefit entitlement logic; do not copy exact pricing, plan names, bundle names, promotional copy, employer offers, or partner offers from Noom.
...
- Manual verification tests for subscription plans, medication eligibility, coaching scope, AI food logging accuracy, body-scan privacy, eating-disorder safety, device sync, ad tracking, and refund/cancellation behavior.
...
- Phase 4: Add app-specific safety controls for behavior-change onboarding, weight and health goals, food logging with AI/photo/barcode/text, lessons, coaching, step tracking, GLP-1 eligibility gates, body scans, subscriptions, and progress insights.
...
- Confirm legal/privacy retention behavior for Noom-style sensitive records and update API contracts before downstream implementation.
