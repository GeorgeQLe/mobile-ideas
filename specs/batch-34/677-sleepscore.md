...
> - Manual verification blockers: supported phone list, sonar tracking accuracy, subscription restore, doctor-report export, sleep-health claims, microphone/sensor permissions, no-emergency/diagnosis copy, and iOS availability verification.
...
Build an original mobile product inspired by SleepScore's public health and medical workflow. The V1 clone focuses on phone-based sleep tracking, sonar/device compatibility, sleep score, sleep stages, smart alarm, science-backed insights, doctor report, subscriptions, and sleep-improvement programs.
...
- Preserve the functional job behind SleepScore while using original product naming, original UI, original sample data, and licensed integrations.
...
- Do not copy SleepScore branding, logos, screenshots, marketing copy, private APIs, proprietary datasets, plan names, UI trade dress, clinical content, nutrition databases, provider directories, or protected media.
...
|---|---|---|---|
| Apple App Store | Platform blocker: no verified active first-party US App Store listing for SleepScore | iOS parity is blocked until a first-party listing is verified | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
| Google Play | https://play.google.com/store/apps/details?id=com.sleepscore.drive | Android listing, data safety, sonar compatibility, subscription claims, and support links | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
| Official product site | https://www.sleepscore.com/ | Sleep tracking, insights, reports, app compatibility, and science positioning | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
| Official support | https://www.sleepscore.com/help/ | Setup, compatibility, subscriptions, reports, and troubleshooting support | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
| Privacy policy | https://www.sleepscore.com/legal/privacy-policy | Sleep, account, device, sensor, analytics, and sharing disclosures | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
| Terms | https://www.sleepscore.com/legal/sleepscore-terms-of-service | Terms, subscriptions, app use, medical disclaimers, and service boundaries | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
...
- Manual blockers must remain launch-blocking until verified: supported phone list, sonar tracking accuracy, subscription restore, doctor-report export, sleep-health claims, microphone/sensor permissions, no-emergency/diagnosis copy, and iOS availability verification.

## Core User Journeys

- User creates or restores a SleepScore-style account, completes consent and eligibility checks, and reaches a privacy-forward dashboard.
...
- Monetization model: use original free/trial/paid/sponsored/benefit entitlement logic; do not copy exact pricing, plan names, bundle names, promotional copy, employer offers, or partner offers from SleepScore.
...
- Manual verification tests for supported phone list, sonar tracking accuracy, subscription restore, doctor-report export, sleep-health claims, microphone/sensor permissions, no-emergency/diagnosis copy, and iOS availability verification.
...
- Phase 4: Add app-specific safety controls for phone-based sleep tracking, sonar/device compatibility, sleep score, sleep stages, smart alarm, science-backed insights, doctor report, subscriptions, and sleep-improvement programs.
...
- Confirm legal/privacy retention behavior for SleepScore-style sensitive records and update API contracts before downstream implementation.
