...
> - Manual verification blockers: nutrition database accuracy, barcode/photo recognition, subscription restore, weight-loss safety, eating-disorder screening, ad tracking, device sync, community moderation, and data export behavior.
...
Build an original mobile product inspired by Lose It!'s public health and medical workflow. The V1 clone focuses on calorie and macro goals, food barcode/photo/search logging, intermittent fasting, weight trends, exercise sync, recipes, insights, community/challenges, Premium gates, and nutrition-safety disclaimers.
...
- Preserve the functional job behind Lose It! while using original product naming, original UI, original sample data, and licensed integrations.
...
- Do not copy Lose It! branding, logos, screenshots, marketing copy, private APIs, proprietary datasets, plan names, UI trade dress, clinical content, nutrition databases, provider directories, or protected media.
...
|---|---|---|---|
| Apple App Store | https://apps.apple.com/us/app/lose-it-calorie-counter/id297368629 | iOS listing, privacy labels, release notes, in-app purchases, and support links | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
| Google Play | https://play.google.com/store/apps/details?id=com.fitnow.loseit | Android listing, data safety, feature claims, and support links | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
| Official product site | https://www.loseit.com/ | Food logging, weight goals, Premium, integrations, and nutrition tracking positioning | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
| Official support | https://help.loseit.com/ | Account, logging, subscription, devices, billing, privacy, and support docs | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
| Privacy policy | https://www.loseit.com/privacy/ | Health, food, weight, account, advertising, analytics, and sharing disclosures | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
| Terms | https://www.loseit.com/terms/ | Service terms, subscriptions, content, account, community, and acceptable-use boundaries | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
...
- Manual blockers must remain launch-blocking until verified: nutrition database accuracy, barcode/photo recognition, subscription restore, weight-loss safety, eating-disorder screening, ad tracking, device sync, community moderation, and data export behavior.

## Core User Journeys

- User creates or restores a Lose It!-style account, completes consent and eligibility checks, and reaches a privacy-forward dashboard.
...
- Monetization model: use original free/trial/paid/sponsored/benefit entitlement logic; do not copy exact pricing, plan names, bundle names, promotional copy, employer offers, or partner offers from Lose It!.
...
- Manual verification tests for nutrition database accuracy, barcode/photo recognition, subscription restore, weight-loss safety, eating-disorder screening, ad tracking, device sync, community moderation, and data export behavior.
...
- Phase 4: Add app-specific safety controls for calorie and macro goals, food barcode/photo/search logging, intermittent fasting, weight trends, exercise sync, recipes, insights, community/challenges, Premium gates, and nutrition-safety disclaimers.
...
- Confirm legal/privacy retention behavior for Lose It!-style sensitive records and update API contracts before downstream implementation.
