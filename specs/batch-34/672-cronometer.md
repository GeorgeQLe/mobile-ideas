...
> - Manual verification blockers: nutrition database licensing, barcode/food verification, device integrations, Gold entitlement restore, professional nutrition claims, fasting safety, custom biomarkers, and data export/import formats.
...
Build an original mobile product inspired by Cronometer's public health and medical workflow. The V1 clone focuses on verified food database logging, nutrient/micronutrient dashboards, diary groups, fasting timer, recipe importer, macro scheduler, device imports, sleep correlations, and Gold subscription gates.
...
- Preserve the functional job behind Cronometer while using original product naming, original UI, original sample data, and licensed integrations.
...
- Do not copy Cronometer branding, logos, screenshots, marketing copy, private APIs, proprietary datasets, plan names, UI trade dress, clinical content, nutrition databases, provider directories, or protected media.
...
|---|---|---|---|
| Apple App Store | https://apps.apple.com/us/app/cronometer-calorie-counter/id1145935738 | iOS listing, privacy labels, release notes, subscription claims, and support links | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
| Google Play | https://play.google.com/store/apps/details?id=com.cronometer.android.gold | Android listing, data safety, in-app purchases, and support links | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
| Official product site | https://cronometer.com/ | Nutrition diary, verified foods, integrations, Gold, professional positioning, and feature scope | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
| Official support | https://support.cronometer.com/ | Account, diary, foods, devices, subscriptions, privacy, and support docs | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
| Privacy policy | https://cronometer.com/privacy/ | Nutrition, health, account, device, payment, advertising, and analytics disclosures | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
| Terms | https://cronometer.com/terms/ | Service terms, nutrition content, subscriptions, accounts, and acceptable-use boundaries | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
...
- Manual blockers must remain launch-blocking until verified: nutrition database licensing, barcode/food verification, device integrations, Gold entitlement restore, professional nutrition claims, fasting safety, custom biomarkers, and data export/import formats.

## Core User Journeys

- User creates or restores a Cronometer-style account, completes consent and eligibility checks, and reaches a privacy-forward dashboard.
...
- Monetization model: use original free/trial/paid/sponsored/benefit entitlement logic; do not copy exact pricing, plan names, bundle names, promotional copy, employer offers, or partner offers from Cronometer.
...
- Manual verification tests for nutrition database licensing, barcode/food verification, device integrations, Gold entitlement restore, professional nutrition claims, fasting safety, custom biomarkers, and data export/import formats.
...
- Phase 4: Add app-specific safety controls for verified food database logging, nutrient/micronutrient dashboards, diary groups, fasting timer, recipe importer, macro scheduler, device imports, sleep correlations, and Gold subscription gates.
...
- Confirm legal/privacy retention behavior for Cronometer-style sensitive records and update API contracts before downstream implementation.
