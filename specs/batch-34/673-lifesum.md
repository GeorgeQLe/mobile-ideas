...
> - Manual verification blockers: AI logging accuracy, nutrition database licensing, subscription pricing, diet-plan medical safety, fitness sync, eating-disorder risk, ad tracking, and international legal terms.
...
Build an original mobile product inspired by Lifesum's public health and medical workflow. The V1 clone focuses on AI/photo/voice/text/barcode meal logging, calorie and macro tracking, water and produce goals, meal plans, recipes, Life Score, fitness sync, and Premium nutrition plans.
...
- Preserve the functional job behind Lifesum while using original product naming, original UI, original sample data, and licensed integrations.
...
- Do not copy Lifesum branding, logos, screenshots, marketing copy, private APIs, proprietary datasets, plan names, UI trade dress, clinical content, nutrition databases, provider directories, or protected media.
...
|---|---|---|---|
| Apple App Store | https://apps.apple.com/us/app/lifesum-ai-calorie-counter/id286906691 | iOS listing, privacy labels, release notes, in-app purchases, and support links | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
| Google Play | https://play.google.com/store/apps/details?id=com.sillens.shapeupclub | Android listing, data safety, feature claims, and support links | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
| Official product site | https://lifesum.com/ | Nutrition tracking, meal plans, AI logging, Life Score, recipes, and Premium positioning | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
| Official support | https://support.lifesum.com/ | Account, subscriptions, logging, devices, data, and support docs | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
| Privacy and terms | https://api.lifesum.com/mobile-terms | Mobile terms and privacy disclosures linked from public app listing | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
| Cookie policy | https://lifesum.com/cookie-policy | Tracking, advertising, analytics, and consent disclosures | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
...
- Manual blockers must remain launch-blocking until verified: AI logging accuracy, nutrition database licensing, subscription pricing, diet-plan medical safety, fitness sync, eating-disorder risk, ad tracking, and international legal terms.

## Core User Journeys

- User creates or restores a Lifesum-style account, completes consent and eligibility checks, and reaches a privacy-forward dashboard.
...
- Monetization model: use original free/trial/paid/sponsored/benefit entitlement logic; do not copy exact pricing, plan names, bundle names, promotional copy, employer offers, or partner offers from Lifesum.
...
- Manual verification tests for AI logging accuracy, nutrition database licensing, subscription pricing, diet-plan medical safety, fitness sync, eating-disorder risk, ad tracking, and international legal terms.
...
- Phase 4: Add app-specific safety controls for AI/photo/voice/text/barcode meal logging, calorie and macro tracking, water and produce goals, meal plans, recipes, Life Score, fitness sync, and Premium nutrition plans.
...
- Confirm legal/privacy retention behavior for Lifesum-style sensitive records and update API contracts before downstream implementation.
