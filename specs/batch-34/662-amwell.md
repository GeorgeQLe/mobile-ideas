...
> - Manual verification blockers: state licensure, insurance pricing, provider availability, clinical intake, video reliability, prescribing limits, urgent-care disclaimers, behavioral health eligibility, and support refund outcomes.
...
Build an original mobile product inspired by Amwell's public health and medical workflow. The V1 clone focuses on telehealth registration, visit-type selection, provider matching, scheduled and on-demand visits, intake forms, video waiting room, payments, prescriptions, and post-visit summaries.
...
- Preserve the functional job behind Amwell while using original product naming, original UI, original sample data, and licensed integrations.
...
- Do not copy Amwell branding, logos, screenshots, marketing copy, private APIs, proprietary datasets, plan names, UI trade dress, clinical content, nutrition databases, provider directories, or protected media.
...
|---|---|---|---|
| Apple App Store | https://apps.apple.com/us/app/amwell-doctor-visits-24-7/id655783752 | iOS listing, privacy labels, release notes, category, and support links | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
| Google Play | https://play.google.com/store/apps/details?id=com.americanwell.android.member.amwell | Android listing, data safety, visit claims, pricing claims, and support links | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
| Official product site | https://patients.amwell.com/ | Patient telehealth service scope, visits, insurance, pricing, and care categories | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
| Official support | https://patients.amwell.com/faq/ | Account, visit, payment, insurance, prescription, video, and technical support FAQ | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
| Privacy policy | https://business.amwell.com/privacy-policy/ | Patient, account, visit, payment, analytics, and sharing disclosures | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
| Terms | https://patients.amwell.com/terms-of-use/ | Patient terms, telehealth limits, accounts, content, payment, and service boundaries | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
...
- Manual blockers must remain launch-blocking until verified: state licensure, insurance pricing, provider availability, clinical intake, video reliability, prescribing limits, urgent-care disclaimers, behavioral health eligibility, and support refund outcomes.

## Core User Journeys

- User creates or restores a Amwell-style account, completes consent and eligibility checks, and reaches a privacy-forward dashboard.
...
- Monetization model: use original free/trial/paid/sponsored/benefit entitlement logic; do not copy exact pricing, plan names, bundle names, promotional copy, employer offers, or partner offers from Amwell.
...
- Manual verification tests for state licensure, insurance pricing, provider availability, clinical intake, video reliability, prescribing limits, urgent-care disclaimers, behavioral health eligibility, and support refund outcomes.
...
- Phase 4: Add app-specific safety controls for telehealth registration, visit-type selection, provider matching, scheduled and on-demand visits, intake forms, video waiting room, payments, prescriptions, and post-visit summaries.
...
- Confirm legal/privacy retention behavior for Amwell-style sensitive records and update API contracts before downstream implementation.
