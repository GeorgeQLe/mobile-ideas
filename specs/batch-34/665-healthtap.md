...
> - Manual verification blockers: medical-provider availability, membership pricing, AI guidance limits, prescription/lab ordering, minor accounts, state licensure, clinical messaging, and emergency disclaimers.
...
Build an original mobile product inspired by HealthTap's public health and medical workflow. The V1 clone focuses on online primary care, AI/symptom guidance boundaries, same-day appointments, dedicated doctor relationships, membership gates, lab/prescription workflows, Q&A content, and care-plan follow-up.
...
- Preserve the functional job behind HealthTap while using original product naming, original UI, original sample data, and licensed integrations.
...
- Do not copy HealthTap branding, logos, screenshots, marketing copy, private APIs, proprietary datasets, plan names, UI trade dress, clinical content, nutrition databases, provider directories, or protected media.
...
|---|---|---|---|
| Apple App Store | https://apps.apple.com/us/app/healthtap-primary-care-doctors/id466079030 | iOS patient listing, privacy labels, release notes, and care claims | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
| Google Play | https://play.google.com/store/apps/details?id=com.healthtap.userhtexpress | Android listing, data safety, membership claims, and support links | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
| Official product site | https://www.healthtap.com/ | Primary care, telehealth, membership, doctor, and health information positioning | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
| Official help | https://support.healthtap.com/ | Account, visits, memberships, billing, prescriptions, and support docs | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
| Privacy policy | https://www.healthtap.com/privacy/ | Health, account, search, provider, analytics, and sharing disclosures | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
| Terms | https://www.healthtap.com/terms/ | Patient terms, medical-service limits, age rules, account, billing, and emergency boundaries | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
...
- Manual blockers must remain launch-blocking until verified: medical-provider availability, membership pricing, AI guidance limits, prescription/lab ordering, minor accounts, state licensure, clinical messaging, and emergency disclaimers.

## Core User Journeys

- User creates or restores a HealthTap-style account, completes consent and eligibility checks, and reaches a privacy-forward dashboard.
...
- Monetization model: use original free/trial/paid/sponsored/benefit entitlement logic; do not copy exact pricing, plan names, bundle names, promotional copy, employer offers, or partner offers from HealthTap.
...
- Manual verification tests for medical-provider availability, membership pricing, AI guidance limits, prescription/lab ordering, minor accounts, state licensure, clinical messaging, and emergency disclaimers.
...
- Phase 4: Add app-specific safety controls for online primary care, AI/symptom guidance boundaries, same-day appointments, dedicated doctor relationships, membership gates, lab/prescription workflows, Q&A content, and care-plan follow-up.
...
- Confirm legal/privacy retention behavior for HealthTap-style sensitive records and update API contracts before downstream implementation.
