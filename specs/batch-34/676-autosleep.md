...
> - Manual verification blockers: Apple Watch hardware, HealthKit sleep-stage access, sensor accuracy, no-data-collection claim, paid App Store purchase, companion apps, alarm behavior through adjacent apps, and no Android parity.
...
Build an original mobile product inspired by AutoSleep's public health and medical workflow. The V1 clone focuses on Apple Watch automatic sleep detection, sleep rings, sleep stages integration, readiness, trends, history, privacy-first local processing, companion watch app, and one-time paid entitlement.
...
- Preserve the functional job behind AutoSleep while using original product naming, original UI, original sample data, and licensed integrations.
...
- Do not copy AutoSleep branding, logos, screenshots, marketing copy, private APIs, proprietary datasets, plan names, UI trade dress, clinical content, nutrition databases, provider directories, or protected media.
...
|---|---|---|---|
| Apple App Store | https://apps.apple.com/us/app/autosleep-watch-sleep-tracker/id1164801111 | iOS listing, privacy labels, purchase model, and feature claims | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
| Google Play | Platform blocker: no verified first-party Google Play listing for AutoSleep Watch Sleep Tracker | Android parity is blocked until a first-party listing is verified | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
| Official product site | https://autosleepapp.tantsissa.com/ | Sleep tracking, Apple Watch, privacy, metrics, and product positioning | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
| Official support | https://autosleepapp.tantsissa.com/support | Setup, Apple Watch, HealthKit, troubleshooting, and support docs | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
| Privacy policy | https://autosleepapp.tantsissa.com/privacy | Privacy, local processing, data collection, HealthKit, and analytics disclosures | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
| Terms | https://autosleepapp.tantsissa.com/terms | Terms, app purchase, support, and service boundaries | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
...
- Manual blockers must remain launch-blocking until verified: Apple Watch hardware, HealthKit sleep-stage access, sensor accuracy, no-data-collection claim, paid App Store purchase, companion apps, alarm behavior through adjacent apps, and no Android parity.

## Core User Journeys

- User creates or restores a AutoSleep-style account, completes consent and eligibility checks, and reaches a privacy-forward dashboard.
...
- Monetization model: use original free/trial/paid/sponsored/benefit entitlement logic; do not copy exact pricing, plan names, bundle names, promotional copy, employer offers, or partner offers from AutoSleep.
...
- Manual verification tests for Apple Watch hardware, HealthKit sleep-stage access, sensor accuracy, no-data-collection claim, paid App Store purchase, companion apps, alarm behavior through adjacent apps, and no Android parity.
...
- Phase 4: Add app-specific safety controls for Apple Watch automatic sleep detection, sleep rings, sleep stages integration, readiness, trends, history, privacy-first local processing, companion watch app, and one-time paid entitlement.
...
- Confirm legal/privacy retention behavior for AutoSleep-style sensitive records and update API contracts before downstream implementation.
