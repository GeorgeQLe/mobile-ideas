...
> - Manual verification blockers: prescription-benefit eligibility, pharmacy account linking, refill authority, mail-order fulfillment, benefit pricing, medication substitutions, member ID verification, notifications, and plan-specific regional availability.
...
Build an original mobile product inspired by Express Scripts's public health and medical workflow. The V1 clone focuses on pharmacy benefit onboarding, prescription dashboard, refill and renew flows, order status, preferred pharmacy lookup, paperless documents, coverage checks, and member-plan eligibility.
...
- Preserve the functional job behind Express Scripts while using original product naming, original UI, original sample data, and licensed integrations.
...
- Do not copy Express Scripts branding, logos, screenshots, marketing copy, private APIs, proprietary datasets, plan names, UI trade dress, clinical content, nutrition databases, provider directories, or protected media.
...
|---|---|---|---|
| Apple App Store | https://apps.apple.com/us/app/express-scripts/id442464896 | iOS listing, privacy labels, release notes, and support/developer links | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
| Google Play | https://play.google.com/store/apps/details?id=com.medco.medcopharmacy | Android listing, data safety, install requirements, release notes, and support links | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
| Official product site | https://www.express-scripts.com/mobile-app | Mobile app feature overview, benefit eligibility, prescriptions, orders, and pharmacy lookup | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
| Official support | https://www.express-scripts.com/frequently-asked-questions | Account, prescription, order, benefit, pharmacy, and paperless-document help | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
| Privacy policy | https://www.express-scripts.com/privacy | Prescription, account, benefit, communication, analytics, and sharing disclosures | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
| Terms | https://www.express-scripts.com/terms-of-use | Website/app terms, account, benefit, content, and service boundaries | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
...
- Manual blockers must remain launch-blocking until verified: prescription-benefit eligibility, pharmacy account linking, refill authority, mail-order fulfillment, benefit pricing, medication substitutions, member ID verification, notifications, and plan-specific regional availability.

## Core User Journeys

- User creates or restores a Express Scripts-style account, completes consent and eligibility checks, and reaches a privacy-forward dashboard.
...
- Monetization model: use original free/trial/paid/sponsored/benefit entitlement logic; do not copy exact pricing, plan names, bundle names, promotional copy, employer offers, or partner offers from Express Scripts.
...
- Manual verification tests for prescription-benefit eligibility, pharmacy account linking, refill authority, mail-order fulfillment, benefit pricing, medication substitutions, member ID verification, notifications, and plan-specific regional availability.
...
- Phase 4: Add app-specific safety controls for pharmacy benefit onboarding, prescription dashboard, refill and renew flows, order status, preferred pharmacy lookup, paperless documents, coverage checks, and member-plan eligibility.
...
- Confirm legal/privacy retention behavior for Express Scripts-style sensitive records and update API contracts before downstream implementation.
