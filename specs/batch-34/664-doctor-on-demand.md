...
> - Manual verification blockers: coverage eligibility, self-pay pricing, clinical intake, mental-health scheduling, prescribing limits, doctor-note issuance, video reliability, pharmacy routing, and support credits/refunds.
...
Build an original mobile product inspired by Doctor On Demand's public health and medical workflow. The V1 clone focuses on Included Health telehealth onboarding, urgent care, therapy, psychiatry, insurance/self-pay pricing, provider selection, video visits, treatment plans, prescriptions, and doctor notes.
...
- Preserve the functional job behind Doctor On Demand while using original product naming, original UI, original sample data, and licensed integrations.
...
- Do not copy Doctor On Demand branding, logos, screenshots, marketing copy, private APIs, proprietary datasets, plan names, UI trade dress, clinical content, nutrition databases, provider directories, or protected media.
...
|---|---|---|---|
| Apple App Store | https://apps.apple.com/us/app/doctor-on-demand/id591981144 | iOS listing, privacy labels, release notes, care categories, and support links | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
| Google Play | https://play.google.com/store/apps/details?id=com.doctorondemand.android.patient | Android listing, data safety, install requirements, and feature claims | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
| Official product site | https://doctorondemand.com/ | Telehealth service overview, urgent care, mental health, insurance, and pricing positioning | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
| Official support | https://support.doctorondemand.com/ | Account, visits, payments, prescriptions, insurance, and technical support docs | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
| Privacy policy | https://www.includedhealth.com/privacy/ | Included Health privacy disclosures for health, account, visit, payment, and analytics data | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
| Terms | https://www.includedhealth.com/terms-of-use/ | Service terms, telehealth limits, account, payment, and clinical boundaries | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
...
- Manual blockers must remain launch-blocking until verified: coverage eligibility, self-pay pricing, clinical intake, mental-health scheduling, prescribing limits, doctor-note issuance, video reliability, pharmacy routing, and support credits/refunds.

## Core User Journeys

- User creates or restores a Doctor On Demand-style account, completes consent and eligibility checks, and reaches a privacy-forward dashboard.
...
- Monetization model: use original free/trial/paid/sponsored/benefit entitlement logic; do not copy exact pricing, plan names, bundle names, promotional copy, employer offers, or partner offers from Doctor On Demand.
...
- Manual verification tests for coverage eligibility, self-pay pricing, clinical intake, mental-health scheduling, prescribing limits, doctor-note issuance, video reliability, pharmacy routing, and support credits/refunds.
...
- Phase 4: Add app-specific safety controls for Included Health telehealth onboarding, urgent care, therapy, psychiatry, insurance/self-pay pricing, provider selection, video visits, treatment plans, prescriptions, and doctor notes.
...
- Confirm legal/privacy retention behavior for Doctor On Demand-style sensitive records and update API contracts before downstream implementation.
