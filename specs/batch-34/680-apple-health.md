...
> - Manual verification blockers: iOS/iPadOS system app behavior, HealthKit entitlements, Apple Watch/device data, medication reminders, health sharing invitations, medical records provider integration, emergency access, and no first-party Android parity.
...
Build an original mobile product inspired by Apple Health's public health and medical workflow. The V1 clone focuses on centralized Health app records, charts, trends, sleep, cycle tracking, medications, mental wellbeing, health sharing, emergency/medical ID, connected devices, third-party app permissions, and privacy controls.
...
- Preserve the functional job behind Apple Health while using original product naming, original UI, original sample data, and licensed integrations.
...
- Do not copy Apple Health branding, logos, screenshots, marketing copy, private APIs, proprietary datasets, plan names, UI trade dress, clinical content, nutrition databases, provider directories, or protected media.
...
|---|---|---|---|
| Apple App Store | https://apps.apple.com/us/app/apple-health/id1242545199 | iOS/iPadOS listing, privacy labels, feature overview, and compatibility | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
| Google Play | Platform blocker: no first-party Google Play listing for Apple Health | Android parity is blocked because Apple Health is an Apple platform app | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
| Official product site | https://www.apple.com/ios/health/ | Health app features, privacy positioning, sharing, records, medications, and Apple Watch/device scope | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
| Official support | https://support.apple.com/guide/iphone/health-iphc5e5aeea3/ios | Health app setup, data, sharing, sources, records, and permissions docs | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
| Privacy policy | https://www.apple.com/legal/privacy/en-ww/ | Apple privacy disclosures for health, device, account, analytics, and sharing | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
| Terms | https://www.apple.com/legal/internet-services/terms/site.html | Apple site/service terms and legal boundaries | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
...
- Manual blockers must remain launch-blocking until verified: iOS/iPadOS system app behavior, HealthKit entitlements, Apple Watch/device data, medication reminders, health sharing invitations, medical records provider integration, emergency access, and no first-party Android parity.

## Core User Journeys

- User creates or restores a Apple Health-style account, completes consent and eligibility checks, and reaches a privacy-forward dashboard.
...
- Monetization model: use original free/trial/paid/sponsored/benefit entitlement logic; do not copy exact pricing, plan names, bundle names, promotional copy, employer offers, or partner offers from Apple Health.
...
- Manual verification tests for iOS/iPadOS system app behavior, HealthKit entitlements, Apple Watch/device data, medication reminders, health sharing invitations, medical records provider integration, emergency access, and no first-party Android parity.
...
- Phase 4: Add app-specific safety controls for centralized Health app records, charts, trends, sleep, cycle tracking, medications, mental wellbeing, health sharing, emergency/medical ID, connected devices, third-party app permissions, and privacy controls.
...
- Confirm legal/privacy retention behavior for Apple Health-style sensitive records and update API contracts before downstream implementation.
