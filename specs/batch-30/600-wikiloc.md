# Wikiloc-Style Clone Spec

> Metadata
> - Inspiration app: Wikiloc
...
> - Manual verification blockers: GPS accuracy, user-generated route moderation, offline navigation limits, premium entitlements, photo/waypoint uploads, smartwatch/GPS transfer, background location, safety disclaimers, and country availability require lawful test evidence before one-for-one native parity claims.
> - Legal scope: functional parity only; use original code, brand, copy, iconography, sample data, media, policies, and integrations.

## Overview

Build an original mobile product inspired by Wikiloc's public user-facing workflow. The clone focus is trail search, route recording, waypoint/photo upload, offline navigation, GPS/smartwatch transfer, premium features, community sharing, environmental contribution messaging, and location privacy. This public-source V1 spec is implementation-ready for an original build, but every behavior marked `Manual verification required` must remain behind a documented blocker until lawful hands-on evidence confirms the exact native behavior.

## Goals

- Deliver a mobile-first experience centered on map, route, waypoint, recording, or offline-navigation session.
...
- Do not copy Wikiloc branding, logos, screenshots, marketing copy, private APIs, proprietary datasets, ranking systems, route algorithms, vehicle integrations, or protected media.
...
|---|---|---|---|
| Apple App Store listing | https://apps.apple.com/us/app/wikiloc-outdoor-navigation-gps/id432102730 | iOS listing, category, age rating, privacy labels, release notes, support links | Public source verified |
| Google Play listing | https://play.google.com/store/apps/details?id=com.wikiloc.wikilocandroid | Android listing, content rating, data safety, feature blurbs, update cadence | Public source verified |
| Official product site | https://www.wikiloc.com/mobile | Public product orientation for trail search, route recording, waypoint/photo upload, offline navigation, GPS/smartwatch transfer, premium features, community sharing, environmental contribution messaging, and location privacy | Public source verified |
| Help/support center | https://help.wikiloc.com/ | Support taxonomy, account, payment, cancellation, session, safety, dispute, and recovery flows | Public source verified |
| Privacy policy | https://www.wikiloc.com/wikiloc/privacy.do | Personal data, location, payment, analytics, retention, export, deletion, and regional privacy rights | Public source verified |
| Terms/legal terms | https://www.wikiloc.com/wikiloc/terms.do | Eligibility, acceptable use, payment terms, cancellation, liability, content, and regional service constraints | Public source verified |

## Detailed Design

- Source-backed requirement: the app must provide a mobile home surface that launches directly into map, route, waypoint, recording, or offline-navigation session.
...
- Manual verification required: GPS accuracy, user-generated route moderation, offline navigation limits, premium entitlements, photo/waypoint uploads, smartwatch/GPS transfer, background location, safety disclaimers, and country availability.
...
- Safety requirement: precise location, route history, offline map regions, public/private land boundaries, and shared tracks data must be minimized, scoped, retained only as needed, and deleted/exported under user privacy requests unless retention is legally required.
...
- User starts map, route, waypoint, recording, or offline-navigation session, sees all important terms or warnings, and can cancel before irreversible commitment.
...
| Map Home | Core discovery and decision flow | taps, forms, filters, map gestures, deep links, permissions | empty, loading, loaded, signed-out, saved, unavailable | denied permission, stale inventory, offline, region-locked, provider error, blocked entitlement |
| Search/Discover | Core discovery and decision flow | taps, forms, filters, map gestures, deep links, permissions | empty, loading, loaded, signed-out, saved, unavailable | denied permission, stale inventory, offline, region-locked, provider error, blocked entitlement |
...
| Planner | Transaction, live state, or management flow | taps, forms, filters, map gestures, deep links, permissions | empty, loading, loaded, signed-out, saved, unavailable | denied permission, stale inventory, offline, region-locked, provider error, blocked entitlement |
| Offline Downloads | Transaction, live state, or management flow | taps, forms, filters, map gestures, deep links, permissions | empty, loading, loaded, signed-out, saved, unavailable | denied permission, stale inventory, offline, region-locked, provider error, blocked entitlement |
| Recorder | Transaction, live state, or management flow | taps, forms, filters, map gestures, deep links, permissions | empty, loading, loaded, signed-out, saved, unavailable | denied permission, stale inventory, offline, region-locked, provider error, blocked entitlement |
| Saved Items | Trust, account, recovery, or support flow | taps, forms, filters, map gestures, deep links, permissions | empty, loading, loaded, signed-out, saved, unavailable | denied permission, stale inventory, offline, region-locked, provider error, blocked entitlement |
| Sharing | Trust, account, recovery, or support flow | taps, forms, filters, map gestures, deep links, permissions | empty, loading, loaded, signed-out, saved, unavailable | denied permission, stale inventory, offline, region-locked, provider error, blocked entitlement |
...
- `ExplorerAccount`: stores lifecycle state, ownership, source provenance, authorization rules, sync status, deletion/export treatment, and audit metadata for Wikiloc-style workflows.
- `MapLayer`: stores lifecycle state, ownership, source provenance, authorization rules, sync status, deletion/export treatment, and audit metadata for Wikiloc-style workflows.
- `TrailOrRoute`: stores lifecycle state, ownership, source provenance, authorization rules, sync status, deletion/export treatment, and audit metadata for Wikiloc-style workflows.
- `Waypoint`: stores lifecycle state, ownership, source provenance, authorization rules, sync status, deletion/export treatment, and audit metadata for Wikiloc-style workflows.
- `OfflineRegion`: stores lifecycle state, ownership, source provenance, authorization rules, sync status, deletion/export treatment, and audit metadata for Wikiloc-style workflows.
- `TrackRecording`: stores lifecycle state, ownership, source provenance, authorization rules, sync status, deletion/export treatment, and audit metadata for Wikiloc-style workflows.
- `SubscriptionEntitlement`: stores lifecycle state, ownership, source provenance, authorization rules, sync status, deletion/export treatment, and audit metadata for Wikiloc-style workflows.
- `SharedRoute`: stores lifecycle state, ownership, source provenance, authorization rules, sync status, deletion/export treatment, and audit metadata for Wikiloc-style workflows.
- `SafetyNotice`: stores lifecycle state, ownership, source provenance, authorization rules, sync status, deletion/export treatment, and audit metadata for Wikiloc-style workflows.
- `SupportCase`: stores lifecycle state, ownership, source provenance, authorization rules, sync status, deletion/export treatment, and audit metadata for Wikiloc-style workflows.
...
- Treat precise location, route history, offline map regions, public/private land boundaries, and shared tracks as a launch-blocking privacy review area with owner, mitigation, retention policy, and acceptance tests.
...
- Manual verification checklist tests for GPS accuracy, user-generated route moderation, offline navigation limits, premium entitlements, photo/waypoint uploads, smartwatch/GPS transfer, background location, safety disclaimers, and country availability.
...
- A returning user can complete map, route, waypoint, recording, or offline-navigation session, recover from a network failure, and confirm canonical server state after reconnect.
...
- What retention periods apply to precise location, route history, offline map regions, public/private land boundaries, and shared tracks, support cases, receipts, and audit records in each launch region?
...
- Phase 7: Conduct lawful hands-on verification for GPS accuracy, user-generated route moderation, offline navigation limits, premium entitlements, photo/waypoint uploads, smartwatch/GPS transfer, background location, safety disclaimers, and country availability, then update this spec with evidence before any one-for-one parity claim.
