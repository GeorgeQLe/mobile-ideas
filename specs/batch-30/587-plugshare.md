# PlugShare-Style Clone Spec

> Metadata
> - Inspiration app: PlugShare
...
> - Manual verification blockers: live charger availability, community moderation, network handoff, payment/session start, review/photo abuse, charging-network coverage, vehicle compatibility, and regional availability require lawful test evidence before one-for-one native parity claims.
> - Legal scope: functional parity only; use original code, brand, copy, iconography, sample data, media, policies, and integrations.

## Overview

Build an original mobile product inspired by PlugShare's public user-facing workflow. The clone focus is EV charger map discovery, plug/speed/network filters, station detail, driver reviews/photos, favorites, route planning, check-ins, and location privacy. This public-source V1 spec is implementation-ready for an original build, but every behavior marked `Manual verification required` must remain behind a documented blocker until lawful hands-on evidence confirms the exact native behavior.
...
- Do not copy PlugShare branding, logos, screenshots, marketing copy, private APIs, proprietary datasets, ranking systems, route algorithms, vehicle integrations, or protected media.
...
|---|---|---|---|
| Apple App Store listing | https://apps.apple.com/us/app/plugshare/id421788217 | iOS listing, category, age rating, privacy labels, release notes, support links | Public source verified |
| Google Play listing | https://play.google.com/store/apps/details?id=com.xatori.Plugshare | Android listing, content rating, data safety, feature blurbs, update cadence | Public source verified |
| Official product site | https://www.plugshare.com/ | Public product orientation for EV charger map discovery, plug/speed/network filters, station detail, driver reviews/photos, favorites, route planning, check-ins, and location privacy | Public source verified |
| Help/support center | https://help.plugshare.com/ | Support taxonomy, account, payment, cancellation, session, safety, dispute, and recovery flows | Public source verified |
| Privacy policy | https://www.plugshare.com/privacy | Personal data, location, payment, analytics, retention, export, deletion, and regional privacy rights | Public source verified |
| Terms/legal terms | https://www.plugshare.com/terms | Eligibility, acceptable use, payment terms, cancellation, liability, content, and regional service constraints | Public source verified |
...
- Manual verification required: live charger availability, community moderation, network handoff, payment/session start, review/photo abuse, charging-network coverage, vehicle compatibility, and regional availability.
...
- `DriverAccount`: stores lifecycle state, ownership, source provenance, authorization rules, sync status, deletion/export treatment, and audit metadata for PlugShare-style workflows.
- `ChargingStation`: stores lifecycle state, ownership, source provenance, authorization rules, sync status, deletion/export treatment, and audit metadata for PlugShare-style workflows.
- `Connector`: stores lifecycle state, ownership, source provenance, authorization rules, sync status, deletion/export treatment, and audit metadata for PlugShare-style workflows.
- `StationAvailability`: stores lifecycle state, ownership, source provenance, authorization rules, sync status, deletion/export treatment, and audit metadata for PlugShare-style workflows.
- `ChargingSession`: stores lifecycle state, ownership, source provenance, authorization rules, sync status, deletion/export treatment, and audit metadata for PlugShare-style workflows.
- `PaymentMethod`: stores lifecycle state, ownership, source provenance, authorization rules, sync status, deletion/export treatment, and audit metadata for PlugShare-style workflows.
- `Membership`: stores lifecycle state, ownership, source provenance, authorization rules, sync status, deletion/export treatment, and audit metadata for PlugShare-style workflows.
- `Receipt`: stores lifecycle state, ownership, source provenance, authorization rules, sync status, deletion/export treatment, and audit metadata for PlugShare-style workflows.
- `NotificationPreference`: stores lifecycle state, ownership, source provenance, authorization rules, sync status, deletion/export treatment, and audit metadata for PlugShare-style workflows.
- `SupportCase`: stores lifecycle state, ownership, source provenance, authorization rules, sync status, deletion/export treatment, and audit metadata for PlugShare-style workflows.
...
- Manual verification checklist tests for live charger availability, community moderation, network handoff, payment/session start, review/photo abuse, charging-network coverage, vehicle compatibility, and regional availability.
...
- Phase 7: Conduct lawful hands-on verification for live charger availability, community moderation, network handoff, payment/session start, review/photo abuse, charging-network coverage, vehicle compatibility, and regional availability, then update this spec with evidence before any one-for-one parity claim.
