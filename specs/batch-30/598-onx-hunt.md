# onX Hunt-Style Clone Spec

> Metadata
> - Inspiration app: onX Hunt
...
> - Manual verification blockers: landowner/property data licensing, hunting-unit/regulation accuracy, offline map limits, subscription entitlements, trail camera integrations, background location, safety/legal disclaimers, and US state availability require lawful test evidence before one-for-one native parity claims.
> - Legal scope: functional parity only; use original code, brand, copy, iconography, sample data, media, policies, and integrations.

## Overview

Build an original mobile product inspired by onX Hunt's public user-facing workflow. The clone focus is property boundary maps, public/private land layers, hunting units, topo/satellite basemaps, waypoints, offline maps, weather/wind, trail camera data, subscriptions, and location privacy. This public-source V1 spec is implementation-ready for an original build, but every behavior marked `Manual verification required` must remain behind a documented blocker until lawful hands-on evidence confirms the exact native behavior.
...
- Do not copy onX Hunt branding, logos, screenshots, marketing copy, private APIs, proprietary datasets, ranking systems, route algorithms, vehicle integrations, or protected media.
...
|---|---|---|---|
| Apple App Store listing | https://apps.apple.com/us/app/onx-hunt-gps-hunting-maps/id672902340 | iOS listing, category, age rating, privacy labels, release notes, support links | Public source verified |
| Google Play listing | https://play.google.com/store/apps/details?id=onxmaps.hunt | Android listing, content rating, data safety, feature blurbs, update cadence | Public source verified |
| Official product site | https://www.onxmaps.com/hunt/app | Public product orientation for property boundary maps, public/private land layers, hunting units, topo/satellite basemaps, waypoints, offline maps, weather/wind, trail camera data, subscriptions, and location privacy | Public source verified |
| Help/support center | https://onxmapssupport.zendesk.com/hc/en-us | Support taxonomy, account, payment, cancellation, session, safety, dispute, and recovery flows | Public source verified |
| Privacy policy | https://www.onxmaps.com/privacy-policy | Personal data, location, payment, analytics, retention, export, deletion, and regional privacy rights | Public source verified |
| Terms/legal terms | https://www.onxmaps.com/tou | Eligibility, acceptable use, payment terms, cancellation, liability, content, and regional service constraints | Public source verified |
...
- Manual verification required: landowner/property data licensing, hunting-unit/regulation accuracy, offline map limits, subscription entitlements, trail camera integrations, background location, safety/legal disclaimers, and US state availability.
...
- `ExplorerAccount`: stores lifecycle state, ownership, source provenance, authorization rules, sync status, deletion/export treatment, and audit metadata for onX Hunt-style workflows.
- `MapLayer`: stores lifecycle state, ownership, source provenance, authorization rules, sync status, deletion/export treatment, and audit metadata for onX Hunt-style workflows.
- `TrailOrRoute`: stores lifecycle state, ownership, source provenance, authorization rules, sync status, deletion/export treatment, and audit metadata for onX Hunt-style workflows.
- `Waypoint`: stores lifecycle state, ownership, source provenance, authorization rules, sync status, deletion/export treatment, and audit metadata for onX Hunt-style workflows.
- `OfflineRegion`: stores lifecycle state, ownership, source provenance, authorization rules, sync status, deletion/export treatment, and audit metadata for onX Hunt-style workflows.
- `TrackRecording`: stores lifecycle state, ownership, source provenance, authorization rules, sync status, deletion/export treatment, and audit metadata for onX Hunt-style workflows.
- `SubscriptionEntitlement`: stores lifecycle state, ownership, source provenance, authorization rules, sync status, deletion/export treatment, and audit metadata for onX Hunt-style workflows.
- `SharedRoute`: stores lifecycle state, ownership, source provenance, authorization rules, sync status, deletion/export treatment, and audit metadata for onX Hunt-style workflows.
- `SafetyNotice`: stores lifecycle state, ownership, source provenance, authorization rules, sync status, deletion/export treatment, and audit metadata for onX Hunt-style workflows.
- `SupportCase`: stores lifecycle state, ownership, source provenance, authorization rules, sync status, deletion/export treatment, and audit metadata for onX Hunt-style workflows.
...
- Manual verification checklist tests for landowner/property data licensing, hunting-unit/regulation accuracy, offline map limits, subscription entitlements, trail camera integrations, background location, safety/legal disclaimers, and US state availability.
...
- Phase 7: Conduct lawful hands-on verification for landowner/property data licensing, hunting-unit/regulation accuracy, offline map limits, subscription entitlements, trail camera integrations, background location, safety/legal disclaimers, and US state availability, then update this spec with evidence before any one-for-one parity claim.
