# Hertz-Style Clone Spec

> Metadata
> - Inspiration app: Hertz
...
> - Manual verification blockers: driver eligibility, Gold Plus Rewards enrollment, counter or skip-the-counter pickup, deposits, damage/incident handling, payment/refund states, roadside assistance, and country availability require lawful test evidence before one-for-one native parity claims.
> - Legal scope: functional parity only; use original code, brand, copy, iconography, sample data, media, policies, and integrations.

## Overview

Build an original mobile product inspired by Hertz's public user-facing workflow. The clone focus is rental location search, vehicle selection, Gold Plus Rewards account flows, reservation management, pickup/return support, roadside assistance, receipts, and location privacy. This public-source V1 spec is implementation-ready for an original build, but every behavior marked `Manual verification required` must remain behind a documented blocker until lawful hands-on evidence confirms the exact native behavior.
...
- Do not copy Hertz branding, logos, screenshots, marketing copy, private APIs, proprietary datasets, ranking systems, route algorithms, vehicle integrations, or protected media.
...
|---|---|---|---|
| Apple App Store listing | https://apps.apple.com/us/app/hertz-rental-car-app/id352698319 | iOS listing, category, age rating, privacy labels, release notes, support links | Public source verified |
| Google Play listing | https://play.google.com/store/apps/details?id=com.hertz | Android listing, content rating, data safety, feature blurbs, update cadence | Public source verified |
| Official product site | https://www.hertz.com/ | Public product orientation for rental location search, vehicle selection, Gold Plus Rewards account flows, reservation management, pickup/return support, roadside assistance, receipts, and location privacy | Public source verified |
| Help/support center | https://www.hertz.com/rentacar/misc/index.jsp?targetPage=contactUsView.jsp | Support taxonomy, account, payment, cancellation, session, safety, dispute, and recovery flows | Public source verified |
| Privacy policy | https://www.hertz.com/rentacar/privacypolicy/index.jsp | Personal data, location, payment, analytics, retention, export, deletion, and regional privacy rights | Public source verified |
| Terms/legal terms | https://www.hertz.com/rentacar/reservation/reviewmodifycancel/templates/rentalTerms.jsp | Eligibility, acceptable use, payment terms, cancellation, liability, content, and regional service constraints | Public source verified |
...
- Manual verification required: driver eligibility, Gold Plus Rewards enrollment, counter or skip-the-counter pickup, deposits, damage/incident handling, payment/refund states, roadside assistance, and country availability.
...
- `RenterAccount`: stores lifecycle state, ownership, source provenance, authorization rules, sync status, deletion/export treatment, and audit metadata for Hertz-style workflows.
- `RentalLocation`: stores lifecycle state, ownership, source provenance, authorization rules, sync status, deletion/export treatment, and audit metadata for Hertz-style workflows.
- `VehicleClass`: stores lifecycle state, ownership, source provenance, authorization rules, sync status, deletion/export treatment, and audit metadata for Hertz-style workflows.
- `Reservation`: stores lifecycle state, ownership, source provenance, authorization rules, sync status, deletion/export treatment, and audit metadata for Hertz-style workflows.
- `DriverEligibility`: stores lifecycle state, ownership, source provenance, authorization rules, sync status, deletion/export treatment, and audit metadata for Hertz-style workflows.
- `PickupReturnState`: stores lifecycle state, ownership, source provenance, authorization rules, sync status, deletion/export treatment, and audit metadata for Hertz-style workflows.
- `PaymentIntent`: stores lifecycle state, ownership, source provenance, authorization rules, sync status, deletion/export treatment, and audit metadata for Hertz-style workflows.
- `Receipt`: stores lifecycle state, ownership, source provenance, authorization rules, sync status, deletion/export treatment, and audit metadata for Hertz-style workflows.
- `RewardAccount`: stores lifecycle state, ownership, source provenance, authorization rules, sync status, deletion/export treatment, and audit metadata for Hertz-style workflows.
- `SupportCase`: stores lifecycle state, ownership, source provenance, authorization rules, sync status, deletion/export treatment, and audit metadata for Hertz-style workflows.
...
- Manual verification checklist tests for driver eligibility, Gold Plus Rewards enrollment, counter or skip-the-counter pickup, deposits, damage/incident handling, payment/refund states, roadside assistance, and country availability.
...
- Phase 7: Conduct lawful hands-on verification for driver eligibility, Gold Plus Rewards enrollment, counter or skip-the-counter pickup, deposits, damage/incident handling, payment/refund states, roadside assistance, and country availability, then update this spec with evidence before any one-for-one parity claim.
