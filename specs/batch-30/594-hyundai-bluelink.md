# Hyundai Bluelink-Style Clone Spec

> Metadata
> - Inspiration app: Hyundai Bluelink
...
> - Manual verification blockers: vehicle pairing, active Bluelink package, remote command reliability, biometrics/PIN behavior, subscription renewal, EV charging controls, valet/location features, safety-critical controls, and regional availability require lawful test evidence before one-for-one native parity claims.
> - Legal scope: functional parity only; use original code, brand, copy, iconography, sample data, media, policies, and integrations.

## Overview

Build an original mobile product inspired by Hyundai Bluelink's public user-facing workflow. The clone focus is MyHyundai/Bluelink account onboarding, remote start/lock/unlock, vehicle status, EV charging, POI send-to-car, service scheduling, roadside/support access, notifications, and privacy controls. This public-source V1 spec is implementation-ready for an original build, but every behavior marked `Manual verification required` must remain behind a documented blocker until lawful hands-on evidence confirms the exact native behavior.
...
- Do not copy Hyundai Bluelink branding, logos, screenshots, marketing copy, private APIs, proprietary datasets, ranking systems, route algorithms, vehicle integrations, or protected media.
...
|---|---|---|---|
| Apple App Store listing | https://apps.apple.com/us/app/myhyundai-with-bluelink/id893514610 | iOS listing, category, age rating, privacy labels, release notes, support links | Public source verified |
| Google Play listing | https://play.google.com/store/apps/details?id=com.stationdm.bluelink | Android listing, content rating, data safety, feature blurbs, update cadence | Public source verified |
| Official product site | https://owners.hyundaiusa.com/us/en/resources/blue-link | Public product orientation for MyHyundai/Bluelink account onboarding, remote start/lock/unlock, vehicle status, EV charging, POI send-to-car, service scheduling, roadside/support access, notifications, and privacy controls | Public source verified |
| Help/support center | https://owners.hyundaiusa.com/us/en/contact-us.html | Support taxonomy, account, payment, cancellation, session, safety, dispute, and recovery flows | Public source verified |
| Privacy policy | https://www.hyundaiusa.com/us/en/privacy-policy | Personal data, location, payment, analytics, retention, export, deletion, and regional privacy rights | Public source verified |
| Terms/legal terms | https://www.hyundaiusa.com/us/en/terms-conditions | Eligibility, acceptable use, payment terms, cancellation, liability, content, and regional service constraints | Public source verified |
...
- Manual verification required: vehicle pairing, active Bluelink package, remote command reliability, biometrics/PIN behavior, subscription renewal, EV charging controls, valet/location features, safety-critical controls, and regional availability.
...
- `OwnerAccount`: stores lifecycle state, ownership, source provenance, authorization rules, sync status, deletion/export treatment, and audit metadata for Hyundai Bluelink-style workflows.
- `Vehicle`: stores lifecycle state, ownership, source provenance, authorization rules, sync status, deletion/export treatment, and audit metadata for Hyundai Bluelink-style workflows.
- `VehiclePairing`: stores lifecycle state, ownership, source provenance, authorization rules, sync status, deletion/export treatment, and audit metadata for Hyundai Bluelink-style workflows.
- `RemoteCommand`: stores lifecycle state, ownership, source provenance, authorization rules, sync status, deletion/export treatment, and audit metadata for Hyundai Bluelink-style workflows.
- `VehicleStatus`: stores lifecycle state, ownership, source provenance, authorization rules, sync status, deletion/export treatment, and audit metadata for Hyundai Bluelink-style workflows.
- `LocationPing`: stores lifecycle state, ownership, source provenance, authorization rules, sync status, deletion/export treatment, and audit metadata for Hyundai Bluelink-style workflows.
- `ServiceAppointment`: stores lifecycle state, ownership, source provenance, authorization rules, sync status, deletion/export treatment, and audit metadata for Hyundai Bluelink-style workflows.
- `ConnectedServiceEntitlement`: stores lifecycle state, ownership, source provenance, authorization rules, sync status, deletion/export treatment, and audit metadata for Hyundai Bluelink-style workflows.
- `NotificationPreference`: stores lifecycle state, ownership, source provenance, authorization rules, sync status, deletion/export treatment, and audit metadata for Hyundai Bluelink-style workflows.
- `SupportCase`: stores lifecycle state, ownership, source provenance, authorization rules, sync status, deletion/export treatment, and audit metadata for Hyundai Bluelink-style workflows.
...
- Manual verification checklist tests for vehicle pairing, active Bluelink package, remote command reliability, biometrics/PIN behavior, subscription renewal, EV charging controls, valet/location features, safety-critical controls, and regional availability.
...
- Phase 7: Conduct lawful hands-on verification for vehicle pairing, active Bluelink package, remote command reliability, biometrics/PIN behavior, subscription renewal, EV charging controls, valet/location features, safety-critical controls, and regional availability, then update this spec with evidence before any one-for-one parity claim.
