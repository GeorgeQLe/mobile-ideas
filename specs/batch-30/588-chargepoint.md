# ChargePoint-Style Clone Spec

> Metadata
> - Inspiration app: ChargePoint
...
> - Manual verification blockers: live station availability, RFID/tap-to-charge, payment authorization, roaming partner handoff, home charger hardware, waitlist correctness, charging interruptions, refunds, and country availability require lawful test evidence before one-for-one native parity claims.
> - Legal scope: functional parity only; use original code, brand, copy, iconography, sample data, media, policies, and integrations.

## Overview

Build an original mobile product inspired by ChargePoint's public user-facing workflow. The clone focus is charging station discovery, real-time availability, roaming partner charging, tap-to-charge/session start, home charger controls, waitlist, charging history, payments, receipts, and location privacy. This public-source V1 spec is implementation-ready for an original build, but every behavior marked `Manual verification required` must remain behind a documented blocker until lawful hands-on evidence confirms the exact native behavior.
...
- Do not copy ChargePoint branding, logos, screenshots, marketing copy, private APIs, proprietary datasets, ranking systems, route algorithms, vehicle integrations, or protected media.
...
|---|---|---|---|
| Apple App Store listing | https://apps.apple.com/us/app/chargepoint/id356866743 | iOS listing, category, age rating, privacy labels, release notes, support links | Public source verified |
| Google Play listing | https://play.google.com/store/apps/details?id=com.coulombtech | Android listing, content rating, data safety, feature blurbs, update cadence | Public source verified |
| Official product site | https://www.chargepoint.com/drivers/mobile/ | Public product orientation for charging station discovery, real-time availability, roaming partner charging, tap-to-charge/session start, home charger controls, waitlist, charging history, payments, receipts, and location privacy | Public source verified |
| Help/support center | https://www.chargepoint.com/support | Support taxonomy, account, payment, cancellation, session, safety, dispute, and recovery flows | Public source verified |
| Privacy policy | https://www.chargepoint.com/privacy_policy | Personal data, location, payment, analytics, retention, export, deletion, and regional privacy rights | Public source verified |
| Terms/legal terms | https://www.chargepoint.com/terms | Eligibility, acceptable use, payment terms, cancellation, liability, content, and regional service constraints | Public source verified |
...
- Manual verification required: live station availability, RFID/tap-to-charge, payment authorization, roaming partner handoff, home charger hardware, waitlist correctness, charging interruptions, refunds, and country availability.
...
- `DriverAccount`: stores lifecycle state, ownership, source provenance, authorization rules, sync status, deletion/export treatment, and audit metadata for ChargePoint-style workflows.
- `ChargingStation`: stores lifecycle state, ownership, source provenance, authorization rules, sync status, deletion/export treatment, and audit metadata for ChargePoint-style workflows.
- `Connector`: stores lifecycle state, ownership, source provenance, authorization rules, sync status, deletion/export treatment, and audit metadata for ChargePoint-style workflows.
- `StationAvailability`: stores lifecycle state, ownership, source provenance, authorization rules, sync status, deletion/export treatment, and audit metadata for ChargePoint-style workflows.
- `ChargingSession`: stores lifecycle state, ownership, source provenance, authorization rules, sync status, deletion/export treatment, and audit metadata for ChargePoint-style workflows.
- `PaymentMethod`: stores lifecycle state, ownership, source provenance, authorization rules, sync status, deletion/export treatment, and audit metadata for ChargePoint-style workflows.
- `Membership`: stores lifecycle state, ownership, source provenance, authorization rules, sync status, deletion/export treatment, and audit metadata for ChargePoint-style workflows.
- `Receipt`: stores lifecycle state, ownership, source provenance, authorization rules, sync status, deletion/export treatment, and audit metadata for ChargePoint-style workflows.
- `NotificationPreference`: stores lifecycle state, ownership, source provenance, authorization rules, sync status, deletion/export treatment, and audit metadata for ChargePoint-style workflows.
- `SupportCase`: stores lifecycle state, ownership, source provenance, authorization rules, sync status, deletion/export treatment, and audit metadata for ChargePoint-style workflows.
...
- Manual verification checklist tests for live station availability, RFID/tap-to-charge, payment authorization, roaming partner handoff, home charger hardware, waitlist correctness, charging interruptions, refunds, and country availability.
...
- Phase 7: Conduct lawful hands-on verification for live station availability, RFID/tap-to-charge, payment authorization, roaming partner handoff, home charger hardware, waitlist correctness, charging interruptions, refunds, and country availability, then update this spec with evidence before any one-for-one parity claim.
