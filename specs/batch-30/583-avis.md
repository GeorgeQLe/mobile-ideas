# Avis-Style Clone Spec

> Metadata
> - Inspiration app: Avis
...
> - Manual verification blockers: driver eligibility, Avis Preferred status, counter pickup, deposits, damage/incident handling, payment/refund states, roadside assistance, and country availability require lawful test evidence before one-for-one native parity claims.
> - Legal scope: functional parity only; use original code, brand, copy, iconography, sample data, media, policies, and integrations.

## Overview

Build an original mobile product inspired by Avis's public user-facing workflow. The clone focus is rental location search, vehicle class comparison, Avis Preferred account flows, reservation management, pickup/return support, roadside assistance, receipts, and location privacy. This public-source V1 spec is implementation-ready for an original build, but every behavior marked `Manual verification required` must remain behind a documented blocker until lawful hands-on evidence confirms the exact native behavior.
...
- Do not copy Avis branding, logos, screenshots, marketing copy, private APIs, proprietary datasets, ranking systems, route algorithms, vehicle integrations, or protected media.
...
|---|---|---|---|
| Apple App Store listing | https://apps.apple.com/us/app/avis-car-rental/id308342527 | iOS listing, category, age rating, privacy labels, release notes, support links | Public source verified |
| Google Play listing | https://play.google.com/store/apps/details?id=com.avis.androidapp | Android listing, content rating, data safety, feature blurbs, update cadence | Public source verified |
| Official product site | https://www.avis.com/ | Public product orientation for rental location search, vehicle class comparison, Avis Preferred account flows, reservation management, pickup/return support, roadside assistance, receipts, and location privacy | Public source verified |
| Help/support center | https://www.avis.com/en/customer-service | Support taxonomy, account, payment, cancellation, session, safety, dispute, and recovery flows | Public source verified |
| Privacy policy | https://www.avis.com/en/privacy | Personal data, location, payment, analytics, retention, export, deletion, and regional privacy rights | Public source verified |
| Terms/legal terms | https://www.avis.com/en/legal-documents/rental-terms | Eligibility, acceptable use, payment terms, cancellation, liability, content, and regional service constraints | Public source verified |
...
- Manual verification required: driver eligibility, Avis Preferred status, counter pickup, deposits, damage/incident handling, payment/refund states, roadside assistance, and country availability.
...
- `RenterAccount`: stores lifecycle state, ownership, source provenance, authorization rules, sync status, deletion/export treatment, and audit metadata for Avis-style workflows.
- `RentalLocation`: stores lifecycle state, ownership, source provenance, authorization rules, sync status, deletion/export treatment, and audit metadata for Avis-style workflows.
- `VehicleClass`: stores lifecycle state, ownership, source provenance, authorization rules, sync status, deletion/export treatment, and audit metadata for Avis-style workflows.
- `Reservation`: stores lifecycle state, ownership, source provenance, authorization rules, sync status, deletion/export treatment, and audit metadata for Avis-style workflows.
- `DriverEligibility`: stores lifecycle state, ownership, source provenance, authorization rules, sync status, deletion/export treatment, and audit metadata for Avis-style workflows.
- `PickupReturnState`: stores lifecycle state, ownership, source provenance, authorization rules, sync status, deletion/export treatment, and audit metadata for Avis-style workflows.
- `PaymentIntent`: stores lifecycle state, ownership, source provenance, authorization rules, sync status, deletion/export treatment, and audit metadata for Avis-style workflows.
- `Receipt`: stores lifecycle state, ownership, source provenance, authorization rules, sync status, deletion/export treatment, and audit metadata for Avis-style workflows.
- `RewardAccount`: stores lifecycle state, ownership, source provenance, authorization rules, sync status, deletion/export treatment, and audit metadata for Avis-style workflows.
- `SupportCase`: stores lifecycle state, ownership, source provenance, authorization rules, sync status, deletion/export treatment, and audit metadata for Avis-style workflows.
...
- Manual verification checklist tests for driver eligibility, Avis Preferred status, counter pickup, deposits, damage/incident handling, payment/refund states, roadside assistance, and country availability.
...
- Phase 7: Conduct lawful hands-on verification for driver eligibility, Avis Preferred status, counter pickup, deposits, damage/incident handling, payment/refund states, roadside assistance, and country availability, then update this spec with evidence before any one-for-one parity claim.
