# Spark Mail-Style Clone Spec

> Metadata
> - Inspiration app: Spark Mail
...
> - Manual verification blockers: Spark/Readdle account and email account linking (Gmail OAuth, Outlook OAuth, iCloud app-specific password, Yahoo, IMAP/SMTP), Smart Inbox auto-categorization algorithm accuracy (Personal, Notifications, Newsletters), priority email detection and smart notification logic, team collaboration (shared drafts, email delegation, private comments) and team workspace management, email scheduling and timed send delivery, snooze scheduling and return-to-inbox timing, quick reply suggestions and smart template generation, natural language search query processing, unified inbox multi-account sync and folder mapping, email signature editor with rich formatting, swipe action customization per account, pin and block sender management, Spark +AI email writing assistance and summarization (LLM integration, data handling), Spark Premium subscription entitlement and team billing, push notification smart filtering (only notify for important email), end-to-end encryption for team features, data handling for email content (Readdle server processing vs on-device), GDPR compliance and data processing transparency, and Spark/Readdle account integration.
...
Build an original mobile product inspired by Spark Mail's public communication workflow. The V1 clone focuses on smart email client with Smart Inbox that auto-categorizes email into Personal, Notifications, and Newsletters sections, priority email detection and smart notifications, team collaboration features (shared drafts, email delegation, private team comments on emails), email scheduling and send later, snooze emails to return at a specific time, quick replies and smart templates, natural language search, unified inbox for multiple accounts (Gmail, Outlook, iCloud, Yahoo, IMAP), email signatures with rich formatting, swipe customization, pin and block sender, Spark +AI for email writing assistance and summarization, Spark Premium subscription for team features and advanced AI, push notifications with smart notification filtering, and freemium model with Spark Premium for teams and advanced features.
...
- Preserve the functional job behind Spark Mail while using original product naming, original UI, original sample data, and licensed integrations.
...
- Do not copy Spark Mail branding, logos, screenshots, marketing copy, private APIs, proprietary datasets, plan names, UI trade dress, course libraries, textbook solutions, documents, school content, AI prompts, or protected media.
...
|---|---|---|---|
| Apple App Store | https://apps.apple.com/us/app/spark-email-app-by-readdle/id997102246 | iOS listing, privacy labels, release notes, smart email/team claims, and support links | Verified public URL or explicit platform blocker on 2026-05-06; hands-on native behavior still blocked. |
| Google Play | https://play.google.com/store/apps/details?id=com.readdle.spark | Android listing, data safety, smart inbox/team email claims, and release cadence | Verified public URL or explicit platform blocker on 2026-05-06; hands-on native behavior still blocked. |
| Official product site | https://sparkmailapp.com/ | Spark Mail smart inbox, team email, AI features, and product positioning | Verified public URL or explicit platform blocker on 2026-05-06; hands-on native behavior still blocked. |
| Official help | https://sparkmailapp.com/help | Spark Mail app help, setup, team features, and troubleshooting | Verified public URL or explicit platform blocker on 2026-05-06; hands-on native behavior still blocked. |
| Privacy policy | https://sparkmailapp.com/privacy | Spark/Readdle data collection, email processing, and privacy disclosures | Verified public URL or explicit platform blocker on 2026-05-06; hands-on native behavior still blocked. |
| Terms | https://sparkmailapp.com/terms | Spark/Readdle services, email terms, and acceptable-use boundaries | Verified public URL or explicit platform blocker on 2026-05-06; hands-on native behavior still blocked. |
...
- Manual blockers must remain launch-blocking until verified: Spark/Readdle account and email account linking (Gmail OAuth, Outlook OAuth, iCloud app-specific password, Yahoo, IMAP/SMTP), Smart Inbox auto-categorization algorithm accuracy (Personal, Notifications, Newsletters), priority email detection and smart notification logic, team collaboration (shared drafts, email delegation, private comments) and team workspace management, email scheduling and timed send delivery, snooze scheduling and return-to-inbox timing, quick reply suggestions and smart template generation, natural language search query processing, unified inbox multi-account sync and folder mapping, email signature editor with rich formatting, swipe action customization per account, pin and block sender management, Spark +AI email writing assistance and summarization (LLM integration, data handling), Spark Premium subscription entitlement and team billing, push notification smart filtering (only notify for important email), end-to-end encryption for team features, data handling for email content (Readdle server processing vs on-device), GDPR compliance and data processing transparency, and Spark/Readdle account integration.

## Core User Journeys

- User creates or restores a Spark Mail-style account, completes role, school, subscription, or tenant checks, and reaches the dashboard.
...
- Monetization model: use original free/trial/paid/sponsored/school/provider/tenant entitlement logic; do not copy exact pricing, plan names, bundle names, promotional copy, school contracts, tenant offers, or partner offers from Spark Mail.
...
- Manual verification tests for Spark/Readdle account and email account linking (Gmail OAuth, Outlook OAuth, iCloud app-specific password, Yahoo, IMAP/SMTP), Smart Inbox auto-categorization algorithm accuracy (Personal, Notifications, Newsletters), priority email detection and smart notification logic, team collaboration (shared drafts, email delegation, private comments) and team workspace management, email scheduling and timed send delivery, snooze scheduling and return-to-inbox timing, quick reply suggestions and smart template generation, natural language search query processing, unified inbox multi-account sync and folder mapping, email signature editor with rich formatting, swipe action customization per account, pin and block sender management, Spark +AI email writing assistance and summarization (LLM integration, data handling), Spark Premium subscription entitlement and team billing, push notification smart filtering (only notify for important email), end-to-end encryption for team features, data handling for email content (Readdle server processing vs on-device), GDPR compliance and data processing transparency, and Spark/Readdle account integration.
...
- Phase 4: Add app-specific safety controls for smart email client with Smart Inbox that auto-categorizes email into Personal, Notifications, and Newsletters sections, priority email detection and smart notifications, team collaboration features (shared drafts, email delegation, private team comments on emails), email scheduling and send later, snooze emails to return at a specific time, quick replies and smart templates, natural language search, unified inbox for multiple accounts (Gmail, Outlook, iCloud, Yahoo, IMAP), email signatures with rich formatting, swipe customization, pin and block sender, Spark +AI for email writing assistance and summarization, Spark Premium subscription for team features and advanced AI, push notifications with smart notification filtering, and freemium model with Spark Premium for teams and advanced features.
...
- Confirm legal/privacy retention behavior for Spark Mail-style sensitive records and update API contracts before downstream implementation.
