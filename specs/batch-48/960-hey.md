...
> - Manual verification blockers: HEY/Basecamp account creation and paid subscription activation (no free tier), Imbox/Feed/Paper Trail three-section inbox paradigm (routing logic, initial setup, re-categorization), The Screener first-time sender approval and screening flow, Set Aside and Reply Later triage mechanics and reminder timing, Focus & Reply distraction-free email processing UX, email bundling algorithm and bundle management, Clips feature (saving highlighted portions of emails), spy tracker and read receipt blocking implementation (pixel stripping, link rewriting), custom domain support with HEY for Work provisioning, HEY World email-to-blog publishing feature, no folders/labels opinionated design (search-first philosophy), no badge count on app icon (intentional design choice), rich text compose and attachment handling, natural language search processing, HEY for Families shared domain and family account management, email forwarding and HEY address assignment, push notification delivery (without content preview by design), two-factor authentication, import/export and migration tools, and HEY/Basecamp account integration.
...
Build an original mobile product inspired by HEY's public communication workflow. The V1 clone focuses on opinionated email service by Basecamp with unique Imbox/Feed/Paper Trail inbox paradigm (Imbox for important email, The Feed for newsletters and subscriptions, Paper Trail for receipts and transactional), The Screener for first-time sender approval (screen out unknown senders), Set Aside and Reply Later for email triage, Focus & Reply for distraction-free email processing, bundling related emails together, Clips for saving important parts of emails, email privacy protection (blocks spy trackers and read receipts), custom domain support with HEY for Work, HEY World for email-based blogging, rich text compose with attachments, search with natural language, push notifications (with no badge count by design), no folders or labels (opinionated design), and paid-only model with HEY for personal, HEY for Work, and HEY for Families plans (no free tier).
...
- Preserve the functional job behind HEY while using original product naming, original UI, original sample data, and licensed integrations.
...
- Do not copy HEY branding, logos, screenshots, marketing copy, private APIs, proprietary datasets, plan names, UI trade dress, course libraries, textbook solutions, documents, school content, AI prompts, or protected media.
...
|---|---|---|---|
| Apple App Store | https://apps.apple.com/us/app/hey-email/id1506603805 | iOS listing, privacy labels, release notes, email/privacy claims, and support links | Verified public URL or explicit platform blocker on 2026-05-06; hands-on native behavior still blocked. |
| Google Play | https://play.google.com/store/apps/details?id=com.basecamp.hey | Android listing, data safety, opinionated email claims, and release cadence | Verified public URL or explicit platform blocker on 2026-05-06; hands-on native behavior still blocked. |
| Official product site | https://www.hey.com/ | HEY email, Imbox, Feed, Paper Trail, Screener, and product positioning | Verified public URL or explicit platform blocker on 2026-05-06; hands-on native behavior still blocked. |
| Official help | https://www.hey.com/support/ | HEY app help, email setup, and troubleshooting | Verified public URL or explicit platform blocker on 2026-05-06; hands-on native behavior still blocked. |
| Privacy policy | https://basecamp.com/about/policies/privacy | Basecamp/HEY data collection, tracker blocking, and privacy disclosures | Verified public URL or explicit platform blocker on 2026-05-06; hands-on native behavior still blocked. |
| Terms | https://basecamp.com/about/policies/terms | Basecamp/HEY services, email terms, and acceptable-use boundaries | Verified public URL or explicit platform blocker on 2026-05-06; hands-on native behavior still blocked. |
...
- Manual blockers must remain launch-blocking until verified: HEY/Basecamp account creation and paid subscription activation (no free tier), Imbox/Feed/Paper Trail three-section inbox paradigm (routing logic, initial setup, re-categorization), The Screener first-time sender approval and screening flow, Set Aside and Reply Later triage mechanics and reminder timing, Focus & Reply distraction-free email processing UX, email bundling algorithm and bundle management, Clips feature (saving highlighted portions of emails), spy tracker and read receipt blocking implementation (pixel stripping, link rewriting), custom domain support with HEY for Work provisioning, HEY World email-to-blog publishing feature, no folders/labels opinionated design (search-first philosophy), no badge count on app icon (intentional design choice), rich text compose and attachment handling, natural language search processing, HEY for Families shared domain and family account management, email forwarding and HEY address assignment, push notification delivery (without content preview by design), two-factor authentication, import/export and migration tools, and HEY/Basecamp account integration.

## Core User Journeys

- User creates or restores a HEY-style account, completes role, school, subscription, or tenant checks, and reaches the dashboard.
...
- Monetization model: use original free/trial/paid/sponsored/school/provider/tenant entitlement logic; do not copy exact pricing, plan names, bundle names, promotional copy, school contracts, tenant offers, or partner offers from HEY.
...
- Manual verification tests for HEY/Basecamp account creation and paid subscription activation (no free tier), Imbox/Feed/Paper Trail three-section inbox paradigm (routing logic, initial setup, re-categorization), The Screener first-time sender approval and screening flow, Set Aside and Reply Later triage mechanics and reminder timing, Focus & Reply distraction-free email processing UX, email bundling algorithm and bundle management, Clips feature (saving highlighted portions of emails), spy tracker and read receipt blocking implementation (pixel stripping, link rewriting), custom domain support with HEY for Work provisioning, HEY World email-to-blog publishing feature, no folders/labels opinionated design (search-first philosophy), no badge count on app icon (intentional design choice), rich text compose and attachment handling, natural language search processing, HEY for Families shared domain and family account management, email forwarding and HEY address assignment, push notification delivery (without content preview by design), two-factor authentication, import/export and migration tools, and HEY/Basecamp account integration.
...
- Phase 4: Add app-specific safety controls for opinionated email service by Basecamp with unique Imbox/Feed/Paper Trail inbox paradigm (Imbox for important email, The Feed for newsletters and subscriptions, Paper Trail for receipts and transactional), The Screener for first-time sender approval (screen out unknown senders), Set Aside and Reply Later for email triage, Focus & Reply for distraction-free email processing, bundling related emails together, Clips for saving important parts of emails, email privacy protection (blocks spy trackers and read receipts), custom domain support with HEY for Work, HEY World for email-based blogging, rich text compose with attachments, search with natural language, push notifications (with no badge count by design), no folders or labels (opinionated design), and paid-only model with HEY for personal, HEY for Work, and HEY for Families plans (no free tier).
...
- Confirm legal/privacy retention behavior for HEY-style sensitive records and update API contracts before downstream implementation.
