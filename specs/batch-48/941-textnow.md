# TextNow-Style Clone Spec

> Metadata
> - Inspiration app: TextNow
...
> - Manual verification blockers: TextNow account and virtual phone number provisioning (US/Canadian number inventory and assignment), ad-supported calling infrastructure (pre-roll and banner ads during calls), VoIP calling over Wi-Fi and cellular data (NAT traversal, SRTP, codec selection), SMS/MMS gateway integration with carrier networks (SMPP, carrier agreements), virtual number lifecycle management (number recycling, reclamation after inactivity), voicemail recording and visual voicemail transcription, caller ID and spam call detection algorithms, call forwarding configuration and simultaneous ring, TextNow SIM card activation and wireless data plan management (MVNO operations), number customization and area code availability checking, group messaging and MMS group chat compatibility with carrier networks, contact sync and phone number matching, cross-platform message and call sync (mobile, desktop, web), push notification for incoming calls and messages (VoIP push on iOS), ad serving infrastructure and ad-free subscription management, E911 emergency calling disclosure and compliance, FCC regulatory compliance for VoIP services, number porting (in and out), international calling rates and PSTN gateway, and TextNow account integration.
...
Build an original mobile product inspired by TextNow's public communication workflow. The V1 clone focuses on ad-supported free phone number platform with virtual US/Canadian phone number provisioning, free unlimited calling and texting over Wi-Fi and data, ad-supported calling with optional ad-free subscription, SMS and MMS messaging with group messaging support, voicemail with visual voicemail interface, caller ID and spam call blocking, call forwarding and Wi-Fi calling, TextNow SIM card and data plan integration, number customization and area code selection, picture messaging and media sharing, conversation threading with read indicators, contact sync and contact management, cross-platform availability (mobile, desktop, web), push notifications for incoming calls and messages, and freemium model with TextNow Premium subscription for ad-free experience and additional features.
...
- Preserve the functional job behind TextNow while using original product naming, original UI, original sample data, and licensed integrations.
...
- Do not copy TextNow branding, logos, screenshots, marketing copy, private APIs, proprietary datasets, plan names, UI trade dress, course libraries, textbook solutions, documents, school content, AI prompts, or protected media.
...
|---|---|---|---|
| Apple App Store | https://apps.apple.com/us/app/textnow-call-text-unlimited/id314716233 | iOS listing, privacy labels, release notes, free calling/texting claims, and support links | Verified public URL or explicit platform blocker on 2026-05-06; hands-on native behavior still blocked. |
| Google Play | https://play.google.com/store/apps/details?id=com.enflick.android.TextNow | Android listing, data safety, free phone number/calling claims, and release cadence | Verified public URL or explicit platform blocker on 2026-05-06; hands-on native behavior still blocked. |
| Official product site | https://www.textnow.com/ | TextNow free phone service, virtual number, SIM plans, and product positioning | Verified public URL or explicit platform blocker on 2026-05-06; hands-on native behavior still blocked. |
| Official help | https://www.textnow.com/support | TextNow app help, number setup, calling, and troubleshooting | Verified public URL or explicit platform blocker on 2026-05-06; hands-on native behavior still blocked. |
| Privacy policy | https://www.textnow.com/privacy | TextNow data collection, calling/messaging data, ad data, and privacy disclosures | Verified public URL or explicit platform blocker on 2026-05-06; hands-on native behavior still blocked. |
| Terms | https://www.textnow.com/terms | TextNow services, virtual number terms, calling policies, and acceptable-use boundaries | Verified public URL or explicit platform blocker on 2026-05-06; hands-on native behavior still blocked. |
...
- Manual blockers must remain launch-blocking until verified: TextNow account and virtual phone number provisioning (US/Canadian number inventory and assignment), ad-supported calling infrastructure (pre-roll and banner ads during calls), VoIP calling over Wi-Fi and cellular data (NAT traversal, SRTP, codec selection), SMS/MMS gateway integration with carrier networks (SMPP, carrier agreements), virtual number lifecycle management (number recycling, reclamation after inactivity), voicemail recording and visual voicemail transcription, caller ID and spam call detection algorithms, call forwarding configuration and simultaneous ring, TextNow SIM card activation and wireless data plan management (MVNO operations), number customization and area code availability checking, group messaging and MMS group chat compatibility with carrier networks, contact sync and phone number matching, cross-platform message and call sync (mobile, desktop, web), push notification for incoming calls and messages (VoIP push on iOS), ad serving infrastructure and ad-free subscription management, E911 emergency calling disclosure and compliance, FCC regulatory compliance for VoIP services, number porting (in and out), international calling rates and PSTN gateway, and TextNow account integration.

## Core User Journeys

- User creates or restores a TextNow-style account, completes role, school, subscription, or tenant checks, and reaches the dashboard.
...
|---|---|---|---|---|
| Welcome/Auth | Account login with phone number verification, contact sync permission, profile setup (name, photo), and device linking | phone, OTP, OAuth, sync-contacts, create-profile, link-device | new, returning, verified, unverified, device-linked | auth failed, OTP expired, verification blocked, device limit reached, network error |
| Conversations | Conversation list with recent chats, group chats, channels, and unread indicators, plus search and filters | scroll, pull-refresh, search, filter, pin, archive, delete, mark-read | loading, loaded, empty, filtered, offline-cached, syncing | sync failed, message delivery pending, conversation unavailable, network error |
| Chat/Thread | Message thread with text, media, voice messages, stickers, reactions, replies, and read receipts | send-text, attach-media, record-voice, send-sticker, react, reply, forward, delete | active, typing-indicator, sending, delivered, read, failed, offline-queued | send failed, media upload failed, encryption error, message too large, blocked |
| Calls | Voice and video calling interface with dial pad, call history, group calls, and call controls (mute, speaker, video toggle) | dial, answer, reject, mute, speaker, video-toggle, add-participant, end-call, screen-share | ringing, in-call, on-hold, reconnecting, ended, missed, group-call | call failed, network poor, participant limit, PSTN unavailable, permission denied |
| Contacts | Contact list with phone-matched users, invite non-users, blocked list, and contact search | browse, search, invite, block, unblock, add-favorite, create-group | loaded, syncing, empty, permission-denied | sync failed, contact unavailable, invite failed, permission revoked |
| Settings/Privacy | Account, privacy controls (last seen, profile photo, read receipts), notification preferences, chat backup, storage management, and support | forms, toggle, backup, restore, manage-storage, block, export, request-delete | loaded, editing, backing-up, restoring | backup failed, restore failed, storage full, account locked, export pending |
...
- Treat private message contents and conversation history (text, media, voice messages), call logs and metadata (duration, participants, timestamps), contact list and phone number graph, voicemail recordings and transcriptions, end-to-end encryption keys and session state, payment and transaction data (where applicable), location sharing data and geo-metadata, device identifiers and linked device information, phone number and identity verification data, push notification tokens and delivery preferences, account credentials and session tokens, file and media shared in conversations, group membership and admin relationships, sticker and emoji purchase history, backup data (cloud-stored chat history), call recording contents (where applicable), IP addresses and network information, and spam/fraud detection signals as launch-blocking review areas with owners, mitigations, and acceptance tests before implementation.
...
- Monetization model: use original free/trial/paid/sponsored/school/provider/tenant entitlement logic; do not copy exact pricing, plan names, bundle names, promotional copy, school contracts, tenant offers, or partner offers from TextNow.
...
- Manual verification tests for TextNow account and virtual phone number provisioning (US/Canadian number inventory and assignment), ad-supported calling infrastructure (pre-roll and banner ads during calls), VoIP calling over Wi-Fi and cellular data (NAT traversal, SRTP, codec selection), SMS/MMS gateway integration with carrier networks (SMPP, carrier agreements), virtual number lifecycle management (number recycling, reclamation after inactivity), voicemail recording and visual voicemail transcription, caller ID and spam call detection algorithms, call forwarding configuration and simultaneous ring, TextNow SIM card activation and wireless data plan management (MVNO operations), number customization and area code availability checking, group messaging and MMS group chat compatibility with carrier networks, contact sync and phone number matching, cross-platform message and call sync (mobile, desktop, web), push notification for incoming calls and messages (VoIP push on iOS), ad serving infrastructure and ad-free subscription management, E911 emergency calling disclosure and compliance, FCC regulatory compliance for VoIP services, number porting (in and out), international calling rates and PSTN gateway, and TextNow account integration.
...
- Phase 4: Add app-specific safety controls for ad-supported free phone number platform with virtual US/Canadian phone number provisioning, free unlimited calling and texting over Wi-Fi and data, ad-supported calling with optional ad-free subscription, SMS and MMS messaging with group messaging support, voicemail with visual voicemail interface, caller ID and spam call blocking, call forwarding and Wi-Fi calling, TextNow SIM card and data plan integration, number customization and area code selection, picture messaging and media sharing, conversation threading with read indicators, contact sync and contact management, cross-platform availability (mobile, desktop, web), push notifications for incoming calls and messages, and freemium model with TextNow Premium subscription for ad-free experience and additional features.
...
- Confirm legal/privacy retention behavior for TextNow-style sensitive records and update API contracts before downstream implementation.
