# Edison Mail-Style Clone Spec

> Metadata
> - Inspiration app: Edison Mail
...
> - Manual verification blockers: Edison Mail account and email account linking (Gmail OAuth, Outlook OAuth, Yahoo, iCloud, IMAP/SMTP), AI assistant email analysis and recommendation engine, one-tap unsubscribe detection and execution (List-Unsubscribe header parsing, web scraping fallback), package tracking extraction from confirmation emails and carrier API integration, travel card aggregation (flight, hotel booking detection from emails), bill detection and payment reminder extraction, blocked sender enforcement at server vs client level, customizable swipe actions per account, focused inbox smart categorization algorithm, Edison OnMail custom email address provisioning and DNS, Edison Mail Plus subscription entitlement, data handling transparency (Edison email data practices disclosure), push notification smart filtering logic, multi-account sync and folder mapping, spam and phishing filtering, and Edison Mail account integration.
...
Build an original mobile product inspired by Edison Mail's public communication workflow. The V1 clone focuses on AI-powered email client with unified inbox for multiple accounts (Gmail, Outlook, Yahoo, iCloud, IMAP), smart assistant for email management, one-tap unsubscribe from mailing lists, package tracking and price alert notifications from emails, travel card aggregation for flight and hotel bookings, bill detection and payment reminders, blocked sender management, customizable swipe actions, rich text compose with attachments, focused inbox with smart categorization, dark mode and theme customization, push notifications with smart filtering, Edison OnMail custom email address service, and free model with Edison Mail Plus subscription for advanced features.
...
- Preserve the functional job behind Edison Mail while using original product naming, original UI, original sample data, and licensed integrations.
...
- Do not copy Edison Mail branding, logos, screenshots, marketing copy, private APIs, proprietary datasets, plan names, UI trade dress, course libraries, textbook solutions, documents, school content, AI prompts, or protected media.
...
|---|---|---|---|
| Apple App Store | https://apps.apple.com/us/app/email-edison-mail/id922793622 | iOS listing, privacy labels, release notes, smart email/AI claims, and support links | Verified public URL or explicit platform blocker on 2026-05-06; hands-on native behavior still blocked. |
| Google Play | https://play.google.com/store/apps/details?id=com.easilydo.mail | Android listing, data safety, smart email/package tracking claims, and release cadence | Verified public URL or explicit platform blocker on 2026-05-06; hands-on native behavior still blocked. |
| Official product site | https://mail.edison.tech/ | Edison Mail smart email, AI assistant, and product positioning | Verified public URL or explicit platform blocker on 2026-05-06; hands-on native behavior still blocked. |
| Official help | https://mail.edison.tech/support | Edison Mail app help, setup, and troubleshooting | Verified public URL or explicit platform blocker on 2026-05-06; hands-on native behavior still blocked. |
| Privacy policy | https://www.edison.tech/privacy | Edison data collection, email analysis practices, and privacy disclosures | Verified public URL or explicit platform blocker on 2026-05-06; hands-on native behavior still blocked. |
| Terms | https://www.edison.tech/terms | Edison services, email terms, and acceptable-use boundaries | Verified public URL or explicit platform blocker on 2026-05-06; hands-on native behavior still blocked. |
...
- Manual blockers must remain launch-blocking until verified: Edison Mail account and email account linking (Gmail OAuth, Outlook OAuth, Yahoo, iCloud, IMAP/SMTP), AI assistant email analysis and recommendation engine, one-tap unsubscribe detection and execution (List-Unsubscribe header parsing, web scraping fallback), package tracking extraction from confirmation emails and carrier API integration, travel card aggregation (flight, hotel booking detection from emails), bill detection and payment reminder extraction, blocked sender enforcement at server vs client level, customizable swipe actions per account, focused inbox smart categorization algorithm, Edison OnMail custom email address provisioning and DNS, Edison Mail Plus subscription entitlement, data handling transparency (Edison email data practices disclosure), push notification smart filtering logic, multi-account sync and folder mapping, spam and phishing filtering, and Edison Mail account integration.

## Core User Journeys

- User creates or restores a Edison Mail-style account, completes role, school, subscription, or tenant checks, and reaches the dashboard.
...
- Monetization model: use original free/trial/paid/sponsored/school/provider/tenant entitlement logic; do not copy exact pricing, plan names, bundle names, promotional copy, school contracts, tenant offers, or partner offers from Edison Mail.
...
- Manual verification tests for Edison Mail account and email account linking (Gmail OAuth, Outlook OAuth, Yahoo, iCloud, IMAP/SMTP), AI assistant email analysis and recommendation engine, one-tap unsubscribe detection and execution (List-Unsubscribe header parsing, web scraping fallback), package tracking extraction from confirmation emails and carrier API integration, travel card aggregation (flight, hotel booking detection from emails), bill detection and payment reminder extraction, blocked sender enforcement at server vs client level, customizable swipe actions per account, focused inbox smart categorization algorithm, Edison OnMail custom email address provisioning and DNS, Edison Mail Plus subscription entitlement, data handling transparency (Edison email data practices disclosure), push notification smart filtering logic, multi-account sync and folder mapping, spam and phishing filtering, and Edison Mail account integration.
...
- Phase 4: Add app-specific safety controls for AI-powered email client with unified inbox for multiple accounts (Gmail, Outlook, Yahoo, iCloud, IMAP), smart assistant for email management, one-tap unsubscribe from mailing lists, package tracking and price alert notifications from emails, travel card aggregation for flight and hotel bookings, bill detection and payment reminders, blocked sender management, customizable swipe actions, rich text compose with attachments, focused inbox with smart categorization, dark mode and theme customization, push notifications with smart filtering, Edison OnMail custom email address service, and free model with Edison Mail Plus subscription for advanced features.
...
- Confirm legal/privacy retention behavior for Edison Mail-style sensitive records and update API contracts before downstream implementation.
