# Google Meet-Style Clone Spec

> Metadata
> - Inspiration app: Google Meet
...
> - Manual verification blockers: Google account and Workspace tenant provisioning (personal vs work/education accounts), video meeting infrastructure (up to 500 participants, SFU, adaptive bitrate), screen sharing and presentation mode rendering, Google Calendar meeting scheduling and invitation management, real-time caption speech-to-text accuracy and language support, AI noise cancellation and low-light enhancement processing, virtual background and visual effects rendering (on-device ML), hand raising and emoji reaction delivery and display, breakout room management and participant assignment, poll creation and real-time results, meeting recording storage (Google Drive) and post-meeting access controls, Google Workspace integration (Gmail meet links, Drive file sharing, Docs collaboration), live streaming infrastructure (up to 100K viewers, Enterprise tier), Q&A moderation and attendance tracking reports, companion mode for in-room hybrid meeting experience, push notification for meeting reminders and join prompts, meeting safety controls (lock meeting, remove participant, mute all), Workspace admin controls and organizational policies, SSO and identity management, and Google/Workspace account integration.
...
Build an original mobile product inspired by Google Meet's public communication workflow. The V1 clone focuses on video conferencing platform with HD video meetings for up to 500 participants (Workspace plans), screen sharing and presentation mode, Google Calendar integration for meeting scheduling, real-time captions powered by speech recognition, noise cancellation and low-light mode, virtual backgrounds and visual effects, hand raising and emoji reactions, breakout rooms and polls, meeting recording to Google Drive, Google Workspace integration (Gmail, Calendar, Drive, Docs), live streaming to up to 100,000 viewers (Enterprise), Q&A and attendance tracking, companion mode for hybrid meetings, push notifications for meeting reminders, and freemium model with Google One and Workspace subscriptions for extended meetings and advanced features.
...
- Preserve the functional job behind Google Meet while using original product naming, original UI, original sample data, and licensed integrations.
...
- Do not copy Google Meet branding, logos, screenshots, marketing copy, private APIs, proprietary datasets, plan names, UI trade dress, course libraries, textbook solutions, documents, school content, AI prompts, or protected media.
...
|---|---|---|---|
| Apple App Store | https://apps.apple.com/us/app/google-meet/id1013231476 | iOS listing, privacy labels, release notes, video meeting claims, and support links | Verified public URL or explicit platform blocker on 2026-05-06; hands-on native behavior still blocked. |
| Google Play | https://play.google.com/store/apps/details?id=com.google.android.apps.meetings | Android listing, data safety, video conferencing/meeting claims, and release cadence | Verified public URL or explicit platform blocker on 2026-05-06; hands-on native behavior still blocked. |
| Official product site | https://meet.google.com/ | Google Meet video conferencing, meetings, and product positioning | Verified public URL or explicit platform blocker on 2026-05-06; hands-on native behavior still blocked. |
| Official help | https://support.google.com/meet/ | Google Meet app help, meetings, and troubleshooting | Verified public URL or explicit platform blocker on 2026-05-06; hands-on native behavior still blocked. |
| Privacy policy | https://policies.google.com/privacy | Google data collection, Meet data, and privacy disclosures | Verified public URL or explicit platform blocker on 2026-05-06; hands-on native behavior still blocked. |
| Terms | https://policies.google.com/terms | Google services, Meet terms, and acceptable-use boundaries | Verified public URL or explicit platform blocker on 2026-05-06; hands-on native behavior still blocked. |
...
- Manual blockers must remain launch-blocking until verified: Google account and Workspace tenant provisioning (personal vs work/education accounts), video meeting infrastructure (up to 500 participants, SFU, adaptive bitrate), screen sharing and presentation mode rendering, Google Calendar meeting scheduling and invitation management, real-time caption speech-to-text accuracy and language support, AI noise cancellation and low-light enhancement processing, virtual background and visual effects rendering (on-device ML), hand raising and emoji reaction delivery and display, breakout room management and participant assignment, poll creation and real-time results, meeting recording storage (Google Drive) and post-meeting access controls, Google Workspace integration (Gmail meet links, Drive file sharing, Docs collaboration), live streaming infrastructure (up to 100K viewers, Enterprise tier), Q&A moderation and attendance tracking reports, companion mode for in-room hybrid meeting experience, push notification for meeting reminders and join prompts, meeting safety controls (lock meeting, remove participant, mute all), Workspace admin controls and organizational policies, SSO and identity management, and Google/Workspace account integration.

## Core User Journeys

- User creates or restores a Google Meet-style account, completes role, school, subscription, or tenant checks, and reaches the dashboard.
...
- Monetization model: use original free/trial/paid/sponsored/school/provider/tenant entitlement logic; do not copy exact pricing, plan names, bundle names, promotional copy, school contracts, tenant offers, or partner offers from Google Meet.
...
- Manual verification tests for Google account and Workspace tenant provisioning (personal vs work/education accounts), video meeting infrastructure (up to 500 participants, SFU, adaptive bitrate), screen sharing and presentation mode rendering, Google Calendar meeting scheduling and invitation management, real-time caption speech-to-text accuracy and language support, AI noise cancellation and low-light enhancement processing, virtual background and visual effects rendering (on-device ML), hand raising and emoji reaction delivery and display, breakout room management and participant assignment, poll creation and real-time results, meeting recording storage (Google Drive) and post-meeting access controls, Google Workspace integration (Gmail meet links, Drive file sharing, Docs collaboration), live streaming infrastructure (up to 100K viewers, Enterprise tier), Q&A moderation and attendance tracking reports, companion mode for in-room hybrid meeting experience, push notification for meeting reminders and join prompts, meeting safety controls (lock meeting, remove participant, mute all), Workspace admin controls and organizational policies, SSO and identity management, and Google/Workspace account integration.
...
- Phase 4: Add app-specific safety controls for video conferencing platform with HD video meetings for up to 500 participants (Workspace plans), screen sharing and presentation mode, Google Calendar integration for meeting scheduling, real-time captions powered by speech recognition, noise cancellation and low-light mode, virtual backgrounds and visual effects, hand raising and emoji reactions, breakout rooms and polls, meeting recording to Google Drive, Google Workspace integration (Gmail, Calendar, Drive, Docs), live streaming to up to 100,000 viewers (Enterprise), Q&A and attendance tracking, companion mode for hybrid meetings, push notifications for meeting reminders, and freemium model with Google One and Workspace subscriptions for extended meetings and advanced features.
...
- Confirm legal/privacy retention behavior for Google Meet-style sensitive records and update API contracts before downstream implementation.
