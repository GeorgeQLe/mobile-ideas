# AOL Mail-Style Clone Spec

> Metadata
> - Inspiration app: AOL Mail
...
> - Manual verification blockers: AOL/Yahoo account creation and sign-in (shared Yahoo identity platform), unified inbox and multi-account management, conversation threading and message grouping, rich text compose editor and attachment handling, folder organization and custom folder creation, contact management and address book sync, spam and phishing filtering accuracy, search indexing and filter capabilities, calendar integration and event detection, news feed content aggregation within mail app, customizable inbox themes and display preferences, swipe action configuration, push notification delivery for new email, AOL Desktop Gold compatibility and feature parity, large attachment handling and storage, ad serving infrastructure, two-factor authentication and security, email forwarding and auto-reply configuration, and AOL/Yahoo account integration.
...
Build an original mobile product inspired by AOL Mail's public communication workflow. The V1 clone focuses on classic email platform with unified inbox, conversation threading, rich text compose with attachments and inline images, folder organization and custom folders, contact management and address book, spam and phishing filtering, search with filters, calendar integration, news feed integration within the mail app, customizable inbox themes, swipe actions, push notifications for new email, multi-account support, AOL Desktop Gold integration, large attachment support, and free ad-supported model with optional premium features.
...
- Preserve the functional job behind AOL Mail while using original product naming, original UI, original sample data, and licensed integrations.
...
- Do not copy AOL Mail branding, logos, screenshots, marketing copy, private APIs, proprietary datasets, plan names, UI trade dress, course libraries, textbook solutions, documents, school content, AI prompts, or protected media.
...
|---|---|---|---|
| Apple App Store | https://apps.apple.com/us/app/aol-news-email-weather-video/id646100661 | iOS listing, privacy labels, release notes, email/news claims, and support links | Verified public URL or explicit platform blocker on 2026-05-06; hands-on native behavior still blocked. |
| Google Play | https://play.google.com/store/apps/details?id=com.aol.mobile.aolapp | Android listing, data safety, email/news claims, and release cadence | Verified public URL or explicit platform blocker on 2026-05-06; hands-on native behavior still blocked. |
| Official product site | https://mail.aol.com/ | AOL Mail email service and product positioning | Verified public URL or explicit platform blocker on 2026-05-06; hands-on native behavior still blocked. |
| Official help | https://help.aol.com/ | AOL Mail app help, account, email, and troubleshooting | Verified public URL or explicit platform blocker on 2026-05-06; hands-on native behavior still blocked. |
| Privacy policy | https://legal.yahoo.com/us/en/yahoo/privacy/index.html | Yahoo/AOL data collection, email data, and privacy disclosures | Verified public URL or explicit platform blocker on 2026-05-06; hands-on native behavior still blocked. |
| Terms | https://legal.yahoo.com/us/en/yahoo/terms/otos/index.html | Yahoo/AOL services, email terms, and acceptable-use boundaries | Verified public URL or explicit platform blocker on 2026-05-06; hands-on native behavior still blocked. |
...
- Manual blockers must remain launch-blocking until verified: AOL/Yahoo account creation and sign-in (shared Yahoo identity platform), unified inbox and multi-account management, conversation threading and message grouping, rich text compose editor and attachment handling, folder organization and custom folder creation, contact management and address book sync, spam and phishing filtering accuracy, search indexing and filter capabilities, calendar integration and event detection, news feed content aggregation within mail app, customizable inbox themes and display preferences, swipe action configuration, push notification delivery for new email, AOL Desktop Gold compatibility and feature parity, large attachment handling and storage, ad serving infrastructure, two-factor authentication and security, email forwarding and auto-reply configuration, and AOL/Yahoo account integration.

## Core User Journeys

- User creates or restores a AOL Mail-style account, completes role, school, subscription, or tenant checks, and reaches the dashboard.
...
- Monetization model: use original free/trial/paid/sponsored/school/provider/tenant entitlement logic; do not copy exact pricing, plan names, bundle names, promotional copy, school contracts, tenant offers, or partner offers from AOL Mail.
...
- Manual verification tests for AOL/Yahoo account creation and sign-in (shared Yahoo identity platform), unified inbox and multi-account management, conversation threading and message grouping, rich text compose editor and attachment handling, folder organization and custom folder creation, contact management and address book sync, spam and phishing filtering accuracy, search indexing and filter capabilities, calendar integration and event detection, news feed content aggregation within mail app, customizable inbox themes and display preferences, swipe action configuration, push notification delivery for new email, AOL Desktop Gold compatibility and feature parity, large attachment handling and storage, ad serving infrastructure, two-factor authentication and security, email forwarding and auto-reply configuration, and AOL/Yahoo account integration.
...
- Phase 4: Add app-specific safety controls for classic email platform with unified inbox, conversation threading, rich text compose with attachments and inline images, folder organization and custom folders, contact management and address book, spam and phishing filtering, search with filters, calendar integration, news feed integration within the mail app, customizable inbox themes, swipe actions, push notifications for new email, multi-account support, AOL Desktop Gold integration, large attachment support, and free ad-supported model with optional premium features.
...
- Confirm legal/privacy retention behavior for AOL Mail-style sensitive records and update API contracts before downstream implementation.
