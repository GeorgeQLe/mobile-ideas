# Proton Mail-Style Clone Spec

> Metadata
> - Inspiration app: Proton Mail
...
> - Manual verification blockers: Proton account creation and recovery (no phone number required, recovery email optional), end-to-end encryption implementation (OpenPGP-based, client-side key generation, zero-access architecture), encrypted inbox rendering and decryption performance, compose with E2EE for Proton-to-Proton and password-protected messages for external recipients, encrypted search index (client-side encrypted search), folder and label organization with nested folders, snooze and scheduled send delivery timing, Proton Calendar encrypted event storage and sync, Proton Drive encrypted attachment and file sharing, Proton VPN bundled subscription management, custom domain DNS configuration and verification, multiple address alias provisioning and management, encrypted contact storage and PGP key management, import/export migration tools (IMAP import, mbox/eml export), swipe actions and inbox customization, push notification for new email (without leaking content), bridge application for desktop client IMAP/SMTP access, spam filtering and phishing protection, two-factor authentication and recovery key management, and Proton account integration.
...
Build an original mobile product inspired by Proton Mail's public communication workflow. The V1 clone focuses on end-to-end encrypted email platform with zero-access encryption architecture, encrypted inbox with conversation threading, compose with end-to-end encryption to Proton users and password-protected messages to non-Proton recipients, encrypted search, folders and labels for organization, snooze and scheduled send, Proton Calendar integration, Proton Drive integration for encrypted attachments, Proton VPN bundled option, custom domain support, multiple address aliases, contact management with encrypted contact details, import/export tools for migration from other providers, swipe actions and customizable inbox, push notifications for new email, dark mode, and freemium model with Proton Free, Mail Plus, Proton Unlimited, and Business plans.
...
- Preserve the functional job behind Proton Mail while using original product naming, original UI, original sample data, and licensed integrations.
...
- Do not copy Proton Mail branding, logos, screenshots, marketing copy, private APIs, proprietary datasets, plan names, UI trade dress, course libraries, textbook solutions, documents, school content, AI prompts, or protected media.
...
|---|---|---|---|
| Apple App Store | https://apps.apple.com/us/app/proton-mail-encrypted-email/id979659905 | iOS listing, privacy labels, release notes, encrypted email claims, and support links | Verified public URL or explicit platform blocker on 2026-05-06; hands-on native behavior still blocked. |
| Google Play | https://play.google.com/store/apps/details?id=ch.protonmail.android | Android listing, data safety, end-to-end encrypted email claims, and release cadence | Verified public URL or explicit platform blocker on 2026-05-06; hands-on native behavior still blocked. |
| Official product site | https://proton.me/mail | Proton Mail encrypted email, privacy, zero-access, and product positioning | Verified public URL or explicit platform blocker on 2026-05-06; hands-on native behavior still blocked. |
| Official help | https://proton.me/support/mail | Proton Mail app help, encryption, setup, and troubleshooting | Verified public URL or explicit platform blocker on 2026-05-06; hands-on native behavior still blocked. |
| Privacy policy | https://proton.me/legal/privacy | Proton data collection, encryption architecture, and privacy disclosures | Verified public URL or explicit platform blocker on 2026-05-06; hands-on native behavior still blocked. |
| Terms | https://proton.me/legal/terms | Proton services, email terms, and acceptable-use boundaries | Verified public URL or explicit platform blocker on 2026-05-06; hands-on native behavior still blocked. |
...
- Manual blockers must remain launch-blocking until verified: Proton account creation and recovery (no phone number required, recovery email optional), end-to-end encryption implementation (OpenPGP-based, client-side key generation, zero-access architecture), encrypted inbox rendering and decryption performance, compose with E2EE for Proton-to-Proton and password-protected messages for external recipients, encrypted search index (client-side encrypted search), folder and label organization with nested folders, snooze and scheduled send delivery timing, Proton Calendar encrypted event storage and sync, Proton Drive encrypted attachment and file sharing, Proton VPN bundled subscription management, custom domain DNS configuration and verification, multiple address alias provisioning and management, encrypted contact storage and PGP key management, import/export migration tools (IMAP import, mbox/eml export), swipe actions and inbox customization, push notification for new email (without leaking content), bridge application for desktop client IMAP/SMTP access, spam filtering and phishing protection, two-factor authentication and recovery key management, and Proton account integration.

## Core User Journeys

- User creates or restores a Proton Mail-style account, completes role, school, subscription, or tenant checks, and reaches the dashboard.
...
- Monetization model: use original free/trial/paid/sponsored/school/provider/tenant entitlement logic; do not copy exact pricing, plan names, bundle names, promotional copy, school contracts, tenant offers, or partner offers from Proton Mail.
...
- Manual verification tests for Proton account creation and recovery (no phone number required, recovery email optional), end-to-end encryption implementation (OpenPGP-based, client-side key generation, zero-access architecture), encrypted inbox rendering and decryption performance, compose with E2EE for Proton-to-Proton and password-protected messages for external recipients, encrypted search index (client-side encrypted search), folder and label organization with nested folders, snooze and scheduled send delivery timing, Proton Calendar encrypted event storage and sync, Proton Drive encrypted attachment and file sharing, Proton VPN bundled subscription management, custom domain DNS configuration and verification, multiple address alias provisioning and management, encrypted contact storage and PGP key management, import/export migration tools (IMAP import, mbox/eml export), swipe actions and inbox customization, push notification for new email (without leaking content), bridge application for desktop client IMAP/SMTP access, spam filtering and phishing protection, two-factor authentication and recovery key management, and Proton account integration.
...
- Phase 4: Add app-specific safety controls for end-to-end encrypted email platform with zero-access encryption architecture, encrypted inbox with conversation threading, compose with end-to-end encryption to Proton users and password-protected messages to non-Proton recipients, encrypted search, folders and labels for organization, snooze and scheduled send, Proton Calendar integration, Proton Drive integration for encrypted attachments, Proton VPN bundled option, custom domain support, multiple address aliases, contact management with encrypted contact details, import/export tools for migration from other providers, swipe actions and customizable inbox, push notifications for new email, dark mode, and freemium model with Proton Free, Mail Plus, Proton Unlimited, and Business plans.
...
- Confirm legal/privacy retention behavior for Proton Mail-style sensitive records and update API contracts before downstream implementation.
