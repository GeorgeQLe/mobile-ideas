# Jitsi Meet-Style Clone Spec

> Metadata
> - Inspiration app: Jitsi Meet
...
> - Manual verification blockers: Jitsi Meet no-account-required meeting creation and join flow, open-source self-hosting deployment (Jitsi Videobridge, Ooblio, Ocelot, Docker/Kubernetes, infrastructure requirements), video meeting infrastructure (WebRTC, SFU via Jitsi Videobridge, OCER), end-to-end encryption implementation (Insertable Streams API, key management), screen sharing and presentation mode rendering, in-meeting chat messaging, hand raising and emoji reaction delivery, virtual background rendering (on-device processing), recording via Jibri (server-side recording, storage), live streaming to YouTube/RTMP destinations via Jibri, breakout room management and participant movement, lobby/waiting room moderation and admission control, speaker statistics and talk-time tracking, YouTube video sharing sync within meetings, tile view and spotlight view switching, calendar integration (Google, Outlook), dial-in audio via Jigasi SIP gateway, 8x8-hosted instance (meet.jit.si) capacity and fair-use limits, JaaS (Jitsi as a Service) enterprise provisioning and API, OCER compliance and data sovereignty for self-hosted deployments, push notification for meeting invites and reminders, and Jitsi/8x8 account integration (optional).
...
Build an original mobile product inspired by Jitsi Meet's public communication workflow. The V1 clone focuses on open-source video conferencing platform with free HD video meetings with no account required, screen sharing and presentation mode, end-to-end encryption (E2EE) option, self-hosting capability with Jitsi Videobridge, in-meeting chat, hand raising and emoji reactions, virtual backgrounds, recording and live streaming (via Jibri), breakout rooms, lobby and waiting room, speaker statistics and talk-time tracking, YouTube video sharing in meetings, tile view and spotlight modes, calendar integration, dial-in audio via Jigasi SIP gateway, push notifications for meeting invites, 8x8-hosted public instance (meet.jit.si), and fully free open-source model with optional 8x8-hosted JaaS (Jitsi as a Service) for enterprise.
...
- Preserve the functional job behind Jitsi Meet while using original product naming, original UI, original sample data, and licensed integrations.
...
- Do not copy Jitsi Meet branding, logos, screenshots, marketing copy, private APIs, proprietary datasets, plan names, UI trade dress, course libraries, textbook solutions, documents, school content, AI prompts, or protected media.
...
|---|---|---|---|
| Apple App Store | https://apps.apple.com/us/app/jitsi-meet/id1165103905 | iOS listing, privacy labels, release notes, open-source video meeting claims, and support links | Verified public URL or explicit platform blocker on 2026-05-06; hands-on native behavior still blocked. |
| Google Play | https://play.google.com/store/apps/details?id=org.jitsi.meet | Android listing, data safety, open-source video conferencing claims, and release cadence | Verified public URL or explicit platform blocker on 2026-05-06; hands-on native behavior still blocked. |
| Official product site | https://jitsi.org/ | Jitsi open-source video conferencing, self-hosting, and product positioning | Verified public URL or explicit platform blocker on 2026-05-06; hands-on native behavior still blocked. |
| Official help | https://community.jitsi.org/ | Jitsi community forum, self-hosting help, and troubleshooting | Verified public URL or explicit platform blocker on 2026-05-06; hands-on native behavior still blocked. |
| Privacy policy | https://jitsi.org/privacy/ | Jitsi/8x8 data collection, meeting data (meet.jit.si), and privacy disclosures | Verified public URL or explicit platform blocker on 2026-05-06; hands-on native behavior still blocked. |
| Terms | https://jitsi.org/tos/ | Jitsi/8x8 services, meet.jit.si terms, and acceptable-use boundaries | Verified public URL or explicit platform blocker on 2026-05-06; hands-on native behavior still blocked. |
...
- Manual blockers must remain launch-blocking until verified: Jitsi Meet no-account-required meeting creation and join flow, open-source self-hosting deployment (Jitsi Videobridge, Ooblio, Ocelot, Docker/Kubernetes, infrastructure requirements), video meeting infrastructure (WebRTC, SFU via Jitsi Videobridge, OCER), end-to-end encryption implementation (Insertable Streams API, key management), screen sharing and presentation mode rendering, in-meeting chat messaging, hand raising and emoji reaction delivery, virtual background rendering (on-device processing), recording via Jibri (server-side recording, storage), live streaming to YouTube/RTMP destinations via Jibri, breakout room management and participant movement, lobby/waiting room moderation and admission control, speaker statistics and talk-time tracking, YouTube video sharing sync within meetings, tile view and spotlight view switching, calendar integration (Google, Outlook), dial-in audio via Jigasi SIP gateway, 8x8-hosted instance (meet.jit.si) capacity and fair-use limits, JaaS (Jitsi as a Service) enterprise provisioning and API, OCER compliance and data sovereignty for self-hosted deployments, push notification for meeting invites and reminders, and Jitsi/8x8 account integration (optional).

## Core User Journeys

- User creates or restores a Jitsi Meet-style account, completes role, school, subscription, or tenant checks, and reaches the dashboard.
...
- Monetization model: use original free/trial/paid/sponsored/school/provider/tenant entitlement logic; do not copy exact pricing, plan names, bundle names, promotional copy, school contracts, tenant offers, or partner offers from Jitsi Meet.
...
- Manual verification tests for Jitsi Meet no-account-required meeting creation and join flow, open-source self-hosting deployment (Jitsi Videobridge, Ooblio, Ocelot, Docker/Kubernetes, infrastructure requirements), video meeting infrastructure (WebRTC, SFU via Jitsi Videobridge, OCER), end-to-end encryption implementation (Insertable Streams API, key management), screen sharing and presentation mode rendering, in-meeting chat messaging, hand raising and emoji reaction delivery, virtual background rendering (on-device processing), recording via Jibri (server-side recording, storage), live streaming to YouTube/RTMP destinations via Jibri, breakout room management and participant movement, lobby/waiting room moderation and admission control, speaker statistics and talk-time tracking, YouTube video sharing sync within meetings, tile view and spotlight view switching, calendar integration (Google, Outlook), dial-in audio via Jigasi SIP gateway, 8x8-hosted instance (meet.jit.si) capacity and fair-use limits, JaaS (Jitsi as a Service) enterprise provisioning and API, OCER compliance and data sovereignty for self-hosted deployments, push notification for meeting invites and reminders, and Jitsi/8x8 account integration (optional).
...
- Phase 4: Add app-specific safety controls for open-source video conferencing platform with free HD video meetings with no account required, screen sharing and presentation mode, end-to-end encryption (E2EE) option, self-hosting capability with Jitsi Videobridge, in-meeting chat, hand raising and emoji reactions, virtual backgrounds, recording and live streaming (via Jibri), breakout rooms, lobby and waiting room, speaker statistics and talk-time tracking, YouTube video sharing in meetings, tile view and spotlight modes, calendar integration, dial-in audio via Jigasi SIP gateway, push notifications for meeting invites, 8x8-hosted public instance (meet.jit.si), and fully free open-source model with optional 8x8-hosted JaaS (Jitsi as a Service) for enterprise.
...
- Confirm legal/privacy retention behavior for Jitsi Meet-style sensitive records and update API contracts before downstream implementation.
