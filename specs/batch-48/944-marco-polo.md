# Marco Polo-Style Clone Spec

> Metadata
> - Inspiration app: Marco Polo
...
> - Manual verification blockers: Marco Polo account and phone number/contact verification, asynchronous video recording and delivery infrastructure (video encoding, CDN, storage), group video conversation management and participant handling, voice-only message recording and playback, video reactions and emoji overlay rendering, video filters and real-time effects processing (on-device), variable speed video playback controls, scrapbook feature (video moment clipping, saving, organizing), video message forwarding and sharing mechanics, group management (invitations, add/remove, admin controls), push notification for new Polos and group activity, cross-platform video sync and quality adaptation, Marco Polo Plus subscription entitlement (HD video, extended length, custom reactions), video storage and retention policy, bandwidth optimization for video messages, contact sync and friend discovery, content moderation for video messages, child safety considerations for video messaging, and Marco Polo account integration.
...
Build an original mobile product inspired by Marco Polo's public communication workflow. The V1 clone focuses on asynchronous video messaging platform with video message recording and sending (Polos), group video conversations with multiple participants, voice-only messaging option, video reactions and emoji responses, video filters and effects, video message playback at variable speeds, scrapbook feature for saving and organizing favorite video moments, video message forwarding and sharing, group management with add/remove members, push notifications for new video messages, cross-platform video sync (mobile, tablet), Marco Polo Plus subscription (HD video, custom reactions, ad-free, extended video length), and freemium model with optional Marco Polo Plus premium features.
...
- Preserve the functional job behind Marco Polo while using original product naming, original UI, original sample data, and licensed integrations.
...
- Do not copy Marco Polo branding, logos, screenshots, marketing copy, private APIs, proprietary datasets, plan names, UI trade dress, course libraries, textbook solutions, documents, school content, AI prompts, or protected media.
...
|---|---|---|---|
| Apple App Store | https://apps.apple.com/us/app/marco-polo-video-messenger/id912561374 | iOS listing, privacy labels, release notes, video messaging claims, and support links | Verified public URL or explicit platform blocker on 2026-05-06; hands-on native behavior still blocked. |
| Google Play | https://play.google.com/store/apps/details?id=co.happybits.marcopolo | Android listing, data safety, video messenger/async video claims, and release cadence | Verified public URL or explicit platform blocker on 2026-05-06; hands-on native behavior still blocked. |
| Official product site | https://www.marcopolo.me/ | Marco Polo video messaging, Polos, group conversations, and product positioning | Verified public URL or explicit platform blocker on 2026-05-06; hands-on native behavior still blocked. |
| Official help | https://support.marcopolo.me/ | Marco Polo app help, video messaging, and troubleshooting | Verified public URL or explicit platform blocker on 2026-05-06; hands-on native behavior still blocked. |
| Privacy policy | https://www.marcopolo.me/privacy-policy | Marco Polo data collection, video data, and privacy disclosures | Verified public URL or explicit platform blocker on 2026-05-06; hands-on native behavior still blocked. |
| Terms | https://www.marcopolo.me/terms-of-service | Marco Polo services, video messaging terms, and acceptable-use boundaries | Verified public URL or explicit platform blocker on 2026-05-06; hands-on native behavior still blocked. |
...
- Manual blockers must remain launch-blocking until verified: Marco Polo account and phone number/contact verification, asynchronous video recording and delivery infrastructure (video encoding, CDN, storage), group video conversation management and participant handling, voice-only message recording and playback, video reactions and emoji overlay rendering, video filters and real-time effects processing (on-device), variable speed video playback controls, scrapbook feature (video moment clipping, saving, organizing), video message forwarding and sharing mechanics, group management (invitations, add/remove, admin controls), push notification for new Polos and group activity, cross-platform video sync and quality adaptation, Marco Polo Plus subscription entitlement (HD video, extended length, custom reactions), video storage and retention policy, bandwidth optimization for video messages, contact sync and friend discovery, content moderation for video messages, child safety considerations for video messaging, and Marco Polo account integration.

## Core User Journeys

- User creates or restores a Marco Polo-style account, completes role, school, subscription, or tenant checks, and reaches the dashboard.
...
- Monetization model: use original free/trial/paid/sponsored/school/provider/tenant entitlement logic; do not copy exact pricing, plan names, bundle names, promotional copy, school contracts, tenant offers, or partner offers from Marco Polo.
...
- Manual verification tests for Marco Polo account and phone number/contact verification, asynchronous video recording and delivery infrastructure (video encoding, CDN, storage), group video conversation management and participant handling, voice-only message recording and playback, video reactions and emoji overlay rendering, video filters and real-time effects processing (on-device), variable speed video playback controls, scrapbook feature (video moment clipping, saving, organizing), video message forwarding and sharing mechanics, group management (invitations, add/remove, admin controls), push notification for new Polos and group activity, cross-platform video sync and quality adaptation, Marco Polo Plus subscription entitlement (HD video, extended length, custom reactions), video storage and retention policy, bandwidth optimization for video messages, contact sync and friend discovery, content moderation for video messages, child safety considerations for video messaging, and Marco Polo account integration.
...
- Phase 4: Add app-specific safety controls for asynchronous video messaging platform with video message recording and sending (Polos), group video conversations with multiple participants, voice-only messaging option, video reactions and emoji responses, video filters and effects, video message playback at variable speeds, scrapbook feature for saving and organizing favorite video moments, video message forwarding and sharing, group management with add/remove members, push notifications for new video messages, cross-platform video sync (mobile, tablet), Marco Polo Plus subscription (HD video, custom reactions, ad-free, extended video length), and freemium model with optional Marco Polo Plus premium features.
...
- Confirm legal/privacy retention behavior for Marco Polo-style sensitive records and update API contracts before downstream implementation.
