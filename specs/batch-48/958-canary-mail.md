# Canary Mail-Style Clone Spec

> Metadata
> - Inspiration app: Canary Mail
...
> - Manual verification blockers: Canary Mail account and email account linking (Gmail OAuth, Outlook OAuth, iCloud, Yahoo, IMAP/SMTP), end-to-end PGP encryption (key generation, key exchange, keyserver lookup, encrypt/decrypt performance), Copilot AI email writing and summarization (LLM integration, on-device vs cloud processing, data handling), focused inbox smart categorization algorithm, read receipt and email tracking pixel implementation, one-tap unsubscribe detection and execution, snooze and remind-later scheduling, email template creation and management, pin email feature and pinned inbox section, bulk mail cleanup detection and batch delete/archive, customizable notification smart filtering, biometric app lock (Face ID, Touch ID, device auth), Canary Mail Pro subscription entitlement and feature gating, PGP key management (import, export, trust model), data handling transparency (on-device vs server-side processing), SecureSend for non-PGP encrypted messages to external recipients, and Canary Mail account integration.
...
Build an original mobile product inspired by Canary Mail's public communication workflow. The V1 clone focuses on privacy-focused email client with end-to-end encryption (PGP) built in, unified inbox for multiple accounts (Gmail, Outlook, iCloud, Yahoo, IMAP), Copilot AI for email writing, summarization, and prioritization, focused inbox with smart categorization, read receipts and email tracking, one-tap unsubscribe, snooze and remind later, email templates, pin important emails, rich text compose with attachments, bulk mail cleanup tools, customizable notifications with smart filtering, biometric app lock (Face ID, Touch ID), dark mode and theme customization, push notifications, and freemium model with Canary Mail Pro subscription for advanced encryption, AI, and productivity features.
...
- Preserve the functional job behind Canary Mail while using original product naming, original UI, original sample data, and licensed integrations.
...
- Do not copy Canary Mail branding, logos, screenshots, marketing copy, private APIs, proprietary datasets, plan names, UI trade dress, course libraries, textbook solutions, documents, school content, AI prompts, or protected media.
...
|---|---|---|---|
| Apple App Store | https://apps.apple.com/us/app/canary-mail/id1236045954 | iOS listing, privacy labels, release notes, encrypted email/AI claims, and support links | Verified public URL or explicit platform blocker on 2026-05-06; hands-on native behavior still blocked. |
| Google Play | https://play.google.com/store/apps/details?id=io.canarymail.android | Android listing, data safety, encrypted email/privacy claims, and release cadence | Verified public URL or explicit platform blocker on 2026-05-06; hands-on native behavior still blocked. |
| Official product site | https://canarymail.io/ | Canary Mail encrypted email, AI Copilot, privacy, and product positioning | Verified public URL or explicit platform blocker on 2026-05-06; hands-on native behavior still blocked. |
| Official help | https://canarymail.io/help/ | Canary Mail app help, encryption setup, and troubleshooting | Verified public URL or explicit platform blocker on 2026-05-06; hands-on native behavior still blocked. |
| Privacy policy | https://canarymail.io/privacy.html | Canary Mail data collection, encryption, AI data handling, and privacy disclosures | Verified public URL or explicit platform blocker on 2026-05-06; hands-on native behavior still blocked. |
| Terms | https://canarymail.io/terms.html | Canary Mail services, email terms, and acceptable-use boundaries | Verified public URL or explicit platform blocker on 2026-05-06; hands-on native behavior still blocked. |
...
- Manual blockers must remain launch-blocking until verified: Canary Mail account and email account linking (Gmail OAuth, Outlook OAuth, iCloud, Yahoo, IMAP/SMTP), end-to-end PGP encryption (key generation, key exchange, keyserver lookup, encrypt/decrypt performance), Copilot AI email writing and summarization (LLM integration, on-device vs cloud processing, data handling), focused inbox smart categorization algorithm, read receipt and email tracking pixel implementation, one-tap unsubscribe detection and execution, snooze and remind-later scheduling, email template creation and management, pin email feature and pinned inbox section, bulk mail cleanup detection and batch delete/archive, customizable notification smart filtering, biometric app lock (Face ID, Touch ID, device auth), Canary Mail Pro subscription entitlement and feature gating, PGP key management (import, export, trust model), data handling transparency (on-device vs server-side processing), SecureSend for non-PGP encrypted messages to external recipients, and Canary Mail account integration.

## Core User Journeys

- User creates or restores a Canary Mail-style account, completes role, school, subscription, or tenant checks, and reaches the dashboard.
...
- Monetization model: use original free/trial/paid/sponsored/school/provider/tenant entitlement logic; do not copy exact pricing, plan names, bundle names, promotional copy, school contracts, tenant offers, or partner offers from Canary Mail.
...
- Manual verification tests for Canary Mail account and email account linking (Gmail OAuth, Outlook OAuth, iCloud, Yahoo, IMAP/SMTP), end-to-end PGP encryption (key generation, key exchange, keyserver lookup, encrypt/decrypt performance), Copilot AI email writing and summarization (LLM integration, on-device vs cloud processing, data handling), focused inbox smart categorization algorithm, read receipt and email tracking pixel implementation, one-tap unsubscribe detection and execution, snooze and remind-later scheduling, email template creation and management, pin email feature and pinned inbox section, bulk mail cleanup detection and batch delete/archive, customizable notification smart filtering, biometric app lock (Face ID, Touch ID, device auth), Canary Mail Pro subscription entitlement and feature gating, PGP key management (import, export, trust model), data handling transparency (on-device vs server-side processing), SecureSend for non-PGP encrypted messages to external recipients, and Canary Mail account integration.
...
- Phase 4: Add app-specific safety controls for privacy-focused email client with end-to-end encryption (PGP) built in, unified inbox for multiple accounts (Gmail, Outlook, iCloud, Yahoo, IMAP), Copilot AI for email writing, summarization, and prioritization, focused inbox with smart categorization, read receipts and email tracking, one-tap unsubscribe, snooze and remind later, email templates, pin important emails, rich text compose with attachments, bulk mail cleanup tools, customizable notifications with smart filtering, biometric app lock (Face ID, Touch ID), dark mode and theme customization, push notifications, and freemium model with Canary Mail Pro subscription for advanced encryption, AI, and productivity features.
...
- Confirm legal/privacy retention behavior for Canary Mail-style sensitive records and update API contracts before downstream implementation.
