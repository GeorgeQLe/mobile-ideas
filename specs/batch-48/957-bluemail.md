# BlueMail-Style Clone Spec

> Metadata
> - Inspiration app: BlueMail
...
> - Manual verification blockers: BlueMail/Blix account and email account linking (Gmail OAuth, Outlook/Exchange OAuth, Yahoo, iCloud, IMAP/POP3/SMTP, EWS), unified inbox aggregation for unlimited accounts, cluster view grouping algorithm (smart threading), people toggle person-to-person email detection, smart push notification timing and quiet hours scheduling, email scheduling and timed send delivery, rich text compose editor with inline images, group email team collaboration and shared inbox management, BlueMail Plus and Business subscription entitlement, S/MIME email encryption and certificate management, calendar integration with email account calendars, contact management and cross-account address book, share email feature mechanics, configurable menus and display density settings, per-account push notification controls, Exchange ActiveSync and EWS support, POP3 account support and limitations, data handling and server-side processing transparency, enterprise deployment and MDM integration, and BlueMail/Blix account integration.
...
Build an original mobile product inspired by BlueMail's public communication workflow. The V1 clone focuses on feature-rich email client with unified inbox for unlimited email accounts (Gmail, Outlook, Yahoo, iCloud, Exchange, IMAP, POP3), cluster view for grouping related emails, people toggle to show only person-to-person emails, smart push notifications with configurable quiet hours, email scheduling and send later, rich text compose with inline images and attachments, Dark Mode, customizable swipe actions, group email for team collaboration, BlueMail Plus and BlueMail Business tiers, email encryption (S/MIME support), calendar integration, contact management, share email feature, configurable menus and display density, push notifications with per-account controls, and freemium model with BlueMail Plus for advanced features and Business for enterprise.
...
- Preserve the functional job behind BlueMail while using original product naming, original UI, original sample data, and licensed integrations.
...
- Do not copy BlueMail branding, logos, screenshots, marketing copy, private APIs, proprietary datasets, plan names, UI trade dress, course libraries, textbook solutions, documents, school content, AI prompts, or protected media.
...
|---|---|---|---|
| Apple App Store | https://apps.apple.com/us/app/bluemail-email-mailbox/id1063729305 | iOS listing, privacy labels, release notes, email client/unified inbox claims, and support links | Verified public URL or explicit platform blocker on 2026-05-06; hands-on native behavior still blocked. |
| Google Play | https://play.google.com/store/apps/details?id=me.bluemail.mail | Android listing, data safety, unified email/team claims, and release cadence | Verified public URL or explicit platform blocker on 2026-05-06; hands-on native behavior still blocked. |
| Official product site | https://bluemail.me/ | BlueMail unified email, team collaboration, and product positioning | Verified public URL or explicit platform blocker on 2026-05-06; hands-on native behavior still blocked. |
| Official help | https://bluemail.me/help/ | BlueMail app help, account setup, and troubleshooting | Verified public URL or explicit platform blocker on 2026-05-06; hands-on native behavior still blocked. |
| Privacy policy | https://bluemail.me/privacy/ | BlueMail/Blix data collection, email processing, and privacy disclosures | Verified public URL or explicit platform blocker on 2026-05-06; hands-on native behavior still blocked. |
| Terms | https://bluemail.me/terms/ | BlueMail/Blix services, email terms, and acceptable-use boundaries | Verified public URL or explicit platform blocker on 2026-05-06; hands-on native behavior still blocked. |
...
- Manual blockers must remain launch-blocking until verified: BlueMail/Blix account and email account linking (Gmail OAuth, Outlook/Exchange OAuth, Yahoo, iCloud, IMAP/POP3/SMTP, EWS), unified inbox aggregation for unlimited accounts, cluster view grouping algorithm (smart threading), people toggle person-to-person email detection, smart push notification timing and quiet hours scheduling, email scheduling and timed send delivery, rich text compose editor with inline images, group email team collaboration and shared inbox management, BlueMail Plus and Business subscription entitlement, S/MIME email encryption and certificate management, calendar integration with email account calendars, contact management and cross-account address book, share email feature mechanics, configurable menus and display density settings, per-account push notification controls, Exchange ActiveSync and EWS support, POP3 account support and limitations, data handling and server-side processing transparency, enterprise deployment and MDM integration, and BlueMail/Blix account integration.

## Core User Journeys

- User creates or restores a BlueMail-style account, completes role, school, subscription, or tenant checks, and reaches the dashboard.
...
- Monetization model: use original free/trial/paid/sponsored/school/provider/tenant entitlement logic; do not copy exact pricing, plan names, bundle names, promotional copy, school contracts, tenant offers, or partner offers from BlueMail.
...
- Manual verification tests for BlueMail/Blix account and email account linking (Gmail OAuth, Outlook/Exchange OAuth, Yahoo, iCloud, IMAP/POP3/SMTP, EWS), unified inbox aggregation for unlimited accounts, cluster view grouping algorithm (smart threading), people toggle person-to-person email detection, smart push notification timing and quiet hours scheduling, email scheduling and timed send delivery, rich text compose editor with inline images, group email team collaboration and shared inbox management, BlueMail Plus and Business subscription entitlement, S/MIME email encryption and certificate management, calendar integration with email account calendars, contact management and cross-account address book, share email feature mechanics, configurable menus and display density settings, per-account push notification controls, Exchange ActiveSync and EWS support, POP3 account support and limitations, data handling and server-side processing transparency, enterprise deployment and MDM integration, and BlueMail/Blix account integration.
...
- Phase 4: Add app-specific safety controls for feature-rich email client with unified inbox for unlimited email accounts (Gmail, Outlook, Yahoo, iCloud, Exchange, IMAP, POP3), cluster view for grouping related emails, people toggle to show only person-to-person emails, smart push notifications with configurable quiet hours, email scheduling and send later, rich text compose with inline images and attachments, Dark Mode, customizable swipe actions, group email for team collaboration, BlueMail Plus and BlueMail Business tiers, email encryption (S/MIME support), calendar integration, contact management, share email feature, configurable menus and display density, push notifications with per-account controls, and freemium model with BlueMail Plus for advanced features and Business for enterprise.
...
- Confirm legal/privacy retention behavior for BlueMail-style sensitive records and update API contracts before downstream implementation.
