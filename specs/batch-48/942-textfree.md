# TextFree-Style Clone Spec

> Metadata
> - Inspiration app: TextFree
...
> - Manual verification blockers: TextFree/Pinger account and virtual phone number provisioning (US number inventory), earned calling minutes model (ad watching, offers, or purchase), VoIP calling infrastructure for voice calls, SMS/MMS gateway integration with carriers, virtual number assignment and recycling policy, voicemail recording and playback, group messaging and MMS compatibility, number customization and area code selection, ad-supported messaging infrastructure and premium subscription, picture and video message handling (MMS size limits, compression), contact sync and management, cross-platform message sync, push notification for incoming texts and calls, E911 emergency calling limitations, FCC regulatory compliance, number porting support, spam and fraud prevention, and TextFree/Pinger account integration.
...
Build an original mobile product inspired by TextFree's public communication workflow. The V1 clone focuses on free texting and calling app with virtual US phone number, free unlimited texting over Wi-Fi and data, earned or purchased calling minutes for voice calls, ad-supported messaging with optional premium subscription, SMS and MMS messaging, group messaging, voicemail, picture and video messaging, number customization with area code selection, contact management, push notifications for incoming texts and calls, cross-platform support, and freemium model with TextFree Premium for ad-free texting and calling minutes.
...
- Preserve the functional job behind TextFree while using original product naming, original UI, original sample data, and licensed integrations.
...
- Do not copy TextFree branding, logos, screenshots, marketing copy, private APIs, proprietary datasets, plan names, UI trade dress, course libraries, textbook solutions, documents, school content, AI prompts, or protected media.
...
|---|---|---|---|
| Apple App Store | https://apps.apple.com/us/app/text-free-texting-calling/id399355755 | iOS listing, privacy labels, release notes, free texting/calling claims, and support links | Verified public URL or explicit platform blocker on 2026-05-06; hands-on native behavior still blocked. |
| Google Play | https://play.google.com/store/apps/details?id=com.pinger.textfree | Android listing, data safety, free texting/phone number claims, and release cadence | Verified public URL or explicit platform blocker on 2026-05-06; hands-on native behavior still blocked. |
| Official product site | https://www.textfree.us/ | TextFree free texting, calling, virtual number, and product positioning | Verified public URL or explicit platform blocker on 2026-05-06; hands-on native behavior still blocked. |
| Official help | https://support.pinger.com/ | TextFree/Pinger app help, texting, calling, and troubleshooting | Verified public URL or explicit platform blocker on 2026-05-06; hands-on native behavior still blocked. |
| Privacy policy | https://www.pinger.com/privacy-policy/ | TextFree/Pinger data collection, messaging data, and privacy disclosures | Verified public URL or explicit platform blocker on 2026-05-06; hands-on native behavior still blocked. |
| Terms | https://www.pinger.com/terms-of-use/ | TextFree/Pinger services, virtual number terms, and acceptable-use boundaries | Verified public URL or explicit platform blocker on 2026-05-06; hands-on native behavior still blocked. |
...
- Manual blockers must remain launch-blocking until verified: TextFree/Pinger account and virtual phone number provisioning (US number inventory), earned calling minutes model (ad watching, offers, or purchase), VoIP calling infrastructure for voice calls, SMS/MMS gateway integration with carriers, virtual number assignment and recycling policy, voicemail recording and playback, group messaging and MMS compatibility, number customization and area code selection, ad-supported messaging infrastructure and premium subscription, picture and video message handling (MMS size limits, compression), contact sync and management, cross-platform message sync, push notification for incoming texts and calls, E911 emergency calling limitations, FCC regulatory compliance, number porting support, spam and fraud prevention, and TextFree/Pinger account integration.

## Core User Journeys

- User creates or restores a TextFree-style account, completes role, school, subscription, or tenant checks, and reaches the dashboard.
...
- Monetization model: use original free/trial/paid/sponsored/school/provider/tenant entitlement logic; do not copy exact pricing, plan names, bundle names, promotional copy, school contracts, tenant offers, or partner offers from TextFree.
...
- Manual verification tests for TextFree/Pinger account and virtual phone number provisioning (US number inventory), earned calling minutes model (ad watching, offers, or purchase), VoIP calling infrastructure for voice calls, SMS/MMS gateway integration with carriers, virtual number assignment and recycling policy, voicemail recording and playback, group messaging and MMS compatibility, number customization and area code selection, ad-supported messaging infrastructure and premium subscription, picture and video message handling (MMS size limits, compression), contact sync and management, cross-platform message sync, push notification for incoming texts and calls, E911 emergency calling limitations, FCC regulatory compliance, number porting support, spam and fraud prevention, and TextFree/Pinger account integration.
...
- Phase 4: Add app-specific safety controls for free texting and calling app with virtual US phone number, free unlimited texting over Wi-Fi and data, earned or purchased calling minutes for voice calls, ad-supported messaging with optional premium subscription, SMS and MMS messaging, group messaging, voicemail, picture and video messaging, number customization with area code selection, contact management, push notifications for incoming texts and calls, cross-platform support, and freemium model with TextFree Premium for ad-free texting and calling minutes.
...
- Confirm legal/privacy retention behavior for TextFree-style sensitive records and update API contracts before downstream implementation.
