# Fastmail-Style Clone Spec

> Metadata
> - Inspiration app: Fastmail
...
> - Manual verification blockers: Fastmail account creation and paid subscription activation (no free tier), custom domain DNS configuration and alias management, label and folder organization with color coding and nested structure, rules and filters engine (server-side rule creation, condition matching, action execution), snooze and scheduled send delivery timing, conversation threading and split view rendering, JMAP protocol implementation for fast sync (vs traditional IMAP), CalDAV calendar and CardDAV contacts sync, masked email address generation and management (1Password integration), custom branding for business domain white-labeling, two-factor authentication (TOTP, U2F/WebAuthn) and app-specific passwords, import/export migration tools (IMAP migration, mbox/eml export), search indexing and advanced filter capabilities, push notification delivery, server-side spam filtering and phishing protection, Standard/Premium/Professional plan entitlement and feature differentiation, family and business account management, and Fastmail account integration.
...
Build an original mobile product inspired by Fastmail's public communication workflow. The V1 clone focuses on privacy-respecting paid email service with fast, ad-free email experience, powerful search and filtering, custom domain support with multiple aliases, label and folder organization with color coding, rules and filters for automatic email sorting, snooze and scheduled send, conversation threading and split view, rich text compose with attachments, calendar and contacts integrated (CalDAV/CardDAV), masked email addresses for privacy (integration with 1Password), custom branding for business domains, JMAP protocol support for fast sync, two-factor authentication and app passwords, import/export tools for email migration, push notifications, website/app without tracking or ads, and paid-only model with Standard, Premium, and Professional plans (no free tier).
...
- Preserve the functional job behind Fastmail while using original product naming, original UI, original sample data, and licensed integrations.
...
- Do not copy Fastmail branding, logos, screenshots, marketing copy, private APIs, proprietary datasets, plan names, UI trade dress, course libraries, textbook solutions, documents, school content, AI prompts, or protected media.
...
|---|---|---|---|
| Apple App Store | https://apps.apple.com/us/app/fastmail-email-calendar/id931370077 | iOS listing, privacy labels, release notes, email/calendar/privacy claims, and support links | Verified public URL or explicit platform blocker on 2026-05-06; hands-on native behavior still blocked. |
| Google Play | https://play.google.com/store/apps/details?id=com.fastmail.app | Android listing, data safety, email/privacy/calendar claims, and release cadence | Verified public URL or explicit platform blocker on 2026-05-06; hands-on native behavior still blocked. |
| Official product site | https://www.fastmail.com/ | Fastmail email service, privacy, custom domains, and product positioning | Verified public URL or explicit platform blocker on 2026-05-06; hands-on native behavior still blocked. |
| Official help | https://www.fastmail.com/help/ | Fastmail app help, setup, migration, and troubleshooting | Verified public URL or explicit platform blocker on 2026-05-06; hands-on native behavior still blocked. |
| Privacy policy | https://www.fastmail.com/about/privacy/ | Fastmail data collection, no-tracking policy, and privacy disclosures | Verified public URL or explicit platform blocker on 2026-05-06; hands-on native behavior still blocked. |
| Terms | https://www.fastmail.com/about/tos/ | Fastmail services, email terms, and acceptable-use boundaries | Verified public URL or explicit platform blocker on 2026-05-06; hands-on native behavior still blocked. |
...
- Manual blockers must remain launch-blocking until verified: Fastmail account creation and paid subscription activation (no free tier), custom domain DNS configuration and alias management, label and folder organization with color coding and nested structure, rules and filters engine (server-side rule creation, condition matching, action execution), snooze and scheduled send delivery timing, conversation threading and split view rendering, JMAP protocol implementation for fast sync (vs traditional IMAP), CalDAV calendar and CardDAV contacts sync, masked email address generation and management (1Password integration), custom branding for business domain white-labeling, two-factor authentication (TOTP, U2F/WebAuthn) and app-specific passwords, import/export migration tools (IMAP migration, mbox/eml export), search indexing and advanced filter capabilities, push notification delivery, server-side spam filtering and phishing protection, Standard/Premium/Professional plan entitlement and feature differentiation, family and business account management, and Fastmail account integration.

## Core User Journeys

- User creates or restores a Fastmail-style account, completes role, school, subscription, or tenant checks, and reaches the dashboard.
...
- Monetization model: use original free/trial/paid/sponsored/school/provider/tenant entitlement logic; do not copy exact pricing, plan names, bundle names, promotional copy, school contracts, tenant offers, or partner offers from Fastmail.
...
- Manual verification tests for Fastmail account creation and paid subscription activation (no free tier), custom domain DNS configuration and alias management, label and folder organization with color coding and nested structure, rules and filters engine (server-side rule creation, condition matching, action execution), snooze and scheduled send delivery timing, conversation threading and split view rendering, JMAP protocol implementation for fast sync (vs traditional IMAP), CalDAV calendar and CardDAV contacts sync, masked email address generation and management (1Password integration), custom branding for business domain white-labeling, two-factor authentication (TOTP, U2F/WebAuthn) and app-specific passwords, import/export migration tools (IMAP migration, mbox/eml export), search indexing and advanced filter capabilities, push notification delivery, server-side spam filtering and phishing protection, Standard/Premium/Professional plan entitlement and feature differentiation, family and business account management, and Fastmail account integration.
...
- Phase 4: Add app-specific safety controls for privacy-respecting paid email service with fast, ad-free email experience, powerful search and filtering, custom domain support with multiple aliases, label and folder organization with color coding, rules and filters for automatic email sorting, snooze and scheduled send, conversation threading and split view, rich text compose with attachments, calendar and contacts integrated (CalDAV/CardDAV), masked email addresses for privacy (integration with 1Password), custom branding for business domains, JMAP protocol support for fast sync, two-factor authentication and app passwords, import/export tools for email migration, push notifications, website/app without tracking or ads, and paid-only model with Standard, Premium, and Professional plans (no free tier).
...
- Confirm legal/privacy retention behavior for Fastmail-style sensitive records and update API contracts before downstream implementation.
