# GroupMe-Style Clone Spec

> Metadata
> - Inspiration app: GroupMe
...
> - Manual verification blockers: GroupMe/Microsoft account and phone number verification, SMS-integrated group chat delivery (SMS fallback for non-app users, carrier costs), group creation and member management at scale, image and video sharing with media hosting and CDN, liking and emoji reaction sync across platforms, event planning and calendar integration (timezone handling, RSVP), polls creation and real-time vote tallying, group gallery aggregation and storage, @mentions and notification routing, GroupMe bot platform and webhook API, expense splitting and payment tracking integration, per-group mute and Do Not Disturb scheduling, cross-platform message sync (mobile, desktop, web, SMS), SMS fallback delivery and carrier compatibility, push notification categories per group, group size limits and performance, content moderation for group-generated content, Microsoft account integration and SSO, spam prevention for group invites, and GroupMe account integration.
...
Build an original mobile product inspired by GroupMe's public communication workflow. The V1 clone focuses on group messaging platform with SMS-integrated group chats, direct messaging, image and video sharing, liking and emoji reactions, event planning and calendar integration, polls and voting within groups, group galleries for shared media, @mentions and topic tagging, GroupMe bots and integrations, split expense tracking, mute and Do Not Disturb per group, group member management (add, remove, promote), cross-platform messaging (mobile, desktop, web), SMS fallback for members without the app, push notifications per group, and free model with no premium tier.
...
- Preserve the functional job behind GroupMe while using original product naming, original UI, original sample data, and licensed integrations.
...
- Do not copy GroupMe branding, logos, screenshots, marketing copy, private APIs, proprietary datasets, plan names, UI trade dress, course libraries, textbook solutions, documents, school content, AI prompts, or protected media.
...
|---|---|---|---|
| Apple App Store | https://apps.apple.com/us/app/groupme/id392796698 | iOS listing, privacy labels, release notes, group messaging claims, and support links | Verified public URL or explicit platform blocker on 2026-05-06; hands-on native behavior still blocked. |
| Google Play | https://play.google.com/store/apps/details?id=com.groupme.android | Android listing, data safety, group messaging/SMS claims, and release cadence | Verified public URL or explicit platform blocker on 2026-05-06; hands-on native behavior still blocked. |
| Official product site | https://groupme.com/ | GroupMe group messaging, SMS integration, and product positioning | Verified public URL or explicit platform blocker on 2026-05-06; hands-on native behavior still blocked. |
| Official help | https://support.microsoft.com/en-us/groupme | GroupMe app help, groups, messaging, and troubleshooting | Verified public URL or explicit platform blocker on 2026-05-06; hands-on native behavior still blocked. |
| Privacy policy | https://privacy.microsoft.com/privacystatement | Microsoft/GroupMe data collection, messaging data, and privacy disclosures | Verified public URL or explicit platform blocker on 2026-05-06; hands-on native behavior still blocked. |
| Terms | https://www.microsoft.com/servicesagreement | Microsoft/GroupMe services, messaging policies, and acceptable-use boundaries | Verified public URL or explicit platform blocker on 2026-05-06; hands-on native behavior still blocked. |
...
- Manual blockers must remain launch-blocking until verified: GroupMe/Microsoft account and phone number verification, SMS-integrated group chat delivery (SMS fallback for non-app users, carrier costs), group creation and member management at scale, image and video sharing with media hosting and CDN, liking and emoji reaction sync across platforms, event planning and calendar integration (timezone handling, RSVP), polls creation and real-time vote tallying, group gallery aggregation and storage, @mentions and notification routing, GroupMe bot platform and webhook API, expense splitting and payment tracking integration, per-group mute and Do Not Disturb scheduling, cross-platform message sync (mobile, desktop, web, SMS), SMS fallback delivery and carrier compatibility, push notification categories per group, group size limits and performance, content moderation for group-generated content, Microsoft account integration and SSO, spam prevention for group invites, and GroupMe account integration.

## Core User Journeys

- User creates or restores a GroupMe-style account, completes role, school, subscription, or tenant checks, and reaches the dashboard.
...
- Monetization model: use original free/trial/paid/sponsored/school/provider/tenant entitlement logic; do not copy exact pricing, plan names, bundle names, promotional copy, school contracts, tenant offers, or partner offers from GroupMe.
...
- Manual verification tests for GroupMe/Microsoft account and phone number verification, SMS-integrated group chat delivery (SMS fallback for non-app users, carrier costs), group creation and member management at scale, image and video sharing with media hosting and CDN, liking and emoji reaction sync across platforms, event planning and calendar integration (timezone handling, RSVP), polls creation and real-time vote tallying, group gallery aggregation and storage, @mentions and notification routing, GroupMe bot platform and webhook API, expense splitting and payment tracking integration, per-group mute and Do Not Disturb scheduling, cross-platform message sync (mobile, desktop, web, SMS), SMS fallback delivery and carrier compatibility, push notification categories per group, group size limits and performance, content moderation for group-generated content, Microsoft account integration and SSO, spam prevention for group invites, and GroupMe account integration.
...
- Phase 4: Add app-specific safety controls for group messaging platform with SMS-integrated group chats, direct messaging, image and video sharing, liking and emoji reactions, event planning and calendar integration, polls and voting within groups, group galleries for shared media, @mentions and topic tagging, GroupMe bots and integrations, split expense tracking, mute and Do Not Disturb per group, group member management (add, remove, promote), cross-platform messaging (mobile, desktop, web), SMS fallback for members without the app, push notifications per group, and free model with no premium tier.
...
- Confirm legal/privacy retention behavior for GroupMe-style sensitive records and update API contracts before downstream implementation.
