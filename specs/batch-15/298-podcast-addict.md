# Podcast Addict-Style Clone Spec

> Metadata
> - Inspiration app: Podcast Addict
...
Build an original mobile podcast playback product inspired by Podcast Addict's public product and policy materials. V1 focuses on podcast/radio/audiobook/RSS discovery, subscriptions, episode queue, downloads/offline, playback automation, backups, ads, and premium gates. The clone must use original branding, original UI copy, original sample media, licensed providers/assets, and explicit disclosures when a feature is inferred from public materials rather than verified hands-on behavior.
...
- Support podcast/radio/audiobook/RSS discovery, subscriptions, episode queue, downloads/offline, playback automation, backups, ads, and premium gates with clear retry, recovery, unavailable, and rights-aware states.
...
- Do not imply affiliation with Podcast Addict or its publisher.
...
|---|---|---|---|
| Official product | https://podcastaddict.com/ | Public Podcast Addict product positioning, podcast/radio/audiobook discovery, playback, and premium surfaces | Verified 2026-05-04 |
| Help/FAQ | https://podcastaddict.com/faq | Public support and troubleshooting taxonomy for subscriptions, downloads, playback, backup, and settings | Verified 2026-05-04 |
| Privacy policy | https://podcastaddict.com/privacy | App, advertising, analytics, device, listening, account, and retention handling | Verified 2026-05-04 |
| Terms/contact | https://podcastaddict.com/contact | Public support/contact path and legal escalation starting point | Verified 2026-05-04 |
...
- Home must expose the latest meaningful podcast playback state, search/discovery, library or project access, settings, and degraded offline/account variants.
...
|---|---|---|---|---|
| Welcome / Import | Defines the welcome / import workflow for Podcast Addict-inspired podcast playback behavior | taps, forms, search, deep links, permissions, media controls | empty, loading, loaded, signed-out, offline |
| Home / Inbox | Defines the home / inbox workflow for Podcast Addict-inspired podcast playback behavior | taps, forms, search, deep links, permissions, media controls | empty, loading, loaded, signed-out, offline |
| Discover / Search | Defines the discover / search workflow for Podcast Addict-inspired podcast playback behavior | taps, forms, search, deep links, permissions, media controls | empty, loading, loaded, signed-out, offline |
| Podcast Detail | Defines the podcast detail workflow for Podcast Addict-inspired podcast playback behavior | taps, forms, search, deep links, permissions, media controls | empty, loading, loaded, signed-out, offline |
| Episode Detail | Defines the episode detail workflow for Podcast Addict-inspired podcast playback behavior | taps, forms, search, deep links, permissions, media controls | empty, loading, loaded, signed-out, offline |
| Queue / Playlist | Defines the queue / playlist workflow for Podcast Addict-inspired podcast playback behavior | taps, forms, search, deep links, permissions, media controls | empty, loading, loaded, signed-out, offline |
| Now Playing | Defines the now playing workflow for Podcast Addict-inspired podcast playback behavior | taps, forms, search, deep links, permissions, media controls | empty, loading, loaded, signed-out, offline |
| Downloads | Defines the downloads workflow for Podcast Addict-inspired podcast playback behavior | taps, forms, search, deep links, permissions, media controls | empty, loading, loaded, signed-out, offline |
| Filters / Automation | Defines the filters / automation workflow for Podcast Addict-inspired podcast playback behavior | taps, forms, search, deep links, permissions, media controls | empty, loading, loaded, signed-out, offline |
| Subscription / Premium | Defines the subscription / premium workflow for Podcast Addict-inspired podcast playback behavior | taps, forms, search, deep links, permissions, media controls | empty, loading, loaded, signed-out, offline |
| Notifications | Defines the notifications workflow for Podcast Addict-inspired podcast playback behavior | taps, forms, search, deep links, permissions, media controls | empty, loading, loaded, signed-out, offline |
| Settings / Privacy | Defines the settings / privacy workflow for Podcast Addict-inspired podcast playback behavior | taps, forms, search, deep links, permissions, media controls | empty, loading, loaded, signed-out, offline |
| Support | Defines the support workflow for Podcast Addict-inspired podcast playback behavior | taps, forms, search, deep links, permissions, media controls | empty, loading, loaded, signed-out, offline |
| Data Export / Delete | Defines the data export / delete workflow for Podcast Addict-inspired podcast playback behavior | taps, forms, search, deep links, permissions, media controls | empty, loading, loaded, signed-out, offline |

## Data Model

- `User`: owner, lifecycle state, authorization boundary, sync state, retention policy, deletion/export behavior, and audit metadata for Podcast Addict-inspired podcast playback workflows.
- `AccountSession`: owner, lifecycle state, authorization boundary, sync state, retention policy, deletion/export behavior, and audit metadata for Podcast Addict-inspired podcast playback workflows.
- `LibraryItem`: owner, lifecycle state, authorization boundary, sync state, retention policy, deletion/export behavior, and audit metadata for Podcast Addict-inspired podcast playback workflows.
- `CatalogOrFeedItem`: owner, lifecycle state, authorization boundary, sync state, retention policy, deletion/export behavior, and audit metadata for Podcast Addict-inspired podcast playback workflows.
- `CreatorOrSource`: owner, lifecycle state, authorization boundary, sync state, retention policy, deletion/export behavior, and audit metadata for Podcast Addict-inspired podcast playback workflows.
- `PlaybackSession`: owner, lifecycle state, authorization boundary, sync state, retention policy, deletion/export behavior, and audit metadata for Podcast Addict-inspired podcast playback workflows.
- `QueueOrProject`: owner, lifecycle state, authorization boundary, sync state, retention policy, deletion/export behavior, and audit metadata for Podcast Addict-inspired podcast playback workflows.
- `MediaAsset`: owner, lifecycle state, authorization boundary, sync state, retention policy, deletion/export behavior, and audit metadata for Podcast Addict-inspired podcast playback workflows.
- `ImportOrUpload`: owner, lifecycle state, authorization boundary, sync state, retention policy, deletion/export behavior, and audit metadata for Podcast Addict-inspired podcast playback workflows.
- `ProviderJob`: owner, lifecycle state, authorization boundary, sync state, retention policy, deletion/export behavior, and audit metadata for Podcast Addict-inspired podcast playback workflows.
- `Entitlement`: owner, lifecycle state, authorization boundary, sync state, retention policy, deletion/export behavior, and audit metadata for Podcast Addict-inspired podcast playback workflows.
- `NotificationPreference`: owner, lifecycle state, authorization boundary, sync state, retention policy, deletion/export behavior, and audit metadata for Podcast Addict-inspired podcast playback workflows.
- `RightsOrSafetyReport`: owner, lifecycle state, authorization boundary, sync state, retention policy, deletion/export behavior, and audit metadata for Podcast Addict-inspired podcast playback workflows.
- `SupportCase`: owner, lifecycle state, authorization boundary, sync state, retention policy, deletion/export behavior, and audit metadata for Podcast Addict-inspired podcast playback workflows.
- `AuditEvent`: owner, lifecycle state, authorization boundary, sync state, retention policy, deletion/export behavior, and audit metadata for Podcast Addict-inspired podcast playback workflows.
- `LocalCacheRecord`: owner, lifecycle state, authorization boundary, sync state, retention policy, deletion/export behavior, and audit metadata for Podcast Addict-inspired podcast playback workflows.
