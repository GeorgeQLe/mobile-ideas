# Voloco-Style Clone Spec

> Metadata
> - Inspiration app: Voloco
...
Build an original mobile mobile music creation product inspired by Voloco's public product and policy materials. V1 focuses on vocal recording, pitch correction, voice effects, beats, projects, exports, sharing, and subscription/asset gates. The clone must use original branding, original UI copy, original sample media, licensed providers/assets, and explicit disclosures when a feature is inferred from public materials rather than verified hands-on behavior.
...
- Support vocal recording, pitch correction, voice effects, beats, projects, exports, sharing, and subscription/asset gates with clear retry, recovery, unavailable, and rights-aware states.
...
- Do not imply affiliation with Voloco or its publisher.
...
|---|---|---|---|
| Official product | https://voloco.com/ | Public Voloco product positioning, recording, effects, beats, and creator workflows | Verified 2026-05-04 |
| App Store listing | https://apps.apple.com/us/app/voloco-vocal-recording-studio/id1052970183 | Canonical iOS listing, privacy label, subscription, age, and release metadata | Verified 2026-05-04 |
| Privacy policy | https://voloco.com/privacy | Application, account, device, advertising, analytics, purchase, and retention handling | Verified 2026-05-04 |
| Terms of use | https://voloco.com/terms | User content, subscriptions, acceptable use, and legal boundaries | Verified 2026-05-04 |
...
|---|---|---|---|---|
| Welcome / Auth | Defines the welcome / auth workflow for Voloco-inspired mobile music creation behavior | taps, forms, search, deep links, permissions, media controls | empty, loading, loaded, signed-out, offline |
| Project Browser | Defines the project browser workflow for Voloco-inspired mobile music creation behavior | taps, forms, search, deep links, permissions, media controls | empty, loading, loaded, signed-out, offline |
| Template / Instrument Picker | Defines the template / instrument picker workflow for Voloco-inspired mobile music creation behavior | taps, forms, search, deep links, permissions, media controls | empty, loading, loaded, signed-out, offline |
| Studio Timeline | Defines the studio timeline workflow for Voloco-inspired mobile music creation behavior | taps, forms, search, deep links, permissions, media controls | empty, loading, loaded, signed-out, offline |
| Track Detail | Defines the track detail workflow for Voloco-inspired mobile music creation behavior | taps, forms, search, deep links, permissions, media controls | empty, loading, loaded, signed-out, offline |
| Loop / Beat Library | Defines the loop / beat library workflow for Voloco-inspired mobile music creation behavior | taps, forms, search, deep links, permissions, media controls | empty, loading, loaded, signed-out, offline |
| Recorder | Defines the recorder workflow for Voloco-inspired mobile music creation behavior | taps, forms, search, deep links, permissions, media controls | empty, loading, loaded, signed-out, offline |
| Mixer / Effects | Defines the mixer / effects workflow for Voloco-inspired mobile music creation behavior | taps, forms, search, deep links, permissions, media controls | empty, loading, loaded, signed-out, offline |
| Collaboration | Defines the collaboration workflow for Voloco-inspired mobile music creation behavior | taps, forms, search, deep links, permissions, media controls | empty, loading, loaded, signed-out, offline |
| Preview / Share | Defines the preview / share workflow for Voloco-inspired mobile music creation behavior | taps, forms, search, deep links, permissions, media controls | empty, loading, loaded, signed-out, offline |
| Export | Defines the export workflow for Voloco-inspired mobile music creation behavior | taps, forms, search, deep links, permissions, media controls | empty, loading, loaded, signed-out, offline |
| Subscription / Assets | Defines the subscription / assets workflow for Voloco-inspired mobile music creation behavior | taps, forms, search, deep links, permissions, media controls | empty, loading, loaded, signed-out, offline |
| Settings / Privacy | Defines the settings / privacy workflow for Voloco-inspired mobile music creation behavior | taps, forms, search, deep links, permissions, media controls | empty, loading, loaded, signed-out, offline |
| Support / Reports | Defines the support / reports workflow for Voloco-inspired mobile music creation behavior | taps, forms, search, deep links, permissions, media controls | empty, loading, loaded, signed-out, offline |

## Data Model

- `User`: owner, lifecycle state, authorization boundary, sync state, retention policy, deletion/export behavior, and audit metadata for Voloco-inspired mobile music creation workflows.
- `AccountSession`: owner, lifecycle state, authorization boundary, sync state, retention policy, deletion/export behavior, and audit metadata for Voloco-inspired mobile music creation workflows.
- `LibraryItem`: owner, lifecycle state, authorization boundary, sync state, retention policy, deletion/export behavior, and audit metadata for Voloco-inspired mobile music creation workflows.
- `CatalogOrFeedItem`: owner, lifecycle state, authorization boundary, sync state, retention policy, deletion/export behavior, and audit metadata for Voloco-inspired mobile music creation workflows.
- `CreatorOrSource`: owner, lifecycle state, authorization boundary, sync state, retention policy, deletion/export behavior, and audit metadata for Voloco-inspired mobile music creation workflows.
- `PlaybackSession`: owner, lifecycle state, authorization boundary, sync state, retention policy, deletion/export behavior, and audit metadata for Voloco-inspired mobile music creation workflows.
- `QueueOrProject`: owner, lifecycle state, authorization boundary, sync state, retention policy, deletion/export behavior, and audit metadata for Voloco-inspired mobile music creation workflows.
- `MediaAsset`: owner, lifecycle state, authorization boundary, sync state, retention policy, deletion/export behavior, and audit metadata for Voloco-inspired mobile music creation workflows.
- `ImportOrUpload`: owner, lifecycle state, authorization boundary, sync state, retention policy, deletion/export behavior, and audit metadata for Voloco-inspired mobile music creation workflows.
- `ProviderJob`: owner, lifecycle state, authorization boundary, sync state, retention policy, deletion/export behavior, and audit metadata for Voloco-inspired mobile music creation workflows.
- `Entitlement`: owner, lifecycle state, authorization boundary, sync state, retention policy, deletion/export behavior, and audit metadata for Voloco-inspired mobile music creation workflows.
- `NotificationPreference`: owner, lifecycle state, authorization boundary, sync state, retention policy, deletion/export behavior, and audit metadata for Voloco-inspired mobile music creation workflows.
- `RightsOrSafetyReport`: owner, lifecycle state, authorization boundary, sync state, retention policy, deletion/export behavior, and audit metadata for Voloco-inspired mobile music creation workflows.
- `SupportCase`: owner, lifecycle state, authorization boundary, sync state, retention policy, deletion/export behavior, and audit metadata for Voloco-inspired mobile music creation workflows.
- `AuditEvent`: owner, lifecycle state, authorization boundary, sync state, retention policy, deletion/export behavior, and audit metadata for Voloco-inspired mobile music creation workflows.
- `LocalCacheRecord`: owner, lifecycle state, authorization boundary, sync state, retention policy, deletion/export behavior, and audit metadata for Voloco-inspired mobile music creation workflows.
