# Overcast-Style Clone Spec

> Metadata
> - Inspiration app: Overcast
...
Build an original mobile podcast playback product inspired by Overcast's public product and policy materials. V1 focuses on podcast discovery, subscriptions, episode queue, smart playlists, downloads/offline, playback enhancements, watch/CarPlay, ads, and premium gates. The clone must use original branding, original UI copy, original sample media, licensed providers/assets, and explicit disclosures when a feature is inferred from public materials rather than verified hands-on behavior.
...
- Support podcast discovery, subscriptions, episode queue, smart playlists, downloads/offline, playback enhancements, watch/CarPlay, ads, and premium gates with clear retry, recovery, unavailable, and rights-aware states.
...
- Do not imply affiliation with Overcast or its publisher.
...
|---|---|---|---|
| Official product | https://overcast.fm/ | Public Overcast product positioning, podcast playback, sync, account, and premium surfaces | Verified 2026-05-04 |
| App Store listing | https://apps.apple.com/us/app/overcast/id888422857 | Canonical iOS listing, feature claims, privacy label, age rating, compatibility, and subscription metadata | Verified 2026-05-04 |
| Privacy policy | https://overcast.fm/privacy | Account, playback, sync, analytics, ads, premium, and retention handling | Verified 2026-05-04 |
| Terms of use | https://overcast.fm/terms | App usage, subscriptions, children boundary, and legal terms | Verified 2026-05-04 |
...
|---|---|---|---|---|
| Welcome / Import | Defines the welcome / import workflow for Overcast-inspired podcast playback behavior | taps, forms, search, deep links, permissions, media controls | empty, loading, loaded, signed-out, offline |
| Home / Inbox | Defines the home / inbox workflow for Overcast-inspired podcast playback behavior | taps, forms, search, deep links, permissions, media controls | empty, loading, loaded, signed-out, offline |
| Discover / Search | Defines the discover / search workflow for Overcast-inspired podcast playback behavior | taps, forms, search, deep links, permissions, media controls | empty, loading, loaded, signed-out, offline |
| Podcast Detail | Defines the podcast detail workflow for Overcast-inspired podcast playback behavior | taps, forms, search, deep links, permissions, media controls | empty, loading, loaded, signed-out, offline |
| Episode Detail | Defines the episode detail workflow for Overcast-inspired podcast playback behavior | taps, forms, search, deep links, permissions, media controls | empty, loading, loaded, signed-out, offline |
| Queue / Playlist | Defines the queue / playlist workflow for Overcast-inspired podcast playback behavior | taps, forms, search, deep links, permissions, media controls | empty, loading, loaded, signed-out, offline |
| Now Playing | Defines the now playing workflow for Overcast-inspired podcast playback behavior | taps, forms, search, deep links, permissions, media controls | empty, loading, loaded, signed-out, offline |
| Downloads | Defines the downloads workflow for Overcast-inspired podcast playback behavior | taps, forms, search, deep links, permissions, media controls | empty, loading, loaded, signed-out, offline |
| Filters / Automation | Defines the filters / automation workflow for Overcast-inspired podcast playback behavior | taps, forms, search, deep links, permissions, media controls | empty, loading, loaded, signed-out, offline |
| Subscription / Premium | Defines the subscription / premium workflow for Overcast-inspired podcast playback behavior | taps, forms, search, deep links, permissions, media controls | empty, loading, loaded, signed-out, offline |
| Notifications | Defines the notifications workflow for Overcast-inspired podcast playback behavior | taps, forms, search, deep links, permissions, media controls | empty, loading, loaded, signed-out, offline |
| Settings / Privacy | Defines the settings / privacy workflow for Overcast-inspired podcast playback behavior | taps, forms, search, deep links, permissions, media controls | empty, loading, loaded, signed-out, offline |
| Support | Defines the support workflow for Overcast-inspired podcast playback behavior | taps, forms, search, deep links, permissions, media controls | empty, loading, loaded, signed-out, offline |
| Data Export / Delete | Defines the data export / delete workflow for Overcast-inspired podcast playback behavior | taps, forms, search, deep links, permissions, media controls | empty, loading, loaded, signed-out, offline |

## Data Model

- `User`: owner, lifecycle state, authorization boundary, sync state, retention policy, deletion/export behavior, and audit metadata for Overcast-inspired podcast playback workflows.
- `AccountSession`: owner, lifecycle state, authorization boundary, sync state, retention policy, deletion/export behavior, and audit metadata for Overcast-inspired podcast playback workflows.
- `LibraryItem`: owner, lifecycle state, authorization boundary, sync state, retention policy, deletion/export behavior, and audit metadata for Overcast-inspired podcast playback workflows.
- `CatalogOrFeedItem`: owner, lifecycle state, authorization boundary, sync state, retention policy, deletion/export behavior, and audit metadata for Overcast-inspired podcast playback workflows.
- `CreatorOrSource`: owner, lifecycle state, authorization boundary, sync state, retention policy, deletion/export behavior, and audit metadata for Overcast-inspired podcast playback workflows.
- `PlaybackSession`: owner, lifecycle state, authorization boundary, sync state, retention policy, deletion/export behavior, and audit metadata for Overcast-inspired podcast playback workflows.
- `QueueOrProject`: owner, lifecycle state, authorization boundary, sync state, retention policy, deletion/export behavior, and audit metadata for Overcast-inspired podcast playback workflows.
- `MediaAsset`: owner, lifecycle state, authorization boundary, sync state, retention policy, deletion/export behavior, and audit metadata for Overcast-inspired podcast playback workflows.
- `ImportOrUpload`: owner, lifecycle state, authorization boundary, sync state, retention policy, deletion/export behavior, and audit metadata for Overcast-inspired podcast playback workflows.
- `ProviderJob`: owner, lifecycle state, authorization boundary, sync state, retention policy, deletion/export behavior, and audit metadata for Overcast-inspired podcast playback workflows.
- `Entitlement`: owner, lifecycle state, authorization boundary, sync state, retention policy, deletion/export behavior, and audit metadata for Overcast-inspired podcast playback workflows.
- `NotificationPreference`: owner, lifecycle state, authorization boundary, sync state, retention policy, deletion/export behavior, and audit metadata for Overcast-inspired podcast playback workflows.
- `RightsOrSafetyReport`: owner, lifecycle state, authorization boundary, sync state, retention policy, deletion/export behavior, and audit metadata for Overcast-inspired podcast playback workflows.
- `SupportCase`: owner, lifecycle state, authorization boundary, sync state, retention policy, deletion/export behavior, and audit metadata for Overcast-inspired podcast playback workflows.
- `AuditEvent`: owner, lifecycle state, authorization boundary, sync state, retention policy, deletion/export behavior, and audit metadata for Overcast-inspired podcast playback workflows.
- `LocalCacheRecord`: owner, lifecycle state, authorization boundary, sync state, retention policy, deletion/export behavior, and audit metadata for Overcast-inspired podcast playback workflows.
