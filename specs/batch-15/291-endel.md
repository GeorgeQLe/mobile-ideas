# Endel-Style Clone Spec

> Metadata
> - Inspiration app: Endel
...
Build an original mobile wellness audio product inspired by Endel's public product and policy materials. V1 focuses on personalized soundscapes, focus/relax/sleep sessions, timer/routine state, wearable/context signals, subscriptions, and wellness disclaimers. The clone must use original branding, original UI copy, original sample media, licensed providers/assets, and explicit disclosures when a feature is inferred from public materials rather than verified hands-on behavior.
...
- Support personalized soundscapes, focus/relax/sleep sessions, timer/routine state, wearable/context signals, subscriptions, and wellness disclaimers with clear retry, recovery, unavailable, and rights-aware states.
...
- Do not imply affiliation with Endel or its publisher.
...
|---|---|---|---|
| Official product | https://endel.io/ | Public Endel product positioning, personalized soundscapes, use cases, and app surfaces | Verified 2026-05-04 |
| Help center | https://endel.zendesk.com/hc/en-us | Public support taxonomy for account, subscriptions, app usage, integrations, and troubleshooting | Verified 2026-05-04 |
| Privacy policy | https://endel.io/privacy-policy | App, account, payment, activity, wearable, newsletter, retention, GDPR/CCPA, and user-rights handling | Verified 2026-05-04 |
| Terms of use | https://endel.io/terms | Subscription, app use, wellness boundaries, acceptable use, and legal terms | Verified 2026-05-04 |
...
|---|---|---|---|---|
| Welcome / Consent | Defines the welcome / consent workflow for Endel-inspired wellness audio behavior | taps, forms, search, deep links, permissions, media controls | empty, loading, loaded, signed-out, offline |
| Home / Today | Defines the home / today workflow for Endel-inspired wellness audio behavior | taps, forms, search, deep links, permissions, media controls | empty, loading, loaded, signed-out, offline |
| Goal Picker | Defines the goal picker workflow for Endel-inspired wellness audio behavior | taps, forms, search, deep links, permissions, media controls | empty, loading, loaded, signed-out, offline |
| Session Detail | Defines the session detail workflow for Endel-inspired wellness audio behavior | taps, forms, search, deep links, permissions, media controls | empty, loading, loaded, signed-out, offline |
| Now Playing | Defines the now playing workflow for Endel-inspired wellness audio behavior | taps, forms, search, deep links, permissions, media controls | empty, loading, loaded, signed-out, offline |
| Timer / Routine | Defines the timer / routine workflow for Endel-inspired wellness audio behavior | taps, forms, search, deep links, permissions, media controls | empty, loading, loaded, signed-out, offline |
| Personalization | Defines the personalization workflow for Endel-inspired wellness audio behavior | taps, forms, search, deep links, permissions, media controls | empty, loading, loaded, signed-out, offline |
| History / Insights | Defines the history / insights workflow for Endel-inspired wellness audio behavior | taps, forms, search, deep links, permissions, media controls | empty, loading, loaded, signed-out, offline |
| Offline Library | Defines the offline library workflow for Endel-inspired wellness audio behavior | taps, forms, search, deep links, permissions, media controls | empty, loading, loaded, signed-out, offline |
| Subscription | Defines the subscription workflow for Endel-inspired wellness audio behavior | taps, forms, search, deep links, permissions, media controls | empty, loading, loaded, signed-out, offline |
| Notifications | Defines the notifications workflow for Endel-inspired wellness audio behavior | taps, forms, search, deep links, permissions, media controls | empty, loading, loaded, signed-out, offline |
| Settings / Privacy | Defines the settings / privacy workflow for Endel-inspired wellness audio behavior | taps, forms, search, deep links, permissions, media controls | empty, loading, loaded, signed-out, offline |
| Support | Defines the support workflow for Endel-inspired wellness audio behavior | taps, forms, search, deep links, permissions, media controls | empty, loading, loaded, signed-out, offline |
| Safety / Disclaimers | Defines the safety / disclaimers workflow for Endel-inspired wellness audio behavior | taps, forms, search, deep links, permissions, media controls | empty, loading, loaded, signed-out, offline |

## Data Model

- `User`: owner, lifecycle state, authorization boundary, sync state, retention policy, deletion/export behavior, and audit metadata for Endel-inspired wellness audio workflows.
- `AccountSession`: owner, lifecycle state, authorization boundary, sync state, retention policy, deletion/export behavior, and audit metadata for Endel-inspired wellness audio workflows.
- `LibraryItem`: owner, lifecycle state, authorization boundary, sync state, retention policy, deletion/export behavior, and audit metadata for Endel-inspired wellness audio workflows.
- `CatalogOrFeedItem`: owner, lifecycle state, authorization boundary, sync state, retention policy, deletion/export behavior, and audit metadata for Endel-inspired wellness audio workflows.
- `CreatorOrSource`: owner, lifecycle state, authorization boundary, sync state, retention policy, deletion/export behavior, and audit metadata for Endel-inspired wellness audio workflows.
- `PlaybackSession`: owner, lifecycle state, authorization boundary, sync state, retention policy, deletion/export behavior, and audit metadata for Endel-inspired wellness audio workflows.
- `QueueOrProject`: owner, lifecycle state, authorization boundary, sync state, retention policy, deletion/export behavior, and audit metadata for Endel-inspired wellness audio workflows.
- `MediaAsset`: owner, lifecycle state, authorization boundary, sync state, retention policy, deletion/export behavior, and audit metadata for Endel-inspired wellness audio workflows.
- `ImportOrUpload`: owner, lifecycle state, authorization boundary, sync state, retention policy, deletion/export behavior, and audit metadata for Endel-inspired wellness audio workflows.
- `ProviderJob`: owner, lifecycle state, authorization boundary, sync state, retention policy, deletion/export behavior, and audit metadata for Endel-inspired wellness audio workflows.
- `Entitlement`: owner, lifecycle state, authorization boundary, sync state, retention policy, deletion/export behavior, and audit metadata for Endel-inspired wellness audio workflows.
- `NotificationPreference`: owner, lifecycle state, authorization boundary, sync state, retention policy, deletion/export behavior, and audit metadata for Endel-inspired wellness audio workflows.
- `RightsOrSafetyReport`: owner, lifecycle state, authorization boundary, sync state, retention policy, deletion/export behavior, and audit metadata for Endel-inspired wellness audio workflows.
- `SupportCase`: owner, lifecycle state, authorization boundary, sync state, retention policy, deletion/export behavior, and audit metadata for Endel-inspired wellness audio workflows.
- `AuditEvent`: owner, lifecycle state, authorization boundary, sync state, retention policy, deletion/export behavior, and audit metadata for Endel-inspired wellness audio workflows.
- `LocalCacheRecord`: owner, lifecycle state, authorization boundary, sync state, retention policy, deletion/export behavior, and audit metadata for Endel-inspired wellness audio workflows.
