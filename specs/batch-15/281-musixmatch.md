# Musixmatch-Style Clone Spec

> Metadata
> - Inspiration app: Musixmatch
...
Build an original mobile song recognition and lyrics product inspired by Musixmatch's public product and policy materials. V1 focuses on lyrics discovery, synchronized lyrics, song identification, translations, library saves, creator/lyrics contribution, and licensed rights gates. The clone must use original branding, original UI copy, original sample media, licensed providers/assets, and explicit disclosures when a feature is inferred from public materials rather than verified hands-on behavior.
...
- Support lyrics discovery, synchronized lyrics, song identification, translations, library saves, creator/lyrics contribution, and licensed rights gates with clear retry, recovery, unavailable, and rights-aware states.
...
- Do not imply affiliation with Musixmatch or its publisher.
...
|---|---|---|---|
| Official product | https://www.musixmatch.com/ | Public lyrics, identification, translation, contribution, and product positioning | Verified 2026-05-04 |
| Help center | https://support.musixmatch.com/ | Public support taxonomy for accounts, lyrics, subscriptions, troubleshooting, and contributor workflows | Verified 2026-05-04 |
| Privacy policy | https://www.musixmatch.com/privacy-policy | Account, device, audio, usage, provider, retention, and rights handling | Verified 2026-05-04 |
| Terms/legal | https://www.musixmatch.com/terms-and-conditions | User content, lyric rights, acceptable use, subscriptions, and legal boundaries | Verified 2026-05-04 |
...
- Onboarding must support signed-out preview, account creation or restore, blocked-account state, unavailable-region state, and entitlement-unavailable state for song recognition and lyrics workflows.
- Home must expose the latest meaningful song recognition and lyrics state, search/discovery, library or project access, settings, and degraded offline/account variants.
...
- Audio recognition and lyrics sync must minimize microphone capture, preserve opt-in consent, and never store raw audio beyond the documented provider need.
- Lyrics, translations, annotations, and contributions must preserve rights, attribution, moderation, takedown, and edit-history controls.
...
|---|---|---|---|---|
| Welcome / Auth | Defines the welcome / auth workflow for Musixmatch-inspired song recognition and lyrics behavior | taps, forms, search, deep links, permissions, media controls | empty, loading, loaded, signed-out, offline |
| Home | Defines the home workflow for Musixmatch-inspired song recognition and lyrics behavior | taps, forms, search, deep links, permissions, media controls | empty, loading, loaded, signed-out, offline |
| Recognize / Listen | Defines the recognize / listen workflow for Musixmatch-inspired song recognition and lyrics behavior | taps, forms, search, deep links, permissions, media controls | empty, loading, loaded, signed-out, offline |
| Search | Defines the search workflow for Musixmatch-inspired song recognition and lyrics behavior | taps, forms, search, deep links, permissions, media controls | empty, loading, loaded, signed-out, offline |
| Song Detail | Defines the song detail workflow for Musixmatch-inspired song recognition and lyrics behavior | taps, forms, search, deep links, permissions, media controls | empty, loading, loaded, signed-out, offline |
| Lyrics View | Defines the lyrics view workflow for Musixmatch-inspired song recognition and lyrics behavior | taps, forms, search, deep links, permissions, media controls | empty, loading, loaded, signed-out, offline |
| Translation | Defines the translation workflow for Musixmatch-inspired song recognition and lyrics behavior | taps, forms, search, deep links, permissions, media controls | empty, loading, loaded, signed-out, offline |
| Library / History | Defines the library / history workflow for Musixmatch-inspired song recognition and lyrics behavior | taps, forms, search, deep links, permissions, media controls | empty, loading, loaded, signed-out, offline |
| Contribution | Defines the contribution workflow for Musixmatch-inspired song recognition and lyrics behavior | taps, forms, search, deep links, permissions, media controls | empty, loading, loaded, signed-out, offline |
| Player Links | Defines the player links workflow for Musixmatch-inspired song recognition and lyrics behavior | taps, forms, search, deep links, permissions, media controls | empty, loading, loaded, signed-out, offline |
| Subscription | Defines the subscription workflow for Musixmatch-inspired song recognition and lyrics behavior | taps, forms, search, deep links, permissions, media controls | empty, loading, loaded, signed-out, offline |
| Notifications | Defines the notifications workflow for Musixmatch-inspired song recognition and lyrics behavior | taps, forms, search, deep links, permissions, media controls | empty, loading, loaded, signed-out, offline |
| Settings / Privacy | Defines the settings / privacy workflow for Musixmatch-inspired song recognition and lyrics behavior | taps, forms, search, deep links, permissions, media controls | empty, loading, loaded, signed-out, offline |
| Support / Reports | Defines the support / reports workflow for Musixmatch-inspired song recognition and lyrics behavior | taps, forms, search, deep links, permissions, media controls | empty, loading, loaded, signed-out, offline |

## Data Model

- `User`: owner, lifecycle state, authorization boundary, sync state, retention policy, deletion/export behavior, and audit metadata for Musixmatch-inspired song recognition and lyrics workflows.
- `AccountSession`: owner, lifecycle state, authorization boundary, sync state, retention policy, deletion/export behavior, and audit metadata for Musixmatch-inspired song recognition and lyrics workflows.
- `LibraryItem`: owner, lifecycle state, authorization boundary, sync state, retention policy, deletion/export behavior, and audit metadata for Musixmatch-inspired song recognition and lyrics workflows.
- `CatalogOrFeedItem`: owner, lifecycle state, authorization boundary, sync state, retention policy, deletion/export behavior, and audit metadata for Musixmatch-inspired song recognition and lyrics workflows.
- `CreatorOrSource`: owner, lifecycle state, authorization boundary, sync state, retention policy, deletion/export behavior, and audit metadata for Musixmatch-inspired song recognition and lyrics workflows.
- `PlaybackSession`: owner, lifecycle state, authorization boundary, sync state, retention policy, deletion/export behavior, and audit metadata for Musixmatch-inspired song recognition and lyrics workflows.
- `QueueOrProject`: owner, lifecycle state, authorization boundary, sync state, retention policy, deletion/export behavior, and audit metadata for Musixmatch-inspired song recognition and lyrics workflows.
- `MediaAsset`: owner, lifecycle state, authorization boundary, sync state, retention policy, deletion/export behavior, and audit metadata for Musixmatch-inspired song recognition and lyrics workflows.
- `ImportOrUpload`: owner, lifecycle state, authorization boundary, sync state, retention policy, deletion/export behavior, and audit metadata for Musixmatch-inspired song recognition and lyrics workflows.
- `ProviderJob`: owner, lifecycle state, authorization boundary, sync state, retention policy, deletion/export behavior, and audit metadata for Musixmatch-inspired song recognition and lyrics workflows.
- `Entitlement`: owner, lifecycle state, authorization boundary, sync state, retention policy, deletion/export behavior, and audit metadata for Musixmatch-inspired song recognition and lyrics workflows.
- `NotificationPreference`: owner, lifecycle state, authorization boundary, sync state, retention policy, deletion/export behavior, and audit metadata for Musixmatch-inspired song recognition and lyrics workflows.
- `RightsOrSafetyReport`: owner, lifecycle state, authorization boundary, sync state, retention policy, deletion/export behavior, and audit metadata for Musixmatch-inspired song recognition and lyrics workflows.
- `SupportCase`: owner, lifecycle state, authorization boundary, sync state, retention policy, deletion/export behavior, and audit metadata for Musixmatch-inspired song recognition and lyrics workflows.
- `AuditEvent`: owner, lifecycle state, authorization boundary, sync state, retention policy, deletion/export behavior, and audit metadata for Musixmatch-inspired song recognition and lyrics workflows.
- `LocalCacheRecord`: owner, lifecycle state, authorization boundary, sync state, retention policy, deletion/export behavior, and audit metadata for Musixmatch-inspired song recognition and lyrics workflows.
