# JBL Portable-Style Clone Spec

> Metadata
> - Inspiration app: JBL Portable
...
Build an original mobile audio hardware control product inspired by JBL Portable's public product and policy materials. V1 focuses on portable-speaker pairing, PartyBoost/stereo grouping, firmware updates, light/equalizer controls, Bluetooth permissions, and product state recovery. The clone must use original branding, original UI copy, original sample media, licensed providers/assets, and explicit disclosures when a feature is inferred from public materials rather than verified hands-on behavior.
...
- Support portable-speaker pairing, PartyBoost/stereo grouping, firmware updates, light/equalizer controls, Bluetooth permissions, and product state recovery with clear retry, recovery, unavailable, and rights-aware states.
...
- Do not imply affiliation with JBL Portable or its publisher.
...
|---|---|---|---|
| Official product | https://www.jbl.com/jblportable.html | Public JBL Portable app positioning, speaker controls, stereo/party features, and firmware surfaces | Verified 2026-05-04 |
| Support center | https://support.jbl.com/ | Public JBL product/app support taxonomy for pairing, updates, controls, and troubleshooting | Verified 2026-05-04 |
| Privacy policy | https://www.jbl.com/privacy-policy.html | HARMAN/JBL services, applications, product/device, usage, cookies, and personal-data handling | Verified 2026-05-04 |
| Terms of use | https://www.harman.com/terms-use | HARMAN service usage, legal boundaries, and linked service terms | Verified 2026-05-04 |
...
- Onboarding must support signed-out preview, account creation or restore, blocked-account state, unavailable-region state, and entitlement-unavailable state for audio hardware control workflows.
- Home must expose the latest meaningful audio hardware control state, search/discovery, library or project access, settings, and degraded offline/account variants.
...
- Hardware setup must require explicit local-network, Bluetooth, location, and product-account consent only when the user starts setup or control.
- Firmware updates must show compatibility, battery/power, rollback, interruption, and warranty-support warnings before device mutation.
...
|---|---|---|---|---|
| Welcome / Account | Defines the welcome / account workflow for JBL Portable-inspired audio hardware control behavior | taps, forms, search, deep links, permissions, media controls | empty, loading, loaded, signed-out, offline |
| Product Setup | Defines the product setup workflow for JBL Portable-inspired audio hardware control behavior | taps, forms, search, deep links, permissions, media controls | empty, loading, loaded, signed-out, offline |
| Device Discovery | Defines the device discovery workflow for JBL Portable-inspired audio hardware control behavior | taps, forms, search, deep links, permissions, media controls | empty, loading, loaded, signed-out, offline |
| Room / Speaker List | Defines the room / speaker list workflow for JBL Portable-inspired audio hardware control behavior | taps, forms, search, deep links, permissions, media controls | empty, loading, loaded, signed-out, offline |
| Now Playing | Defines the now playing workflow for JBL Portable-inspired audio hardware control behavior | taps, forms, search, deep links, permissions, media controls | empty, loading, loaded, signed-out, offline |
| Device Detail | Defines the device detail workflow for JBL Portable-inspired audio hardware control behavior | taps, forms, search, deep links, permissions, media controls | empty, loading, loaded, signed-out, offline |
| EQ / Sound Controls | Defines the eq / sound controls workflow for JBL Portable-inspired audio hardware control behavior | taps, forms, search, deep links, permissions, media controls | empty, loading, loaded, signed-out, offline |
| Grouping / Party Mode | Defines the grouping / party mode workflow for JBL Portable-inspired audio hardware control behavior | taps, forms, search, deep links, permissions, media controls | empty, loading, loaded, signed-out, offline |
| Music Services | Defines the music services workflow for JBL Portable-inspired audio hardware control behavior | taps, forms, search, deep links, permissions, media controls | empty, loading, loaded, signed-out, offline |
| Firmware Update | Defines the firmware update workflow for JBL Portable-inspired audio hardware control behavior | taps, forms, search, deep links, permissions, media controls | empty, loading, loaded, signed-out, offline |
| Notifications | Defines the notifications workflow for JBL Portable-inspired audio hardware control behavior | taps, forms, search, deep links, permissions, media controls | empty, loading, loaded, signed-out, offline |
| Settings / Privacy | Defines the settings / privacy workflow for JBL Portable-inspired audio hardware control behavior | taps, forms, search, deep links, permissions, media controls | empty, loading, loaded, signed-out, offline |
| Support | Defines the support workflow for JBL Portable-inspired audio hardware control behavior | taps, forms, search, deep links, permissions, media controls | empty, loading, loaded, signed-out, offline |
| Safety / Diagnostics | Defines the safety / diagnostics workflow for JBL Portable-inspired audio hardware control behavior | taps, forms, search, deep links, permissions, media controls | empty, loading, loaded, signed-out, offline |

## Data Model

- `User`: owner, lifecycle state, authorization boundary, sync state, retention policy, deletion/export behavior, and audit metadata for JBL Portable-inspired audio hardware control workflows.
- `AccountSession`: owner, lifecycle state, authorization boundary, sync state, retention policy, deletion/export behavior, and audit metadata for JBL Portable-inspired audio hardware control workflows.
- `LibraryItem`: owner, lifecycle state, authorization boundary, sync state, retention policy, deletion/export behavior, and audit metadata for JBL Portable-inspired audio hardware control workflows.
- `CatalogOrFeedItem`: owner, lifecycle state, authorization boundary, sync state, retention policy, deletion/export behavior, and audit metadata for JBL Portable-inspired audio hardware control workflows.
- `CreatorOrSource`: owner, lifecycle state, authorization boundary, sync state, retention policy, deletion/export behavior, and audit metadata for JBL Portable-inspired audio hardware control workflows.
- `PlaybackSession`: owner, lifecycle state, authorization boundary, sync state, retention policy, deletion/export behavior, and audit metadata for JBL Portable-inspired audio hardware control workflows.
- `QueueOrProject`: owner, lifecycle state, authorization boundary, sync state, retention policy, deletion/export behavior, and audit metadata for JBL Portable-inspired audio hardware control workflows.
- `MediaAsset`: owner, lifecycle state, authorization boundary, sync state, retention policy, deletion/export behavior, and audit metadata for JBL Portable-inspired audio hardware control workflows.
- `ImportOrUpload`: owner, lifecycle state, authorization boundary, sync state, retention policy, deletion/export behavior, and audit metadata for JBL Portable-inspired audio hardware control workflows.
- `ProviderJob`: owner, lifecycle state, authorization boundary, sync state, retention policy, deletion/export behavior, and audit metadata for JBL Portable-inspired audio hardware control workflows.
- `Entitlement`: owner, lifecycle state, authorization boundary, sync state, retention policy, deletion/export behavior, and audit metadata for JBL Portable-inspired audio hardware control workflows.
- `NotificationPreference`: owner, lifecycle state, authorization boundary, sync state, retention policy, deletion/export behavior, and audit metadata for JBL Portable-inspired audio hardware control workflows.
- `RightsOrSafetyReport`: owner, lifecycle state, authorization boundary, sync state, retention policy, deletion/export behavior, and audit metadata for JBL Portable-inspired audio hardware control workflows.
- `SupportCase`: owner, lifecycle state, authorization boundary, sync state, retention policy, deletion/export behavior, and audit metadata for JBL Portable-inspired audio hardware control workflows.
- `AuditEvent`: owner, lifecycle state, authorization boundary, sync state, retention policy, deletion/export behavior, and audit metadata for JBL Portable-inspired audio hardware control workflows.
- `LocalCacheRecord`: owner, lifecycle state, authorization boundary, sync state, retention policy, deletion/export behavior, and audit metadata for JBL Portable-inspired audio hardware control workflows.
