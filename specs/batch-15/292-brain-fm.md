# Brain.fm-Style Clone Spec

> Metadata
> - Inspiration app: Brain.fm
...
Build an original mobile wellness audio product inspired by Brain.fm's public product and policy materials. V1 focuses on functional music sessions, focus/relax/sleep modes, recommendations, science claims boundaries, offline playback, subscriptions, and privacy controls. The clone must use original branding, original UI copy, original sample media, licensed providers/assets, and explicit disclosures when a feature is inferred from public materials rather than verified hands-on behavior.
...
- Support functional music sessions, focus/relax/sleep modes, recommendations, science claims boundaries, offline playback, subscriptions, and privacy controls with clear retry, recovery, unavailable, and rights-aware states.
...
- Do not imply affiliation with Brain.fm or its publisher.
...
|---|---|---|---|
| Official product | https://www.brain.fm/ | Public Brain.fm product positioning, functional music categories, and app surfaces | Verified 2026-05-04 |
| Help center | https://help.brain.fm/ | Public support taxonomy for accounts, subscriptions, playback, science, and troubleshooting | Verified 2026-05-04 |
| Privacy policy | https://www.brain.fm/privacy | Account, app, survey, preference, device, usage, and retention handling | Verified 2026-05-04 |
| Terms and conditions | https://www.brain.fm/terms | Product usage, subscriptions, disclaimers, acceptable use, and legal terms | Verified 2026-05-04 |
...
- Onboarding must support signed-out preview, account creation or restore, blocked-account state, unavailable-region state, and entitlement-unavailable state for wellness audio workflows.
- Home must expose the latest meaningful wellness audio state, search/discovery, library or project access, settings, and degraded offline/account variants.
...
- Wellness positioning must avoid medical, therapeutic, cognitive-performance, sleep-treatment, or safety-critical claims beyond sourced public materials.
- Wearable, circadian, focus, motion, or location signals must be optional, minimized, revocable, and never required for basic playback.
...
|---|---|---|---|---|
| Welcome / Consent | Defines the welcome / consent workflow for Brain.fm-inspired wellness audio behavior | taps, forms, search, deep links, permissions, media controls | empty, loading, loaded, signed-out, offline |
| Home / Today | Defines the home / today workflow for Brain.fm-inspired wellness audio behavior | taps, forms, search, deep links, permissions, media controls | empty, loading, loaded, signed-out, offline |
| Goal Picker | Defines the goal picker workflow for Brain.fm-inspired wellness audio behavior | taps, forms, search, deep links, permissions, media controls | empty, loading, loaded, signed-out, offline |
| Session Detail | Defines the session detail workflow for Brain.fm-inspired wellness audio behavior | taps, forms, search, deep links, permissions, media controls | empty, loading, loaded, signed-out, offline |
| Now Playing | Defines the now playing workflow for Brain.fm-inspired wellness audio behavior | taps, forms, search, deep links, permissions, media controls | empty, loading, loaded, signed-out, offline |
| Timer / Routine | Defines the timer / routine workflow for Brain.fm-inspired wellness audio behavior | taps, forms, search, deep links, permissions, media controls | empty, loading, loaded, signed-out, offline |
| Personalization | Defines the personalization workflow for Brain.fm-inspired wellness audio behavior | taps, forms, search, deep links, permissions, media controls | empty, loading, loaded, signed-out, offline |
| History / Insights | Defines the history / insights workflow for Brain.fm-inspired wellness audio behavior | taps, forms, search, deep links, permissions, media controls | empty, loading, loaded, signed-out, offline |
| Offline Library | Defines the offline library workflow for Brain.fm-inspired wellness audio behavior | taps, forms, search, deep links, permissions, media controls | empty, loading, loaded, signed-out, offline |
| Subscription | Defines the subscription workflow for Brain.fm-inspired wellness audio behavior | taps, forms, search, deep links, permissions, media controls | empty, loading, loaded, signed-out, offline |
| Notifications | Defines the notifications workflow for Brain.fm-inspired wellness audio behavior | taps, forms, search, deep links, permissions, media controls | empty, loading, loaded, signed-out, offline |
| Settings / Privacy | Defines the settings / privacy workflow for Brain.fm-inspired wellness audio behavior | taps, forms, search, deep links, permissions, media controls | empty, loading, loaded, signed-out, offline |
| Support | Defines the support workflow for Brain.fm-inspired wellness audio behavior | taps, forms, search, deep links, permissions, media controls | empty, loading, loaded, signed-out, offline |
| Safety / Disclaimers | Defines the safety / disclaimers workflow for Brain.fm-inspired wellness audio behavior | taps, forms, search, deep links, permissions, media controls | empty, loading, loaded, signed-out, offline |

## Data Model

- `User`: owner, lifecycle state, authorization boundary, sync state, retention policy, deletion/export behavior, and audit metadata for Brain.fm-inspired wellness audio workflows.
- `AccountSession`: owner, lifecycle state, authorization boundary, sync state, retention policy, deletion/export behavior, and audit metadata for Brain.fm-inspired wellness audio workflows.
- `LibraryItem`: owner, lifecycle state, authorization boundary, sync state, retention policy, deletion/export behavior, and audit metadata for Brain.fm-inspired wellness audio workflows.
- `CatalogOrFeedItem`: owner, lifecycle state, authorization boundary, sync state, retention policy, deletion/export behavior, and audit metadata for Brain.fm-inspired wellness audio workflows.
- `CreatorOrSource`: owner, lifecycle state, authorization boundary, sync state, retention policy, deletion/export behavior, and audit metadata for Brain.fm-inspired wellness audio workflows.
- `PlaybackSession`: owner, lifecycle state, authorization boundary, sync state, retention policy, deletion/export behavior, and audit metadata for Brain.fm-inspired wellness audio workflows.
- `QueueOrProject`: owner, lifecycle state, authorization boundary, sync state, retention policy, deletion/export behavior, and audit metadata for Brain.fm-inspired wellness audio workflows.
- `MediaAsset`: owner, lifecycle state, authorization boundary, sync state, retention policy, deletion/export behavior, and audit metadata for Brain.fm-inspired wellness audio workflows.
- `ImportOrUpload`: owner, lifecycle state, authorization boundary, sync state, retention policy, deletion/export behavior, and audit metadata for Brain.fm-inspired wellness audio workflows.
- `ProviderJob`: owner, lifecycle state, authorization boundary, sync state, retention policy, deletion/export behavior, and audit metadata for Brain.fm-inspired wellness audio workflows.
- `Entitlement`: owner, lifecycle state, authorization boundary, sync state, retention policy, deletion/export behavior, and audit metadata for Brain.fm-inspired wellness audio workflows.
- `NotificationPreference`: owner, lifecycle state, authorization boundary, sync state, retention policy, deletion/export behavior, and audit metadata for Brain.fm-inspired wellness audio workflows.
- `RightsOrSafetyReport`: owner, lifecycle state, authorization boundary, sync state, retention policy, deletion/export behavior, and audit metadata for Brain.fm-inspired wellness audio workflows.
- `SupportCase`: owner, lifecycle state, authorization boundary, sync state, retention policy, deletion/export behavior, and audit metadata for Brain.fm-inspired wellness audio workflows.
- `AuditEvent`: owner, lifecycle state, authorization boundary, sync state, retention policy, deletion/export behavior, and audit metadata for Brain.fm-inspired wellness audio workflows.
- `LocalCacheRecord`: owner, lifecycle state, authorization boundary, sync state, retention policy, deletion/export behavior, and audit metadata for Brain.fm-inspired wellness audio workflows.
