# SoundHound-Style Clone Spec

> Metadata
> - Inspiration app: SoundHound
...
Build an original mobile song recognition and lyrics product inspired by SoundHound's public product and policy materials. V1 focuses on song recognition, humming/voice search, results, lyrics, history, external music/video links, and voice/audio privacy controls. The clone must use original branding, original UI copy, original sample media, licensed providers/assets, and explicit disclosures when a feature is inferred from public materials rather than verified hands-on behavior.
...
- Support song recognition, humming/voice search, results, lyrics, history, external music/video links, and voice/audio privacy controls with clear retry, recovery, unavailable, and rights-aware states.
...
- Do not imply affiliation with SoundHound or its publisher.
...
|---|---|---|---|
| Official product | https://www.soundhound.com/soundhound/ | Public SoundHound app positioning, music recognition, voice, lyrics, and result surfaces | Verified 2026-05-04 |
| Privacy policy | https://www.soundhound.com/privacy | App, voice/audio, location, identifiers, advertising, YouTube/API, AI vendor, retention, and child-safety handling | Verified 2026-05-04 |
| Terms of service | https://www.soundhound.com/terms-of-service/ | End-user license, third-party agreements, app usage, and legal boundaries | Verified 2026-05-04 |
| Company support/contact | https://www.soundhound.com/contact/ | Public support/contact path and product escalation routing | Verified 2026-05-04 |
...
|---|---|---|---|---|
| Welcome / Auth | Defines the welcome / auth workflow for SoundHound-inspired song recognition and lyrics behavior | taps, forms, search, deep links, permissions, media controls | empty, loading, loaded, signed-out, offline |
| Home | Defines the home workflow for SoundHound-inspired song recognition and lyrics behavior | taps, forms, search, deep links, permissions, media controls | empty, loading, loaded, signed-out, offline |
| Recognize / Listen | Defines the recognize / listen workflow for SoundHound-inspired song recognition and lyrics behavior | taps, forms, search, deep links, permissions, media controls | empty, loading, loaded, signed-out, offline |
| Search | Defines the search workflow for SoundHound-inspired song recognition and lyrics behavior | taps, forms, search, deep links, permissions, media controls | empty, loading, loaded, signed-out, offline |
| Song Detail | Defines the song detail workflow for SoundHound-inspired song recognition and lyrics behavior | taps, forms, search, deep links, permissions, media controls | empty, loading, loaded, signed-out, offline |
| Lyrics View | Defines the lyrics view workflow for SoundHound-inspired song recognition and lyrics behavior | taps, forms, search, deep links, permissions, media controls | empty, loading, loaded, signed-out, offline |
| Translation | Defines the translation workflow for SoundHound-inspired song recognition and lyrics behavior | taps, forms, search, deep links, permissions, media controls | empty, loading, loaded, signed-out, offline |
| Library / History | Defines the library / history workflow for SoundHound-inspired song recognition and lyrics behavior | taps, forms, search, deep links, permissions, media controls | empty, loading, loaded, signed-out, offline |
| Contribution | Defines the contribution workflow for SoundHound-inspired song recognition and lyrics behavior | taps, forms, search, deep links, permissions, media controls | empty, loading, loaded, signed-out, offline |
| Player Links | Defines the player links workflow for SoundHound-inspired song recognition and lyrics behavior | taps, forms, search, deep links, permissions, media controls | empty, loading, loaded, signed-out, offline |
| Subscription | Defines the subscription workflow for SoundHound-inspired song recognition and lyrics behavior | taps, forms, search, deep links, permissions, media controls | empty, loading, loaded, signed-out, offline |
| Notifications | Defines the notifications workflow for SoundHound-inspired song recognition and lyrics behavior | taps, forms, search, deep links, permissions, media controls | empty, loading, loaded, signed-out, offline |
| Settings / Privacy | Defines the settings / privacy workflow for SoundHound-inspired song recognition and lyrics behavior | taps, forms, search, deep links, permissions, media controls | empty, loading, loaded, signed-out, offline |
| Support / Reports | Defines the support / reports workflow for SoundHound-inspired song recognition and lyrics behavior | taps, forms, search, deep links, permissions, media controls | empty, loading, loaded, signed-out, offline |

## Data Model

- `User`: owner, lifecycle state, authorization boundary, sync state, retention policy, deletion/export behavior, and audit metadata for SoundHound-inspired song recognition and lyrics workflows.
- `AccountSession`: owner, lifecycle state, authorization boundary, sync state, retention policy, deletion/export behavior, and audit metadata for SoundHound-inspired song recognition and lyrics workflows.
- `LibraryItem`: owner, lifecycle state, authorization boundary, sync state, retention policy, deletion/export behavior, and audit metadata for SoundHound-inspired song recognition and lyrics workflows.
- `CatalogOrFeedItem`: owner, lifecycle state, authorization boundary, sync state, retention policy, deletion/export behavior, and audit metadata for SoundHound-inspired song recognition and lyrics workflows.
- `CreatorOrSource`: owner, lifecycle state, authorization boundary, sync state, retention policy, deletion/export behavior, and audit metadata for SoundHound-inspired song recognition and lyrics workflows.
- `PlaybackSession`: owner, lifecycle state, authorization boundary, sync state, retention policy, deletion/export behavior, and audit metadata for SoundHound-inspired song recognition and lyrics workflows.
- `QueueOrProject`: owner, lifecycle state, authorization boundary, sync state, retention policy, deletion/export behavior, and audit metadata for SoundHound-inspired song recognition and lyrics workflows.
- `MediaAsset`: owner, lifecycle state, authorization boundary, sync state, retention policy, deletion/export behavior, and audit metadata for SoundHound-inspired song recognition and lyrics workflows.
- `ImportOrUpload`: owner, lifecycle state, authorization boundary, sync state, retention policy, deletion/export behavior, and audit metadata for SoundHound-inspired song recognition and lyrics workflows.
- `ProviderJob`: owner, lifecycle state, authorization boundary, sync state, retention policy, deletion/export behavior, and audit metadata for SoundHound-inspired song recognition and lyrics workflows.
- `Entitlement`: owner, lifecycle state, authorization boundary, sync state, retention policy, deletion/export behavior, and audit metadata for SoundHound-inspired song recognition and lyrics workflows.
- `NotificationPreference`: owner, lifecycle state, authorization boundary, sync state, retention policy, deletion/export behavior, and audit metadata for SoundHound-inspired song recognition and lyrics workflows.
- `RightsOrSafetyReport`: owner, lifecycle state, authorization boundary, sync state, retention policy, deletion/export behavior, and audit metadata for SoundHound-inspired song recognition and lyrics workflows.
- `SupportCase`: owner, lifecycle state, authorization boundary, sync state, retention policy, deletion/export behavior, and audit metadata for SoundHound-inspired song recognition and lyrics workflows.
- `AuditEvent`: owner, lifecycle state, authorization boundary, sync state, retention policy, deletion/export behavior, and audit metadata for SoundHound-inspired song recognition and lyrics workflows.
- `LocalCacheRecord`: owner, lifecycle state, authorization boundary, sync state, retention policy, deletion/export behavior, and audit metadata for SoundHound-inspired song recognition and lyrics workflows.
