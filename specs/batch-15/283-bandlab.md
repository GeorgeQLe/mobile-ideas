# BandLab-Style Clone Spec

> Metadata
> - Inspiration app: BandLab
...
Build an original mobile collaborative music creation product inspired by BandLab's public product and policy materials. V1 focuses on cloud music creation, multitrack studio, loops, collaboration, social publishing, creator profiles, monetization, and moderation controls. The clone must use original branding, original UI copy, original sample media, licensed providers/assets, and explicit disclosures when a feature is inferred from public materials rather than verified hands-on behavior.
...
- Support cloud music creation, multitrack studio, loops, collaboration, social publishing, creator profiles, monetization, and moderation controls with clear retry, recovery, unavailable, and rights-aware states.
...
- Do not imply affiliation with BandLab or its publisher.
...
|---|---|---|---|
| Official product | https://www.bandlab.com/ | Public BandLab product positioning, studio, social, publishing, and creator surfaces | Verified 2026-05-04 |
| Help center | https://help.bandlab.com/hc/en-us | Public support taxonomy for creation, accounts, social, monetization, artist services, and trust/safety | Verified 2026-05-04 |
| Community guidelines | https://help.bandlab.com/hc/en-us/articles/115003930014-Community-Guidelines | Public safety, privacy, authenticity, minor safety, and content policy requirements | Verified 2026-05-04 |
| Privacy policy | https://blog.bandlab.com/privacy-policy/ | Account, user content, device, analytics, retention, sharing, and child-privacy handling | Verified 2026-05-04 |
| Terms of use | https://blog.bandlab.com/terms-of-use/ | User content, copyright, Sounds, Boost, Fan Reach, subscriptions, and acceptable use | Verified 2026-05-04 |
...
- Onboarding must support signed-out preview, account creation or restore, blocked-account state, unavailable-region state, and entitlement-unavailable state for collaborative music creation workflows.
- Home must expose the latest meaningful collaborative music creation state, search/discovery, library or project access, settings, and degraded offline/account variants.
...
|---|---|---|---|---|
| Welcome / Auth | Defines the welcome / auth workflow for BandLab-inspired collaborative music creation behavior | taps, forms, search, deep links, permissions, media controls | empty, loading, loaded, signed-out, offline |
| Project Browser | Defines the project browser workflow for BandLab-inspired collaborative music creation behavior | taps, forms, search, deep links, permissions, media controls | empty, loading, loaded, signed-out, offline |
| Template / Instrument Picker | Defines the template / instrument picker workflow for BandLab-inspired collaborative music creation behavior | taps, forms, search, deep links, permissions, media controls | empty, loading, loaded, signed-out, offline |
| Studio Timeline | Defines the studio timeline workflow for BandLab-inspired collaborative music creation behavior | taps, forms, search, deep links, permissions, media controls | empty, loading, loaded, signed-out, offline |
| Track Detail | Defines the track detail workflow for BandLab-inspired collaborative music creation behavior | taps, forms, search, deep links, permissions, media controls | empty, loading, loaded, signed-out, offline |
| Loop / Beat Library | Defines the loop / beat library workflow for BandLab-inspired collaborative music creation behavior | taps, forms, search, deep links, permissions, media controls | empty, loading, loaded, signed-out, offline |
| Recorder | Defines the recorder workflow for BandLab-inspired collaborative music creation behavior | taps, forms, search, deep links, permissions, media controls | empty, loading, loaded, signed-out, offline |
| Mixer / Effects | Defines the mixer / effects workflow for BandLab-inspired collaborative music creation behavior | taps, forms, search, deep links, permissions, media controls | empty, loading, loaded, signed-out, offline |
| Collaboration | Defines the collaboration workflow for BandLab-inspired collaborative music creation behavior | taps, forms, search, deep links, permissions, media controls | empty, loading, loaded, signed-out, offline |
| Preview / Share | Defines the preview / share workflow for BandLab-inspired collaborative music creation behavior | taps, forms, search, deep links, permissions, media controls | empty, loading, loaded, signed-out, offline |
| Export | Defines the export workflow for BandLab-inspired collaborative music creation behavior | taps, forms, search, deep links, permissions, media controls | empty, loading, loaded, signed-out, offline |
| Subscription / Assets | Defines the subscription / assets workflow for BandLab-inspired collaborative music creation behavior | taps, forms, search, deep links, permissions, media controls | empty, loading, loaded, signed-out, offline |
| Settings / Privacy | Defines the settings / privacy workflow for BandLab-inspired collaborative music creation behavior | taps, forms, search, deep links, permissions, media controls | empty, loading, loaded, signed-out, offline |
| Support / Reports | Defines the support / reports workflow for BandLab-inspired collaborative music creation behavior | taps, forms, search, deep links, permissions, media controls | empty, loading, loaded, signed-out, offline |

## Data Model

- `User`: owner, lifecycle state, authorization boundary, sync state, retention policy, deletion/export behavior, and audit metadata for BandLab-inspired collaborative music creation workflows.
- `AccountSession`: owner, lifecycle state, authorization boundary, sync state, retention policy, deletion/export behavior, and audit metadata for BandLab-inspired collaborative music creation workflows.
- `LibraryItem`: owner, lifecycle state, authorization boundary, sync state, retention policy, deletion/export behavior, and audit metadata for BandLab-inspired collaborative music creation workflows.
- `CatalogOrFeedItem`: owner, lifecycle state, authorization boundary, sync state, retention policy, deletion/export behavior, and audit metadata for BandLab-inspired collaborative music creation workflows.
- `CreatorOrSource`: owner, lifecycle state, authorization boundary, sync state, retention policy, deletion/export behavior, and audit metadata for BandLab-inspired collaborative music creation workflows.
- `PlaybackSession`: owner, lifecycle state, authorization boundary, sync state, retention policy, deletion/export behavior, and audit metadata for BandLab-inspired collaborative music creation workflows.
- `QueueOrProject`: owner, lifecycle state, authorization boundary, sync state, retention policy, deletion/export behavior, and audit metadata for BandLab-inspired collaborative music creation workflows.
- `MediaAsset`: owner, lifecycle state, authorization boundary, sync state, retention policy, deletion/export behavior, and audit metadata for BandLab-inspired collaborative music creation workflows.
- `ImportOrUpload`: owner, lifecycle state, authorization boundary, sync state, retention policy, deletion/export behavior, and audit metadata for BandLab-inspired collaborative music creation workflows.
- `ProviderJob`: owner, lifecycle state, authorization boundary, sync state, retention policy, deletion/export behavior, and audit metadata for BandLab-inspired collaborative music creation workflows.
- `Entitlement`: owner, lifecycle state, authorization boundary, sync state, retention policy, deletion/export behavior, and audit metadata for BandLab-inspired collaborative music creation workflows.
- `NotificationPreference`: owner, lifecycle state, authorization boundary, sync state, retention policy, deletion/export behavior, and audit metadata for BandLab-inspired collaborative music creation workflows.
- `RightsOrSafetyReport`: owner, lifecycle state, authorization boundary, sync state, retention policy, deletion/export behavior, and audit metadata for BandLab-inspired collaborative music creation workflows.
- `SupportCase`: owner, lifecycle state, authorization boundary, sync state, retention policy, deletion/export behavior, and audit metadata for BandLab-inspired collaborative music creation workflows.
- `AuditEvent`: owner, lifecycle state, authorization boundary, sync state, retention policy, deletion/export behavior, and audit metadata for BandLab-inspired collaborative music creation workflows.
- `LocalCacheRecord`: owner, lifecycle state, authorization boundary, sync state, retention policy, deletion/export behavior, and audit metadata for BandLab-inspired collaborative music creation workflows.
