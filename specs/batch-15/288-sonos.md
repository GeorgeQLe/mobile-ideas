# Sonos-Style Clone Spec

> Metadata
> - Inspiration app: Sonos
...
Build an original mobile audio hardware control product inspired by Sonos's public product and policy materials. V1 focuses on speaker setup, local-network discovery, room grouping, playback service linking, device controls, firmware/account state, and household permissions. The clone must use original branding, original UI copy, original sample media, licensed providers/assets, and explicit disclosures when a feature is inferred from public materials rather than verified hands-on behavior.
...
- Support speaker setup, local-network discovery, room grouping, playback service linking, device controls, firmware/account state, and household permissions with clear retry, recovery, unavailable, and rights-aware states.
...
- Do not imply affiliation with Sonos or its publisher.
...
|---|---|---|---|
| Official product | https://www.sonos.com/en-us/controller-app | Public Sonos app positioning, setup, playback control, and service integration surfaces | Verified 2026-05-04 |
| Support center | https://support.sonos.com/ | Public support taxonomy for setup, playback, accounts, products, and troubleshooting | Verified 2026-05-04 |
| App permissions | https://support.sonos.com/en-us/article/sonos-app-permissions | Public local network, location, Bluetooth, microphone, and notification permission usage | Verified 2026-05-04 |
| Privacy statement | https://www.sonos.com/en-us/legal/privacy | Account, product, device, diagnostics, voice, usage, and retention handling | Verified 2026-05-04 |
| Terms of use | https://www.sonos.com/en-us/legal/terms-of-use | Product/service terms, accounts, subscriptions, and legal boundaries | Verified 2026-05-04 |
...
|---|---|---|---|---|
| Welcome / Account | Defines the welcome / account workflow for Sonos-inspired audio hardware control behavior | taps, forms, search, deep links, permissions, media controls | empty, loading, loaded, signed-out, offline |
| Product Setup | Defines the product setup workflow for Sonos-inspired audio hardware control behavior | taps, forms, search, deep links, permissions, media controls | empty, loading, loaded, signed-out, offline |
| Device Discovery | Defines the device discovery workflow for Sonos-inspired audio hardware control behavior | taps, forms, search, deep links, permissions, media controls | empty, loading, loaded, signed-out, offline |
| Room / Speaker List | Defines the room / speaker list workflow for Sonos-inspired audio hardware control behavior | taps, forms, search, deep links, permissions, media controls | empty, loading, loaded, signed-out, offline |
| Now Playing | Defines the now playing workflow for Sonos-inspired audio hardware control behavior | taps, forms, search, deep links, permissions, media controls | empty, loading, loaded, signed-out, offline |
| Device Detail | Defines the device detail workflow for Sonos-inspired audio hardware control behavior | taps, forms, search, deep links, permissions, media controls | empty, loading, loaded, signed-out, offline |
| EQ / Sound Controls | Defines the eq / sound controls workflow for Sonos-inspired audio hardware control behavior | taps, forms, search, deep links, permissions, media controls | empty, loading, loaded, signed-out, offline |
| Grouping / Party Mode | Defines the grouping / party mode workflow for Sonos-inspired audio hardware control behavior | taps, forms, search, deep links, permissions, media controls | empty, loading, loaded, signed-out, offline |
| Music Services | Defines the music services workflow for Sonos-inspired audio hardware control behavior | taps, forms, search, deep links, permissions, media controls | empty, loading, loaded, signed-out, offline |
| Firmware Update | Defines the firmware update workflow for Sonos-inspired audio hardware control behavior | taps, forms, search, deep links, permissions, media controls | empty, loading, loaded, signed-out, offline |
| Notifications | Defines the notifications workflow for Sonos-inspired audio hardware control behavior | taps, forms, search, deep links, permissions, media controls | empty, loading, loaded, signed-out, offline |
| Settings / Privacy | Defines the settings / privacy workflow for Sonos-inspired audio hardware control behavior | taps, forms, search, deep links, permissions, media controls | empty, loading, loaded, signed-out, offline |
| Support | Defines the support workflow for Sonos-inspired audio hardware control behavior | taps, forms, search, deep links, permissions, media controls | empty, loading, loaded, signed-out, offline |
| Safety / Diagnostics | Defines the safety / diagnostics workflow for Sonos-inspired audio hardware control behavior | taps, forms, search, deep links, permissions, media controls | empty, loading, loaded, signed-out, offline |

## Data Model

- `User`: owner, lifecycle state, authorization boundary, sync state, retention policy, deletion/export behavior, and audit metadata for Sonos-inspired audio hardware control workflows.
- `AccountSession`: owner, lifecycle state, authorization boundary, sync state, retention policy, deletion/export behavior, and audit metadata for Sonos-inspired audio hardware control workflows.
- `LibraryItem`: owner, lifecycle state, authorization boundary, sync state, retention policy, deletion/export behavior, and audit metadata for Sonos-inspired audio hardware control workflows.
- `CatalogOrFeedItem`: owner, lifecycle state, authorization boundary, sync state, retention policy, deletion/export behavior, and audit metadata for Sonos-inspired audio hardware control workflows.
- `CreatorOrSource`: owner, lifecycle state, authorization boundary, sync state, retention policy, deletion/export behavior, and audit metadata for Sonos-inspired audio hardware control workflows.
- `PlaybackSession`: owner, lifecycle state, authorization boundary, sync state, retention policy, deletion/export behavior, and audit metadata for Sonos-inspired audio hardware control workflows.
- `QueueOrProject`: owner, lifecycle state, authorization boundary, sync state, retention policy, deletion/export behavior, and audit metadata for Sonos-inspired audio hardware control workflows.
- `MediaAsset`: owner, lifecycle state, authorization boundary, sync state, retention policy, deletion/export behavior, and audit metadata for Sonos-inspired audio hardware control workflows.
- `ImportOrUpload`: owner, lifecycle state, authorization boundary, sync state, retention policy, deletion/export behavior, and audit metadata for Sonos-inspired audio hardware control workflows.
- `ProviderJob`: owner, lifecycle state, authorization boundary, sync state, retention policy, deletion/export behavior, and audit metadata for Sonos-inspired audio hardware control workflows.
- `Entitlement`: owner, lifecycle state, authorization boundary, sync state, retention policy, deletion/export behavior, and audit metadata for Sonos-inspired audio hardware control workflows.
- `NotificationPreference`: owner, lifecycle state, authorization boundary, sync state, retention policy, deletion/export behavior, and audit metadata for Sonos-inspired audio hardware control workflows.
- `RightsOrSafetyReport`: owner, lifecycle state, authorization boundary, sync state, retention policy, deletion/export behavior, and audit metadata for Sonos-inspired audio hardware control workflows.
- `SupportCase`: owner, lifecycle state, authorization boundary, sync state, retention policy, deletion/export behavior, and audit metadata for Sonos-inspired audio hardware control workflows.
- `AuditEvent`: owner, lifecycle state, authorization boundary, sync state, retention policy, deletion/export behavior, and audit metadata for Sonos-inspired audio hardware control workflows.
- `LocalCacheRecord`: owner, lifecycle state, authorization boundary, sync state, retention policy, deletion/export behavior, and audit metadata for Sonos-inspired audio hardware control workflows.
