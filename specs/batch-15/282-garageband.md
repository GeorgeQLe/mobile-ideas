# GarageBand-Style Clone Spec

> Metadata
> - Inspiration app: GarageBand
...
Build an original mobile mobile music creation product inspired by GarageBand's public product and policy materials. V1 focuses on mobile music creation, instruments, loops, multitrack projects, local/iCloud project storage, sharing, and downloadable sound libraries. The clone must use original branding, original UI copy, original sample media, licensed providers/assets, and explicit disclosures when a feature is inferred from public materials rather than verified hands-on behavior.
...
- Support mobile music creation, instruments, loops, multitrack projects, local/iCloud project storage, sharing, and downloadable sound libraries with clear retry, recovery, unavailable, and rights-aware states.
...
- Do not imply affiliation with GarageBand or its publisher.
...
|---|---|---|---|
| Official product | https://www.apple.com/ios/garageband/ | Public GarageBand for iOS positioning, instruments, loops, Live Loops, recording, and sharing surfaces | Verified 2026-05-04 |
| App Store listing | https://apps.apple.com/us/app/garageband/id408709785 | Canonical iOS listing, compatibility, privacy label, accessibility, and release metadata | Verified 2026-05-04 |
| Support: contacts permission | https://support.apple.com/en-us/101752 | Public explanation of Contacts permission during song or ringtone sharing | Verified 2026-05-04 |
| Support: iOS project storage | https://support.apple.com/en-us/101861 | Public iCloud Drive/local storage behavior and third-party storage limitations | Verified 2026-05-04 |
| Apple privacy | https://www.apple.com/legal/privacy/ | Apple privacy posture for account, device, iCloud, and app data handling | Verified 2026-05-04 |
| Apple terms | https://www.apple.com/legal/internet-services/itunes/ | Apple media-services terms and store/subscription boundaries | Verified 2026-05-04 |
...
- Onboarding must support signed-out preview, account creation or restore, blocked-account state, unavailable-region state, and entitlement-unavailable state for mobile music creation workflows.
- Home must expose the latest meaningful mobile music creation state, search/discovery, library or project access, settings, and degraded offline/account variants.
...
- User recordings, projects, vocals, stems, beats, loops, collaborations, and exports must keep license, attribution, consent, takedown, and privacy metadata.
- Public publishing must require a confirmation that the user owns or has licensed every uploaded vocal, backing track, loop, sample, image, and caption.
...
|---|---|---|---|---|
| Welcome / Auth | Defines the welcome / auth workflow for GarageBand-inspired mobile music creation behavior | taps, forms, search, deep links, permissions, media controls | empty, loading, loaded, signed-out, offline |
| Project Browser | Defines the project browser workflow for GarageBand-inspired mobile music creation behavior | taps, forms, search, deep links, permissions, media controls | empty, loading, loaded, signed-out, offline |
| Template / Instrument Picker | Defines the template / instrument picker workflow for GarageBand-inspired mobile music creation behavior | taps, forms, search, deep links, permissions, media controls | empty, loading, loaded, signed-out, offline |
| Studio Timeline | Defines the studio timeline workflow for GarageBand-inspired mobile music creation behavior | taps, forms, search, deep links, permissions, media controls | empty, loading, loaded, signed-out, offline |
| Track Detail | Defines the track detail workflow for GarageBand-inspired mobile music creation behavior | taps, forms, search, deep links, permissions, media controls | empty, loading, loaded, signed-out, offline |
| Loop / Beat Library | Defines the loop / beat library workflow for GarageBand-inspired mobile music creation behavior | taps, forms, search, deep links, permissions, media controls | empty, loading, loaded, signed-out, offline |
| Recorder | Defines the recorder workflow for GarageBand-inspired mobile music creation behavior | taps, forms, search, deep links, permissions, media controls | empty, loading, loaded, signed-out, offline |
| Mixer / Effects | Defines the mixer / effects workflow for GarageBand-inspired mobile music creation behavior | taps, forms, search, deep links, permissions, media controls | empty, loading, loaded, signed-out, offline |
| Collaboration | Defines the collaboration workflow for GarageBand-inspired mobile music creation behavior | taps, forms, search, deep links, permissions, media controls | empty, loading, loaded, signed-out, offline |
| Preview / Share | Defines the preview / share workflow for GarageBand-inspired mobile music creation behavior | taps, forms, search, deep links, permissions, media controls | empty, loading, loaded, signed-out, offline |
| Export | Defines the export workflow for GarageBand-inspired mobile music creation behavior | taps, forms, search, deep links, permissions, media controls | empty, loading, loaded, signed-out, offline |
| Subscription / Assets | Defines the subscription / assets workflow for GarageBand-inspired mobile music creation behavior | taps, forms, search, deep links, permissions, media controls | empty, loading, loaded, signed-out, offline |
| Settings / Privacy | Defines the settings / privacy workflow for GarageBand-inspired mobile music creation behavior | taps, forms, search, deep links, permissions, media controls | empty, loading, loaded, signed-out, offline |
| Support / Reports | Defines the support / reports workflow for GarageBand-inspired mobile music creation behavior | taps, forms, search, deep links, permissions, media controls | empty, loading, loaded, signed-out, offline |

## Data Model

- `User`: owner, lifecycle state, authorization boundary, sync state, retention policy, deletion/export behavior, and audit metadata for GarageBand-inspired mobile music creation workflows.
- `AccountSession`: owner, lifecycle state, authorization boundary, sync state, retention policy, deletion/export behavior, and audit metadata for GarageBand-inspired mobile music creation workflows.
- `LibraryItem`: owner, lifecycle state, authorization boundary, sync state, retention policy, deletion/export behavior, and audit metadata for GarageBand-inspired mobile music creation workflows.
- `CatalogOrFeedItem`: owner, lifecycle state, authorization boundary, sync state, retention policy, deletion/export behavior, and audit metadata for GarageBand-inspired mobile music creation workflows.
- `CreatorOrSource`: owner, lifecycle state, authorization boundary, sync state, retention policy, deletion/export behavior, and audit metadata for GarageBand-inspired mobile music creation workflows.
- `PlaybackSession`: owner, lifecycle state, authorization boundary, sync state, retention policy, deletion/export behavior, and audit metadata for GarageBand-inspired mobile music creation workflows.
- `QueueOrProject`: owner, lifecycle state, authorization boundary, sync state, retention policy, deletion/export behavior, and audit metadata for GarageBand-inspired mobile music creation workflows.
- `MediaAsset`: owner, lifecycle state, authorization boundary, sync state, retention policy, deletion/export behavior, and audit metadata for GarageBand-inspired mobile music creation workflows.
- `ImportOrUpload`: owner, lifecycle state, authorization boundary, sync state, retention policy, deletion/export behavior, and audit metadata for GarageBand-inspired mobile music creation workflows.
- `ProviderJob`: owner, lifecycle state, authorization boundary, sync state, retention policy, deletion/export behavior, and audit metadata for GarageBand-inspired mobile music creation workflows.
- `Entitlement`: owner, lifecycle state, authorization boundary, sync state, retention policy, deletion/export behavior, and audit metadata for GarageBand-inspired mobile music creation workflows.
- `NotificationPreference`: owner, lifecycle state, authorization boundary, sync state, retention policy, deletion/export behavior, and audit metadata for GarageBand-inspired mobile music creation workflows.
- `RightsOrSafetyReport`: owner, lifecycle state, authorization boundary, sync state, retention policy, deletion/export behavior, and audit metadata for GarageBand-inspired mobile music creation workflows.
- `SupportCase`: owner, lifecycle state, authorization boundary, sync state, retention policy, deletion/export behavior, and audit metadata for GarageBand-inspired mobile music creation workflows.
- `AuditEvent`: owner, lifecycle state, authorization boundary, sync state, retention policy, deletion/export behavior, and audit metadata for GarageBand-inspired mobile music creation workflows.
- `LocalCacheRecord`: owner, lifecycle state, authorization boundary, sync state, retention policy, deletion/export behavior, and audit metadata for GarageBand-inspired mobile music creation workflows.
