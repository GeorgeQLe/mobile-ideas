# Castro-Style Clone Spec

> Metadata
> - Inspiration app: Castro
...
Build an original mobile podcast playback product inspired by Castro's public product and policy materials. V1 focuses on podcast inbox, queue triage, subscriptions, downloads/offline, watch/Siri integrations, and Castro Plus entitlement gates. The clone must use original branding, original UI copy, original sample media, licensed providers/assets, and explicit disclosures when a feature is inferred from public materials rather than verified hands-on behavior.
...
- Support podcast inbox, queue triage, subscriptions, downloads/offline, watch/Siri integrations, and Castro Plus entitlement gates with clear retry, recovery, unavailable, and rights-aware states.
...
- Do not imply affiliation with Castro or its publisher.
...
|---|---|---|---|
| Official product | https://castro.fm/ | Public Castro product positioning, inbox/queue workflow, podcast playback, and subscription surfaces | Verified 2026-05-04 |
| App Store listing | https://apps.apple.com/us/app/castro-podcast-app-player/id1080840241 | Canonical iOS listing, subscription, compatibility, Siri, family sharing, privacy label, and release metadata | Verified 2026-05-04 |
| Privacy policy and terms | https://castro.fm/privacy-policy | Privacy, terms, account, analytics, subscription, user content, and legal boundaries | Verified 2026-05-04 |
| Support/contact | https://castro.fm/support | Public support and troubleshooting entry point | Verified 2026-05-04 |
...
|---|---|---|---|---|
| Welcome / Import | Defines the welcome / import workflow for Castro-inspired podcast playback behavior | taps, forms, search, deep links, permissions, media controls | empty, loading, loaded, signed-out, offline |
| Home / Inbox | Defines the home / inbox workflow for Castro-inspired podcast playback behavior | taps, forms, search, deep links, permissions, media controls | empty, loading, loaded, signed-out, offline |
| Discover / Search | Defines the discover / search workflow for Castro-inspired podcast playback behavior | taps, forms, search, deep links, permissions, media controls | empty, loading, loaded, signed-out, offline |
| Podcast Detail | Defines the podcast detail workflow for Castro-inspired podcast playback behavior | taps, forms, search, deep links, permissions, media controls | empty, loading, loaded, signed-out, offline |
| Episode Detail | Defines the episode detail workflow for Castro-inspired podcast playback behavior | taps, forms, search, deep links, permissions, media controls | empty, loading, loaded, signed-out, offline |
| Queue / Playlist | Defines the queue / playlist workflow for Castro-inspired podcast playback behavior | taps, forms, search, deep links, permissions, media controls | empty, loading, loaded, signed-out, offline |
| Now Playing | Defines the now playing workflow for Castro-inspired podcast playback behavior | taps, forms, search, deep links, permissions, media controls | empty, loading, loaded, signed-out, offline |
| Downloads | Defines the downloads workflow for Castro-inspired podcast playback behavior | taps, forms, search, deep links, permissions, media controls | empty, loading, loaded, signed-out, offline |
| Filters / Automation | Defines the filters / automation workflow for Castro-inspired podcast playback behavior | taps, forms, search, deep links, permissions, media controls | empty, loading, loaded, signed-out, offline |
| Subscription / Premium | Defines the subscription / premium workflow for Castro-inspired podcast playback behavior | taps, forms, search, deep links, permissions, media controls | empty, loading, loaded, signed-out, offline |
| Notifications | Defines the notifications workflow for Castro-inspired podcast playback behavior | taps, forms, search, deep links, permissions, media controls | empty, loading, loaded, signed-out, offline |
| Settings / Privacy | Defines the settings / privacy workflow for Castro-inspired podcast playback behavior | taps, forms, search, deep links, permissions, media controls | empty, loading, loaded, signed-out, offline |
| Support | Defines the support workflow for Castro-inspired podcast playback behavior | taps, forms, search, deep links, permissions, media controls | empty, loading, loaded, signed-out, offline |
| Data Export / Delete | Defines the data export / delete workflow for Castro-inspired podcast playback behavior | taps, forms, search, deep links, permissions, media controls | empty, loading, loaded, signed-out, offline |

## Data Model

- `User`: owner, lifecycle state, authorization boundary, sync state, retention policy, deletion/export behavior, and audit metadata for Castro-inspired podcast playback workflows.
- `AccountSession`: owner, lifecycle state, authorization boundary, sync state, retention policy, deletion/export behavior, and audit metadata for Castro-inspired podcast playback workflows.
- `LibraryItem`: owner, lifecycle state, authorization boundary, sync state, retention policy, deletion/export behavior, and audit metadata for Castro-inspired podcast playback workflows.
- `CatalogOrFeedItem`: owner, lifecycle state, authorization boundary, sync state, retention policy, deletion/export behavior, and audit metadata for Castro-inspired podcast playback workflows.
- `CreatorOrSource`: owner, lifecycle state, authorization boundary, sync state, retention policy, deletion/export behavior, and audit metadata for Castro-inspired podcast playback workflows.
- `PlaybackSession`: owner, lifecycle state, authorization boundary, sync state, retention policy, deletion/export behavior, and audit metadata for Castro-inspired podcast playback workflows.
- `QueueOrProject`: owner, lifecycle state, authorization boundary, sync state, retention policy, deletion/export behavior, and audit metadata for Castro-inspired podcast playback workflows.
- `MediaAsset`: owner, lifecycle state, authorization boundary, sync state, retention policy, deletion/export behavior, and audit metadata for Castro-inspired podcast playback workflows.
- `ImportOrUpload`: owner, lifecycle state, authorization boundary, sync state, retention policy, deletion/export behavior, and audit metadata for Castro-inspired podcast playback workflows.
- `ProviderJob`: owner, lifecycle state, authorization boundary, sync state, retention policy, deletion/export behavior, and audit metadata for Castro-inspired podcast playback workflows.
- `Entitlement`: owner, lifecycle state, authorization boundary, sync state, retention policy, deletion/export behavior, and audit metadata for Castro-inspired podcast playback workflows.
- `NotificationPreference`: owner, lifecycle state, authorization boundary, sync state, retention policy, deletion/export behavior, and audit metadata for Castro-inspired podcast playback workflows.
- `RightsOrSafetyReport`: owner, lifecycle state, authorization boundary, sync state, retention policy, deletion/export behavior, and audit metadata for Castro-inspired podcast playback workflows.
- `SupportCase`: owner, lifecycle state, authorization boundary, sync state, retention policy, deletion/export behavior, and audit metadata for Castro-inspired podcast playback workflows.
- `AuditEvent`: owner, lifecycle state, authorization boundary, sync state, retention policy, deletion/export behavior, and audit metadata for Castro-inspired podcast playback workflows.
- `LocalCacheRecord`: owner, lifecycle state, authorization boundary, sync state, retention policy, deletion/export behavior, and audit metadata for Castro-inspired podcast playback workflows.
