...
## Overview
Build an original mobile product inspired by Expedia's user-facing workflow, not its brand identity or proprietary implementation.
The clone target is: Bundled flight/hotel/car search, itinerary wallet, loyalty rewards, price tracking, and customer support flows.
...
## Goals
- Deliver a mobile-first travel booking experience with complete onboarding, core action, settings, and recovery flows.
- Implement the app-specific focus: Bundled flight/hotel/car search, itinerary wallet, loyalty rewards, price tracking, and customer support flows.
...
## Non-Goals
- Do not copy Expedia branding, trade dress, logos, app icons, screenshots, marketing copy, or proprietary media.
...
## Research Sources
- App Store source-discovery link: https://apps.apple.com/us/search?term=Expedia
- Google Play source-discovery link: https://play.google.com/store/search?q=Expedia&c=apps
- Official help/privacy source-discovery link: https://www.google.com/search?q=Expedia%20official%20app%20help%20privacy
...
## Detailed Design
- Onboarding: support guest, signup, returning-user, permission-primer, and blocked-region or blocked-account states as appropriate for travel booking.
