...
## Overview
Build an original mobile product inspired by Gmail's user-facing workflow, not its brand identity or proprietary implementation.
The clone target is: Inbox categories, search, thread view, compose, attachments, labels, swipe actions, and multi-account switching.
...
## Goals
- Deliver a mobile-first email experience with complete onboarding, core action, settings, and recovery flows.
- Implement the app-specific focus: Inbox categories, search, thread view, compose, attachments, labels, swipe actions, and multi-account switching.
...
## Non-Goals
- Do not copy Gmail branding, trade dress, logos, app icons, screenshots, marketing copy, or proprietary media.
...
## Research Sources
- App Store source-discovery link: https://apps.apple.com/us/search?term=Gmail
- Google Play source-discovery link: https://play.google.com/store/search?q=Gmail&c=apps
- Official help/privacy source-discovery link: https://www.google.com/search?q=Gmail%20official%20app%20help%20privacy
...
## Detailed Design
- Onboarding: support guest, signup, returning-user, permission-primer, and blocked-region or blocked-account states as appropriate for email.
