...
## Overview
Build an original mobile product inspired by Google Maps's user-facing workflow, not its brand identity or proprietary implementation.
The clone target is: Search, place detail pages, saved lists, directions, live navigation, transit, reviews, and offline maps.
...
- Implement the app-specific focus: Search, place detail pages, saved lists, directions, live navigation, transit, reviews, and offline maps.
...
## Non-Goals
- Do not copy Google Maps branding, trade dress, logos, app icons, screenshots, marketing copy, or proprietary media.
...
## Research Sources
- App Store source-discovery link: https://apps.apple.com/us/search?term=Google%20Maps
- Google Play source-discovery link: https://play.google.com/store/search?q=Google%20Maps&c=apps
- Official help/privacy source-discovery link: https://www.google.com/search?q=Google%20Maps%20official%20app%20help%20privacy
