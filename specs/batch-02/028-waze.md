...
## Overview
Build an original mobile product inspired by Waze's user-facing workflow, not its brand identity or proprietary implementation.
The clone target is: Driver reports, live hazards, route ETA, traffic rerouting, gas prices, and community moderation.
...
## Goals
- Deliver a mobile-first navigation experience with complete onboarding, core action, settings, and recovery flows.
- Implement the app-specific focus: Driver reports, live hazards, route ETA, traffic rerouting, gas prices, and community moderation.
...
## Non-Goals
- Do not copy Waze branding, trade dress, logos, app icons, screenshots, marketing copy, or proprietary media.
...
## Research Sources
- App Store source-discovery link: https://apps.apple.com/us/search?term=Waze
- Google Play source-discovery link: https://play.google.com/store/search?q=Waze&c=apps
- Official help/privacy source-discovery link: https://www.google.com/search?q=Waze%20official%20app%20help%20privacy
...
## Detailed Design
- Onboarding: support guest, signup, returning-user, permission-primer, and blocked-region or blocked-account states as appropriate for navigation.
