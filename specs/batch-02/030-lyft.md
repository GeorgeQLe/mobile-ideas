...
## Overview
Build an original mobile product inspired by Lyft's user-facing workflow, not its brand identity or proprietary implementation.
The clone target is: Rideshare booking, saved places, shared rides concept, driver profile, receipts, promotions, and cancellation flows.
...
- Implement the app-specific focus: Rideshare booking, saved places, shared rides concept, driver profile, receipts, promotions, and cancellation flows.
...
## Non-Goals
- Do not copy Lyft branding, trade dress, logos, app icons, screenshots, marketing copy, or proprietary media.
...
## Research Sources
- App Store source-discovery link: https://apps.apple.com/us/search?term=Lyft
- Google Play source-discovery link: https://play.google.com/store/search?q=Lyft&c=apps
- Official help/privacy source-discovery link: https://www.google.com/search?q=Lyft%20official%20app%20help%20privacy
