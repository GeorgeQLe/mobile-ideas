...
## Overview
Build an original mobile product inspired by FaceTime's user-facing workflow, not its brand identity or proprietary implementation.
The clone target is: Contact-based video calls, group call grid, screen share, reactions, call links, and call history.
...
## Goals
- Deliver a mobile-first video calling experience with complete onboarding, core action, settings, and recovery flows.
- Implement the app-specific focus: Contact-based video calls, group call grid, screen share, reactions, call links, and call history.
...
## Non-Goals
- Do not copy FaceTime branding, trade dress, logos, app icons, screenshots, marketing copy, or proprietary media.
...
## Research Sources
- App Store source-discovery link: https://apps.apple.com/us/search?term=FaceTime
- Google Play source-discovery link: https://play.google.com/store/search?q=FaceTime&c=apps
- Official help/privacy source-discovery link: https://www.google.com/search?q=FaceTime%20official%20app%20help%20privacy
...
## Detailed Design
- Onboarding: support guest, signup, returning-user, permission-primer, and blocked-region or blocked-account states as appropriate for video calling.
