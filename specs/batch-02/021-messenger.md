...
## Overview
Build an original mobile product inspired by Messenger's user-facing workflow, not its brand identity or proprietary implementation.
The clone target is: Social graph messaging, read receipts, reactions, video calls, group chats, stories, and marketplace-style attachments.
...
- Implement the app-specific focus: Social graph messaging, read receipts, reactions, video calls, group chats, stories, and marketplace-style attachments.
...
## Non-Goals
- Do not copy Messenger branding, trade dress, logos, app icons, screenshots, marketing copy, or proprietary media.
...
## Research Sources
- App Store source-discovery link: https://apps.apple.com/us/search?term=Messenger
- Google Play source-discovery link: https://play.google.com/store/search?q=Messenger&c=apps
- Official help/privacy source-discovery link: https://www.google.com/search?q=Messenger%20official%20app%20help%20privacy
