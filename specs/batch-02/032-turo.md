...
## Overview
Build an original mobile product inspired by Turo's user-facing workflow, not its brand identity or proprietary implementation.
The clone target is: Vehicle marketplace, availability calendar, trip request, host messaging, insurance options, pickup instructions, and reviews.
...
## Goals
- Deliver a mobile-first car sharing experience with complete onboarding, core action, settings, and recovery flows.
- Implement the app-specific focus: Vehicle marketplace, availability calendar, trip request, host messaging, insurance options, pickup instructions, and reviews.
...
## Non-Goals
- Do not copy Turo branding, trade dress, logos, app icons, screenshots, marketing copy, or proprietary media.
...
## Research Sources
- App Store source-discovery link: https://apps.apple.com/us/search?term=Turo
- Google Play source-discovery link: https://play.google.com/store/search?q=Turo&c=apps
- Official help/privacy source-discovery link: https://www.google.com/search?q=Turo%20official%20app%20help%20privacy
...
## Detailed Design
- Onboarding: support guest, signup, returning-user, permission-primer, and blocked-region or blocked-account states as appropriate for car sharing.
