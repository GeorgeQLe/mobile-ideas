...
## Overview
Build an original mobile product inspired by DoorDash's user-facing workflow, not its brand identity or proprietary implementation.
The clone target is: Restaurant marketplace, cart customization, fees, delivery tracking, dasher handoff, support, and reorder.
...
- Implement the app-specific focus: Restaurant marketplace, cart customization, fees, delivery tracking, dasher handoff, support, and reorder.
...
## Non-Goals
- Do not copy DoorDash branding, trade dress, logos, app icons, screenshots, marketing copy, or proprietary media.
...
## Research Sources
- App Store source-discovery link: https://apps.apple.com/us/search?term=DoorDash
- Google Play source-discovery link: https://play.google.com/store/search?q=DoorDash&c=apps
- Official help/privacy source-discovery link: https://www.google.com/search?q=DoorDash%20official%20app%20help%20privacy
