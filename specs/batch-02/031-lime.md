...
## Overview
Build an original mobile product inspired by Lime's user-facing workflow, not its brand identity or proprietary implementation.
The clone target is: Scooter/bike map, QR unlock, ride timer, parking photo, wallet, safety tutorial, and geofenced restrictions.
...
## Goals
- Deliver a mobile-first micromobility experience with complete onboarding, core action, settings, and recovery flows.
- Implement the app-specific focus: Scooter/bike map, QR unlock, ride timer, parking photo, wallet, safety tutorial, and geofenced restrictions.
...
## Non-Goals
- Do not copy Lime branding, trade dress, logos, app icons, screenshots, marketing copy, or proprietary media.
...
## Research Sources
- App Store source-discovery link: https://apps.apple.com/us/search?term=Lime
- Google Play source-discovery link: https://play.google.com/store/search?q=Lime&c=apps
- Official help/privacy source-discovery link: https://www.google.com/search?q=Lime%20official%20app%20help%20privacy
...
## Detailed Design
- Onboarding: support guest, signup, returning-user, permission-primer, and blocked-region or blocked-account states as appropriate for micromobility.
