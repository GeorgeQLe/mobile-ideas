...
## Overview
Build an original mobile product inspired by Airbnb's user-facing workflow, not its brand identity or proprietary implementation.
The clone target is: Search, map/list results, listing detail, booking calendar, guest fees, host messaging, wishlists, and trip management.
...
- Implement the app-specific focus: Search, map/list results, listing detail, booking calendar, guest fees, host messaging, wishlists, and trip management.
...
## Non-Goals
- Do not copy Airbnb branding, trade dress, logos, app icons, screenshots, marketing copy, or proprietary media.
...
## Research Sources
- App Store source-discovery link: https://apps.apple.com/us/search?term=Airbnb
- Google Play source-discovery link: https://play.google.com/store/search?q=Airbnb&c=apps
- Official help/privacy source-discovery link: https://www.google.com/search?q=Airbnb%20official%20app%20help%20privacy
