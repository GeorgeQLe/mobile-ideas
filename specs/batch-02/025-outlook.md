...
## Overview
Build an original mobile product inspired by Outlook's user-facing workflow, not its brand identity or proprietary implementation.
The clone target is: Focused inbox, calendar agenda, meeting RSVP, contacts, attachments, and enterprise account policies.
...
## Goals
- Deliver a mobile-first email/calendar experience with complete onboarding, core action, settings, and recovery flows.
- Implement the app-specific focus: Focused inbox, calendar agenda, meeting RSVP, contacts, attachments, and enterprise account policies.
...
## Non-Goals
- Do not copy Outlook branding, trade dress, logos, app icons, screenshots, marketing copy, or proprietary media.
...
## Research Sources
- App Store source-discovery link: https://apps.apple.com/us/search?term=Outlook
- Google Play source-discovery link: https://play.google.com/store/search?q=Outlook&c=apps
- Official help/privacy source-discovery link: https://www.google.com/search?q=Outlook%20official%20app%20help%20privacy
...
## Detailed Design
- Onboarding: support guest, signup, returning-user, permission-primer, and blocked-region or blocked-account states as appropriate for email/calendar.
