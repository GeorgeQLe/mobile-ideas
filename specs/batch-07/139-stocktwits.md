...
> - Category: Social investing community
...
> - Manual verification blockers: native posting/media capture, premium room purchase/restore, moderation queue behavior, trading/investing partner flows, sentiment calculation, and push payloads require community/compliance owners plus a test device/account.
...
Build an original mobile social investing community app inspired by Stocktwits's public workflow: ticker-centered social feed, watchlists, bullish/bearish sentiment, rooms, direct chat, charts, earnings calendar, market news, premium subscriptions, and community moderation. The clone must not copy Stocktwits branding, protected UI artwork, screenshots, copy, private APIs, partner contracts, proprietary datasets, or regulated operating status.
...
- Deliver the core social investing community jobs documented by the official app listings and first-party support/legal pages.
...
- Do not build a Stocktwits-branded app or imply affiliation, endorsement, banking status, broker-dealer status, RIA status, publisher status, money-transmitter status, or insurance status.
- Do not scrape Stocktwits, reuse private APIs, replay app traffic, copy article text, reproduce proprietary algorithms, or use unlicensed market/account/card/payment data.
...
|---|---|---|---|
| Apple App Store | https://apps.apple.com/us/app/stocktwits/id389157776 | Official iOS listing, device support, age rating, privacy label, feature claims, subscriptions or account disclosures where listed | Verified 2026-05-01 |
| Google Play | https://play.google.com/store/apps/details?id=org.stocktwits.android.activity | Official Android listing, feature claims, content rating, data safety, developer contact, partner/risk disclosures where listed | Verified 2026-05-01 |
| Stocktwits website | https://stocktwits.com | First-party product orientation and non-affiliation boundary for a lawful functional-parity clone | Verified 2026-05-01 |
| Stocktwits help/support | https://help.stocktwits.com | Support taxonomy, account-management concepts, troubleshooting paths, and user-facing escalation expectations | Verified 2026-05-01 |
| Stocktwits Privacy Policy | https://stocktwits.com/about/legal/privacy | Personal, financial, device, location, analytics, support, retention, sharing, deletion, and privacy-rights obligations | Verified 2026-05-01 |
| Stocktwits Terms | https://stocktwits.com/about/legal/terms | Eligibility, account rules, prohibited conduct, subscription/payment terms, risk language, user responsibilities, and dispute path | Verified 2026-05-01 |
| Stocktwits legal/disclosures | https://stocktwits.com/about/legal/disclaimer | Finance, banking, brokerage, advisory, market-data, partner-bank, FDIC/SIPC, risk, or product-specific disclosures | Verified 2026-05-01 |

## Detailed Design

### Source-Backed Product Requirements

- The V1 must center on ticker-centered social feed, watchlists, bullish/bearish sentiment, rooms, direct chat, charts, earnings calendar, market news, premium subscriptions, and community moderation, while using original product names, copy, visual design, data contracts, and content.
- The public app listings and first-party pages support real-time investor discussion, ticker watchlists, sentiment, posts with media, replies, follows, premium rooms, subscriptions, 18+ rating, and no-recommendation disclosures; any deeper account, paid, native, or regulated behavior remains blocked until hands-on verification.
...
- Social investing requires market-abuse, pump-and-dump, insider-information, impersonation, and harassment moderation before launch.
- Ticker posts, rooms, chat, comments, follows, reactions, and media uploads must enforce abuse, manipulation, spam, impersonation, disclosure, and misinformation rules.
- Sentiment signals must be labeled as community-derived indicators, not predictive recommendations or investment advice.

## Core User Journeys

- New user installs the app, reviews original onboarding, sees non-affiliation and social investing community disclosures, and chooses sign-up or read-only exploration where permitted.
...
- `AuditEvent`: append-only record for Stocktwits-inspired auth, consent, disclosure, privacy, support, regulated-action, and admin changes.
...
- `GET /dashboard`: returns the Stocktwits-inspired home summary with stale-data labels and feature flags.
