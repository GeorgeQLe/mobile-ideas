...
> - Manual verification blockers: native iOS/Android capture, subscription purchase/restore, live audio background behavior, quote-feed licensing, paywall entitlements, and push payloads require product/editorial/compliance owners plus a test device/account before one-for-one parity claims.
...
Build an original mobile finance news and markets app inspired by Bloomberg's public workflow: markets dashboard, watchlists, business-news reader, quote charts, alerts, live audio, podcasts, offline magazine reading, and subscription-gated premium journalism. The clone must not copy Bloomberg branding, protected UI artwork, screenshots, copy, private APIs, partner contracts, proprietary datasets, or regulated operating status.
...
- Do not build a Bloomberg-branded app or imply affiliation, endorsement, banking status, broker-dealer status, RIA status, publisher status, money-transmitter status, or insurance status.
- Do not scrape Bloomberg, reuse private APIs, replay app traffic, copy article text, reproduce proprietary algorithms, or use unlicensed market/account/card/payment data.
...
|---|---|---|---|
| Apple App Store | https://apps.apple.com/us/app/bloomberg-business-news/id281941097 | Official iOS listing, device support, age rating, privacy label, feature claims, subscriptions or account disclosures where listed | Verified 2026-05-01 |
| Google Play | https://play.google.com/store/apps/details?id=com.bloomberg.android.plus | Official Android listing, feature claims, content rating, data safety, developer contact, partner/risk disclosures where listed | Verified 2026-05-01 |
| Bloomberg website | https://www.bloomberg.com | First-party product orientation and non-affiliation boundary for a lawful functional-parity clone | Verified 2026-05-01 |
| Bloomberg help/support | https://www.bloomberg.com/company/support/ | Support taxonomy, account-management concepts, troubleshooting paths, and user-facing escalation expectations | Verified 2026-05-01 |
| Bloomberg Privacy Policy | https://www.bloomberg.com/notices/privacy/ | Personal, financial, device, location, analytics, support, retention, sharing, deletion, and privacy-rights obligations | Verified 2026-05-01 |
| Bloomberg Terms | https://www.bloomberg.com/notices/tos/ | Eligibility, account rules, prohibited conduct, subscription/payment terms, risk language, user responsibilities, and dispute path | Verified 2026-05-01 |
| Bloomberg legal/disclosures | https://www.bloomberg.com/notices/tos/ | Finance, banking, brokerage, advisory, market-data, partner-bank, FDIC/SIPC, risk, or product-specific disclosures | Verified 2026-05-01 |

## Detailed Design

### Source-Backed Product Requirements

- The V1 must center on markets dashboard, watchlists, business-news reader, quote charts, alerts, live audio, podcasts, offline magazine reading, and subscription-gated premium journalism, while using original product names, copy, visual design, data contracts, and content.
- The public app listings and first-party pages support news, markets data, watchlists, alerts, Bloomberg TV/radio, podcasts, offline Businessweek reading, app subscriptions, and legal notices; any deeper account, paid, native, or regulated behavior remains blocked until hands-on verification.
...
- Market data and news content must be licensed or original; never copy Bloomberg articles, terminal workflows, indices, videos, audio, trademarks, or paywalled datasets.
...
- `AuditEvent`: append-only record for Bloomberg-inspired auth, consent, disclosure, privacy, support, regulated-action, and admin changes.
...
- `GET /dashboard`: returns the Bloomberg-inspired home summary with stale-data labels and feature flags.
