...
> - Category: Investing and brokerage
...
> - Manual verification blockers: KYC/AML account approval, options suitability, crypto availability, IRA transfer, high-yield cash sweep, AI tool disclaimers, tax forms, and trading execution require brokerage/compliance/security owners and regulated-provider sandbox evidence.
...
Build an original mobile investing and brokerage app inspired by Public's public workflow: multi-asset self-directed investing, brokerage onboarding, portfolio transfer, stocks, options, bonds, crypto, retirement, high-yield cash, AI exploration, disclosures, and account approval. The clone must not copy Public branding, protected UI artwork, screenshots, copy, private APIs, partner contracts, proprietary datasets, or regulated operating status.
...
- Deliver the core investing and brokerage jobs documented by the official app listings and first-party support/legal pages.
...
- Do not build a Public-branded app or imply affiliation, endorsement, banking status, broker-dealer status, RIA status, publisher status, money-transmitter status, or insurance status.
- Do not scrape Public, reuse private APIs, replay app traffic, copy article text, reproduce proprietary algorithms, or use unlicensed market/account/card/payment data.
...
|---|---|---|---|
| Apple App Store | https://apps.apple.com/us/app/public-invest-trade/id1204112719 | Official iOS listing, device support, age rating, privacy label, feature claims, subscriptions or account disclosures where listed | Verified 2026-05-01 |
| Google Play | https://play.google.com/store/apps/details?id=com.public.app | Official Android listing, feature claims, content rating, data safety, developer contact, partner/risk disclosures where listed | Verified 2026-05-01 |
| Public website | https://public.com | First-party product orientation and non-affiliation boundary for a lawful functional-parity clone | Verified 2026-05-01 |
| Public help/support | https://help.public.com | Support taxonomy, account-management concepts, troubleshooting paths, and user-facing escalation expectations | Verified 2026-05-01 |
| Public Privacy Policy | https://public.com/privacy-policy | Personal, financial, device, location, analytics, support, retention, sharing, deletion, and privacy-rights obligations | Verified 2026-05-01 |
| Public Terms | https://public.com/terms-of-service | Eligibility, account rules, prohibited conduct, subscription/payment terms, risk language, user responsibilities, and dispute path | Verified 2026-05-01 |
| Public legal/disclosures | https://public.com/disclosures | Finance, banking, brokerage, advisory, market-data, partner-bank, FDIC/SIPC, risk, or product-specific disclosures | Verified 2026-05-01 |

## Detailed Design

### Source-Backed Product Requirements

- The V1 must center on multi-asset self-directed investing, brokerage onboarding, portfolio transfer, stocks, options, bonds, crypto, retirement, high-yield cash, AI exploration, disclosures, and account approval, while using original product names, copy, visual design, data contracts, and content.
- The public app listings and first-party pages support US 18+ account approval, securities/options/bonds/crypto disclosures, high-yield cash partner-bank disclosure, portfolio transfer match terms, AI exploration disclaimer, and brokerage risk language; any deeper account, paid, native, or regulated behavior remains blocked until hands-on verification.
...
- No order execution, options, crypto, IRA, cash sweep, or AI-investing assistant may ship without broker-dealer/registered-adviser/crypto partner review and explicit risk copy.
...
- New user installs the app, reviews original onboarding, sees non-affiliation and investing and brokerage disclosures, and chooses sign-up or read-only exploration where permitted.
...
- `AuditEvent`: append-only record for Public-inspired auth, consent, disclosure, privacy, support, regulated-action, and admin changes.
...
- `GET /dashboard`: returns the Public-inspired home summary with stale-data labels and feature flags.
