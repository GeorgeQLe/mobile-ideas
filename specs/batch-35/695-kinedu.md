...
> - Manual verification blockers: child development advice boundaries, expert content licensing, AI assistant safety, child profile privacy, subscriptions, caregiver sharing, milestone accuracy, and pregnancy/age-region support.
...
Build an original mobile product inspired by Kinedu's public parenting and family safety workflow. The V1 clone focuses on pregnancy and early-child development plans, milestone tracking, expert classes, AI assistant, activities, progress reports, caregiver sharing, subscriptions, and child-development disclaimers.
...
- Preserve the functional job behind Kinedu while using original product naming, original UI, original sample data, and licensed integrations.
...
- Do not copy Kinedu branding, logos, screenshots, marketing copy, private APIs, proprietary datasets, plan names, UI trade dress, community content, school content, health content, or protected media.
...
|---|---|---|---|
| Apple App Store | https://apps.apple.com/us/app/kinedu-baby-development/id741277284 | iOS listing, privacy labels, release notes, subscriptions, and child development claims | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
| Google Play | https://play.google.com/store/apps/details?id=com.kinedu.appkinedu | Android listing, data safety, subscriptions, and development feature claims | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
| Official product site | https://www.kinedu.com/ | Baby development, pregnancy, activities, classes, and subscription positioning | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
| Official support | https://help.kinedu.com/ | Account, baby profiles, subscriptions, activities, and troubleshooting | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
| Privacy policy | https://blog.kinedu.com/privacy-policy | Child profile, pregnancy, account, advertising, analytics, and sharing disclosures | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
| Terms | https://blog.kinedu.com/terms-of-use | Service terms, subscriptions, content, advice boundaries, and acceptable-use terms | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
...
- Manual blockers must remain launch-blocking until verified: child development advice boundaries, expert content licensing, AI assistant safety, child profile privacy, subscriptions, caregiver sharing, milestone accuracy, and pregnancy/age-region support.

## Core User Journeys

- User creates or restores a Kinedu-style account, completes required consent, role, or eligibility checks, and reaches the dashboard.
...
- Monetization model: use original free/trial/paid/sponsored/school/provider entitlement logic; do not copy exact pricing, plan names, bundle names, promotional copy, school contracts, or partner offers from Kinedu.
...
- Manual verification tests for child development advice boundaries, expert content licensing, AI assistant safety, child profile privacy, subscriptions, caregiver sharing, milestone accuracy, and pregnancy/age-region support.
...
- Phase 4: Add app-specific safety controls for pregnancy and early-child development plans, milestone tracking, expert classes, AI assistant, activities, progress reports, caregiver sharing, subscriptions, and child-development disclaimers.
...
- Confirm legal/privacy retention behavior for Kinedu-style sensitive records and update API contracts before downstream implementation.
