...
> - Manual verification blockers: calendar sharing permissions, household invite revocation, reminder delivery, subscription restore, private notes/list export, child accounts, and cross-platform sync conflict behavior.
...
Build an original mobile product inspired by FamCal's public parenting and family safety workflow. The V1 clone focuses on shared family calendar, lists, tasks, notes, reminders, birthdays, meal or grocery coordination, member roles, subscriptions, and private household data.
...
- Preserve the functional job behind FamCal while using original product naming, original UI, original sample data, and licensed integrations.
...
- Do not copy FamCal branding, logos, screenshots, marketing copy, private APIs, proprietary datasets, plan names, UI trade dress, community content, school content, health content, or protected media.
...
|---|---|---|---|
| Apple App Store | https://apps.apple.com/us/app/famcal-shared-family-calendar/id982105939 | iOS listing, privacy labels, release notes, subscriptions, and sharing claims | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
| Google Play | https://play.google.com/store/apps/details?id=com.appxy.famcal | Android listing, data safety, calendar/list claims, and release cadence | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
| Official product site | https://www.appxy.com/famcal/ | Family calendar, lists, tasks, notes, and product positioning | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
| Official support | https://www.appxy.com/contact/ | Account, sync, sharing, subscription, and support path | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
| Privacy policy | https://www.appxy.com/privacy-policy/ | Account, calendar, list, device, analytics, and sharing disclosures | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
| Terms | https://www.appxy.com/terms-of-service/ | Service terms, subscriptions, account, content, and acceptable-use boundaries | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
...
- Manual blockers must remain launch-blocking until verified: calendar sharing permissions, household invite revocation, reminder delivery, subscription restore, private notes/list export, child accounts, and cross-platform sync conflict behavior.

## Core User Journeys

- User creates or restores a FamCal-style account, completes required consent, role, or eligibility checks, and reaches the dashboard.
...
- Monetization model: use original free/trial/paid/sponsored/school/provider entitlement logic; do not copy exact pricing, plan names, bundle names, promotional copy, school contracts, or partner offers from FamCal.
...
- Manual verification tests for calendar sharing permissions, household invite revocation, reminder delivery, subscription restore, private notes/list export, child accounts, and cross-platform sync conflict behavior.
...
- Phase 4: Add app-specific safety controls for shared family calendar, lists, tasks, notes, reminders, birthdays, meal or grocery coordination, member roles, subscriptions, and private household data.
...
- Confirm legal/privacy retention behavior for FamCal-style sensitive records and update API contracts before downstream implementation.
