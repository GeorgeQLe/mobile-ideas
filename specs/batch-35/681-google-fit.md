...
> - Manual verification blockers: Health Connect behavior, connected-app permissions, wearable/device imports, Google account deletion/export, iOS availability, sensor accuracy, and regional health-feature availability.
...
Build an original mobile product inspired by Google Fit's public health and medical workflow. The V1 clone focuses on activity goals, steps, heart points, workouts, sleep, vitals, journal history, connected apps, Health Connect migration, and Google account privacy controls.
...
- Preserve the functional job behind Google Fit while using original product naming, original UI, original sample data, and licensed integrations.
...
- Do not copy Google Fit branding, logos, screenshots, marketing copy, private APIs, proprietary datasets, plan names, UI trade dress, community content, school content, health content, or protected media.
...
|---|---|---|---|
| Apple App Store | https://apps.apple.com/us/app/google-fit-activity-tracker/id1433864494 | iOS listing, privacy labels, release notes, and support links | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
| Google Play | https://play.google.com/store/apps/details?id=com.google.android.apps.fitness | Android listing, data safety, release cadence, and Health Connect notes | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
| Official product site | https://www.google.com/fit/ | Google Fit goals, activity, connected apps, and platform positioning | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
| Official help | https://support.google.com/fit/ | Setup, activity tracking, connected apps, account, and troubleshooting | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
| Privacy policy | https://policies.google.com/privacy | Google account, health, device, location, analytics, and sharing disclosures | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
| Terms | https://policies.google.com/terms | Google service terms, account, content, suspension, and service-change boundaries | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
...
- Manual blockers must remain launch-blocking until verified: Health Connect behavior, connected-app permissions, wearable/device imports, Google account deletion/export, iOS availability, sensor accuracy, and regional health-feature availability.

## Core User Journeys

- User creates or restores a Google Fit-style account, completes required consent, role, or eligibility checks, and reaches the dashboard.
...
- Monetization model: use original free/trial/paid/sponsored/school/provider entitlement logic; do not copy exact pricing, plan names, bundle names, promotional copy, school contracts, or partner offers from Google Fit.
...
- Manual verification tests for Health Connect behavior, connected-app permissions, wearable/device imports, Google account deletion/export, iOS availability, sensor accuracy, and regional health-feature availability.
...
- Phase 4: Add app-specific safety controls for activity goals, steps, heart points, workouts, sleep, vitals, journal history, connected apps, Health Connect migration, and Google account privacy controls.
...
- Confirm legal/privacy retention behavior for Google Fit-style sensitive records and update API contracts before downstream implementation.
