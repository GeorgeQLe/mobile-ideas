...
> - Manual verification blockers: Apple Watch data availability, Apple Health permissions, HRV/recovery algorithm claims, no verified Android parity, subscription restore, cycle-phase inference, and sensor gaps by device model.
...
Build an original mobile product inspired by Athlytic's public health and medical workflow. The V1 clone focuses on Apple Watch recovery, exertion, sleep, stress, battery, training load, widgets, menstrual-cycle context, subscriptions, and privacy-first Apple Health imports.
...
- Preserve the functional job behind Athlytic while using original product naming, original UI, original sample data, and licensed integrations.
...
- Do not copy Athlytic branding, logos, screenshots, marketing copy, private APIs, proprietary datasets, plan names, UI trade dress, community content, school content, health content, or protected media.
...
|---|---|---|---|
| Apple App Store | https://apps.apple.com/us/app/athlytic/id1543571755 | iOS listing, privacy labels, release notes, subscription claims, and Apple Watch requirements | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
| Google Play | Platform blocker: no verified first-party Google Play listing for Athlytic | Android parity is blocked until a first-party listing is verified | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
| Official product site | https://www.athlyticapp.com/ | Recovery, exertion, sleep, stress, Apple Watch, and feature positioning | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
| Official support | https://www.athlyticapp.com/support | Setup, Apple Health, Apple Watch, subscription, and troubleshooting support | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
| Privacy policy | https://www.athlyticapp.com/privacy-policy | Privacy disclosures for Health data, app data, and collection claims | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
| Terms | https://www.hockeytrackerapp.com/terms-of-service/ | Developer terms linked from public app listing | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
...
- Manual blockers must remain launch-blocking until verified: Apple Watch data availability, Apple Health permissions, HRV/recovery algorithm claims, no verified Android parity, subscription restore, cycle-phase inference, and sensor gaps by device model.

## Core User Journeys

- User creates or restores a Athlytic-style account, completes required consent, role, or eligibility checks, and reaches the dashboard.
...
- Monetization model: use original free/trial/paid/sponsored/school/provider entitlement logic; do not copy exact pricing, plan names, bundle names, promotional copy, school contracts, or partner offers from Athlytic.
...
- Manual verification tests for Apple Watch data availability, Apple Health permissions, HRV/recovery algorithm claims, no verified Android parity, subscription restore, cycle-phase inference, and sensor gaps by device model.
...
- Phase 4: Add app-specific safety controls for Apple Watch recovery, exertion, sleep, stress, battery, training load, widgets, menstrual-cycle context, subscriptions, and privacy-first Apple Health imports.
...
- Confirm legal/privacy retention behavior for Athlytic-style sensitive records and update API contracts before downstream implementation.
