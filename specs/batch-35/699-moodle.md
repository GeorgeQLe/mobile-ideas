# Moodle-Style Clone Spec

> Metadata
> - Inspiration app: Moodle
> - Category: Education
...
> - Manual verification blockers: site URL and version compatibility, plugin variance, offline sync, quiz security, assignment upload limits, student-data privacy, SSO, and school-hosted data deletion/export.
...
Build an original mobile product inspired by Moodle's public education workflow. The V1 clone focuses on self-hosted Moodle course access, offline course content, activities, assignments, quizzes, grades, messages, notifications, calendar, site plugins, and organization-specific configuration.
...
- Preserve the functional job behind Moodle while using original product naming, original UI, original sample data, and licensed integrations.
...
- Do not copy Moodle branding, logos, screenshots, marketing copy, private APIs, proprietary datasets, plan names, UI trade dress, community content, school content, health content, or protected media.
...
|---|---|---|---|
| Apple App Store | https://apps.apple.com/us/app/moodle/id633359593 | iOS listing, privacy labels, language support, compatibility, and app claims | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
| Google Play | https://play.google.com/store/apps/details?id=com.moodle.moodlemobile | Android listing, data safety, app claims, and release cadence | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
| Official product site | https://moodle.com/app/ | Moodle App feature scope, offline learning, notifications, and LMS positioning | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
| Official docs | https://docs.moodle.org/en/Moodle_app | App setup, site compatibility, offline access, activities, and troubleshooting | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
| Privacy notice | https://moodle.com/privacy-notice/ | Moodle service privacy disclosures and product data boundaries | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
| Terms | https://moodle.com/terms/ | Moodle website/service terms and acceptable-use boundaries | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
...
- Manual blockers must remain launch-blocking until verified: site URL and version compatibility, plugin variance, offline sync, quiz security, assignment upload limits, student-data privacy, SSO, and school-hosted data deletion/export.

## Core User Journeys

- User creates or restores a Moodle-style account, completes required consent, role, or eligibility checks, and reaches the dashboard.
...
- Monetization model: use original free/trial/paid/sponsored/school/provider entitlement logic; do not copy exact pricing, plan names, bundle names, promotional copy, school contracts, or partner offers from Moodle.
...
- Manual verification tests for site URL and version compatibility, plugin variance, offline sync, quiz security, assignment upload limits, student-data privacy, SSO, and school-hosted data deletion/export.
...
- Phase 4: Add app-specific safety controls for self-hosted Moodle course access, offline course content, activities, assignments, quizzes, grades, messages, notifications, calendar, site plugins, and organization-specific configuration.
...
- Confirm legal/privacy retention behavior for Moodle-style sensitive records and update API contracts before downstream implementation.
