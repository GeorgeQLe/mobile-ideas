...
> - Manual verification blockers: VPN/router/device-control behavior, location tracking, browsing history retention, subscription restore, child consent, app/site categorization, and emergency connectivity exceptions.
...
Build an original mobile product inspired by Circle Parental Controls's public parenting and family safety workflow. The V1 clone focuses on screen-time filters, pause internet, time limits, bedtime, focus time, rewards, history, location, in-home and on-the-go device coverage, and subscription gates.
...
- Preserve the functional job behind Circle Parental Controls while using original product naming, original UI, original sample data, and licensed integrations.
...
- Do not copy Circle Parental Controls branding, logos, screenshots, marketing copy, private APIs, proprietary datasets, plan names, UI trade dress, community content, school content, health content, or protected media.
...
|---|---|---|---|
| Apple App Store | https://apps.apple.com/us/app/circle-parental-controls-app/id1440668949 | iOS listing, privacy labels, location note, subscription claims, and support links | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
| Google Play | https://play.google.com/store/apps/details?id=com.meetcircle.circle | Android listing, data safety, subscription claims, and release cadence | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
| Official product site | https://meetcircle.com/ | Parental controls, filtering, screen time, location, and subscription positioning | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
| Official support | https://support.meetcircle.com/ | Setup, subscriptions, devices, filtering, location, and troubleshooting | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
| Privacy policy | https://meetcircle.com/legal/privacy/ | Child, browsing, location, account, analytics, and sharing disclosures | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
| Terms | https://meetcircle.com/license/ | License, subscriptions, family controls, device coverage, and acceptable-use terms | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
...
- Manual blockers must remain launch-blocking until verified: VPN/router/device-control behavior, location tracking, browsing history retention, subscription restore, child consent, app/site categorization, and emergency connectivity exceptions.

## Core User Journeys

- User creates or restores a Circle Parental Controls-style account, completes required consent, role, or eligibility checks, and reaches the dashboard.
...
- Monetization model: use original free/trial/paid/sponsored/school/provider entitlement logic; do not copy exact pricing, plan names, bundle names, promotional copy, school contracts, or partner offers from Circle Parental Controls.
...
- Manual verification tests for VPN/router/device-control behavior, location tracking, browsing history retention, subscription restore, child consent, app/site categorization, and emergency connectivity exceptions.
...
- Phase 4: Add app-specific safety controls for screen-time filters, pause internet, time limits, bedtime, focus time, rewards, history, location, in-home and on-the-go device coverage, and subscription gates.
...
- Confirm legal/privacy retention behavior for Circle Parental Controls-style sensitive records and update API contracts before downstream implementation.
