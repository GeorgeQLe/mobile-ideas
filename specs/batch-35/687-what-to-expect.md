...
> - Manual verification blockers: medical advice boundaries, community moderation, due-date personalization, advertising/sponsored content, account deletion/export, push timing, and pregnancy/family privacy controls.
...
Build an original mobile product inspired by What to Expect's public parenting and family safety workflow. The V1 clone focuses on pregnancy and baby tracking, daily/week-by-week content, community groups, due-date personalization, checklists, product recommendations, and health-adjacent disclaimers.
...
- Preserve the functional job behind What to Expect while using original product naming, original UI, original sample data, and licensed integrations.
...
- Do not copy What to Expect branding, logos, screenshots, marketing copy, private APIs, proprietary datasets, plan names, UI trade dress, community content, school content, health content, or protected media.
...
|---|---|---|---|
| Apple App Store | https://apps.apple.com/us/app/pregnancy-baby-tracker-wte/id289560144 | iOS listing, privacy labels, release notes, and pregnancy/baby claims | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
| Google Play | https://play.google.com/store/apps/details?id=com.wte.view | Android listing, data safety, community/content claims, and release cadence | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
| Official product site | https://www.whattoexpect.com/ | Pregnancy, baby, community, tools, and content positioning | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
| Official support | https://www.whattoexpect.com/contact-us | Account, content, app, advertising, privacy, and support paths | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
| Privacy policy | https://www.whattoexpect.com/privacy-policy | Pregnancy, child, community, account, advertising, analytics, and sharing disclosures | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
| Terms | https://www.whattoexpect.com/terms-of-use | Service terms, community, content, medical disclaimers, and acceptable-use boundaries | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
...
- Manual blockers must remain launch-blocking until verified: medical advice boundaries, community moderation, due-date personalization, advertising/sponsored content, account deletion/export, push timing, and pregnancy/family privacy controls.

## Core User Journeys

- User creates or restores a What to Expect-style account, completes required consent, role, or eligibility checks, and reaches the dashboard.
...
- Monetization model: use original free/trial/paid/sponsored/school/provider entitlement logic; do not copy exact pricing, plan names, bundle names, promotional copy, school contracts, or partner offers from What to Expect.
...
- Manual verification tests for medical advice boundaries, community moderation, due-date personalization, advertising/sponsored content, account deletion/export, push timing, and pregnancy/family privacy controls.
...
- Phase 4: Add app-specific safety controls for pregnancy and baby tracking, daily/week-by-week content, community groups, due-date personalization, checklists, product recommendations, and health-adjacent disclaimers.
...
- Confirm legal/privacy retention behavior for What to Expect-style sensitive records and update API contracts before downstream implementation.
