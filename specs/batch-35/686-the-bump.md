...
> - Manual verification blockers: pregnancy/medical advice boundaries, sponsored content, registry partner handoff, community moderation, personalized ads, minor/family data, notifications, and regional availability.
...
Build an original mobile product inspired by The Bump's public parenting and family safety workflow. The V1 clone focuses on pregnancy tracking, week-by-week content, baby registry, appointment and checklist reminders, community/content surfaces, product tools, and family privacy controls.
...
- Preserve the functional job behind The Bump while using original product naming, original UI, original sample data, and licensed integrations.
...
- Do not copy The Bump branding, logos, screenshots, marketing copy, private APIs, proprietary datasets, plan names, UI trade dress, community content, school content, health content, or protected media.
...
|---|---|---|---|
| Apple App Store | https://apps.apple.com/us/app/the-bump-pregnancy-tracker/id566780309 | iOS listing, privacy labels, release notes, and pregnancy feature claims | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
| Google Play | https://play.google.com/store/apps/details?id=com.xogrp.thebump | Android listing, data safety, feature claims, and release cadence | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
| Official product site | https://www.thebump.com/ | Pregnancy tracker, registry, content, tools, and community positioning | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
| Official help | https://help.thebump.com/ | Account, app, registry, content, privacy, and support docs | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
| Privacy policy | https://www.thebump.com/privacy-policy | Pregnancy, family, account, advertising, analytics, and sharing disclosures | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
| Terms | https://www.thebump.com/terms-of-use | Service terms, content, registry, community, and acceptable-use boundaries | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
...
- Manual blockers must remain launch-blocking until verified: pregnancy/medical advice boundaries, sponsored content, registry partner handoff, community moderation, personalized ads, minor/family data, notifications, and regional availability.

## Core User Journeys

- User creates or restores a The Bump-style account, completes required consent, role, or eligibility checks, and reaches the dashboard.
...
- Monetization model: use original free/trial/paid/sponsored/school/provider entitlement logic; do not copy exact pricing, plan names, bundle names, promotional copy, school contracts, or partner offers from The Bump.
...
- Manual verification tests for pregnancy/medical advice boundaries, sponsored content, registry partner handoff, community moderation, personalized ads, minor/family data, notifications, and regional availability.
...
- Phase 4: Add app-specific safety controls for pregnancy tracking, week-by-week content, baby registry, appointment and checklist reminders, community/content surfaces, product tools, and family privacy controls.
...
- Confirm legal/privacy retention behavior for The Bump-style sensitive records and update API contracts before downstream implementation.
