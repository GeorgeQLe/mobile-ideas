...
> - Manual verification blockers: identity/profile moderation, private messaging, community safety, reproductive/fertility privacy, age gating, subscriptions or paid features, push payloads, and abusive-content handling.
...
Build an original mobile product inspired by Peanut's public parenting and family safety workflow. The V1 clone focuses on women-focused community onboarding, profile verification, matching, groups, chats, pregnancy/fertility/parenting/menopause spaces, reporting/blocking, and safety moderation.
...
- Preserve the functional job behind Peanut while using original product naming, original UI, original sample data, and licensed integrations.
...
- Do not copy Peanut branding, logos, screenshots, marketing copy, private APIs, proprietary datasets, plan names, UI trade dress, community content, school content, health content, or protected media.
...
|---|---|---|---|
| Apple App Store | https://apps.apple.com/us/app/peanut-meet-female-friends/id1178656034 | iOS listing, privacy labels, release notes, community claims, and support links | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
| Google Play | https://play.google.com/store/apps/details?id=com.teampeanut.peanut | Android listing, data safety, community claims, and release cadence | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
| Official product site | https://www.peanut-app.io/ | Community, friendship, fertility, pregnancy, motherhood, and safety positioning | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
| Official support | https://support.peanut-app.io/ | Account, matching, groups, messages, reporting, and safety support | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
| Privacy policy | https://www.peanut-app.io/privacy | Community, profile, reproductive, account, analytics, and sharing disclosures | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
| Terms | https://www.peanut-app.io/terms | Service, community, safety, content, account, and acceptable-use terms | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
...
- Manual blockers must remain launch-blocking until verified: identity/profile moderation, private messaging, community safety, reproductive/fertility privacy, age gating, subscriptions or paid features, push payloads, and abusive-content handling.

## Core User Journeys

- User creates or restores a Peanut-style account, completes required consent, role, or eligibility checks, and reaches the dashboard.
...
- Monetization model: use original free/trial/paid/sponsored/school/provider entitlement logic; do not copy exact pricing, plan names, bundle names, promotional copy, school contracts, or partner offers from Peanut.
...
- Manual verification tests for identity/profile moderation, private messaging, community safety, reproductive/fertility privacy, age gating, subscriptions or paid features, push payloads, and abusive-content handling.
...
- Phase 4: Add app-specific safety controls for women-focused community onboarding, profile verification, matching, groups, chats, pregnancy/fertility/parenting/menopause spaces, reporting/blocking, and safety moderation.
...
- Confirm legal/privacy retention behavior for Peanut-style sensitive records and update API contracts before downstream implementation.
