...
> - Manual verification blockers: provider licensing freshness, reviews provenance, childcare availability, messaging/contact routing, ad/sponsored listings, child data, location privacy, and regional market coverage.
...
Build an original mobile product inspired by Winnie's public parenting and family safety workflow. The V1 clone focuses on childcare and preschool search, provider profiles, parent reviews, licensing/safety cues, messaging/contact, waitlists, community Q&A, and family-location privacy.
...
- Preserve the functional job behind Winnie while using original product naming, original UI, original sample data, and licensed integrations.
...
- Do not copy Winnie branding, logos, screenshots, marketing copy, private APIs, proprietary datasets, plan names, UI trade dress, community content, school content, health content, or protected media.
...
|---|---|---|---|
| Apple App Store | https://apps.apple.com/us/app/winnie-childcare-preschool/id1065802380 | iOS listing, privacy labels, childcare search claims, and support links | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
| Google Play | https://play.google.com/store/apps/details?id=co.winnie | Android listing, data safety, childcare search claims, and release cadence | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
| Official product site | https://winnie.com/ | Childcare search, preschool, reviews, providers, and local family resources | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
| Official support | https://winnie.com/contact | Contact, provider support, account, listing, and family support paths | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
| Privacy policy | https://winnie.com/privacy | Family, location, childcare-search, account, analytics, and sharing disclosures | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
| Terms | https://winnie.com/terms | Service, reviews, provider listings, content, and acceptable-use terms | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
...
- Manual blockers must remain launch-blocking until verified: provider licensing freshness, reviews provenance, childcare availability, messaging/contact routing, ad/sponsored listings, child data, location privacy, and regional market coverage.
...
- Monetization model: use original free/trial/paid/sponsored/school/provider entitlement logic; do not copy exact pricing, plan names, bundle names, promotional copy, school contracts, or partner offers from Winnie.
...
- Manual verification tests for provider licensing freshness, reviews provenance, childcare availability, messaging/contact routing, ad/sponsored listings, child data, location privacy, and regional market coverage.
...
- Phase 4: Add app-specific safety controls for childcare and preschool search, provider profiles, parent reviews, licensing/safety cues, messaging/contact, waitlists, community Q&A, and family-location privacy.
...
- Confirm legal/privacy retention behavior for Winnie-style sensitive records and update API contracts before downstream implementation.
