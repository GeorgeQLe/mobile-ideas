...
> - Manual verification blockers: supervised account age/region rules, child device compatibility, Google Play approval limits, location availability, school-time behavior, account deletion, and Google ecosystem policy changes.
...
Build an original mobile product inspired by Family Link's public parenting and family safety workflow. The V1 clone focuses on supervised Google accounts, screen-time rules, app approvals, content filters, location, school time/downtime, privacy settings, child account recovery, and parent notifications.
...
- Preserve the functional job behind Family Link while using original product naming, original UI, original sample data, and licensed integrations.
...
- Do not copy Family Link branding, logos, screenshots, marketing copy, private APIs, proprietary datasets, plan names, UI trade dress, community content, school content, health content, or protected media.
...
|---|---|---|---|
| Apple App Store | https://apps.apple.com/us/app/google-family-link/id1150085200 | iOS listing, privacy labels, compatibility notes, and feature limitations | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
| Google Play | https://play.google.com/store/apps/details?id=com.google.android.apps.kids.familylink | Android listing, data safety, feature claims, and release cadence | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
| Official product site | https://families.google/familylink/ | Family Link features, supervised accounts, compatibility, and family-safety positioning | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
| Official help | https://support.google.com/families/ | Setup, accounts, supervision, location, Play approvals, and troubleshooting | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
| Privacy policy | https://policies.google.com/privacy | Google account, child, device, location, analytics, and sharing disclosures | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
| Terms | https://policies.google.com/terms | Google service terms, family account boundaries, and account controls | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
...
- Manual blockers must remain launch-blocking until verified: supervised account age/region rules, child device compatibility, Google Play approval limits, location availability, school-time behavior, account deletion, and Google ecosystem policy changes.

## Core User Journeys

- User creates or restores a Family Link-style account, completes required consent, role, or eligibility checks, and reaches the dashboard.
...
- Monetization model: use original free/trial/paid/sponsored/school/provider entitlement logic; do not copy exact pricing, plan names, bundle names, promotional copy, school contracts, or partner offers from Family Link.
...
- Manual verification tests for supervised account age/region rules, child device compatibility, Google Play approval limits, location availability, school-time behavior, account deletion, and Google ecosystem policy changes.
...
- Phase 4: Add app-specific safety controls for supervised Google accounts, screen-time rules, app approvals, content filters, location, school time/downtime, privacy settings, child account recovery, and parent notifications.
...
- Confirm legal/privacy retention behavior for Family Link-style sensitive records and update API contracts before downstream implementation.
