...
> - Manual verification blockers: sleep debt algorithm, calendar permissions, Apple Health/watch imports, notification timing, subscription restore, sleep-health claims, and regional privacy/ad tracking disclosures.
...
Build an original mobile product inspired by Rise Sleep's public health and medical workflow. The V1 clone focuses on sleep debt, energy schedule, circadian predictions, habit reminders, calendar integration, sleep sounds, smart alarm, Apple Watch data, coaching content, and subscription gates.
...
- Preserve the functional job behind Rise Sleep while using original product naming, original UI, original sample data, and licensed integrations.
...
- Do not copy Rise Sleep branding, logos, screenshots, marketing copy, private APIs, proprietary datasets, plan names, UI trade dress, community content, school content, health content, or protected media.
...
|---|---|---|---|
| Apple App Store | https://apps.apple.com/us/app/rise-sleep-tracker/id1453884781 | iOS listing, privacy labels, release notes, subscription and tracking disclosures | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
| Google Play | https://play.google.com/store/apps/details?id=com.risesci.nyx | Android listing, data safety, sleep tracking claims, and release cadence | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
| Official product site | https://www.risescience.com/rise-app | Sleep debt, energy, habits, calendar, and product positioning | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
| Official support | https://help.risescience.com/ | Account, sleep tracking, subscriptions, calendar, and troubleshooting | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
| Privacy policy | https://www.risescience.com/privacy-policy | Sleep, calendar, account, analytics, advertising, and sharing disclosures | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
| Terms | https://www.risescience.com/terms-of-use | Service terms, subscription, app use, content, and health-disclaimer boundaries | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
...
- Manual blockers must remain launch-blocking until verified: sleep debt algorithm, calendar permissions, Apple Health/watch imports, notification timing, subscription restore, sleep-health claims, and regional privacy/ad tracking disclosures.

## Core User Journeys

- User creates or restores a Rise Sleep-style account, completes required consent, role, or eligibility checks, and reaches the dashboard.
...
- Monetization model: use original free/trial/paid/sponsored/school/provider entitlement logic; do not copy exact pricing, plan names, bundle names, promotional copy, school contracts, or partner offers from Rise Sleep.
...
- Manual verification tests for sleep debt algorithm, calendar permissions, Apple Health/watch imports, notification timing, subscription restore, sleep-health claims, and regional privacy/ad tracking disclosures.
...
- Phase 4: Add app-specific safety controls for sleep debt, energy schedule, circadian predictions, habit reminders, calendar integration, sleep sounds, smart alarm, Apple Watch data, coaching content, and subscription gates.
...
- Confirm legal/privacy retention behavior for Rise Sleep-style sensitive records and update API contracts before downstream implementation.
