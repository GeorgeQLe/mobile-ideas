...
> - Manual verification blockers: camera/PPG measurement accuracy, HRV interpretation, Apple Health and wearable permissions, subscription restore, medical disclaimer copy, blood-pressure claim boundaries, and data-sharing controls.
...
Build an original mobile product inspired by Welltory's public health and medical workflow. The V1 clone focuses on heart-rate and HRV readings, stress/energy insights, blood pressure and wellness disclaimers, Apple Health/device imports, integrations, experiments, subscriptions, and analytics-heavy privacy controls.
...
- Deliver a mobile-first health and medical experience with onboarding, dashboard, primary workflow, reminders or notifications, settings, support, and recovery flows.
- Preserve the functional job behind Welltory while using original product naming, original UI, original sample data, and licensed integrations.
...
- Do not copy Welltory branding, logos, screenshots, marketing copy, private APIs, proprietary datasets, plan names, UI trade dress, community content, school content, health content, or protected media.
...
|---|---|---|---|
| Apple App Store | https://apps.apple.com/us/app/welltory-heart-rate-monitor/id1074367771 | iOS listing, privacy labels, release notes, subscription terms, and Apple Health notes | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
| Google Play | https://play.google.com/store/apps/details?id=com.welltory.client.android | Android listing, data safety, feature claims, and release cadence | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
| Official product site | https://welltory.com/ | Health insights, HRV, stress, integrations, and subscription positioning | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
| Official support | https://help.welltory.com/ | Account, measurements, integrations, subscriptions, and troubleshooting | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
| Privacy policy | https://welltory.com/privacy/ | Health, location, account, analytics, advertising, and sharing disclosures | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
| Terms | https://welltory.com/terms/ | Service terms, subscriptions, health disclaimers, account, and acceptable-use boundaries | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
...
- Manual blockers must remain launch-blocking until verified: camera/PPG measurement accuracy, HRV interpretation, Apple Health and wearable permissions, subscription restore, medical disclaimer copy, blood-pressure claim boundaries, and data-sharing controls.

## Core User Journeys

- User creates or restores a Welltory-style account, completes required consent, role, or eligibility checks, and reaches the dashboard.
...
|---|---|---|---|---|
| Welcome/Auth | Health onboarding, consent, and account setup | email, SSO, permissions, device | new, returning, consented, locked | permission denied, no wearable, unsupported region |
| Health Dashboard | Activity, sleep, recovery, wellness, or session summary | tap, refresh, device sync | empty, loading, current, stale | sensor missing, stale sync, subscription gated |
| Tracking/Session | Workout, sleep, audio, health metric, or wellness session | start, stop, log, import, timer | draft, active, complete, synced | bad sensor, unsafe claim, interrupted session |
| Insights/History | Trends, reports, records, charts, and exports | filter, export, share | empty, loaded, exported, delayed | device-owned data, unsupported export, privacy hold |
| Settings/Privacy | Permissions, integrations, subscriptions, support, export, and deletion | toggles, restore, links, request | loaded, editing, requested | HealthKit/Connect revoked, legal hold, account locked |
...
- Treat health data, wearable/device readings, sleep/audio data, wellness recommendations, medical-adjacent disclaimers, subscriptions, HealthKit/Health Connect permissions, sensor accuracy, and data export/deletion as launch-blocking review areas with owners, mitigations, and acceptance tests before implementation.
...
- Monetization model: use original free/trial/paid/sponsored/school/provider entitlement logic; do not copy exact pricing, plan names, bundle names, promotional copy, school contracts, or partner offers from Welltory.
...
- Manual verification tests for camera/PPG measurement accuracy, HRV interpretation, Apple Health and wearable permissions, subscription restore, medical disclaimer copy, blood-pressure claim boundaries, and data-sharing controls.
...
- Phase 4: Add app-specific safety controls for heart-rate and HRV readings, stress/energy insights, blood pressure and wellness disclaimers, Apple Health/device imports, integrations, experiments, subscriptions, and analytics-heavy privacy controls.
...
- Confirm legal/privacy retention behavior for Welltory-style sensitive records and update API contracts before downstream implementation.
