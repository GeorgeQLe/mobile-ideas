...
> - Manual verification blockers: licensed audio assets, offline playback, sleep-health claims, subscription restore, background audio behavior, content personalization, and no-medical-advice copy.
...
Build an original mobile product inspired by Pzizz's public health and medical workflow. The V1 clone focuses on sleep, nap, focus, soundscape sessions, narration/music mixes, timers, offline audio, favorites, reminders, Premium access, and wellness disclaimers.
...
- Preserve the functional job behind Pzizz while using original product naming, original UI, original sample data, and licensed integrations.
...
- Do not copy Pzizz branding, logos, screenshots, marketing copy, private APIs, proprietary datasets, plan names, UI trade dress, community content, school content, health content, or protected media.
...
|---|---|---|---|
| Apple App Store | https://apps.apple.com/us/app/pzizz-sleep-nap-focus/id915664862 | iOS listing, privacy labels, release notes, subscriptions, and audio feature claims | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
| Google Play | https://play.google.com/store/apps/details?id=com.pzizz.android | Android listing, data safety, subscriptions, and audio behavior | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
| Official product site | https://pzizz.com/ | Sleep, nap, focus, audio science, and product positioning | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
| Official support | https://pzizz.com/support/ | Account, audio, subscriptions, downloads, and troubleshooting | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
| Privacy policy | https://pzizz.com/privacy-policy/ | Account, usage, audio, analytics, and sharing disclosures | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
| Terms | https://pzizz.com/terms-and-conditions/ | Service, subscriptions, content licensing, and acceptable-use terms | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
...
- Manual blockers must remain launch-blocking until verified: licensed audio assets, offline playback, sleep-health claims, subscription restore, background audio behavior, content personalization, and no-medical-advice copy.

## Core User Journeys

- User creates or restores a Pzizz-style account, completes required consent, role, or eligibility checks, and reaches the dashboard.
...
- Monetization model: use original free/trial/paid/sponsored/school/provider entitlement logic; do not copy exact pricing, plan names, bundle names, promotional copy, school contracts, or partner offers from Pzizz.
...
- Manual verification tests for licensed audio assets, offline playback, sleep-health claims, subscription restore, background audio behavior, content personalization, and no-medical-advice copy.
...
- Phase 4: Add app-specific safety controls for sleep, nap, focus, soundscape sessions, narration/music mixes, timers, offline audio, favorites, reminders, Premium access, and wellness disclaimers.
...
- Confirm legal/privacy retention behavior for Pzizz-style sensitive records and update API contracts before downstream implementation.
