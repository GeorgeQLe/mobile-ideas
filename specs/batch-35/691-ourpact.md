...
> - Manual verification blockers: iOS device management profiles, Android device-admin behavior, screenshot privacy, location accuracy, VPN/filter behavior, subscription restore, child consent, and uninstall/tamper handling.
...
Build an original mobile product inspired by OurPact's public parenting and family safety workflow. The V1 clone focuses on family screen-time rules, app blocking, schedules, web filters, location/geofences, screenshots, child device management, subscriptions, and parent-child trust controls.
...
- Preserve the functional job behind OurPact while using original product naming, original UI, original sample data, and licensed integrations.
...
- Do not copy OurPact branding, logos, screenshots, marketing copy, private APIs, proprietary datasets, plan names, UI trade dress, community content, school content, health content, or protected media.
...
|---|---|---|---|
| Apple App Store | https://apps.apple.com/us/app/ourpact-parental-control-app/id954029412 | iOS listing, privacy labels, release notes, subscriptions, and device-management claims | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
| Google Play | https://play.google.com/store/apps/details?id=com.eturi.ourpact | Android listing, data safety, feature claims, and release cadence | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
| Official product site | https://ourpact.com/ | Screen time, app blocking, family locator, schedules, and subscription positioning | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
| Official support | https://support.ourpact.com/ | Setup, profiles, devices, subscriptions, family rules, and troubleshooting | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
| Privacy policy | https://ourpact.com/privacy/ | Child, device, location, screenshot, account, analytics, and sharing disclosures | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
| Terms | https://ourpact.com/terms/ | Service terms, parental controls, subscriptions, device management, and acceptable-use boundaries | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
...
- Manual blockers must remain launch-blocking until verified: iOS device management profiles, Android device-admin behavior, screenshot privacy, location accuracy, VPN/filter behavior, subscription restore, child consent, and uninstall/tamper handling.

## Core User Journeys

- User creates or restores a OurPact-style account, completes required consent, role, or eligibility checks, and reaches the dashboard.
...
- Monetization model: use original free/trial/paid/sponsored/school/provider entitlement logic; do not copy exact pricing, plan names, bundle names, promotional copy, school contracts, or partner offers from OurPact.
...
- Manual verification tests for iOS device management profiles, Android device-admin behavior, screenshot privacy, location accuracy, VPN/filter behavior, subscription restore, child consent, and uninstall/tamper handling.
...
- Phase 4: Add app-specific safety controls for family screen-time rules, app blocking, schedules, web filters, location/geofences, screenshots, child device management, subscriptions, and parent-child trust controls.
...
- Confirm legal/privacy retention behavior for OurPact-style sensitive records and update API contracts before downstream implementation.
