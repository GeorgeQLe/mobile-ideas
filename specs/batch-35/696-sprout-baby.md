...
> - Manual verification blockers: infant health advice boundaries, medicine dose safety, caregiver sharing, data export, subscription/paid app state, device sync, multi-child privacy, and notification timing.
...
Build an original mobile product inspired by Sprout Baby's public parenting and family safety workflow. The V1 clone focuses on baby feeding, diaper, sleep, growth, health, pumping, milestone, medicine, multi-child logs, reports, reminders, caregiver sharing, and pediatrician export.
...
- Preserve the functional job behind Sprout Baby while using original product naming, original UI, original sample data, and licensed integrations.
...
- Do not copy Sprout Baby branding, logos, screenshots, marketing copy, private APIs, proprietary datasets, plan names, UI trade dress, community content, school content, health content, or protected media.
...
|---|---|---|---|
| Apple App Store | https://apps.apple.com/us/app/sprout-baby-tracker/id551448817 | iOS listing, privacy labels, release notes, and baby tracking claims | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
| Google Play | https://play.google.com/store/apps/details?id=com.medart.baby | Android listing, data safety, baby tracker claims, and release cadence | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
| Official product site | https://sprout-apps.com/sprout-baby/ | Baby tracking, reports, reminders, and family app positioning | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
| Official support | https://sprout-apps.com/support/ | Account, sync, reports, subscriptions, and troubleshooting | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
| Privacy policy | https://sprout-apps.com/privacy-policy/ | Child, health, account, device, analytics, and sharing disclosures | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
| Terms | https://sprout-apps.com/terms-of-use/ | Service terms, app use, content, subscriptions, and advice boundaries | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
...
- Manual blockers must remain launch-blocking until verified: infant health advice boundaries, medicine dose safety, caregiver sharing, data export, subscription/paid app state, device sync, multi-child privacy, and notification timing.

## Core User Journeys

- User creates or restores a Sprout Baby-style account, completes required consent, role, or eligibility checks, and reaches the dashboard.
...
- Monetization model: use original free/trial/paid/sponsored/school/provider entitlement logic; do not copy exact pricing, plan names, bundle names, promotional copy, school contracts, or partner offers from Sprout Baby.
...
- Manual verification tests for infant health advice boundaries, medicine dose safety, caregiver sharing, data export, subscription/paid app state, device sync, multi-child privacy, and notification timing.
...
- Phase 4: Add app-specific safety controls for baby feeding, diaper, sleep, growth, health, pumping, milestone, medicine, multi-child logs, reports, reminders, caregiver sharing, and pediatrician export.
...
- Confirm legal/privacy retention behavior for Sprout Baby-style sensitive records and update API contracts before downstream implementation.
