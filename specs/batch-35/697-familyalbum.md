...
> - Manual verification blockers: child photo/video privacy, invite revocation, print/order fulfillment, Premium restore, media export/delete, ad tracking, moderation/reporting, and regional print availability.
...
Build an original mobile product inspired by FamilyAlbum's public parenting and family safety workflow. The V1 clone focuses on private family photo/video sharing, child age timeline, family invites, comments, monthly movies, prints, Premium storage/video features, visibility controls, and child-media privacy.
...
- Preserve the functional job behind FamilyAlbum while using original product naming, original UI, original sample data, and licensed integrations.
...
- Do not copy FamilyAlbum branding, logos, screenshots, marketing copy, private APIs, proprietary datasets, plan names, UI trade dress, community content, school content, health content, or protected media.
...
|---|---|---|---|
| Apple App Store | https://apps.apple.com/us/app/familyalbum-photo-sharing/id935672069 | iOS listing, privacy labels, media sharing claims, subscriptions, and print offers | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
| Google Play | https://play.google.com/store/apps/details?id=us.mitene | Android listing, data safety, subscriptions, print offers, and media sharing claims | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
| Official product site | https://family-album.com/ | Private album, family sharing, prints, Premium, and product positioning | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
| Official help | https://help.family-album.com/ | Account, album, invites, media, prints, subscriptions, and support docs | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
| Privacy policy | https://family-album.com/privacy | Child media, account, invites, advertising, analytics, and sharing disclosures | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
| Terms | https://family-album.com/terms | Service terms, family media, content, subscriptions, prints, and acceptable-use boundaries | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
...
- Manual blockers must remain launch-blocking until verified: child photo/video privacy, invite revocation, print/order fulfillment, Premium restore, media export/delete, ad tracking, moderation/reporting, and regional print availability.

## Core User Journeys

- User creates or restores a FamilyAlbum-style account, completes required consent, role, or eligibility checks, and reaches the dashboard.
...
- Monetization model: use original free/trial/paid/sponsored/school/provider entitlement logic; do not copy exact pricing, plan names, bundle names, promotional copy, school contracts, or partner offers from FamilyAlbum.
...
- Manual verification tests for child photo/video privacy, invite revocation, print/order fulfillment, Premium restore, media export/delete, ad tracking, moderation/reporting, and regional print availability.
...
- Phase 4: Add app-specific safety controls for private family photo/video sharing, child age timeline, family invites, comments, monthly movies, prints, Premium storage/video features, visibility controls, and child-media privacy.
...
- Confirm legal/privacy retention behavior for FamilyAlbum-style sensitive records and update API contracts before downstream implementation.
