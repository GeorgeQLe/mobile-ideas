# Product Hunt-Style Clone Spec

> Metadata
> - Inspiration app: Product Hunt
...
> - Manual verification blockers: Product Hunt account and maker profile policy, hunter/maker/community-member role distinctions, daily launch timing and timezone handling, upvote authenticity and fraud detection, comment threading and moderation, product page creation and media upload requirements, collection curation and editorial selection, launch scheduling rules and hunter invitation, review rating criteria and verification, discussion thread categorization, Ask PH question submission and answer ranking, golden kitty nomination and voting periods, job board posting and application flow, newsletter subscriber management and delivery, Ship page creation and subscriber notification, push notification delivery for launch/upvote/comment/milestone events, offline product browsing, API rate limits, and community guidelines enforcement.
...
Build an original mobile product inspired by Product Hunt's public developer tools workflow. The V1 clone focuses on product discovery and launch platform with daily product launches and rankings, product upvoting and commenting, maker profiles and product pages, collections and topics for categorization, launch scheduling and announcement, product reviews and ratings, discussion threads, Ask Product Hunt (Q&A), golden kitty awards, job board, newsletter digest, maker tools (ship pages, upcoming), push notifications for launches/upvotes/comments/milestones, and community features (streaks, badges).
...
- Preserve the functional job behind Product Hunt while using original product naming, original UI, original sample data, and licensed integrations.
...
- Do not copy Product Hunt branding, logos, screenshots, marketing copy, private APIs, proprietary datasets, plan names, UI trade dress, course libraries, textbook solutions, documents, school content, AI prompts, or protected media.
...
|---|---|---|---|
| Apple App Store | https://apps.apple.com/us/app/product-hunt-tech-new-products/id904658671 | iOS listing, privacy labels, release notes, product discovery claims, and support links | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
| Google Play | https://play.google.com/store/apps/details?id=com.producthunt | Android listing, data safety, product launch/community claims, and release cadence | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
| Official product site | https://www.producthunt.com/ | Product Hunt product discovery, launches, maker tools, and product positioning | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
| Official help | https://www.producthunt.com/faq | Product Hunt FAQ, launching, hunting, community rules, and troubleshooting | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
| Privacy policy | https://www.producthunt.com/privacy | Product Hunt account, product data, analytics, and privacy disclosures | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
| Terms | https://www.producthunt.com/terms | Product Hunt services, community rules, and acceptable-use boundaries | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
...
- Manual blockers must remain launch-blocking until verified: Product Hunt account and maker profile policy, hunter/maker/community-member role distinctions, daily launch timing and timezone handling, upvote authenticity and fraud detection, comment threading and moderation, product page creation and media upload requirements, collection curation and editorial selection, launch scheduling rules and hunter invitation, review rating criteria and verification, discussion thread categorization, Ask PH question submission and answer ranking, golden kitty nomination and voting periods, job board posting and application flow, newsletter subscriber management and delivery, Ship page creation and subscriber notification, push notification delivery for launch/upvote/comment/milestone events, offline product browsing, API rate limits, and community guidelines enforcement.

## Core User Journeys

- User creates or restores a Product Hunt-style account, completes role, school, subscription, or tenant checks, and reaches the dashboard.
...
|---|---|---|---|---|
| Welcome/Auth | Account login or creation, profile setup, interest/tag selection, and community guidelines acceptance | email, OAuth, username, interests | new, returning, onboarding, locked | OAuth failed, username taken, rate limited, auth timeout |
| Feed/Discovery | Content feed with articles, questions, or products; trending/latest/following filters; tag filtering; and search | scroll, filter, search, upvote, bookmark | loading, populated, empty, filtered | feed stale, algorithm error, no results, offline cached |
| Content Detail | Article, question, or product page with full content, comments/answers, reactions, author info, and related items | read, react, comment, share, bookmark, answer | loading, loaded, commenting, answered | content removed, author blocked, comment failed, rate limited |
| Create/Write | Content creation with rich text/Markdown editor, code formatting, tags, preview, and draft management | write, format, tag, preview, publish, save-draft | draft, preview, published, scheduled | publish failed, tag invalid, duplicate detected, content too short |
| Profile/Reputation | User profile with bio, activity history, reputation/karma, badges, followers/following, and authored content | view, edit, follow, unfollow | own-profile, other-profile, loading | profile not found, follow failed, reputation recalculated, content removed |
| Settings/Privacy | Account, profile, notification preferences, connected accounts, privacy, blocking, support, and data export | forms, toggle, connect, block, request | loaded, editing, syncing | account restricted, notification overload, export pending, deletion requested |
...
- Treat user-generated content (articles, questions, answers, comments), user profile information and activity history, reputation and karma data, private messages and drafts, email addresses and connected account OAuth tokens, newsletter subscriber lists, content moderation decisions and flags, upvote and engagement analytics, community governance and moderator actions, API keys, and organizational membership data as launch-blocking review areas with owners, mitigations, and acceptance tests before implementation.
...
- Monetization model: use original free/trial/paid/sponsored/school/provider/tenant entitlement logic; do not copy exact pricing, plan names, bundle names, promotional copy, school contracts, tenant offers, or partner offers from Product Hunt.
...
- Manual verification tests for Product Hunt account and maker profile policy, hunter/maker/community-member role distinctions, daily launch timing and timezone handling, upvote authenticity and fraud detection, comment threading and moderation, product page creation and media upload requirements, collection curation and editorial selection, launch scheduling rules and hunter invitation, review rating criteria and verification, discussion thread categorization, Ask PH question submission and answer ranking, golden kitty nomination and voting periods, job board posting and application flow, newsletter subscriber management and delivery, Ship page creation and subscriber notification, push notification delivery for launch/upvote/comment/milestone events, offline product browsing, API rate limits, and community guidelines enforcement.
...
- Phase 4: Add app-specific safety controls for product discovery and launch platform with daily product launches and rankings, product upvoting and commenting, maker profiles and product pages, collections and topics for categorization, launch scheduling and announcement, product reviews and ratings, discussion threads, Ask Product Hunt (Q&A), golden kitty awards, job board, newsletter digest, maker tools (ship pages, upcoming), push notifications for launches/upvotes/comments/milestones, and community features (streaks, badges).
...
- Confirm legal/privacy retention behavior for Product Hunt-style sensitive records and update API contracts before downstream implementation.
