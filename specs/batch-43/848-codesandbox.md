# CodeSandbox-Style Clone Spec

> Metadata
> - Inspiration app: CodeSandbox
...
> - Manual verification blockers: CodeSandbox account and team workspace policy, viewer/editor/admin role and permission model, sandbox creation and template resolution, DevBox VM provisioning and resource allocation (CPU, RAM, storage), live collaboration WebSocket reliability and cursor synchronization, template gallery curation and custom template publishing, GitHub OAuth connection and repository import/sync, VS Code extension WebSocket tunnel and remote development, terminal session management and process isolation, preview browser URL routing and port forwarding, branch creation and switching in cloud environment, Docker and Nix environment build caching and layer management, team workspace billing and member limits, project sharing URL and embed iframe configuration, Boxy AI code generation accuracy and context limits, push notification delivery for collaboration/mention/deployment events, offline access limitations (cloud-dependent), workspace sync and environment persistence, and enterprise SSO/SAML provisioning.
...
Build an original mobile product inspired by CodeSandbox's public developer tools workflow. The V1 clone focuses on cloud development environment with instant sandboxes (browser-based coding), DevBox cloud VMs for full-stack development, live collaboration (multiplayer editing), template gallery for project bootstrapping, GitHub integration (import, commit, PR), VS Code integration, terminal access, preview browser, branch management, environment configuration (Docker, Nix), team workspaces and permissions, project sharing with embed support, AI code generation (Boxy), push notifications for collaboration/mentions/deployments, and plan-gated feature enforcement (Free, Pro, Team, Enterprise).
...
- Preserve the functional job behind CodeSandbox while using original product naming, original UI, original sample data, and licensed integrations.
...
- Do not copy CodeSandbox branding, logos, screenshots, marketing copy, private APIs, proprietary datasets, plan names, UI trade dress, course libraries, textbook solutions, documents, school content, AI prompts, or protected media.
...
|---|---|---|---|
| Apple App Store | https://apps.apple.com/us/app/codesandbox/id1621966946 | iOS listing, privacy labels, release notes, cloud IDE claims, and support links | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
| Google Play | https://play.google.com/store/apps/details?id=io.codesandbox.app | Android listing, data safety, cloud development claims, and release cadence | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
| Official product site | https://codesandbox.io/ | CodeSandbox cloud development, DevBoxes, collaboration, and product positioning | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
| Official help | https://codesandbox.io/docs/ | CodeSandbox documentation, sandboxes, DevBoxes, collaboration, and troubleshooting | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
| Privacy policy | https://codesandbox.io/legal/privacy | CodeSandbox account, project data, collaboration data, and privacy disclosures | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
| Terms | https://codesandbox.io/legal/terms | CodeSandbox services, subscriptions, and acceptable-use boundaries | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
...
- Manual blockers must remain launch-blocking until verified: CodeSandbox account and team workspace policy, viewer/editor/admin role and permission model, sandbox creation and template resolution, DevBox VM provisioning and resource allocation (CPU, RAM, storage), live collaboration WebSocket reliability and cursor synchronization, template gallery curation and custom template publishing, GitHub OAuth connection and repository import/sync, VS Code extension WebSocket tunnel and remote development, terminal session management and process isolation, preview browser URL routing and port forwarding, branch creation and switching in cloud environment, Docker and Nix environment build caching and layer management, team workspace billing and member limits, project sharing URL and embed iframe configuration, Boxy AI code generation accuracy and context limits, push notification delivery for collaboration/mention/deployment events, offline access limitations (cloud-dependent), workspace sync and environment persistence, and enterprise SSO/SAML provisioning.

## Core User Journeys

- User creates or restores a CodeSandbox-style account, completes role, school, subscription, or tenant checks, and reaches the dashboard.
...
- Monetization model: use original free/trial/paid/sponsored/school/provider/tenant entitlement logic; do not copy exact pricing, plan names, bundle names, promotional copy, school contracts, tenant offers, or partner offers from CodeSandbox.
...
- Manual verification tests for CodeSandbox account and team workspace policy, viewer/editor/admin role and permission model, sandbox creation and template resolution, DevBox VM provisioning and resource allocation (CPU, RAM, storage), live collaboration WebSocket reliability and cursor synchronization, template gallery curation and custom template publishing, GitHub OAuth connection and repository import/sync, VS Code extension WebSocket tunnel and remote development, terminal session management and process isolation, preview browser URL routing and port forwarding, branch creation and switching in cloud environment, Docker and Nix environment build caching and layer management, team workspace billing and member limits, project sharing URL and embed iframe configuration, Boxy AI code generation accuracy and context limits, push notification delivery for collaboration/mention/deployment events, offline access limitations (cloud-dependent), workspace sync and environment persistence, and enterprise SSO/SAML provisioning.
...
- Phase 4: Add app-specific safety controls for cloud development environment with instant sandboxes (browser-based coding), DevBox cloud VMs for full-stack development, live collaboration (multiplayer editing), template gallery for project bootstrapping, GitHub integration (import, commit, PR), VS Code integration, terminal access, preview browser, branch management, environment configuration (Docker, Nix), team workspaces and permissions, project sharing with embed support, AI code generation (Boxy), push notifications for collaboration/mentions/deployments, and plan-gated feature enforcement (Free, Pro, Team, Enterprise).
...
- Confirm legal/privacy retention behavior for CodeSandbox-style sensitive records and update API contracts before downstream implementation.
