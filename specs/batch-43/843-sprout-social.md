# Sprout Social-Style Clone Spec

> Metadata
> - Inspiration app: Sprout Social
...
> - Manual verification blockers: Sprout Social account and group/profile policy, user/admin role and permission model, social profile OAuth connection per platform (Facebook/Meta, Instagram, Twitter/X, LinkedIn, TikTok, Pinterest, YouTube, Google Business, Reddit), Smart Inbox message aggregation and reply-as routing, publishing API compliance per network and content type, scheduling queue and send-time optimization, asset library storage and media format support, social listening topic configuration and sentiment model accuracy, analytics data refresh cadence and cross-network normalization, profile and competitor report data sourcing, paid performance tracking and ad account connection, task assignment and approval workflow routing, CRM contact enrichment and merge logic, chatbot builder flow design and deployment, review management platform connection and response workflow, tagging taxonomy and automation rules, push notification delivery for inbox/tasks/approvals/reports, offline message viewing, multi-group switching, and enterprise SSO/SCIM provisioning.
...
Build an original mobile product inspired by Sprout Social's public enterprise operations workflow. The V1 clone focuses on social media management platform with Smart Inbox (unified message stream across networks), publishing calendar and scheduling, post composer with asset library, social listening and sentiment analysis, analytics and reporting with cross-network dashboards, profile performance reports, competitor reports, paid performance reports, team collaboration with task assignment and approval workflows, CRM-style contact profiles, chatbot builder, review management (Google, Facebook, TripAdvisor, Yelp), tagging and labeling for message categorization, push notifications for messages/tasks/approvals, and plan-gated feature enforcement (Standard, Professional, Advanced, Enterprise).
...
- Preserve the functional job behind Sprout Social while using original product naming, original UI, original sample data, and licensed integrations.
...
- Do not copy Sprout Social branding, logos, screenshots, marketing copy, private APIs, proprietary datasets, plan names, UI trade dress, course libraries, textbook solutions, documents, school content, AI prompts, or protected media.
...
|---|---|---|---|
| Apple App Store | https://apps.apple.com/us/app/sprout-social-social-media/id1025553035 | iOS listing, privacy labels, release notes, social management/inbox claims, and support links | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
| Google Play | https://play.google.com/store/apps/details?id=com.sproutsocial | Android listing, data safety, social inbox/publishing claims, and release cadence | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
| Official product site | https://sproutsocial.com/ | Sprout Social social media management, listening, analytics, and product positioning | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
| Official help | https://support.sproutsocial.com/ | Sprout Social setup, Smart Inbox, publishing, analytics, and troubleshooting | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
| Privacy policy | https://sproutsocial.com/privacy/ | Sprout Social account, social data, analytics, and privacy disclosures | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
| Terms | https://sproutsocial.com/terms/ | Sprout Social services, subscriptions, and acceptable-use boundaries | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
...
- Manual blockers must remain launch-blocking until verified: Sprout Social account and group/profile policy, user/admin role and permission model, social profile OAuth connection per platform (Facebook/Meta, Instagram, Twitter/X, LinkedIn, TikTok, Pinterest, YouTube, Google Business, Reddit), Smart Inbox message aggregation and reply-as routing, publishing API compliance per network and content type, scheduling queue and send-time optimization, asset library storage and media format support, social listening topic configuration and sentiment model accuracy, analytics data refresh cadence and cross-network normalization, profile and competitor report data sourcing, paid performance tracking and ad account connection, task assignment and approval workflow routing, CRM contact enrichment and merge logic, chatbot builder flow design and deployment, review management platform connection and response workflow, tagging taxonomy and automation rules, push notification delivery for inbox/tasks/approvals/reports, offline message viewing, multi-group switching, and enterprise SSO/SCIM provisioning.

## Core User Journeys

- User creates or restores a Sprout Social-style account, completes role, school, subscription, or tenant checks, and reaches the dashboard.
...
|---|---|---|---|---|
| Welcome/Auth | Account login, organization/workspace selection, SSO/SAML, role assignment, and connected social profile primers | email, SSO, org-select, biometric | new, returning, multi-org, locked | SSO failed, org unavailable, license expired, auth timeout |
| Composer/Scheduler | Post creation with media, multi-platform targeting, scheduling, queue management, first comment, hashtags, and link shortening | compose, attach, schedule, queue, hashtag | draft, scheduled, published, failed | media upload failed, platform rejection, schedule conflict, character limit exceeded |
| Calendar/Queue | Visual content calendar, scheduled posts timeline, drag-and-drop rescheduling, and queue slot management | view, drag, reschedule, filter | empty, populated, filtered, week/month | timezone mismatch, slot conflict, platform disconnected, sync failed |
| Inbox/Streams | Unified social inbox for messages, mentions, comments, and real-time stream monitoring across platforms | reply, assign, archive, filter, monitor | unread, read, assigned, archived | message failed, platform rate-limited, connection lost, stale data |
| Analytics/Reports | Cross-platform engagement metrics, audience demographics, post performance, and exportable reports | view, filter, drill-down, export, compare | loading, loaded, filtered, empty | data delayed, platform API limited, export failed, metric unavailable |
| Settings/Privacy | Account, organization, connected profiles, notification preferences, team, privacy, support, and data export | forms, toggle, connect, disconnect, request | loaded, editing, syncing | OAuth expired, profile disconnected, role restricted, export pending |
...
- Treat connected social account OAuth tokens and credentials, social media post content and drafts, audience engagement data and demographics, team member permissions and approval workflows, scheduled content queues, media library assets, analytics and reporting data, organization/workspace configuration, link tracking and UTM data, customer conversation and inbox messages, social listening queries and results, API keys and webhook endpoints, and enterprise SSO/SCIM credentials as launch-blocking review areas with owners, mitigations, and acceptance tests before implementation.
...
- Monetization model: use original free/trial/paid/sponsored/school/provider/tenant entitlement logic; do not copy exact pricing, plan names, bundle names, promotional copy, school contracts, tenant offers, or partner offers from Sprout Social.
...
- Manual verification tests for Sprout Social account and group/profile policy, user/admin role and permission model, social profile OAuth connection per platform (Facebook/Meta, Instagram, Twitter/X, LinkedIn, TikTok, Pinterest, YouTube, Google Business, Reddit), Smart Inbox message aggregation and reply-as routing, publishing API compliance per network and content type, scheduling queue and send-time optimization, asset library storage and media format support, social listening topic configuration and sentiment model accuracy, analytics data refresh cadence and cross-network normalization, profile and competitor report data sourcing, paid performance tracking and ad account connection, task assignment and approval workflow routing, CRM contact enrichment and merge logic, chatbot builder flow design and deployment, review management platform connection and response workflow, tagging taxonomy and automation rules, push notification delivery for inbox/tasks/approvals/reports, offline message viewing, multi-group switching, and enterprise SSO/SCIM provisioning.
...
- Phase 4: Add app-specific safety controls for social media management platform with Smart Inbox (unified message stream across networks), publishing calendar and scheduling, post composer with asset library, social listening and sentiment analysis, analytics and reporting with cross-network dashboards, profile performance reports, competitor reports, paid performance reports, team collaboration with task assignment and approval workflows, CRM-style contact profiles, chatbot builder, review management (Google, Facebook, TripAdvisor, Yelp), tagging and labeling for message categorization, push notifications for messages/tasks/approvals, and plan-gated feature enforcement (Standard, Professional, Advanced, Enterprise).
...
- Confirm legal/privacy retention behavior for Sprout Social-style sensitive records and update API contracts before downstream implementation.
