# Bitbucket-Style Clone Spec

> Metadata
> - Inspiration app: Bitbucket
...
> - Manual verification blockers: Bitbucket Cloud workspace and repository policy, read/write/admin repository permission model, Atlassian account and workspace membership, pull request CRUD and reviewer/approval configuration (merge checks, minimum approvals), Pipelines configuration and build-minutes allocation, pipeline step logs and artifact access, issue tracker field configuration and workflow, project hierarchy and workspace navigation, code review comment threading and task tracking, branch permissions and merge strategy enforcement, commit comparison and diff rendering, Jira issue key linking and status sync, Trello card attachment workflow, deployment environment tracking and promotion, code search indexing and scope, snippet visibility and sharing, push notification delivery for PR/pipeline/mention events, offline browsing limitations, and Atlassian Access/SSO provisioning.
...
Build an original mobile product inspired by Bitbucket's public developer tools workflow. The V1 clone focuses on Git repository hosting with repository browsing and source viewer, pull request management (create, review, approve, merge), Bitbucket Pipelines CI/CD monitoring and logs, issue tracker, project and workspace navigation, code review with inline comments and tasks, branch management and branch permissions, commit history and diffs, Jira integration for issue linking, Trello integration, deployment tracking, code search, snippets, push notifications for PRs/pipelines/mentions, and plan-gated feature enforcement (Free, Standard, Premium).
...
- Preserve the functional job behind Bitbucket while using original product naming, original UI, original sample data, and licensed integrations.
...
- Do not copy Bitbucket branding, logos, screenshots, marketing copy, private APIs, proprietary datasets, plan names, UI trade dress, course libraries, textbook solutions, documents, school content, AI prompts, or protected media.
...
|---|---|---|---|
| Apple App Store | https://apps.apple.com/us/app/bitbucket-cloud/id1434078866 | iOS listing, privacy labels, release notes, Git/repository claims, and support links | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
| Google Play | https://play.google.com/store/apps/details?id=com.atlassian.bitbucket.app | Android listing, data safety, repository/PR/pipeline claims, and release cadence | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
| Official product site | https://bitbucket.org/product/ | Bitbucket Git hosting, Pipelines, PRs, and product positioning | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
| Official help | https://support.atlassian.com/bitbucket-cloud/ | Bitbucket setup, repositories, pull requests, Pipelines, and troubleshooting | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
| Privacy policy | https://www.atlassian.com/legal/privacy-policy | Atlassian/Bitbucket account, repository data, analytics, and privacy disclosures | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
| Terms | https://www.atlassian.com/legal/cloud-terms-of-service | Atlassian/Bitbucket services, subscriptions, and acceptable-use boundaries | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
...
- Manual blockers must remain launch-blocking until verified: Bitbucket Cloud workspace and repository policy, read/write/admin repository permission model, Atlassian account and workspace membership, pull request CRUD and reviewer/approval configuration (merge checks, minimum approvals), Pipelines configuration and build-minutes allocation, pipeline step logs and artifact access, issue tracker field configuration and workflow, project hierarchy and workspace navigation, code review comment threading and task tracking, branch permissions and merge strategy enforcement, commit comparison and diff rendering, Jira issue key linking and status sync, Trello card attachment workflow, deployment environment tracking and promotion, code search indexing and scope, snippet visibility and sharing, push notification delivery for PR/pipeline/mention events, offline browsing limitations, and Atlassian Access/SSO provisioning.

## Core User Journeys

- User creates or restores a Bitbucket-style account, completes role, school, subscription, or tenant checks, and reaches the dashboard.
...
- Monetization model: use original free/trial/paid/sponsored/school/provider/tenant entitlement logic; do not copy exact pricing, plan names, bundle names, promotional copy, school contracts, tenant offers, or partner offers from Bitbucket.
...
- Manual verification tests for Bitbucket Cloud workspace and repository policy, read/write/admin repository permission model, Atlassian account and workspace membership, pull request CRUD and reviewer/approval configuration (merge checks, minimum approvals), Pipelines configuration and build-minutes allocation, pipeline step logs and artifact access, issue tracker field configuration and workflow, project hierarchy and workspace navigation, code review comment threading and task tracking, branch permissions and merge strategy enforcement, commit comparison and diff rendering, Jira issue key linking and status sync, Trello card attachment workflow, deployment environment tracking and promotion, code search indexing and scope, snippet visibility and sharing, push notification delivery for PR/pipeline/mention events, offline browsing limitations, and Atlassian Access/SSO provisioning.
...
- Phase 4: Add app-specific safety controls for Git repository hosting with repository browsing and source viewer, pull request management (create, review, approve, merge), Bitbucket Pipelines CI/CD monitoring and logs, issue tracker, project and workspace navigation, code review with inline comments and tasks, branch management and branch permissions, commit history and diffs, Jira integration for issue linking, Trello integration, deployment tracking, code search, snippets, push notifications for PRs/pipelines/mentions, and plan-gated feature enforcement (Free, Standard, Premium).
...
- Confirm legal/privacy retention behavior for Bitbucket-style sensitive records and update API contracts before downstream implementation.
