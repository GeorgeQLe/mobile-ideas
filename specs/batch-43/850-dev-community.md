# DEV Community-Style Clone Spec

> Metadata
> - Inspiration app: DEV Community
...
> - Manual verification blockers: DEV Community account and profile policy, content creator/moderator/admin role model, article creation rate limits and content moderation, Markdown editor rendering and front matter parsing, code block syntax highlighting language support, tag creation and moderation governance, reaction counting and notification delivery, comment threading depth and formatting, profile customization and social links, follow feed algorithm and chronological/relevance sorting, reading list sync and organization, listings posting and expiration rules, podcast RSS feed integration and player, video embed and upload support, organization page creation and member management, push notification delivery for reaction/comment/follow/mention events, offline article reading, Forem API rate limits, and community code of conduct enforcement.
...
Build an original mobile product inspired by DEV Community's public developer tools workflow. The V1 clone focuses on developer blogging and community platform with article reading and discovery feed, article writing with Markdown editor, code syntax highlighting, tag-based content organization, reactions (heart, unicorn, bookmark), comments and threaded discussions, user profiles with bio and links, following users and tags, reading list (bookmarks), listings (jobs, events, products), podcast episodes, video content, organization pages, push notifications for reactions/comments/follows/mentions, and community moderation (open-source platform based on Forem).
...
- Preserve the functional job behind DEV Community while using original product naming, original UI, original sample data, and licensed integrations.
...
- Do not copy DEV Community branding, logos, screenshots, marketing copy, private APIs, proprietary datasets, plan names, UI trade dress, course libraries, textbook solutions, documents, school content, AI prompts, or protected media.
...
|---|---|---|---|
| Apple App Store | https://apps.apple.com/us/app/dev-community/id1439463456 | iOS listing, privacy labels, release notes, developer community claims, and support links | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
| Google Play | https://play.google.com/store/apps/details?id=to.dev.dev_android | Android listing, data safety, developer community/blogging claims, and release cadence | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
| Official product site | https://dev.to/ | DEV Community developer blogging, discussions, and product positioning | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
| Official help | https://dev.to/faq | DEV Community FAQ, writing, moderation, and troubleshooting | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
| Privacy policy | https://dev.to/privacy | DEV Community account, content data, analytics, and privacy disclosures | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
| Terms | https://dev.to/terms | DEV Community services, content licensing, and acceptable-use boundaries | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
...
- Manual blockers must remain launch-blocking until verified: DEV Community account and profile policy, content creator/moderator/admin role model, article creation rate limits and content moderation, Markdown editor rendering and front matter parsing, code block syntax highlighting language support, tag creation and moderation governance, reaction counting and notification delivery, comment threading depth and formatting, profile customization and social links, follow feed algorithm and chronological/relevance sorting, reading list sync and organization, listings posting and expiration rules, podcast RSS feed integration and player, video embed and upload support, organization page creation and member management, push notification delivery for reaction/comment/follow/mention events, offline article reading, Forem API rate limits, and community code of conduct enforcement.

## Core User Journeys

- User creates or restores a DEV Community-style account, completes role, school, subscription, or tenant checks, and reaches the dashboard.
...
- Monetization model: use original free/trial/paid/sponsored/school/provider/tenant entitlement logic; do not copy exact pricing, plan names, bundle names, promotional copy, school contracts, tenant offers, or partner offers from DEV Community.
...
- Manual verification tests for DEV Community account and profile policy, content creator/moderator/admin role model, article creation rate limits and content moderation, Markdown editor rendering and front matter parsing, code block syntax highlighting language support, tag creation and moderation governance, reaction counting and notification delivery, comment threading depth and formatting, profile customization and social links, follow feed algorithm and chronological/relevance sorting, reading list sync and organization, listings posting and expiration rules, podcast RSS feed integration and player, video embed and upload support, organization page creation and member management, push notification delivery for reaction/comment/follow/mention events, offline article reading, Forem API rate limits, and community code of conduct enforcement.
...
- Phase 4: Add app-specific safety controls for developer blogging and community platform with article reading and discovery feed, article writing with Markdown editor, code syntax highlighting, tag-based content organization, reactions (heart, unicorn, bookmark), comments and threaded discussions, user profiles with bio and links, following users and tags, reading list (bookmarks), listings (jobs, events, products), podcast episodes, video content, organization pages, push notifications for reactions/comments/follows/mentions, and community moderation (open-source platform based on Forem).
...
- Confirm legal/privacy retention behavior for DEV Community-style sensitive records and update API contracts before downstream implementation.
