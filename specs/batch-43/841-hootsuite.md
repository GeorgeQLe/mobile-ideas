# Hootsuite-Style Clone Spec

> Metadata
> - Inspiration app: Hootsuite
...
> - Manual verification blockers: Hootsuite account and organization policy, member/admin/super-admin role and permission model, social network OAuth connection and token refresh (Facebook/Meta, Instagram, Twitter/X, LinkedIn, TikTok, Pinterest, YouTube), publishing API rate limits and content format requirements per platform, scheduling timezone and queue behavior, social inbox message threading and reply-as capabilities, streams configuration and real-time data refresh, analytics data aggregation and platform-specific metric availability, team approval workflow routing and rejection handling, content library upload limits and media format support, bulk scheduling CSV parsing and validation, Canva integration OAuth and asset import, social listening keyword configuration and sentiment accuracy, hashtag suggestion relevance, best time to publish algorithm data requirements, Ow.ly link tracking and UTM parameter handling, campaign tagging and cross-platform attribution, push notification delivery for mentions/DMs/comments/approvals, offline draft access, multi-organization switching, and enterprise SSO/SCIM provisioning.
...
Build an original mobile product inspired by Hootsuite's public enterprise operations workflow. The V1 clone focuses on social media management with multi-platform publishing (Facebook, Instagram, Twitter/X, LinkedIn, TikTok, Pinterest, YouTube), content calendar and scheduling, social inbox for unified message management, streams for real-time monitoring, analytics and reporting dashboards, team collaboration with approval workflows, content library for media assets, bulk scheduling via CSV, Canva integration for in-app design, social listening, hashtag suggestions, best time to publish recommendations, link tracking (Ow.ly), campaign management, push notifications for mentions/messages/approvals, and plan-gated feature enforcement (Professional, Team, Enterprise).
...
- Preserve the functional job behind Hootsuite while using original product naming, original UI, original sample data, and licensed integrations.
...
- Do not copy Hootsuite branding, logos, screenshots, marketing copy, private APIs, proprietary datasets, plan names, UI trade dress, course libraries, textbook solutions, documents, school content, AI prompts, or protected media.
...
|---|---|---|---|
| Apple App Store | https://apps.apple.com/us/app/hootsuite-social-media-tools/id341249709 | iOS listing, privacy labels, release notes, social media management claims, and support links | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
| Google Play | https://play.google.com/store/apps/details?id=com.hootsuite.droid.full | Android listing, data safety, social scheduling/inbox claims, and release cadence | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
| Official product site | https://www.hootsuite.com/ | Hootsuite social media management, scheduling, analytics, and product positioning | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
| Official help | https://help.hootsuite.com/ | Hootsuite setup, publishing, streams, analytics, team, and troubleshooting | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
| Privacy policy | https://www.hootsuite.com/legal/privacy | Hootsuite account, social data, analytics, and privacy disclosures | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
| Terms | https://www.hootsuite.com/legal/terms | Hootsuite services, subscriptions, API usage, and acceptable-use boundaries | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
...
- Manual blockers must remain launch-blocking until verified: Hootsuite account and organization policy, member/admin/super-admin role and permission model, social network OAuth connection and token refresh (Facebook/Meta, Instagram, Twitter/X, LinkedIn, TikTok, Pinterest, YouTube), publishing API rate limits and content format requirements per platform, scheduling timezone and queue behavior, social inbox message threading and reply-as capabilities, streams configuration and real-time data refresh, analytics data aggregation and platform-specific metric availability, team approval workflow routing and rejection handling, content library upload limits and media format support, bulk scheduling CSV parsing and validation, Canva integration OAuth and asset import, social listening keyword configuration and sentiment accuracy, hashtag suggestion relevance, best time to publish algorithm data requirements, Ow.ly link tracking and UTM parameter handling, campaign tagging and cross-platform attribution, push notification delivery for mentions/DMs/comments/approvals, offline draft access, multi-organization switching, and enterprise SSO/SCIM provisioning.

## Core User Journeys

- User creates or restores a Hootsuite-style account, completes role, school, subscription, or tenant checks, and reaches the dashboard.
...
- Monetization model: use original free/trial/paid/sponsored/school/provider/tenant entitlement logic; do not copy exact pricing, plan names, bundle names, promotional copy, school contracts, tenant offers, or partner offers from Hootsuite.
...
- Manual verification tests for Hootsuite account and organization policy, member/admin/super-admin role and permission model, social network OAuth connection and token refresh (Facebook/Meta, Instagram, Twitter/X, LinkedIn, TikTok, Pinterest, YouTube), publishing API rate limits and content format requirements per platform, scheduling timezone and queue behavior, social inbox message threading and reply-as capabilities, streams configuration and real-time data refresh, analytics data aggregation and platform-specific metric availability, team approval workflow routing and rejection handling, content library upload limits and media format support, bulk scheduling CSV parsing and validation, Canva integration OAuth and asset import, social listening keyword configuration and sentiment accuracy, hashtag suggestion relevance, best time to publish algorithm data requirements, Ow.ly link tracking and UTM parameter handling, campaign tagging and cross-platform attribution, push notification delivery for mentions/DMs/comments/approvals, offline draft access, multi-organization switching, and enterprise SSO/SCIM provisioning.
...
- Phase 4: Add app-specific safety controls for social media management with multi-platform publishing (Facebook, Instagram, Twitter/X, LinkedIn, TikTok, Pinterest, YouTube), content calendar and scheduling, social inbox for unified message management, streams for real-time monitoring, analytics and reporting dashboards, team collaboration with approval workflows, content library for media assets, bulk scheduling via CSV, Canva integration for in-app design, social listening, hashtag suggestions, best time to publish recommendations, link tracking (Ow.ly), campaign management, push notifications for mentions/messages/approvals, and plan-gated feature enforcement (Professional, Team, Enterprise).
...
- Confirm legal/privacy retention behavior for Hootsuite-style sensitive records and update API contracts before downstream implementation.
