# Yubo-Style Clone Spec

> Metadata
> - Inspiration app: Yubo
> - Category: Social
...
> - Manual verification blockers: Yubo account and age verification (Yoti age estimation AI, document verification), age-segregated communities (13-17 strictly separated from 18+), live video streaming infrastructure with multi-person rooms, swipe-based friend matching algorithm and geographic proximity, real-time video chat quality and participant management, games and interactive overlay features during live streams, safety features (real-time content moderation, AI age estimation, parental controls), COPPA and child safety compliance for 13-17 community, parental consent and notification mechanisms, content moderation for live video (nudity detection, harassment, predator detection), community guidelines enforcement and safety team operations, friend discovery algorithm (interests, location, mutual connections), direct messaging safety features (keyword detection, reporting), push notification management for minor users, Yubo Power Pack premium feature entitlement, location data handling for minor users, data retention and deletion for minor accounts, reporting and blocking mechanisms, law enforcement cooperation protocols, and Yubo account integration.
...
Build an original mobile product inspired by Yubo's public social workflow. The V1 clone focuses on youth-focused social discovery and live streaming platform with age-verified profiles (13-17 and 18+ separated communities), live video streaming with multi-person rooms, swipe-based friend discovery, profile creation with photos, bio, and interests, real-time video chat and hangout rooms, games and interactive features during lives, friend feed with status updates, direct messaging, safety features (age estimation AI, parental controls, content moderation), community guidelines and safety team, push notifications for friend requests and live activity, and free model with optional Yubo Power Pack (premium features).
...
- Deliver a mobile-first social experience with onboarding, dashboard, primary workflow, reminders or notifications, settings, support, and recovery flows.
- Preserve the functional job behind Yubo while using original product naming, original UI, original sample data, and licensed integrations.
...
- Do not copy Yubo branding, logos, screenshots, marketing copy, private APIs, proprietary datasets, plan names, UI trade dress, course libraries, textbook solutions, documents, school content, AI prompts, or protected media.
...
|---|---|---|---|
| Apple App Store | https://apps.apple.com/us/app/yubo-make-new-friends/id1038653883 | iOS listing, privacy labels, release notes, youth social/live stream claims, and support links | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
| Google Play | https://play.google.com/store/apps/details?id=co.yellw.yellowapp | Android listing, data safety, youth social discovery claims, and release cadence | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
| Official product site | https://yubo.live/ | Yubo youth social, live streaming, friend discovery, and product positioning | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
| Official help | https://support.yubo.live/ | Yubo app help, safety, parental controls, and troubleshooting | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
| Privacy policy | https://yubo.live/en/legal/privacy-policy | Yubo data collection, minor data, age verification, and privacy disclosures | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
| Terms | https://yubo.live/en/legal/terms | Yubo services, age requirements, safety policies, and acceptable-use boundaries | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
...
- Manual blockers must remain launch-blocking until verified: Yubo account and age verification (Yoti age estimation AI, document verification), age-segregated communities (13-17 strictly separated from 18+), live video streaming infrastructure with multi-person rooms, swipe-based friend matching algorithm and geographic proximity, real-time video chat quality and participant management, games and interactive overlay features during live streams, safety features (real-time content moderation, AI age estimation, parental controls), COPPA and child safety compliance for 13-17 community, parental consent and notification mechanisms, content moderation for live video (nudity detection, harassment, predator detection), community guidelines enforcement and safety team operations, friend discovery algorithm (interests, location, mutual connections), direct messaging safety features (keyword detection, reporting), push notification management for minor users, Yubo Power Pack premium feature entitlement, location data handling for minor users, data retention and deletion for minor accounts, reporting and blocking mechanisms, law enforcement cooperation protocols, and Yubo account integration.

## Core User Journeys

- User creates or restores a Yubo-style account, completes role, school, subscription, or tenant checks, and reaches the dashboard.
...
|---|---|---|---|---|
| Welcome/Auth | Account login or creation, instance/server selection (if federated), interest selection, and profile setup | email, OAuth, phone, select-instance, select-interests, create-profile | new, returning, verified, unverified, suspended | auth failed, instance unavailable, verification pending, network error |
| Feed/Timeline | Home feed with posts from followed accounts, discovery/explore feed, trending topics, and content filtering | scroll, pull-refresh, post, react, share, filter, search | loading, loaded, empty, filtered, offline-cached | feed stale, network error, content unavailable, rate-limited |
| Post/Create | Content creation with text, images, video, audio, polls, and sharing controls (visibility, content warnings) | compose, attach-media, set-visibility, add-tags, publish, schedule | composing, uploading, publishing, draft-saved, scheduled | upload failed, media too large, content policy violation, publish failed |
| Profile/Community | User profiles, followers/following, community/group pages, membership, and moderation tools | view-profile, follow, unfollow, join, leave, moderate, report, block | viewing, own-profile, other-profile, community, moderated | profile unavailable, blocked, suspended, community closed, rate-limited |
| Messaging/Chat | Direct messages, group chats, voice/video rooms, and conversation management | send, receive, react, call, join-room, leave-room, mute, block | active, archived, muted, blocked, voice-active, video-active | message failed, call dropped, room full, network error, blocked |
| Settings/Privacy | Account, privacy controls, notification preferences, blocked/muted lists, data export, content filters, and support | forms, toggle, block, mute, filter, export, request-delete | loaded, editing, syncing | save failed, export pending, filter conflict, account locked |
...
- Treat user-generated content and posts (text, images, video, audio), social graph (followers, following, connections, blocked/muted), direct messages and private communications, profile information and identity data, location data and geotagged content, community membership and moderation actions, push notification tokens and delivery preferences, account credentials and session tokens, content engagement data (likes, shares, comments, reactions), search and discovery behavior, advertising identifiers and consent records, voice and video chat recordings or metadata, IP addresses and device information, and content moderation and trust/safety signals as launch-blocking review areas with owners, mitigations, and acceptance tests before implementation.
...
- Monetization model: use original free/trial/paid/sponsored/school/provider/tenant entitlement logic; do not copy exact pricing, plan names, bundle names, promotional copy, school contracts, tenant offers, or partner offers from Yubo.
...
- Manual verification tests for Yubo account and age verification (Yoti age estimation AI, document verification), age-segregated communities (13-17 strictly separated from 18+), live video streaming infrastructure with multi-person rooms, swipe-based friend matching algorithm and geographic proximity, real-time video chat quality and participant management, games and interactive overlay features during live streams, safety features (real-time content moderation, AI age estimation, parental controls), COPPA and child safety compliance for 13-17 community, parental consent and notification mechanisms, content moderation for live video (nudity detection, harassment, predator detection), community guidelines enforcement and safety team operations, friend discovery algorithm (interests, location, mutual connections), direct messaging safety features (keyword detection, reporting), push notification management for minor users, Yubo Power Pack premium feature entitlement, location data handling for minor users, data retention and deletion for minor accounts, reporting and blocking mechanisms, law enforcement cooperation protocols, and Yubo account integration.
...
- Phase 4: Add app-specific safety controls for youth-focused social discovery and live streaming platform with age-verified profiles (13-17 and 18+ separated communities), live video streaming with multi-person rooms, swipe-based friend discovery, profile creation with photos, bio, and interests, real-time video chat and hangout rooms, games and interactive features during lives, friend feed with status updates, direct messaging, safety features (age estimation AI, parental controls, content moderation), community guidelines and safety team, push notifications for friend requests and live activity, and free model with optional Yubo Power Pack (premium features).
...
- Confirm legal/privacy retention behavior for Yubo-style sensitive records and update API contracts before downstream implementation.
