# Viber-Style Clone Spec

> Metadata
> - Inspiration app: Viber
...
> - Manual verification blockers: Viber/Rakuten account and phone number verification, end-to-end encryption implementation (Viber protocol), VoIP calling infrastructure (voice and video, NAT traversal, SRTP/SRDES), Viber Communities scaling (millions of members, moderation, admin hierarchy), Viber Channels broadcast messaging and subscriber management, sticker market catalog and purchase/download mechanics, Viber Out paid calling rates and PSTN gateway integration, disappearing message timer and deletion sync across devices, message reactions and threaded reply handling, file and media sharing (size limits, compression, CDN delivery), group chat admin controls (add/remove, permissions, settings), chatbot platform and business messaging API, Viber Pay payment integration (regional availability), cross-platform message sync (mobile, desktop, tablet), push notification delivery and call notification handling, spam and fraud prevention for messaging, contact sync and phone number matching, backup and restore (Google Drive, iCloud), content moderation for communities and channels, and Rakuten/Viber account integration.
...
Build an original mobile product inspired by Viber's public communication workflow. The V1 clone focuses on messaging and VoIP calling platform with 1-on-1 and group text messaging, free voice and video calls (VoIP), Viber Communities (large public group chats up to millions), Viber Channels (broadcast messaging), end-to-end encryption for private chats and calls, sticker market and GIF sharing, Viber Out (paid calls to landlines and mobiles), disappearing messages, message reactions and replies, file and media sharing (photos, videos, documents), group chat with admin controls, chatbots and business messaging, Viber Pay (select markets), push notifications, cross-platform sync (mobile, desktop, tablet), and free model with Viber Out paid calling and sticker purchases.
...
- Preserve the functional job behind Viber while using original product naming, original UI, original sample data, and licensed integrations.
...
- Do not copy Viber branding, logos, screenshots, marketing copy, private APIs, proprietary datasets, plan names, UI trade dress, course libraries, textbook solutions, documents, school content, AI prompts, or protected media.
...
|---|---|---|---|
| Apple App Store | https://apps.apple.com/us/app/viber-messenger-chats-calls/id382617920 | iOS listing, privacy labels, release notes, messaging/calling claims, and support links | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
| Google Play | https://play.google.com/store/apps/details?id=com.viber.voip | Android listing, data safety, messaging/VoIP calling claims, and release cadence | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
| Official product site | https://www.viber.com/ | Viber messaging, calling, communities, and product positioning | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
| Official help | https://help.viber.com/ | Viber app help, messaging, calling, and troubleshooting | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
| Privacy policy | https://www.viber.com/terms/viber-privacy-policy/ | Viber/Rakuten data collection, messaging data, and privacy disclosures | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
| Terms | https://www.viber.com/terms/viber-terms-use/ | Viber services, messaging policies, and acceptable-use boundaries | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
...
- Manual blockers must remain launch-blocking until verified: Viber/Rakuten account and phone number verification, end-to-end encryption implementation (Viber protocol), VoIP calling infrastructure (voice and video, NAT traversal, SRTP/SRDES), Viber Communities scaling (millions of members, moderation, admin hierarchy), Viber Channels broadcast messaging and subscriber management, sticker market catalog and purchase/download mechanics, Viber Out paid calling rates and PSTN gateway integration, disappearing message timer and deletion sync across devices, message reactions and threaded reply handling, file and media sharing (size limits, compression, CDN delivery), group chat admin controls (add/remove, permissions, settings), chatbot platform and business messaging API, Viber Pay payment integration (regional availability), cross-platform message sync (mobile, desktop, tablet), push notification delivery and call notification handling, spam and fraud prevention for messaging, contact sync and phone number matching, backup and restore (Google Drive, iCloud), content moderation for communities and channels, and Rakuten/Viber account integration.

## Core User Journeys

- User creates or restores a Viber-style account, completes role, school, subscription, or tenant checks, and reaches the dashboard.
...
- Monetization model: use original free/trial/paid/sponsored/school/provider/tenant entitlement logic; do not copy exact pricing, plan names, bundle names, promotional copy, school contracts, tenant offers, or partner offers from Viber.
...
- Manual verification tests for Viber/Rakuten account and phone number verification, end-to-end encryption implementation (Viber protocol), VoIP calling infrastructure (voice and video, NAT traversal, SRTP/SRDES), Viber Communities scaling (millions of members, moderation, admin hierarchy), Viber Channels broadcast messaging and subscriber management, sticker market catalog and purchase/download mechanics, Viber Out paid calling rates and PSTN gateway integration, disappearing message timer and deletion sync across devices, message reactions and threaded reply handling, file and media sharing (size limits, compression, CDN delivery), group chat admin controls (add/remove, permissions, settings), chatbot platform and business messaging API, Viber Pay payment integration (regional availability), cross-platform message sync (mobile, desktop, tablet), push notification delivery and call notification handling, spam and fraud prevention for messaging, contact sync and phone number matching, backup and restore (Google Drive, iCloud), content moderation for communities and channels, and Rakuten/Viber account integration.
...
- Phase 4: Add app-specific safety controls for messaging and VoIP calling platform with 1-on-1 and group text messaging, free voice and video calls (VoIP), Viber Communities (large public group chats up to millions), Viber Channels (broadcast messaging), end-to-end encryption for private chats and calls, sticker market and GIF sharing, Viber Out (paid calls to landlines and mobiles), disappearing messages, message reactions and replies, file and media sharing (photos, videos, documents), group chat with admin controls, chatbots and business messaging, Viber Pay (select markets), push notifications, cross-platform sync (mobile, desktop, tablet), and free model with Viber Out paid calling and sticker purchases.
...
- Confirm legal/privacy retention behavior for Viber-style sensitive records and update API contracts before downstream implementation.
