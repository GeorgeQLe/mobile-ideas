# Skype-Style Clone Spec

> Metadata
> - Inspiration app: Skype
...
> - Manual verification blockers: Skype/Microsoft account and sign-in (Microsoft account integration, legacy Skype names), VoIP calling infrastructure (voice, video, group up to 100, SRTP), screen sharing and live captions (speech-to-text accuracy, latency), Skype to Phone paid calling rates and PSTN gateway, SMS Connect feature and carrier integration, Skype Number virtual phone number provisioning and regional availability, call recording consent and storage, real-time translation quality and language support, end-to-end encryption (private conversations using Signal Protocol), Microsoft account contact sync and directory, chat themes and custom video background rendering, cross-platform message sync (mobile, desktop, web), file sharing size limits and hosting, push notification and incoming call notification reliability, Copilot AI integration and chat assistance features, legacy Skype feature compatibility, spam and fraud prevention for calling/messaging, emergency calling limitations disclosure, and Microsoft/Skype account integration.
...
Build an original mobile product inspired by Skype's public communication workflow. The V1 clone focuses on messaging and video calling platform with 1-on-1 and group text messaging, free voice and video calls (VoIP), group video calls up to 100 participants, screen sharing and live captions, Skype to Phone (paid calls to landlines and mobiles), SMS Connect (send SMS from Skype), file and media sharing, message reactions and @mentions, chat themes and custom backgrounds, Skype Number (virtual phone number), call recording, real-time translation during calls, end-to-end encryption for private conversations, contact sync with Microsoft account, push notifications, cross-platform availability (mobile, desktop, web), and free model with Skype to Phone paid calling and Skype Number subscriptions.
...
- Preserve the functional job behind Skype while using original product naming, original UI, original sample data, and licensed integrations.
...
- Do not copy Skype branding, logos, screenshots, marketing copy, private APIs, proprietary datasets, plan names, UI trade dress, course libraries, textbook solutions, documents, school content, AI prompts, or protected media.
...
|---|---|---|---|
| Apple App Store | https://apps.apple.com/us/app/skype/id304878510 | iOS listing, privacy labels, release notes, messaging/video calling claims, and support links | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
| Google Play | https://play.google.com/store/apps/details?id=com.skype.raider | Android listing, data safety, messaging/video calling claims, and release cadence | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
| Official product site | https://www.skype.com/ | Skype messaging, video calling, screen sharing, and product positioning | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
| Official help | https://support.skype.com/ | Skype app help, account, calling, and troubleshooting | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
| Privacy policy | https://privacy.microsoft.com/privacystatement | Microsoft/Skype data collection, calling data, and privacy disclosures | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
| Terms | https://www.microsoft.com/servicesagreement | Microsoft/Skype services, calling terms, and acceptable-use boundaries | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
...
- Manual blockers must remain launch-blocking until verified: Skype/Microsoft account and sign-in (Microsoft account integration, legacy Skype names), VoIP calling infrastructure (voice, video, group up to 100, SRTP), screen sharing and live captions (speech-to-text accuracy, latency), Skype to Phone paid calling rates and PSTN gateway, SMS Connect feature and carrier integration, Skype Number virtual phone number provisioning and regional availability, call recording consent and storage, real-time translation quality and language support, end-to-end encryption (private conversations using Signal Protocol), Microsoft account contact sync and directory, chat themes and custom video background rendering, cross-platform message sync (mobile, desktop, web), file sharing size limits and hosting, push notification and incoming call notification reliability, Copilot AI integration and chat assistance features, legacy Skype feature compatibility, spam and fraud prevention for calling/messaging, emergency calling limitations disclosure, and Microsoft/Skype account integration.

## Core User Journeys

- User creates or restores a Skype-style account, completes role, school, subscription, or tenant checks, and reaches the dashboard.
...
- Monetization model: use original free/trial/paid/sponsored/school/provider/tenant entitlement logic; do not copy exact pricing, plan names, bundle names, promotional copy, school contracts, tenant offers, or partner offers from Skype.
...
- Manual verification tests for Skype/Microsoft account and sign-in (Microsoft account integration, legacy Skype names), VoIP calling infrastructure (voice, video, group up to 100, SRTP), screen sharing and live captions (speech-to-text accuracy, latency), Skype to Phone paid calling rates and PSTN gateway, SMS Connect feature and carrier integration, Skype Number virtual phone number provisioning and regional availability, call recording consent and storage, real-time translation quality and language support, end-to-end encryption (private conversations using Signal Protocol), Microsoft account contact sync and directory, chat themes and custom video background rendering, cross-platform message sync (mobile, desktop, web), file sharing size limits and hosting, push notification and incoming call notification reliability, Copilot AI integration and chat assistance features, legacy Skype feature compatibility, spam and fraud prevention for calling/messaging, emergency calling limitations disclosure, and Microsoft/Skype account integration.
...
- Phase 4: Add app-specific safety controls for messaging and video calling platform with 1-on-1 and group text messaging, free voice and video calls (VoIP), group video calls up to 100 participants, screen sharing and live captions, Skype to Phone (paid calls to landlines and mobiles), SMS Connect (send SMS from Skype), file and media sharing, message reactions and @mentions, chat themes and custom backgrounds, Skype Number (virtual phone number), call recording, real-time translation during calls, end-to-end encryption for private conversations, contact sync with Microsoft account, push notifications, cross-platform availability (mobile, desktop, web), and free model with Skype to Phone paid calling and Skype Number subscriptions.
...
- Confirm legal/privacy retention behavior for Skype-style sensitive records and update API contracts before downstream implementation.
