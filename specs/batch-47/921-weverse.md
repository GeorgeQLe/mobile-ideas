# Weverse-Style Clone Spec

> Metadata
> - Inspiration app: Weverse
> - Category: Social
...
> - Manual verification blockers: Weverse/HYBE account and membership policy (free fan community vs paid membership tiers), artist-to-fan communication moderation and content scheduling, Weverse Live streaming infrastructure and VOD replay, Weverse Shop integration (merchandise catalog, ordering, payment, shipping), Weverse DM paid messaging model and artist response management, fan community content moderation at scale (millions of fans per artist), multilingual auto-translation quality and language support, Weverse Albums digital album delivery and collectible card mechanics, event ticketing integration and fan verification, artist moment (stories) creation and expiration, fan letter submission and screening, Weverse Magazine editorial content and exclusive media, community tab per-artist isolation and cross-artist discovery, push notification for artist posts/lives/shop/events, media upload and CDN for fan-generated content, in-app purchase and membership management on iOS/Android, content geo-restrictions by artist licensing, and HYBE/Weverse account integration.
...
Build an original mobile product inspired by Weverse's public social workflow. The V1 clone focuses on K-pop and artist fan community platform with official artist-to-fan communication, artist posts and live streams (Weverse Live), fan community posts and comments, Weverse Shop integration for official merchandise, Weverse Magazines and exclusive content, Weverse DM (paid artist messaging), fan feed with text, photo, and video posts, artist moment posts (stories-style), community tabs per artist, multilingual auto-translation, fan letter submission, Weverse Albums (digital album experience), event ticketing and fan meetup features, push notifications for artist activity, and freemium model with Weverse membership and paid DM features.
...
- Preserve the functional job behind Weverse while using original product naming, original UI, original sample data, and licensed integrations.
...
- Do not copy Weverse branding, logos, screenshots, marketing copy, private APIs, proprietary datasets, plan names, UI trade dress, course libraries, textbook solutions, documents, school content, AI prompts, or protected media.
...
|---|---|---|---|
| Apple App Store | https://apps.apple.com/us/app/weverse/id1478523498 | iOS listing, privacy labels, release notes, fan community/artist claims, and support links | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
| Google Play | https://play.google.com/store/apps/details?id=com.weverse.sec | Android listing, data safety, fan community/K-pop claims, and release cadence | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
| Official product site | https://weverse.io/ | Weverse fan community, artist communication, Weverse Live, and product positioning | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
| Official help | https://help.weverse.io/ | Weverse app help, account, membership, and troubleshooting | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
| Privacy policy | https://weverse.io/policy/privacy | Weverse/HYBE data collection, fan data, analytics, and privacy disclosures | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
| Terms | https://weverse.io/policy/terms | Weverse services, community guidelines, membership, and acceptable-use boundaries | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
...
- Manual blockers must remain launch-blocking until verified: Weverse/HYBE account and membership policy (free fan community vs paid membership tiers), artist-to-fan communication moderation and content scheduling, Weverse Live streaming infrastructure and VOD replay, Weverse Shop integration (merchandise catalog, ordering, payment, shipping), Weverse DM paid messaging model and artist response management, fan community content moderation at scale (millions of fans per artist), multilingual auto-translation quality and language support, Weverse Albums digital album delivery and collectible card mechanics, event ticketing integration and fan verification, artist moment (stories) creation and expiration, fan letter submission and screening, Weverse Magazine editorial content and exclusive media, community tab per-artist isolation and cross-artist discovery, push notification for artist posts/lives/shop/events, media upload and CDN for fan-generated content, in-app purchase and membership management on iOS/Android, content geo-restrictions by artist licensing, and HYBE/Weverse account integration.

## Core User Journeys

- User creates or restores a Weverse-style account, completes role, school, subscription, or tenant checks, and reaches the dashboard.
...
- Monetization model: use original free/trial/paid/sponsored/school/provider/tenant entitlement logic; do not copy exact pricing, plan names, bundle names, promotional copy, school contracts, tenant offers, or partner offers from Weverse.
...
- Manual verification tests for Weverse/HYBE account and membership policy (free fan community vs paid membership tiers), artist-to-fan communication moderation and content scheduling, Weverse Live streaming infrastructure and VOD replay, Weverse Shop integration (merchandise catalog, ordering, payment, shipping), Weverse DM paid messaging model and artist response management, fan community content moderation at scale (millions of fans per artist), multilingual auto-translation quality and language support, Weverse Albums digital album delivery and collectible card mechanics, event ticketing integration and fan verification, artist moment (stories) creation and expiration, fan letter submission and screening, Weverse Magazine editorial content and exclusive media, community tab per-artist isolation and cross-artist discovery, push notification for artist posts/lives/shop/events, media upload and CDN for fan-generated content, in-app purchase and membership management on iOS/Android, content geo-restrictions by artist licensing, and HYBE/Weverse account integration.
...
- Phase 4: Add app-specific safety controls for K-pop and artist fan community platform with official artist-to-fan communication, artist posts and live streams (Weverse Live), fan community posts and comments, Weverse Shop integration for official merchandise, Weverse Magazines and exclusive content, Weverse DM (paid artist messaging), fan feed with text, photo, and video posts, artist moment posts (stories-style), community tabs per artist, multilingual auto-translation, fan letter submission, Weverse Albums (digital album experience), event ticketing and fan meetup features, push notifications for artist activity, and freemium model with Weverse membership and paid DM features.
...
- Confirm legal/privacy retention behavior for Weverse-style sensitive records and update API contracts before downstream implementation.
