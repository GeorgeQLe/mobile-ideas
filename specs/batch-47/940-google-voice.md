# Google Voice-Style Clone Spec

> Metadata
> - Inspiration app: Google Voice
...
> - Manual verification blockers: Google Voice/Google account and US phone number provisioning (US availability primarily), virtual phone number assignment and inventory management, VoIP calling infrastructure over Wi-Fi and mobile data, SMS and MMS sending and receiving (carrier interoperability), voicemail recording and AI transcription accuracy, call forwarding configuration and linked phone management, call screening and real-time caller identification, do not disturb scheduling and custom voicemail greetings, spam call detection and filtering algorithm, Google Voice for Workspace business tier features and admin controls, multi-device simultaneous ring and call handoff, voicemail PIN security and access controls, number porting process and carrier compatibility, Google Fi integration and dual-service management, cross-platform message and call sync (mobile, desktop, web), push notification for incoming calls and messages, 911 emergency calling limitations and disclosure, Google Voice number reclamation policy (inactivity), MMS group messaging compatibility, RCS messaging support status, and Google/Google Voice account integration.
...
Build an original mobile product inspired by Google Voice's public communication workflow. The V1 clone focuses on virtual phone number and communication platform with free US phone number, voice calls over Wi-Fi and mobile data, SMS and MMS messaging, voicemail with transcription, call forwarding and routing to linked phones, call screening with caller ID, do not disturb and custom greetings, spam call filtering and blocking, Google Voice for Google Workspace (business), multi-device ring (simultaneous ring on linked devices), voicemail PIN and security, number porting (bring existing number), Google Fi integration, push notifications for calls and messages, cross-platform availability (mobile, desktop, web), and free personal model with Google Workspace Voice paid tiers for business.
...
- Preserve the functional job behind Google Voice while using original product naming, original UI, original sample data, and licensed integrations.
...
- Do not copy Google Voice branding, logos, screenshots, marketing copy, private APIs, proprietary datasets, plan names, UI trade dress, course libraries, textbook solutions, documents, school content, AI prompts, or protected media.
...
|---|---|---|---|
| Apple App Store | https://apps.apple.com/us/app/google-voice/id318698524 | iOS listing, privacy labels, release notes, virtual number/calling claims, and support links | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
| Google Play | https://play.google.com/store/apps/details?id=com.google.android.apps.googlevoice | Android listing, data safety, virtual phone number/VoIP claims, and release cadence | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
| Official product site | https://voice.google.com/ | Google Voice virtual number, calling, messaging, and product positioning | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
| Official help | https://support.google.com/voice/ | Google Voice app help, number setup, calling, and troubleshooting | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
| Privacy policy | https://policies.google.com/privacy | Google data collection, calling/messaging data, and privacy disclosures | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
| Terms | https://policies.google.com/terms | Google services, Voice terms, and acceptable-use boundaries | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
...
- Manual blockers must remain launch-blocking until verified: Google Voice/Google account and US phone number provisioning (US availability primarily), virtual phone number assignment and inventory management, VoIP calling infrastructure over Wi-Fi and mobile data, SMS and MMS sending and receiving (carrier interoperability), voicemail recording and AI transcription accuracy, call forwarding configuration and linked phone management, call screening and real-time caller identification, do not disturb scheduling and custom voicemail greetings, spam call detection and filtering algorithm, Google Voice for Workspace business tier features and admin controls, multi-device simultaneous ring and call handoff, voicemail PIN security and access controls, number porting process and carrier compatibility, Google Fi integration and dual-service management, cross-platform message and call sync (mobile, desktop, web), push notification for incoming calls and messages, 911 emergency calling limitations and disclosure, Google Voice number reclamation policy (inactivity), MMS group messaging compatibility, RCS messaging support status, and Google/Google Voice account integration.

## Core User Journeys

- User creates or restores a Google Voice-style account, completes role, school, subscription, or tenant checks, and reaches the dashboard.
...
- Monetization model: use original free/trial/paid/sponsored/school/provider/tenant entitlement logic; do not copy exact pricing, plan names, bundle names, promotional copy, school contracts, tenant offers, or partner offers from Google Voice.
...
- Manual verification tests for Google Voice/Google account and US phone number provisioning (US availability primarily), virtual phone number assignment and inventory management, VoIP calling infrastructure over Wi-Fi and mobile data, SMS and MMS sending and receiving (carrier interoperability), voicemail recording and AI transcription accuracy, call forwarding configuration and linked phone management, call screening and real-time caller identification, do not disturb scheduling and custom voicemail greetings, spam call detection and filtering algorithm, Google Voice for Workspace business tier features and admin controls, multi-device simultaneous ring and call handoff, voicemail PIN security and access controls, number porting process and carrier compatibility, Google Fi integration and dual-service management, cross-platform message and call sync (mobile, desktop, web), push notification for incoming calls and messages, 911 emergency calling limitations and disclosure, Google Voice number reclamation policy (inactivity), MMS group messaging compatibility, RCS messaging support status, and Google/Google Voice account integration.
...
- Phase 4: Add app-specific safety controls for virtual phone number and communication platform with free US phone number, voice calls over Wi-Fi and mobile data, SMS and MMS messaging, voicemail with transcription, call forwarding and routing to linked phones, call screening with caller ID, do not disturb and custom greetings, spam call filtering and blocking, Google Voice for Google Workspace (business), multi-device ring (simultaneous ring on linked devices), voicemail PIN and security, number porting (bring existing number), Google Fi integration, push notifications for calls and messages, cross-platform availability (mobile, desktop, web), and free personal model with Google Workspace Voice paid tiers for business.
...
- Confirm legal/privacy retention behavior for Google Voice-style sensitive records and update API contracts before downstream implementation.
