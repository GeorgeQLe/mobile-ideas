# Ko-fi-Style Clone Spec

> Metadata
> - Inspiration app: Ko-fi
> - Category: Social
...
> - Manual verification blockers: Ko-fi account and creator policy (free tier vs Ko-fi Gold subscription), one-time donation processing (PayPal, Stripe with 0% platform fee claim), Ko-fi Gold membership features and subscription billing, creator shop product listing (digital downloads, physical products), commissions marketplace and order management workflow, supporter feed content creation and media hosting, creator page customization (tabs, gallery, colors, layout), membership tier creation and subscriber management, fundraising goal tracking and display, supporter messaging and notification delivery, payment processor integration (PayPal and Stripe dual support), embeddable widget generation, analytics dashboard (earnings, supporters, page views, shop sales), push notification for new supporters, orders, and commissions, physical product shipping and fulfillment tracking, tax handling and international payments, content moderation for creator pages, in-app purchase considerations on iOS, and Ko-fi account integration.
...
Build an original mobile product inspired by Ko-fi's public social workflow. The V1 clone focuses on creator funding platform with one-time donations (buy a coffee), Ko-fi Gold membership features, creator shop for digital and physical products, commissions marketplace, supporter feed with posts and updates, creator page customization (gallery, about, shop, commissions tabs), Ko-fi Gold features (memberships/tiers, shop, commissions, advanced page), goal tracking and fundraising, supporter messaging and thank-you messages, payment processing (PayPal, Stripe) with 0% platform fee on donations (Gold takes subscription fee), embeddable widgets and donation buttons, push notifications for new supporters and orders, analytics (earnings, views, supporters), and freemium model (free donations with Ko-fi Gold subscription for advanced features).
...
- Preserve the functional job behind Ko-fi while using original product naming, original UI, original sample data, and licensed integrations.
...
- Do not copy Ko-fi branding, logos, screenshots, marketing copy, private APIs, proprietary datasets, plan names, UI trade dress, course libraries, textbook solutions, documents, school content, AI prompts, or protected media.
...
|---|---|---|---|
| Apple App Store | https://apps.apple.com/us/app/ko-fi/id1544469498 | iOS listing, privacy labels, release notes, creator support/shop claims, and support links | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
| Google Play | https://play.google.com/store/apps/details?id=fi.ko.app | Android listing, data safety, creator funding/shop claims, and release cadence | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
| Official product site | https://ko-fi.com/ | Ko-fi creator funding, shop, commissions, Gold, and product positioning | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
| Official help | https://help.ko-fi.com/ | Ko-fi app help, creator tools, Gold features, and troubleshooting | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
| Privacy policy | https://more.ko-fi.com/privacy | Ko-fi data collection, payment data, and privacy disclosures | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
| Terms | https://more.ko-fi.com/terms | Ko-fi services, creator terms, and acceptable-use boundaries | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
...
- Manual blockers must remain launch-blocking until verified: Ko-fi account and creator policy (free tier vs Ko-fi Gold subscription), one-time donation processing (PayPal, Stripe with 0% platform fee claim), Ko-fi Gold membership features and subscription billing, creator shop product listing (digital downloads, physical products), commissions marketplace and order management workflow, supporter feed content creation and media hosting, creator page customization (tabs, gallery, colors, layout), membership tier creation and subscriber management, fundraising goal tracking and display, supporter messaging and notification delivery, payment processor integration (PayPal and Stripe dual support), embeddable widget generation, analytics dashboard (earnings, supporters, page views, shop sales), push notification for new supporters, orders, and commissions, physical product shipping and fulfillment tracking, tax handling and international payments, content moderation for creator pages, in-app purchase considerations on iOS, and Ko-fi account integration.

## Core User Journeys

- User creates or restores a Ko-fi-style account, completes role, school, subscription, or tenant checks, and reaches the dashboard.
...
- Monetization model: use original free/trial/paid/sponsored/school/provider/tenant entitlement logic; do not copy exact pricing, plan names, bundle names, promotional copy, school contracts, tenant offers, or partner offers from Ko-fi.
...
- Manual verification tests for Ko-fi account and creator policy (free tier vs Ko-fi Gold subscription), one-time donation processing (PayPal, Stripe with 0% platform fee claim), Ko-fi Gold membership features and subscription billing, creator shop product listing (digital downloads, physical products), commissions marketplace and order management workflow, supporter feed content creation and media hosting, creator page customization (tabs, gallery, colors, layout), membership tier creation and subscriber management, fundraising goal tracking and display, supporter messaging and notification delivery, payment processor integration (PayPal and Stripe dual support), embeddable widget generation, analytics dashboard (earnings, supporters, page views, shop sales), push notification for new supporters, orders, and commissions, physical product shipping and fulfillment tracking, tax handling and international payments, content moderation for creator pages, in-app purchase considerations on iOS, and Ko-fi account integration.
...
- Phase 4: Add app-specific safety controls for creator funding platform with one-time donations (buy a coffee), Ko-fi Gold membership features, creator shop for digital and physical products, commissions marketplace, supporter feed with posts and updates, creator page customization (gallery, about, shop, commissions tabs), Ko-fi Gold features (memberships/tiers, shop, commissions, advanced page), goal tracking and fundraising, supporter messaging and thank-you messages, payment processing (PayPal, Stripe) with 0% platform fee on donations (Gold takes subscription fee), embeddable widgets and donation buttons, push notifications for new supporters and orders, analytics (earnings, views, supporters), and freemium model (free donations with Ko-fi Gold subscription for advanced features).
...
- Confirm legal/privacy retention behavior for Ko-fi-style sensitive records and update API contracts before downstream implementation.
