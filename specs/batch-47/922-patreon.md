# Patreon-Style Clone Spec

> Metadata
> - Inspiration app: Patreon
> - Category: Social
...
> - Manual verification blockers: Patreon account and subscription policy (patron vs creator accounts, tier setup), tiered membership billing and payment processing (Stripe, PayPal, platform fees), content gating by tier (exclusive posts, early access, behind-the-scenes), creator page customization and tier benefit configuration, patron feed algorithm and chronological vs recommended ordering, media hosting for exclusive content (video, audio, images, files), direct messaging privacy and moderation, creator analytics dashboard (earnings, patron growth, churn, engagement), Patreon Lens short-form video creation and discovery, Discord integration and role syncing with patron tiers, membership gifting mechanics and redemption, offline audio content caching and playback, push notification for new posts from supported creators, payment method management and failed payment recovery (dunning), creator payout scheduling and tax reporting (1099), international payment support and currency conversion, content policy enforcement and DMCA handling, in-app purchase restrictions on iOS (Apple commission considerations), and Patreon account integration.
...
Build an original mobile product inspired by Patreon's public social workflow. The V1 clone focuses on creator membership and patronage platform with tiered subscription support for creators, patron feed with exclusive posts (text, images, audio, video, polls, links), tier-based content gating and early access, creator page with about, tiers, posts, and community tabs, patron management and membership billing, direct messaging between creators and patrons, community features (comments, likes), creator analytics and earnings dashboard, Patreon Lens (short-form video), patron-only Discord and community integrations, membership gifting, mobile content consumption with offline audio, push notifications for new creator posts, and commission-based model (Patreon takes percentage of creator earnings).
...
- Preserve the functional job behind Patreon while using original product naming, original UI, original sample data, and licensed integrations.
...
- Do not copy Patreon branding, logos, screenshots, marketing copy, private APIs, proprietary datasets, plan names, UI trade dress, course libraries, textbook solutions, documents, school content, AI prompts, or protected media.
...
|---|---|---|---|
| Apple App Store | https://apps.apple.com/us/app/patreon/id1044456188 | iOS listing, privacy labels, release notes, creator membership/patron claims, and support links | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
| Google Play | https://play.google.com/store/apps/details?id=com.patreon.android | Android listing, data safety, creator membership/subscription claims, and release cadence | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
| Official product site | https://www.patreon.com/ | Patreon creator membership, tiers, patronage, and product positioning | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
| Official help | https://support.patreon.com/ | Patreon app help, creator tools, patron FAQ, and troubleshooting | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
| Privacy policy | https://www.patreon.com/privacy | Patreon data collection, payment data, analytics, and privacy disclosures | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
| Terms | https://www.patreon.com/policy/legal | Patreon services, creator terms, patron terms, and acceptable-use boundaries | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
...
- Manual blockers must remain launch-blocking until verified: Patreon account and subscription policy (patron vs creator accounts, tier setup), tiered membership billing and payment processing (Stripe, PayPal, platform fees), content gating by tier (exclusive posts, early access, behind-the-scenes), creator page customization and tier benefit configuration, patron feed algorithm and chronological vs recommended ordering, media hosting for exclusive content (video, audio, images, files), direct messaging privacy and moderation, creator analytics dashboard (earnings, patron growth, churn, engagement), Patreon Lens short-form video creation and discovery, Discord integration and role syncing with patron tiers, membership gifting mechanics and redemption, offline audio content caching and playback, push notification for new posts from supported creators, payment method management and failed payment recovery (dunning), creator payout scheduling and tax reporting (1099), international payment support and currency conversion, content policy enforcement and DMCA handling, in-app purchase restrictions on iOS (Apple commission considerations), and Patreon account integration.

## Core User Journeys

- User creates or restores a Patreon-style account, completes role, school, subscription, or tenant checks, and reaches the dashboard.
...
- Monetization model: use original free/trial/paid/sponsored/school/provider/tenant entitlement logic; do not copy exact pricing, plan names, bundle names, promotional copy, school contracts, tenant offers, or partner offers from Patreon.
...
- Manual verification tests for Patreon account and subscription policy (patron vs creator accounts, tier setup), tiered membership billing and payment processing (Stripe, PayPal, platform fees), content gating by tier (exclusive posts, early access, behind-the-scenes), creator page customization and tier benefit configuration, patron feed algorithm and chronological vs recommended ordering, media hosting for exclusive content (video, audio, images, files), direct messaging privacy and moderation, creator analytics dashboard (earnings, patron growth, churn, engagement), Patreon Lens short-form video creation and discovery, Discord integration and role syncing with patron tiers, membership gifting mechanics and redemption, offline audio content caching and playback, push notification for new posts from supported creators, payment method management and failed payment recovery (dunning), creator payout scheduling and tax reporting (1099), international payment support and currency conversion, content policy enforcement and DMCA handling, in-app purchase restrictions on iOS (Apple commission considerations), and Patreon account integration.
...
- Phase 4: Add app-specific safety controls for creator membership and patronage platform with tiered subscription support for creators, patron feed with exclusive posts (text, images, audio, video, polls, links), tier-based content gating and early access, creator page with about, tiers, posts, and community tabs, patron management and membership billing, direct messaging between creators and patrons, community features (comments, likes), creator analytics and earnings dashboard, Patreon Lens (short-form video), patron-only Discord and community integrations, membership gifting, mobile content consumption with offline audio, push notifications for new creator posts, and commission-based model (Patreon takes percentage of creator earnings).
...
- Confirm legal/privacy retention behavior for Patreon-style sensitive records and update API contracts before downstream implementation.
