# Guilded-Style Clone Spec

> Metadata
> - Inspiration app: Guilded
> - Category: Social
...
> - Manual verification blockers: Guilded/Roblox account and community policy, server creation and management (roles, permissions, channel types), text messaging with rich formatting (markdown, embeds, mentions, reactions, threads), voice channel infrastructure (low-latency gaming audio, WebRTC), video and screen sharing quality and participant limits, server customization (roles, permission hierarchy, categories, custom emoji), scheduling and calendar feature for gaming sessions (timezone handling, RSVP), announcements and event management, media channel hosting (screenshots, clips, video), forums and docs collaborative editing, tournament bracket creation and management, LFG matchmaking system and game integration, bot marketplace and webhook/API integration, streaming to channels infrastructure, server discovery algorithm and content safety, push notification categories and delivery, content moderation tools (auto-mod, reporting, bans), age-appropriate content controls for gaming communities, Roblox integration and account linking, mobile-optimized voice/video for gaming contexts, and Guilded/Roblox account integration.
...
Build an original mobile product inspired by Guilded's public social workflow. The V1 clone focuses on gaming community platform with servers (communities) for gaming teams, clans, and groups, text channels with rich messaging (markdown, embeds, reactions, threads), voice channels with low-latency gaming audio, video and screen sharing, server customization (roles, permissions, categories, bots), scheduling and calendar for gaming sessions, announcements and event management, media channels for screenshots and clips, forums and docs (collaborative documents), tournament bracket support, LFG (looking for group) matchmaking, bot marketplace and webhook integrations, streaming and screen share to channels, server discovery and exploration, push notifications, and free model (all features free, no paid tiers for core functionality).
...
- Preserve the functional job behind Guilded while using original product naming, original UI, original sample data, and licensed integrations.
...
- Do not copy Guilded branding, logos, screenshots, marketing copy, private APIs, proprietary datasets, plan names, UI trade dress, course libraries, textbook solutions, documents, school content, AI prompts, or protected media.
...
|---|---|---|---|
| Apple App Store | https://apps.apple.com/us/app/guilded-gaming-communities/id1484694030 | iOS listing, privacy labels, release notes, gaming community/server claims, and support links | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
| Google Play | https://play.google.com/store/apps/details?id=com.guilded.retern | Android listing, data safety, gaming community/voice claims, and release cadence | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
| Official product site | https://www.guilded.gg/ | Guilded gaming communities, servers, voice, and product positioning | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
| Official help | https://support.guilded.gg/ | Guilded app help, servers, voice, and troubleshooting | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
| Privacy policy | https://www.guilded.gg/privacy | Guilded/Roblox data collection, voice data, and privacy disclosures | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
| Terms | https://www.guilded.gg/tos | Guilded services, community guidelines, and acceptable-use boundaries | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
...
- Manual blockers must remain launch-blocking until verified: Guilded/Roblox account and community policy, server creation and management (roles, permissions, channel types), text messaging with rich formatting (markdown, embeds, mentions, reactions, threads), voice channel infrastructure (low-latency gaming audio, WebRTC), video and screen sharing quality and participant limits, server customization (roles, permission hierarchy, categories, custom emoji), scheduling and calendar feature for gaming sessions (timezone handling, RSVP), announcements and event management, media channel hosting (screenshots, clips, video), forums and docs collaborative editing, tournament bracket creation and management, LFG matchmaking system and game integration, bot marketplace and webhook/API integration, streaming to channels infrastructure, server discovery algorithm and content safety, push notification categories and delivery, content moderation tools (auto-mod, reporting, bans), age-appropriate content controls for gaming communities, Roblox integration and account linking, mobile-optimized voice/video for gaming contexts, and Guilded/Roblox account integration.

## Core User Journeys

- User creates or restores a Guilded-style account, completes role, school, subscription, or tenant checks, and reaches the dashboard.
...
- Monetization model: use original free/trial/paid/sponsored/school/provider/tenant entitlement logic; do not copy exact pricing, plan names, bundle names, promotional copy, school contracts, tenant offers, or partner offers from Guilded.
...
- Manual verification tests for Guilded/Roblox account and community policy, server creation and management (roles, permissions, channel types), text messaging with rich formatting (markdown, embeds, mentions, reactions, threads), voice channel infrastructure (low-latency gaming audio, WebRTC), video and screen sharing quality and participant limits, server customization (roles, permission hierarchy, categories, custom emoji), scheduling and calendar feature for gaming sessions (timezone handling, RSVP), announcements and event management, media channel hosting (screenshots, clips, video), forums and docs collaborative editing, tournament bracket creation and management, LFG matchmaking system and game integration, bot marketplace and webhook/API integration, streaming to channels infrastructure, server discovery algorithm and content safety, push notification categories and delivery, content moderation tools (auto-mod, reporting, bans), age-appropriate content controls for gaming communities, Roblox integration and account linking, mobile-optimized voice/video for gaming contexts, and Guilded/Roblox account integration.
...
- Phase 4: Add app-specific safety controls for gaming community platform with servers (communities) for gaming teams, clans, and groups, text channels with rich messaging (markdown, embeds, reactions, threads), voice channels with low-latency gaming audio, video and screen sharing, server customization (roles, permissions, categories, bots), scheduling and calendar for gaming sessions, announcements and event management, media channels for screenshots and clips, forums and docs (collaborative documents), tournament bracket support, LFG (looking for group) matchmaking, bot marketplace and webhook integrations, streaming and screen share to channels, server discovery and exploration, push notifications, and free model (all features free, no paid tiers for core functionality).
...
- Confirm legal/privacy retention behavior for Guilded-style sensitive records and update API contracts before downstream implementation.
