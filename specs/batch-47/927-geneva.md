# Geneva-Style Clone Spec

> Metadata
> - Inspiration app: Geneva
> - Category: Social
...
> - Manual verification blockers: Geneva account and community policy, group creation and management (rooms, roles, permissions, branding), text chat room messaging and rich media support, voice and video room infrastructure and participant limits, event scheduling with calendar integration and RSVP tracking, bulletin board posting and announcement management, shared calendar sync and timezone handling, member directory and role assignment, file and media sharing hosting and storage limits, group discovery and invitation mechanics (link sharing, QR codes), admin tools (moderation, member removal, content deletion), cross-group home feed aggregation and notification routing, push notification categories (chat, events, announcements, mentions), content moderation for community-generated content, group privacy controls (public vs private), mobile-optimized voice/video experience, and Geneva account integration.
...
Build an original mobile product inspired by Geneva's public social workflow. The V1 clone focuses on group communication and community platform with rooms for organizing conversations by topic, home feed with activity across all joined groups, text chat rooms, voice and video rooms, event scheduling and RSVP, bulletin boards for announcements, shared calendars, member directory and roles, file and media sharing, group discovery and invitations, customizable group branding (name, icon, description), admin tools (moderation, member management, permissions), cross-group home feed aggregation, push notifications for room activity and events, and free model (no ads, no subscription).
...
- Preserve the functional job behind Geneva while using original product naming, original UI, original sample data, and licensed integrations.
...
- Do not copy Geneva branding, logos, screenshots, marketing copy, private APIs, proprietary datasets, plan names, UI trade dress, course libraries, textbook solutions, documents, school content, AI prompts, or protected media.
...
|---|---|---|---|
| Apple App Store | https://apps.apple.com/us/app/geneva-group-communication/id1535462312 | iOS listing, privacy labels, release notes, group community claims, and support links | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
| Google Play | https://play.google.com/store/apps/details?id=com.geneva.android | Android listing, data safety, group communication/community claims, and release cadence | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
| Official product site | https://www.geneva.com/ | Geneva group communication, rooms, events, and product positioning | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
| Official help | https://support.geneva.com/ | Geneva app help, groups, rooms, and troubleshooting | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
| Privacy policy | https://www.geneva.com/privacy | Geneva data collection, group data, and privacy disclosures | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
| Terms | https://www.geneva.com/terms | Geneva services, community guidelines, and acceptable-use boundaries | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
...
- Manual blockers must remain launch-blocking until verified: Geneva account and community policy, group creation and management (rooms, roles, permissions, branding), text chat room messaging and rich media support, voice and video room infrastructure and participant limits, event scheduling with calendar integration and RSVP tracking, bulletin board posting and announcement management, shared calendar sync and timezone handling, member directory and role assignment, file and media sharing hosting and storage limits, group discovery and invitation mechanics (link sharing, QR codes), admin tools (moderation, member removal, content deletion), cross-group home feed aggregation and notification routing, push notification categories (chat, events, announcements, mentions), content moderation for community-generated content, group privacy controls (public vs private), mobile-optimized voice/video experience, and Geneva account integration.

## Core User Journeys

- User creates or restores a Geneva-style account, completes role, school, subscription, or tenant checks, and reaches the dashboard.
...
- Monetization model: use original free/trial/paid/sponsored/school/provider/tenant entitlement logic; do not copy exact pricing, plan names, bundle names, promotional copy, school contracts, tenant offers, or partner offers from Geneva.
...
- Manual verification tests for Geneva account and community policy, group creation and management (rooms, roles, permissions, branding), text chat room messaging and rich media support, voice and video room infrastructure and participant limits, event scheduling with calendar integration and RSVP tracking, bulletin board posting and announcement management, shared calendar sync and timezone handling, member directory and role assignment, file and media sharing hosting and storage limits, group discovery and invitation mechanics (link sharing, QR codes), admin tools (moderation, member removal, content deletion), cross-group home feed aggregation and notification routing, push notification categories (chat, events, announcements, mentions), content moderation for community-generated content, group privacy controls (public vs private), mobile-optimized voice/video experience, and Geneva account integration.
...
- Phase 4: Add app-specific safety controls for group communication and community platform with rooms for organizing conversations by topic, home feed with activity across all joined groups, text chat rooms, voice and video rooms, event scheduling and RSVP, bulletin boards for announcements, shared calendars, member directory and roles, file and media sharing, group discovery and invitations, customizable group branding (name, icon, description), admin tools (moderation, member management, permissions), cross-group home feed aggregation, push notifications for room activity and events, and free model (no ads, no subscription).
...
- Confirm legal/privacy retention behavior for Geneva-style sensitive records and update API contracts before downstream implementation.
