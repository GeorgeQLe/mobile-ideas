# WeChat-Style Clone Spec

> Metadata
> - Inspiration app: WeChat
...
> - Manual verification blockers: WeChat/Tencent account and phone number verification (region-specific requirements), end-to-end encryption status (not enabled by default, regulatory considerations), Moments social feed algorithm and privacy controls (visibility groups), WeChat Pay integration (payment licensing, KYC, regional availability, QR code standards), Mini Programs platform (development framework, approval process, hosting), Official Accounts subscription and messaging rules, group chat management and admin controls at scale, sticker marketplace and emoji pack distribution, Channels short video algorithm and live streaming infrastructure, location sharing privacy and nearby people feature safety, file sharing size limits and document collaboration, WeChat Work enterprise integration and admin controls, translation service quality and language support, QR code ecosystem (generation, scanning, deeplinks), content moderation and censorship compliance (China regulatory requirements), data localization and cross-border data transfer regulations, regional feature availability (Pay, Mini Programs region-locked), spam and fraud prevention at massive scale, contact discovery and phone number matching, and Tencent/WeChat account integration.
...
Build an original mobile product inspired by WeChat's public communication workflow. The V1 clone focuses on super-app messaging platform with text, voice, and video messaging, Moments (social feed with photos and short videos), voice and video calls, WeChat Pay (mobile payments, QR code payments, red packets), Mini Programs (embedded lightweight apps), Official Accounts (brand and media subscriptions), group chats up to 500 members, sticker and emoji marketplace, Channels (short video and live streaming), location sharing and nearby features, file and document sharing, WeChat Work integration, multi-language and translation features, QR code scanning for everything (payments, contacts, mini-programs, websites), push notifications, and free model with WeChat Pay transaction services and Mini Program ecosystem.
...
- Preserve the functional job behind WeChat while using original product naming, original UI, original sample data, and licensed integrations.
...
- Do not copy WeChat branding, logos, screenshots, marketing copy, private APIs, proprietary datasets, plan names, UI trade dress, course libraries, textbook solutions, documents, school content, AI prompts, or protected media.
...
|---|---|---|---|
| Apple App Store | https://apps.apple.com/us/app/wechat/id414478124 | iOS listing, privacy labels, release notes, messaging/payments/mini-program claims, and support links | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
| Google Play | https://play.google.com/store/apps/details?id=com.tencent.mm | Android listing, data safety, super-app/messaging claims, and release cadence | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
| Official product site | https://www.wechat.com/ | WeChat messaging, Moments, Pay, Mini Programs, and product positioning | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
| Official help | https://help.wechat.com/ | WeChat app help, account, payments, and troubleshooting | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
| Privacy policy | https://www.wechat.com/en/privacy_policy.html | WeChat/Tencent data collection, payment data, and privacy disclosures | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
| Terms | https://www.wechat.com/en/service_terms.html | WeChat services, payment terms, Mini Program policies, and acceptable-use boundaries | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
...
- Manual blockers must remain launch-blocking until verified: WeChat/Tencent account and phone number verification (region-specific requirements), end-to-end encryption status (not enabled by default, regulatory considerations), Moments social feed algorithm and privacy controls (visibility groups), WeChat Pay integration (payment licensing, KYC, regional availability, QR code standards), Mini Programs platform (development framework, approval process, hosting), Official Accounts subscription and messaging rules, group chat management and admin controls at scale, sticker marketplace and emoji pack distribution, Channels short video algorithm and live streaming infrastructure, location sharing privacy and nearby people feature safety, file sharing size limits and document collaboration, WeChat Work enterprise integration and admin controls, translation service quality and language support, QR code ecosystem (generation, scanning, deeplinks), content moderation and censorship compliance (China regulatory requirements), data localization and cross-border data transfer regulations, regional feature availability (Pay, Mini Programs region-locked), spam and fraud prevention at massive scale, contact discovery and phone number matching, and Tencent/WeChat account integration.

## Core User Journeys

- User creates or restores a WeChat-style account, completes role, school, subscription, or tenant checks, and reaches the dashboard.
...
- Monetization model: use original free/trial/paid/sponsored/school/provider/tenant entitlement logic; do not copy exact pricing, plan names, bundle names, promotional copy, school contracts, tenant offers, or partner offers from WeChat.
...
- Manual verification tests for WeChat/Tencent account and phone number verification (region-specific requirements), end-to-end encryption status (not enabled by default, regulatory considerations), Moments social feed algorithm and privacy controls (visibility groups), WeChat Pay integration (payment licensing, KYC, regional availability, QR code standards), Mini Programs platform (development framework, approval process, hosting), Official Accounts subscription and messaging rules, group chat management and admin controls at scale, sticker marketplace and emoji pack distribution, Channels short video algorithm and live streaming infrastructure, location sharing privacy and nearby people feature safety, file sharing size limits and document collaboration, WeChat Work enterprise integration and admin controls, translation service quality and language support, QR code ecosystem (generation, scanning, deeplinks), content moderation and censorship compliance (China regulatory requirements), data localization and cross-border data transfer regulations, regional feature availability (Pay, Mini Programs region-locked), spam and fraud prevention at massive scale, contact discovery and phone number matching, and Tencent/WeChat account integration.
...
- Phase 4: Add app-specific safety controls for super-app messaging platform with text, voice, and video messaging, Moments (social feed with photos and short videos), voice and video calls, WeChat Pay (mobile payments, QR code payments, red packets), Mini Programs (embedded lightweight apps), Official Accounts (brand and media subscriptions), group chats up to 500 members, sticker and emoji marketplace, Channels (short video and live streaming), location sharing and nearby features, file and document sharing, WeChat Work integration, multi-language and translation features, QR code scanning for everything (payments, contacts, mini-programs, websites), push notifications, and free model with WeChat Pay transaction services and Mini Program ecosystem.
...
- Confirm legal/privacy retention behavior for WeChat-style sensitive records and update API contracts before downstream implementation.
