# Poparazzi-Style Clone Spec

> Metadata
> - Inspiration app: Poparazzi
> - Category: Social
...
> - Manual verification blockers: Poparazzi account and social graph management, no-selfie enforcement (front camera blocking or policy-based), other-focused photo upload and tagging workflow, profile construction from others' photos (consent and attribution), pop feed algorithm (chronological, friends-of-friends), friend connection and discovery mechanics, photo tagging consent and removal/untag flow, reactions and comments moderation, camera interface optimization for quick capture, push notification for new tags and friend activity, photo memory and throwback content generation, privacy controls (who can tag you, photo visibility, untag requests), content moderation for uploaded photos, photo hosting and CDN delivery, anti-bullying measures (unwanted photo posting, harassment via tags), minor safety considerations, data retention for photos and deleted content, and Poparazzi account integration.
...
Build an original mobile product inspired by Poparazzi's public social workflow. The V1 clone focuses on social photo-sharing platform where only friends can post photos of you (no selfies), other-focused photography encouraging authentic social moments, profile built from photos others take of you, pop (photo) feed from friends, tagging and photo attribution, friend connections and mutual friend discovery, reactions and comments on pops, camera-first interface for quick photo capture, push notifications when tagged in new photos, photo memory features and throwback content, privacy controls for tagged photos, and free model focused on reducing social media vanity metrics.
...
- Preserve the functional job behind Poparazzi while using original product naming, original UI, original sample data, and licensed integrations.
...
- Do not copy Poparazzi branding, logos, screenshots, marketing copy, private APIs, proprietary datasets, plan names, UI trade dress, course libraries, textbook solutions, documents, school content, AI prompts, or protected media.
...
|---|---|---|---|
| Apple App Store | https://apps.apple.com/us/app/poparazzi/id1558icons730680 | iOS listing, privacy labels, release notes, social photo/no-selfie claims, and support links | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
| Google Play | https://play.google.com/store/apps/details?id=com.poparazzi.app | Android listing, data safety, friend photo/social claims, and release cadence | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
| Official product site | https://www.poparazzi.com/ | Poparazzi social photos, no-selfie concept, and product positioning | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
| Official help | https://www.poparazzi.com/faq | Poparazzi app help, tagging, privacy, and troubleshooting | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
| Privacy policy | https://www.poparazzi.com/privacy | Poparazzi data collection, photo data, and privacy disclosures | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
| Terms | https://www.poparazzi.com/terms | Poparazzi services, content policies, and acceptable-use boundaries | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
...
- Manual blockers must remain launch-blocking until verified: Poparazzi account and social graph management, no-selfie enforcement (front camera blocking or policy-based), other-focused photo upload and tagging workflow, profile construction from others' photos (consent and attribution), pop feed algorithm (chronological, friends-of-friends), friend connection and discovery mechanics, photo tagging consent and removal/untag flow, reactions and comments moderation, camera interface optimization for quick capture, push notification for new tags and friend activity, photo memory and throwback content generation, privacy controls (who can tag you, photo visibility, untag requests), content moderation for uploaded photos, photo hosting and CDN delivery, anti-bullying measures (unwanted photo posting, harassment via tags), minor safety considerations, data retention for photos and deleted content, and Poparazzi account integration.

## Core User Journeys

- User creates or restores a Poparazzi-style account, completes role, school, subscription, or tenant checks, and reaches the dashboard.
...
- Monetization model: use original free/trial/paid/sponsored/school/provider/tenant entitlement logic; do not copy exact pricing, plan names, bundle names, promotional copy, school contracts, tenant offers, or partner offers from Poparazzi.
...
- Manual verification tests for Poparazzi account and social graph management, no-selfie enforcement (front camera blocking or policy-based), other-focused photo upload and tagging workflow, profile construction from others' photos (consent and attribution), pop feed algorithm (chronological, friends-of-friends), friend connection and discovery mechanics, photo tagging consent and removal/untag flow, reactions and comments moderation, camera interface optimization for quick capture, push notification for new tags and friend activity, photo memory and throwback content generation, privacy controls (who can tag you, photo visibility, untag requests), content moderation for uploaded photos, photo hosting and CDN delivery, anti-bullying measures (unwanted photo posting, harassment via tags), minor safety considerations, data retention for photos and deleted content, and Poparazzi account integration.
...
- Phase 4: Add app-specific safety controls for social photo-sharing platform where only friends can post photos of you (no selfies), other-focused photography encouraging authentic social moments, profile built from photos others take of you, pop (photo) feed from friends, tagging and photo attribution, friend connections and mutual friend discovery, reactions and comments on pops, camera-first interface for quick photo capture, push notifications when tagged in new photos, photo memory features and throwback content, privacy controls for tagged photos, and free model focused on reducing social media vanity metrics.
...
- Confirm legal/privacy retention behavior for Poparazzi-style sensitive records and update API contracts before downstream implementation.
