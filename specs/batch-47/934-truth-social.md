# Truth Social-Style Clone Spec

> Metadata
> - Inspiration app: Truth Social
> - Category: Social
...
> - Manual verification blockers: Truth Social/Trump Media & Technology Group account and content policy, Truth posting with text, images, links, and media, ReTruth sharing and attribution mechanics, feed algorithm (Following tab chronological vs For You algorithmic), user profile customization and verification, Truth Mail direct messaging infrastructure, trending topics and hashtag indexing, explore and search functionality, Truth+ premium subscription for video content and live TV, live TV streaming infrastructure and content licensing, group messaging feature and participant management, push notification categories and delivery, content moderation policy and enforcement (stated light-touch approach), political content considerations and platform positioning, community guidelines and appeals process, ad serving and monetization, DMCA and copyright handling, in-app subscription management for Truth+ on iOS/Android, user verification and notable account handling, and Truth Social/TMTG account integration.
...
Build an original mobile product inspired by Truth Social's public social workflow. The V1 clone focuses on social media platform with Truths (posts similar to tweets), ReTruths (sharing/reblogging), Truth feed with following and discovery tabs, user profiles with followers/following, direct messaging (Truth Mail), trending topics and hashtags, explore and search functionality, Truth+ subscription for premium video content, live TV streaming integration, group messaging, push notifications for interactions and followed accounts, content moderation (community guidelines), and free ad-supported model with Truth+ premium subscription.
...
- Preserve the functional job behind Truth Social while using original product naming, original UI, original sample data, and licensed integrations.
...
- Do not copy Truth Social branding, logos, screenshots, marketing copy, private APIs, proprietary datasets, plan names, UI trade dress, course libraries, textbook solutions, documents, school content, AI prompts, or protected media.
...
|---|---|---|---|
| Apple App Store | https://apps.apple.com/us/app/truth-social/id1586018825 | iOS listing, privacy labels, release notes, social media/Truth claims, and support links | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
| Google Play | https://play.google.com/store/apps/details?id=com.truthsocial.android.app | Android listing, data safety, social media/Truth claims, and release cadence | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
| Official product site | https://truthsocial.com/ | Truth Social platform, Truths, and product positioning | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
| Official help | https://help.truthsocial.com/ | Truth Social app help, account, and troubleshooting | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
| Privacy policy | https://truthsocial.com/privacy-policy | Truth Social/TMTG data collection, analytics, and privacy disclosures | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
| Terms | https://truthsocial.com/terms-of-service | Truth Social services, community guidelines, and acceptable-use boundaries | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
...
- Manual blockers must remain launch-blocking until verified: Truth Social/Trump Media & Technology Group account and content policy, Truth posting with text, images, links, and media, ReTruth sharing and attribution mechanics, feed algorithm (Following tab chronological vs For You algorithmic), user profile customization and verification, Truth Mail direct messaging infrastructure, trending topics and hashtag indexing, explore and search functionality, Truth+ premium subscription for video content and live TV, live TV streaming infrastructure and content licensing, group messaging feature and participant management, push notification categories and delivery, content moderation policy and enforcement (stated light-touch approach), political content considerations and platform positioning, community guidelines and appeals process, ad serving and monetization, DMCA and copyright handling, in-app subscription management for Truth+ on iOS/Android, user verification and notable account handling, and Truth Social/TMTG account integration.

## Core User Journeys

- User creates or restores a Truth Social-style account, completes role, school, subscription, or tenant checks, and reaches the dashboard.
...
- Monetization model: use original free/trial/paid/sponsored/school/provider/tenant entitlement logic; do not copy exact pricing, plan names, bundle names, promotional copy, school contracts, tenant offers, or partner offers from Truth Social.
...
- Manual verification tests for Truth Social/Trump Media & Technology Group account and content policy, Truth posting with text, images, links, and media, ReTruth sharing and attribution mechanics, feed algorithm (Following tab chronological vs For You algorithmic), user profile customization and verification, Truth Mail direct messaging infrastructure, trending topics and hashtag indexing, explore and search functionality, Truth+ premium subscription for video content and live TV, live TV streaming infrastructure and content licensing, group messaging feature and participant management, push notification categories and delivery, content moderation policy and enforcement (stated light-touch approach), political content considerations and platform positioning, community guidelines and appeals process, ad serving and monetization, DMCA and copyright handling, in-app subscription management for Truth+ on iOS/Android, user verification and notable account handling, and Truth Social/TMTG account integration.
...
- Phase 4: Add app-specific safety controls for social media platform with Truths (posts similar to tweets), ReTruths (sharing/reblogging), Truth feed with following and discovery tabs, user profiles with followers/following, direct messaging (Truth Mail), trending topics and hashtags, explore and search functionality, Truth+ subscription for premium video content, live TV streaming integration, group messaging, push notifications for interactions and followed accounts, content moderation (community guidelines), and free ad-supported model with Truth+ premium subscription.
...
- Confirm legal/privacy retention behavior for Truth Social-style sensitive records and update API contracts before downstream implementation.
