# Tellonym-Style Clone Spec

> Metadata
> - Inspiration app: Tellonym
> - Category: Social
...
> - Manual verification blockers: Tellonym account and social platform linking, anonymous message delivery and sender identity protection, AI content moderation for harmful anonymous messages, Tellonym Premium sender reveal feature and privacy implications, social media integration (Instagram, Snapchat, Twitter link sharing), customizable question prompts and icebreaker generation, public answer feed curation and display, friend discovery algorithm and social graph, push notification delivery for new Tells, safety features (AI moderation, keyword filtering, block/report), child safety and minor protection for anonymous Q&A, anti-cyberbullying measures and content filtering, explore and trending content curation, custom themes and profile customization (Premium), ad-free experience and subscription management, data retention for anonymous messages and answered Tells, GDPR compliance (EU-based service), and Tellonym account integration.
...
Build an original mobile product inspired by Tellonym's public social workflow. The V1 clone focuses on anonymous Q&A and messaging platform with Tells (anonymous messages), public profile with answered Tells, social media integration (Instagram, Snapchat, Twitter bio links), customizable question prompts and icebreakers, anonymous message inbox with moderation tools, public answer feed with community engagement, friend discovery and following, push notifications for new Tells, safety features (AI moderation, keyword filtering, blocking), Tellonym Premium (see who sent messages, custom themes, ad-free), explore and trending content, and freemium model with Tellonym Premium subscription.
...
- Preserve the functional job behind Tellonym while using original product naming, original UI, original sample data, and licensed integrations.
...
- Do not copy Tellonym branding, logos, screenshots, marketing copy, private APIs, proprietary datasets, plan names, UI trade dress, course libraries, textbook solutions, documents, school content, AI prompts, or protected media.
...
|---|---|---|---|
| Apple App Store | https://apps.apple.com/us/app/tellonym-anonymous-q-a/id1166992953 | iOS listing, privacy labels, release notes, anonymous Q&A claims, and support links | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
| Google Play | https://play.google.com/store/apps/details?id=com.tellonym.app | Android listing, data safety, anonymous messaging/Q&A claims, and release cadence | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
| Official product site | https://tellonym.me/ | Tellonym anonymous Q&A, Tells, and product positioning | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
| Official help | https://tellonym.me/help | Tellonym app help, safety, and troubleshooting | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
| Privacy policy | https://tellonym.me/privacy | Tellonym data collection, anonymous data, GDPR, and privacy disclosures | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
| Terms | https://tellonym.me/terms | Tellonym services, community guidelines, and acceptable-use boundaries | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
...
- Manual blockers must remain launch-blocking until verified: Tellonym account and social platform linking, anonymous message delivery and sender identity protection, AI content moderation for harmful anonymous messages, Tellonym Premium sender reveal feature and privacy implications, social media integration (Instagram, Snapchat, Twitter link sharing), customizable question prompts and icebreaker generation, public answer feed curation and display, friend discovery algorithm and social graph, push notification delivery for new Tells, safety features (AI moderation, keyword filtering, block/report), child safety and minor protection for anonymous Q&A, anti-cyberbullying measures and content filtering, explore and trending content curation, custom themes and profile customization (Premium), ad-free experience and subscription management, data retention for anonymous messages and answered Tells, GDPR compliance (EU-based service), and Tellonym account integration.

## Core User Journeys

- User creates or restores a Tellonym-style account, completes role, school, subscription, or tenant checks, and reaches the dashboard.
...
- Monetization model: use original free/trial/paid/sponsored/school/provider/tenant entitlement logic; do not copy exact pricing, plan names, bundle names, promotional copy, school contracts, tenant offers, or partner offers from Tellonym.
...
- Manual verification tests for Tellonym account and social platform linking, anonymous message delivery and sender identity protection, AI content moderation for harmful anonymous messages, Tellonym Premium sender reveal feature and privacy implications, social media integration (Instagram, Snapchat, Twitter link sharing), customizable question prompts and icebreaker generation, public answer feed curation and display, friend discovery algorithm and social graph, push notification delivery for new Tells, safety features (AI moderation, keyword filtering, block/report), child safety and minor protection for anonymous Q&A, anti-cyberbullying measures and content filtering, explore and trending content curation, custom themes and profile customization (Premium), ad-free experience and subscription management, data retention for anonymous messages and answered Tells, GDPR compliance (EU-based service), and Tellonym account integration.
...
- Phase 4: Add app-specific safety controls for anonymous Q&A and messaging platform with Tells (anonymous messages), public profile with answered Tells, social media integration (Instagram, Snapchat, Twitter bio links), customizable question prompts and icebreakers, anonymous message inbox with moderation tools, public answer feed with community engagement, friend discovery and following, push notifications for new Tells, safety features (AI moderation, keyword filtering, blocking), Tellonym Premium (see who sent messages, custom themes, ad-free), explore and trending content, and freemium model with Tellonym Premium subscription.
...
- Confirm legal/privacy retention behavior for Tellonym-style sensitive records and update API contracts before downstream implementation.
