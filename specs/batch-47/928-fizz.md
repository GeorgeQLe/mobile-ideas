# Fizz-Style Clone Spec

> Metadata
> - Inspiration app: Fizz
> - Category: Social
...
> - Manual verification blockers: Fizz account and .edu email verification (campus exclusivity enforcement), anonymous identity management and de-anonymization prevention, campus-specific community isolation and multi-campus handling, anonymous posting content moderation at scale (AI + community reporting), upvote/downvote system and ranking algorithm (trending, hot, top), Fizz Score reputation calculation and anti-gaming measures, anonymous direct messaging with optional identity reveal, campus events creation and calendar integration, marketplace buy/sell listings and transaction safety, .edu email domain validation and university database, age verification and FERPA considerations for campus data, anti-bullying and harassment detection in anonymous context, content policy enforcement (hate speech, threats, doxxing), push notification delivery for anonymous content interactions, campus admin reporting and university relationship, child safety considerations (18+ verification for college context), data retention for anonymous posts and legal compliance, and Fizz account integration.
...
Build an original mobile product inspired by Fizz's public social workflow. The V1 clone focuses on college-exclusive anonymous social platform with campus-specific communities verified by .edu email, anonymous posting with text, images, polls, and confessions, feed sorted by trending, new, and top, upvote/downvote voting system, commenting and reply threads, campus-specific content isolation, reputation system (Fizz Score based on engagement), direct messaging (anonymous and revealed), campus events and social calendar, marketplace for campus buy/sell, content moderation with AI and community reporting, push notifications for trending posts and replies, and free model with college verification requirement.
...
- Preserve the functional job behind Fizz while using original product naming, original UI, original sample data, and licensed integrations.
...
- Do not copy Fizz branding, logos, screenshots, marketing copy, private APIs, proprietary datasets, plan names, UI trade dress, course libraries, textbook solutions, documents, school content, AI prompts, or protected media.
...
|---|---|---|---|
| Apple App Store | https://apps.apple.com/us/app/fizz-college-community/id1556609498 | iOS listing, privacy labels, release notes, college anonymous social claims, and support links | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
| Google Play | https://play.google.com/store/apps/details?id=com.fizz.android | Android listing, data safety, college community/anonymous claims, and release cadence | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
| Official product site | https://www.fizzsocial.app/ | Fizz college social, anonymous posting, campus community, and product positioning | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
| Official help | https://www.fizzsocial.app/faq | Fizz app help, campus verification, and troubleshooting | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
| Privacy policy | https://www.fizzsocial.app/privacy | Fizz data collection, anonymous identity handling, and privacy disclosures | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
| Terms | https://www.fizzsocial.app/terms | Fizz services, community guidelines, campus policies, and acceptable-use boundaries | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
...
- Manual blockers must remain launch-blocking until verified: Fizz account and .edu email verification (campus exclusivity enforcement), anonymous identity management and de-anonymization prevention, campus-specific community isolation and multi-campus handling, anonymous posting content moderation at scale (AI + community reporting), upvote/downvote system and ranking algorithm (trending, hot, top), Fizz Score reputation calculation and anti-gaming measures, anonymous direct messaging with optional identity reveal, campus events creation and calendar integration, marketplace buy/sell listings and transaction safety, .edu email domain validation and university database, age verification and FERPA considerations for campus data, anti-bullying and harassment detection in anonymous context, content policy enforcement (hate speech, threats, doxxing), push notification delivery for anonymous content interactions, campus admin reporting and university relationship, child safety considerations (18+ verification for college context), data retention for anonymous posts and legal compliance, and Fizz account integration.

## Core User Journeys

- User creates or restores a Fizz-style account, completes role, school, subscription, or tenant checks, and reaches the dashboard.
...
- Monetization model: use original free/trial/paid/sponsored/school/provider/tenant entitlement logic; do not copy exact pricing, plan names, bundle names, promotional copy, school contracts, tenant offers, or partner offers from Fizz.
...
- Manual verification tests for Fizz account and .edu email verification (campus exclusivity enforcement), anonymous identity management and de-anonymization prevention, campus-specific community isolation and multi-campus handling, anonymous posting content moderation at scale (AI + community reporting), upvote/downvote system and ranking algorithm (trending, hot, top), Fizz Score reputation calculation and anti-gaming measures, anonymous direct messaging with optional identity reveal, campus events creation and calendar integration, marketplace buy/sell listings and transaction safety, .edu email domain validation and university database, age verification and FERPA considerations for campus data, anti-bullying and harassment detection in anonymous context, content policy enforcement (hate speech, threats, doxxing), push notification delivery for anonymous content interactions, campus admin reporting and university relationship, child safety considerations (18+ verification for college context), data retention for anonymous posts and legal compliance, and Fizz account integration.
...
- Phase 4: Add app-specific safety controls for college-exclusive anonymous social platform with campus-specific communities verified by .edu email, anonymous posting with text, images, polls, and confessions, feed sorted by trending, new, and top, upvote/downvote voting system, commenting and reply threads, campus-specific content isolation, reputation system (Fizz Score based on engagement), direct messaging (anonymous and revealed), campus events and social calendar, marketplace for campus buy/sell, content moderation with AI and community reporting, push notifications for trending posts and replies, and free model with college verification requirement.
...
- Confirm legal/privacy retention behavior for Fizz-style sensitive records and update API contracts before downstream implementation.
