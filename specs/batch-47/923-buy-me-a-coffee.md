# Buy Me a Coffee-Style Clone Spec

> Metadata
> - Inspiration app: Buy Me a Coffee
> - Category: Social
...
> - Manual verification blockers: Buy Me a Coffee account and creator/supporter policy, one-time donation processing and payment handling (Stripe), recurring membership billing and tier management, Extras digital product delivery (downloads, commissions, 1-on-1 call scheduling), supporter feed content creation and media hosting, creator page customization (bio, links, featured extras, supporter wall), supporter messaging and thank-you note delivery, fundraising goal tracking and progress display, instant payout mechanics and minimum thresholds, embeddable widget/button generation and external site integration, analytics dashboard (earnings, supporter demographics, page views), push notification for new supporters, purchases, and messages, payment method management and international currency support, tax reporting and compliance, content moderation for creator pages and posts, in-app purchase restrictions on iOS, and Buy Me a Coffee account integration.
...
Build an original mobile product inspired by Buy Me a Coffee's public social workflow. The V1 clone focuses on creator support platform with one-time donations (buy a coffee), recurring memberships with tiers, supporter feed with exclusive posts and updates, creator page with bio, extras (digital products), and supporter wall, Extras marketplace for selling digital downloads, commissions, and 1-on-1 calls, supporter messaging and thank-you notes, goal tracking for fundraising, integration with payment processors (Stripe), instant payouts, embeddable widgets and buttons for external sites, push notifications for new supporters and messages, analytics dashboard (earnings, supporters, page views), and commission-based model (platform fee on transactions).
...
- Preserve the functional job behind Buy Me a Coffee while using original product naming, original UI, original sample data, and licensed integrations.
...
- Do not copy Buy Me a Coffee branding, logos, screenshots, marketing copy, private APIs, proprietary datasets, plan names, UI trade dress, course libraries, textbook solutions, documents, school content, AI prompts, or protected media.
...
|---|---|---|---|
| Apple App Store | https://apps.apple.com/us/app/buy-me-a-coffee/id1480411392 | iOS listing, privacy labels, release notes, creator support/donation claims, and support links | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
| Google Play | https://play.google.com/store/apps/details?id=com.buymeacoffee.app | Android listing, data safety, creator support/membership claims, and release cadence | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
| Official product site | https://www.buymeacoffee.com/ | Buy Me a Coffee creator support, memberships, Extras, and product positioning | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
| Official help | https://help.buymeacoffee.com/ | Buy Me a Coffee app help, creator tools, and troubleshooting | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
| Privacy policy | https://www.buymeacoffee.com/privacy-policy | Buy Me a Coffee data collection, payment data, and privacy disclosures | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
| Terms | https://www.buymeacoffee.com/terms | Buy Me a Coffee services, creator terms, and acceptable-use boundaries | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
...
- Manual blockers must remain launch-blocking until verified: Buy Me a Coffee account and creator/supporter policy, one-time donation processing and payment handling (Stripe), recurring membership billing and tier management, Extras digital product delivery (downloads, commissions, 1-on-1 call scheduling), supporter feed content creation and media hosting, creator page customization (bio, links, featured extras, supporter wall), supporter messaging and thank-you note delivery, fundraising goal tracking and progress display, instant payout mechanics and minimum thresholds, embeddable widget/button generation and external site integration, analytics dashboard (earnings, supporter demographics, page views), push notification for new supporters, purchases, and messages, payment method management and international currency support, tax reporting and compliance, content moderation for creator pages and posts, in-app purchase restrictions on iOS, and Buy Me a Coffee account integration.

## Core User Journeys

- User creates or restores a Buy Me a Coffee-style account, completes role, school, subscription, or tenant checks, and reaches the dashboard.
...
- Monetization model: use original free/trial/paid/sponsored/school/provider/tenant entitlement logic; do not copy exact pricing, plan names, bundle names, promotional copy, school contracts, tenant offers, or partner offers from Buy Me a Coffee.
...
- Manual verification tests for Buy Me a Coffee account and creator/supporter policy, one-time donation processing and payment handling (Stripe), recurring membership billing and tier management, Extras digital product delivery (downloads, commissions, 1-on-1 call scheduling), supporter feed content creation and media hosting, creator page customization (bio, links, featured extras, supporter wall), supporter messaging and thank-you note delivery, fundraising goal tracking and progress display, instant payout mechanics and minimum thresholds, embeddable widget/button generation and external site integration, analytics dashboard (earnings, supporter demographics, page views), push notification for new supporters, purchases, and messages, payment method management and international currency support, tax reporting and compliance, content moderation for creator pages and posts, in-app purchase restrictions on iOS, and Buy Me a Coffee account integration.
...
- Phase 4: Add app-specific safety controls for creator support platform with one-time donations (buy a coffee), recurring memberships with tiers, supporter feed with exclusive posts and updates, creator page with bio, extras (digital products), and supporter wall, Extras marketplace for selling digital downloads, commissions, and 1-on-1 calls, supporter messaging and thank-you notes, goal tracking for fundraising, integration with payment processors (Stripe), instant payouts, embeddable widgets and buttons for external sites, push notifications for new supporters and messages, analytics dashboard (earnings, supporters, page views), and commission-based model (platform fee on transactions).
...
- Confirm legal/privacy retention behavior for Buy Me a Coffee-style sensitive records and update API contracts before downstream implementation.
