# Google Sheets-Style Clone Spec

> Metadata
> - Inspiration app: Google Sheets
...
> - Manual verification blockers: formula fidelity, chart rendering, Drive sync conflicts, Gemini eligibility, offline edit merge behavior, Excel conversion, protected ranges, comments, link sharing, permissions, and tenant compliance.
...
Build an original mobile product inspired by Google Sheets's public productivity documents workflow. The V1 clone focuses on spreadsheet creation and editing, formulas, charts, comments, real-time collaboration, templates, Microsoft Excel import/export, offline edits, Drive sharing, Gemini-assisted analysis, and Workspace entitlements.
...
- Preserve the functional job behind Google Sheets while using original product naming, original UI, original sample data, and licensed integrations.
...
- Do not copy Google Sheets branding, logos, screenshots, marketing copy, private APIs, proprietary datasets, plan names, UI trade dress, course libraries, textbook solutions, documents, school content, AI prompts, or protected media.
...
|---|---|---|---|
| Apple App Store | https://apps.apple.com/us/app/google-sheets/id842849113 | iOS listing, privacy labels, release notes, spreadsheet/collaboration claims, and support links | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
| Google Play | https://play.google.com/store/apps/details?id=com.google.android.apps.docs.editors.sheets | Android listing, data safety, Sheets feature claims, and release cadence | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
| Official product site | https://www.google.com/sheets/about/ | Sheets editor, collaboration, formulas, Gemini, and Workspace positioning | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
| Official help | https://support.google.com/docs/topic/9054603 | Sheets editing, formulas, charts, sharing, offline, and troubleshooting | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
...
- Manual blockers must remain launch-blocking until verified: formula fidelity, chart rendering, Drive sync conflicts, Gemini eligibility, offline edit merge behavior, Excel conversion, protected ranges, comments, link sharing, permissions, and tenant compliance.

## Core User Journeys

- User creates or restores a Google Sheets-style account, completes role, school, subscription, or tenant checks, and reaches the dashboard.
...
- Monetization model: use original free/trial/paid/sponsored/school/provider/tenant entitlement logic; do not copy exact pricing, plan names, bundle names, promotional copy, school contracts, tenant offers, or partner offers from Google Sheets.
...
- Manual verification tests for formula fidelity, chart rendering, Drive sync conflicts, Gemini eligibility, offline edit merge behavior, Excel conversion, protected ranges, comments, link sharing, permissions, and tenant compliance.
...
- Phase 4: Add app-specific safety controls for spreadsheet creation and editing, formulas, charts, comments, real-time collaboration, templates, Microsoft Excel import/export, offline edits, Drive sharing, Gemini-assisted analysis, and Workspace entitlements.
...
- Confirm legal/privacy retention behavior for Google Sheets-style sensitive records and update API contracts before downstream implementation.
