# Ulysses-Style Clone Spec

> Metadata
> - Inspiration app: Ulysses
...
> - Manual verification blockers: Apple-platform-only availability, no verified first-party Android listing, iCloud sync conflicts, publishing/export fidelity, subscription restore, library recovery, attachments, and platform feature differences.
...
Build an original mobile product inspired by Ulysses's public productivity documents workflow. The V1 clone focuses on long-form writing library, sheets, Markdown-style editing, goals, publishing/export, iCloud sync, attachments, backups, and Apple-platform subscription entitlements.
...
- Preserve the functional job behind Ulysses while using original product naming, original UI, original sample data, and licensed integrations.
...
- Do not copy Ulysses branding, logos, screenshots, marketing copy, private APIs, proprietary datasets, plan names, UI trade dress, course libraries, textbook solutions, documents, school content, AI prompts, or protected media.
...
|---|---|---|---|
| Apple App Store | https://apps.apple.com/us/app/ulysses-writing-app/id1225570693 | iOS listing, privacy labels, subscription state, release notes, and support links | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
| Google Play | Platform blocker: no verified first-party Google Play listing for Ulysses | Android parity is blocked until a first-party listing is verified | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
| Official product site | https://ulysses.app/ | Writing library, editor, export, publishing, and subscription positioning | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
| Official help | https://help.ulysses.app/ | Ulysses setup, sync, writing, export, publishing, subscription, and troubleshooting | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
| Privacy policy | https://ulysses.app/app-privacy-policy/ | App usage, purchase, optional analytics, iCloud, and privacy disclosures | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
| Terms | https://ulysses.app/terms/ | Service, subscription, license, content, and acceptable-use boundaries | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
...
- Manual blockers must remain launch-blocking until verified: Apple-platform-only availability, no verified first-party Android listing, iCloud sync conflicts, publishing/export fidelity, subscription restore, library recovery, attachments, and platform feature differences.

## Core User Journeys

- User creates or restores a Ulysses-style account, completes role, school, subscription, or tenant checks, and reaches the dashboard.
...
- Monetization model: use original free/trial/paid/sponsored/school/provider/tenant entitlement logic; do not copy exact pricing, plan names, bundle names, promotional copy, school contracts, tenant offers, or partner offers from Ulysses.
...
- Manual verification tests for Apple-platform-only availability, no verified first-party Android listing, iCloud sync conflicts, publishing/export fidelity, subscription restore, library recovery, attachments, and platform feature differences.
...
- Phase 4: Add app-specific safety controls for long-form writing library, sheets, Markdown-style editing, goals, publishing/export, iCloud sync, attachments, backups, and Apple-platform subscription entitlements.
...
- Confirm legal/privacy retention behavior for Ulysses-style sensitive records and update API contracts before downstream implementation.
