# Joplin-Style Clone Spec

> Metadata
> - Inspiration app: Joplin
...
> - Manual verification blockers: sync-target credentials, end-to-end encryption setup, attachment/OCR behavior, reminder delivery, conflict resolution, Joplin Cloud subscription restore, plugin parity, import/export fidelity, and self-hosted server compatibility.
...
Build an original mobile product inspired by Joplin's public productivity documents workflow. The V1 clone focuses on open-source notes and to-dos, notebooks, Markdown/rich text editing, attachments, OCR search, reminders, end-to-end encryption, sync targets, and Joplin Cloud entitlements.
...
- Preserve the functional job behind Joplin while using original product naming, original UI, original sample data, and licensed integrations.
...
- Do not copy Joplin branding, logos, screenshots, marketing copy, private APIs, proprietary datasets, plan names, UI trade dress, course libraries, textbook solutions, documents, school content, AI prompts, or protected media.
...
|---|---|---|---|
| Apple App Store | https://apps.apple.com/us/app/joplin/id1315599797 | iOS listing, privacy labels, notes/to-do claims, and support links | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
| Google Play | https://play.google.com/store/apps/details?id=net.cozic.joplin | Android listing, data safety, notes/OCR/E2EE claims, and release cadence | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
| Official product site | https://joplinapp.org/ | Open-source notes, sync, E2EE, Joplin Cloud, and product positioning | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
| Official help | https://joplinapp.org/help/ | Joplin docs, sync, encryption, import/export, cloud, and troubleshooting | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
| Privacy policy | https://joplinapp.org/privacy/ | Account, sync, cloud, analytics, and privacy disclosures | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
| Terms | https://joplinapp.org/terms/ | Service, cloud, content, account, and acceptable-use boundaries | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
...
- Manual blockers must remain launch-blocking until verified: sync-target credentials, end-to-end encryption setup, attachment/OCR behavior, reminder delivery, conflict resolution, Joplin Cloud subscription restore, plugin parity, import/export fidelity, and self-hosted server compatibility.

## Core User Journeys

- User creates or restores a Joplin-style account, completes role, school, subscription, or tenant checks, and reaches the dashboard.
...
- Monetization model: use original free/trial/paid/sponsored/school/provider/tenant entitlement logic; do not copy exact pricing, plan names, bundle names, promotional copy, school contracts, tenant offers, or partner offers from Joplin.
...
- Manual verification tests for sync-target credentials, end-to-end encryption setup, attachment/OCR behavior, reminder delivery, conflict resolution, Joplin Cloud subscription restore, plugin parity, import/export fidelity, and self-hosted server compatibility.
...
- Phase 4: Add app-specific safety controls for open-source notes and to-dos, notebooks, Markdown/rich text editing, attachments, OCR search, reminders, end-to-end encryption, sync targets, and Joplin Cloud entitlements.
...
- Confirm legal/privacy retention behavior for Joplin-style sensitive records and update API contracts before downstream implementation.
