# Roam Research-Style Clone Spec

> Metadata
> - Inspiration app: Roam Research
...
> - Manual verification blockers: paid account requirement, graph sync conflicts, block reference fidelity, mobile/web parity, export/import behavior, privacy/delete requests, offline behavior, and no-signup-from-app edge cases.
...
Build an original mobile product inspired by Roam Research's public productivity documents workflow. The V1 clone focuses on networked notes, daily pages, bidirectional links, graph databases, block references, search, mobile capture, sync, and subscription-gated account access.
...
- Preserve the functional job behind Roam Research while using original product naming, original UI, original sample data, and licensed integrations.
...
- Do not copy Roam Research branding, logos, screenshots, marketing copy, private APIs, proprietary datasets, plan names, UI trade dress, course libraries, textbook solutions, documents, school content, AI prompts, or protected media.
...
|---|---|---|---|
| Apple App Store | https://apps.apple.com/us/app/roam-research/id1609277273 | iOS listing, privacy labels, graph note claims, and support links | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
| Google Play | https://play.google.com/store/apps/details?id=com.roamresearch.relemma | Android listing, data safety, graph note claims, and release cadence | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
| Official product site | https://roamresearch.com/ | Networked note graph, daily notes, and product positioning | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
| Official help | https://roamresearch.com/#/app/help | Roam help graph, onboarding, blocks, graph, export, and troubleshooting | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
| Privacy policy | https://roamresearch.com/#/app/help/page/Vu1MmjinS | Account, graph content, storage, analytics, and sharing disclosures | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
| Terms | https://roamresearch.com/#/app/help/page/0ZcAVDYUW | Service, subscriptions, content, account, and acceptable-use boundaries | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
...
- Manual blockers must remain launch-blocking until verified: paid account requirement, graph sync conflicts, block reference fidelity, mobile/web parity, export/import behavior, privacy/delete requests, offline behavior, and no-signup-from-app edge cases.

## Core User Journeys

- User creates or restores a Roam Research-style account, completes role, school, subscription, or tenant checks, and reaches the dashboard.
...
- Monetization model: use original free/trial/paid/sponsored/school/provider/tenant entitlement logic; do not copy exact pricing, plan names, bundle names, promotional copy, school contracts, tenant offers, or partner offers from Roam Research.
...
- Manual verification tests for paid account requirement, graph sync conflicts, block reference fidelity, mobile/web parity, export/import behavior, privacy/delete requests, offline behavior, and no-signup-from-app edge cases.
...
- Phase 4: Add app-specific safety controls for networked notes, daily pages, bidirectional links, graph databases, block references, search, mobile capture, sync, and subscription-gated account access.
...
- Confirm legal/privacy retention behavior for Roam Research-style sensitive records and update API contracts before downstream implementation.
