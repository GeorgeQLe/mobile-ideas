# Microsoft PowerPoint-Style Clone Spec

> Metadata
> - Inspiration app: Microsoft PowerPoint
...
> - Manual verification blockers: theme and animation fidelity, media playback, OneDrive sync conflicts, Copilot eligibility, subscription restore, PPTX/PDF fidelity, coauthoring, presenter mode, link sharing, permissions, and tenant compliance.
...
Build an original mobile product inspired by Microsoft PowerPoint's public productivity documents workflow. The V1 clone focuses on presentation creation and editing, themes, presenter surfaces, media, PDF/export actions, OneDrive files, Microsoft 365 sharing, offline drafts, Copilot-assisted deck creation, and subscription entitlements.
...
- Preserve the functional job behind Microsoft PowerPoint while using original product naming, original UI, original sample data, and licensed integrations.
...
- Do not copy Microsoft PowerPoint branding, logos, screenshots, marketing copy, private APIs, proprietary datasets, plan names, UI trade dress, course libraries, textbook solutions, documents, school content, AI prompts, or protected media.
...
|---|---|---|---|
| Apple App Store | https://apps.apple.com/us/app/microsoft-powerpoint/id586449534 | iOS listing, privacy labels, PowerPoint claims, subscriptions, and support links | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
| Google Play | https://play.google.com/store/apps/details?id=com.microsoft.office.powerpoint | Android listing, data safety, PowerPoint feature claims, and release cadence | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
| Official product site | https://www.microsoft.com/microsoft-365/powerpoint | PowerPoint editor, templates, Copilot, presenting, and subscription positioning | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
| Official support | https://support.microsoft.com/powerpoint | PowerPoint mobile, presenting, sharing, account, subscriptions, and troubleshooting | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
| Privacy statement | https://privacy.microsoft.com/privacystatement | Microsoft account, files, cloud, enterprise, analytics, advertising, and sharing disclosures | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
...
- Manual blockers must remain launch-blocking until verified: theme and animation fidelity, media playback, OneDrive sync conflicts, Copilot eligibility, subscription restore, PPTX/PDF fidelity, coauthoring, presenter mode, link sharing, permissions, and tenant compliance.

## Core User Journeys

- User creates or restores a Microsoft PowerPoint-style account, completes role, school, subscription, or tenant checks, and reaches the dashboard.
...
- Monetization model: use original free/trial/paid/sponsored/school/provider/tenant entitlement logic; do not copy exact pricing, plan names, bundle names, promotional copy, school contracts, tenant offers, or partner offers from Microsoft PowerPoint.
...
- Manual verification tests for theme and animation fidelity, media playback, OneDrive sync conflicts, Copilot eligibility, subscription restore, PPTX/PDF fidelity, coauthoring, presenter mode, link sharing, permissions, and tenant compliance.
...
- Phase 4: Add app-specific safety controls for presentation creation and editing, themes, presenter surfaces, media, PDF/export actions, OneDrive files, Microsoft 365 sharing, offline drafts, Copilot-assisted deck creation, and subscription entitlements.
...
- Confirm legal/privacy retention behavior for Microsoft PowerPoint-style sensitive records and update API contracts before downstream implementation.
