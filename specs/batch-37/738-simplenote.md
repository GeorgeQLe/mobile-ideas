# Simplenote-Style Clone Spec

> Metadata
> - Inspiration app: Simplenote
...
> - Manual verification blockers: WordPress.com account behavior, note collaboration and publishing privacy, sync conflict handling, passcode behavior, third-party sharing, deletion/export, Markdown rendering, and no-E2EE limitation disclosure.
...
Build an original mobile product inspired by Simplenote's public productivity documents workflow. The V1 clone focuses on simple notes, tags, pins, instant search, free sync, collaboration, web publishing, Markdown, WordPress.com login, passcode lock, and third-party sharing.
...
- Preserve the functional job behind Simplenote while using original product naming, original UI, original sample data, and licensed integrations.
...
- Do not copy Simplenote branding, logos, screenshots, marketing copy, private APIs, proprietary datasets, plan names, UI trade dress, course libraries, textbook solutions, documents, school content, AI prompts, or protected media.
...
|---|---|---|---|
| Apple App Store | https://apps.apple.com/us/app/simplenote/id289429962 | iOS listing, privacy labels, notes/sync claims, and support links | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
| Google Play | https://play.google.com/store/apps/details?id=com.automattic.simplenote | Android listing, data safety, notes/sync/collaboration claims, and release cadence | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
| Official product site | https://simplenote.com/ | Simple notes, sync, collaboration, publishing, and platform positioning | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
| Official help | https://simplenote.com/help/ | Simplenote account, sync, tags, collaboration, publishing, and troubleshooting | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
| Privacy policy | https://automattic.com/privacy/ | Automattic account, notes, analytics, sharing, and privacy disclosures | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
| Terms | https://simplenote.com/terms/ | Service, content, account, publishing, and acceptable-use boundaries | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
...
- Manual blockers must remain launch-blocking until verified: WordPress.com account behavior, note collaboration and publishing privacy, sync conflict handling, passcode behavior, third-party sharing, deletion/export, Markdown rendering, and no-E2EE limitation disclosure.

## Core User Journeys

- User creates or restores a Simplenote-style account, completes role, school, subscription, or tenant checks, and reaches the dashboard.
...
- Monetization model: use original free/trial/paid/sponsored/school/provider/tenant entitlement logic; do not copy exact pricing, plan names, bundle names, promotional copy, school contracts, tenant offers, or partner offers from Simplenote.
...
- Manual verification tests for WordPress.com account behavior, note collaboration and publishing privacy, sync conflict handling, passcode behavior, third-party sharing, deletion/export, Markdown rendering, and no-E2EE limitation disclosure.
...
- Phase 4: Add app-specific safety controls for simple notes, tags, pins, instant search, free sync, collaboration, web publishing, Markdown, WordPress.com login, passcode lock, and third-party sharing.
...
- Confirm legal/privacy retention behavior for Simplenote-style sensitive records and update API contracts before downstream implementation.
