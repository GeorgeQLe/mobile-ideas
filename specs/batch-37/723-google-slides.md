# Google Slides-Style Clone Spec

> Metadata
> - Inspiration app: Google Slides
...
> - Manual verification blockers: slide/theme fidelity, media playback, Drive sync conflicts, Gemini eligibility, offline edit merge behavior, PowerPoint conversion, presenter behavior, comments, link sharing, permissions, and tenant compliance.
...
Build an original mobile product inspired by Google Slides's public productivity documents workflow. The V1 clone focuses on presentation creation and editing, themes, speaker notes, comments, real-time collaboration, Microsoft PowerPoint import/export, offline edits, Drive sharing, Gemini-assisted deck creation, and Workspace entitlements.
...
- Preserve the functional job behind Google Slides while using original product naming, original UI, original sample data, and licensed integrations.
...
- Do not copy Google Slides branding, logos, screenshots, marketing copy, private APIs, proprietary datasets, plan names, UI trade dress, course libraries, textbook solutions, documents, school content, AI prompts, or protected media.
...
|---|---|---|---|
| Apple App Store | https://apps.apple.com/us/app/google-slides/id879478102 | iOS listing, privacy labels, release notes, presentation/collaboration claims, and support links | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
| Google Play | https://play.google.com/store/apps/details?id=com.google.android.apps.docs.editors.slides | Android listing, data safety, Slides feature claims, and release cadence | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
| Official product site | https://www.google.com/slides/about/ | Slides editor, collaboration, templates, Gemini, and Workspace positioning | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
| Official help | https://support.google.com/docs/topic/9052827 | Slides editing, presenting, sharing, offline, import/export, and troubleshooting | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
| Privacy policy | https://policies.google.com/privacy | Google account, files, Workspace, analytics, advertising, and sharing disclosures | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
| Terms | https://policies.google.com/terms | Google service terms, content, accounts, subscriptions, and acceptable-use boundaries | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
...
- Manual blockers must remain launch-blocking until verified: slide/theme fidelity, media playback, Drive sync conflicts, Gemini eligibility, offline edit merge behavior, PowerPoint conversion, presenter behavior, comments, link sharing, permissions, and tenant compliance.

## Core User Journeys

- User creates or restores a Google Slides-style account, completes role, school, subscription, or tenant checks, and reaches the dashboard.
...
- Monetization model: use original free/trial/paid/sponsored/school/provider/tenant entitlement logic; do not copy exact pricing, plan names, bundle names, promotional copy, school contracts, tenant offers, or partner offers from Google Slides.
...
- Manual verification tests for slide/theme fidelity, media playback, Drive sync conflicts, Gemini eligibility, offline edit merge behavior, PowerPoint conversion, presenter behavior, comments, link sharing, permissions, and tenant compliance.
...
- Phase 4: Add app-specific safety controls for presentation creation and editing, themes, speaker notes, comments, real-time collaboration, Microsoft PowerPoint import/export, offline edits, Drive sharing, Gemini-assisted deck creation, and Workspace entitlements.
...
- Confirm legal/privacy retention behavior for Google Slides-style sensitive records and update API contracts before downstream implementation.
