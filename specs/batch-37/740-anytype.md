# Anytype-Style Clone Spec

> Metadata
> - Inspiration app: Anytype
...
> - Manual verification blockers: identity/key recovery, local-first sync conflicts, peer/network behavior, collaboration space permissions, publishing privacy, mobile/desktop parity, self-hosting limitations, paid entitlement restore, and import/export fidelity.
...
Build an original mobile product inspired by Anytype's public productivity documents workflow. The V1 clone focuses on local-first encrypted spaces, notes, docs, databases, object types, tasks, chats, publishing, templates, peer sync, offline-first access, open code, and paid collaboration entitlements.
...
- Preserve the functional job behind Anytype while using original product naming, original UI, original sample data, and licensed integrations.
...
- Do not copy Anytype branding, logos, screenshots, marketing copy, private APIs, proprietary datasets, plan names, UI trade dress, course libraries, textbook solutions, documents, school content, AI prompts, or protected media.
...
|---|---|---|---|
| Apple App Store | https://apps.apple.com/us/app/anytype-the-everything-app/id6449487029 | iOS listing, privacy labels, local-first docs/database claims, and support links | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
| Google Play | https://play.google.com/store/apps/details?id=io.anytype.app | Android listing, data safety, local-first collaboration claims, and release cadence | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
| Official product site | https://anytype.io/ | Local-first encrypted spaces, docs, databases, chats, sync, and product positioning | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
| Official docs | https://doc.anytype.io/ | Anytype setup, objects, spaces, sync, publishing, import/export, and troubleshooting | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
| Privacy policy | https://anytype.io/privacy | Account, keys, local data, sync, analytics, and privacy disclosures | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
| Terms | https://anytype.io/terms | Service, membership, content, account, and acceptable-use boundaries | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
...
- Manual blockers must remain launch-blocking until verified: identity/key recovery, local-first sync conflicts, peer/network behavior, collaboration space permissions, publishing privacy, mobile/desktop parity, self-hosting limitations, paid entitlement restore, and import/export fidelity.

## Core User Journeys

- User creates or restores a Anytype-style account, completes role, school, subscription, or tenant checks, and reaches the dashboard.
...
- Monetization model: use original free/trial/paid/sponsored/school/provider/tenant entitlement logic; do not copy exact pricing, plan names, bundle names, promotional copy, school contracts, tenant offers, or partner offers from Anytype.
...
- Manual verification tests for identity/key recovery, local-first sync conflicts, peer/network behavior, collaboration space permissions, publishing privacy, mobile/desktop parity, self-hosting limitations, paid entitlement restore, and import/export fidelity.
...
- Phase 4: Add app-specific safety controls for local-first encrypted spaces, notes, docs, databases, object types, tasks, chats, publishing, templates, peer sync, offline-first access, open code, and paid collaboration entitlements.
...
- Confirm legal/privacy retention behavior for Anytype-style sensitive records and update API contracts before downstream implementation.
