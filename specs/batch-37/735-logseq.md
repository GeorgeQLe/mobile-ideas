# Logseq-Style Clone Spec

> Metadata
> - Inspiration app: Logseq
...
> - Manual verification blockers: local file permissions, file-provider sync conflicts, optional Logseq Sync eligibility, plugin behavior, whiteboard/mobile parity, data-loss recovery, encryption boundaries, and export/import fidelity.
...
Build an original mobile product inspired by Logseq's public productivity documents workflow. The V1 clone focuses on local-first open-source outliner, Markdown and Org-mode files, journals, backlinks, graph view, tasks, whiteboards, SRS cards, file-provider sync, and optional Logseq Sync.
...
- Preserve the functional job behind Logseq while using original product naming, original UI, original sample data, and licensed integrations.
...
- Do not copy Logseq branding, logos, screenshots, marketing copy, private APIs, proprietary datasets, plan names, UI trade dress, course libraries, textbook solutions, documents, school content, AI prompts, or protected media.
...
|---|---|---|---|
| Apple App Store | https://apps.apple.com/us/app/logseq/id1601013908 | iOS listing, privacy labels, local-first claims, and release notes | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
| Google Play | https://play.google.com/store/apps/details?id=com.logseq.app | Android listing, data safety, local-first/outliner claims, and release cadence | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
| Official product site | https://logseq.com/ | Open-source outliner, local-first notes, whiteboards, sync, and product positioning | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
| Official docs | https://docs.logseq.com/ | Logseq docs, files, sync, graph, tasks, whiteboards, and troubleshooting | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
| Privacy policy | https://logseq.com/privacy | Account, optional sync, crash diagnostics, and privacy disclosures | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
| Terms | https://logseq.com/terms | Service, sync, content, account, and acceptable-use boundaries | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
...
- Manual blockers must remain launch-blocking until verified: local file permissions, file-provider sync conflicts, optional Logseq Sync eligibility, plugin behavior, whiteboard/mobile parity, data-loss recovery, encryption boundaries, and export/import fidelity.

## Core User Journeys

- User creates or restores a Logseq-style account, completes role, school, subscription, or tenant checks, and reaches the dashboard.
...
- Monetization model: use original free/trial/paid/sponsored/school/provider/tenant entitlement logic; do not copy exact pricing, plan names, bundle names, promotional copy, school contracts, tenant offers, or partner offers from Logseq.
...
- Manual verification tests for local file permissions, file-provider sync conflicts, optional Logseq Sync eligibility, plugin behavior, whiteboard/mobile parity, data-loss recovery, encryption boundaries, and export/import fidelity.
...
- Phase 4: Add app-specific safety controls for local-first open-source outliner, Markdown and Org-mode files, journals, backlinks, graph view, tasks, whiteboards, SRS cards, file-provider sync, and optional Logseq Sync.
...
- Confirm legal/privacy retention behavior for Logseq-style sensitive records and update API contracts before downstream implementation.
