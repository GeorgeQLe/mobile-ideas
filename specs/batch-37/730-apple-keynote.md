# Apple Keynote-Style Clone Spec

> Metadata
> - Inspiration app: Apple Keynote
...
> - Manual verification blockers: Apple ID and iCloud availability, no first-party Android listing, iCloud sync conflicts, presentation/export fidelity, collaboration invitations, Creator Studio subscription availability, platform feature differences, presenter behavior, and regional compliance.
...
Build an original mobile product inspired by Apple Keynote's public productivity documents workflow. The V1 clone focuses on presentation creation and editing, Apple templates, animation, presenter surfaces, collaboration, iCloud files, import/export, Apple Creator Studio availability, offline edits, and platform-specific entitlements.
...
- Preserve the functional job behind Apple Keynote while using original product naming, original UI, original sample data, and licensed integrations.
...
- Do not copy Apple Keynote branding, logos, screenshots, marketing copy, private APIs, proprietary datasets, plan names, UI trade dress, course libraries, textbook solutions, documents, school content, AI prompts, or protected media.
...
|---|---|---|---|
| Apple App Store | https://apps.apple.com/us/app/keynote/id361285480 | iOS listing, privacy labels, Keynote claims, Creator Studio note, and support links | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
| Google Play | Platform blocker: no verified first-party Google Play listing for Apple Keynote | Android parity is blocked until Apple publishes a first-party listing | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
| Official product site | https://www.apple.com/keynote/ | Keynote templates, animation, collaboration, and Apple platform positioning | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
| Official support | https://support.apple.com/keynote | Keynote for iPhone/iPad/Mac, iCloud, collaboration, import/export, and troubleshooting | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
| Privacy policy | https://www.apple.com/legal/privacy/ | Apple ID, iCloud, documents, analytics, and sharing disclosures | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
| Terms | https://www.apple.com/legal/internet-services/terms/site.html | Apple service terms, iCloud, content, subscriptions, and service boundaries | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
...
- Manual blockers must remain launch-blocking until verified: Apple ID and iCloud availability, no first-party Android listing, iCloud sync conflicts, presentation/export fidelity, collaboration invitations, Creator Studio subscription availability, platform feature differences, presenter behavior, and regional compliance.

## Core User Journeys

- User creates or restores a Apple Keynote-style account, completes role, school, subscription, or tenant checks, and reaches the dashboard.
...
- Monetization model: use original free/trial/paid/sponsored/school/provider/tenant entitlement logic; do not copy exact pricing, plan names, bundle names, promotional copy, school contracts, tenant offers, or partner offers from Apple Keynote.
...
- Manual verification tests for Apple ID and iCloud availability, no first-party Android listing, iCloud sync conflicts, presentation/export fidelity, collaboration invitations, Creator Studio subscription availability, platform feature differences, presenter behavior, and regional compliance.
...
- Phase 4: Add app-specific safety controls for presentation creation and editing, Apple templates, animation, presenter surfaces, collaboration, iCloud files, import/export, Apple Creator Studio availability, offline edits, and platform-specific entitlements.
...
- Confirm legal/privacy retention behavior for Apple Keynote-style sensitive records and update API contracts before downstream implementation.
