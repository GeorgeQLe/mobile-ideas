# Craft-Style Clone Spec

> Metadata
> - Inspiration app: Craft
...
> - Manual verification blockers: Craft account and workspace policy, AI eligibility, subscription restore, offline sync conflicts, block export fidelity, publishing links, team permissions, family/business plan boundaries, and regional compliance.
...
Build an original mobile product inspired by Craft's public productivity documents workflow. The V1 clone focuses on notes and document creation, block editing, AI writing/editing, spaces, backlinks, sharing, publishing, templates, offline sync, and Plus/Family/Team/Business entitlements.
...
- Preserve the functional job behind Craft while using original product naming, original UI, original sample data, and licensed integrations.
...
- Do not copy Craft branding, logos, screenshots, marketing copy, private APIs, proprietary datasets, plan names, UI trade dress, course libraries, textbook solutions, documents, school content, AI prompts, or protected media.
...
|---|---|---|---|
| Apple App Store | https://apps.apple.com/us/app/craft-write-docs-ai-editing/id1487937127 | iOS listing, privacy labels, AI/docs claims, subscription tiers, and support links | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
| Google Play | https://play.google.com/store/apps/details?id=com.craft.do | Android listing, data safety, docs/AI feature claims, and release cadence | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
| Official product site | https://www.craft.do/ | Craft notes, documents, AI, spaces, sharing, and product positioning | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
| Official support | https://support.craft.do/ | Account, sync, spaces, sharing, subscriptions, and troubleshooting | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
| Privacy policy | https://www.craft.do/privacy | Account, content, analytics, AI, team, and sharing disclosures | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
| Terms | https://www.craft.do/terms | Service, subscriptions, content, teams, and acceptable-use boundaries | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
...
- Manual blockers must remain launch-blocking until verified: Craft account and workspace policy, AI eligibility, subscription restore, offline sync conflicts, block export fidelity, publishing links, team permissions, family/business plan boundaries, and regional compliance.

## Core User Journeys

- User creates or restores a Craft-style account, completes role, school, subscription, or tenant checks, and reaches the dashboard.
...
- Monetization model: use original free/trial/paid/sponsored/school/provider/tenant entitlement logic; do not copy exact pricing, plan names, bundle names, promotional copy, school contracts, tenant offers, or partner offers from Craft.
...
- Manual verification tests for Craft account and workspace policy, AI eligibility, subscription restore, offline sync conflicts, block export fidelity, publishing links, team permissions, family/business plan boundaries, and regional compliance.
...
- Phase 4: Add app-specific safety controls for notes and document creation, block editing, AI writing/editing, spaces, backlinks, sharing, publishing, templates, offline sync, and Plus/Family/Team/Business entitlements.
...
- Confirm legal/privacy retention behavior for Craft-style sensitive records and update API contracts before downstream implementation.
