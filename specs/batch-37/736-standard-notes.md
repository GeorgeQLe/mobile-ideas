# Standard Notes-Style Clone Spec

> Metadata
> - Inspiration app: Standard Notes
...
> - Manual verification blockers: encryption key recovery, sync conflict handling, passcode/biometric behavior, protected note recovery, paid editor entitlements, encrypted backups, account deletion, and import/export fidelity.
...
Build an original mobile product inspired by Standard Notes's public productivity documents workflow. The V1 clone focuses on end-to-end encrypted notes, tags, offline access, cross-device sync, passcode/biometric lock, protected notes, encrypted backups, editors, themes, and paid plan entitlements.
...
- Preserve the functional job behind Standard Notes while using original product naming, original UI, original sample data, and licensed integrations.
...
- Do not copy Standard Notes branding, logos, screenshots, marketing copy, private APIs, proprietary datasets, plan names, UI trade dress, course libraries, textbook solutions, documents, school content, AI prompts, or protected media.
...
|---|---|---|---|
| Apple App Store | https://apps.apple.com/us/app/standard-notes/id1285392450 | iOS listing, privacy labels, encrypted-notes claims, subscription state, and support links | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
| Google Play | https://play.google.com/store/apps/details?id=com.standardnotes | Android listing, data safety, encrypted sync claims, and release cadence | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
| Official product site | https://standardnotes.com/ | Encrypted notes, sync, editors, backups, and privacy positioning | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
| Official help | https://standardnotes.com/help | Account, encryption, sync, editors, backups, subscriptions, and troubleshooting | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
| Privacy policy | https://standardnotes.com/privacy | Encrypted content, account, payment, analytics, and privacy disclosures | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
| Terms | https://standardnotes.com/terms | Service, subscription, content, account, and acceptable-use boundaries | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
...
- Manual blockers must remain launch-blocking until verified: encryption key recovery, sync conflict handling, passcode/biometric behavior, protected note recovery, paid editor entitlements, encrypted backups, account deletion, and import/export fidelity.

## Core User Journeys

- User creates or restores a Standard Notes-style account, completes role, school, subscription, or tenant checks, and reaches the dashboard.
...
- Monetization model: use original free/trial/paid/sponsored/school/provider/tenant entitlement logic; do not copy exact pricing, plan names, bundle names, promotional copy, school contracts, tenant offers, or partner offers from Standard Notes.
...
- Manual verification tests for encryption key recovery, sync conflict handling, passcode/biometric behavior, protected note recovery, paid editor entitlements, encrypted backups, account deletion, and import/export fidelity.
...
- Phase 4: Add app-specific safety controls for end-to-end encrypted notes, tags, offline access, cross-device sync, passcode/biometric lock, protected notes, encrypted backups, editors, themes, and paid plan entitlements.
...
- Confirm legal/privacy retention behavior for Standard Notes-style sensitive records and update API contracts before downstream implementation.
