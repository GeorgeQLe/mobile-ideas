# iA Writer-Style Clone Spec

> Metadata
> - Inspiration app: iA Writer
...
> - Manual verification blockers: no current Android distribution, iCloud/Dropbox/Drive provider behavior, Android legacy cloud connector failures, file-provider permissions, Markdown export fidelity, purchase restore, local file recovery, and platform feature differences.
...
Build an original mobile product inspired by iA Writer's public productivity documents workflow. The V1 clone focuses on focused Markdown writing, file-library organization, local and cloud-provider storage, export/preview, keyboard workflows, style/focus tooling, iCloud sync, and platform-specific purchase/subscription state.
...
- Preserve the functional job behind iA Writer while using original product naming, original UI, original sample data, and licensed integrations.
...
- Do not copy iA Writer branding, logos, screenshots, marketing copy, private APIs, proprietary datasets, plan names, UI trade dress, course libraries, textbook solutions, documents, school content, AI prompts, or protected media.
...
|---|---|---|---|
| Apple App Store | https://apps.apple.com/us/app/ia-writer/id775737172 | iOS listing, privacy labels, release notes, purchase state, and support links | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
| Google Play | Platform blocker: iA Writer for Android is no longer available in Google Play | Android parity is blocked; official FAQ says Android is no longer distributed | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
| Official product site | https://ia.net/writer | Focused writing app, Markdown, file library, and platform positioning | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
| Official help | https://ia.net/writer/support/help | iA Writer support, files, iCloud, export, Android FAQ, and troubleshooting | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
| Privacy policy | https://ia.net/privacy | App content, crash reports, anonymous statistics, and privacy disclosures | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
| Terms | https://ia.net/terms | Service, product, licensing, and acceptable-use boundaries | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
...
- Manual blockers must remain launch-blocking until verified: no current Android distribution, iCloud/Dropbox/Drive provider behavior, Android legacy cloud connector failures, file-provider permissions, Markdown export fidelity, purchase restore, local file recovery, and platform feature differences.

## Core User Journeys

- User creates or restores a iA Writer-style account, completes role, school, subscription, or tenant checks, and reaches the dashboard.
...
- Monetization model: use original free/trial/paid/sponsored/school/provider/tenant entitlement logic; do not copy exact pricing, plan names, bundle names, promotional copy, school contracts, tenant offers, or partner offers from iA Writer.
...
- Manual verification tests for no current Android distribution, iCloud/Dropbox/Drive provider behavior, Android legacy cloud connector failures, file-provider permissions, Markdown export fidelity, purchase restore, local file recovery, and platform feature differences.
...
- Phase 4: Add app-specific safety controls for focused Markdown writing, file-library organization, local and cloud-provider storage, export/preview, keyboard workflows, style/focus tooling, iCloud sync, and platform-specific purchase/subscription state.
...
- Confirm legal/privacy retention behavior for iA Writer-style sensitive records and update API contracts before downstream implementation.
