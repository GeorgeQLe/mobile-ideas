# OneNote-Style Clone Spec

> Metadata
> - Inspiration app: OneNote
...
> - Manual verification blockers: Microsoft account and tenant policy, OneDrive notebook sync conflicts, ink/audio/OCR fidelity, Samsung Notes integration, offline merge behavior, notebook sharing, coauthoring, permissions, and regional compliance.
...
Build an original mobile product inspired by OneNote's public productivity documents workflow. The V1 clone focuses on notebook creation, pages, ink, audio, scan/OCR capture, tags, search, sharing, OneDrive sync, offline notes, Samsung Notes integration, and Microsoft account or tenant entitlements.
...
- Preserve the functional job behind OneNote while using original product naming, original UI, original sample data, and licensed integrations.
...
- Do not copy OneNote branding, logos, screenshots, marketing copy, private APIs, proprietary datasets, plan names, UI trade dress, course libraries, textbook solutions, documents, school content, AI prompts, or protected media.
...
|---|---|---|---|
| Apple App Store | https://apps.apple.com/us/app/microsoft-onenote/id784801555 | iOS listing, privacy labels, OneNote claims, and support links | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
| Google Play | https://play.google.com/store/apps/details?id=com.microsoft.office.onenote | Android listing, data safety, OneNote capture/sync claims, and release cadence | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
| Official product site | https://www.onenote.com/ | OneNote notebooks, sync, capture, and product positioning | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
| Official support | https://support.microsoft.com/onenote | OneNote mobile, notebooks, sharing, sync, account, and troubleshooting | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
...
- Manual blockers must remain launch-blocking until verified: Microsoft account and tenant policy, OneDrive notebook sync conflicts, ink/audio/OCR fidelity, Samsung Notes integration, offline merge behavior, notebook sharing, coauthoring, permissions, and regional compliance.

## Core User Journeys

- User creates or restores a OneNote-style account, completes role, school, subscription, or tenant checks, and reaches the dashboard.
...
- Monetization model: use original free/trial/paid/sponsored/school/provider/tenant entitlement logic; do not copy exact pricing, plan names, bundle names, promotional copy, school contracts, tenant offers, or partner offers from OneNote.
...
- Manual verification tests for Microsoft account and tenant policy, OneDrive notebook sync conflicts, ink/audio/OCR fidelity, Samsung Notes integration, offline merge behavior, notebook sharing, coauthoring, permissions, and regional compliance.
...
- Phase 4: Add app-specific safety controls for notebook creation, pages, ink, audio, scan/OCR capture, tags, search, sharing, OneDrive sync, offline notes, Samsung Notes integration, and Microsoft account or tenant entitlements.
...
- Confirm legal/privacy retention behavior for OneNote-style sensitive records and update API contracts before downstream implementation.
