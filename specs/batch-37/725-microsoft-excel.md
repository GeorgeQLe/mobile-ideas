# Microsoft Excel-Style Clone Spec

> Metadata
> - Inspiration app: Microsoft Excel
...
> - Manual verification blockers: formula fidelity, chart rendering, OneDrive sync conflicts, Copilot eligibility, subscription restore, XLSX/PDF fidelity, coauthoring, protected workbooks, link sharing, permissions, and tenant compliance.
...
Build an original mobile product inspired by Microsoft Excel's public productivity documents workflow. The V1 clone focuses on spreadsheet creation and editing, formulas, charts, tables, PDF/export actions, OneDrive files, Microsoft 365 sharing, offline drafts, Copilot-assisted analysis, and subscription entitlements.
...
- Preserve the functional job behind Microsoft Excel while using original product naming, original UI, original sample data, and licensed integrations.
...
- Do not copy Microsoft Excel branding, logos, screenshots, marketing copy, private APIs, proprietary datasets, plan names, UI trade dress, course libraries, textbook solutions, documents, school content, AI prompts, or protected media.
...
|---|---|---|---|
| Apple App Store | https://apps.apple.com/us/app/microsoft-excel/id586683407 | iOS listing, privacy labels, Excel claims, subscriptions, and support links | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
| Google Play | https://play.google.com/store/apps/details?id=com.microsoft.office.excel | Android listing, data safety, Excel feature claims, and release cadence | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
| Official product site | https://www.microsoft.com/microsoft-365/excel | Excel editor, formulas, templates, Copilot, and subscription positioning | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
| Official support | https://support.microsoft.com/excel | Excel mobile, formulas, sharing, account, subscriptions, and troubleshooting | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
...
- Manual blockers must remain launch-blocking until verified: formula fidelity, chart rendering, OneDrive sync conflicts, Copilot eligibility, subscription restore, XLSX/PDF fidelity, coauthoring, protected workbooks, link sharing, permissions, and tenant compliance.

## Core User Journeys

- User creates or restores a Microsoft Excel-style account, completes role, school, subscription, or tenant checks, and reaches the dashboard.
...
- Monetization model: use original free/trial/paid/sponsored/school/provider/tenant entitlement logic; do not copy exact pricing, plan names, bundle names, promotional copy, school contracts, tenant offers, or partner offers from Microsoft Excel.
...
- Manual verification tests for formula fidelity, chart rendering, OneDrive sync conflicts, Copilot eligibility, subscription restore, XLSX/PDF fidelity, coauthoring, protected workbooks, link sharing, permissions, and tenant compliance.
...
- Phase 4: Add app-specific safety controls for spreadsheet creation and editing, formulas, charts, tables, PDF/export actions, OneDrive files, Microsoft 365 sharing, offline drafts, Copilot-assisted analysis, and subscription entitlements.
...
- Confirm legal/privacy retention behavior for Microsoft Excel-style sensitive records and update API contracts before downstream implementation.
