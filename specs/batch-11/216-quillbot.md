...
Build an original mobile AI assistant inspired by QuillBot's public product and policy materials. V1 focuses on paraphrasing, grammar checking, summarization, citation/writing tools, history, uploads, and premium limits. The clone must use original branding, original UI copy, original sample prompts, licensed providers, and explicit disclosures when a feature is inferred from public materials rather than verified hands-on behavior.
...
- Do not imply affiliation with QuillBot or its publisher.
...
|---|---|---|---|
| Official product | https://quillbot.com/ | Writing tools product surface, paraphraser, grammar, summarizer, and premium positioning | Verified 2026-05-03 |
| Help center | https://help.quillbot.com/ | Public support taxonomy for product use, accounts, subscriptions, and troubleshooting | Verified 2026-05-03 |
| Privacy policy | https://quillbot.com/privacy | Text, uploads, account, device, analytics, and retention handling | Verified 2026-05-03 |
| Terms of service | https://quillbot.com/terms | Generated output, acceptable use, subscriptions, and legal boundaries | Verified 2026-05-03 |
...
- academic integrity boundaries, uploaded document privacy, plagiarism/citation disclaimers, rewrite quality, and subscription metering.
