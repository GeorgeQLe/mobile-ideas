...
Build an original mobile AI assistant inspired by Wysa's public product and policy materials. V1 focuses on AI-guided mental wellbeing chat, coaching exercises, mood check-ins, journaling, therapist/escalation pathways, and subscription gates. The clone must use original branding, original UI copy, original sample prompts, licensed providers, and explicit disclosures when a feature is inferred from public materials rather than verified hands-on behavior.
...
- Do not imply affiliation with Wysa or its publisher.
...
|---|---|---|---|
| Official product | https://www.wysa.com/ | Mental wellbeing product surface, AI chat, exercises, coaching, and plan positioning | Verified 2026-05-03 |
| Privacy policy | https://www.wysa.com/privacy-policy | Sensitive wellbeing, account, device, support, and retention data handling | Verified 2026-05-03 |
| Terms of use | https://www.wysa.com/terms | Wellbeing scope, emergency disclaimers, subscriptions, and legal boundaries | Verified 2026-05-03 |
| Help / Support | https://www.wysa.com/contact | Public support and escalation contact surface | Verified 2026-05-03 |
...
- mental-health crisis routing, non-medical-device disclaimers, sensitive journal/mood data, age gates, therapist handoff, and regulated claims.
