...
Build an original mobile AI assistant inspired by Pi's public product and policy materials. V1 focuses on supportive conversational assistant, voice-style dialogue, memory/history, account recovery, and wellbeing-adjacent safety boundaries. The clone must use original branding, original UI copy, original sample prompts, licensed providers, and explicit disclosures when a feature is inferred from public materials rather than verified hands-on behavior.
...
- Do not imply affiliation with Pi or its publisher.
...
|---|---|---|---|
| Official product | https://pi.ai/talk | Public Pi chat entry and conversational assistant positioning | Verified 2026-05-03 |
| Company site | https://inflection.ai/ | Provider identity and public product context | Verified 2026-05-03 |
| Privacy policy | https://inflection.ai/policies/privacy-policy | Conversation, account, device, and retention data handling | Verified 2026-05-03 |
| Terms of service | https://inflection.ai/policies/terms-of-service | Acceptable use, AI output, service scope, and safety boundaries | Verified 2026-05-03 |
...
- wellbeing-adjacent conversation safety, crisis escalation, memory controls, voice retention, and unsupported medical/mental-health advice.
