...
Build an original mobile AI assistant inspired by Ask AI's public product and policy materials. V1 focuses on consumer AI chat, prompt templates, image/file input where supported, conversation history, voice input, and subscription gates. The clone must use original branding, original UI copy, original sample prompts, licensed providers, and explicit disclosures when a feature is inferred from public materials rather than verified hands-on behavior.
...
- Do not imply affiliation with Ask AI or its publisher.
...
|---|---|---|---|
| Official product | https://askaichat.app/ | Consumer Ask AI product surface and assistant positioning | Verified 2026-05-03 |
| Developer site | https://codeway.co/ | Publisher identity and product portfolio context | Verified 2026-05-03 |
| Privacy policy | https://codeway.co/privacy-policy | Account, prompt, device, analytics, advertising, and retention handling | Verified 2026-05-03 |
| Terms of use | https://codeway.co/terms-of-use | Subscription, generated output, acceptable use, and legal boundaries | Verified 2026-05-03 |
...
- publisher/app identity verification, ad/analytics SDK data flow, prompt template safety, paid subscription restore, and marketplace-only behavior.
