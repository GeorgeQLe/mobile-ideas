...
Build an original mobile AI assistant inspired by Monica's public product and policy materials. V1 focuses on AI assistant across chat, writing, summarization, translation, browser/mobile context, file input, and premium limits. The clone must use original branding, original UI copy, original sample prompts, licensed providers, and explicit disclosures when a feature is inferred from public materials rather than verified hands-on behavior.
...
- Do not imply affiliation with Monica or its publisher.
...
|---|---|---|---|
| Official product | https://monica.im/ | Monica AI assistant product surface, chat/writing/summarization tools, and paid positioning | Verified 2026-05-03 |
| Help center | https://help.monica.im/ | Public support taxonomy for account, subscriptions, product use, and troubleshooting | Verified 2026-05-03 |
| Privacy policy | https://monica.im/privacy | Prompt, account, browser/page context, files, device, and retention handling | Verified 2026-05-03 |
| Terms of service | https://monica.im/terms | Generated output, acceptable use, subscriptions, and service boundaries | Verified 2026-05-03 |
...
- browser/page context capture, file privacy, extension-to-mobile data sync, translation/summarization accuracy, and paid quota transparency.
