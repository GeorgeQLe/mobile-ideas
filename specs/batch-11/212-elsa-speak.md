...
Build an original mobile AI assistant inspired by ELSA Speak's public product and policy materials. V1 focuses on AI pronunciation coaching, speech recording, lessons, scores, progress tracking, curriculum paths, and subscription gates. The clone must use original branding, original UI copy, original sample prompts, licensed providers, and explicit disclosures when a feature is inferred from public materials rather than verified hands-on behavior.
...
- Do not imply affiliation with ELSA Speak or its publisher.
...
|---|---|---|---|
| Official product | https://elsaspeak.com/ | Language-learning product surface, speech scoring, lessons, and subscription positioning | Verified 2026-05-03 |
| Help center | https://support.elsaspeak.com/hc/en-us | Public support taxonomy for accounts, lessons, subscriptions, and troubleshooting | Verified 2026-05-03 |
| Privacy policy | https://elsaspeak.com/privacy | Voice/audio, account, learning progress, device, and retention context | Verified 2026-05-03 |
| Terms of service | https://elsaspeak.com/terms | Subscription, user content, acceptable use, and legal boundaries | Verified 2026-05-03 |
...
- microphone consent, audio retention, speech-score explainability, child/education use, accent bias, and offline lesson availability.
