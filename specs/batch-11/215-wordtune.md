...
Build an original mobile AI assistant inspired by Wordtune's public product and policy materials. V1 focuses on AI rewrite assistant, tone/length transforms, summarization, writing templates, document context, and premium usage limits. The clone must use original branding, original UI copy, original sample prompts, licensed providers, and explicit disclosures when a feature is inferred from public materials rather than verified hands-on behavior.
...
- Do not imply affiliation with Wordtune or its publisher.
...
|---|---|---|---|
| Official product | https://www.wordtune.com/ | Writing assistant product surface, rewrite, summarize, and AI writing positioning | Verified 2026-05-03 |
| Help center | https://support.wordtune.com/ | Public support taxonomy for accounts, subscriptions, product use, and troubleshooting | Verified 2026-05-03 |
| Privacy policy | https://www.wordtune.com/privacy | Text, account, device, analytics, and retention handling | Verified 2026-05-03 |
| Terms of service | https://www.wordtune.com/terms | Generated output, subscriptions, acceptable use, and legal boundaries | Verified 2026-05-03 |
...
- document/text privacy, academic integrity controls, hallucination in summaries, attribution, plan limits, and workspace/admin policies.
