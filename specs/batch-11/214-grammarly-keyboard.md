...
Build an original mobile AI assistant inspired by Grammarly Keyboard's public product and policy materials. V1 focuses on mobile keyboard writing assistant, grammar suggestions, tone rewrites, full-access keyboard privacy, dictionary, and premium gates. The clone must use original branding, original UI copy, original sample prompts, licensed providers, and explicit disclosures when a feature is inferred from public materials rather than verified hands-on behavior.
...
- Do not imply affiliation with Grammarly Keyboard or its publisher.
...
|---|---|---|---|
| Official product | https://www.grammarly.com/keyboard | Mobile keyboard product surface, writing suggestions, and premium positioning | Verified 2026-05-03 |
| Support | https://support.grammarly.com/ | Public support taxonomy for mobile keyboard, account, billing, and troubleshooting | Verified 2026-05-03 |
| Privacy policy | https://www.grammarly.com/privacy-policy | Text input, account, device, product telemetry, and retention handling | Verified 2026-05-03 |
| Terms of service | https://www.grammarly.com/terms | User content, subscriptions, acceptable use, and service boundaries | Verified 2026-05-03 |
...
- keyboard full-access disclosure, sensitive-field suppression, local/remote text processing, suggestion attribution, and enterprise policy controls.
