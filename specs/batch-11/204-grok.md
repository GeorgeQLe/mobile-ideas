...
Build an original mobile AI assistant inspired by Grok's public product and policy materials. V1 focuses on assistant chat, image understanding/generation, voice conversation, X/xAI account integration, history, and paid access gates. The clone must use original branding, original UI copy, original sample prompts, licensed providers, and explicit disclosures when a feature is inferred from public materials rather than verified hands-on behavior.
...
- Do not imply affiliation with Grok or its publisher.
...
|---|---|---|---|
| Official product | https://grok.com/ | Public Grok product surface for assistant chat, media input, voice, and account entry | Verified 2026-05-03 |
| xAI | https://x.ai/ | Provider identity and public product orientation | Verified 2026-05-03 |
| xAI Privacy Policy | https://x.ai/legal/privacy-policy | Account, prompt, usage, media, and support data handling | Verified 2026-05-03 |
| xAI Terms of Service | https://x.ai/legal/terms-of-service | Legal, acceptable-use, generated-output, and service-boundary terms | Verified 2026-05-03 |
...
- media generation abuse, X account linkage, sexual/deepfake safety controls, prompt/media retention, and paid tier availability.
