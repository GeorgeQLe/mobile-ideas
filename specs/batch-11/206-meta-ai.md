...
Build an original mobile AI assistant inspired by Meta AI's public product and policy materials. V1 focuses on assistant chat, image generation, search-style answers, Meta account surfaces, cross-app entry points, and conversation history. The clone must use original branding, original UI copy, original sample prompts, licensed providers, and explicit disclosures when a feature is inferred from public materials rather than verified hands-on behavior.
...
- Do not imply affiliation with Meta AI or its publisher.
...
|---|---|---|---|
| Official product | https://www.meta.ai/ | Meta AI public assistant surface and feature orientation | Verified 2026-05-03 |
| Meta Privacy Policy | https://www.facebook.com/privacy/policy/ | Meta account, AI, device, ads, and cross-service data handling | Verified 2026-05-03 |
| Meta Terms | https://www.facebook.com/legal/terms | Service terms, user content, acceptable use, and platform boundaries | Verified 2026-05-03 |
| Meta AI Information | https://www.facebook.com/help/236218699857484 | Public help orientation for Meta AI availability and controls | Verified 2026-05-03 |
...
- Meta account linkage, social graph and ads data separation, image-generation moderation, cross-app availability, and memory/history controls.
