...
Build an original mobile AI assistant inspired by OtterPilot's public product and policy materials. V1 focuses on AI meeting assistant, recording, live transcription, summaries, speaker labels, calendar joins, sharing, and workspace plan gates. The clone must use original branding, original UI copy, original sample prompts, licensed providers, and explicit disclosures when a feature is inferred from public materials rather than verified hands-on behavior.
...
- Do not imply affiliation with OtterPilot or its publisher.
...
|---|---|---|---|
| Official product | https://otter.ai/ | Meeting assistant, transcription, summary, calendar, and collaboration positioning | Verified 2026-05-03 |
| Help center | https://help.otter.ai/hc/en-us | Public support taxonomy for recording, import, calendar, sharing, billing, and account controls | Verified 2026-05-03 |
| Privacy policy | https://otter.ai/privacy-policy | Audio, transcript, calendar, account, device, and retention handling | Verified 2026-05-03 |
| Terms of service | https://otter.ai/terms | Recording consent, subscriptions, workspace use, generated output, and legal boundaries | Verified 2026-05-03 |
...
- recording consent by jurisdiction, calendar OAuth scopes, meeting-bot joins, transcript sharing, speaker diarization errors, and retention/export/delete.
