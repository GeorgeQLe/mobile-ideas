...
Build an original mobile AI assistant inspired by Poe's public product and policy materials. V1 focuses on multi-model assistant chat, bot discovery, creator bots, attachments, prompt history, model routing, and subscription usage limits. The clone must use original branding, original UI copy, original sample prompts, licensed providers, and explicit disclosures when a feature is inferred from public materials rather than verified hands-on behavior.
...
- Do not imply affiliation with Poe or its publisher.
...
|---|---|---|---|
| Official product | https://poe.com/ | Product surface for AI chat, bot discovery, model access, accounts, and subscriptions | Verified 2026-05-03 |
| Help center | https://help.poe.com/ | Public support taxonomy for accounts, bots, subscriptions, safety, and troubleshooting | Verified 2026-05-03 |
| Privacy policy | https://poe.com/privacy | Prompt, account, usage, device, support, and retention posture | Verified 2026-05-03 |
| Terms of service | https://poe.com/terms | Acceptable use, subscriptions, user content, bots, and legal boundaries | Verified 2026-05-03 |
...
- bot marketplace moderation, creator attribution, model-provider routing, prompt/attachment retention, and paid usage-meter transparency.
