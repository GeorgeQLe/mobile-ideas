...
Build an original mobile AI assistant inspired by Gemini's public product and policy materials. V1 focuses on assistant chat, Gemini Live-style voice sessions, file/image context, connected-app actions, conversation history, and Google-account controls. The clone must use original branding, original UI copy, original sample prompts, licensed providers, and explicit disclosures when a feature is inferred from public materials rather than verified hands-on behavior.
...
- Do not imply affiliation with Gemini or its publisher.
...
|---|---|---|---|
| Official product | https://gemini.google.com/ | Web/mobile Gemini Apps entry point and consumer assistant positioning | Verified 2026-05-03 |
| Gemini Apps Privacy Hub | https://support.google.com/gemini/answer/13594961 | Gemini Apps data handling, audio/video/screen sharing, retention, settings, and export context | Verified 2026-05-03 |
| Gemini Help | https://support.google.com/gemini/ | Public help taxonomy for Gemini Apps features, account controls, connected apps, and troubleshooting | Verified 2026-05-03 |
| Google Privacy Policy | https://policies.google.com/privacy | Google account, device, activity, and service-wide privacy framework | Verified 2026-05-03 |
| Google Terms | https://policies.google.com/terms | Service-wide legal and acceptable-use context | Verified 2026-05-03 |
...
- Google account data boundaries, connected-app scopes, audio/video/screen retention, regional availability, and hallucination disclaimers.
