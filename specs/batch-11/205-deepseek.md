...
Build an original mobile AI assistant inspired by DeepSeek's public product and policy materials. V1 focuses on reasoning assistant chat, code/math workflows, conversation history, attachments where supported, and account-level usage limits. The clone must use original branding, original UI copy, original sample prompts, licensed providers, and explicit disclosures when a feature is inferred from public materials rather than verified hands-on behavior.
...
- Do not imply affiliation with DeepSeek or its publisher.
...
|---|---|---|---|
| Official product | https://www.deepseek.com/ | Public DeepSeek product orientation and model/service positioning | Verified 2026-05-03 |
| Chat surface | https://chat.deepseek.com/ | Consumer chat entry point and account-gated assistant workflow | Verified 2026-05-03 |
| Privacy policy | https://cdn.deepseek.com/policies/en-US/deepseek-privacy-policy.html | Prompt, account, device, usage, and retention context | Verified 2026-05-03 |
| Terms of use | https://cdn.deepseek.com/policies/en-US/deepseek-terms-of-use.html | Acceptable use, service limits, generated output, and legal scope | Verified 2026-05-03 |
...
- cross-border data handling, reasoning-output trust boundaries, code-generation safety, account availability, and outage/degraded-mode behavior.
