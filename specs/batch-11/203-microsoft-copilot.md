...
Build an original mobile AI assistant inspired by Microsoft Copilot's public product and policy materials. V1 focuses on consumer AI chat, image generation, voice chat, web answers, Microsoft account continuity, and entitlement gates. The clone must use original branding, original UI copy, original sample prompts, licensed providers, and explicit disclosures when a feature is inferred from public materials rather than verified hands-on behavior.
...
- Do not imply affiliation with Microsoft Copilot or its publisher.
...
|---|---|---|---|
| Official product | https://copilot.microsoft.com/ | Consumer Copilot product surface, chat, voice, and image-generation positioning | Verified 2026-05-03 |
| Copilot Help | https://support.microsoft.com/copilot | Public support taxonomy for Copilot usage, account, privacy, and troubleshooting | Verified 2026-05-03 |
| Microsoft Privacy Statement | https://privacy.microsoft.com/privacystatement | Microsoft account, AI, device, service, and support data handling | Verified 2026-05-03 |
| Microsoft Services Agreement | https://www.microsoft.com/servicesagreement | Consumer service terms, AI services boundaries, and acceptable use | Verified 2026-05-03 |
...
- consumer-vs-work account boundaries, web-grounded answer citations, image-safety controls, Microsoft account telemetry, and subscription limits.
