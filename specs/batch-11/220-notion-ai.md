...
Build an original mobile AI assistant inspired by Notion AI's public product and policy materials. V1 focuses on workspace AI writing, Q&A over workspace content, summaries, meeting notes, database/page actions, search, and workspace plan gates. The clone must use original branding, original UI copy, original sample prompts, licensed providers, and explicit disclosures when a feature is inferred from public materials rather than verified hands-on behavior.
...
- Do not imply affiliation with Notion AI or its publisher.
...
|---|---|---|---|
| Official product | https://www.notion.com/product/ai | Notion AI product surface for workspace writing, Q&A, summaries, and connected workflows | Verified 2026-05-03 |
| Help center | https://www.notion.com/help/notion-ai | Public help details for Notion AI usage, limits, workspace behavior, and controls | Verified 2026-05-03 |
| Privacy policy | https://www.notion.com/privacy | Workspace content, account, device, analytics, subprocessors, and retention handling | Verified 2026-05-03 |
| Terms of service | https://www.notion.com/terms | Workspace content, AI features, subscriptions, acceptable use, and legal boundaries | Verified 2026-05-03 |
...
- workspace permission scoping, enterprise/admin controls, page/database write authorization, connected content retrieval, and AI add-on billing.
