...
- Do not imply affiliation with Singapore Airlines or its publisher.
...
|---|---|---|---|
| Official product/app page | https://www.singaporeair.com/en_UK/us/mobile-app/ | Public mobile-app positioning, trip workflow, booking/check-in surfaces, loyalty framing, support entry points, and app capability claims | Verified 2026-05-04 |
| Support/help center | https://www.singaporeair.com/en_UK/us/contact-us/ | Public support taxonomy for booking, trips, check-in, seats, bags, disruption, refunds, loyalty, accessibility, and account lifecycle flows | Verified 2026-05-04 |
| Privacy policy | https://www.singaporeair.com/en_UK/privacy-policy/ | Passenger, contact, payment, travel-document, location, device, analytics, support, retention, and privacy-rights handling | Verified 2026-05-04 |
| Terms / contract of carriage | https://www.singaporeair.com/en_UK/conditions-of-use/ | Passenger obligations, ticketing, check-in, baggage, refunds, delays/cancellations, liability, and legal boundaries | Verified 2026-05-04 |
| Legal/customer commitment | https://www.singaporeair.com/en_UK/legal/ | Accessibility, customer commitment, operational-disruption, refund, passenger-rights, and legal notice framing | Verified 2026-05-04 |
| App Store listing | https://apps.apple.com/us/app/singapore-airlines/id515287841 | Canonical iOS listing, category, age rating, privacy label, compatibility, public feature claims, and native metadata | Verified 2026-05-04 |
| Google Play listing | https://play.google.com/store/apps/details?id=com.amadeus.merci.client.ui | Canonical Android listing, feature blurbs, content rating, data safety, downloads, and native metadata | Verified 2026-05-04 |
...
- Returning user signs in, views KrisFlyer status, retrieves an upcoming trip, and sees current flight and check-in readiness.
...
- Public API documentation must use original route names and domain models; never mimic private endpoint paths, request bodies, fare logic, loyalty logic, or proprietary schemas from Singapore Airlines.
