...
- Do not imply affiliation with Lufthansa or its publisher.
...
|---|---|---|---|
| Official product/app page | https://www.lufthansa.com/us/en/lufthansa-app | Public mobile-app positioning, trip workflow, booking/check-in surfaces, loyalty framing, support entry points, and app capability claims | Verified 2026-05-04 |
| Support/help center | https://www.lufthansa.com/us/en/help-and-contact | Public support taxonomy for booking, trips, check-in, seats, bags, disruption, refunds, loyalty, accessibility, and account lifecycle flows | Verified 2026-05-04 |
| Privacy policy | https://www.lufthansa.com/us/en/privacy-statement | Passenger, contact, payment, travel-document, location, device, analytics, support, retention, and privacy-rights handling | Verified 2026-05-04 |
| Terms / contract of carriage | https://www.lufthansa.com/us/en/conditions-of-carriage | Passenger obligations, ticketing, check-in, baggage, refunds, delays/cancellations, liability, and legal boundaries | Verified 2026-05-04 |
| Legal/customer commitment | https://www.lufthansa.com/us/en/legal-information | Accessibility, customer commitment, operational-disruption, refund, passenger-rights, and legal notice framing | Verified 2026-05-04 |
| App Store listing | https://apps.apple.com/us/app/lufthansa/id299219152 | Canonical iOS listing, category, age rating, privacy label, compatibility, public feature claims, and native metadata | Verified 2026-05-04 |
| Google Play listing | https://play.google.com/store/apps/details?id=com.lufthansa.android.lufthansa | Canonical Android listing, feature blurbs, content rating, data safety, downloads, and native metadata | Verified 2026-05-04 |
...
- Returning user signs in, views Miles & More status, retrieves an upcoming trip, and sees current flight and check-in readiness.
...
- Public API documentation must use original route names and domain models; never mimic private endpoint paths, request bodies, fare logic, loyalty logic, or proprietary schemas from Lufthansa.
