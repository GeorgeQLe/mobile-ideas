...
> - Research state: 42 implementation-ready public-source V1 specs; 58 Draft 1 scaffolds still require exact first-party source replacement and hands-on verification blockers

## Overview

This directory contains technical specs for all 100 mobile app clone ideas in `tasks/ideas.md`. Most specs are canonical Draft 1 scaffolds; 42 upgraded specs are implementation-ready public-source V1 specs.
