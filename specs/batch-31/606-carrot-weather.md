# CARROT Weather-Style Clone Spec

> Metadata
> - Inspiration app: CARROT Weather
...
> - Manual verification blockers: weather source switching, personality settings, achievements, premium tier restoration, widgets/watch surfaces, radar playback, location prompts, push alerts, and regional source availability require lawful test evidence before one-for-one native parity claims.
> - Legal scope: functional parity only; use original code, brand, copy, iconography, sample data, media, policies, and integrations.

## Overview

Build an original mobile product inspired by CARROT Weather's public user-facing workflow. The clone focus is personality-driven forecasts, weather source selection, radar maps, alerts, widgets, Apple Watch-style surfaces, achievements, premium tiers, and privacy controls. This public-source V1 spec is implementation-ready for an original build, but every behavior marked `Manual verification required` must remain behind a documented blocker until lawful hands-on evidence confirms the exact native behavior.
...
- Do not copy CARROT Weather branding, logos, screenshots, marketing copy, private APIs, proprietary datasets, ranking systems, route algorithms, or protected media.
...
|---|---|---|---|
| Apple App Store listing | https://apps.apple.com/us/app/carrot-weather-alerts-radar/id961390574 | iOS listing, category, age rating, privacy labels, release notes, support links | Public source verified |
| Google Play listing | https://play.google.com/store/apps/details?id=com.grailr.carrotweather | Android listing, content rating, data safety, feature blurbs, update cadence | Public source verified |
| Official product site | https://www.meetcarrot.com/weather/ | Public product orientation for personality-driven forecasts, weather source selection, radar maps, alerts, widgets, Apple Watch-style surfaces, achievements, premium tiers, and privacy controls | Public source verified |
| Help/support center | https://support.meetcarrot.com/ | Support taxonomy, account, subscriptions, alerts, saved items, provider handoff, contact, privacy, and recovery flows | Public source verified |
| Privacy policy | https://www.meetcarrot.com/privacy/ | Personal data, location, payment, analytics, retention, export, deletion, and regional privacy rights | Public source verified |
| Terms/legal terms | https://www.meetcarrot.com/terms/ | Eligibility, acceptable use, subscription or lead terms, cancellation, liability, content, and regional service constraints | Public source verified |
...
- Manual verification required: weather source switching, personality settings, achievements, premium tier restoration, widgets/watch surfaces, radar playback, location prompts, push alerts, and regional source availability.
...
|---|---|---|---|---|
| Forecast Home | Core discovery and decision flow | taps, forms, filters, map gestures, deep links, permissions | empty, loading, loaded, signed-out, saved, unavailable | denied permission, stale inventory, offline, region-locked, provider error, blocked entitlement |
...
| Alert Builder | Transaction, live state, or management flow | taps, forms, filters, map gestures, deep links, permissions | empty, loading, loaded, signed-out, saved, unavailable | denied permission, stale inventory, offline, region-locked, provider error, blocked entitlement |
| Weather Sources | Transaction, live state, or management flow | taps, forms, filters, map gestures, deep links, permissions | empty, loading, loaded, signed-out, saved, unavailable | denied permission, stale inventory, offline, region-locked, provider error, blocked entitlement |
| Widgets | Transaction, live state, or management flow | taps, forms, filters, map gestures, deep links, permissions | empty, loading, loaded, signed-out, saved, unavailable | denied permission, stale inventory, offline, region-locked, provider error, blocked entitlement |
| Achievements | Transaction, live state, or management flow | taps, forms, filters, map gestures, deep links, permissions | empty, loading, loaded, signed-out, saved, unavailable | denied permission, stale inventory, offline, region-locked, provider error, blocked entitlement |
| Locations | Trust, account, recovery, or support flow | taps, forms, filters, map gestures, deep links, permissions | empty, loading, loaded, signed-out, saved, unavailable | denied permission, stale inventory, offline, region-locked, provider error, blocked entitlement |
...
- `ForecastLocation`: stores lifecycle state, ownership, source provenance, authorization rules, sync status, deletion/export treatment, and audit metadata for CARROT Weather-style workflows.
- `WeatherSource`: stores lifecycle state, ownership, source provenance, authorization rules, sync status, deletion/export treatment, and audit metadata for CARROT Weather-style workflows.
- `HourlyForecast`: stores lifecycle state, ownership, source provenance, authorization rules, sync status, deletion/export treatment, and audit metadata for CARROT Weather-style workflows.
- `DailyForecast`: stores lifecycle state, ownership, source provenance, authorization rules, sync status, deletion/export treatment, and audit metadata for CARROT Weather-style workflows.
- `RadarLayer`: stores lifecycle state, ownership, source provenance, authorization rules, sync status, deletion/export treatment, and audit metadata for CARROT Weather-style workflows.
- `WeatherAlert`: stores lifecycle state, ownership, source provenance, authorization rules, sync status, deletion/export treatment, and audit metadata for CARROT Weather-style workflows.
- `WidgetConfig`: stores lifecycle state, ownership, source provenance, authorization rules, sync status, deletion/export treatment, and audit metadata for CARROT Weather-style workflows.
- `Achievement`: stores lifecycle state, ownership, source provenance, authorization rules, sync status, deletion/export treatment, and audit metadata for CARROT Weather-style workflows.
- `SubscriptionEntitlement`: stores lifecycle state, ownership, source provenance, authorization rules, sync status, deletion/export treatment, and audit metadata for CARROT Weather-style workflows.
- `PersonalitySetting`: stores lifecycle state, ownership, source provenance, authorization rules, sync status, deletion/export treatment, and audit metadata for CARROT Weather-style workflows.
...
- Manual verification checklist tests for weather source switching, personality settings, achievements, premium tier restoration, widgets/watch surfaces, radar playback, location prompts, push alerts, and regional source availability.
...
- Phase 7: Conduct lawful hands-on verification for weather source switching, personality settings, achievements, premium tier restoration, widgets/watch surfaces, radar playback, location prompts, push alerts, and regional source availability, then update this spec with evidence before any one-for-one parity claim.
