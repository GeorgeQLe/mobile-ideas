# HotPads-Style Clone Spec

> Metadata
> - Inspiration app: HotPads
...
> - Manual verification blockers: rental listing freshness, landlord/contact routing, saved search alerts, scam/report workflows, application/deposit handoffs, fair-housing copy, location prompts, push alerts, and regional rental coverage require lawful test evidence before one-for-one native parity claims.
> - Legal scope: functional parity only; use original code, brand, copy, iconography, sample data, media, policies, and integrations.

## Overview

Build an original mobile product inspired by HotPads's public user-facing workflow. The clone focus is apartment and rental search, map/list comparison, filters, property details, landlord/contact workflows, saved searches, alerts, commute context, and trust/safety controls. This public-source V1 spec is implementation-ready for an original build, but every behavior marked `Manual verification required` must remain behind a documented blocker until lawful hands-on evidence confirms the exact native behavior.
...
- Do not copy HotPads branding, logos, screenshots, marketing copy, private APIs, proprietary datasets, ranking systems, route algorithms, or protected media.
...
|---|---|---|---|
| Apple App Store listing | https://apps.apple.com/us/app/hotpads-apartment-rentals/id345957475 | iOS listing, category, age rating, privacy labels, release notes, support links | Public source verified |
| Google Play listing | https://play.google.com/store/apps/details?id=com.hotpads.mobile | Android listing, content rating, data safety, feature blurbs, update cadence | Public source verified |
| Official product site | https://hotpads.com/ | Public product orientation for apartment and rental search, map/list comparison, filters, property details, landlord/contact workflows, saved searches, alerts, commute context, and trust/safety controls | Public source verified |
| Help/support center | https://help.hotpads.com/hc/en-us | Support taxonomy, account, subscriptions, alerts, saved items, provider handoff, contact, privacy, and recovery flows | Public source verified |
| Privacy policy | https://privacy.zillowgroup.com/ | Personal data, location, payment, analytics, retention, export, deletion, and regional privacy rights | Public source verified |
| Terms/legal terms | https://hotpads.com/terms | Eligibility, acceptable use, subscription or lead terms, cancellation, liability, content, and regional service constraints | Public source verified |
...
- Manual verification required: rental listing freshness, landlord/contact routing, saved search alerts, scam/report workflows, application/deposit handoffs, fair-housing copy, location prompts, push alerts, and regional rental coverage.
...
| Rental Detail | Core discovery and decision flow | taps, forms, filters, map gestures, deep links, permissions | empty, loading, loaded, signed-out, saved, unavailable | denied permission, stale inventory, offline, region-locked, provider error, blocked entitlement |
| Contact Landlord | Transaction, live state, or management flow | taps, forms, filters, map gestures, deep links, permissions | empty, loading, loaded, signed-out, saved, unavailable | denied permission, stale inventory, offline, region-locked, provider error, blocked entitlement |
...
| Commute | Transaction, live state, or management flow | taps, forms, filters, map gestures, deep links, permissions | empty, loading, loaded, signed-out, saved, unavailable | denied permission, stale inventory, offline, region-locked, provider error, blocked entitlement |
| Filters | Trust, account, recovery, or support flow | taps, forms, filters, map gestures, deep links, permissions | empty, loading, loaded, signed-out, saved, unavailable | denied permission, stale inventory, offline, region-locked, provider error, blocked entitlement |
...
- `RentalListing`: stores lifecycle state, ownership, source provenance, authorization rules, sync status, deletion/export treatment, and audit metadata for HotPads-style workflows.
- `ListingMedia`: stores lifecycle state, ownership, source provenance, authorization rules, sync status, deletion/export treatment, and audit metadata for HotPads-style workflows.
- `LandlordProfile`: stores lifecycle state, ownership, source provenance, authorization rules, sync status, deletion/export treatment, and audit metadata for HotPads-style workflows.
- `LeadRequest`: stores lifecycle state, ownership, source provenance, authorization rules, sync status, deletion/export treatment, and audit metadata for HotPads-style workflows.
- `SavedSearch`: stores lifecycle state, ownership, source provenance, authorization rules, sync status, deletion/export treatment, and audit metadata for HotPads-style workflows.
- `SavedRental`: stores lifecycle state, ownership, source provenance, authorization rules, sync status, deletion/export treatment, and audit metadata for HotPads-style workflows.
- `CommuteEstimate`: stores lifecycle state, ownership, source provenance, authorization rules, sync status, deletion/export treatment, and audit metadata for HotPads-style workflows.
- `FraudReport`: stores lifecycle state, ownership, source provenance, authorization rules, sync status, deletion/export treatment, and audit metadata for HotPads-style workflows.
- `NotificationPreference`: stores lifecycle state, ownership, source provenance, authorization rules, sync status, deletion/export treatment, and audit metadata for HotPads-style workflows.
- `ModerationReport`: stores lifecycle state, ownership, source provenance, authorization rules, sync status, deletion/export treatment, and audit metadata for HotPads-style workflows.
...
- Manual verification checklist tests for rental listing freshness, landlord/contact routing, saved search alerts, scam/report workflows, application/deposit handoffs, fair-housing copy, location prompts, push alerts, and regional rental coverage.
...
- Phase 7: Conduct lawful hands-on verification for rental listing freshness, landlord/contact routing, saved search alerts, scam/report workflows, application/deposit handoffs, fair-housing copy, location prompts, push alerts, and regional rental coverage, then update this spec with evidence before any one-for-one parity claim.
