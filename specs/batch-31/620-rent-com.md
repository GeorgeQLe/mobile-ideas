# Rent.com-Style Clone Spec

> Metadata
> - Inspiration app: Rent.com
...
> - Manual verification blockers: availability and price freshness, tour/contact lead routing, saved search alerts, rental applications/deposit handoffs, fair-housing copy, location prompts, push alerts, and regional listing coverage require lawful test evidence before one-for-one native parity claims.
> - Legal scope: functional parity only; use original code, brand, copy, iconography, sample data, media, policies, and integrations.

## Overview

Build an original mobile product inspired by Rent.com's public user-facing workflow. The clone focus is apartment and home rental search, map/list comparison, property detail pages, availability and pricing, tour/contact workflows, saved searches, alerts, renter tools, and trust/safety controls. This public-source V1 spec is implementation-ready for an original build, but every behavior marked `Manual verification required` must remain behind a documented blocker until lawful hands-on evidence confirms the exact native behavior.
...
- Do not copy Rent.com branding, logos, screenshots, marketing copy, private APIs, proprietary datasets, ranking systems, route algorithms, or protected media.
...
|---|---|---|---|
| Apple App Store listing | https://apps.apple.com/us/app/rent-apartments-and-homes/id388038507 | iOS listing, category, age rating, privacy labels, release notes, support links | Public source verified |
| Google Play listing | https://play.google.com/store/apps/details?id=com.rent | Android listing, content rating, data safety, feature blurbs, update cadence | Public source verified |
| Official product site | https://www.rent.com/ | Public product orientation for apartment and home rental search, map/list comparison, property detail pages, availability and pricing, tour/contact workflows, saved searches, alerts, renter tools, and trust/safety controls | Public source verified |
| Help/support center | https://help.rent.com/hc/en-us | Support taxonomy, account, subscriptions, alerts, saved items, provider handoff, contact, privacy, and recovery flows | Public source verified |
| Privacy policy | https://www.rent.com/privacy-policy | Personal data, location, payment, analytics, retention, export, deletion, and regional privacy rights | Public source verified |
| Terms/legal terms | https://www.rent.com/terms-of-service | Eligibility, acceptable use, subscription or lead terms, cancellation, liability, content, and regional service constraints | Public source verified |
...
- Manual verification required: availability and price freshness, tour/contact lead routing, saved search alerts, rental applications/deposit handoffs, fair-housing copy, location prompts, push alerts, and regional listing coverage.
...
|---|---|---|---|---|
| Rental Search | Core discovery and decision flow | taps, forms, filters, map gestures, deep links, permissions | empty, loading, loaded, signed-out, saved, unavailable | denied permission, stale inventory, offline, region-locked, provider error, blocked entitlement |
...
| Availability | Transaction, live state, or management flow | taps, forms, filters, map gestures, deep links, permissions | empty, loading, loaded, signed-out, saved, unavailable | denied permission, stale inventory, offline, region-locked, provider error, blocked entitlement |
| Tour/Contact | Transaction, live state, or management flow | taps, forms, filters, map gestures, deep links, permissions | empty, loading, loaded, signed-out, saved, unavailable | denied permission, stale inventory, offline, region-locked, provider error, blocked entitlement |
| Saved Rentals | Transaction, live state, or management flow | taps, forms, filters, map gestures, deep links, permissions | empty, loading, loaded, signed-out, saved, unavailable | denied permission, stale inventory, offline, region-locked, provider error, blocked entitlement |
...
| Renter Tools | Trust, account, recovery, or support flow | taps, forms, filters, map gestures, deep links, permissions | empty, loading, loaded, signed-out, saved, unavailable | denied permission, stale inventory, offline, region-locked, provider error, blocked entitlement |
...
- `RentalListing`: stores lifecycle state, ownership, source provenance, authorization rules, sync status, deletion/export treatment, and audit metadata for Rent.com-style workflows.
- `UnitAvailability`: stores lifecycle state, ownership, source provenance, authorization rules, sync status, deletion/export treatment, and audit metadata for Rent.com-style workflows.
- `ListingMedia`: stores lifecycle state, ownership, source provenance, authorization rules, sync status, deletion/export treatment, and audit metadata for Rent.com-style workflows.
- `PropertyManager`: stores lifecycle state, ownership, source provenance, authorization rules, sync status, deletion/export treatment, and audit metadata for Rent.com-style workflows.
- `LeadRequest`: stores lifecycle state, ownership, source provenance, authorization rules, sync status, deletion/export treatment, and audit metadata for Rent.com-style workflows.
- `TourRequest`: stores lifecycle state, ownership, source provenance, authorization rules, sync status, deletion/export treatment, and audit metadata for Rent.com-style workflows.
- `SavedSearch`: stores lifecycle state, ownership, source provenance, authorization rules, sync status, deletion/export treatment, and audit metadata for Rent.com-style workflows.
- `SavedRental`: stores lifecycle state, ownership, source provenance, authorization rules, sync status, deletion/export treatment, and audit metadata for Rent.com-style workflows.
- `AffordabilityEstimate`: stores lifecycle state, ownership, source provenance, authorization rules, sync status, deletion/export treatment, and audit metadata for Rent.com-style workflows.
- `FraudReport`: stores lifecycle state, ownership, source provenance, authorization rules, sync status, deletion/export treatment, and audit metadata for Rent.com-style workflows.
...
- Manual verification checklist tests for availability and price freshness, tour/contact lead routing, saved search alerts, rental applications/deposit handoffs, fair-housing copy, location prompts, push alerts, and regional listing coverage.
...
- Phase 7: Conduct lawful hands-on verification for availability and price freshness, tour/contact lead routing, saved search alerts, rental applications/deposit handoffs, fair-housing copy, location prompts, push alerts, and regional listing coverage, then update this spec with evidence before any one-for-one parity claim.
