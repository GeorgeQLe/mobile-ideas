# MyRadar-Style Clone Spec

> Metadata
> - Inspiration app: MyRadar
...
> - Manual verification blockers: radar animation timing, rain alert delivery, hurricane/aviation layers, premium layer restoration, widgets, location prompts, push alerts, and regional radar coverage require lawful test evidence before one-for-one native parity claims.
> - Legal scope: functional parity only; use original code, brand, copy, iconography, sample data, media, policies, and integrations.

## Overview

Build an original mobile product inspired by MyRadar's public user-facing workflow. The clone focus is animated radar maps, weather layers, aviation and hurricane overlays, rain alerts, saved locations, widgets, premium layers, and location privacy controls. This public-source V1 spec is implementation-ready for an original build, but every behavior marked `Manual verification required` must remain behind a documented blocker until lawful hands-on evidence confirms the exact native behavior.
...
- Do not copy MyRadar branding, logos, screenshots, marketing copy, private APIs, proprietary datasets, ranking systems, route algorithms, or protected media.
...
|---|---|---|---|
| Apple App Store listing | https://apps.apple.com/us/app/myradar-accurate-weather-radar/id322439990 | iOS listing, category, age rating, privacy labels, release notes, support links | Public source verified |
| Google Play listing | https://play.google.com/store/apps/details?id=com.acmeaom.android.myradar | Android listing, content rating, data safety, feature blurbs, update cadence | Public source verified |
| Official product site | https://myradar.com/ | Public product orientation for animated radar maps, weather layers, aviation and hurricane overlays, rain alerts, saved locations, widgets, premium layers, and location privacy controls | Public source verified |
| Help/support center | https://myradar.com/contact-us/ | Support taxonomy, account, subscriptions, alerts, saved items, provider handoff, contact, privacy, and recovery flows | Public source verified |
| Privacy policy | https://myradar.com/privacy-policy/ | Personal data, location, payment, analytics, retention, export, deletion, and regional privacy rights | Public source verified |
| Terms/legal terms | https://myradar.com/terms-of-use/ | Eligibility, acceptable use, subscription or lead terms, cancellation, liability, content, and regional service constraints | Public source verified |
...
- Manual verification required: radar animation timing, rain alert delivery, hurricane/aviation layers, premium layer restoration, widgets, location prompts, push alerts, and regional radar coverage.
...
|---|---|---|---|---|
| Radar Home | Core discovery and decision flow | taps, forms, filters, map gestures, deep links, permissions | empty, loading, loaded, signed-out, saved, unavailable | denied permission, stale inventory, offline, region-locked, provider error, blocked entitlement |
...
| Rain Alerts | Core discovery and decision flow | taps, forms, filters, map gestures, deep links, permissions | empty, loading, loaded, signed-out, saved, unavailable | denied permission, stale inventory, offline, region-locked, provider error, blocked entitlement |
...
| Aviation Layers | Transaction, live state, or management flow | taps, forms, filters, map gestures, deep links, permissions | empty, loading, loaded, signed-out, saved, unavailable | denied permission, stale inventory, offline, region-locked, provider error, blocked entitlement |
...
| Premium Layers | Trust, account, recovery, or support flow | taps, forms, filters, map gestures, deep links, permissions | empty, loading, loaded, signed-out, saved, unavailable | denied permission, stale inventory, offline, region-locked, provider error, blocked entitlement |
...
- `MapViewport`: stores lifecycle state, ownership, source provenance, authorization rules, sync status, deletion/export treatment, and audit metadata for MyRadar-style workflows.
- `RadarFrame`: stores lifecycle state, ownership, source provenance, authorization rules, sync status, deletion/export treatment, and audit metadata for MyRadar-style workflows.
- `WeatherLayer`: stores lifecycle state, ownership, source provenance, authorization rules, sync status, deletion/export treatment, and audit metadata for MyRadar-style workflows.
- `RainAlert`: stores lifecycle state, ownership, source provenance, authorization rules, sync status, deletion/export treatment, and audit metadata for MyRadar-style workflows.
- `StormTrack`: stores lifecycle state, ownership, source provenance, authorization rules, sync status, deletion/export treatment, and audit metadata for MyRadar-style workflows.
- `AviationOverlay`: stores lifecycle state, ownership, source provenance, authorization rules, sync status, deletion/export treatment, and audit metadata for MyRadar-style workflows.
- `SavedLocation`: stores lifecycle state, ownership, source provenance, authorization rules, sync status, deletion/export treatment, and audit metadata for MyRadar-style workflows.
- `WidgetConfig`: stores lifecycle state, ownership, source provenance, authorization rules, sync status, deletion/export treatment, and audit metadata for MyRadar-style workflows.
- `SubscriptionEntitlement`: stores lifecycle state, ownership, source provenance, authorization rules, sync status, deletion/export treatment, and audit metadata for MyRadar-style workflows.
- `NotificationPreference`: stores lifecycle state, ownership, source provenance, authorization rules, sync status, deletion/export treatment, and audit metadata for MyRadar-style workflows.
...
- Manual verification checklist tests for radar animation timing, rain alert delivery, hurricane/aviation layers, premium layer restoration, widgets, location prompts, push alerts, and regional radar coverage.
...
- Phase 7: Conduct lawful hands-on verification for radar animation timing, rain alert delivery, hurricane/aviation layers, premium layer restoration, widgets, location prompts, push alerts, and regional radar coverage, then update this spec with evidence before any one-for-one parity claim.
