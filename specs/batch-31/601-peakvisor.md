# PeakVisor-Style Clone Spec

> Metadata
> - Inspiration app: PeakVisor
...
> - Manual verification blockers: AR peak identification, GPS track recording, offline map downloads, route export, premium entitlement restoration, camera/location prompts, push alerts, slope and avalanche-terrain overlays, and regional trail coverage require lawful test evidence before one-for-one native parity claims.
> - Legal scope: functional parity only; use original code, brand, copy, iconography, sample data, media, policies, and integrations.

## Overview

Build an original mobile product inspired by PeakVisor's public user-facing workflow. The clone focus is 3D mountain maps, peak identification, hiking and ski route planning, offline map access, GPS tracks, AR camera orientation, terrain layers, saved routes, subscriptions, and outdoor safety disclaimers. This public-source V1 spec is implementation-ready for an original build, but every behavior marked `Manual verification required` must remain behind a documented blocker until lawful hands-on evidence confirms the exact native behavior.
...
- Do not copy PeakVisor branding, logos, screenshots, marketing copy, private APIs, proprietary datasets, ranking systems, route algorithms, or protected media.
...
|---|---|---|---|
| Apple App Store listing | https://apps.apple.com/us/app/hiking-and-skiing-peakvisor/id1187259191 | iOS listing, category, age rating, privacy labels, release notes, support links | Public source verified |
| Google Play listing | https://play.google.com/store/apps/details?id=tips.routes.peakvisor | Android listing, content rating, data safety, feature blurbs, update cadence | Public source verified |
| Official product site | https://peakvisor.com/ | Public product orientation for 3D mountain maps, peak identification, hiking and ski route planning, offline map access, GPS tracks, AR camera orientation, terrain layers, saved routes, subscriptions, and outdoor safety disclaimers | Public source verified |
| Help/support center | https://peakvisor.com/en/faq.html | Support taxonomy, account, subscriptions, alerts, saved items, provider handoff, contact, privacy, and recovery flows | Public source verified |
| Privacy policy | https://peakvisor.com/en/privacy.html | Personal data, location, payment, analytics, retention, export, deletion, and regional privacy rights | Public source verified |
| Terms/legal terms | https://peakvisor.com/en/terms.html | Eligibility, acceptable use, subscription or lead terms, cancellation, liability, content, and regional service constraints | Public source verified |
...
- Manual verification required: AR peak identification, GPS track recording, offline map downloads, route export, premium entitlement restoration, camera/location prompts, push alerts, slope and avalanche-terrain overlays, and regional trail coverage.
...
|---|---|---|---|---|
| Discover Mountains | Core discovery and decision flow | taps, forms, filters, map gestures, deep links, permissions | empty, loading, loaded, signed-out, saved, unavailable | denied permission, stale inventory, offline, region-locked, provider error, blocked entitlement |
| AR Peak Finder | Core discovery and decision flow | taps, forms, filters, map gestures, deep links, permissions | empty, loading, loaded, signed-out, saved, unavailable | denied permission, stale inventory, offline, region-locked, provider error, blocked entitlement |
| 3D Map | Core discovery and decision flow | taps, forms, filters, map gestures, deep links, permissions | empty, loading, loaded, signed-out, saved, unavailable | denied permission, stale inventory, offline, region-locked, provider error, blocked entitlement |
...
| Route Detail | Transaction, live state, or management flow | taps, forms, filters, map gestures, deep links, permissions | empty, loading, loaded, signed-out, saved, unavailable | denied permission, stale inventory, offline, region-locked, provider error, blocked entitlement |
| GPS Track | Transaction, live state, or management flow | taps, forms, filters, map gestures, deep links, permissions | empty, loading, loaded, signed-out, saved, unavailable | denied permission, stale inventory, offline, region-locked, provider error, blocked entitlement |
| Offline Maps | Transaction, live state, or management flow | taps, forms, filters, map gestures, deep links, permissions | empty, loading, loaded, signed-out, saved, unavailable | denied permission, stale inventory, offline, region-locked, provider error, blocked entitlement |
| Ski/Terrain Layers | Transaction, live state, or management flow | taps, forms, filters, map gestures, deep links, permissions | empty, loading, loaded, signed-out, saved, unavailable | denied permission, stale inventory, offline, region-locked, provider error, blocked entitlement |
| Saved Peaks | Trust, account, recovery, or support flow | taps, forms, filters, map gestures, deep links, permissions | empty, loading, loaded, signed-out, saved, unavailable | denied permission, stale inventory, offline, region-locked, provider error, blocked entitlement |
| Flyover | Trust, account, recovery, or support flow | taps, forms, filters, map gestures, deep links, permissions | empty, loading, loaded, signed-out, saved, unavailable | denied permission, stale inventory, offline, region-locked, provider error, blocked entitlement |
...
- `Mountain`: stores lifecycle state, ownership, source provenance, authorization rules, sync status, deletion/export treatment, and audit metadata for PeakVisor-style workflows.
- `Trail`: stores lifecycle state, ownership, source provenance, authorization rules, sync status, deletion/export treatment, and audit metadata for PeakVisor-style workflows.
- `RoutePlan`: stores lifecycle state, ownership, source provenance, authorization rules, sync status, deletion/export treatment, and audit metadata for PeakVisor-style workflows.
- `GpsTrack`: stores lifecycle state, ownership, source provenance, authorization rules, sync status, deletion/export treatment, and audit metadata for PeakVisor-style workflows.
- `OfflineMapPack`: stores lifecycle state, ownership, source provenance, authorization rules, sync status, deletion/export treatment, and audit metadata for PeakVisor-style workflows.
- `TerrainLayer`: stores lifecycle state, ownership, source provenance, authorization rules, sync status, deletion/export treatment, and audit metadata for PeakVisor-style workflows.
- `PeakIdentification`: stores lifecycle state, ownership, source provenance, authorization rules, sync status, deletion/export treatment, and audit metadata for PeakVisor-style workflows.
- `SavedPlace`: stores lifecycle state, ownership, source provenance, authorization rules, sync status, deletion/export treatment, and audit metadata for PeakVisor-style workflows.
- `SubscriptionEntitlement`: stores lifecycle state, ownership, source provenance, authorization rules, sync status, deletion/export treatment, and audit metadata for PeakVisor-style workflows.
- `SafetyNotice`: stores lifecycle state, ownership, source provenance, authorization rules, sync status, deletion/export treatment, and audit metadata for PeakVisor-style workflows.
...
- Manual verification checklist tests for AR peak identification, GPS track recording, offline map downloads, route export, premium entitlement restoration, camera/location prompts, push alerts, slope and avalanche-terrain overlays, and regional trail coverage.
...
- Phase 7: Conduct lawful hands-on verification for AR peak identification, GPS track recording, offline map downloads, route export, premium entitlement restoration, camera/location prompts, push alerts, slope and avalanche-terrain overlays, and regional trail coverage, then update this spec with evidence before any one-for-one parity claim.
