# WeatherBug-Style Clone Spec

> Metadata
> - Inspiration app: WeatherBug
...
> - Manual verification blockers: lightning alert delivery, weather-camera availability, radar playback, air-quality feeds, premium/ad states, widgets, location prompts, and regional station coverage require lawful test evidence before one-for-one native parity claims.
> - Legal scope: functional parity only; use original code, brand, copy, iconography, sample data, media, policies, and integrations.

## Overview

Build an original mobile product inspired by WeatherBug's public user-facing workflow. The clone focus is local forecasts, spark/lightning and severe weather alerts, radar maps, weather cameras, air quality, saved locations, widgets, and location privacy controls. This public-source V1 spec is implementation-ready for an original build, but every behavior marked `Manual verification required` must remain behind a documented blocker until lawful hands-on evidence confirms the exact native behavior.
...
- Do not copy WeatherBug branding, logos, screenshots, marketing copy, private APIs, proprietary datasets, ranking systems, route algorithms, or protected media.
...
|---|---|---|---|
| Apple App Store listing | https://apps.apple.com/us/app/weatherbug-weather-forecast/id281940292 | iOS listing, category, age rating, privacy labels, release notes, support links | Public source verified |
| Google Play listing | https://play.google.com/store/apps/details?id=com.aws.android | Android listing, content rating, data safety, feature blurbs, update cadence | Public source verified |
| Official product site | https://www.weatherbug.com/ | Public product orientation for local forecasts, spark/lightning and severe weather alerts, radar maps, weather cameras, air quality, saved locations, widgets, and location privacy controls | Public source verified |
| Help/support center | https://www.weatherbug.com/about-us/contact | Support taxonomy, account, subscriptions, alerts, saved items, provider handoff, contact, privacy, and recovery flows | Public source verified |
| Privacy policy | https://www.weatherbug.com/legal/privacy-policy | Personal data, location, payment, analytics, retention, export, deletion, and regional privacy rights | Public source verified |
| Terms/legal terms | https://www.weatherbug.com/legal/terms-of-use | Eligibility, acceptable use, subscription or lead terms, cancellation, liability, content, and regional service constraints | Public source verified |
...
- Manual verification required: lightning alert delivery, weather-camera availability, radar playback, air-quality feeds, premium/ad states, widgets, location prompts, and regional station coverage.
...
|---|---|---|---|---|
| Home Forecast | Core discovery and decision flow | taps, forms, filters, map gestures, deep links, permissions | empty, loading, loaded, signed-out, saved, unavailable | denied permission, stale inventory, offline, region-locked, provider error, blocked entitlement |
...
| Lightning Alerts | Transaction, live state, or management flow | taps, forms, filters, map gestures, deep links, permissions | empty, loading, loaded, signed-out, saved, unavailable | denied permission, stale inventory, offline, region-locked, provider error, blocked entitlement |
| Weather Cameras | Transaction, live state, or management flow | taps, forms, filters, map gestures, deep links, permissions | empty, loading, loaded, signed-out, saved, unavailable | denied permission, stale inventory, offline, region-locked, provider error, blocked entitlement |
| Air Quality | Transaction, live state, or management flow | taps, forms, filters, map gestures, deep links, permissions | empty, loading, loaded, signed-out, saved, unavailable | denied permission, stale inventory, offline, region-locked, provider error, blocked entitlement |
...
- `ForecastLocation`: stores lifecycle state, ownership, source provenance, authorization rules, sync status, deletion/export treatment, and audit metadata for WeatherBug-style workflows.
- `HourlyForecast`: stores lifecycle state, ownership, source provenance, authorization rules, sync status, deletion/export treatment, and audit metadata for WeatherBug-style workflows.
- `DailyForecast`: stores lifecycle state, ownership, source provenance, authorization rules, sync status, deletion/export treatment, and audit metadata for WeatherBug-style workflows.
- `RadarFrame`: stores lifecycle state, ownership, source provenance, authorization rules, sync status, deletion/export treatment, and audit metadata for WeatherBug-style workflows.
- `LightningAlert`: stores lifecycle state, ownership, source provenance, authorization rules, sync status, deletion/export treatment, and audit metadata for WeatherBug-style workflows.
- `WeatherCamera`: stores lifecycle state, ownership, source provenance, authorization rules, sync status, deletion/export treatment, and audit metadata for WeatherBug-style workflows.
- `AirQualityReading`: stores lifecycle state, ownership, source provenance, authorization rules, sync status, deletion/export treatment, and audit metadata for WeatherBug-style workflows.
- `SavedLocation`: stores lifecycle state, ownership, source provenance, authorization rules, sync status, deletion/export treatment, and audit metadata for WeatherBug-style workflows.
- `WidgetConfig`: stores lifecycle state, ownership, source provenance, authorization rules, sync status, deletion/export treatment, and audit metadata for WeatherBug-style workflows.
- `SubscriptionEntitlement`: stores lifecycle state, ownership, source provenance, authorization rules, sync status, deletion/export treatment, and audit metadata for WeatherBug-style workflows.
...
- Manual verification checklist tests for lightning alert delivery, weather-camera availability, radar playback, air-quality feeds, premium/ad states, widgets, location prompts, and regional station coverage.
...
- Phase 7: Conduct lawful hands-on verification for lightning alert delivery, weather-camera availability, radar playback, air-quality feeds, premium/ad states, widgets, location prompts, and regional station coverage, then update this spec with evidence before any one-for-one parity claim.
