# Trulia-Style Clone Spec

> Metadata
> - Inspiration app: Trulia
...
> - Manual verification blockers: listing freshness, contact/lead routing, saved search alerts, neighborhood overlays, commute tools, fair-housing copy, location prompts, push alerts, and regional listing coverage require lawful test evidence before one-for-one native parity claims.
> - Legal scope: functional parity only; use original code, brand, copy, iconography, sample data, media, policies, and integrations.

## Overview

Build an original mobile product inspired by Trulia's public user-facing workflow. The clone focus is home and rental search, map/list results, property details, neighborhood insights, commute and local overlays, agent/property contact, saved searches, alerts, and fair-housing controls. This public-source V1 spec is implementation-ready for an original build, but every behavior marked `Manual verification required` must remain behind a documented blocker until lawful hands-on evidence confirms the exact native behavior.
...
- Do not copy Trulia branding, logos, screenshots, marketing copy, private APIs, proprietary datasets, ranking systems, route algorithms, or protected media.
...
|---|---|---|---|
| Apple App Store listing | https://apps.apple.com/us/app/trulia-real-estate-rentals/id288487321 | iOS listing, category, age rating, privacy labels, release notes, support links | Public source verified |
| Google Play listing | https://play.google.com/store/apps/details?id=com.trulia.android | Android listing, content rating, data safety, feature blurbs, update cadence | Public source verified |
| Official product site | https://www.trulia.com/ | Public product orientation for home and rental search, map/list results, property details, neighborhood insights, commute and local overlays, agent/property contact, saved searches, alerts, and fair-housing controls | Public source verified |
| Help/support center | https://support.trulia.com/hc/en-us | Support taxonomy, account, subscriptions, alerts, saved items, provider handoff, contact, privacy, and recovery flows | Public source verified |
...
| Terms/legal terms | https://www.trulia.com/info/terms/ | Eligibility, acceptable use, subscription or lead terms, cancellation, liability, content, and regional service constraints | Public source verified |
...
- Manual verification required: listing freshness, contact/lead routing, saved search alerts, neighborhood overlays, commute tools, fair-housing copy, location prompts, push alerts, and regional listing coverage.
...
| Neighborhood Insights | Transaction, live state, or management flow | taps, forms, filters, map gestures, deep links, permissions | empty, loading, loaded, signed-out, saved, unavailable | denied permission, stale inventory, offline, region-locked, provider error, blocked entitlement |
...
| Contact Form | Transaction, live state, or management flow | taps, forms, filters, map gestures, deep links, permissions | empty, loading, loaded, signed-out, saved, unavailable | denied permission, stale inventory, offline, region-locked, provider error, blocked entitlement |
...
| Saved Searches | Trust, account, recovery, or support flow | taps, forms, filters, map gestures, deep links, permissions | empty, loading, loaded, signed-out, saved, unavailable | denied permission, stale inventory, offline, region-locked, provider error, blocked entitlement |
...
- `PropertyListing`: stores lifecycle state, ownership, source provenance, authorization rules, sync status, deletion/export treatment, and audit metadata for Trulia-style workflows.
- `ListingMedia`: stores lifecycle state, ownership, source provenance, authorization rules, sync status, deletion/export treatment, and audit metadata for Trulia-style workflows.
- `NeighborhoodInsight`: stores lifecycle state, ownership, source provenance, authorization rules, sync status, deletion/export treatment, and audit metadata for Trulia-style workflows.
- `CommuteEstimate`: stores lifecycle state, ownership, source provenance, authorization rules, sync status, deletion/export treatment, and audit metadata for Trulia-style workflows.
- `LeadRequest`: stores lifecycle state, ownership, source provenance, authorization rules, sync status, deletion/export treatment, and audit metadata for Trulia-style workflows.
- `SavedSearch`: stores lifecycle state, ownership, source provenance, authorization rules, sync status, deletion/export treatment, and audit metadata for Trulia-style workflows.
- `SavedProperty`: stores lifecycle state, ownership, source provenance, authorization rules, sync status, deletion/export treatment, and audit metadata for Trulia-style workflows.
- `AgentProfile`: stores lifecycle state, ownership, source provenance, authorization rules, sync status, deletion/export treatment, and audit metadata for Trulia-style workflows.
- `NotificationPreference`: stores lifecycle state, ownership, source provenance, authorization rules, sync status, deletion/export treatment, and audit metadata for Trulia-style workflows.
- `ModerationReport`: stores lifecycle state, ownership, source provenance, authorization rules, sync status, deletion/export treatment, and audit metadata for Trulia-style workflows.
...
- Manual verification checklist tests for listing freshness, contact/lead routing, saved search alerts, neighborhood overlays, commute tools, fair-housing copy, location prompts, push alerts, and regional listing coverage.
...
- Phase 7: Conduct lawful hands-on verification for listing freshness, contact/lead routing, saved search alerts, neighborhood overlays, commute tools, fair-housing copy, location prompts, push alerts, and regional listing coverage, then update this spec with evidence before any one-for-one parity claim.
