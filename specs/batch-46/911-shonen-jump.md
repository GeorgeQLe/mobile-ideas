# Shonen Jump-Style Clone Spec

> Metadata
> - Inspiration app: Shonen Jump
...
> - Manual verification blockers: VIZ Media/Shonen Jump account and subscription policy (free chapter-a-day vs paid unlimited membership), Shueisha/VIZ manga content licensing and simultaneous release scheduling, chapter-a-day free reading mechanics and daily reset timing, subscription vault access (15,000+ chapters) and catalog completeness, manga reader rendering (page-by-page, double-page spread, zoom), series library organization and genre/tag classification, new chapter notification timing and followed series management, reading history and bookmark sync across devices, offline chapter download limits and subscription entitlement, editor's picks and themed collection curation, manga calendar weekly schedule accuracy, completed series availability and licensing windows, creator interview and bonus content scheduling, in-app subscription management on iOS/Android, content geo-restrictions (US/Canada/UK/Ireland/etc.), push notification delivery for chapter releases, and VIZ Media/Shonen Jump account integration.
...
Build an original mobile product inspired by Shonen Jump's public books & reference workflow. The V1 clone focuses on official Shonen Jump manga reading app by VIZ Media with access to the Shonen Jump digital vault (15,000+ chapters), simultaneous chapter releases with Japan, chapter-a-day free reading with subscription for unlimited access, manga reader with page-turn and double-page spread support, series library browsing by popularity and genre, new chapter notifications for followed series, reading history and bookmarks, offline chapter download (subscription), curated editor's picks and themed collections, manga calendar with weekly release schedule, completed series back-catalog, creator interviews and bonus content, and subscription model (Shonen Jump membership for unlimited reading).
...
- Preserve the functional job behind Shonen Jump while using original product naming, original UI, original sample data, and licensed integrations.
...
- Do not copy Shonen Jump branding, logos, screenshots, marketing copy, private APIs, proprietary datasets, plan names, UI trade dress, course libraries, textbook solutions, documents, school content, AI prompts, or protected media.
...
|---|---|---|---|
| Apple App Store | https://apps.apple.com/us/app/shonen-jump-manga-comics/id594237344 | iOS listing, privacy labels, release notes, manga/Shonen Jump vault claims, and support links | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
| Google Play | https://play.google.com/store/apps/details?id=com.viz.wsj.android | Android listing, data safety, manga/Shonen Jump claims, and release cadence | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
| Official product site | https://www.viz.com/shonenjump | Shonen Jump manga vault, simultaneous release, subscription, and product positioning | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
| Official help | https://www.viz.com/company-faq | VIZ Media/Shonen Jump app help, account, subscription, and troubleshooting | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
| Privacy policy | https://www.viz.com/privacy | VIZ Media data collection, reading data, analytics, and privacy disclosures | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
| Terms | https://www.viz.com/terms | VIZ Media services, content licensing, subscriptions, and acceptable-use boundaries | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
...
- Manual blockers must remain launch-blocking until verified: VIZ Media/Shonen Jump account and subscription policy (free chapter-a-day vs paid unlimited membership), Shueisha/VIZ manga content licensing and simultaneous release scheduling, chapter-a-day free reading mechanics and daily reset timing, subscription vault access (15,000+ chapters) and catalog completeness, manga reader rendering (page-by-page, double-page spread, zoom), series library organization and genre/tag classification, new chapter notification timing and followed series management, reading history and bookmark sync across devices, offline chapter download limits and subscription entitlement, editor's picks and themed collection curation, manga calendar weekly schedule accuracy, completed series availability and licensing windows, creator interview and bonus content scheduling, in-app subscription management on iOS/Android, content geo-restrictions (US/Canada/UK/Ireland/etc.), push notification delivery for chapter releases, and VIZ Media/Shonen Jump account integration.

## Core User Journeys

- User creates or restores a Shonen Jump-style account, completes role, school, subscription, or tenant checks, and reaches the dashboard.
...
|---|---|---|---|---|
| Welcome/Auth | Account login or creation, subscription verification, age confirmation, and reading preference setup | email, OAuth, subscribe, age-confirm, set-preferences | new, returning, subscriber, free-tier, expired | auth failed, subscription lapsed, age-gate blocked, network error |
| Library/Series | Series library with followed titles, reading progress per series, chapter lists, and update indicators | browse, follow, unfollow, sort, filter, search, mark-read | populated, empty, syncing, updating, offline | sync failed, series unavailable, region-blocked, update delayed |
| Reader | Comic/manga reader with page-turn, vertical scroll, panel-by-panel guided view, zoom, and double-page spread support | page-turn, scroll, zoom, panel-tap, rotate, bookmark, screenshot-block | reading, loading, buffering, offline-cached, locked | page load failed, DRM error, chapter locked, rendering error, panel detection failed |
| Discover/Store | Series browsing by genre, popularity, new releases, editorial picks, and chapter/volume purchasing | browse, search, filter, preview, purchase, subscribe, add-to-library | browsing, searching, previewing, purchasing, empty-results | purchase failed, region-unavailable, catalog unavailable, chapter locked |
| Calendar/Updates | Release schedule, new chapter notifications, followed series updates, and upcoming releases | view-calendar, set-reminder, check-updates, filter-by-day | current-week, future, past, empty, loading | schedule unavailable, notification failed, timezone mismatch, release delayed |
| Settings/Privacy | Account, subscription, reading preferences, download management, notifications, privacy, and support | forms, toggle, subscribe, restore, manage-downloads, request-delete | loaded, editing, syncing | subscription error, download limit, storage full, account locked |
...
- Treat reading history and behavioral patterns (series followed, chapters read, reading speed), subscription and payment information, virtual currency balances and transaction history, offline downloaded content and DRM credentials, push notification tokens and delivery preferences, account credentials and session tokens, community engagement data (comments, ratings, favorites), content licensing and regional availability data, age verification and content maturity preferences, reading progress sync across devices, purchase history and library contents, and publisher/creator relationship data as launch-blocking review areas with owners, mitigations, and acceptance tests before implementation.
...
- Monetization model: use original free/trial/paid/sponsored/school/provider/tenant entitlement logic; do not copy exact pricing, plan names, bundle names, promotional copy, school contracts, tenant offers, or partner offers from Shonen Jump.
...
- Manual verification tests for VIZ Media/Shonen Jump account and subscription policy (free chapter-a-day vs paid unlimited membership), Shueisha/VIZ manga content licensing and simultaneous release scheduling, chapter-a-day free reading mechanics and daily reset timing, subscription vault access (15,000+ chapters) and catalog completeness, manga reader rendering (page-by-page, double-page spread, zoom), series library organization and genre/tag classification, new chapter notification timing and followed series management, reading history and bookmark sync across devices, offline chapter download limits and subscription entitlement, editor's picks and themed collection curation, manga calendar weekly schedule accuracy, completed series availability and licensing windows, creator interview and bonus content scheduling, in-app subscription management on iOS/Android, content geo-restrictions (US/Canada/UK/Ireland/etc.), push notification delivery for chapter releases, and VIZ Media/Shonen Jump account integration.
...
- Phase 4: Add app-specific safety controls for official Shonen Jump manga reading app by VIZ Media with access to the Shonen Jump digital vault (15,000+ chapters), simultaneous chapter releases with Japan, chapter-a-day free reading with subscription for unlimited access, manga reader with page-turn and double-page spread support, series library browsing by popularity and genre, new chapter notifications for followed series, reading history and bookmarks, offline chapter download (subscription), curated editor's picks and themed collections, manga calendar with weekly release schedule, completed series back-catalog, creator interviews and bonus content, and subscription model (Shonen Jump membership for unlimited reading).
...
- Confirm legal/privacy retention behavior for Shonen Jump-style sensitive records and update API contracts before downstream implementation.
