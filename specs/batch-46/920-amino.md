# Amino-Style Clone Spec

> Metadata
> - Inspiration app: Amino
> - Category: Social
...
> - Manual verification blockers: Amino/MediaLab account and content policy, community creation and management (rules, roles, moderation hierarchy), multimedia post composition and media hosting, real-time chat infrastructure (1:1, group, voice, video), community discovery algorithm and interest classification, user profile customization (walls, titles, custom roles per community), blogging with rich text editor and media embedding, community challenges and event scheduling, reputation/leveling system calculation (check-in streaks, participation), moderation tools (leader/curator roles, content review, bans, strikes), push notification categories and delivery, content discovery (trending, featured) curation, Amino+ subscription entitlement and premium features, virtual currency (Amino Coins) and in-app purchase management, voice and video chat room quality and moderation, wiki/knowledge base collaborative editing, content moderation for user-generated content across diverse fandoms, child safety (13+ age requirement, minor protection), community migration and closure, and MediaLab/Amino account integration.
...
Build an original mobile product inspired by Amino's public social workflow. The V1 clone focuses on fandom and interest-based community platform with topic-specific communities (Amino communities), community discovery by interest (Anime, Gaming, K-Pop, Art, Music, Books, Cosplay, etc.), multimedia posting (text, images, GIFs, polls, quizzes, wikis), real-time chat (1:1 and group), voice and video chat rooms, community customization (titles, roles, featured content), user profiles with customizable bios and walls, blogging with rich text and media, community challenges and events, reputation system (levels, check-in streaks), moderation tools (community leaders, curators), push notifications, content discovery (trending, featured, new), Amino+ subscription (premium features, ad-free), and freemium model with virtual currency (Amino Coins) and Amino+ subscription.
...
- Preserve the functional job behind Amino while using original product naming, original UI, original sample data, and licensed integrations.
...
- Do not copy Amino branding, logos, screenshots, marketing copy, private APIs, proprietary datasets, plan names, UI trade dress, course libraries, textbook solutions, documents, school content, AI prompts, or protected media.
...
|---|---|---|---|
| Apple App Store | https://apps.apple.com/us/app/amino-communities-and-fandom/id911544974 | iOS listing, privacy labels, release notes, fandom community/chat claims, and support links | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
| Google Play | https://play.google.com/store/apps/details?id=com.narvii.amino.master | Android listing, data safety, fandom community/interest claims, and release cadence | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
| Official product site | https://aminoapps.com/ | Amino fandom communities, discovery, chat, and product positioning | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
| Official help | https://aminoapps.com/help | Amino app help, account, communities, and troubleshooting | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
| Privacy policy | https://aminoapps.com/privacy | Amino/MediaLab data collection, community data, and privacy disclosures | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
| Terms | https://aminoapps.com/terms | Amino services, community guidelines, content policies, and acceptable-use boundaries | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
...
- Manual blockers must remain launch-blocking until verified: Amino/MediaLab account and content policy, community creation and management (rules, roles, moderation hierarchy), multimedia post composition and media hosting, real-time chat infrastructure (1:1, group, voice, video), community discovery algorithm and interest classification, user profile customization (walls, titles, custom roles per community), blogging with rich text editor and media embedding, community challenges and event scheduling, reputation/leveling system calculation (check-in streaks, participation), moderation tools (leader/curator roles, content review, bans, strikes), push notification categories and delivery, content discovery (trending, featured) curation, Amino+ subscription entitlement and premium features, virtual currency (Amino Coins) and in-app purchase management, voice and video chat room quality and moderation, wiki/knowledge base collaborative editing, content moderation for user-generated content across diverse fandoms, child safety (13+ age requirement, minor protection), community migration and closure, and MediaLab/Amino account integration.

## Core User Journeys

- User creates or restores a Amino-style account, completes role, school, subscription, or tenant checks, and reaches the dashboard.
...
- Monetization model: use original free/trial/paid/sponsored/school/provider/tenant entitlement logic; do not copy exact pricing, plan names, bundle names, promotional copy, school contracts, tenant offers, or partner offers from Amino.
...
- Manual verification tests for Amino/MediaLab account and content policy, community creation and management (rules, roles, moderation hierarchy), multimedia post composition and media hosting, real-time chat infrastructure (1:1, group, voice, video), community discovery algorithm and interest classification, user profile customization (walls, titles, custom roles per community), blogging with rich text editor and media embedding, community challenges and event scheduling, reputation/leveling system calculation (check-in streaks, participation), moderation tools (leader/curator roles, content review, bans, strikes), push notification categories and delivery, content discovery (trending, featured) curation, Amino+ subscription entitlement and premium features, virtual currency (Amino Coins) and in-app purchase management, voice and video chat room quality and moderation, wiki/knowledge base collaborative editing, content moderation for user-generated content across diverse fandoms, child safety (13+ age requirement, minor protection), community migration and closure, and MediaLab/Amino account integration.
...
- Phase 4: Add app-specific safety controls for fandom and interest-based community platform with topic-specific communities (Amino communities), community discovery by interest (Anime, Gaming, K-Pop, Art, Music, Books, Cosplay, etc.), multimedia posting (text, images, GIFs, polls, quizzes, wikis), real-time chat (1:1 and group), voice and video chat rooms, community customization (titles, roles, featured content), user profiles with customizable bios and walls, blogging with rich text and media, community challenges and events, reputation system (levels, check-in streaks), moderation tools (community leaders, curators), push notifications, content discovery (trending, featured, new), Amino+ subscription (premium features, ad-free), and freemium model with virtual currency (Amino Coins) and Amino+ subscription.
...
- Confirm legal/privacy retention behavior for Amino-style sensitive records and update API contracts before downstream implementation.
