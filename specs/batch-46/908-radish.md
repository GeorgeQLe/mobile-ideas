# Radish-Style Clone Spec

> Metadata
> - Inspiration app: Radish
...
> - Manual verification blockers: Radish account and virtual currency policy (coins, daily rewards, streak bonuses), serialized fiction content licensing (Radish Originals exclusive agreements, partner content), coin-based episode unlocking and wait-to-unlock timer mechanics, Radish Unlimited subscription catalog and entitlement, premium vs free content delineation, genre classification and content moderation, recommendation algorithm (reading patterns, genre preferences, completion rates), community features (comments, reactions) moderation, daily coin distribution and streak bonus calculation, push notification for new episodes from followed series, offline episode caching and storage, author partnership program terms and revenue model, reader customization persistence and sync, in-app purchase and virtual currency management (iOS/Android), mature content filtering and age-gating, reading progress sync across devices, and Radish/Kakao account integration.
...
Build an original mobile product inspired by Radish's public books & reference workflow. The V1 clone focuses on serialized fiction platform with bite-sized story episodes, genre discovery (Romance, Thriller, Fantasy, Horror, Sci-Fi, Mystery, Teen Fiction), coin-based episode unlocking and wait-to-unlock free reading, premium Radish Originals with exclusive serialized content, customizable reader (fonts, themes, text size), community features (comments, reactions on episodes), daily coin rewards and streak bonuses, push notifications for new episode releases, reading history and library management, offline episode access, author partnership program, personalized recommendations, mature content filtering, and freemium model with coin purchases and Radish Unlimited subscription.
...
- Preserve the functional job behind Radish while using original product naming, original UI, original sample data, and licensed integrations.
...
- Do not copy Radish branding, logos, screenshots, marketing copy, private APIs, proprietary datasets, plan names, UI trade dress, course libraries, textbook solutions, documents, school content, AI prompts, or protected media.
...
|---|---|---|---|
| Apple App Store | https://apps.apple.com/us/app/radish-fiction-romance-stories/id1076390498 | iOS listing, privacy labels, release notes, serialized fiction claims, and support links | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
| Google Play | https://play.google.com/store/apps/details?id=co.radish.radish | Android listing, data safety, serialized fiction/romance claims, and release cadence | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
| Official product site | https://radishfiction.com/ | Radish serialized fiction, Radish Originals, genres, and product positioning | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
| Official help | https://radishfiction.com/help | Radish app help, account, coins, and troubleshooting | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
| Privacy policy | https://radishfiction.com/privacy | Radish data collection, reading data, analytics, and privacy disclosures | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
| Terms | https://radishfiction.com/terms | Radish services, content licensing, virtual currency, and acceptable-use boundaries | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
...
- Manual blockers must remain launch-blocking until verified: Radish account and virtual currency policy (coins, daily rewards, streak bonuses), serialized fiction content licensing (Radish Originals exclusive agreements, partner content), coin-based episode unlocking and wait-to-unlock timer mechanics, Radish Unlimited subscription catalog and entitlement, premium vs free content delineation, genre classification and content moderation, recommendation algorithm (reading patterns, genre preferences, completion rates), community features (comments, reactions) moderation, daily coin distribution and streak bonus calculation, push notification for new episodes from followed series, offline episode caching and storage, author partnership program terms and revenue model, reader customization persistence and sync, in-app purchase and virtual currency management (iOS/Android), mature content filtering and age-gating, reading progress sync across devices, and Radish/Kakao account integration.

## Core User Journeys

- User creates or restores a Radish-style account, completes role, school, subscription, or tenant checks, and reaches the dashboard.
...
- Monetization model: use original free/trial/paid/sponsored/school/provider/tenant entitlement logic; do not copy exact pricing, plan names, bundle names, promotional copy, school contracts, tenant offers, or partner offers from Radish.
...
- Manual verification tests for Radish account and virtual currency policy (coins, daily rewards, streak bonuses), serialized fiction content licensing (Radish Originals exclusive agreements, partner content), coin-based episode unlocking and wait-to-unlock timer mechanics, Radish Unlimited subscription catalog and entitlement, premium vs free content delineation, genre classification and content moderation, recommendation algorithm (reading patterns, genre preferences, completion rates), community features (comments, reactions) moderation, daily coin distribution and streak bonus calculation, push notification for new episodes from followed series, offline episode caching and storage, author partnership program terms and revenue model, reader customization persistence and sync, in-app purchase and virtual currency management (iOS/Android), mature content filtering and age-gating, reading progress sync across devices, and Radish/Kakao account integration.
...
- Phase 4: Add app-specific safety controls for serialized fiction platform with bite-sized story episodes, genre discovery (Romance, Thriller, Fantasy, Horror, Sci-Fi, Mystery, Teen Fiction), coin-based episode unlocking and wait-to-unlock free reading, premium Radish Originals with exclusive serialized content, customizable reader (fonts, themes, text size), community features (comments, reactions on episodes), daily coin rewards and streak bonuses, push notifications for new episode releases, reading history and library management, offline episode access, author partnership program, personalized recommendations, mature content filtering, and freemium model with coin purchases and Radish Unlimited subscription.
...
- Confirm legal/privacy retention behavior for Radish-style sensitive records and update API contracts before downstream implementation.
