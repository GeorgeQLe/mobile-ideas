# Marvel Unlimited-Style Clone Spec

> Metadata
> - Inspiration app: Marvel Unlimited
...
> - Manual verification blockers: Marvel/Disney account and subscription policy (monthly vs annual Marvel Unlimited), comic content licensing and 3-month delay window from print release, guided view panel detection and smart navigation accuracy for diverse page layouts, full-page rendering quality (high-resolution comic art, color accuracy), 30,000+ comic catalog organization and metadata accuracy, reading order guides for crossover events and character arcs, offline download limit (12 issues) and rotation management, personalized recommendation algorithm (reading history, character affinity), curated reading list editorial creation and maintenance, character/creator profile metadata and cross-referencing, new release calendar accuracy and addition scheduling, search functionality across massive catalog (character, creator, series, event), push notification for new weekly additions, reading history and bookmark sync across devices, exclusive subscriber content delivery and variant cover presentation, in-app subscription management on iOS/Android, content geo-restrictions, and Marvel/Disney account integration.
...
Build an original mobile product inspired by Marvel Unlimited's public books & reference workflow. The V1 clone focuses on digital comic book subscription service by Marvel with access to 30,000+ comics spanning 80+ years, new digital comics added weekly (3 months after print release), comic reader with guided view (panel-by-panel smart navigation) and full-page modes, series and event browsing with reading order guides, personalized recommendations, curated reading lists by character, event, and creator, offline download (up to 12 issues), reading history and bookmarks, new release calendar, character and creator profiles, search by character/creator/series/event, push notifications for new additions, annual and monthly subscription options, and exclusive subscriber content (variant covers, behind-the-scenes).
...
- Preserve the functional job behind Marvel Unlimited while using original product naming, original UI, original sample data, and licensed integrations.
...
- Do not copy Marvel Unlimited branding, logos, screenshots, marketing copy, private APIs, proprietary datasets, plan names, UI trade dress, course libraries, textbook solutions, documents, school content, AI prompts, or protected media.
...
|---|---|---|---|
| Apple App Store | https://apps.apple.com/us/app/marvel-unlimited/id607205403 | iOS listing, privacy labels, release notes, comic subscription/30K+ catalog claims, and support links | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
| Google Play | https://play.google.com/store/apps/details?id=com.marvel.unlimited | Android listing, data safety, comic subscription/Marvel catalog claims, and release cadence | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
| Official product site | https://www.marvel.com/unlimited | Marvel Unlimited subscription, catalog, reading lists, and product positioning | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
| Official help | https://help.marvel.com/ | Marvel Unlimited app help, account, subscription, and troubleshooting | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
| Privacy policy | https://privacy.thewaltdisneycompany.com/ | Disney/Marvel data collection, analytics, and privacy disclosures | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
| Terms | https://disneytermsofuse.com/ | Disney/Marvel services, content licensing, subscriptions, and acceptable-use boundaries | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
...
- Manual blockers must remain launch-blocking until verified: Marvel/Disney account and subscription policy (monthly vs annual Marvel Unlimited), comic content licensing and 3-month delay window from print release, guided view panel detection and smart navigation accuracy for diverse page layouts, full-page rendering quality (high-resolution comic art, color accuracy), 30,000+ comic catalog organization and metadata accuracy, reading order guides for crossover events and character arcs, offline download limit (12 issues) and rotation management, personalized recommendation algorithm (reading history, character affinity), curated reading list editorial creation and maintenance, character/creator profile metadata and cross-referencing, new release calendar accuracy and addition scheduling, search functionality across massive catalog (character, creator, series, event), push notification for new weekly additions, reading history and bookmark sync across devices, exclusive subscriber content delivery and variant cover presentation, in-app subscription management on iOS/Android, content geo-restrictions, and Marvel/Disney account integration.

## Core User Journeys

- User creates or restores a Marvel Unlimited-style account, completes role, school, subscription, or tenant checks, and reaches the dashboard.
...
- Monetization model: use original free/trial/paid/sponsored/school/provider/tenant entitlement logic; do not copy exact pricing, plan names, bundle names, promotional copy, school contracts, tenant offers, or partner offers from Marvel Unlimited.
...
- Manual verification tests for Marvel/Disney account and subscription policy (monthly vs annual Marvel Unlimited), comic content licensing and 3-month delay window from print release, guided view panel detection and smart navigation accuracy for diverse page layouts, full-page rendering quality (high-resolution comic art, color accuracy), 30,000+ comic catalog organization and metadata accuracy, reading order guides for crossover events and character arcs, offline download limit (12 issues) and rotation management, personalized recommendation algorithm (reading history, character affinity), curated reading list editorial creation and maintenance, character/creator profile metadata and cross-referencing, new release calendar accuracy and addition scheduling, search functionality across massive catalog (character, creator, series, event), push notification for new weekly additions, reading history and bookmark sync across devices, exclusive subscriber content delivery and variant cover presentation, in-app subscription management on iOS/Android, content geo-restrictions, and Marvel/Disney account integration.
...
- Phase 4: Add app-specific safety controls for digital comic book subscription service by Marvel with access to 30,000+ comics spanning 80+ years, new digital comics added weekly (3 months after print release), comic reader with guided view (panel-by-panel smart navigation) and full-page modes, series and event browsing with reading order guides, personalized recommendations, curated reading lists by character, event, and creator, offline download (up to 12 issues), reading history and bookmarks, new release calendar, character and creator profiles, search by character/creator/series/event, push notifications for new additions, annual and monthly subscription options, and exclusive subscriber content (variant covers, behind-the-scenes).
...
- Confirm legal/privacy retention behavior for Marvel Unlimited-style sensitive records and update API contracts before downstream implementation.
