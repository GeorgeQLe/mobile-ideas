# Dreame-Style Clone Spec

> Metadata
> - Inspiration app: Dreame
...
> - Manual verification blockers: Dreame account and virtual currency policy (coins, bonus coins, VIP privileges), serialized fiction content licensing and exclusive/non-exclusive agreements, coin-based chapter unlocking pricing and free chapter allocation, daily check-in reward system and streak calculation, VIP subscription benefits and tier differences, genre classification and content tagging (mature content, age-gating), recommendation algorithm (reading history, genre preferences, popularity), offline chapter download limits and storage, community comments moderation for user-generated content, author program terms and revenue sharing, new chapter notification delivery and followed-story management, reader customization persistence, reading history and bookmark sync across devices, in-app purchase and virtual currency management (iOS/Android), content moderation for sensitive genres (mature, violence, etc.), regional content availability and licensing, and Dreame/Stary account integration.
...
Build an original mobile product inspired by Dreame's public books & reference workflow. The V1 clone focuses on serialized fiction and romance reading platform with vast library of web novels and serialized stories, genre discovery (Romance, Fantasy, Werewolf, Billionaire, CEO, Mafia, Paranormal, Urban), daily free chapters and coin-based unlocking system, customizable reader (fonts, themes, background, text size), offline chapter download, bookmarks and reading history, personalized recommendations, new chapter update notifications for followed stories, reading streaks and daily check-in rewards, community comments on chapters, author program and reader-to-writer pipeline, mature content tags and filtering, and freemium model with coin purchases and VIP subscription.
...
- Preserve the functional job behind Dreame while using original product naming, original UI, original sample data, and licensed integrations.
...
- Do not copy Dreame branding, logos, screenshots, marketing copy, private APIs, proprietary datasets, plan names, UI trade dress, course libraries, textbook solutions, documents, school content, AI prompts, or protected media.
...
|---|---|---|---|
| Apple App Store | https://apps.apple.com/us/app/dreame-read-fiction-romance/id1433529236 | iOS listing, privacy labels, release notes, romance/fiction reading claims, and support links | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
| Google Play | https://play.google.com/store/apps/details?id=com.stary.dreame | Android listing, data safety, web novel/romance/fiction claims, and release cadence | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
| Official product site | https://www.dreame.com/ | Dreame serialized fiction, romance novels, genres, and product positioning | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
| Official help | https://www.dreame.com/help | Dreame app help, account, coins, VIP, and troubleshooting | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
| Privacy policy | https://www.dreame.com/privacy | Dreame data collection, reading data, analytics, and privacy disclosures | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
| Terms | https://www.dreame.com/terms | Dreame services, content licensing, virtual currency, and acceptable-use boundaries | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
...
- Manual blockers must remain launch-blocking until verified: Dreame account and virtual currency policy (coins, bonus coins, VIP privileges), serialized fiction content licensing and exclusive/non-exclusive agreements, coin-based chapter unlocking pricing and free chapter allocation, daily check-in reward system and streak calculation, VIP subscription benefits and tier differences, genre classification and content tagging (mature content, age-gating), recommendation algorithm (reading history, genre preferences, popularity), offline chapter download limits and storage, community comments moderation for user-generated content, author program terms and revenue sharing, new chapter notification delivery and followed-story management, reader customization persistence, reading history and bookmark sync across devices, in-app purchase and virtual currency management (iOS/Android), content moderation for sensitive genres (mature, violence, etc.), regional content availability and licensing, and Dreame/Stary account integration.

## Core User Journeys

- User creates or restores a Dreame-style account, completes role, school, subscription, or tenant checks, and reaches the dashboard.
...
- Monetization model: use original free/trial/paid/sponsored/school/provider/tenant entitlement logic; do not copy exact pricing, plan names, bundle names, promotional copy, school contracts, tenant offers, or partner offers from Dreame.
...
- Manual verification tests for Dreame account and virtual currency policy (coins, bonus coins, VIP privileges), serialized fiction content licensing and exclusive/non-exclusive agreements, coin-based chapter unlocking pricing and free chapter allocation, daily check-in reward system and streak calculation, VIP subscription benefits and tier differences, genre classification and content tagging (mature content, age-gating), recommendation algorithm (reading history, genre preferences, popularity), offline chapter download limits and storage, community comments moderation for user-generated content, author program terms and revenue sharing, new chapter notification delivery and followed-story management, reader customization persistence, reading history and bookmark sync across devices, in-app purchase and virtual currency management (iOS/Android), content moderation for sensitive genres (mature, violence, etc.), regional content availability and licensing, and Dreame/Stary account integration.
...
- Phase 4: Add app-specific safety controls for serialized fiction and romance reading platform with vast library of web novels and serialized stories, genre discovery (Romance, Fantasy, Werewolf, Billionaire, CEO, Mafia, Paranormal, Urban), daily free chapters and coin-based unlocking system, customizable reader (fonts, themes, background, text size), offline chapter download, bookmarks and reading history, personalized recommendations, new chapter update notifications for followed stories, reading streaks and daily check-in rewards, community comments on chapters, author program and reader-to-writer pipeline, mature content tags and filtering, and freemium model with coin purchases and VIP subscription.
...
- Confirm legal/privacy retention behavior for Dreame-style sensitive records and update API contracts before downstream implementation.
