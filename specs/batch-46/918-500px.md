# 500px-Style Clone Spec

> Metadata
> - Inspiration app: 500px
> - Category: Social
...
> - Manual verification blockers: 500px/Visual China Group account and membership policy (Free vs Awesome vs Pro tier limits), high-quality photo upload and resolution preservation, Discover feed curation algorithm (Pulse score, editorial picks, freshness), photo quest creation and themed challenge management, photographer portfolio presentation and customization, licensing marketplace (commercial/editorial terms, pricing, contributor agreements, royalty splits), EXIF metadata extraction and gear community features, Pulse score calculation algorithm (views, likes, comments, freshness, engagement), community engagement at scale (likes, comments, follows), gallery and collection organization, photo editing tools and preset quality, category classification and discovery indexing, push notification categories (likes, comments, follows, quests, licensing), photographer directory and search, portfolio website integration, membership tier entitlement and feature gating, content moderation (nudity policy, quality standards), photo licensing rights management and usage tracking, and 500px/Visual China Group account integration.
...
Build an original mobile product inspired by 500px's public social workflow. The V1 clone focuses on photography community and licensing marketplace with high-quality photo sharing, Discover feed with curated and popular photos, photo quests (themed challenges), photographer profiles with portfolios, photo licensing marketplace (commercial and editorial), EXIF data display and camera gear information, Pulse score (popularity and engagement metric), community engagement (likes, comments, follows), galleries and collections, photo editing and preset filters, categories (Landscape, Portrait, Street, Abstract, Nature, etc.), push notifications, photographer directory, portfolio website integration, and freemium model with 500px membership tiers (Free, Awesome, Pro).
...
- Preserve the functional job behind 500px while using original product naming, original UI, original sample data, and licensed integrations.
...
- Do not copy 500px branding, logos, screenshots, marketing copy, private APIs, proprietary datasets, plan names, UI trade dress, course libraries, textbook solutions, documents, school content, AI prompts, or protected media.
...
|---|---|---|---|
| Apple App Store | https://apps.apple.com/us/app/500px-photography-community/id471965292 | iOS listing, privacy labels, release notes, photography community/licensing claims, and support links | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
| Google Play | https://play.google.com/store/apps/details?id=com.fivehundredpx.viewer | Android listing, data safety, photography community/marketplace claims, and release cadence | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
| Official product site | https://500px.com/ | 500px photography community, licensing, quests, and product positioning | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
| Official help | https://support.500px.com/ | 500px app help, account, licensing, membership, and troubleshooting | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
| Privacy policy | https://500px.com/privacy | 500px data collection, photo data, licensing data, and privacy disclosures | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
| Terms | https://500px.com/terms | 500px services, content licensing, marketplace terms, and acceptable-use boundaries | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
...
- Manual blockers must remain launch-blocking until verified: 500px/Visual China Group account and membership policy (Free vs Awesome vs Pro tier limits), high-quality photo upload and resolution preservation, Discover feed curation algorithm (Pulse score, editorial picks, freshness), photo quest creation and themed challenge management, photographer portfolio presentation and customization, licensing marketplace (commercial/editorial terms, pricing, contributor agreements, royalty splits), EXIF metadata extraction and gear community features, Pulse score calculation algorithm (views, likes, comments, freshness, engagement), community engagement at scale (likes, comments, follows), gallery and collection organization, photo editing tools and preset quality, category classification and discovery indexing, push notification categories (likes, comments, follows, quests, licensing), photographer directory and search, portfolio website integration, membership tier entitlement and feature gating, content moderation (nudity policy, quality standards), photo licensing rights management and usage tracking, and 500px/Visual China Group account integration.

## Core User Journeys

- User creates or restores a 500px-style account, completes role, school, subscription, or tenant checks, and reaches the dashboard.
...
- Monetization model: use original free/trial/paid/sponsored/school/provider/tenant entitlement logic; do not copy exact pricing, plan names, bundle names, promotional copy, school contracts, tenant offers, or partner offers from 500px.
...
- Manual verification tests for 500px/Visual China Group account and membership policy (Free vs Awesome vs Pro tier limits), high-quality photo upload and resolution preservation, Discover feed curation algorithm (Pulse score, editorial picks, freshness), photo quest creation and themed challenge management, photographer portfolio presentation and customization, licensing marketplace (commercial/editorial terms, pricing, contributor agreements, royalty splits), EXIF metadata extraction and gear community features, Pulse score calculation algorithm (views, likes, comments, freshness, engagement), community engagement at scale (likes, comments, follows), gallery and collection organization, photo editing tools and preset quality, category classification and discovery indexing, push notification categories (likes, comments, follows, quests, licensing), photographer directory and search, portfolio website integration, membership tier entitlement and feature gating, content moderation (nudity policy, quality standards), photo licensing rights management and usage tracking, and 500px/Visual China Group account integration.
...
- Confirm legal/privacy retention behavior for 500px-style sensitive records and update API contracts before downstream implementation.
