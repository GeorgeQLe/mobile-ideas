# Headway-Style Clone Spec

> Metadata
> - Inspiration app: Headway
...
> - Manual verification blockers: Headway account and subscription policy (free limited access vs Premium unlimited), book summary content licensing and publisher agreements, visual summary infographic rendering and illustration assets, audio summary narration and playback controls, daily insight selection algorithm and challenge design, personalized growth plan recommendation engine, spaced repetition algorithm for flashcard review, streak tracking and gamification calculation (achievements, levels, XP), widget implementation and daily content refresh, Headway for Teams business subscription and admin controls, offline download management and storage, highlight and flashcard sync across devices, push notification timing (daily insight, streak reminder, challenge), content catalog size and category distribution, in-app purchase and subscription management, reading statistics and progress visualization, and Headway account integration.
...
Build an original mobile product inspired by Headway's public books & reference workflow. The V1 clone focuses on non-fiction book summary and self-growth platform with bite-sized key insights from bestsellers, visual summaries with infographics and illustrations, audio summaries with narration, daily insights and challenges, personalized growth plans by category (Productivity, Leadership, Happiness, Health, Relationships, Money), reading streaks and spaced repetition, highlights and flashcards, widget for daily motivation, Headway for Teams (business plans), gamification (achievements, levels, streaks), offline access, and freemium model with Headway Premium subscription.
...
- Preserve the functional job behind Headway while using original product naming, original UI, original sample data, and licensed integrations.
...
- Do not copy Headway branding, logos, screenshots, marketing copy, private APIs, proprietary datasets, plan names, UI trade dress, course libraries, textbook solutions, documents, school content, AI prompts, or protected media.
...
|---|---|---|---|
| Apple App Store | https://apps.apple.com/us/app/headway-daily-book-summaries/id1457185832 | iOS listing, privacy labels, release notes, book summary/growth claims, and support links | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
| Google Play | https://play.google.com/store/apps/details?id=com.headway.books | Android listing, data safety, book summary/self-growth claims, and release cadence | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
| Official product site | https://www.headway.com/ | Headway book summaries, self-growth, daily insights, and product positioning | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
| Official help | https://help.headway.com/ | Headway app help, account, subscription, and troubleshooting | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
| Privacy policy | https://www.headway.com/privacy-policy | Headway data collection, reading data, analytics, and privacy disclosures | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
| Terms | https://www.headway.com/terms-of-use | Headway services, content licensing, subscriptions, and acceptable-use boundaries | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
...
- Manual blockers must remain launch-blocking until verified: Headway account and subscription policy (free limited access vs Premium unlimited), book summary content licensing and publisher agreements, visual summary infographic rendering and illustration assets, audio summary narration and playback controls, daily insight selection algorithm and challenge design, personalized growth plan recommendation engine, spaced repetition algorithm for flashcard review, streak tracking and gamification calculation (achievements, levels, XP), widget implementation and daily content refresh, Headway for Teams business subscription and admin controls, offline download management and storage, highlight and flashcard sync across devices, push notification timing (daily insight, streak reminder, challenge), content catalog size and category distribution, in-app purchase and subscription management, reading statistics and progress visualization, and Headway account integration.

## Core User Journeys

- User creates or restores a Headway-style account, completes role, school, subscription, or tenant checks, and reaches the dashboard.
...
- Monetization model: use original free/trial/paid/sponsored/school/provider/tenant entitlement logic; do not copy exact pricing, plan names, bundle names, promotional copy, school contracts, tenant offers, or partner offers from Headway.
...
- Manual verification tests for Headway account and subscription policy (free limited access vs Premium unlimited), book summary content licensing and publisher agreements, visual summary infographic rendering and illustration assets, audio summary narration and playback controls, daily insight selection algorithm and challenge design, personalized growth plan recommendation engine, spaced repetition algorithm for flashcard review, streak tracking and gamification calculation (achievements, levels, XP), widget implementation and daily content refresh, Headway for Teams business subscription and admin controls, offline download management and storage, highlight and flashcard sync across devices, push notification timing (daily insight, streak reminder, challenge), content catalog size and category distribution, in-app purchase and subscription management, reading statistics and progress visualization, and Headway account integration.
...
- Phase 4: Add app-specific safety controls for non-fiction book summary and self-growth platform with bite-sized key insights from bestsellers, visual summaries with infographics and illustrations, audio summaries with narration, daily insights and challenges, personalized growth plans by category (Productivity, Leadership, Happiness, Health, Relationships, Money), reading streaks and spaced repetition, highlights and flashcards, widget for daily motivation, Headway for Teams (business plans), gamification (achievements, levels, streaks), offline access, and freemium model with Headway Premium subscription.
...
- Confirm legal/privacy retention behavior for Headway-style sensitive records and update API contracts before downstream implementation.
