# Inkitt-Style Clone Spec

> Metadata
> - Inspiration app: Inkitt
...
> - Manual verification blockers: Inkitt account and content policy, reader-driven publishing algorithm (reading behavior signals for publishing decisions), serialized fiction chapter release scheduling and author upload cadence, genre classification and content moderation for user-generated fiction, recommendation algorithm (reading patterns, completion rates, engagement signals), offline chapter caching and storage management, reader customization persistence, community features (comments, ratings, reviews) and content moderation, reading list organization and sync, push notification for new chapters from followed stories/authors, author profile and following relationship management, Galatea premium interactive stories and separate app/content integration, reading streak and achievement calculation, content licensing (reader-submitted vs Inkitt-published), mature content filtering and age verification, copyright protection for user-submitted stories, and Inkitt/Galatea account integration.
...
Build an original mobile product inspired by Inkitt's public books & reference workflow. The V1 clone focuses on reader-driven publishing platform with free serialized fiction reading, genre-based discovery (Romance, Fantasy, Thriller, Sci-Fi, Young Adult, Mystery, Horror), algorithm-driven story recommendations based on reading behavior, chapter-by-chapter reading with offline access, customizable reader (fonts, themes, brightness, text size), bookmarks and reading history, community engagement (comments, reviews, story ratings), reading lists and library organization, push notifications for new chapter updates from followed stories, author profiles and following, Galatea (premium interactive story spinoff), reading streaks and achievements, and freemium model with premium stories.
...
- Deliver a mobile-first books & reference experience with onboarding, dashboard, primary workflow, reminders or notifications, settings, support, and recovery flows.
- Preserve the functional job behind Inkitt while using original product naming, original UI, original sample data, and licensed integrations.
...
- Do not copy Inkitt branding, logos, screenshots, marketing copy, private APIs, proprietary datasets, plan names, UI trade dress, course libraries, textbook solutions, documents, school content, AI prompts, or protected media.
...
|---|---|---|---|
| Apple App Store | https://apps.apple.com/us/app/inkitt-books-novels-stories/id1056775498 | iOS listing, privacy labels, release notes, fiction reading/publishing claims, and support links | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
| Google Play | https://play.google.com/store/apps/details?id=com.inkitt.android.reader | Android listing, data safety, fiction reading/community claims, and release cadence | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
| Official product site | https://www.inkitt.com/ | Inkitt reader-driven publishing, free fiction, genres, and product positioning | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
| Official help | https://help.inkitt.com/ | Inkitt app help, account, reading, publishing, and troubleshooting | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
| Privacy policy | https://www.inkitt.com/privacy_policy | Inkitt data collection, reading behavior, analytics, and privacy disclosures | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
| Terms | https://www.inkitt.com/terms_of_service | Inkitt services, content licensing, publishing, and acceptable-use boundaries | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
...
- Manual blockers must remain launch-blocking until verified: Inkitt account and content policy, reader-driven publishing algorithm (reading behavior signals for publishing decisions), serialized fiction chapter release scheduling and author upload cadence, genre classification and content moderation for user-generated fiction, recommendation algorithm (reading patterns, completion rates, engagement signals), offline chapter caching and storage management, reader customization persistence, community features (comments, ratings, reviews) and content moderation, reading list organization and sync, push notification for new chapters from followed stories/authors, author profile and following relationship management, Galatea premium interactive stories and separate app/content integration, reading streak and achievement calculation, content licensing (reader-submitted vs Inkitt-published), mature content filtering and age verification, copyright protection for user-submitted stories, and Inkitt/Galatea account integration.

## Core User Journeys

- User creates or restores a Inkitt-style account, completes role, school, subscription, or tenant checks, and reaches the dashboard.
...
|---|---|---|---|---|
| Welcome/Auth | Account login or creation, subscription/purchase verification, library import, and reading preference setup | email, OAuth, subscribe, import-library, set-preferences | new, returning, subscriber, free-tier, expired | auth failed, subscription lapsed, import failed, network error |
| Library/Bookshelf | Book and audiobook library with shelves/collections, reading progress indicators, sorting, and filtering | browse, sort, filter, search, organize, create-shelf | populated, empty, syncing, downloading, offline | sync failed, download stalled, shelf limit, storage full |
| Reader/Player | E-book reader with customizable display or audiobook player with playback controls, bookmarks, and annotations | read, scroll, page-turn, highlight, annotate, bookmark, adjust-font, play, pause, seek, speed, sleep-timer | reading, listening, paused, loading, offline | format error, DRM failed, sync conflict, rendering error, playback interrupted |
| Store/Discovery | Book browsing, search, recommendations, wishlists, purchasing or subscription catalog exploration | browse, search, filter, preview, purchase, wishlist, subscribe | browsing, searching, previewing, purchasing, empty-results | purchase failed, region-unavailable, catalog unavailable, recommendation cold-start |
| Progress/Stats | Reading statistics, progress tracking, goals, streaks, achievements, and reading history | view, set-goal, track-streak, log-progress, share-stats | tracking, goal-set, streak-active, review-ready, empty | stats calculation error, goal missed, streak broken, data incomplete |
| Settings/Privacy | Account, subscription, reading preferences (fonts, themes), notifications, privacy, support, and data export/import | forms, toggle, subscribe, restore, export, import, request-delete | loaded, editing, syncing | subscription error, export pending, import failed, account locked |
...
- Treat reading history and behavioral patterns (books read, chapters, time spent, completion rates), library contents and purchase/download history, subscription and payment information, annotations, highlights, and notes (potentially sensitive personal reflections), bookmarks and reading progress across devices, account credentials and session tokens, social/community features (friends, reading activity, reviews, shared shelves), wishlist and recommendation data, offline downloaded content and DRM credentials, virtual currency balances and transaction history, push notification tokens and delivery preferences, content licensing and regional availability data, reading goals and streak data, and imported library data from other services as launch-blocking review areas with owners, mitigations, and acceptance tests before implementation.
...
- Monetization model: use original free/trial/paid/sponsored/school/provider/tenant entitlement logic; do not copy exact pricing, plan names, bundle names, promotional copy, school contracts, tenant offers, or partner offers from Inkitt.
...
- Manual verification tests for Inkitt account and content policy, reader-driven publishing algorithm (reading behavior signals for publishing decisions), serialized fiction chapter release scheduling and author upload cadence, genre classification and content moderation for user-generated fiction, recommendation algorithm (reading patterns, completion rates, engagement signals), offline chapter caching and storage management, reader customization persistence, community features (comments, ratings, reviews) and content moderation, reading list organization and sync, push notification for new chapters from followed stories/authors, author profile and following relationship management, Galatea premium interactive stories and separate app/content integration, reading streak and achievement calculation, content licensing (reader-submitted vs Inkitt-published), mature content filtering and age verification, copyright protection for user-submitted stories, and Inkitt/Galatea account integration.
...
- Phase 4: Add app-specific safety controls for reader-driven publishing platform with free serialized fiction reading, genre-based discovery (Romance, Fantasy, Thriller, Sci-Fi, Young Adult, Mystery, Horror), algorithm-driven story recommendations based on reading behavior, chapter-by-chapter reading with offline access, customizable reader (fonts, themes, brightness, text size), bookmarks and reading history, community engagement (comments, reviews, story ratings), reading lists and library organization, push notifications for new chapter updates from followed stories, author profiles and following, Galatea (premium interactive story spinoff), reading streaks and achievements, and freemium model with premium stories.
...
- Confirm legal/privacy retention behavior for Inkitt-style sensitive records and update API contracts before downstream implementation.
