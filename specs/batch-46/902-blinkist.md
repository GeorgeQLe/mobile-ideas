# Blinkist-Style Clone Spec

> Metadata
> - Inspiration app: Blinkist
...
> - Manual verification blockers: Blinkist account and subscription policy (free daily Blink vs Premium unlimited access), book summary content licensing from publishers, audio narration recording quality and playback controls, text vs audio format switching and progress sync, personalization algorithm (interests, reading history, ratings), streak and goal tracking calculation, offline download management and storage, highlight and note sync and export, Shortcasts content creation and expert sourcing, Spaces team/business subscription management and admin controls, Kindle highlights integration (API access and sync), daily pick selection algorithm, content catalog size and new release cadence, in-app purchase and subscription management on iOS/Android, push notification timing (daily pick, streak reminder), reading statistics and annual summary, family/shared subscription options, and Blinkist account integration.
...
Build an original mobile product inspired by Blinkist's public books & reference workflow. The V1 clone focuses on non-fiction book summary platform with 15-minute key insights (Blinks) from bestsellers and new releases, audio and text summary formats, curated collections by topic and expert, personalized recommendations based on interests, reading/listening streaks and goals, offline access for downloaded Blinks, highlights and notes, Shortcasts (podcast-style expert explanations), Spaces (team libraries for business), integration with Kindle highlights, daily personalized picks, categories (Career, Psychology, Science, Health, History, etc.), and freemium model with Blinkist Premium subscription.
...
- Preserve the functional job behind Blinkist while using original product naming, original UI, original sample data, and licensed integrations.
...
- Do not copy Blinkist branding, logos, screenshots, marketing copy, private APIs, proprietary datasets, plan names, UI trade dress, course libraries, textbook solutions, documents, school content, AI prompts, or protected media.
...
|---|---|---|---|
| Apple App Store | https://apps.apple.com/us/app/blinkist-book-summaries/id568839295 | iOS listing, privacy labels, release notes, book summary/audio claims, and support links | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
| Google Play | https://play.google.com/store/apps/details?id=com.blinkslabs.blinkist.android | Android listing, data safety, book summary/Blinks claims, and release cadence | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
| Official product site | https://www.blinkist.com/ | Blinkist book summaries, key insights, Shortcasts, and product positioning | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
| Official help | https://support.blinkist.com/ | Blinkist app help, account, subscription, and troubleshooting | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
| Privacy policy | https://www.blinkist.com/en/privacy | Blinkist data collection, reading data, analytics, and privacy disclosures | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
| Terms | https://www.blinkist.com/en/tos | Blinkist services, content licensing, subscriptions, and acceptable-use boundaries | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
...
- Manual blockers must remain launch-blocking until verified: Blinkist account and subscription policy (free daily Blink vs Premium unlimited access), book summary content licensing from publishers, audio narration recording quality and playback controls, text vs audio format switching and progress sync, personalization algorithm (interests, reading history, ratings), streak and goal tracking calculation, offline download management and storage, highlight and note sync and export, Shortcasts content creation and expert sourcing, Spaces team/business subscription management and admin controls, Kindle highlights integration (API access and sync), daily pick selection algorithm, content catalog size and new release cadence, in-app purchase and subscription management on iOS/Android, push notification timing (daily pick, streak reminder), reading statistics and annual summary, family/shared subscription options, and Blinkist account integration.

## Core User Journeys

- User creates or restores a Blinkist-style account, completes role, school, subscription, or tenant checks, and reaches the dashboard.
...
- Monetization model: use original free/trial/paid/sponsored/school/provider/tenant entitlement logic; do not copy exact pricing, plan names, bundle names, promotional copy, school contracts, tenant offers, or partner offers from Blinkist.
...
- Manual verification tests for Blinkist account and subscription policy (free daily Blink vs Premium unlimited access), book summary content licensing from publishers, audio narration recording quality and playback controls, text vs audio format switching and progress sync, personalization algorithm (interests, reading history, ratings), streak and goal tracking calculation, offline download management and storage, highlight and note sync and export, Shortcasts content creation and expert sourcing, Spaces team/business subscription management and admin controls, Kindle highlights integration (API access and sync), daily pick selection algorithm, content catalog size and new release cadence, in-app purchase and subscription management on iOS/Android, push notification timing (daily pick, streak reminder), reading statistics and annual summary, family/shared subscription options, and Blinkist account integration.
...
- Phase 4: Add app-specific safety controls for non-fiction book summary platform with 15-minute key insights (Blinks) from bestsellers and new releases, audio and text summary formats, curated collections by topic and expert, personalized recommendations based on interests, reading/listening streaks and goals, offline access for downloaded Blinks, highlights and notes, Shortcasts (podcast-style expert explanations), Spaces (team libraries for business), integration with Kindle highlights, daily personalized picks, categories (Career, Psychology, Science, Health, History, etc.), and freemium model with Blinkist Premium subscription.
...
- Confirm legal/privacy retention behavior for Blinkist-style sensitive records and update API contracts before downstream implementation.
