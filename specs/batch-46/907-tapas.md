# Tapas-Style Clone Spec

> Metadata
> - Inspiration app: Tapas
...
> - Manual verification blockers: Tapas account and virtual currency policy (Ink purchases, bonus Ink, daily rewards), webcomic and web novel content licensing (exclusive vs non-exclusive creator agreements), Ink-based episode unlocking and wait-to-unlock timer mechanics, comic reader vertical scroll rendering and panel optimization for mobile, novel reader text customization and format support, creator program revenue sharing and ad-revenue model, genre classification and content tagging (mature, LGBTQ+, violence), recommendation algorithm (reading history, likes, trending, editorial picks), library and subscription management for followed series, community moderation (comments, creator messages, reporting), daily free Ink distribution and reward calculation, push notification for new episodes from subscribed series, reading history and bookmark sync, in-app purchase and virtual currency management (iOS/Android), content moderation for user-generated comics and fiction, mature content age-gating and filtering controls, creator verification and publishing tools, and Tapas/Tapastic account integration.
...
Build an original mobile product inspired by Tapas's public books & reference workflow. The V1 clone focuses on webcomic and web novel reading platform with episodic comics and serialized fiction, genre discovery (Romance, Fantasy, Action, Comedy, Drama, Horror, Sci-Fi, Slice of Life, LGBTQ+, BL/GL), free episodes with Ink (virtual currency) unlocking for premium content, comic reader with vertical scroll and panel optimization, novel reader with customizable text display, personalized recommendations and trending lists, library and subscription management for followed series, community engagement (likes, comments, creator messages), creator program with ad revenue sharing, daily free Ink rewards and wait-to-unlock system, push notifications for new episode updates, reading history and bookmarks, mature content filtering, and freemium model with Ink purchases and ad-supported free reading.
...
- Preserve the functional job behind Tapas while using original product naming, original UI, original sample data, and licensed integrations.
...
- Do not copy Tapas branding, logos, screenshots, marketing copy, private APIs, proprietary datasets, plan names, UI trade dress, course libraries, textbook solutions, documents, school content, AI prompts, or protected media.
...
|---|---|---|---|
| Apple App Store | https://apps.apple.com/us/app/tapas-comics-novels/id578836126 | iOS listing, privacy labels, release notes, webcomic/novel reading claims, and support links | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
| Google Play | https://play.google.com/store/apps/details?id=com.tapastic | Android listing, data safety, webcomic/web novel claims, and release cadence | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
| Official product site | https://tapas.io/ | Tapas webcomics, web novels, creator program, and product positioning | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
| Official help | https://help.tapas.io/ | Tapas app help, account, Ink, creators, and troubleshooting | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
| Privacy policy | https://tapas.io/privacy | Tapas data collection, reading data, analytics, and privacy disclosures | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
| Terms | https://tapas.io/terms | Tapas services, content licensing, virtual currency, and acceptable-use boundaries | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
...
- Manual blockers must remain launch-blocking until verified: Tapas account and virtual currency policy (Ink purchases, bonus Ink, daily rewards), webcomic and web novel content licensing (exclusive vs non-exclusive creator agreements), Ink-based episode unlocking and wait-to-unlock timer mechanics, comic reader vertical scroll rendering and panel optimization for mobile, novel reader text customization and format support, creator program revenue sharing and ad-revenue model, genre classification and content tagging (mature, LGBTQ+, violence), recommendation algorithm (reading history, likes, trending, editorial picks), library and subscription management for followed series, community moderation (comments, creator messages, reporting), daily free Ink distribution and reward calculation, push notification for new episodes from subscribed series, reading history and bookmark sync, in-app purchase and virtual currency management (iOS/Android), content moderation for user-generated comics and fiction, mature content age-gating and filtering controls, creator verification and publishing tools, and Tapas/Tapastic account integration.

## Core User Journeys

- User creates or restores a Tapas-style account, completes role, school, subscription, or tenant checks, and reaches the dashboard.
...
- Monetization model: use original free/trial/paid/sponsored/school/provider/tenant entitlement logic; do not copy exact pricing, plan names, bundle names, promotional copy, school contracts, tenant offers, or partner offers from Tapas.
...
- Manual verification tests for Tapas account and virtual currency policy (Ink purchases, bonus Ink, daily rewards), webcomic and web novel content licensing (exclusive vs non-exclusive creator agreements), Ink-based episode unlocking and wait-to-unlock timer mechanics, comic reader vertical scroll rendering and panel optimization for mobile, novel reader text customization and format support, creator program revenue sharing and ad-revenue model, genre classification and content tagging (mature, LGBTQ+, violence), recommendation algorithm (reading history, likes, trending, editorial picks), library and subscription management for followed series, community moderation (comments, creator messages, reporting), daily free Ink distribution and reward calculation, push notification for new episodes from subscribed series, reading history and bookmark sync, in-app purchase and virtual currency management (iOS/Android), content moderation for user-generated comics and fiction, mature content age-gating and filtering controls, creator verification and publishing tools, and Tapas/Tapastic account integration.
...
- Phase 4: Add app-specific safety controls for webcomic and web novel reading platform with episodic comics and serialized fiction, genre discovery (Romance, Fantasy, Action, Comedy, Drama, Horror, Sci-Fi, Slice of Life, LGBTQ+, BL/GL), free episodes with Ink (virtual currency) unlocking for premium content, comic reader with vertical scroll and panel optimization, novel reader with customizable text display, personalized recommendations and trending lists, library and subscription management for followed series, community engagement (likes, comments, creator messages), creator program with ad revenue sharing, daily free Ink rewards and wait-to-unlock system, push notifications for new episode updates, reading history and bookmarks, mature content filtering, and freemium model with Ink purchases and ad-supported free reading.
...
- Confirm legal/privacy retention behavior for Tapas-style sensitive records and update API contracts before downstream implementation.
