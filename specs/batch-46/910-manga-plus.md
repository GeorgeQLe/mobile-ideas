# MANGA Plus-Style Clone Spec

> Metadata
> - Inspiration app: MANGA Plus
...
> - Manual verification blockers: MANGA Plus account and subscription policy (free ad-supported vs MAX full catalog), Shueisha manga content licensing and simultaneous global release scheduling, chapter availability windows (first 3 + latest 3 free, older chapters paywalled), manga reader rendering (page-by-page, vertical scroll, double-page spread), panel detection and panel-by-panel navigation accuracy, series following and chapter release notification timing, chapter comments moderation, recommendation algorithm (reading history, genre preferences, popularity), offline chapter viewing limits and expiration, manga calendar release schedule accuracy and timezone handling, multi-language translation delivery and language switching, MANGA Plus MAX subscription catalog and entitlement, ad insertion and consent framework, push notification for new chapter releases, reading progress sync, content geo-restrictions by license territory, creator spotlight and one-shot content scheduling, and Shueisha/MANGA Plus account integration.
...
Build an original mobile product inspired by MANGA Plus's public books & reference workflow. The V1 clone focuses on official manga reading platform by Shueisha with simultaneous global chapter releases from Weekly Shonen Jump and other magazines, free first and latest chapters for ongoing series, complete back-catalog reading for select titles, vertical and horizontal reading modes, manga reader with page-turn and panel navigation, series following and update notifications, chapter comments and community engagement, personalized recommendations, trending and popular series rankings, creator spotlights and one-shot manga, offline chapter viewing (limited), manga calendar with release schedules, multi-language support (English, Spanish, French, Portuguese, Thai, Indonesian), and free ad-supported model with MANGA Plus MAX subscription for full catalog access.
...
- Preserve the functional job behind MANGA Plus while using original product naming, original UI, original sample data, and licensed integrations.
...
- Do not copy MANGA Plus branding, logos, screenshots, marketing copy, private APIs, proprietary datasets, plan names, UI trade dress, course libraries, textbook solutions, documents, school content, AI prompts, or protected media.
...
|---|---|---|---|
| Apple App Store | https://apps.apple.com/us/app/manga-plus-by-shueisha/id1442476536 | iOS listing, privacy labels, release notes, official manga reading claims, and support links | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
| Google Play | https://play.google.com/store/apps/details?id=jp.co.shueisha.mangaplus | Android listing, data safety, official manga/Shueisha claims, and release cadence | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
| Official product site | https://mangaplus.shueisha.co.jp/ | MANGA Plus official manga, simultaneous release, series catalog, and product positioning | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
| Official help | https://mangaplus.shueisha.co.jp/help | MANGA Plus app help, account, reading, and troubleshooting | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
| Privacy policy | https://mangaplus.shueisha.co.jp/privacy | MANGA Plus/Shueisha data collection, reading data, and privacy disclosures | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
| Terms | https://mangaplus.shueisha.co.jp/terms | MANGA Plus/Shueisha services, content licensing, and acceptable-use boundaries | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
...
- Manual blockers must remain launch-blocking until verified: MANGA Plus account and subscription policy (free ad-supported vs MAX full catalog), Shueisha manga content licensing and simultaneous global release scheduling, chapter availability windows (first 3 + latest 3 free, older chapters paywalled), manga reader rendering (page-by-page, vertical scroll, double-page spread), panel detection and panel-by-panel navigation accuracy, series following and chapter release notification timing, chapter comments moderation, recommendation algorithm (reading history, genre preferences, popularity), offline chapter viewing limits and expiration, manga calendar release schedule accuracy and timezone handling, multi-language translation delivery and language switching, MANGA Plus MAX subscription catalog and entitlement, ad insertion and consent framework, push notification for new chapter releases, reading progress sync, content geo-restrictions by license territory, creator spotlight and one-shot content scheduling, and Shueisha/MANGA Plus account integration.

## Core User Journeys

- User creates or restores a MANGA Plus-style account, completes role, school, subscription, or tenant checks, and reaches the dashboard.
...
- Monetization model: use original free/trial/paid/sponsored/school/provider/tenant entitlement logic; do not copy exact pricing, plan names, bundle names, promotional copy, school contracts, tenant offers, or partner offers from MANGA Plus.
...
- Manual verification tests for MANGA Plus account and subscription policy (free ad-supported vs MAX full catalog), Shueisha manga content licensing and simultaneous global release scheduling, chapter availability windows (first 3 + latest 3 free, older chapters paywalled), manga reader rendering (page-by-page, vertical scroll, double-page spread), panel detection and panel-by-panel navigation accuracy, series following and chapter release notification timing, chapter comments moderation, recommendation algorithm (reading history, genre preferences, popularity), offline chapter viewing limits and expiration, manga calendar release schedule accuracy and timezone handling, multi-language translation delivery and language switching, MANGA Plus MAX subscription catalog and entitlement, ad insertion and consent framework, push notification for new chapter releases, reading progress sync, content geo-restrictions by license territory, creator spotlight and one-shot content scheduling, and Shueisha/MANGA Plus account integration.
...
- Phase 4: Add app-specific safety controls for official manga reading platform by Shueisha with simultaneous global chapter releases from Weekly Shonen Jump and other magazines, free first and latest chapters for ongoing series, complete back-catalog reading for select titles, vertical and horizontal reading modes, manga reader with page-turn and panel navigation, series following and update notifications, chapter comments and community engagement, personalized recommendations, trending and popular series rankings, creator spotlights and one-shot manga, offline chapter viewing (limited), manga calendar with release schedules, multi-language support (English, Spanish, French, Portuguese, Thai, Indonesian), and free ad-supported model with MANGA Plus MAX subscription for full catalog access.
...
- Confirm legal/privacy retention behavior for MANGA Plus-style sensitive records and update API contracts before downstream implementation.
