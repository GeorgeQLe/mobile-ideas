# Serial Reader-Style Clone Spec

> Metadata
> - Inspiration app: Serial Reader
...
> - Manual verification blockers: Serial Reader account and delivery scheduling, public domain book catalog sourcing (Project Gutenberg, other sources) and format parsing, daily issue chunking algorithm (chapter splitting, length calibration), delivery notification timing and timezone handling, reading schedule customization and multiple active serial management, font rendering and custom theme support, streak tracking and issue completion calculation, bookmark and highlight persistence, offline issue caching and storage management, progress tracking across multiple concurrent serials, push notification delivery (new issue available, streak reminder), reading statistics calculation, book completion detection and certificate generation, community popularity metrics and reading-together features, dark mode and dynamic type support, and Serial Reader account/purchase integration.
...
Build an original mobile product inspired by Serial Reader's public books & reference workflow. The V1 clone focuses on classic literature reading app with daily serial delivery of public domain books in short installments (issues), reading schedule customization (delivery time, issue length), extensive classic book catalog (Project Gutenberg integration), customizable reader (fonts, themes, text size, margins), reading streak tracking, bookmarks and highlights, offline reading, progress tracking across multiple active serials, notification reminders for new issues, reading statistics, book completion certificates, community features (popular books, reading together), dark mode, and one-time purchase or subscription model.
...
- Preserve the functional job behind Serial Reader while using original product naming, original UI, original sample data, and licensed integrations.
...
- Do not copy Serial Reader branding, logos, screenshots, marketing copy, private APIs, proprietary datasets, plan names, UI trade dress, course libraries, textbook solutions, documents, school content, AI prompts, or protected media.
...
|---|---|---|---|
| Apple App Store | https://apps.apple.com/us/app/serial-reader-daily-reads/id1064227882 | iOS listing, privacy labels, release notes, classic literature/serial delivery claims, and support links | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
| Google Play | https://play.google.com/store/apps/details?id=org.mobileera.serialreader | Android listing, data safety, classic literature/daily serial claims, and release cadence | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
| Official product site | https://www.serial-reader.com/ | Serial Reader daily classic literature, serial delivery, and product positioning | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
| Official help | https://www.serial-reader.com/faq/ | Serial Reader app help, FAQ, book catalog, and troubleshooting | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
| Privacy policy | https://www.serial-reader.com/privacy/ | Serial Reader data collection, reading data, and privacy disclosures | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
| Terms | https://www.serial-reader.com/terms/ | Serial Reader services, content, and acceptable-use boundaries | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
...
- Manual blockers must remain launch-blocking until verified: Serial Reader account and delivery scheduling, public domain book catalog sourcing (Project Gutenberg, other sources) and format parsing, daily issue chunking algorithm (chapter splitting, length calibration), delivery notification timing and timezone handling, reading schedule customization and multiple active serial management, font rendering and custom theme support, streak tracking and issue completion calculation, bookmark and highlight persistence, offline issue caching and storage management, progress tracking across multiple concurrent serials, push notification delivery (new issue available, streak reminder), reading statistics calculation, book completion detection and certificate generation, community popularity metrics and reading-together features, dark mode and dynamic type support, and Serial Reader account/purchase integration.

## Core User Journeys

- User creates or restores a Serial Reader-style account, completes role, school, subscription, or tenant checks, and reaches the dashboard.
...
- Monetization model: use original free/trial/paid/sponsored/school/provider/tenant entitlement logic; do not copy exact pricing, plan names, bundle names, promotional copy, school contracts, tenant offers, or partner offers from Serial Reader.
...
- Manual verification tests for Serial Reader account and delivery scheduling, public domain book catalog sourcing (Project Gutenberg, other sources) and format parsing, daily issue chunking algorithm (chapter splitting, length calibration), delivery notification timing and timezone handling, reading schedule customization and multiple active serial management, font rendering and custom theme support, streak tracking and issue completion calculation, bookmark and highlight persistence, offline issue caching and storage management, progress tracking across multiple concurrent serials, push notification delivery (new issue available, streak reminder), reading statistics calculation, book completion detection and certificate generation, community popularity metrics and reading-together features, dark mode and dynamic type support, and Serial Reader account/purchase integration.
...
- Phase 4: Add app-specific safety controls for classic literature reading app with daily serial delivery of public domain books in short installments (issues), reading schedule customization (delivery time, issue length), extensive classic book catalog (Project Gutenberg integration), customizable reader (fonts, themes, text size, margins), reading streak tracking, bookmarks and highlights, offline reading, progress tracking across multiple active serials, notification reminders for new issues, reading statistics, book completion certificates, community features (popular books, reading together), dark mode, and one-time purchase or subscription model.
...
- Confirm legal/privacy retention behavior for Serial Reader-style sensitive records and update API contracts before downstream implementation.
