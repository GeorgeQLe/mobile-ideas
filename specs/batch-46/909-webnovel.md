# Webnovel-Style Clone Spec

> Metadata
> - Inspiration app: Webnovel
...
> - Manual verification blockers: Webnovel account and virtual currency policy (Spirit Stones for unlocking, Power Stones for voting, Fast Pass), web novel content licensing (Qidian/China Literature exclusive translations, original English content), Spirit Stone chapter unlocking pricing and free chapter allocation, Power Stone voting system and story ranking mechanics, daily check-in reward system and streak calculation, translation program management (fan translation quality, official translation cadence), creator/author contract terms and revenue sharing, genre classification including Eastern Fantasy/Xianxia/Xuanhuan categories, recommendation algorithm (reading patterns, popularity, ratings, editorial), offline chapter download limits and storage, paragraph-level commenting system and moderation, reading progress sync and bookmark management, push notification for new chapters from followed novels, in-app purchase and virtual currency management (iOS/Android), content moderation for fan fiction and user-generated content, regional content availability (licensed translations by region), mature content filtering and age-gating, and Webnovel/Qidian/Tencent account integration.
...
Build an original mobile product inspired by Webnovel's public books & reference workflow. The V1 clone focuses on web novel and light novel reading platform with massive library of translated and original serialized fiction, genre discovery (Fantasy, Romance, Eastern Fantasy, Sci-Fi, Urban, Action, Mystery, Horror, Games, Fan Fiction), Spirit Stones (virtual currency) for chapter unlocking, Power Stones (voting) for story ranking support, daily free chapters and fast-pass system, customizable reader (fonts, themes, text size, background), offline chapter download, reading streaks and daily check-in rewards, community features (paragraph comments, reviews, story ratings), translation program (fan and official translations), creator/author program with contract writing, personalized recommendations and ranking lists, push notifications for new chapter updates, and freemium model with Spirit Stone purchases and premium membership.
...
- Preserve the functional job behind Webnovel while using original product naming, original UI, original sample data, and licensed integrations.
...
- Do not copy Webnovel branding, logos, screenshots, marketing copy, private APIs, proprietary datasets, plan names, UI trade dress, course libraries, textbook solutions, documents, school content, AI prompts, or protected media.
...
|---|---|---|---|
| Apple App Store | https://apps.apple.com/us/app/webnovel-fictions-daily-update/id1261154498 | iOS listing, privacy labels, release notes, web novel/fiction claims, and support links | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
| Google Play | https://play.google.com/store/apps/details?id=com.qidian.international | Android listing, data safety, web novel/light novel claims, and release cadence | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
| Official product site | https://www.webnovel.com/ | Webnovel fiction library, translations, creator program, and product positioning | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
| Official help | https://www.webnovel.com/help | Webnovel app help, account, Spirit Stones, and troubleshooting | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
| Privacy policy | https://www.webnovel.com/privacy | Webnovel/Qidian data collection, reading data, and privacy disclosures | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
| Terms | https://www.webnovel.com/terms | Webnovel services, content licensing, virtual currency, and acceptable-use boundaries | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
...
- Manual blockers must remain launch-blocking until verified: Webnovel account and virtual currency policy (Spirit Stones for unlocking, Power Stones for voting, Fast Pass), web novel content licensing (Qidian/China Literature exclusive translations, original English content), Spirit Stone chapter unlocking pricing and free chapter allocation, Power Stone voting system and story ranking mechanics, daily check-in reward system and streak calculation, translation program management (fan translation quality, official translation cadence), creator/author contract terms and revenue sharing, genre classification including Eastern Fantasy/Xianxia/Xuanhuan categories, recommendation algorithm (reading patterns, popularity, ratings, editorial), offline chapter download limits and storage, paragraph-level commenting system and moderation, reading progress sync and bookmark management, push notification for new chapters from followed novels, in-app purchase and virtual currency management (iOS/Android), content moderation for fan fiction and user-generated content, regional content availability (licensed translations by region), mature content filtering and age-gating, and Webnovel/Qidian/Tencent account integration.

## Core User Journeys

- User creates or restores a Webnovel-style account, completes role, school, subscription, or tenant checks, and reaches the dashboard.
...
- Monetization model: use original free/trial/paid/sponsored/school/provider/tenant entitlement logic; do not copy exact pricing, plan names, bundle names, promotional copy, school contracts, tenant offers, or partner offers from Webnovel.
...
- Manual verification tests for Webnovel account and virtual currency policy (Spirit Stones for unlocking, Power Stones for voting, Fast Pass), web novel content licensing (Qidian/China Literature exclusive translations, original English content), Spirit Stone chapter unlocking pricing and free chapter allocation, Power Stone voting system and story ranking mechanics, daily check-in reward system and streak calculation, translation program management (fan translation quality, official translation cadence), creator/author contract terms and revenue sharing, genre classification including Eastern Fantasy/Xianxia/Xuanhuan categories, recommendation algorithm (reading patterns, popularity, ratings, editorial), offline chapter download limits and storage, paragraph-level commenting system and moderation, reading progress sync and bookmark management, push notification for new chapters from followed novels, in-app purchase and virtual currency management (iOS/Android), content moderation for fan fiction and user-generated content, regional content availability (licensed translations by region), mature content filtering and age-gating, and Webnovel/Qidian/Tencent account integration.
...
- Phase 4: Add app-specific safety controls for web novel and light novel reading platform with massive library of translated and original serialized fiction, genre discovery (Fantasy, Romance, Eastern Fantasy, Sci-Fi, Urban, Action, Mystery, Horror, Games, Fan Fiction), Spirit Stones (virtual currency) for chapter unlocking, Power Stones (voting) for story ranking support, daily free chapters and fast-pass system, customizable reader (fonts, themes, text size, background), offline chapter download, reading streaks and daily check-in rewards, community features (paragraph comments, reviews, story ratings), translation program (fan and official translations), creator/author program with contract writing, personalized recommendations and ranking lists, push notifications for new chapter updates, and freemium model with Spirit Stone purchases and premium membership.
...
- Confirm legal/privacy retention behavior for Webnovel-style sensitive records and update API contracts before downstream implementation.
