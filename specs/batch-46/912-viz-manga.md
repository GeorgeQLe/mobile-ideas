# VIZ Manga-Style Clone Spec

> Metadata
> - Inspiration app: VIZ Manga
...
> - Manual verification blockers: VIZ Media account and purchasing policy (individual volume purchase vs subscription), manga volume DRM and format delivery, digital manga store catalog and pricing, free chapter preview length and availability, manga reader rendering quality (high-resolution pages, zoom, double-spread), series library and genre classification, new release notification scheduling, purchased library management and re-download policy, offline reading for purchased content and storage, wishlist management and sale/promotion alerts, series completion tracking accuracy, VIZ simulpub chapter integration with Shonen Jump, creator spotlight content scheduling, in-app purchase on iOS/Android and pricing parity, content geo-restrictions by license territory, volume vs chapter purchasing model differences, and VIZ Media account integration across VIZ apps.
...
Build an original mobile product inspired by VIZ Manga's public books & reference workflow. The V1 clone focuses on official manga reading and purchasing app by VIZ Media with digital manga store for individual volume purchases, free chapter previews, manga reader with high-quality page rendering and zoom, series browsing by genre and popularity, new release notifications, reading history and purchased library management, offline reading for purchased volumes, wishlists and recommendations, sale and promotion notifications, series completion tracking, VIZ Media simulpub chapters, creator spotlights, and individual purchase model with optional subscription tie-in.
...
- Preserve the functional job behind VIZ Manga while using original product naming, original UI, original sample data, and licensed integrations.
...
- Do not copy VIZ Manga branding, logos, screenshots, marketing copy, private APIs, proprietary datasets, plan names, UI trade dress, course libraries, textbook solutions, documents, school content, AI prompts, or protected media.
...
|---|---|---|---|
| Apple App Store | https://apps.apple.com/us/app/viz-manga/id321496171 | iOS listing, privacy labels, release notes, manga reading/purchasing claims, and support links | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
| Google Play | https://play.google.com/store/apps/details?id=com.viz.android.reader | Android listing, data safety, manga store/reader claims, and release cadence | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
| Official product site | https://www.viz.com/read | VIZ Manga digital store, series catalog, and product positioning | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
| Official help | https://www.viz.com/company-faq | VIZ Media app help, account, purchases, and troubleshooting | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
| Privacy policy | https://www.viz.com/privacy | VIZ Media data collection, purchase data, and privacy disclosures | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
| Terms | https://www.viz.com/terms | VIZ Media services, content licensing, purchases, and acceptable-use boundaries | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
...
- Manual blockers must remain launch-blocking until verified: VIZ Media account and purchasing policy (individual volume purchase vs subscription), manga volume DRM and format delivery, digital manga store catalog and pricing, free chapter preview length and availability, manga reader rendering quality (high-resolution pages, zoom, double-spread), series library and genre classification, new release notification scheduling, purchased library management and re-download policy, offline reading for purchased content and storage, wishlist management and sale/promotion alerts, series completion tracking accuracy, VIZ simulpub chapter integration with Shonen Jump, creator spotlight content scheduling, in-app purchase on iOS/Android and pricing parity, content geo-restrictions by license territory, volume vs chapter purchasing model differences, and VIZ Media account integration across VIZ apps.

## Core User Journeys

- User creates or restores a VIZ Manga-style account, completes role, school, subscription, or tenant checks, and reaches the dashboard.
...
- Monetization model: use original free/trial/paid/sponsored/school/provider/tenant entitlement logic; do not copy exact pricing, plan names, bundle names, promotional copy, school contracts, tenant offers, or partner offers from VIZ Manga.
...
- Manual verification tests for VIZ Media account and purchasing policy (individual volume purchase vs subscription), manga volume DRM and format delivery, digital manga store catalog and pricing, free chapter preview length and availability, manga reader rendering quality (high-resolution pages, zoom, double-spread), series library and genre classification, new release notification scheduling, purchased library management and re-download policy, offline reading for purchased content and storage, wishlist management and sale/promotion alerts, series completion tracking accuracy, VIZ simulpub chapter integration with Shonen Jump, creator spotlight content scheduling, in-app purchase on iOS/Android and pricing parity, content geo-restrictions by license territory, volume vs chapter purchasing model differences, and VIZ Media account integration across VIZ apps.
...
- Phase 4: Add app-specific safety controls for official manga reading and purchasing app by VIZ Media with digital manga store for individual volume purchases, free chapter previews, manga reader with high-quality page rendering and zoom, series browsing by genre and popularity, new release notifications, reading history and purchased library management, offline reading for purchased volumes, wishlists and recommendations, sale and promotion notifications, series completion tracking, VIZ Media simulpub chapters, creator spotlights, and individual purchase model with optional subscription tie-in.
...
- Confirm legal/privacy retention behavior for VIZ Manga-style sensitive records and update API contracts before downstream implementation.
