# Bookmate-Style Clone Spec

> Metadata
> - Inspiration app: Bookmate
...
> - Manual verification blockers: Bookmate account and subscription policy (free tier limited books vs Premium unlimited), e-book DRM and format support (EPUB, FB2, PDF, MOBI, TXT), audiobook DRM and streaming vs offline download, library catalog size and regional availability, in-app purchase restrictions on iOS (Apple requirement), reading progress sync and cross-device bookmark reconciliation, font embedding and custom reading theme support, annotation and highlight sync and export, offline download management and storage limits, social features (friends, activity feed, shared bookshelves) and privacy controls, book club creation and discussion features, user-generated bookshelf curation, reading statistics calculation and goal tracking, comics/manga reader panel rendering, serial fiction chapter release scheduling, family subscription sharing and household management, recommendation algorithm (reading history, ratings, editorial curation), publisher content licensing and geo-restrictions, and Bookmate/Yandex account integration.
...
Build an original mobile product inspired by Bookmate's public books & reference workflow. The V1 clone focuses on e-book and audiobook subscription platform with unlimited reading library, personalized book recommendations, curated bookshelves by editors and celebrities, e-book reader with customizable display (fonts, themes, margins, brightness), audiobook player with speed control and sleep timer, reading progress sync across devices, highlighting and note-taking, offline library download, social reading features (friends, activity feed, shared bookshelves), book clubs, user-generated bookshelves, reading statistics and goals, comics and manga support, serial fiction, family subscription sharing, and freemium model with Bookmate Premium subscription.
...
- Preserve the functional job behind Bookmate while using original product naming, original UI, original sample data, and licensed integrations.
...
- Do not copy Bookmate branding, logos, screenshots, marketing copy, private APIs, proprietary datasets, plan names, UI trade dress, course libraries, textbook solutions, documents, school content, AI prompts, or protected media.
...
|---|---|---|---|
| Apple App Store | https://apps.apple.com/us/app/bookmate-read-listen-to-books/id386177450 | iOS listing, privacy labels, release notes, e-book/audiobook subscription claims, and support links | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
| Google Play | https://play.google.com/store/apps/details?id=com.bookmate | Android listing, data safety, e-book/audiobook/subscription claims, and release cadence | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
| Official product site | https://bookmate.com/ | Bookmate subscription library, editorial bookshelves, and product positioning | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
| Official help | https://bookmate.com/help | Bookmate app help, account, subscription, reading, and troubleshooting | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
| Privacy policy | https://bookmate.com/privacy | Bookmate data collection, reading data, analytics, and privacy disclosures | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
| Terms | https://bookmate.com/terms | Bookmate services, content licensing, subscriptions, and acceptable-use boundaries | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
...
- Manual blockers must remain launch-blocking until verified: Bookmate account and subscription policy (free tier limited books vs Premium unlimited), e-book DRM and format support (EPUB, FB2, PDF, MOBI, TXT), audiobook DRM and streaming vs offline download, library catalog size and regional availability, in-app purchase restrictions on iOS (Apple requirement), reading progress sync and cross-device bookmark reconciliation, font embedding and custom reading theme support, annotation and highlight sync and export, offline download management and storage limits, social features (friends, activity feed, shared bookshelves) and privacy controls, book club creation and discussion features, user-generated bookshelf curation, reading statistics calculation and goal tracking, comics/manga reader panel rendering, serial fiction chapter release scheduling, family subscription sharing and household management, recommendation algorithm (reading history, ratings, editorial curation), publisher content licensing and geo-restrictions, and Bookmate/Yandex account integration.

## Core User Journeys

- User creates or restores a Bookmate-style account, completes role, school, subscription, or tenant checks, and reaches the dashboard.
...
- Monetization model: use original free/trial/paid/sponsored/school/provider/tenant entitlement logic; do not copy exact pricing, plan names, bundle names, promotional copy, school contracts, tenant offers, or partner offers from Bookmate.
...
- Manual verification tests for Bookmate account and subscription policy (free tier limited books vs Premium unlimited), e-book DRM and format support (EPUB, FB2, PDF, MOBI, TXT), audiobook DRM and streaming vs offline download, library catalog size and regional availability, in-app purchase restrictions on iOS (Apple requirement), reading progress sync and cross-device bookmark reconciliation, font embedding and custom reading theme support, annotation and highlight sync and export, offline download management and storage limits, social features (friends, activity feed, shared bookshelves) and privacy controls, book club creation and discussion features, user-generated bookshelf curation, reading statistics calculation and goal tracking, comics/manga reader panel rendering, serial fiction chapter release scheduling, family subscription sharing and household management, recommendation algorithm (reading history, ratings, editorial curation), publisher content licensing and geo-restrictions, and Bookmate/Yandex account integration.
...
- Phase 4: Add app-specific safety controls for e-book and audiobook subscription platform with unlimited reading library, personalized book recommendations, curated bookshelves by editors and celebrities, e-book reader with customizable display (fonts, themes, margins, brightness), audiobook player with speed control and sleep timer, reading progress sync across devices, highlighting and note-taking, offline library download, social reading features (friends, activity feed, shared bookshelves), book clubs, user-generated bookshelves, reading statistics and goals, comics and manga support, serial fiction, family subscription sharing, and freemium model with Bookmate Premium subscription.
...
- Confirm legal/privacy retention behavior for Bookmate-style sensitive records and update API contracts before downstream implementation.
