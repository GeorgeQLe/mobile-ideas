...
Build an original mobile photo/video editing product inspired by Apple Clips's public product and policy materials. V1 focuses on Apple mobile clip capture/editing, live titles, effects, stickers, posters, music, save/share, and platform-gated behavior. The clone must use original branding, original UI copy, original sample media, licensed providers/assets, and explicit disclosures when a feature is inferred from public materials rather than verified hands-on behavior.
...
- Do not imply affiliation with Apple Clips or its publisher.
...
|---|---|---|---|
| Official product | https://www.apple.com/clips/ | Public Apple Clips product positioning, editor workflow, feature surfaces, and account/subscription framing | Verified 2026-05-03 |
| Help/support | https://support.apple.com/clips | Public support taxonomy for app usage, subscriptions, exports, troubleshooting, and native behavior to verify | Verified 2026-05-03 |
| Privacy policy | https://www.apple.com/legal/privacy/ | Media, account, device, analytics, provider, retention, and user-rights handling | Verified 2026-05-03 |
| Terms/legal | https://www.apple.com/legal/internet-services/itunes/ | User content, subscriptions, AI/media tools, acceptable use, and legal boundaries | Verified 2026-05-03 |
