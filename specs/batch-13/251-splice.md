...
- Do not imply affiliation with Splice or its publisher.
...
|---|---|---|---|
| Official product | https://spliceapp.com/ | Public Splice product positioning, editor workflow, feature surfaces, and account/subscription framing | Verified 2026-05-03 |
| Help/support | https://support.spliceapp.com/ | Public support taxonomy for app usage, subscriptions, exports, troubleshooting, and native behavior to verify | Verified 2026-05-03 |
| Privacy policy | https://spliceapp.com/privacy-policy | Media, account, device, analytics, provider, retention, and user-rights handling | Verified 2026-05-03 |
| Terms/legal | https://spliceapp.com/terms-of-service | User content, subscriptions, AI/media tools, acceptable use, and legal boundaries | Verified 2026-05-03 |
