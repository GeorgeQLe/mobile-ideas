...
Build an original mobile photo/video editing product inspired by Magisto's public product and policy materials. V1 focuses on automated video creation, media import, templates/styles, music, business/social exports, and subscription gates. The clone must use original branding, original UI copy, original sample media, licensed providers/assets, and explicit disclosures when a feature is inferred from public materials rather than verified hands-on behavior.
...
- Do not imply affiliation with Magisto or its publisher.
...
|---|---|---|---|
| Official product | https://www.magisto.com/ | Public Magisto product positioning, editor workflow, feature surfaces, and account/subscription framing | Verified 2026-05-03 |
| Help/support | https://help.magisto.com/ | Public support taxonomy for app usage, subscriptions, exports, troubleshooting, and native behavior to verify | Verified 2026-05-03 |
| Privacy policy | https://vimeo.com/privacy | Media, account, device, analytics, provider, retention, and user-rights handling | Verified 2026-05-03 |
| Terms/legal | https://vimeo.com/terms | User content, subscriptions, AI/media tools, acceptable use, and legal boundaries | Verified 2026-05-03 |
