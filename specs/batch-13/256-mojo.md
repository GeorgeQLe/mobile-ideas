...
Build an original mobile photo/video editing product inspired by Mojo's public product and policy materials. V1 focuses on social video/story templates, animated text, brand kits, media import, export/share, and subscription gates. The clone must use original branding, original UI copy, original sample media, licensed providers/assets, and explicit disclosures when a feature is inferred from public materials rather than verified hands-on behavior.
...
- Do not imply affiliation with Mojo or its publisher.
...
|---|---|---|---|
| Official product | https://www.mojo-app.com/ | Public Mojo product positioning, editor workflow, feature surfaces, and account/subscription framing | Verified 2026-05-03 |
| Help/support | https://help.mojo-app.com/ | Public support taxonomy for app usage, subscriptions, exports, troubleshooting, and native behavior to verify | Verified 2026-05-03 |
| Privacy policy | https://www.mojo-app.com/privacy | Media, account, device, analytics, provider, retention, and user-rights handling | Verified 2026-05-03 |
| Terms/legal | https://www.mojo-app.com/terms | User content, subscriptions, AI/media tools, acceptable use, and legal boundaries | Verified 2026-05-03 |
