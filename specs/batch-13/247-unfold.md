...
Build an original mobile photo/video editing product inspired by Unfold's public product and policy materials. V1 focuses on story/reel templates, link-in-bio style creator tools, brand kits, media editing, export/share, and subscription gates. The clone must use original branding, original UI copy, original sample media, licensed providers/assets, and explicit disclosures when a feature is inferred from public materials rather than verified hands-on behavior.
...
- Do not imply affiliation with Unfold or its publisher.
...
|---|---|---|---|
| Official product | https://unfold.com/ | Public Unfold product positioning, editor workflow, feature surfaces, and account/subscription framing | Verified 2026-05-03 |
| Help/support | https://support.squarespace.com/hc/en-us/categories/360001637592-Unfold | Public support taxonomy for app usage, subscriptions, exports, troubleshooting, and native behavior to verify | Verified 2026-05-03 |
| Privacy policy | https://www.squarespace.com/privacy | Media, account, device, analytics, provider, retention, and user-rights handling | Verified 2026-05-03 |
| Terms/legal | https://www.squarespace.com/terms-of-service | User content, subscriptions, AI/media tools, acceptable use, and legal boundaries | Verified 2026-05-03 |
