...
Build an original mobile photo/video editing product inspired by InShot's public product and policy materials. V1 focuses on mobile video/photo editing, timeline clips, music/text/stickers, filters, canvas ratios, export/share, and subscription gates. The clone must use original branding, original UI copy, original sample media, licensed providers/assets, and explicit disclosures when a feature is inferred from public materials rather than verified hands-on behavior.
...
- Do not imply affiliation with InShot or its publisher.
...
|---|---|---|---|
| Official product | https://inshot.com/ | Public InShot product positioning, editor workflow, feature surfaces, and account/subscription framing | Verified 2026-05-03 |
| Help/support | https://inshot.com/contact/ | Public support taxonomy for app usage, subscriptions, exports, troubleshooting, and native behavior to verify | Verified 2026-05-03 |
| Privacy policy | https://inshot.com/privacy/ | Media, account, device, analytics, provider, retention, and user-rights handling | Verified 2026-05-03 |
| Terms/legal | https://inshot.com/terms/ | User content, subscriptions, AI/media tools, acceptable use, and legal boundaries | Verified 2026-05-03 |
