...
Build an original mobile photo/video editing product inspired by Remini's public product and policy materials. V1 focuses on AI photo enhancement, restoration, portrait improvement, processing queue, before/after comparison, export/share, and subscription gates. The clone must use original branding, original UI copy, original sample media, licensed providers/assets, and explicit disclosures when a feature is inferred from public materials rather than verified hands-on behavior.
...
- Do not imply affiliation with Remini or its publisher.
...
|---|---|---|---|
| Official product | https://remini.ai/ | Public Remini product positioning, editor workflow, feature surfaces, and account/subscription framing | Verified 2026-05-03 |
| Help/support | https://support.remini.ai/ | Public support taxonomy for app usage, subscriptions, exports, troubleshooting, and native behavior to verify | Verified 2026-05-03 |
| Privacy policy | https://bendingspoons.com/privacy.html | Media, account, device, analytics, provider, retention, and user-rights handling | Verified 2026-05-03 |
| Terms/legal | https://bendingspoons.com/tos.html | User content, subscriptions, AI/media tools, acceptable use, and legal boundaries | Verified 2026-05-03 |
