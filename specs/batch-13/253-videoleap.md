...
Build an original mobile photo/video editing product inspired by Videoleap's public product and policy materials. V1 focuses on AI/mobile video editing, templates, timeline, effects, text, generated-media tools, export/share, and subscription gates. The clone must use original branding, original UI copy, original sample media, licensed providers/assets, and explicit disclosures when a feature is inferred from public materials rather than verified hands-on behavior.
...
- Do not imply affiliation with Videoleap or its publisher.
...
|---|---|---|---|
| Official product | https://www.videoleapapp.com/ | Public Videoleap product positioning, editor workflow, feature surfaces, and account/subscription framing | Verified 2026-05-03 |
| Help/support | https://support.videoleapapp.com/ | Public support taxonomy for app usage, subscriptions, exports, troubleshooting, and native behavior to verify | Verified 2026-05-03 |
| Privacy policy | https://static.lightricks.com/legal/privacy-policy.pdf | Media, account, device, analytics, provider, retention, and user-rights handling | Verified 2026-05-03 |
| Terms/legal | https://static.lightricks.com/legal/terms-of-use.pdf | User content, subscriptions, AI/media tools, acceptable use, and legal boundaries | Verified 2026-05-03 |
