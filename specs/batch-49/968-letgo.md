# letgo-Style Clone Spec

> Metadata
> - Inspiration app: letgo
> - Category: Shopping
...
> - Manual verification blockers: letgo/OfferUp account creation and phone verification, AI-powered image recognition for listing categorization (on-device or cloud ML, category prediction, pricing suggestion), photo-first listing flow (camera capture, multi-photo upload, image optimization), in-app messaging infrastructure (real-time chat, message persistence, media sharing), location-based feed with proximity sorting and radius filtering (geolocation, reverse geocoding), category browsing taxonomy and keyword search indexing, price negotiation chat flow and offer/counter-offer mechanics, user profile with ratings and review aggregation, saved searches with notification triggers for new matches, favorite listings sync and availability tracking, push notification for messages, price drops, and new matches, meetup safety features and location sharing for transactions, fraud and scam detection for listings and messages, content moderation for photos and listing text, and letgo/OfferUp account integration.
...
Build an original mobile product inspired by letgo's public shopping workflow. The V1 clone focuses on local marketplace for buying and selling secondhand items with AI-powered image recognition for automatic listing categorization and pricing suggestions, photo-first listing creation, in-app messaging between buyers and sellers, location-based feed showing nearby listings, category browsing and keyword search, price negotiation via chat, user profiles with ratings and reviews, saved searches and favorite listings, push notifications for messages and price drops, safety tips for in-person meetups, and free listing model (merged with OfferUp in 2020, but original letgo-style workflow preserved as clone target).
...
- Preserve the functional job behind letgo while using original product naming, original UI, original sample data, and licensed integrations.
...
- Do not copy letgo branding, logos, screenshots, marketing copy, private APIs, proprietary datasets, plan names, UI trade dress, course libraries, textbook solutions, documents, school content, AI prompts, or protected media.
...
|---|---|---|---|
| Apple App Store | https://apps.apple.com/us/app/offerup-buy-sell-letgo/id468996152 | iOS listing (OfferUp, merged with letgo), privacy labels, release notes, and support links | Verified public URL or explicit platform blocker on 2026-05-06; hands-on native behavior still blocked. |
| Google Play | https://play.google.com/store/apps/details?id=com.offerupnow | Android listing (OfferUp, merged with letgo), data safety, and release cadence | Verified public URL or explicit platform blocker on 2026-05-06; hands-on native behavior still blocked. |
| Official product site | https://offerup.com/ | OfferUp/letgo local marketplace, buying and selling, and product positioning | Verified public URL or explicit platform blocker on 2026-05-06; hands-on native behavior still blocked. |
| Official help | https://help.offerup.com/ | OfferUp/letgo app help, selling, buying, and troubleshooting | Verified public URL or explicit platform blocker on 2026-05-06; hands-on native behavior still blocked. |
| Privacy policy | https://offerup.com/privacy/ | OfferUp/letgo data collection, location data, messaging data, and privacy disclosures | Verified public URL or explicit platform blocker on 2026-05-06; hands-on native behavior still blocked. |
| Terms | https://offerup.com/tos/ | OfferUp/letgo services, marketplace terms, and acceptable-use boundaries | Verified public URL or explicit platform blocker on 2026-05-06; hands-on native behavior still blocked. |
...
- Manual blockers must remain launch-blocking until verified: letgo/OfferUp account creation and phone verification, AI-powered image recognition for listing categorization (on-device or cloud ML, category prediction, pricing suggestion), photo-first listing flow (camera capture, multi-photo upload, image optimization), in-app messaging infrastructure (real-time chat, message persistence, media sharing), location-based feed with proximity sorting and radius filtering (geolocation, reverse geocoding), category browsing taxonomy and keyword search indexing, price negotiation chat flow and offer/counter-offer mechanics, user profile with ratings and review aggregation, saved searches with notification triggers for new matches, favorite listings sync and availability tracking, push notification for messages, price drops, and new matches, meetup safety features and location sharing for transactions, fraud and scam detection for listings and messages, content moderation for photos and listing text, and letgo/OfferUp account integration.

## Core User Journeys

- User creates or restores a letgo-style account, completes role, school, subscription, or tenant checks, and reaches the dashboard.
...
- Monetization model: use original free/trial/paid/sponsored/school/provider/tenant entitlement logic; do not copy exact pricing, plan names, bundle names, promotional copy, school contracts, tenant offers, or partner offers from letgo.
...
- Manual verification tests for letgo/OfferUp account creation and phone verification, AI-powered image recognition for listing categorization (on-device or cloud ML, category prediction, pricing suggestion), photo-first listing flow (camera capture, multi-photo upload, image optimization), in-app messaging infrastructure (real-time chat, message persistence, media sharing), location-based feed with proximity sorting and radius filtering (geolocation, reverse geocoding), category browsing taxonomy and keyword search indexing, price negotiation chat flow and offer/counter-offer mechanics, user profile with ratings and review aggregation, saved searches with notification triggers for new matches, favorite listings sync and availability tracking, push notification for messages, price drops, and new matches, meetup safety features and location sharing for transactions, fraud and scam detection for listings and messages, content moderation for photos and listing text, and letgo/OfferUp account integration.
...
- Phase 4: Add app-specific safety controls for local marketplace for buying and selling secondhand items with AI-powered image recognition for automatic listing categorization and pricing suggestions, photo-first listing creation, in-app messaging between buyers and sellers, location-based feed showing nearby listings, category browsing and keyword search, price negotiation via chat, user profiles with ratings and reviews, saved searches and favorite listings, push notifications for messages and price drops, safety tips for in-person meetups, and free listing model (merged with OfferUp in 2020, but original letgo-style workflow preserved as clone target).
...
- Confirm legal/privacy retention behavior for letgo-style sensitive records and update API contracts before downstream implementation.
