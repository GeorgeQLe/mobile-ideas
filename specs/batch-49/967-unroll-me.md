# Unroll.Me-Style Clone Spec

> Metadata
> - Inspiration app: Unroll.Me
...
> - Manual verification blockers: Unroll.Me account and email account linking (Gmail OAuth, Outlook OAuth, Yahoo, AOL), subscription detection algorithm (scanning for mailing list headers, common newsletter patterns), one-tap unsubscribe execution (List-Unsubscribe header parsing, automated unsubscribe link following), Rollup digest email generation and delivery scheduling, subscription list maintenance and sender preview rendering, add/remove from Rollup toggling and immediate effect, unsubscribe history tracking and confirmation verification, multi-account subscription aggregation, swipe interface keep/unsubscribe/rollup gesture handling, new subscription detection and notification, data monetization transparency (historical Slice Intelligence/Edison partnership, FTC scrutiny, current data practices), privacy disclosure compliance and user consent for data sharing, rate limiting for bulk unsubscribe operations, and Unroll.Me account integration.
...
Build an original mobile product inspired by Unroll.Me's public communication workflow. The V1 clone focuses on email subscription management tool with automatic detection of all email subscriptions, one-tap unsubscribe from unwanted mailing lists, Rollup feature to bundle selected subscriptions into a single daily digest email, subscription list with sender previews, add or remove subscriptions from Rollup, unsubscribe history tracking, multi-account support (Gmail, Outlook, Yahoo, AOL), simple swipe interface for keep/unsubscribe/rollup decisions, push notifications for new subscription detection, and free model with data monetization disclosure (anonymized, aggregated purchase data via Edison/Slice Intelligence history).
...
- Preserve the functional job behind Unroll.Me while using original product naming, original UI, original sample data, and licensed integrations.
...
- Do not copy Unroll.Me branding, logos, screenshots, marketing copy, private APIs, proprietary datasets, plan names, UI trade dress, course libraries, textbook solutions, documents, school content, AI prompts, or protected media.
...
|---|---|---|---|
| Apple App Store | https://apps.apple.com/us/app/unroll-me-email-cleanup/id1532710893 | iOS listing, privacy labels, release notes, email subscription management claims, and support links | Verified public URL or explicit platform blocker on 2026-05-06; hands-on native behavior still blocked. |
| Google Play | https://play.google.com/store/apps/details?id=com.unrollme | Android listing, data safety, unsubscribe/rollup claims, and release cadence | Verified public URL or explicit platform blocker on 2026-05-06; hands-on native behavior still blocked. |
| Official product site | https://unroll.me/ | Unroll.Me email subscription management, Rollup, and product positioning | Verified public URL or explicit platform blocker on 2026-05-06; hands-on native behavior still blocked. |
| Official help | https://support.unroll.me/ | Unroll.Me app help, setup, and troubleshooting | Verified public URL or explicit platform blocker on 2026-05-06; hands-on native behavior still blocked. |
| Privacy policy | https://unroll.me/legal/privacy | Unroll.Me data collection, data monetization disclosure, and privacy practices | Verified public URL or explicit platform blocker on 2026-05-06; hands-on native behavior still blocked. |
| Terms | https://unroll.me/legal/terms | Unroll.Me services, email access terms, and acceptable-use boundaries | Verified public URL or explicit platform blocker on 2026-05-06; hands-on native behavior still blocked. |
...
- Manual blockers must remain launch-blocking until verified: Unroll.Me account and email account linking (Gmail OAuth, Outlook OAuth, Yahoo, AOL), subscription detection algorithm (scanning for mailing list headers, common newsletter patterns), one-tap unsubscribe execution (List-Unsubscribe header parsing, automated unsubscribe link following), Rollup digest email generation and delivery scheduling, subscription list maintenance and sender preview rendering, add/remove from Rollup toggling and immediate effect, unsubscribe history tracking and confirmation verification, multi-account subscription aggregation, swipe interface keep/unsubscribe/rollup gesture handling, new subscription detection and notification, data monetization transparency (historical Slice Intelligence/Edison partnership, FTC scrutiny, current data practices), privacy disclosure compliance and user consent for data sharing, rate limiting for bulk unsubscribe operations, and Unroll.Me account integration.

## Core User Journeys

- User creates or restores a Unroll.Me-style account, completes role, school, subscription, or tenant checks, and reaches the dashboard.
...
- Monetization model: use original free/trial/paid/sponsored/school/provider/tenant entitlement logic; do not copy exact pricing, plan names, bundle names, promotional copy, school contracts, tenant offers, or partner offers from Unroll.Me.
...
- Manual verification tests for Unroll.Me account and email account linking (Gmail OAuth, Outlook OAuth, Yahoo, AOL), subscription detection algorithm (scanning for mailing list headers, common newsletter patterns), one-tap unsubscribe execution (List-Unsubscribe header parsing, automated unsubscribe link following), Rollup digest email generation and delivery scheduling, subscription list maintenance and sender preview rendering, add/remove from Rollup toggling and immediate effect, unsubscribe history tracking and confirmation verification, multi-account subscription aggregation, swipe interface keep/unsubscribe/rollup gesture handling, new subscription detection and notification, data monetization transparency (historical Slice Intelligence/Edison partnership, FTC scrutiny, current data practices), privacy disclosure compliance and user consent for data sharing, rate limiting for bulk unsubscribe operations, and Unroll.Me account integration.
...
- Phase 4: Add app-specific safety controls for email subscription management tool with automatic detection of all email subscriptions, one-tap unsubscribe from unwanted mailing lists, Rollup feature to bundle selected subscriptions into a single daily digest email, subscription list with sender previews, add or remove subscriptions from Rollup, unsubscribe history tracking, multi-account support (Gmail, Outlook, Yahoo, AOL), simple swipe interface for keep/unsubscribe/rollup decisions, push notifications for new subscription detection, and free model with data monetization disclosure (anonymized, aggregated purchase data via Edison/Slice Intelligence history).
...
- Confirm legal/privacy retention behavior for Unroll.Me-style sensitive records and update API contracts before downstream implementation.
