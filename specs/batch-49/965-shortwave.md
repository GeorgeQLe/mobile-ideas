# Shortwave-Style Clone Spec

> Metadata
> - Inspiration app: Shortwave
...
> - Manual verification blockers: Shortwave account and Gmail OAuth linking (Gmail-only platform), AI email summarization and writing assistance (LLM integration, data handling, context window), smart inbox automatic bundling algorithm (grouping by sender, topic, thread), AI search natural language query processing over email corpus, instant scheduling and Google Calendar integration, To-Do list email task management and completion tracking, shared channels team collaboration mapped to email, real-time typing indicators in email context, emoji reaction rendering on email messages, customizable notification controls per bundle/channel, keyboard shortcut navigation, Gmail API dependency and quota management, data handling transparency (server-side email processing for AI features), and Shortwave account integration.
...
Build an original mobile product inspired by Shortwave's public communication workflow. The V1 clone focuses on AI-native email client built on Gmail with AI-powered email summarization and writing assistance, smart inbox with automatic bundling of related emails, AI search with natural language queries, instant scheduling and calendar integration, To-Do list for email task management, shared channels for team email collaboration, real-time typing indicators, emoji reactions on emails, customizable notification controls, dark mode, keyboard shortcuts, push notifications, and freemium model with Shortwave Free, Pro, and Business plans.
...
- Preserve the functional job behind Shortwave while using original product naming, original UI, original sample data, and licensed integrations.
...
- Do not copy Shortwave branding, logos, screenshots, marketing copy, private APIs, proprietary datasets, plan names, UI trade dress, course libraries, textbook solutions, documents, school content, AI prompts, or protected media.
...
|---|---|---|---|
| Apple App Store | https://apps.apple.com/us/app/shortwave-ai-email/id1589656970 | iOS listing, privacy labels, release notes, AI email claims, and support links | Verified public URL or explicit platform blocker on 2026-05-06; hands-on native behavior still blocked. |
| Google Play | https://play.google.com/store/apps/details?id=com.shortwave.android | Android listing, data safety, AI email/Gmail claims, and release cadence | Verified public URL or explicit platform blocker on 2026-05-06; hands-on native behavior still blocked. |
| Official product site | https://www.shortwave.com/ | Shortwave AI email, smart inbox, and product positioning | Verified public URL or explicit platform blocker on 2026-05-06; hands-on native behavior still blocked. |
| Official help | https://www.shortwave.com/help | Shortwave app help, setup, and troubleshooting | Verified public URL or explicit platform blocker on 2026-05-06; hands-on native behavior still blocked. |
| Privacy policy | https://www.shortwave.com/privacy | Shortwave data collection, AI data handling, and privacy disclosures | Verified public URL or explicit platform blocker on 2026-05-06; hands-on native behavior still blocked. |
| Terms | https://www.shortwave.com/terms | Shortwave services, email terms, and acceptable-use boundaries | Verified public URL or explicit platform blocker on 2026-05-06; hands-on native behavior still blocked. |
...
- Manual blockers must remain launch-blocking until verified: Shortwave account and Gmail OAuth linking (Gmail-only platform), AI email summarization and writing assistance (LLM integration, data handling, context window), smart inbox automatic bundling algorithm (grouping by sender, topic, thread), AI search natural language query processing over email corpus, instant scheduling and Google Calendar integration, To-Do list email task management and completion tracking, shared channels team collaboration mapped to email, real-time typing indicators in email context, emoji reaction rendering on email messages, customizable notification controls per bundle/channel, keyboard shortcut navigation, Gmail API dependency and quota management, data handling transparency (server-side email processing for AI features), and Shortwave account integration.

## Core User Journeys

- User creates or restores a Shortwave-style account, completes role, school, subscription, or tenant checks, and reaches the dashboard.
...
- Monetization model: use original free/trial/paid/sponsored/school/provider/tenant entitlement logic; do not copy exact pricing, plan names, bundle names, promotional copy, school contracts, tenant offers, or partner offers from Shortwave.
...
- Manual verification tests for Shortwave account and Gmail OAuth linking (Gmail-only platform), AI email summarization and writing assistance (LLM integration, data handling, context window), smart inbox automatic bundling algorithm (grouping by sender, topic, thread), AI search natural language query processing over email corpus, instant scheduling and Google Calendar integration, To-Do list email task management and completion tracking, shared channels team collaboration mapped to email, real-time typing indicators in email context, emoji reaction rendering on email messages, customizable notification controls per bundle/channel, keyboard shortcut navigation, Gmail API dependency and quota management, data handling transparency (server-side email processing for AI features), and Shortwave account integration.
...
- Phase 4: Add app-specific safety controls for AI-native email client built on Gmail with AI-powered email summarization and writing assistance, smart inbox with automatic bundling of related emails, AI search with natural language queries, instant scheduling and calendar integration, To-Do list for email task management, shared channels for team email collaboration, real-time typing indicators, emoji reactions on emails, customizable notification controls, dark mode, keyboard shortcuts, push notifications, and freemium model with Shortwave Free, Pro, and Business plans.
...
- Confirm legal/privacy retention behavior for Shortwave-style sensitive records and update API contracts before downstream implementation.
