# Superhuman-Style Clone Spec

> Metadata
> - Inspiration app: Superhuman
...
> - Manual verification blockers: Superhuman account and waitlist/invitation flow (historically invite-only), Gmail and Outlook OAuth account linking, keyboard-first navigation and command palette (Cmd+K) implementation, Split Inbox automatic categorization algorithm (VIP, Important, Other, Newsletters), Superhuman AI email triage, summarization, and auto-draft generation (LLM integration, data handling), Instant Reply AI-generated response draft quality and personalization, Remind Me follow-up scheduling and return-to-inbox timing, Undo Send configurable delay and delivery cancellation, Read Status tracking pixel implementation and privacy considerations, Snippets template storage and insertion, social insights sender profile aggregation (LinkedIn, Twitter, company data), team features shared snippet library and email delegation, speed optimization (preloading, predictive caching, instant search), push notification delivery, premium subscription entitlement (no free tier), and Superhuman account integration.
...
Build an original mobile product inspired by Superhuman's public communication workflow. The V1 clone focuses on premium high-speed email client with keyboard-first design and speed optimizations, Split Inbox with automatic sender categorization (VIP, Important, Other, Newsletters), AI-powered triage and auto-summarization (Superhuman AI), Instant Reply with AI-generated response drafts, Remind Me for follow-up scheduling, Undo Send with configurable delay, Read Statuses to see when emails are opened, Snippets for reusable text templates, unified inbox for Gmail and Outlook accounts, scheduled send, social insights showing sender context and social profiles, team features with shared snippets and delegation, push notifications, and premium subscription-only model (no free tier).
...
- Preserve the functional job behind Superhuman while using original product naming, original UI, original sample data, and licensed integrations.
...
- Do not copy Superhuman branding, logos, screenshots, marketing copy, private APIs, proprietary datasets, plan names, UI trade dress, course libraries, textbook solutions, documents, school content, AI prompts, or protected media.
...
|---|---|---|---|
| Apple App Store | https://apps.apple.com/us/app/superhuman-email/id1271265416 | iOS listing, privacy labels, release notes, fast email/AI claims, and support links | Verified public URL or explicit platform blocker on 2026-05-06; hands-on native behavior still blocked. |
| Google Play | https://play.google.com/store/apps/details?id=com.superhuman.mail | Android listing, data safety, premium email/AI claims, and release cadence | Verified public URL or explicit platform blocker on 2026-05-06; hands-on native behavior still blocked. |
| Official product site | https://superhuman.com/ | Superhuman fast email, AI features, and product positioning | Verified public URL or explicit platform blocker on 2026-05-06; hands-on native behavior still blocked. |
| Official help | https://support.superhuman.com/ | Superhuman app help, setup, and troubleshooting | Verified public URL or explicit platform blocker on 2026-05-06; hands-on native behavior still blocked. |
| Privacy policy | https://superhuman.com/privacy | Superhuman data collection, AI data handling, read status, and privacy disclosures | Verified public URL or explicit platform blocker on 2026-05-06; hands-on native behavior still blocked. |
| Terms | https://superhuman.com/terms | Superhuman services, email terms, and acceptable-use boundaries | Verified public URL or explicit platform blocker on 2026-05-06; hands-on native behavior still blocked. |
...
- Manual blockers must remain launch-blocking until verified: Superhuman account and waitlist/invitation flow (historically invite-only), Gmail and Outlook OAuth account linking, keyboard-first navigation and command palette (Cmd+K) implementation, Split Inbox automatic categorization algorithm (VIP, Important, Other, Newsletters), Superhuman AI email triage, summarization, and auto-draft generation (LLM integration, data handling), Instant Reply AI-generated response draft quality and personalization, Remind Me follow-up scheduling and return-to-inbox timing, Undo Send configurable delay and delivery cancellation, Read Status tracking pixel implementation and privacy considerations, Snippets template storage and insertion, social insights sender profile aggregation (LinkedIn, Twitter, company data), team features shared snippet library and email delegation, speed optimization (preloading, predictive caching, instant search), push notification delivery, premium subscription entitlement (no free tier), and Superhuman account integration.

## Core User Journeys

- User creates or restores a Superhuman-style account, completes role, school, subscription, or tenant checks, and reaches the dashboard.
...
- Monetization model: use original free/trial/paid/sponsored/school/provider/tenant entitlement logic; do not copy exact pricing, plan names, bundle names, promotional copy, school contracts, tenant offers, or partner offers from Superhuman.
...
- Manual verification tests for Superhuman account and waitlist/invitation flow (historically invite-only), Gmail and Outlook OAuth account linking, keyboard-first navigation and command palette (Cmd+K) implementation, Split Inbox automatic categorization algorithm (VIP, Important, Other, Newsletters), Superhuman AI email triage, summarization, and auto-draft generation (LLM integration, data handling), Instant Reply AI-generated response draft quality and personalization, Remind Me follow-up scheduling and return-to-inbox timing, Undo Send configurable delay and delivery cancellation, Read Status tracking pixel implementation and privacy considerations, Snippets template storage and insertion, social insights sender profile aggregation (LinkedIn, Twitter, company data), team features shared snippet library and email delegation, speed optimization (preloading, predictive caching, instant search), push notification delivery, premium subscription entitlement (no free tier), and Superhuman account integration.
...
- Phase 4: Add app-specific safety controls for premium high-speed email client with keyboard-first design and speed optimizations, Split Inbox with automatic sender categorization (VIP, Important, Other, Newsletters), AI-powered triage and auto-summarization (Superhuman AI), Instant Reply with AI-generated response drafts, Remind Me for follow-up scheduling, Undo Send with configurable delay, Read Statuses to see when emails are opened, Snippets for reusable text templates, unified inbox for Gmail and Outlook accounts, scheduled send, social insights showing sender context and social profiles, team features with shared snippets and delegation, push notifications, and premium subscription-only model (no free tier).
...
- Confirm legal/privacy retention behavior for Superhuman-style sensitive records and update API contracts before downstream implementation.
