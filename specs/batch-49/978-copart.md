# Copart-Style Clone Spec

> Metadata
> - Inspiration app: Copart
> - Category: Shopping
...
> - Manual verification blockers: Copart account creation and member verification (ID verification, deposit requirement), real-time virtual bidding infrastructure (VB3 auction technology, bid streaming, latency requirements), vehicle search with auction-specific filtering (make, model, year, damage type, sale date, location, odometer, title type), lot detail page with vehicle photos, condition reports, damage descriptions, and sale information, pre-bidding and proxy bid placement and management, Member area with bidding history, won lots, invoices, and account management, vehicle condition grading system and damage category taxonomy, sale calendar with auction scheduling and timezone handling, CashForCars instant offer and vehicle pickup logistics, shipping and transportation quote integration (third-party carriers), title and document processing (state-specific salvage title, rebuilt title, clean title), buyer fees calculation and deposit management, Member and Premier Member tier entitlement and benefits, push notification for bid updates, outbid alerts, and sale reminders, auction compliance and regulatory requirements (state salvage laws), and Copart account integration.
...
Build an original mobile product inspired by Copart's public shopping workflow. The V1 clone focuses on online vehicle auction platform for salvage, insurance, and clean title vehicles with real-time and virtual bidding (VB3 virtual auction technology), vehicle search by make, model, year, damage type, sale date, and location, detailed lot pages with vehicle photos, condition reports, and damage descriptions, pre-bidding and proxy bidding before live auction, Member area with bidding history, won lots, and account management, vehicle condition grading (run and drive, starts, enhanced vehicles, stationary), sale calendar with upcoming auction dates and times, CashForCars instant offer for selling vehicles, shipping and transportation quotes, title and document processing, buyer fees and deposit requirements, Copart Member and Premier Member tiers, push notifications for bid updates and sale reminders, and membership-based model with buyer fees per transaction.
...
- Preserve the functional job behind Copart while using original product naming, original UI, original sample data, and licensed integrations.
...
- Do not copy Copart branding, logos, screenshots, marketing copy, private APIs, proprietary datasets, plan names, UI trade dress, course libraries, textbook solutions, documents, school content, AI prompts, or protected media.
...
|---|---|---|---|
| Apple App Store | https://apps.apple.com/us/app/copart-online-auto-auctions/id800734963 | iOS listing, privacy labels, release notes, vehicle auction claims, and support links | Verified public URL or explicit platform blocker on 2026-05-06; hands-on native behavior still blocked. |
| Google Play | https://play.google.com/store/apps/details?id=com.copart.membermobile | Android listing, data safety, vehicle auction/bidding claims, and release cadence | Verified public URL or explicit platform blocker on 2026-05-06; hands-on native behavior still blocked. |
| Official product site | https://www.copart.com/ | Copart online vehicle auctions, salvage cars, and product positioning | Verified public URL or explicit platform blocker on 2026-05-06; hands-on native behavior still blocked. |
| Official help | https://www.copart.com/content/us/en/support | Copart app help, auctions, and troubleshooting | Verified public URL or explicit platform blocker on 2026-05-06; hands-on native behavior still blocked. |
| Privacy policy | https://www.copart.com/content/us/en/privacy-notice | Copart data collection, auction data, and privacy disclosures | Verified public URL or explicit platform blocker on 2026-05-06; hands-on native behavior still blocked. |
| Terms | https://www.copart.com/content/us/en/member-terms-and-conditions | Copart services, auction terms, and acceptable-use boundaries | Verified public URL or explicit platform blocker on 2026-05-06; hands-on native behavior still blocked. |
...
- Manual blockers must remain launch-blocking until verified: Copart account creation and member verification (ID verification, deposit requirement), real-time virtual bidding infrastructure (VB3 auction technology, bid streaming, latency requirements), vehicle search with auction-specific filtering (make, model, year, damage type, sale date, location, odometer, title type), lot detail page with vehicle photos, condition reports, damage descriptions, and sale information, pre-bidding and proxy bid placement and management, Member area with bidding history, won lots, invoices, and account management, vehicle condition grading system and damage category taxonomy, sale calendar with auction scheduling and timezone handling, CashForCars instant offer and vehicle pickup logistics, shipping and transportation quote integration (third-party carriers), title and document processing (state-specific salvage title, rebuilt title, clean title), buyer fees calculation and deposit management, Member and Premier Member tier entitlement and benefits, push notification for bid updates, outbid alerts, and sale reminders, auction compliance and regulatory requirements (state salvage laws), and Copart account integration.

## Core User Journeys

- User creates or restores a Copart-style account, completes role, school, subscription, or tenant checks, and reaches the dashboard.
...
- Monetization model: use original free/trial/paid/sponsored/school/provider/tenant entitlement logic; do not copy exact pricing, plan names, bundle names, promotional copy, school contracts, tenant offers, or partner offers from Copart.
...
- Manual verification tests for Copart account creation and member verification (ID verification, deposit requirement), real-time virtual bidding infrastructure (VB3 auction technology, bid streaming, latency requirements), vehicle search with auction-specific filtering (make, model, year, damage type, sale date, location, odometer, title type), lot detail page with vehicle photos, condition reports, damage descriptions, and sale information, pre-bidding and proxy bid placement and management, Member area with bidding history, won lots, invoices, and account management, vehicle condition grading system and damage category taxonomy, sale calendar with auction scheduling and timezone handling, CashForCars instant offer and vehicle pickup logistics, shipping and transportation quote integration (third-party carriers), title and document processing (state-specific salvage title, rebuilt title, clean title), buyer fees calculation and deposit management, Member and Premier Member tier entitlement and benefits, push notification for bid updates, outbid alerts, and sale reminders, auction compliance and regulatory requirements (state salvage laws), and Copart account integration.
...
- Phase 4: Add app-specific safety controls for online vehicle auction platform for salvage, insurance, and clean title vehicles with real-time and virtual bidding (VB3 virtual auction technology), vehicle search by make, model, year, damage type, sale date, and location, detailed lot pages with vehicle photos, condition reports, and damage descriptions, pre-bidding and proxy bidding before live auction, Member area with bidding history, won lots, and account management, vehicle condition grading (run and drive, starts, enhanced vehicles, stationary), sale calendar with upcoming auction dates and times, CashForCars instant offer for selling vehicles, shipping and transportation quotes, title and document processing, buyer fees and deposit requirements, Copart Member and Premier Member tiers, push notifications for bid updates and sale reminders, and membership-based model with buyer fees per transaction.
...
- Confirm legal/privacy retention behavior for Copart-style sensitive records and update API contracts before downstream implementation.
