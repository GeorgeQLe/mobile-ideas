# Spike-Style Clone Spec

> Metadata
> - Inspiration app: Spike
...
> - Manual verification blockers: Spike account and email account linking (Gmail OAuth, Outlook OAuth, iCloud, Yahoo, IMAP/SMTP), conversational bubble rendering from standard email format (header stripping, quote collapsing, thread grouping), Priority Inbox sender categorization algorithm (People, Other, Newsletters), real-time collaboration Spike Notes (CRDT or OT sync for shared documents), group chat channels mapped to email threads, video meeting infrastructure integrated with email, voice message recording and delivery as email attachment, email scheduling and snooze queue, advanced search with natural language, file manager aggregation from email attachments, read receipt tracking and delivery confirmation, multi-account folder sync and unified inbox, push notification smart filtering logic, data handling transparency (server-side email processing), and Spike account integration.
...
Build an original mobile product inspired by Spike's public communication workflow. The V1 clone focuses on conversational email platform that transforms email into chat-like bubbles, unified inbox for multiple accounts (Gmail, Outlook, iCloud, Yahoo, IMAP), Priority Inbox with smart sender categorization, real-time collaboration with Spike Notes (shared documents), group chat channels on top of email, video meetings built into email, voice messages, email scheduling and snooze, advanced search, file manager for email attachments, read receipts, push notifications with smart filtering, and freemium model with Spike Free, Pro, and Business plans.
...
- Preserve the functional job behind Spike while using original product naming, original UI, original sample data, and licensed integrations.
...
- Do not copy Spike branding, logos, screenshots, marketing copy, private APIs, proprietary datasets, plan names, UI trade dress, course libraries, textbook solutions, documents, school content, AI prompts, or protected media.
...
|---|---|---|---|
| Apple App Store | https://apps.apple.com/us/app/spike-email-messenger-more/id707452888 | iOS listing, privacy labels, release notes, conversational email claims, and support links | Verified public URL or explicit platform blocker on 2026-05-06; hands-on native behavior still blocked. |
| Google Play | https://play.google.com/store/apps/details?id=com.pingapp.app | Android listing, data safety, conversational email/collaboration claims, and release cadence | Verified public URL or explicit platform blocker on 2026-05-06; hands-on native behavior still blocked. |
| Official product site | https://www.spikenow.com/ | Spike conversational email, collaboration, and product positioning | Verified public URL or explicit platform blocker on 2026-05-06; hands-on native behavior still blocked. |
| Official help | https://www.spikenow.com/help/ | Spike app help, setup, and troubleshooting | Verified public URL or explicit platform blocker on 2026-05-06; hands-on native behavior still blocked. |
| Privacy policy | https://www.spikenow.com/privacy-policy/ | Spike data collection, email processing, and privacy disclosures | Verified public URL or explicit platform blocker on 2026-05-06; hands-on native behavior still blocked. |
| Terms | https://www.spikenow.com/terms-of-use/ | Spike services, email terms, and acceptable-use boundaries | Verified public URL or explicit platform blocker on 2026-05-06; hands-on native behavior still blocked. |
...
- Manual blockers must remain launch-blocking until verified: Spike account and email account linking (Gmail OAuth, Outlook OAuth, iCloud, Yahoo, IMAP/SMTP), conversational bubble rendering from standard email format (header stripping, quote collapsing, thread grouping), Priority Inbox sender categorization algorithm (People, Other, Newsletters), real-time collaboration Spike Notes (CRDT or OT sync for shared documents), group chat channels mapped to email threads, video meeting infrastructure integrated with email, voice message recording and delivery as email attachment, email scheduling and snooze queue, advanced search with natural language, file manager aggregation from email attachments, read receipt tracking and delivery confirmation, multi-account folder sync and unified inbox, push notification smart filtering logic, data handling transparency (server-side email processing), and Spike account integration.

## Core User Journeys

- User creates or restores a Spike-style account, completes role, school, subscription, or tenant checks, and reaches the dashboard.
...
- Monetization model: use original free/trial/paid/sponsored/school/provider/tenant entitlement logic; do not copy exact pricing, plan names, bundle names, promotional copy, school contracts, tenant offers, or partner offers from Spike.
...
- Manual verification tests for Spike account and email account linking (Gmail OAuth, Outlook OAuth, iCloud, Yahoo, IMAP/SMTP), conversational bubble rendering from standard email format (header stripping, quote collapsing, thread grouping), Priority Inbox sender categorization algorithm (People, Other, Newsletters), real-time collaboration Spike Notes (CRDT or OT sync for shared documents), group chat channels mapped to email threads, video meeting infrastructure integrated with email, voice message recording and delivery as email attachment, email scheduling and snooze queue, advanced search with natural language, file manager aggregation from email attachments, read receipt tracking and delivery confirmation, multi-account folder sync and unified inbox, push notification smart filtering logic, data handling transparency (server-side email processing), and Spike account integration.
...
- Phase 4: Add app-specific safety controls for conversational email platform that transforms email into chat-like bubbles, unified inbox for multiple accounts (Gmail, Outlook, iCloud, Yahoo, IMAP), Priority Inbox with smart sender categorization, real-time collaboration with Spike Notes (shared documents), group chat channels on top of email, video meetings built into email, voice messages, email scheduling and snooze, advanced search, file manager for email attachments, read receipts, push notifications with smart filtering, and freemium model with Spike Free, Pro, and Business plans.
...
- Confirm legal/privacy retention behavior for Spike-style sensitive records and update API contracts before downstream implementation.
