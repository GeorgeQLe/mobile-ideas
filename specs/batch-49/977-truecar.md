# TrueCar-Style Clone Spec

> Metadata
> - Inspiration app: TrueCar
> - Category: Shopping
...
> - Manual verification blockers: TrueCar account creation, TrueCar Price Curve algorithm and data aggregation (transaction price data, market analysis), upfront pricing from Certified Dealer network (dealer agreement, price guarantee), new and used vehicle search with multi-attribute filtering, vehicle detail page with market context and pricing analysis display, dealer inventory with pre-negotiated pricing integration, trade-in value estimation and cash offer algorithm (vehicle condition, market data), build and price tool for new vehicles (OEM configuration data, option packages, MSRP), TrueCar Military and partner discount program validation and enrollment, dealer review and rating aggregation, saved vehicles and searches with price alert triggers, vehicle comparison tool with side-by-side analysis, finance calculator with loan term and APR estimation, push notification for price alerts and new matches, Certified Dealer network management and lead distribution, and TrueCar account integration.
...
Build an original mobile product inspired by TrueCar's public shopping workflow. The V1 clone focuses on vehicle pricing transparency and shopping platform with TrueCar Price Curves showing what others paid for the same vehicle, upfront pricing from TrueCar Certified Dealers, new and used vehicle search with make, model, year, price, and feature filters, vehicle detail pages with market context and pricing analysis, dealer inventory with pre-negotiated pricing, trade-in value estimation and cash offer, build and price tool for new vehicles with configuration options, TrueCar Military and partner discount programs, dealer reviews and ratings, saved vehicles and searches with price alerts, vehicle comparison tool, finance calculator, push notifications for price alerts and matches, and free consumer model with dealer network subscription for lead generation.
...
- Preserve the functional job behind TrueCar while using original product naming, original UI, original sample data, and licensed integrations.
...
- Do not copy TrueCar branding, logos, screenshots, marketing copy, private APIs, proprietary datasets, plan names, UI trade dress, course libraries, textbook solutions, documents, school content, AI prompts, or protected media.
...
|---|---|---|---|
| Apple App Store | https://apps.apple.com/us/app/truecar-used-cars-new-cars/id327725498 | iOS listing, privacy labels, release notes, pricing transparency/car shopping claims, and support links | Verified public URL or explicit platform blocker on 2026-05-06; hands-on native behavior still blocked. |
| Google Play | https://play.google.com/store/apps/details?id=com.truecar.mobile.android.consumer | Android listing, data safety, vehicle pricing/dealer claims, and release cadence | Verified public URL or explicit platform blocker on 2026-05-06; hands-on native behavior still blocked. |
| Official product site | https://www.truecar.com/ | TrueCar pricing transparency, upfront pricing, and product positioning | Verified public URL or explicit platform blocker on 2026-05-06; hands-on native behavior still blocked. |
| Official help | https://www.truecar.com/help/ | TrueCar app help, pricing, and troubleshooting | Verified public URL or explicit platform blocker on 2026-05-06; hands-on native behavior still blocked. |
| Privacy policy | https://www.truecar.com/privacy/ | TrueCar data collection, pricing data, and privacy disclosures | Verified public URL or explicit platform blocker on 2026-05-06; hands-on native behavior still blocked. |
| Terms | https://www.truecar.com/terms/ | TrueCar services, marketplace terms, and acceptable-use boundaries | Verified public URL or explicit platform blocker on 2026-05-06; hands-on native behavior still blocked. |
...
- Manual blockers must remain launch-blocking until verified: TrueCar account creation, TrueCar Price Curve algorithm and data aggregation (transaction price data, market analysis), upfront pricing from Certified Dealer network (dealer agreement, price guarantee), new and used vehicle search with multi-attribute filtering, vehicle detail page with market context and pricing analysis display, dealer inventory with pre-negotiated pricing integration, trade-in value estimation and cash offer algorithm (vehicle condition, market data), build and price tool for new vehicles (OEM configuration data, option packages, MSRP), TrueCar Military and partner discount program validation and enrollment, dealer review and rating aggregation, saved vehicles and searches with price alert triggers, vehicle comparison tool with side-by-side analysis, finance calculator with loan term and APR estimation, push notification for price alerts and new matches, Certified Dealer network management and lead distribution, and TrueCar account integration.

## Core User Journeys

- User creates or restores a TrueCar-style account, completes role, school, subscription, or tenant checks, and reaches the dashboard.
...
- Monetization model: use original free/trial/paid/sponsored/school/provider/tenant entitlement logic; do not copy exact pricing, plan names, bundle names, promotional copy, school contracts, tenant offers, or partner offers from TrueCar.
...
- Manual verification tests for TrueCar account creation, TrueCar Price Curve algorithm and data aggregation (transaction price data, market analysis), upfront pricing from Certified Dealer network (dealer agreement, price guarantee), new and used vehicle search with multi-attribute filtering, vehicle detail page with market context and pricing analysis display, dealer inventory with pre-negotiated pricing integration, trade-in value estimation and cash offer algorithm (vehicle condition, market data), build and price tool for new vehicles (OEM configuration data, option packages, MSRP), TrueCar Military and partner discount program validation and enrollment, dealer review and rating aggregation, saved vehicles and searches with price alert triggers, vehicle comparison tool with side-by-side analysis, finance calculator with loan term and APR estimation, push notification for price alerts and new matches, Certified Dealer network management and lead distribution, and TrueCar account integration.
...
- Phase 4: Add app-specific safety controls for vehicle pricing transparency and shopping platform with TrueCar Price Curves showing what others paid for the same vehicle, upfront pricing from TrueCar Certified Dealers, new and used vehicle search with make, model, year, price, and feature filters, vehicle detail pages with market context and pricing analysis, dealer inventory with pre-negotiated pricing, trade-in value estimation and cash offer, build and price tool for new vehicles with configuration options, TrueCar Military and partner discount programs, dealer reviews and ratings, saved vehicles and searches with price alerts, vehicle comparison tool, finance calculator, push notifications for price alerts and matches, and free consumer model with dealer network subscription for lead generation.
...
- Confirm legal/privacy retention behavior for TrueCar-style sensitive records and update API contracts before downstream implementation.
