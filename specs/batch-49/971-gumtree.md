# Gumtree-Style Clone Spec

> Metadata
> - Inspiration app: Gumtree
> - Category: Shopping
...
> - Manual verification blockers: Gumtree account creation and verification, broad category taxonomy (for sale, property, jobs, motors, services, community), location-based browsing with UK postcode and AU suburb radius filtering, photo listing creation with multi-photo upload, in-app messaging infrastructure for buyer-seller communication, motors section vehicle-specific filters (make, model, year, mileage, fuel type, body type), saved searches with push and email alert triggers, user profile with active ad management, featured and urgent ad paid promotion system, price alert tracking for saved search items, distance sorting and map view integration, content moderation for listings and messages, fraud and scam detection, UK and AU regulatory compliance for classified ads, regional availability (UK, AU, South Africa markets), and Gumtree account integration.
...
Build an original mobile product inspired by Gumtree's public shopping workflow. The V1 clone focuses on UK and Australia-focused local classifieds marketplace with broad category coverage (for sale, property, jobs, motors, services, community), location-based browsing with postcode and radius filtering, photo listings with detailed descriptions and pricing, in-app messaging for buyer-seller communication, motors section with vehicle-specific filters (make, model, year, mileage, fuel type), saved searches with email and push alerts, user profiles with active ad listings, featured and urgent ad promotions, price alerts for saved searches, distance sorting and map view, community safety tips, push notifications for messages and alerts, and free listing model with optional paid promotion tiers.
...
- Preserve the functional job behind Gumtree while using original product naming, original UI, original sample data, and licensed integrations.
...
- Do not copy Gumtree branding, logos, screenshots, marketing copy, private APIs, proprietary datasets, plan names, UI trade dress, course libraries, textbook solutions, documents, school content, AI prompts, or protected media.
...
|---|---|---|---|
| Apple App Store | https://apps.apple.com/gb/app/gumtree-local-ads-buy-sell/id487946492 | iOS listing (UK), privacy labels, release notes, classifieds claims, and support links | Verified public URL or explicit platform blocker on 2026-05-06; hands-on native behavior still blocked. |
| Google Play | https://play.google.com/store/apps/details?id=com.gumtree.android | Android listing, data safety, UK classifieds claims, and release cadence | Verified public URL or explicit platform blocker on 2026-05-06; hands-on native behavior still blocked. |
| Official product site | https://www.gumtree.com/ | Gumtree UK classifieds, categories, and product positioning | Verified public URL or explicit platform blocker on 2026-05-06; hands-on native behavior still blocked. |
| Official help | https://help.gumtree.com/ | Gumtree app help, listings, and troubleshooting | Verified public URL or explicit platform blocker on 2026-05-06; hands-on native behavior still blocked. |
| Privacy policy | https://www.gumtree.com/privacy_policy | Gumtree data collection, listing data, and privacy disclosures | Verified public URL or explicit platform blocker on 2026-05-06; hands-on native behavior still blocked. |
| Terms | https://www.gumtree.com/terms_of_use | Gumtree services, classifieds terms, and acceptable-use boundaries | Verified public URL or explicit platform blocker on 2026-05-06; hands-on native behavior still blocked. |
...
- Manual blockers must remain launch-blocking until verified: Gumtree account creation and verification, broad category taxonomy (for sale, property, jobs, motors, services, community), location-based browsing with UK postcode and AU suburb radius filtering, photo listing creation with multi-photo upload, in-app messaging infrastructure for buyer-seller communication, motors section vehicle-specific filters (make, model, year, mileage, fuel type, body type), saved searches with push and email alert triggers, user profile with active ad management, featured and urgent ad paid promotion system, price alert tracking for saved search items, distance sorting and map view integration, content moderation for listings and messages, fraud and scam detection, UK and AU regulatory compliance for classified ads, regional availability (UK, AU, South Africa markets), and Gumtree account integration.

## Core User Journeys

- User creates or restores a Gumtree-style account, completes role, school, subscription, or tenant checks, and reaches the dashboard.
...
- Monetization model: use original free/trial/paid/sponsored/school/provider/tenant entitlement logic; do not copy exact pricing, plan names, bundle names, promotional copy, school contracts, tenant offers, or partner offers from Gumtree.
...
- Manual verification tests for Gumtree account creation and verification, broad category taxonomy (for sale, property, jobs, motors, services, community), location-based browsing with UK postcode and AU suburb radius filtering, photo listing creation with multi-photo upload, in-app messaging infrastructure for buyer-seller communication, motors section vehicle-specific filters (make, model, year, mileage, fuel type, body type), saved searches with push and email alert triggers, user profile with active ad management, featured and urgent ad paid promotion system, price alert tracking for saved search items, distance sorting and map view integration, content moderation for listings and messages, fraud and scam detection, UK and AU regulatory compliance for classified ads, regional availability (UK, AU, South Africa markets), and Gumtree account integration.
...
- Phase 4: Add app-specific safety controls for UK and Australia-focused local classifieds marketplace with broad category coverage (for sale, property, jobs, motors, services, community), location-based browsing with postcode and radius filtering, photo listings with detailed descriptions and pricing, in-app messaging for buyer-seller communication, motors section with vehicle-specific filters (make, model, year, mileage, fuel type), saved searches with email and push alerts, user profiles with active ad listings, featured and urgent ad promotions, price alerts for saved searches, distance sorting and map view, community safety tips, push notifications for messages and alerts, and free listing model with optional paid promotion tiers.
...
- Confirm legal/privacy retention behavior for Gumtree-style sensitive records and update API contracts before downstream implementation.
