# AutoTrader-Style Clone Spec

> Metadata
> - Inspiration app: AutoTrader
> - Category: Shopping
...
> - Manual verification blockers: AutoTrader account creation, comprehensive vehicle search with multi-attribute filtering (make, model, year, price, mileage, body type, fuel type, drivetrain, features, distance, color), vehicle detail page with photo gallery, specs, and dealer info, Kelley Blue Book price advisor integration and fair market value estimation, dealer inventory aggregation and dealer review management, direct dealer contact and lead submission infrastructure, trade-in value estimator powered by KBB data, vehicle comparison with side-by-side spec analysis, saved searches with price drop alert triggers, vehicle history and Carfax report link integration, finance tools and payment calculator (loan terms, APR, down payment), home delivery and virtual deal option availability, push notification for price drops and new matches, VIN decoding and vehicle specification database, content moderation for listings and reviews, and AutoTrader account integration.
...
Build an original mobile product inspired by AutoTrader's public shopping workflow. The V1 clone focuses on comprehensive vehicle marketplace with new, used, and certified pre-owned car listings, detailed search with make, model, year, price, mileage, body type, fuel type, drivetrain, and feature filters, vehicle detail pages with photo galleries, specifications, and dealer information, Kelley Blue Book price advisor integration for fair market value, dealer inventory and dealer reviews, direct dealer contact and lead submission, trade-in value estimator powered by KBB, vehicle comparison tool, saved searches with price drop alerts, vehicle history and Carfax report links, finance tools and payment calculator, home delivery and virtual deal options, push notifications for price drops and new matches, and free consumer model with dealer subscription for listing placement.
...
- Preserve the functional job behind AutoTrader while using original product naming, original UI, original sample data, and licensed integrations.
...
- Do not copy AutoTrader branding, logos, screenshots, marketing copy, private APIs, proprietary datasets, plan names, UI trade dress, course libraries, textbook solutions, documents, school content, AI prompts, or protected media.
...
|---|---|---|---|
| Apple App Store | https://apps.apple.com/us/app/autotrader-buy-sell-cars/id300515498 | iOS listing, privacy labels, release notes, car shopping claims, and support links | Verified public URL or explicit platform blocker on 2026-05-06; hands-on native behavior still blocked. |
| Google Play | https://play.google.com/store/apps/details?id=com.autotrader.consumer | Android listing, data safety, vehicle marketplace claims, and release cadence | Verified public URL or explicit platform blocker on 2026-05-06; hands-on native behavior still blocked. |
| Official product site | https://www.autotrader.com/ | AutoTrader vehicle marketplace, search, and product positioning | Verified public URL or explicit platform blocker on 2026-05-06; hands-on native behavior still blocked. |
| Official help | https://www.autotrader.com/car-shopping/help-center | AutoTrader app help, search, and troubleshooting | Verified public URL or explicit platform blocker on 2026-05-06; hands-on native behavior still blocked. |
| Privacy policy | https://www.autotrader.com/privacy | AutoTrader data collection, search data, and privacy disclosures | Verified public URL or explicit platform blocker on 2026-05-06; hands-on native behavior still blocked. |
| Terms | https://www.autotrader.com/terms-of-service | AutoTrader services, marketplace terms, and acceptable-use boundaries | Verified public URL or explicit platform blocker on 2026-05-06; hands-on native behavior still blocked. |
...
- Manual blockers must remain launch-blocking until verified: AutoTrader account creation, comprehensive vehicle search with multi-attribute filtering (make, model, year, price, mileage, body type, fuel type, drivetrain, features, distance, color), vehicle detail page with photo gallery, specs, and dealer info, Kelley Blue Book price advisor integration and fair market value estimation, dealer inventory aggregation and dealer review management, direct dealer contact and lead submission infrastructure, trade-in value estimator powered by KBB data, vehicle comparison with side-by-side spec analysis, saved searches with price drop alert triggers, vehicle history and Carfax report link integration, finance tools and payment calculator (loan terms, APR, down payment), home delivery and virtual deal option availability, push notification for price drops and new matches, VIN decoding and vehicle specification database, content moderation for listings and reviews, and AutoTrader account integration.

## Core User Journeys

- User creates or restores a AutoTrader-style account, completes role, school, subscription, or tenant checks, and reaches the dashboard.
...
- Monetization model: use original free/trial/paid/sponsored/school/provider/tenant entitlement logic; do not copy exact pricing, plan names, bundle names, promotional copy, school contracts, tenant offers, or partner offers from AutoTrader.
...
- Manual verification tests for AutoTrader account creation, comprehensive vehicle search with multi-attribute filtering (make, model, year, price, mileage, body type, fuel type, drivetrain, features, distance, color), vehicle detail page with photo gallery, specs, and dealer info, Kelley Blue Book price advisor integration and fair market value estimation, dealer inventory aggregation and dealer review management, direct dealer contact and lead submission infrastructure, trade-in value estimator powered by KBB data, vehicle comparison with side-by-side spec analysis, saved searches with price drop alert triggers, vehicle history and Carfax report link integration, finance tools and payment calculator (loan terms, APR, down payment), home delivery and virtual deal option availability, push notification for price drops and new matches, VIN decoding and vehicle specification database, content moderation for listings and reviews, and AutoTrader account integration.
...
- Phase 4: Add app-specific safety controls for comprehensive vehicle marketplace with new, used, and certified pre-owned car listings, detailed search with make, model, year, price, mileage, body type, fuel type, drivetrain, and feature filters, vehicle detail pages with photo galleries, specifications, and dealer information, Kelley Blue Book price advisor integration for fair market value, dealer inventory and dealer reviews, direct dealer contact and lead submission, trade-in value estimator powered by KBB, vehicle comparison tool, saved searches with price drop alerts, vehicle history and Carfax report links, finance tools and payment calculator, home delivery and virtual deal options, push notifications for price drops and new matches, and free consumer model with dealer subscription for listing placement.
...
- Confirm legal/privacy retention behavior for AutoTrader-style sensitive records and update API contracts before downstream implementation.
