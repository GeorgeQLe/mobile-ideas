# Zoho Mail-Style Clone Spec

> Metadata
> - Inspiration app: Zoho Mail
...
> - Manual verification blockers: Zoho account creation and custom domain email provisioning (MX, SPF, DKIM, DMARC), multi-account unified inbox aggregation and folder sync, email streams team collaboration threading and permission model, eDiscovery search and legal hold implementation, retention policy configuration and enforcement, S/MIME encryption certificate management and key exchange, Zoho Workplace app integration (Writer, Sheet, Show, Cliq, WorkDrive), calendar scheduling and resource booking, task management sync with email threads, offline email access caching and sync, folder and label organization with server-side filter rules, email delegation and shared mailbox permission model, email recall timing and delivery-state handling, scheduled send queue and delivery, push notification delivery, two-factor authentication (TOTP, SMS, push), admin console and organization management, Zoho SSO and directory integration, and Zoho Mail account integration.
...
Build an original mobile product inspired by Zoho Mail's public communication workflow. The V1 clone focuses on business email suite with ad-free email hosting, custom domain support, multi-account unified inbox, email streams for team collaboration and threaded discussions, eDiscovery and retention policies, S/MIME encryption, Zoho Workplace integration (Writer, Sheet, Show, Cliq, WorkDrive), calendar with scheduling and resource booking, task management within email, offline email access, folder and label organization with rules and filters, email delegation and shared mailboxes, email recall and scheduled send, push notifications, two-factor authentication, and Zoho Mail Free, Mail Lite, Mail Premium, and Workplace plans.
...
- Preserve the functional job behind Zoho Mail while using original product naming, original UI, original sample data, and licensed integrations.
...
- Do not copy Zoho Mail branding, logos, screenshots, marketing copy, private APIs, proprietary datasets, plan names, UI trade dress, course libraries, textbook solutions, documents, school content, AI prompts, or protected media.
...
|---|---|---|---|
| Apple App Store | https://apps.apple.com/us/app/zoho-mail-email-and-calendar/id909262651 | iOS listing, privacy labels, release notes, business email claims, and support links | Verified public URL or explicit platform blocker on 2026-05-06; hands-on native behavior still blocked. |
| Google Play | https://play.google.com/store/apps/details?id=com.zoho.mail | Android listing, data safety, business email/calendar claims, and release cadence | Verified public URL or explicit platform blocker on 2026-05-06; hands-on native behavior still blocked. |
| Official product site | https://www.zoho.com/mail/ | Zoho Mail business email, hosting, and product positioning | Verified public URL or explicit platform blocker on 2026-05-06; hands-on native behavior still blocked. |
| Official help | https://www.zoho.com/mail/help/ | Zoho Mail app help, setup, and troubleshooting | Verified public URL or explicit platform blocker on 2026-05-06; hands-on native behavior still blocked. |
| Privacy policy | https://www.zoho.com/privacy.html | Zoho data collection, no-ad-scanning policy, and privacy disclosures | Verified public URL or explicit platform blocker on 2026-05-06; hands-on native behavior still blocked. |
| Terms | https://www.zoho.com/terms.html | Zoho services, email terms, and acceptable-use boundaries | Verified public URL or explicit platform blocker on 2026-05-06; hands-on native behavior still blocked. |
...
- Manual blockers must remain launch-blocking until verified: Zoho account creation and custom domain email provisioning (MX, SPF, DKIM, DMARC), multi-account unified inbox aggregation and folder sync, email streams team collaboration threading and permission model, eDiscovery search and legal hold implementation, retention policy configuration and enforcement, S/MIME encryption certificate management and key exchange, Zoho Workplace app integration (Writer, Sheet, Show, Cliq, WorkDrive), calendar scheduling and resource booking, task management sync with email threads, offline email access caching and sync, folder and label organization with server-side filter rules, email delegation and shared mailbox permission model, email recall timing and delivery-state handling, scheduled send queue and delivery, push notification delivery, two-factor authentication (TOTP, SMS, push), admin console and organization management, Zoho SSO and directory integration, and Zoho Mail account integration.

## Core User Journeys

- User creates or restores a Zoho Mail-style account, completes role, school, subscription, or tenant checks, and reaches the dashboard.
...
- Monetization model: use original free/trial/paid/sponsored/school/provider/tenant entitlement logic; do not copy exact pricing, plan names, bundle names, promotional copy, school contracts, tenant offers, or partner offers from Zoho Mail.
...
- Manual verification tests for Zoho account creation and custom domain email provisioning (MX, SPF, DKIM, DMARC), multi-account unified inbox aggregation and folder sync, email streams team collaboration threading and permission model, eDiscovery search and legal hold implementation, retention policy configuration and enforcement, S/MIME encryption certificate management and key exchange, Zoho Workplace app integration (Writer, Sheet, Show, Cliq, WorkDrive), calendar scheduling and resource booking, task management sync with email threads, offline email access caching and sync, folder and label organization with server-side filter rules, email delegation and shared mailbox permission model, email recall timing and delivery-state handling, scheduled send queue and delivery, push notification delivery, two-factor authentication (TOTP, SMS, push), admin console and organization management, Zoho SSO and directory integration, and Zoho Mail account integration.
...
- Phase 4: Add app-specific safety controls for business email suite with ad-free email hosting, custom domain support, multi-account unified inbox, email streams for team collaboration and threaded discussions, eDiscovery and retention policies, S/MIME encryption, Zoho Workplace integration (Writer, Sheet, Show, Cliq, WorkDrive), calendar with scheduling and resource booking, task management within email, offline email access, folder and label organization with rules and filters, email delegation and shared mailboxes, email recall and scheduled send, push notifications, two-factor authentication, and Zoho Mail Free, Mail Lite, Mail Premium, and Workplace plans.
...
- Confirm legal/privacy retention behavior for Zoho Mail-style sensitive records and update API contracts before downstream implementation.
