# Kijiji-Style Clone Spec

> Metadata
> - Inspiration app: Kijiji
> - Category: Shopping
...
> - Manual verification blockers: Kijiji account creation and verification, category taxonomy covering buy-and-sell, real estate, jobs, services, pets, and vehicles, location-based feed with Canadian city and neighborhood filtering, photo listing creation with multi-photo upload and description, in-app messaging infrastructure for buyer-seller communication, Kijiji Autos vehicle listing with make/model/year/mileage specs, price comparison and market value indicator data source, saved searches with new listing alert notification triggers, user profile with ad posting history, promoted listings and top ads paid promotion system, shipping option eligibility and fulfillment integration, Kijiji Central community content aggregation, push notification for messages and new listing alerts, content moderation for listings and messages, fraud detection for scam listings and phishing, Canadian regulatory compliance for classified ads, and Kijiji account integration.
...
Build an original mobile product inspired by Kijiji's public shopping workflow. The V1 clone focuses on Canadian local classifieds marketplace with category-rich listing browsing (buy and sell, real estate, jobs, services, pets, cars and vehicles), location-based feed with city and neighborhood filtering, photo listings with detailed descriptions, in-app messaging for buyer-seller communication, Kijiji Autos integration for vehicle listings with detailed specs, price comparison and market value indicators, saved searches with new listing alerts, user profiles with ad history, promoted listings and top ads for seller visibility, shipping option for eligible items, Kijiji Central community content, push notifications for messages and alerts, and free listing model with optional paid promotion features.
...
- Preserve the functional job behind Kijiji while using original product naming, original UI, original sample data, and licensed integrations.
...
- Do not copy Kijiji branding, logos, screenshots, marketing copy, private APIs, proprietary datasets, plan names, UI trade dress, course libraries, textbook solutions, documents, school content, AI prompts, or protected media.
...
|---|---|---|---|
| Apple App Store | https://apps.apple.com/ca/app/kijiji-buy-and-sell-local/id667943580 | iOS listing (Canada), privacy labels, release notes, classifieds claims, and support links | Verified public URL or explicit platform blocker on 2026-05-06; hands-on native behavior still blocked. |
| Google Play | https://play.google.com/store/apps/details?id=com.ebay.kijiji.ca | Android listing, data safety, Canadian classifieds claims, and release cadence | Verified public URL or explicit platform blocker on 2026-05-06; hands-on native behavior still blocked. |
| Official product site | https://www.kijiji.ca/ | Kijiji Canadian classifieds, categories, and product positioning | Verified public URL or explicit platform blocker on 2026-05-06; hands-on native behavior still blocked. |
| Official help | https://help.kijiji.ca/ | Kijiji app help, listings, and troubleshooting | Verified public URL or explicit platform blocker on 2026-05-06; hands-on native behavior still blocked. |
| Privacy policy | https://www.kijiji.ca/m-privacy-policy/privacy-policy/privacyPolicyPage.html | Kijiji data collection, listing data, and privacy disclosures | Verified public URL or explicit platform blocker on 2026-05-06; hands-on native behavior still blocked. |
| Terms | https://www.kijiji.ca/m-terms-of-use/terms-of-use/termsOfUsePage.html | Kijiji services, classifieds terms, and acceptable-use boundaries | Verified public URL or explicit platform blocker on 2026-05-06; hands-on native behavior still blocked. |
...
- Manual blockers must remain launch-blocking until verified: Kijiji account creation and verification, category taxonomy covering buy-and-sell, real estate, jobs, services, pets, and vehicles, location-based feed with Canadian city and neighborhood filtering, photo listing creation with multi-photo upload and description, in-app messaging infrastructure for buyer-seller communication, Kijiji Autos vehicle listing with make/model/year/mileage specs, price comparison and market value indicator data source, saved searches with new listing alert notification triggers, user profile with ad posting history, promoted listings and top ads paid promotion system, shipping option eligibility and fulfillment integration, Kijiji Central community content aggregation, push notification for messages and new listing alerts, content moderation for listings and messages, fraud detection for scam listings and phishing, Canadian regulatory compliance for classified ads, and Kijiji account integration.

## Core User Journeys

- User creates or restores a Kijiji-style account, completes role, school, subscription, or tenant checks, and reaches the dashboard.
...
- Monetization model: use original free/trial/paid/sponsored/school/provider/tenant entitlement logic; do not copy exact pricing, plan names, bundle names, promotional copy, school contracts, tenant offers, or partner offers from Kijiji.
...
- Manual verification tests for Kijiji account creation and verification, category taxonomy covering buy-and-sell, real estate, jobs, services, pets, and vehicles, location-based feed with Canadian city and neighborhood filtering, photo listing creation with multi-photo upload and description, in-app messaging infrastructure for buyer-seller communication, Kijiji Autos vehicle listing with make/model/year/mileage specs, price comparison and market value indicator data source, saved searches with new listing alert notification triggers, user profile with ad posting history, promoted listings and top ads paid promotion system, shipping option eligibility and fulfillment integration, Kijiji Central community content aggregation, push notification for messages and new listing alerts, content moderation for listings and messages, fraud detection for scam listings and phishing, Canadian regulatory compliance for classified ads, and Kijiji account integration.
...
- Phase 4: Add app-specific safety controls for Canadian local classifieds marketplace with category-rich listing browsing (buy and sell, real estate, jobs, services, pets, cars and vehicles), location-based feed with city and neighborhood filtering, photo listings with detailed descriptions, in-app messaging for buyer-seller communication, Kijiji Autos integration for vehicle listings with detailed specs, price comparison and market value indicators, saved searches with new listing alerts, user profiles with ad history, promoted listings and top ads for seller visibility, shipping option for eligible items, Kijiji Central community content, push notifications for messages and alerts, and free listing model with optional paid promotion features.
...
- Confirm legal/privacy retention behavior for Kijiji-style sensitive records and update API contracts before downstream implementation.
