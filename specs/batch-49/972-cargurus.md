# CarGurus-Style Clone Spec

> Metadata
> - Inspiration app: CarGurus
> - Category: Shopping
...
> - Manual verification blockers: CarGurus account creation, Deal Rating algorithm (market value analysis, price comparison, deal scoring across inventory), comprehensive vehicle search with multi-attribute filtering (make, model, year, price, mileage, body style, features, distance), vehicle listing detail with photo galleries, specs, features, and VIN-based history, price history chart data aggregation and visualization, IMV (Instant Market Value) pricing model and data sources, dealer inventory aggregation and dealer profile/review management, direct messaging and lead submission to dealer CRM systems, trade-in value estimation algorithm and data sources (vehicle condition, market data), vehicle comparison tool with side-by-side spec analysis, saved searches with price drop alert notification triggers, new and used car listing aggregation from dealer and private sources, finance calculator and pre-qualification partner integration, push notification for price drops and new match alerts, VIN decoding and vehicle history report integration, content moderation for listings and reviews, and CarGurus account integration.
...
Build an original mobile product inspired by CarGurus's public shopping workflow. The V1 clone focuses on vehicle shopping and research platform with Deal Rating system comparing prices against market value (Great Deal, Good Deal, Fair Deal, High Price, Overpriced), comprehensive vehicle search with make, model, year, price, mileage, body style, and feature filters, detailed vehicle listings with photos, specs, history, and dealer information, price history charts showing listing price trends, IMV (Instant Market Value) pricing tool, dealer inventory browsing and dealer reviews, direct messaging and lead submission to dealers, trade-in value estimator, vehicle comparison tool, saved searches with price drop alerts, new and used car listings, finance calculator and pre-qualification, push notifications for price drops and new matches, and free consumer model with dealer subscription for enhanced listings.
...
- Preserve the functional job behind CarGurus while using original product naming, original UI, original sample data, and licensed integrations.
...
- Do not copy CarGurus branding, logos, screenshots, marketing copy, private APIs, proprietary datasets, plan names, UI trade dress, course libraries, textbook solutions, documents, school content, AI prompts, or protected media.
...
|---|---|---|---|
| Apple App Store | https://apps.apple.com/us/app/cargurus-shop-cars-new-used/id543242460 | iOS listing, privacy labels, release notes, car shopping/deal rating claims, and support links | Verified public URL or explicit platform blocker on 2026-05-06; hands-on native behavior still blocked. |
| Google Play | https://play.google.com/store/apps/details?id=com.cargurus.android.mobile | Android listing, data safety, vehicle shopping/pricing claims, and release cadence | Verified public URL or explicit platform blocker on 2026-05-06; hands-on native behavior still blocked. |
| Official product site | https://www.cargurus.com/ | CarGurus car shopping, Deal Rating, pricing, and product positioning | Verified public URL or explicit platform blocker on 2026-05-06; hands-on native behavior still blocked. |
| Official help | https://www.cargurus.com/Cars/helpCenter.action | CarGurus app help, search, and troubleshooting | Verified public URL or explicit platform blocker on 2026-05-06; hands-on native behavior still blocked. |
| Privacy policy | https://www.cargurus.com/Cars/privacyPolicy.action | CarGurus data collection, vehicle search data, and privacy disclosures | Verified public URL or explicit platform blocker on 2026-05-06; hands-on native behavior still blocked. |
| Terms | https://www.cargurus.com/Cars/termsOfUse.action | CarGurus services, marketplace terms, and acceptable-use boundaries | Verified public URL or explicit platform blocker on 2026-05-06; hands-on native behavior still blocked. |
...
- Manual blockers must remain launch-blocking until verified: CarGurus account creation, Deal Rating algorithm (market value analysis, price comparison, deal scoring across inventory), comprehensive vehicle search with multi-attribute filtering (make, model, year, price, mileage, body style, features, distance), vehicle listing detail with photo galleries, specs, features, and VIN-based history, price history chart data aggregation and visualization, IMV (Instant Market Value) pricing model and data sources, dealer inventory aggregation and dealer profile/review management, direct messaging and lead submission to dealer CRM systems, trade-in value estimation algorithm and data sources (vehicle condition, market data), vehicle comparison tool with side-by-side spec analysis, saved searches with price drop alert notification triggers, new and used car listing aggregation from dealer and private sources, finance calculator and pre-qualification partner integration, push notification for price drops and new match alerts, VIN decoding and vehicle history report integration, content moderation for listings and reviews, and CarGurus account integration.

## Core User Journeys

- User creates or restores a CarGurus-style account, completes role, school, subscription, or tenant checks, and reaches the dashboard.
...
- Monetization model: use original free/trial/paid/sponsored/school/provider/tenant entitlement logic; do not copy exact pricing, plan names, bundle names, promotional copy, school contracts, tenant offers, or partner offers from CarGurus.
...
- Manual verification tests for CarGurus account creation, Deal Rating algorithm (market value analysis, price comparison, deal scoring across inventory), comprehensive vehicle search with multi-attribute filtering (make, model, year, price, mileage, body style, features, distance), vehicle listing detail with photo galleries, specs, features, and VIN-based history, price history chart data aggregation and visualization, IMV (Instant Market Value) pricing model and data sources, dealer inventory aggregation and dealer profile/review management, direct messaging and lead submission to dealer CRM systems, trade-in value estimation algorithm and data sources (vehicle condition, market data), vehicle comparison tool with side-by-side spec analysis, saved searches with price drop alert notification triggers, new and used car listing aggregation from dealer and private sources, finance calculator and pre-qualification partner integration, push notification for price drops and new match alerts, VIN decoding and vehicle history report integration, content moderation for listings and reviews, and CarGurus account integration.
...
- Phase 4: Add app-specific safety controls for vehicle shopping and research platform with Deal Rating system comparing prices against market value (Great Deal, Good Deal, Fair Deal, High Price, Overpriced), comprehensive vehicle search with make, model, year, price, mileage, body style, and feature filters, detailed vehicle listings with photos, specs, history, and dealer information, price history charts showing listing price trends, IMV (Instant Market Value) pricing tool, dealer inventory browsing and dealer reviews, direct messaging and lead submission to dealers, trade-in value estimator, vehicle comparison tool, saved searches with price drop alerts, new and used car listings, finance calculator and pre-qualification, push notifications for price drops and new matches, and free consumer model with dealer subscription for enhanced listings.
...
- Confirm legal/privacy retention behavior for CarGurus-style sensitive records and update API contracts before downstream implementation.
