# eBay-Style Clone Spec

> Metadata
> - Inspiration app: eBay
> - Category: Marketplace, auctions, offers, seller tools, authenticity, buyer protection, and payments
...
> - Manual verification blockers: native iOS/Android screens, signup/login, bidding timers, offer flows, watchlist notifications, checkout/payment authorization, taxes/fees, managed payments, seller onboarding, listing creation, shipping labels, payouts, returns/refunds, authenticity verification, disputes, ads, data export/deletion, push payloads, and regional policy behavior require lawful test devices/accounts.
...
Build an original marketplace inspired by eBay public behavior: search, category browse, watchlist, auctions, Buy It Now, offers, product/listing detail, cart/checkout, order tracking, returns/refunds, Money Back Guarantee-style protection, seller listings, payments, authenticity verification, ads, and privacy controls.

The clone must not imply affiliation with eBay. Public-source V1 parity means the product architecture is grounded in exact public sources while all unverified native, account, payment, seller, support, notification, deletion/export, and regional behavior remains launch-blocked until lawful hands-on verification is captured.

## Goals

- Support the public-source V1 buyer journey for eBay: discovery, listing detail, saved state, transaction draft, checkout or handoff, order tracking, support, and privacy controls.
...
- Do not build a eBay-branded app or imply affiliation with eBay, parent companies, sellers, carriers, payment providers, ad products, or support programs.
...
|---|---|---|---|
| Apple App Store | https://apps.apple.com/us/app/ebay-online-shopping-selling/id282614216 | Official iOS listing, buyer/seller positioning, category, privacy labels, notifications, and current release notes | Verified 2026-04-17 |
| Google Play | https://play.google.com/store/apps/details?id=com.ebay.mobile | Official Android listing, package id, marketplace positioning, data safety, and app support | Verified 2026-04-17 |
| eBay Help Center | https://www.ebay.com/help/home | Buyer, seller, account, payment, shipping, returns, refunds, and contact-support entrypoint | Verified 2026-04-17 |
| User Agreement | https://www.ebay.com/help/policies/member-behaviour-policies/user-agreement?id=4259 | Legal account, marketplace, listing, payment, dispute, and seller obligations | Verified 2026-04-17 |
| User Privacy Notice | https://www.ebay.com/help/policies/member-behaviour-policies/user-privacy-notice-privacy-policy?id=4260 | Personal data, personalization, communications, sharing, retention, and rights | Verified 2026-04-17 |
| eBay Money Back Guarantee | https://www.ebay.com/help/policies/ebay-money-back-guarantee-policy/ebay-money-back-guarantee-policy?id=4210 | Buyer protection eligibility, not received, not as described, refund, and case flow | Verified 2026-04-17 |
| Authenticity Guarantee | https://www.ebay.com/authenticity-guarantee | Authentication categories, verified item flow, buyer trust, and eligible goods | Verified 2026-04-17 |
| Seller Center | https://www.ebay.com/sellercenter | Seller listing, shipping, payments, fees, performance, and growth tooling | Verified 2026-04-17 |
| Seller Fees | https://www.ebay.com/sellercenter/selling/seller-fees | Public seller fee structure and seller economics | Verified 2026-04-17 |
| Return Item For Refund | https://www.ebay.com/help/buying/returns-refunds/return-item-refund?id=4041 | Buyer return workflow, refund path, seller response, and escalation | Verified 2026-04-17 |
| Rules and Policies | https://www.ebay.com/help/policies/default/ebays-rules-policies?id=4205 | Marketplace rules, prohibited/restricted items, listing policies, and member behavior | Verified 2026-04-17 |

## Detailed Design

### Source-Backed Product Requirements

- Search must support text, category, condition, price, buying format, auction ending time, location, delivery, returns, authenticity, seller rating, and promoted listing disclosure.
- Listing detail must include media, title, condition, price/bid/offer state, time left, seller profile, shipping, returns, authenticity eligibility, item specifics, watch, message seller, report listing, and purchase actions.
- Auction state must be server-owned with synchronized timers, bid increments, reserve state, outbid events, winning/losing status, cancellation rules, and anti-sniping/load handling.
- Best offer flows must support buyer offer, seller counter/accept/decline, expiration, binding acceptance, message context, and abuse controls.
- Seller tools must support listing draft/publish, photos, title, item specifics, condition, pricing format, reserve, offers, quantity, shipping, returns, promoted listing, and policy checks.
...
- Buyer searches for a sneaker, filters for authenticity guarantee, watches an auction, receives outbid notification, raises bid, wins, pays, and tracks authentication and delivery.
- Buyer submits best offer, seller counters, buyer accepts, checkout quote refreshes, and the order is created server-side.
- Seller creates a listing, chooses auction or fixed price, sets shipping/returns, publishes, receives a sale, ships, and receives payout.
...
- What current native bid confirmation, outbid, and offer-counter screens appear on iOS versus Android?
- Which categories and regions expose authenticity guarantee and which use direct versus authenticator-routed fulfillment?
- What seller payout, fee, and account-health states are mobile-only versus web-only?
- What exact push payloads are used for watched items, bids, offers, orders, returns, cases, and seller payouts?
