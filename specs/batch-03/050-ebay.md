...
## Overview
Build an original mobile product inspired by eBay's user-facing workflow, not its brand identity or proprietary implementation.
The clone target is: Auctions, buy-now listings, watchlist, bids, seller tools, offers, shipping, and dispute flows.
...
- Implement the app-specific focus: Auctions, buy-now listings, watchlist, bids, seller tools, offers, shipping, and dispute flows.
...
## Non-Goals
- Do not copy eBay branding, trade dress, logos, app icons, screenshots, marketing copy, or proprietary media.
...
## Research Sources
- App Store source-discovery link: https://apps.apple.com/us/search?term=eBay
- Google Play source-discovery link: https://play.google.com/store/search?q=eBay&c=apps
- Official help/privacy source-discovery link: https://www.google.com/search?q=eBay%20official%20app%20help%20privacy
