...
## Overview
Build an original mobile product inspired by Amazon's user-facing workflow, not its brand identity or proprietary implementation.
The clone target is: Product search, detail pages, cart, checkout, delivery tracking, reviews, returns, and recommendations.
...
- Implement the app-specific focus: Product search, detail pages, cart, checkout, delivery tracking, reviews, returns, and recommendations.
...
## Non-Goals
- Do not copy Amazon branding, trade dress, logos, app icons, screenshots, marketing copy, or proprietary media.
...
## Research Sources
- App Store source-discovery link: https://apps.apple.com/us/search?term=Amazon
- Google Play source-discovery link: https://play.google.com/store/search?q=Amazon&c=apps
- Official help/privacy source-discovery link: https://www.google.com/search?q=Amazon%20official%20app%20help%20privacy
