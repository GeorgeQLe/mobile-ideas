# Depop-Style Clone Spec

> Metadata
> - Inspiration app: Depop
> - Category: Fashion resale, social marketplace, offers, messaging, shipping, buyer/seller protection, and payments
...
> - Manual verification blockers: native iOS/Android screens, signup/login, feed personalization, listing creation, messages, offers, checkout, Depop Payments-style authorization, shipping labels, seller payouts, buyer/seller protection, refunds, reviews, boosted listings, push payloads, data export/deletion, and regional availability require lawful test devices/accounts.
...
Build an original fashion resale app inspired by Depop public behavior: feed/search discovery, shop profiles, listings, likes, follows, messages, offers, checkout, Depop Payments-style processing, shipping labels, buyer/seller protection, reviews, support, and privacy controls.

The clone must not imply affiliation with Depop. Public-source V1 parity means the product architecture is grounded in exact public sources while all unverified native, account, payment, seller, support, notification, deletion/export, and regional behavior remains launch-blocked until lawful hands-on verification is captured.

## Goals

- Support the public-source V1 buyer journey for Depop: discovery, listing detail, saved state, transaction draft, checkout or handoff, order tracking, support, and privacy controls.
...
- Do not build a Depop-branded app or imply affiliation with Depop, parent companies, sellers, carriers, payment providers, ad products, or support programs.
...
|---|---|---|---|
| Apple App Store | https://apps.apple.com/us/app/depop-buy-sell-clothing/id518684914 | Official iOS listing, resale positioning, category, privacy labels, and current app notes | Verified 2026-04-17 |
| Google Play | https://play.google.com/store/apps/details?id=com.depop | Official Android listing, package id, data safety, and app support | Verified 2026-04-17 |
| Depop Help Centre | https://depophelp.zendesk.com/hc/en-gb | Buyer, seller, payment, shipping, protection, account, and support entrypoint | Verified 2026-04-17 |
| Terms of Service | https://depophelp.zendesk.com/hc/en-gb/articles/360001773148-Terms-of-Service | Legal account, listing, transaction, fee, tax, payment, and service obligations | Verified 2026-04-17 |
| Privacy Policy | https://depophelp.zendesk.com/hc/en-gb/articles/360001792147-Privacy-Policy | Personal data, profiles, listings, messages, payments, sharing, retention, and rights | Verified 2026-04-17 |
| Seller Fees | https://depophelp.zendesk.com/hc/en-gb/articles/360001791127-Seller-fees-and-charges | Seller and payment-processing fees by region and fee handling | Verified 2026-04-17 |
| Depop Payments | https://depophelp.zendesk.com/hc/en-gb/articles/18320822281361-Depop-Payments | Payment methods, payout model, supported regions, and payment-provider orientation | Verified 2026-04-17 |
| Seller Protection | https://depophelp.zendesk.com/hc/en-gb/articles/360001845367 | Seller protection eligibility, shipping label requirements, limits, exclusions, and evidence | Verified 2026-04-17 |
| US Shipping Guide | https://depophelp.zendesk.com/hc/en-gb/articles/16523051318033-Shipping-Guide-US | Shipping labels, tracking, dispatch timing, and seller obligations | Verified 2026-04-17 |

## Detailed Design

### Source-Backed Product Requirements

- Home/feed must expose personalized resale discovery, search, categories, likes, follows, messages, sell button, bag, notifications, and account.
- Messages and comments must support negotiation, offer context, shipping questions, evidence retention, and off-platform payment/scam detection.
- Seller protection must require in-app purchase, eligible goods, correct address, tracked label where applicable, dispatch deadlines, and evidence.
- Payout tools must show payment processing fee, seller fee where applicable, balance, payout method, pending/available state, refunds, and holds.
...
- Buyer browses personalized feed, likes a vintage jacket, messages seller, makes an offer, checks out, tracks shipping, and leaves review.
- Seller lists item with photos and shipping, accepts offer, ships using label, and receives payout after order clears.
- Buyer reports item not received, seller provides tracking, support checks protection eligibility, and refund/appeal status updates.
...
- Trust reviewer receives a prohibited-item, counterfeit, scam, harassment, or policy report, reviews evidence, suppresses or restores the DepopListing, notifies affected users, and records appeal state.
...
- DepopListing: public title, description, category, media metadata, price or market state, availability, policy flags, moderation state, and source-specific attributes.
...
- GET /search?query=&filters=&sort=&cursor=: depoplisting discovery with facets, sponsored/promoted disclosure where relevant, safe-category suppression, and no-result recovery.
- GET /items/:id: depoplisting detail, media, seller/store context, availability, pricing, reviews, shipping, protection, and policy warnings.
...
- Which Depop Protection and fee rules differ by U.S., UK, Australia, and other regions in native flows?
- What exact offer, message, and checkout screens are current on iOS and Android?
- Which boosted listing controls and metrics are visible in mobile seller surfaces?
- What push payloads are used for offers, messages, orders, labels, protection cases, and payouts?
