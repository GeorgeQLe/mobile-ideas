# Temu-Style Clone Spec

> Metadata
> - Inspiration app: Temu
> - Category: Discount shopping, cross-border marketplace, promotions, logistics, returns, and customer support
...
> - Manual verification blockers: native iOS/Android screen capture, signup/login, personalized home ranking, visual search, coupon/game mechanics, cart quote refresh, payment authorization, wallet/credit use, checkout, order tracking, returns/refunds, support chat, review submission, data export/deletion, push notifications, seller/local-warehouse behavior, restricted goods, and regional availability require lawful test devices/accounts.
...
Build an original mobile discount marketplace inspired by Temu public behavior: broad category discovery, deal-heavy home modules, product search, product detail, cart, checkout, order tracking, coupons/credits, returns/refunds, customer support, product reviews, and safety/privacy settings.

The clone must not imply affiliation with Temu. Public-source V1 parity means the product architecture is grounded in exact public sources while all unverified native, account, payment, seller, support, notification, deletion/export, and regional behavior remains launch-blocked until lawful hands-on verification is captured.

## Goals

- Support the public-source V1 buyer journey for Temu: discovery, product detail, saved state, transaction draft, checkout or handoff, order tracking, support, and privacy controls.
...
- Do not build a Temu-branded app or imply affiliation with Temu, parent companies, sellers, carriers, payment providers, ad products, or support programs.
...
|---|---|---|---|
| Apple App Store | https://apps.apple.com/us/app/temu-shop-like-a-billionaire/id1641486558 | Official iOS listing, developer, category, age rating, product categories, visual search update, privacy labels, and current version notes | Verified 2026-04-17 |
| Google Play | https://play.google.com/store/apps/details?id=com.einnovation.temu | Official Android listing, package id, download scale, shopping positioning, free shipping/returns claim, data safety, and support contact | Verified 2026-04-17 |
| Temu Support Center | https://www.temu.com/support-center.html | Customer help entrypoint for orders, payments, shipping, returns, refunds, account, and contact support | Verified 2026-04-17 |
| Terms of Use | https://www.temu.com/csr/terms-of-use.html | Legal terms covering service use, purchases, refunds, rewards, account obligations, and dispute boundaries | Verified 2026-04-17 |
| Privacy and Cookie Policy | https://www.temu.com/privacy-and-cookie-policy.html | Personal data categories, app/device data, personalization, sharing, cookies, retention, and rights | Verified 2026-04-17 |
| Return and Refund Policy | https://www.temu.com/return-and-refund-policy.html | Return window, refund paths, item eligibility, return shipping, and customer-service implications | Verified 2026-04-17 |
| Shipping Info | https://www.temu.com/shipping-info.html | Shipping options, delivery estimates, tracking, logistics, and delivery-problem orientation | Verified 2026-04-17 |
| Intellectual Property Policy | https://www.temu.com/intellectual-property-policy.html | IP complaint and counterfeit/reporting obligations for marketplace listing safety | Verified 2026-04-17 |
| Temu homepage | https://www.temu.com/ | Public category, deal, product, search, and promotion orientation | Verified 2026-04-17 |

## Detailed Design

### Source-Backed Product Requirements

- Home must expose search, category shortcuts, deal modules, coupons/credits, order entrypoints, cart, support, account, notifications, and signed-out states.
- Search must support text and visual search where licensed, category facets, sort, price filters, delivery filters, no-result recovery, and prohibited-item suppression.
- Product detail must include title, media, price/deal state, variations, seller/store cues where public, reviews, shipping promise, return eligibility, quantity controls, related products, report listing, and add-to-cart.
- Cart must support quantity changes, variation edits, coupons, reward credits, stale price/stock refresh, free-shipping thresholds, local versus cross-border shipping cues, and checkout readiness.
- Reward and coupon mechanics must show source, value, expiration, eligibility, minimum spend, stacking rules, and abuse/fraud holds without dark-pattern pressure.
- Return/refund flows must show eligible item selection, reason, evidence, return method, refund destination, keep-item refund where policy allows, shipping fee caveat, status, and escalation.
...
- New shopper opens the app, grants or denies notifications, browses deals, sets delivery region, searches for an item, compares reviews, adds a variation to cart, and checks out after quote refresh.
- Returning shopper applies a coupon and credit balance, sees a minimum-spend warning, removes an ineligible item, confirms payment, and tracks shipment.
- Shopper uses visual search, denies photo access, receives manual search fallback, later grants permission, and sees privacy-safe analytics for the permission change.
- Customer starts a return, selects item condition and reason, receives return instructions or keep-item refund outcome, tracks refund status, and escalates if rejected.
...
- Trust reviewer receives a prohibited-item, counterfeit, scam, harassment, or policy report, reviews evidence, suppresses or restores the CatalogItem, notifies affected users, and records appeal state.
...
- CouponCredit: source, value, currency, eligibility, minimum spend, expiration, stacking rules, redemption, reversal, and abuse state.
- PromotionCampaign: deal module, reward campaign, audience eligibility, disclosure, expiration, inventory tie, and fraud controls.
- Review: order eligibility, rating, text/media, dimensions, report state, moderation state, and publication timestamp.
...
- CatalogItem: public title, description, category, media metadata, price or market state, availability, policy flags, moderation state, and source-specific attributes.
...
- GET /coupons, POST /coupons/:id/claim, POST /drafts/:id/apply-coupon: reward and coupon lifecycle with abuse controls.
- POST /search/image: visual search with permission errors, safe-category controls, and provider failures.
...
- GET /search?query=&filters=&sort=&cursor=: catalogitem discovery with facets, sponsored/promoted disclosure where relevant, safe-category suppression, and no-result recovery.
- GET /items/:id: catalogitem detail, media, seller/store context, availability, pricing, reviews, shipping, protection, and policy warnings.
...
- Track discovery impressions, search success, filter use, visual-search starts, product detail engagement, cart edits, coupon claim/apply, quote refresh, checkout conversion, payment failure, tracking opens, return starts, support contacts, counterfeit/IP reports, and privacy changes.
- Monetization may include marketplace commission, sponsored placement analogs, seller services, promotional campaigns, and affiliate-like placement only with clear disclosure and opt-outs.
...
- Coupon applies in cart but expires before checkout confirmation.
- Visual search returns a prohibited or unsafe product category.
- Free-shipping threshold changes by warehouse, seller, or region.
- Delivery estimate changes after address validation.
...
- Which Temu local-warehouse and cross-border fulfillment states are visible in the current native apps by region?
- Which coupon, game, credit, and promotion mechanics are available to new versus returning users, and what exact expiration rules apply?
- Which return outcomes allow keep-item refunds, return labels, pickup, or customer-paid shipping in each region?
- What exact push payload text and privacy controls are used for shipment, promotion, refund, and support notifications?
