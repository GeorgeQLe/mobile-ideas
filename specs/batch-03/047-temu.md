...
## Overview
Build an original mobile product inspired by Temu's user-facing workflow, not its brand identity or proprietary implementation.
The clone target is: Deal-heavy marketplace, gamified discounts, flash sales, product discovery, order tracking, and referral loops.
...
## Goals
- Deliver a mobile-first shopping experience with complete onboarding, core action, settings, and recovery flows.
- Implement the app-specific focus: Deal-heavy marketplace, gamified discounts, flash sales, product discovery, order tracking, and referral loops.
...
## Non-Goals
- Do not copy Temu branding, trade dress, logos, app icons, screenshots, marketing copy, or proprietary media.
...
## Research Sources
- App Store source-discovery link: https://apps.apple.com/us/search?term=Temu
- Google Play source-discovery link: https://play.google.com/store/search?q=Temu&c=apps
- Official help/privacy source-discovery link: https://www.google.com/search?q=Temu%20official%20app%20help%20privacy
...
## Detailed Design
- Onboarding: support guest, signup, returning-user, permission-primer, and blocked-region or blocked-account states as appropriate for shopping.
