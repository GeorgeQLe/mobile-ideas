...
## Overview
Build an original mobile product inspired by Zelle's user-facing workflow, not its brand identity or proprietary implementation.
The clone target is: Bank-linked instant payment flow, recipient verification, send/request, history, limits, and fraud warnings.
...
- Implement the app-specific focus: Bank-linked instant payment flow, recipient verification, send/request, history, limits, and fraud warnings.
...
## Non-Goals
- Do not copy Zelle branding, trade dress, logos, app icons, screenshots, marketing copy, or proprietary media.
...
## Research Sources
- App Store source-discovery link: https://apps.apple.com/us/search?term=Zelle
- Google Play source-discovery link: https://play.google.com/store/search?q=Zelle&c=apps
- Official help/privacy source-discovery link: https://www.google.com/search?q=Zelle%20official%20app%20help%20privacy
