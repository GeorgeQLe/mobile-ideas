...
## Overview
Build an original mobile product inspired by Too Good To Go's user-facing workflow, not its brand identity or proprietary implementation.
The clone target is: Surplus food marketplace, mystery bags, pickup windows, reservations, merchant pages, and impact metrics.
...
## Goals
- Deliver a mobile-first food marketplace experience with complete onboarding, core action, settings, and recovery flows.
- Implement the app-specific focus: Surplus food marketplace, mystery bags, pickup windows, reservations, merchant pages, and impact metrics.
...
## Non-Goals
- Do not copy Too Good To Go branding, trade dress, logos, app icons, screenshots, marketing copy, or proprietary media.
...
## Research Sources
- App Store source-discovery link: https://apps.apple.com/us/search?term=Too%20Good%20To%20Go
- Google Play source-discovery link: https://play.google.com/store/search?q=Too%20Good%20To%20Go&c=apps
- Official help/privacy source-discovery link: https://www.google.com/search?q=Too%20Good%20To%20Go%20official%20app%20help%20privacy
...
## Detailed Design
- Onboarding: support guest, signup, returning-user, permission-primer, and blocked-region or blocked-account states as appropriate for food marketplace.
