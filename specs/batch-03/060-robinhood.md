...
## Overview
Build an original mobile product inspired by Robinhood's user-facing workflow, not its brand identity or proprietary implementation.
The clone target is: Brokerage-style portfolio, watchlists, stock detail charts, order tickets, options education gates, and news.
...
## Goals
- Deliver a mobile-first investing experience with complete onboarding, core action, settings, and recovery flows.
- Implement the app-specific focus: Brokerage-style portfolio, watchlists, stock detail charts, order tickets, options education gates, and news.
...
## Non-Goals
- Do not copy Robinhood branding, trade dress, logos, app icons, screenshots, marketing copy, or proprietary media.
...
## Research Sources
- App Store source-discovery link: https://apps.apple.com/us/search?term=Robinhood
- Google Play source-discovery link: https://play.google.com/store/search?q=Robinhood&c=apps
- Official help/privacy source-discovery link: https://www.google.com/search?q=Robinhood%20official%20app%20help%20privacy
...
## Detailed Design
- Onboarding: support guest, signup, returning-user, permission-primer, and blocked-region or blocked-account states as appropriate for investing.
