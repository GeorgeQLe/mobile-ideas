# Poshmark-Style Clone Spec

> Metadata
> - Inspiration app: Poshmark
> - Category: Fashion resale, social closets, offers, bundles, shipping labels, seller earnings, and buyer protection
...
> - Manual verification blockers: native iOS/Android screens, signup/login, closet personalization, likes/shares/follows, Posh Parties, offers to likers, bundles, checkout, payment authorization, prepaid labels, seller earnings and redemption, returns, Posh Protect claims, authentication, push payloads, data export/deletion, and regional availability require lawful test devices/accounts.
...
Build an original fashion resale marketplace inspired by Poshmark public behavior: social closets, listing discovery, likes, offers, bundles, Posh Protect-style buyer protection, prepaid shipping labels, seller earnings, ratings, support, and privacy controls.

The clone must not imply affiliation with Poshmark. Public-source V1 parity means the product architecture is grounded in exact public sources while all unverified native, account, payment, seller, support, notification, deletion/export, and regional behavior remains launch-blocked until lawful hands-on verification is captured.

## Goals

- Support the public-source V1 buyer journey for Poshmark: discovery, listing detail, saved state, transaction draft, checkout or handoff, order tracking, support, and privacy controls.
...
- Do not build a Poshmark-branded app or imply affiliation with Poshmark, parent companies, sellers, carriers, payment providers, ad products, or support programs.
...
|---|---|---|---|
| Apple App Store | https://apps.apple.com/us/app/poshmark-buy-sell-fashion/id470412147 | Official iOS listing, fashion resale positioning, category, privacy labels, and current app notes | Verified 2026-04-17 |
| Google Play | https://play.google.com/store/apps/details?id=com.poshmark.app | Official Android listing, package id, data safety, app support, and marketplace positioning | Verified 2026-04-17 |
| Support Center | https://support.poshmark.com/s/ | Buyer, seller, order, shipping, returns, payment, and account help entrypoint | Verified 2026-04-17 |
| Privacy Policy | https://poshmark.com/privacy | Personal data, marketplace activity, sharing, retention, ads, and privacy rights | Verified 2026-04-17 |
| Terms of Service | https://poshmark.com/terms | Legal account, commerce, content, disputes, and service terms | Verified 2026-04-17 |
| Posh Protect | https://poshmark.com/posh_protect | Buyer protection, order issue, refund, and claim expectations | Verified 2026-04-17 |
| Community Guidelines | https://poshmark.com/community_guidelines | Social marketplace behavior, harassment, spam, safety, and listing expectations | Verified 2026-04-17 |
| Seller Fees | https://support.poshmark.com/s/article/What-are-the-fees-for-selling-on-Poshmark | Public seller fee model and earnings implications | Verified 2026-04-17 |
| Shipping Sold Items | https://support.poshmark.com/s/article/How-do-I-ship-my-item-once-its-sold | Seller shipping label and fulfillment workflow | Verified 2026-04-17 |
| Return Policy | https://support.poshmark.com/s/article/What-is-Poshmark-s-return-policy | Return eligibility, buyer claim, and support decision orientation | Verified 2026-04-17 |
| Bundles | https://support.poshmark.com/s/article/What-is-a-Bundle | Bundle shopping, seller discount, and multi-item purchase behavior | Verified 2026-04-17 |

## Detailed Design

### Source-Backed Product Requirements

- Home must expose feed, search, brands/categories, closets, likes, shares, bundles, offers, orders, selling tools, balance, notifications, and support.
- Offers and bundles must show buyer/seller proposal, discount, expiration, binding acceptance, shipping, payment, and audit trail.
- Shipping must support prepaid label generation, tracking, delayed shipment reminders, carrier exceptions, and seller cancellation rules.
- Seller earnings must show gross sale, fees, shipping adjustments, refunds, pending/available balance, redemption methods, and payout holds.
...
- Buyer likes an item, receives an offer, counters, accepts, checks out, tracks shipment, and rates the purchase.
- Buyer creates a bundle across one closet, asks a question, receives seller discount, and purchases with combined shipping state.
- Seller lists an item, shares it, receives an offer, ships using prepaid label, and redeems available earnings.
...
- Trust reviewer receives a prohibited-item, counterfeit, scam, harassment, or policy report, reviews evidence, suppresses or restores the ClosetListing, notifies affected users, and records appeal state.
...
- ClosetListing: public title, description, category, media metadata, price or market state, availability, policy flags, moderation state, and source-specific attributes.
...
- GET /search?query=&filters=&sort=&cursor=: closetlisting discovery with facets, sponsored/promoted disclosure where relevant, safe-category suppression, and no-result recovery.
- GET /items/:id: closetlisting detail, media, seller/store context, availability, pricing, reviews, shipping, protection, and policy warnings.
...
- Which Posh Parties, live/social shopping, and authentication flows are currently visible in native apps?
- What exact seller balance, redemption, and payout states are mobile-visible?
- Which return/claim evidence screens and deadlines appear for U.S. accounts?
- What push payloads are used for likes, offers, bundles, orders, claims, and payouts?
