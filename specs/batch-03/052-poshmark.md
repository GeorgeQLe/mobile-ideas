...
## Overview
Build an original mobile product inspired by Poshmark's user-facing workflow, not its brand identity or proprietary implementation.
The clone target is: Social resale closet, listing creation, offers, bundles, shipping labels, parties, and seller stats.
...
## Goals
- Deliver a mobile-first resale experience with complete onboarding, core action, settings, and recovery flows.
- Implement the app-specific focus: Social resale closet, listing creation, offers, bundles, shipping labels, parties, and seller stats.
...
## Non-Goals
- Do not copy Poshmark branding, trade dress, logos, app icons, screenshots, marketing copy, or proprietary media.
...
## Research Sources
- App Store source-discovery link: https://apps.apple.com/us/search?term=Poshmark
- Google Play source-discovery link: https://play.google.com/store/search?q=Poshmark&c=apps
- Official help/privacy source-discovery link: https://www.google.com/search?q=Poshmark%20official%20app%20help%20privacy
...
## Detailed Design
- Onboarding: support guest, signup, returning-user, permission-primer, and blocked-region or blocked-account states as appropriate for resale.
