# Kobo Books-Style Clone Spec

> Metadata
> - Inspiration app: Kobo Books
...
> - Manual verification blockers: Kobo account and subscription policy (individual purchase vs Kobo Plus Unlimited), e-book DRM (Adobe DRM, Kobo DRM) and format support (EPUB, PDF, MOBI, CBR, CBZ), audiobook DRM and streaming vs download, bookstore content catalog and regional availability, in-app purchase restrictions on iOS (Apple requirement to remove store links), reading progress sync and cross-device bookmark reconciliation, font embedding and custom font loading, annotation and highlight sync and export, reading statistics calculation and award criteria, Kobo Plus catalog availability and subscription entitlement, wishlist and recommendation algorithm, series detection and reading order, night mode and blue-light filter, offline library download management and storage, dictionary and translation language support, social activity privacy and sharing controls, publisher content restrictions and geo-licensing, and Rakuten/Kobo account integration.
...
Build an original mobile product inspired by Kobo Books's public books & reference workflow. The V1 clone focuses on e-book and audiobook reading platform with e-book reader (EPUB, PDF, CBR/CBZ), audiobook playback, bookstore browsing and purchasing, reading progress sync across devices, customizable reading experience (fonts, margins, line spacing, themes, brightness), highlighting and annotation, bookmark management, reading statistics and awards, Kobo Plus subscription (unlimited e-books and audiobooks), wishlist and recommendations, series management, dark mode and night mode, offline library access, dictionary and translation lookup, and social features (reading activity, reviews).
...
- Preserve the functional job behind Kobo Books while using original product naming, original UI, original sample data, and licensed integrations.
...
- Do not copy Kobo Books branding, logos, screenshots, marketing copy, private APIs, proprietary datasets, plan names, UI trade dress, course libraries, textbook solutions, documents, school content, AI prompts, or protected media.
...
|---|---|---|---|
| Apple App Store | https://apps.apple.com/us/app/kobo-books/id301259483 | iOS listing, privacy labels, release notes, e-book/audiobook claims, and support links | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
| Google Play | https://play.google.com/store/apps/details?id=com.kobobooks.android | Android listing, data safety, e-book/audiobook/Kobo Plus claims, and release cadence | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
| Official product site | https://www.kobo.com/ | Kobo e-books, audiobooks, Kobo Plus, e-readers, and product positioning | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
| Official help | https://help.kobo.com/ | Kobo app help, account, reading, library, and troubleshooting | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
| Privacy policy | https://www.kobo.com/privacypolicy | Kobo/Rakuten data collection, reading data, analytics, and privacy disclosures | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
| Terms | https://www.kobo.com/termsofuse | Kobo services, content licensing, subscriptions, and acceptable-use boundaries | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
...
- Manual blockers must remain launch-blocking until verified: Kobo account and subscription policy (individual purchase vs Kobo Plus Unlimited), e-book DRM (Adobe DRM, Kobo DRM) and format support (EPUB, PDF, MOBI, CBR, CBZ), audiobook DRM and streaming vs download, bookstore content catalog and regional availability, in-app purchase restrictions on iOS (Apple requirement to remove store links), reading progress sync and cross-device bookmark reconciliation, font embedding and custom font loading, annotation and highlight sync and export, reading statistics calculation and award criteria, Kobo Plus catalog availability and subscription entitlement, wishlist and recommendation algorithm, series detection and reading order, night mode and blue-light filter, offline library download management and storage, dictionary and translation language support, social activity privacy and sharing controls, publisher content restrictions and geo-licensing, and Rakuten/Kobo account integration.

## Core User Journeys

- User creates or restores a Kobo Books-style account, completes role, school, subscription, or tenant checks, and reaches the dashboard.
...
| Store/Discovery | Book browsing, search, recommendations, wishlists, purchasing, and subscription catalog exploration | browse, search, filter, preview, purchase, wishlist, subscribe | browsing, searching, previewing, purchasing, empty-results | purchase failed, region-unavailable, catalog unavailable, recommendation cold-start |
| Progress/Stats | Reading statistics, progress tracking, goals, challenges, year-in-review, awards, and reading history | view, set-goal, join-challenge, log-progress, share-stats | tracking, goal-set, challenge-active, review-ready, empty | stats calculation error, goal missed, challenge ended, data incomplete |
...
- Treat reading history and behavioral patterns (books read, pages, time spent), library contents and purchase history, subscription and payment information, annotations, highlights, and notes (potentially sensitive personal reflections), bookmarks and reading progress across devices, account credentials and session tokens, social/community features (friends, reading activity, reviews), wishlist and recommendation data, offline downloaded content and DRM credentials, children's reading profiles and parental controls, imported library data (Goodreads, other services), push notification tokens and delivery preferences, and content licensing and regional availability data as launch-blocking review areas with owners, mitigations, and acceptance tests before implementation.
...
- Monetization model: use original free/trial/paid/sponsored/school/provider/tenant entitlement logic; do not copy exact pricing, plan names, bundle names, promotional copy, school contracts, tenant offers, or partner offers from Kobo Books.
...
- Manual verification tests for Kobo account and subscription policy (individual purchase vs Kobo Plus Unlimited), e-book DRM (Adobe DRM, Kobo DRM) and format support (EPUB, PDF, MOBI, CBR, CBZ), audiobook DRM and streaming vs download, bookstore content catalog and regional availability, in-app purchase restrictions on iOS (Apple requirement to remove store links), reading progress sync and cross-device bookmark reconciliation, font embedding and custom font loading, annotation and highlight sync and export, reading statistics calculation and award criteria, Kobo Plus catalog availability and subscription entitlement, wishlist and recommendation algorithm, series detection and reading order, night mode and blue-light filter, offline library download management and storage, dictionary and translation language support, social activity privacy and sharing controls, publisher content restrictions and geo-licensing, and Rakuten/Kobo account integration.
...
- Phase 4: Add app-specific safety controls for e-book and audiobook reading platform with e-book reader (EPUB, PDF, CBR/CBZ), audiobook playback, bookstore browsing and purchasing, reading progress sync across devices, customizable reading experience (fonts, margins, line spacing, themes, brightness), highlighting and annotation, bookmark management, reading statistics and awards, Kobo Plus subscription (unlimited e-books and audiobooks), wishlist and recommendations, series management, dark mode and night mode, offline library access, dictionary and translation lookup, and social features (reading activity, reviews).
...
- Confirm legal/privacy retention behavior for Kobo Books-style sensitive records and update API contracts before downstream implementation.
