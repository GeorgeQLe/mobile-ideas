# Axios-Style Clone Spec

> Metadata
> - Inspiration app: Axios
> - Category: News
...
> - Manual verification blockers: Axios account and Axios Pro subscription policy (free vs Pro subscriber for business intelligence), Smart Brevity article format rendering and structured content, newsletter and local edition integration (Axios Local cities), push notification category configuration (breaking, newsletters, topics, local), personalization algorithm and topic following, saved articles sync across devices, Axios Pro premium content entitlement and pricing tiers, podcast feed (Axios Today) and background audio playback, local edition city selection and geo-detection, ad serving and consent framework (Axios native advertising), dark mode and dynamic type support, accessibility features (VoiceOver, dynamic type), offline article caching, and Axios/Cox Enterprises account integration.
...
Build an original mobile product inspired by Axios's public news workflow. The V1 clone focuses on smart brevity news with concise article format (Why it matters, The big picture, What's next), top stories feed, section navigation (Politics, Business, Tech, Science, Health, World, Energy, Media, Sports, Cities), Axios newsletters and local editions, push notification alerts for breaking news, saved articles, personalized topic following, Axios Pro premium business intelligence, podcast integration (Axios Today), dark mode, and ad-supported with Axios Pro premium subscription.
...
- Preserve the functional job behind Axios while using original product naming, original UI, original sample data, and licensed integrations.
...
- Do not copy Axios branding, logos, screenshots, marketing copy, private APIs, proprietary datasets, plan names, UI trade dress, course libraries, textbook solutions, documents, school content, AI prompts, or protected media.
...
|---|---|---|---|
| Apple App Store | https://apps.apple.com/us/app/axios/id1573872498 | iOS listing, privacy labels, release notes, news/Smart Brevity claims, and support links | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
| Google Play | https://play.google.com/store/apps/details?id=com.axios.android | Android listing, data safety, news/newsletter claims, and release cadence | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
| Official product site | https://www.axios.com/ | Axios smart brevity news, newsletters, and editorial positioning | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
| Official help | https://www.axios.com/contact | Axios app help, feedback, and troubleshooting | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
| Privacy policy | https://www.axios.com/privacy-policy | Axios data collection, advertising, and privacy disclosures | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
| Terms | https://www.axios.com/terms | Axios services, content licensing, and acceptable-use boundaries | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
...
- Manual blockers must remain launch-blocking until verified: Axios account and Axios Pro subscription policy (free vs Pro subscriber for business intelligence), Smart Brevity article format rendering and structured content, newsletter and local edition integration (Axios Local cities), push notification category configuration (breaking, newsletters, topics, local), personalization algorithm and topic following, saved articles sync across devices, Axios Pro premium content entitlement and pricing tiers, podcast feed (Axios Today) and background audio playback, local edition city selection and geo-detection, ad serving and consent framework (Axios native advertising), dark mode and dynamic type support, accessibility features (VoiceOver, dynamic type), offline article caching, and Axios/Cox Enterprises account integration.

## Core User Journeys

- User creates or restores a Axios-style account, completes role, school, subscription, or tenant checks, and reaches the dashboard.
...
- Monetization model: use original free/trial/paid/sponsored/school/provider/tenant entitlement logic; do not copy exact pricing, plan names, bundle names, promotional copy, school contracts, tenant offers, or partner offers from Axios.
...
- Manual verification tests for Axios account and Axios Pro subscription policy (free vs Pro subscriber for business intelligence), Smart Brevity article format rendering and structured content, newsletter and local edition integration (Axios Local cities), push notification category configuration (breaking, newsletters, topics, local), personalization algorithm and topic following, saved articles sync across devices, Axios Pro premium content entitlement and pricing tiers, podcast feed (Axios Today) and background audio playback, local edition city selection and geo-detection, ad serving and consent framework (Axios native advertising), dark mode and dynamic type support, accessibility features (VoiceOver, dynamic type), offline article caching, and Axios/Cox Enterprises account integration.
...
- Phase 4: Add app-specific safety controls for smart brevity news with concise article format (Why it matters, The big picture, What's next), top stories feed, section navigation (Politics, Business, Tech, Science, Health, World, Energy, Media, Sports, Cities), Axios newsletters and local editions, push notification alerts for breaking news, saved articles, personalized topic following, Axios Pro premium business intelligence, podcast integration (Axios Today), dark mode, and ad-supported with Axios Pro premium subscription.
...
- Confirm legal/privacy retention behavior for Axios-style sensitive records and update API contracts before downstream implementation.
