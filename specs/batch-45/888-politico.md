# Politico-Style Clone Spec

> Metadata
> - Inspiration app: Politico
> - Category: News
...
> - Manual verification blockers: Politico account and Politico Pro subscription policy (free vs Pro subscriber), paywall enforcement for Pro-only policy analysis and intelligence, Playbook and newsletter content integration and delivery timing, push notification category configuration (breaking, Playbook, policy areas), personalization algorithm and policy topic following, saved articles sync across devices, Pro premium content entitlement and institutional access, live event and hearing coverage real-time updates, podcast feed and background audio playback, ad serving and consent framework (Axel Springer/Politico), dark mode and dynamic type support, accessibility features (VoiceOver, dynamic type), offline article caching, EU edition (Politico Europe) content and regional switching, and Axel Springer/Politico account integration.
...
Build an original mobile product inspired by Politico's public news workflow. The V1 clone focuses on political news and policy analysis with top stories feed, section navigation (Congress, White House, Elections, Policy, Magazine, Opinion, Playbook), Playbook daily newsletter reading, policy newsletters (Morning Energy, Morning Defense, etc.), push notification alerts for breaking political news, saved articles, personalized topic following, Politico Pro premium content, live event coverage, podcast integration, dark mode, and ad-supported with Politico Pro premium subscription.
...
- Preserve the functional job behind Politico while using original product naming, original UI, original sample data, and licensed integrations.
...
- Do not copy Politico branding, logos, screenshots, marketing copy, private APIs, proprietary datasets, plan names, UI trade dress, course libraries, textbook solutions, documents, school content, AI prompts, or protected media.
...
|---|---|---|---|
| Apple App Store | https://apps.apple.com/us/app/politico/id490649587 | iOS listing, privacy labels, release notes, political news claims, and support links | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
| Google Play | https://play.google.com/store/apps/details?id=com.politico.android | Android listing, data safety, political news/policy claims, and release cadence | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
| Official product site | https://www.politico.com/ | Politico political news, Playbook, policy, and editorial positioning | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
| Official help | https://www.politico.com/faq | Politico app help, account, subscription, and troubleshooting | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
| Privacy policy | https://www.politico.com/privacy-policy | Politico/Axel Springer data collection, advertising, and privacy disclosures | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
| Terms | https://www.politico.com/terms-of-service | Politico services, content licensing, and acceptable-use boundaries | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
...
- Manual blockers must remain launch-blocking until verified: Politico account and Politico Pro subscription policy (free vs Pro subscriber), paywall enforcement for Pro-only policy analysis and intelligence, Playbook and newsletter content integration and delivery timing, push notification category configuration (breaking, Playbook, policy areas), personalization algorithm and policy topic following, saved articles sync across devices, Pro premium content entitlement and institutional access, live event and hearing coverage real-time updates, podcast feed and background audio playback, ad serving and consent framework (Axel Springer/Politico), dark mode and dynamic type support, accessibility features (VoiceOver, dynamic type), offline article caching, EU edition (Politico Europe) content and regional switching, and Axel Springer/Politico account integration.

## Core User Journeys

- User creates or restores a Politico-style account, completes role, school, subscription, or tenant checks, and reaches the dashboard.
...
- Monetization model: use original free/trial/paid/sponsored/school/provider/tenant entitlement logic; do not copy exact pricing, plan names, bundle names, promotional copy, school contracts, tenant offers, or partner offers from Politico.
...
- Manual verification tests for Politico account and Politico Pro subscription policy (free vs Pro subscriber), paywall enforcement for Pro-only policy analysis and intelligence, Playbook and newsletter content integration and delivery timing, push notification category configuration (breaking, Playbook, policy areas), personalization algorithm and policy topic following, saved articles sync across devices, Pro premium content entitlement and institutional access, live event and hearing coverage real-time updates, podcast feed and background audio playback, ad serving and consent framework (Axel Springer/Politico), dark mode and dynamic type support, accessibility features (VoiceOver, dynamic type), offline article caching, EU edition (Politico Europe) content and regional switching, and Axel Springer/Politico account integration.
...
- Phase 4: Add app-specific safety controls for political news and policy analysis with top stories feed, section navigation (Congress, White House, Elections, Policy, Magazine, Opinion, Playbook), Playbook daily newsletter reading, policy newsletters (Morning Energy, Morning Defense, etc.), push notification alerts for breaking political news, saved articles, personalized topic following, Politico Pro premium content, live event coverage, podcast integration, dark mode, and ad-supported with Politico Pro premium subscription.
...
- Confirm legal/privacy retention behavior for Politico-style sensitive records and update API contracts before downstream implementation.
