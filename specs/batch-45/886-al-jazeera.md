# Al Jazeera-Style Clone Spec

> Metadata
> - Inspiration app: Al Jazeera
> - Category: News
...
> - Manual verification blockers: Al Jazeera account policy, live TV streaming geo-restrictions and regional availability, Arabic/English language switching and content parity, video content rights and documentary licensing, push notification category configuration (breaking, regions, topics), saved articles sync across devices, audio article and podcast playback with background audio, offline article download and storage management, multi-language content management (English, Arabic), ad serving and consent framework, dark mode and dynamic type support, accessibility features (VoiceOver, RTL layout for Arabic), regional content censorship and availability, embedded video player behavior, and Al Jazeera Media Network editorial independence disclosures.
...
Build an original mobile product inspired by Al Jazeera's public news workflow. The V1 clone focuses on international news coverage with top stories feed, section navigation (Middle East, Africa, Asia, US & Canada, Latin America, Europe, Asia Pacific, Features, Opinion, Economy, Science & Technology, Sport), Al Jazeera English and Al Jazeera Arabic live TV streaming, video documentaries and investigative reports, push notification alerts for breaking news, saved articles, audio articles, podcasts (The Take, Newsfeed), offline reading, dark mode, multi-language support (English, Arabic), and free ad-supported model with public media funding.
...
- Preserve the functional job behind Al Jazeera while using original product naming, original UI, original sample data, and licensed integrations.
...
- Do not copy Al Jazeera branding, logos, screenshots, marketing copy, private APIs, proprietary datasets, plan names, UI trade dress, course libraries, textbook solutions, documents, school content, AI prompts, or protected media.
...
|---|---|---|---|
| Apple App Store | https://apps.apple.com/us/app/al-jazeera-english/id409648957 | iOS listing, privacy labels, release notes, international news claims, and support links | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
| Google Play | https://play.google.com/store/apps/details?id=com.aljazeera.mobile | Android listing, data safety, international news/live TV claims, and release cadence | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
| Official product site | https://www.aljazeera.com/ | Al Jazeera English international news, documentaries, and editorial positioning | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
| Official help | https://www.aljazeera.com/contact-us | Al Jazeera app help, feedback, and troubleshooting | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
| Privacy policy | https://www.aljazeera.com/privacy-policy | Al Jazeera data collection, analytics, and privacy disclosures | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
| Terms | https://www.aljazeera.com/terms-and-conditions | Al Jazeera services, content, and acceptable-use boundaries | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
...
- Manual blockers must remain launch-blocking until verified: Al Jazeera account policy, live TV streaming geo-restrictions and regional availability, Arabic/English language switching and content parity, video content rights and documentary licensing, push notification category configuration (breaking, regions, topics), saved articles sync across devices, audio article and podcast playback with background audio, offline article download and storage management, multi-language content management (English, Arabic), ad serving and consent framework, dark mode and dynamic type support, accessibility features (VoiceOver, RTL layout for Arabic), regional content censorship and availability, embedded video player behavior, and Al Jazeera Media Network editorial independence disclosures.

## Core User Journeys

- User creates or restores a Al Jazeera-style account, completes role, school, subscription, or tenant checks, and reaches the dashboard.
...
- Monetization model: use original free/trial/paid/sponsored/school/provider/tenant entitlement logic; do not copy exact pricing, plan names, bundle names, promotional copy, school contracts, tenant offers, or partner offers from Al Jazeera.
...
- Manual verification tests for Al Jazeera account policy, live TV streaming geo-restrictions and regional availability, Arabic/English language switching and content parity, video content rights and documentary licensing, push notification category configuration (breaking, regions, topics), saved articles sync across devices, audio article and podcast playback with background audio, offline article download and storage management, multi-language content management (English, Arabic), ad serving and consent framework, dark mode and dynamic type support, accessibility features (VoiceOver, RTL layout for Arabic), regional content censorship and availability, embedded video player behavior, and Al Jazeera Media Network editorial independence disclosures.
...
- Phase 4: Add app-specific safety controls for international news coverage with top stories feed, section navigation (Middle East, Africa, Asia, US & Canada, Latin America, Europe, Asia Pacific, Features, Opinion, Economy, Science & Technology, Sport), Al Jazeera English and Al Jazeera Arabic live TV streaming, video documentaries and investigative reports, push notification alerts for breaking news, saved articles, audio articles, podcasts (The Take, Newsfeed), offline reading, dark mode, multi-language support (English, Arabic), and free ad-supported model with public media funding.
...
- Confirm legal/privacy retention behavior for Al Jazeera-style sensitive records and update API contracts before downstream implementation.
