# ABC News-Style Clone Spec

> Metadata
> - Inspiration app: ABC News
> - Category: News
...
> - Manual verification blockers: ABC News account and Disney+ integration policy, ABC News Live streaming availability and ad insertion, video content rights and DRM for show segments, cable provider authentication for certain live content, push notification category configuration (breaking, politics, entertainment, sports, shows), FiveThirtyEight data journalism and poll aggregation content, personalization algorithm and topic following, local ABC station content integration and geo-detection, saved articles sync across devices, ad serving and consent framework (Disney/ABC), dark mode and dynamic type support, accessibility features (VoiceOver, captions for video), offline article caching, embedded video player behavior (autoplay, PiP), and Disney/ABC account integration.
...
Build an original mobile product inspired by ABC News's public news workflow. The V1 clone focuses on breaking news and live coverage with top stories feed, section navigation (US, International, Politics, Business, Technology, Entertainment, Health, Sports, Lifestyle, Science), ABC News Live streaming (24/7), video clips and show segments (Good Morning America, World News Tonight, 20/20, Nightline, This Week), push notification alerts for breaking news, personalized news feed, saved articles, FiveThirtyEight data journalism integration, local ABC station news, dark mode, and ad-supported model.
...
- Preserve the functional job behind ABC News while using original product naming, original UI, original sample data, and licensed integrations.
...
- Do not copy ABC News branding, logos, screenshots, marketing copy, private APIs, proprietary datasets, plan names, UI trade dress, course libraries, textbook solutions, documents, school content, AI prompts, or protected media.
...
|---|---|---|---|
| Apple App Store | https://apps.apple.com/us/app/abc-news-breaking-news-live/id300255638 | iOS listing, privacy labels, release notes, news/streaming claims, and support links | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
| Google Play | https://play.google.com/store/apps/details?id=com.abc.abcnews | Android listing, data safety, news/live streaming claims, and release cadence | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
| Official product site | https://abcnews.go.com/ | ABC News breaking news, live, shows, and editorial positioning | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
| Official help | https://abcnews.go.com/meta/contact | ABC News app help, feedback, and troubleshooting | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
| Privacy policy | https://disneyprivacycenter.com/ | Disney/ABC data collection, advertising, and privacy disclosures | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
| Terms | https://disneytermsofuse.com/ | Disney/ABC services, content licensing, and acceptable-use boundaries | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
...
- Manual blockers must remain launch-blocking until verified: ABC News account and Disney+ integration policy, ABC News Live streaming availability and ad insertion, video content rights and DRM for show segments, cable provider authentication for certain live content, push notification category configuration (breaking, politics, entertainment, sports, shows), FiveThirtyEight data journalism and poll aggregation content, personalization algorithm and topic following, local ABC station content integration and geo-detection, saved articles sync across devices, ad serving and consent framework (Disney/ABC), dark mode and dynamic type support, accessibility features (VoiceOver, captions for video), offline article caching, embedded video player behavior (autoplay, PiP), and Disney/ABC account integration.

## Core User Journeys

- User creates or restores a ABC News-style account, completes role, school, subscription, or tenant checks, and reaches the dashboard.
...
- Monetization model: use original free/trial/paid/sponsored/school/provider/tenant entitlement logic; do not copy exact pricing, plan names, bundle names, promotional copy, school contracts, tenant offers, or partner offers from ABC News.
...
- Manual verification tests for ABC News account and Disney+ integration policy, ABC News Live streaming availability and ad insertion, video content rights and DRM for show segments, cable provider authentication for certain live content, push notification category configuration (breaking, politics, entertainment, sports, shows), FiveThirtyEight data journalism and poll aggregation content, personalization algorithm and topic following, local ABC station content integration and geo-detection, saved articles sync across devices, ad serving and consent framework (Disney/ABC), dark mode and dynamic type support, accessibility features (VoiceOver, captions for video), offline article caching, embedded video player behavior (autoplay, PiP), and Disney/ABC account integration.
...
- Phase 4: Add app-specific safety controls for breaking news and live coverage with top stories feed, section navigation (US, International, Politics, Business, Technology, Entertainment, Health, Sports, Lifestyle, Science), ABC News Live streaming (24/7), video clips and show segments (Good Morning America, World News Tonight, 20/20, Nightline, This Week), push notification alerts for breaking news, personalized news feed, saved articles, FiveThirtyEight data journalism integration, local ABC station news, dark mode, and ad-supported model.
...
- Confirm legal/privacy retention behavior for ABC News-style sensitive records and update API contracts before downstream implementation.
