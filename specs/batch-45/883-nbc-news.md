# NBC News-Style Clone Spec

> Metadata
> - Inspiration app: NBC News
> - Category: News
...
> - Manual verification blockers: NBC News account policy, NBC News NOW live stream availability and ad insertion, video content rights and DRM for show segments, cable provider authentication for certain live content, push notification category configuration (breaking, politics, health, sports, shows), personalization algorithm and topic/show following, saved articles sync across devices, audio article playback and background audio, local NBC station content integration and geo-detection, ad serving and consent framework (NBCUniversal), dark mode and dynamic type support, accessibility features (VoiceOver, captions for video), offline article caching, embedded video player behavior (autoplay, PiP), and NBCUniversal/Comcast account integration.
...
Build an original mobile product inspired by NBC News's public news workflow. The V1 clone focuses on breaking news and live coverage with top stories feed, section navigation (US, World, Politics, Business, Health, Science, Tech, Culture, Sports), NBC News NOW live streaming, video clips and show segments (Today, Nightly News, Meet the Press, Dateline), push notification alerts for breaking news, personalized news feed, saved articles, audio articles, local news integration (NBC stations), dark mode, text size adjustment, and ad-supported model.
...
- Preserve the functional job behind NBC News while using original product naming, original UI, original sample data, and licensed integrations.
...
- Do not copy NBC News branding, logos, screenshots, marketing copy, private APIs, proprietary datasets, plan names, UI trade dress, course libraries, textbook solutions, documents, school content, AI prompts, or protected media.
...
|---|---|---|---|
| Apple App Store | https://apps.apple.com/us/app/nbc-news-breaking-us-news/id319740707 | iOS listing, privacy labels, release notes, news/streaming claims, and support links | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
| Google Play | https://play.google.com/store/apps/details?id=com.zumobi.msnbc | Android listing, data safety, news/live streaming claims, and release cadence | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
| Official product site | https://www.nbcnews.com/ | NBC News breaking news, live, video, and editorial positioning | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
| Official help | https://nbcnews.zendesk.com/ | NBC News app help, account, and troubleshooting | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
| Privacy policy | https://www.nbcuniversal.com/privacy | NBCUniversal data collection, advertising, and privacy disclosures | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
| Terms | https://www.nbcuniversal.com/terms | NBCUniversal services, content licensing, and acceptable-use boundaries | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
...
- Manual blockers must remain launch-blocking until verified: NBC News account policy, NBC News NOW live stream availability and ad insertion, video content rights and DRM for show segments, cable provider authentication for certain live content, push notification category configuration (breaking, politics, health, sports, shows), personalization algorithm and topic/show following, saved articles sync across devices, audio article playback and background audio, local NBC station content integration and geo-detection, ad serving and consent framework (NBCUniversal), dark mode and dynamic type support, accessibility features (VoiceOver, captions for video), offline article caching, embedded video player behavior (autoplay, PiP), and NBCUniversal/Comcast account integration.

## Core User Journeys

- User creates or restores a NBC News-style account, completes role, school, subscription, or tenant checks, and reaches the dashboard.
...
- Monetization model: use original free/trial/paid/sponsored/school/provider/tenant entitlement logic; do not copy exact pricing, plan names, bundle names, promotional copy, school contracts, tenant offers, or partner offers from NBC News.
...
- Manual verification tests for NBC News account policy, NBC News NOW live stream availability and ad insertion, video content rights and DRM for show segments, cable provider authentication for certain live content, push notification category configuration (breaking, politics, health, sports, shows), personalization algorithm and topic/show following, saved articles sync across devices, audio article playback and background audio, local NBC station content integration and geo-detection, ad serving and consent framework (NBCUniversal), dark mode and dynamic type support, accessibility features (VoiceOver, captions for video), offline article caching, embedded video player behavior (autoplay, PiP), and NBCUniversal/Comcast account integration.
...
- Confirm legal/privacy retention behavior for NBC News-style sensitive records and update API contracts before downstream implementation.
