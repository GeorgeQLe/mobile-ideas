# Semafor-Style Clone Spec

> Metadata
> - Inspiration app: Semafor
> - Category: News
...
> - Manual verification blockers: Semafor account policy, Semaform structured article format rendering (multi-section per story), Signals global perspective aggregation and attribution, newsletter integration and delivery timing, push notification category configuration (breaking, Flagship, topics), saved articles sync across devices, event and summit coverage real-time updates, sponsored content labeling and native advertising, dark mode and dynamic type support, accessibility features (VoiceOver, dynamic type), offline article caching, global correspondent byline and regional perspective, and Semafor account integration.
...
Build an original mobile product inspired by Semafor's public news workflow. The V1 clone focuses on global news with Semaform structured article format (The News, The Reporter's View, Room for Disagreement, The View From, Notable), top stories feed, section navigation (Business, Tech, Media, Climate, World), Flagship newsletter, Semafor Signals (diverse global perspectives on each story), push notification alerts for breaking news, saved articles, event coverage (Semafor World Economy Summit, etc.), dark mode, and ad-supported with sponsored content model.
...
- Preserve the functional job behind Semafor while using original product naming, original UI, original sample data, and licensed integrations.
...
- Do not copy Semafor branding, logos, screenshots, marketing copy, private APIs, proprietary datasets, plan names, UI trade dress, course libraries, textbook solutions, documents, school content, AI prompts, or protected media.
...
|---|---|---|---|
| Apple App Store | https://apps.apple.com/us/app/semafor/id1661427043 | iOS listing, privacy labels, release notes, global news claims, and support links | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
| Google Play | https://play.google.com/store/apps/details?id=com.semafor.android | Android listing, data safety, structured news claims, and release cadence | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
| Official product site | https://www.semafor.com/ | Semafor global news, Semaform, Signals, and editorial positioning | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
| Official help | https://www.semafor.com/contact | Semafor app help, feedback, and troubleshooting | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
| Privacy policy | https://www.semafor.com/privacy-policy | Semafor data collection, advertising, and privacy disclosures | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
| Terms | https://www.semafor.com/terms-of-service | Semafor services, content, and acceptable-use boundaries | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
...
- Manual blockers must remain launch-blocking until verified: Semafor account policy, Semaform structured article format rendering (multi-section per story), Signals global perspective aggregation and attribution, newsletter integration and delivery timing, push notification category configuration (breaking, Flagship, topics), saved articles sync across devices, event and summit coverage real-time updates, sponsored content labeling and native advertising, dark mode and dynamic type support, accessibility features (VoiceOver, dynamic type), offline article caching, global correspondent byline and regional perspective, and Semafor account integration.

## Core User Journeys

- User creates or restores a Semafor-style account, completes role, school, subscription, or tenant checks, and reaches the dashboard.
...
- Monetization model: use original free/trial/paid/sponsored/school/provider/tenant entitlement logic; do not copy exact pricing, plan names, bundle names, promotional copy, school contracts, tenant offers, or partner offers from Semafor.
...
- Manual verification tests for Semafor account policy, Semaform structured article format rendering (multi-section per story), Signals global perspective aggregation and attribution, newsletter integration and delivery timing, push notification category configuration (breaking, Flagship, topics), saved articles sync across devices, event and summit coverage real-time updates, sponsored content labeling and native advertising, dark mode and dynamic type support, accessibility features (VoiceOver, dynamic type), offline article caching, global correspondent byline and regional perspective, and Semafor account integration.
...
- Phase 4: Add app-specific safety controls for global news with Semaform structured article format (The News, The Reporter's View, Room for Disagreement, The View From, Notable), top stories feed, section navigation (Business, Tech, Media, Climate, World), Flagship newsletter, Semafor Signals (diverse global perspectives on each story), push notification alerts for breaking news, saved articles, event coverage (Semafor World Economy Summit, etc.), dark mode, and ad-supported with sponsored content model.
...
- Confirm legal/privacy retention behavior for Semafor-style sensitive records and update API contracts before downstream implementation.
