# Fox News-Style Clone Spec

> Metadata
> - Inspiration app: Fox News
> - Category: News
...
> - Manual verification blockers: Fox News account and Fox Nation subscription policy, content access (free vs Fox Nation subscriber-only shows), live TV streaming authentication and cable provider sign-in (TV Everywhere/MVPD), Fox Nation streaming DRM and device limits, video content rights and adaptive bitrate delivery, push notification category configuration (breaking, politics, opinion, sports, alerts), personalization algorithm and topic following, saved articles sync across devices, audio article generation and playback, podcast feed integration and background audio, live blog real-time update delivery, ad serving and consent framework, dark mode and dynamic type support, accessibility features (VoiceOver, captions for video), offline article caching, embedded video player behavior (autoplay, PiP), and Fox Corporation account integration.
...
Build an original mobile product inspired by Fox News's public news workflow. The V1 clone focuses on breaking news and opinion with top stories feed, section navigation (US, World, Opinion, Politics, Entertainment, Business, Lifestyle, Science, Tech, Health, Sports), Fox News Live and Fox Nation streaming, video clips and show segments, push notification alerts for breaking news, personalized news feed, saved articles, audio articles, podcast integration, live blog coverage, dark mode, text size adjustment, and ad-supported with Fox Nation premium subscription.
...
- Preserve the functional job behind Fox News while using original product naming, original UI, original sample data, and licensed integrations.
...
- Do not copy Fox News branding, logos, screenshots, marketing copy, private APIs, proprietary datasets, plan names, UI trade dress, course libraries, textbook solutions, documents, school content, AI prompts, or protected media.
...
|---|---|---|---|
| Apple App Store | https://apps.apple.com/us/app/fox-news-breaking-news-live/id367623988 | iOS listing, privacy labels, release notes, news/streaming claims, and support links | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
| Google Play | https://play.google.com/store/apps/details?id=com.foxnews.android | Android listing, data safety, news/live TV/Fox Nation claims, and release cadence | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
| Official product site | https://www.foxnews.com/ | Fox News breaking news, opinion, Fox Nation, and editorial positioning | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
| Official help | https://help.foxnews.com/ | Fox News app help, account, Fox Nation subscription, and troubleshooting | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
| Privacy policy | https://www.foxnews.com/privacy-policy | Fox News/Fox Corporation data collection, advertising, and privacy disclosures | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
| Terms | https://www.foxnews.com/terms-of-use | Fox News services, content licensing, and acceptable-use boundaries | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
...
- Manual blockers must remain launch-blocking until verified: Fox News account and Fox Nation subscription policy, content access (free vs Fox Nation subscriber-only shows), live TV streaming authentication and cable provider sign-in (TV Everywhere/MVPD), Fox Nation streaming DRM and device limits, video content rights and adaptive bitrate delivery, push notification category configuration (breaking, politics, opinion, sports, alerts), personalization algorithm and topic following, saved articles sync across devices, audio article generation and playback, podcast feed integration and background audio, live blog real-time update delivery, ad serving and consent framework, dark mode and dynamic type support, accessibility features (VoiceOver, captions for video), offline article caching, embedded video player behavior (autoplay, PiP), and Fox Corporation account integration.

## Core User Journeys

- User creates or restores a Fox News-style account, completes role, school, subscription, or tenant checks, and reaches the dashboard.
...
- Monetization model: use original free/trial/paid/sponsored/school/provider/tenant entitlement logic; do not copy exact pricing, plan names, bundle names, promotional copy, school contracts, tenant offers, or partner offers from Fox News.
...
- Manual verification tests for Fox News account and Fox Nation subscription policy, content access (free vs Fox Nation subscriber-only shows), live TV streaming authentication and cable provider sign-in (TV Everywhere/MVPD), Fox Nation streaming DRM and device limits, video content rights and adaptive bitrate delivery, push notification category configuration (breaking, politics, opinion, sports, alerts), personalization algorithm and topic following, saved articles sync across devices, audio article generation and playback, podcast feed integration and background audio, live blog real-time update delivery, ad serving and consent framework, dark mode and dynamic type support, accessibility features (VoiceOver, captions for video), offline article caching, embedded video player behavior (autoplay, PiP), and Fox Corporation account integration.
...
- Phase 4: Add app-specific safety controls for breaking news and opinion with top stories feed, section navigation (US, World, Opinion, Politics, Entertainment, Business, Lifestyle, Science, Tech, Health, Sports), Fox News Live and Fox Nation streaming, video clips and show segments, push notification alerts for breaking news, personalized news feed, saved articles, audio articles, podcast integration, live blog coverage, dark mode, text size adjustment, and ad-supported with Fox Nation premium subscription.
...
- Confirm legal/privacy retention behavior for Fox News-style sensitive records and update API contracts before downstream implementation.
