# Nook-Style Clone Spec

> Metadata
> - Inspiration app: Nook
...
> - Manual verification blockers: Barnes & Noble/NOOK account and purchasing policy, e-book DRM (Barnes & Noble DRM, Adobe DRM) and format support (EPUB, PDF), magazine/newspaper content delivery and publisher agreements, in-app purchase restrictions on iOS (Apple requirement), Barnes & Noble bookstore catalog and regional availability, reading progress sync across devices and NOOK cloud, font and reading customization persistence, annotation and highlight sync and export, library shelf and collection organization, NOOK Pass subscription catalog and entitlement, LendMe lending eligibility per publisher and friend management, kids' profile creation and content filtering, offline library download management and storage, dictionary language support, social features (friends list, recommendation sharing) and privacy controls, magazine rendering and interactive content, Barnes & Noble membership discount integration, and legacy NOOK device library compatibility.
...
Build an original mobile product inspired by Nook's public books & reference workflow. The V1 clone focuses on e-book and magazine reading platform with e-book reader (EPUB, PDF), magazine and newspaper browsing, Barnes & Noble bookstore integration, customizable reading experience (fonts, themes, margins, line spacing, brightness), highlighting and note-taking, bookmark management, reading progress sync, library organization (shelves, collections), NOOK Pass subscription (curated selections), wishlist and recommendations, LendMe book lending, kids' reading profiles, offline library access, dictionary lookup, social features (friends, recommendations), and Barnes & Noble membership integration.
...
- Preserve the functional job behind Nook while using original product naming, original UI, original sample data, and licensed integrations.
...
- Do not copy Nook branding, logos, screenshots, marketing copy, private APIs, proprietary datasets, plan names, UI trade dress, course libraries, textbook solutions, documents, school content, AI prompts, or protected media.
...
|---|---|---|---|
| Apple App Store | https://apps.apple.com/us/app/barnes-noble-nook/id373582546 | iOS listing, privacy labels, release notes, e-book/magazine claims, and support links | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
| Google Play | https://play.google.com/store/apps/details?id=bn.ereader | Android listing, data safety, e-book/magazine/NOOK claims, and release cadence | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
| Official product site | https://www.barnesandnoble.com/h/nook | NOOK e-books, magazines, NOOK devices, and product positioning | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
| Official help | https://help.barnesandnoble.com/ | NOOK app help, account, library, reading, and troubleshooting | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
| Privacy policy | https://www.barnesandnoble.com/h/help/privacy-policy | Barnes & Noble/NOOK data collection, reading data, and privacy disclosures | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
| Terms | https://www.barnesandnoble.com/h/help/terms-of-use | Barnes & Noble/NOOK services, content licensing, and acceptable-use boundaries | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
...
- Manual blockers must remain launch-blocking until verified: Barnes & Noble/NOOK account and purchasing policy, e-book DRM (Barnes & Noble DRM, Adobe DRM) and format support (EPUB, PDF), magazine/newspaper content delivery and publisher agreements, in-app purchase restrictions on iOS (Apple requirement), Barnes & Noble bookstore catalog and regional availability, reading progress sync across devices and NOOK cloud, font and reading customization persistence, annotation and highlight sync and export, library shelf and collection organization, NOOK Pass subscription catalog and entitlement, LendMe lending eligibility per publisher and friend management, kids' profile creation and content filtering, offline library download management and storage, dictionary language support, social features (friends list, recommendation sharing) and privacy controls, magazine rendering and interactive content, Barnes & Noble membership discount integration, and legacy NOOK device library compatibility.

## Core User Journeys

- User creates or restores a Nook-style account, completes role, school, subscription, or tenant checks, and reaches the dashboard.
...
- Monetization model: use original free/trial/paid/sponsored/school/provider/tenant entitlement logic; do not copy exact pricing, plan names, bundle names, promotional copy, school contracts, tenant offers, or partner offers from Nook.
...
- Manual verification tests for Barnes & Noble/NOOK account and purchasing policy, e-book DRM (Barnes & Noble DRM, Adobe DRM) and format support (EPUB, PDF), magazine/newspaper content delivery and publisher agreements, in-app purchase restrictions on iOS (Apple requirement), Barnes & Noble bookstore catalog and regional availability, reading progress sync across devices and NOOK cloud, font and reading customization persistence, annotation and highlight sync and export, library shelf and collection organization, NOOK Pass subscription catalog and entitlement, LendMe lending eligibility per publisher and friend management, kids' profile creation and content filtering, offline library download management and storage, dictionary language support, social features (friends list, recommendation sharing) and privacy controls, magazine rendering and interactive content, Barnes & Noble membership discount integration, and legacy NOOK device library compatibility.
...
- Phase 4: Add app-specific safety controls for e-book and magazine reading platform with e-book reader (EPUB, PDF), magazine and newspaper browsing, Barnes & Noble bookstore integration, customizable reading experience (fonts, themes, margins, line spacing, brightness), highlighting and note-taking, bookmark management, reading progress sync, library organization (shelves, collections), NOOK Pass subscription (curated selections), wishlist and recommendations, LendMe book lending, kids' reading profiles, offline library access, dictionary lookup, social features (friends, recommendations), and Barnes & Noble membership integration.
...
- Confirm legal/privacy retention behavior for Nook-style sensitive records and update API contracts before downstream implementation.
