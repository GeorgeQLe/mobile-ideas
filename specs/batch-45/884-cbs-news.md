# CBS News-Style Clone Spec

> Metadata
> - Inspiration app: CBS News
> - Category: News
...
> - Manual verification blockers: CBS News account and Paramount+ integration policy, CBS News Streaming availability and ad insertion, video content rights and DRM for show episodes (60 Minutes, 48 Hours), Paramount+ authentication for premium content, push notification category configuration (breaking, shows, local, topics), local CBS station content integration and geo-detection, saved articles sync across devices, ad serving and consent framework (Paramount/CBS), dark mode and dynamic type support, accessibility features (VoiceOver, captions for video), offline article caching, embedded video player behavior (autoplay, PiP), and Paramount Global account integration.
...
Build an original mobile product inspired by CBS News's public news workflow. The V1 clone focuses on breaking news and live coverage with top stories feed, section navigation (US, World, Politics, HealthWatch, MoneyWatch, Entertainment, Tech, Science, Crime, Space), CBS News Streaming (24/7 live news channel), CBS News shows (60 Minutes, CBS Mornings, CBS Evening News, 48 Hours, Face the Nation), video clips and full episodes, push notification alerts for breaking news, local CBS station news integration, saved articles, dark mode, and ad-supported model.
...
- Preserve the functional job behind CBS News while using original product naming, original UI, original sample data, and licensed integrations.
...
- Do not copy CBS News branding, logos, screenshots, marketing copy, private APIs, proprietary datasets, plan names, UI trade dress, course libraries, textbook solutions, documents, school content, AI prompts, or protected media.
...
|---|---|---|---|
| Apple App Store | https://apps.apple.com/us/app/cbs-news-live-breaking-news/id334256223 | iOS listing, privacy labels, release notes, news/streaming claims, and support links | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
| Google Play | https://play.google.com/store/apps/details?id=com.treemolabs.apps.cbsnews | Android listing, data safety, news/live streaming claims, and release cadence | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
| Official product site | https://www.cbsnews.com/ | CBS News breaking news, streaming, shows, and editorial positioning | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
| Official help | https://help.cbsnews.com/ | CBS News app help, account, and troubleshooting | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
| Privacy policy | https://www.paramount.com/privacy-policy | Paramount/CBS data collection, advertising, and privacy disclosures | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
| Terms | https://www.paramount.com/terms-of-use | Paramount/CBS services, content licensing, and acceptable-use boundaries | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
...
- Manual blockers must remain launch-blocking until verified: CBS News account and Paramount+ integration policy, CBS News Streaming availability and ad insertion, video content rights and DRM for show episodes (60 Minutes, 48 Hours), Paramount+ authentication for premium content, push notification category configuration (breaking, shows, local, topics), local CBS station content integration and geo-detection, saved articles sync across devices, ad serving and consent framework (Paramount/CBS), dark mode and dynamic type support, accessibility features (VoiceOver, captions for video), offline article caching, embedded video player behavior (autoplay, PiP), and Paramount Global account integration.

## Core User Journeys

- User creates or restores a CBS News-style account, completes role, school, subscription, or tenant checks, and reaches the dashboard.
...
- Monetization model: use original free/trial/paid/sponsored/school/provider/tenant entitlement logic; do not copy exact pricing, plan names, bundle names, promotional copy, school contracts, tenant offers, or partner offers from CBS News.
...
- Manual verification tests for CBS News account and Paramount+ integration policy, CBS News Streaming availability and ad insertion, video content rights and DRM for show episodes (60 Minutes, 48 Hours), Paramount+ authentication for premium content, push notification category configuration (breaking, shows, local, topics), local CBS station content integration and geo-detection, saved articles sync across devices, ad serving and consent framework (Paramount/CBS), dark mode and dynamic type support, accessibility features (VoiceOver, captions for video), offline article caching, embedded video player behavior (autoplay, PiP), and Paramount Global account integration.
...
- Confirm legal/privacy retention behavior for CBS News-style sensitive records and update API contracts before downstream implementation.
