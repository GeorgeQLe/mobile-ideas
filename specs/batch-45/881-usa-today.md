# USA Today-Style Clone Spec

> Metadata
> - Inspiration app: USA Today
> - Category: News
...
> - Manual verification blockers: USA Today account and subscription policy (ad-supported free tier vs USA Today+ subscriber), content access and ad experience differences, local news market detection and ZIP code configuration, live sports score data source and real-time update frequency, 360° video and immersive content rendering and device compatibility, push notification category configuration (breaking, sports scores, local, topics), personalization algorithm and followed-topic feed, saved articles sync across devices, crossword and puzzle rendering and progress persistence, video autoplay and data usage settings, ad serving and consent framework (GDPR, CCPA, Gannett/USA Today Network), dark mode and dynamic type support, accessibility features (VoiceOver, captions for video), offline article caching, interactive data visualization rendering, and Gannett/USA Today Network account integration.
...
Build an original mobile product inspired by USA Today's public news workflow. The V1 clone focuses on national and local news with top stories carousel, section navigation (News, Sports, Money, Life, Tech, Travel, Opinion), short-form video stories (USA Today Originals), live sports scores and standings, interactive storytelling and data visualizations, push notification alerts for breaking news, personalized news feed, saved articles, local news by market, 360° video and immersive content, crosswords and puzzles, dark mode, text size adjustment, and ad-supported with optional subscription (USA Today+).
...
- Preserve the functional job behind USA Today while using original product naming, original UI, original sample data, and licensed integrations.
...
- Do not copy USA Today branding, logos, screenshots, marketing copy, private APIs, proprietary datasets, plan names, UI trade dress, course libraries, textbook solutions, documents, school content, AI prompts, or protected media.
...
|---|---|---|---|
| Apple App Store | https://apps.apple.com/us/app/usa-today-us-breaking-news/id504700302 | iOS listing, privacy labels, release notes, news app claims, and support links | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
| Google Play | https://play.google.com/store/apps/details?id=com.usatoday.android.news | Android listing, data safety, news/sports/local claims, and release cadence | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
| Official product site | https://www.usatoday.com/ | USA Today national news, sports, life, tech, and editorial positioning | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
| Official help | https://help.usatoday.com/ | USA Today app help, account, subscription, and troubleshooting | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
| Privacy policy | https://www.usatoday.com/privacy-policy/ | Gannett/USA Today data collection, advertising, and privacy disclosures | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
| Terms | https://www.usatoday.com/terms/ | USA Today services, content licensing, and acceptable-use boundaries | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
...
- Manual blockers must remain launch-blocking until verified: USA Today account and subscription policy (ad-supported free tier vs USA Today+ subscriber), content access and ad experience differences, local news market detection and ZIP code configuration, live sports score data source and real-time update frequency, 360° video and immersive content rendering and device compatibility, push notification category configuration (breaking, sports scores, local, topics), personalization algorithm and followed-topic feed, saved articles sync across devices, crossword and puzzle rendering and progress persistence, video autoplay and data usage settings, ad serving and consent framework (GDPR, CCPA, Gannett/USA Today Network), dark mode and dynamic type support, accessibility features (VoiceOver, captions for video), offline article caching, interactive data visualization rendering, and Gannett/USA Today Network account integration.

## Core User Journeys

- User creates or restores a USA Today-style account, completes role, school, subscription, or tenant checks, and reaches the dashboard.
...
- Monetization model: use original free/trial/paid/sponsored/school/provider/tenant entitlement logic; do not copy exact pricing, plan names, bundle names, promotional copy, school contracts, tenant offers, or partner offers from USA Today.
...
- Manual verification tests for USA Today account and subscription policy (ad-supported free tier vs USA Today+ subscriber), content access and ad experience differences, local news market detection and ZIP code configuration, live sports score data source and real-time update frequency, 360° video and immersive content rendering and device compatibility, push notification category configuration (breaking, sports scores, local, topics), personalization algorithm and followed-topic feed, saved articles sync across devices, crossword and puzzle rendering and progress persistence, video autoplay and data usage settings, ad serving and consent framework (GDPR, CCPA, Gannett/USA Today Network), dark mode and dynamic type support, accessibility features (VoiceOver, captions for video), offline article caching, interactive data visualization rendering, and Gannett/USA Today Network account integration.
...
- Phase 4: Add app-specific safety controls for national and local news with top stories carousel, section navigation (News, Sports, Money, Life, Tech, Travel, Opinion), short-form video stories (USA Today Originals), live sports scores and standings, interactive storytelling and data visualizations, push notification alerts for breaking news, personalized news feed, saved articles, local news by market, 360° video and immersive content, crosswords and puzzles, dark mode, text size adjustment, and ad-supported with optional subscription (USA Today+).
...
- Confirm legal/privacy retention behavior for USA Today-style sensitive records and update API contracts before downstream implementation.
