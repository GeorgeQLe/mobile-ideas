...
> - Manual verification blockers: Vox account and Vox Media policy, explanatory journalism article format rendering (long-form, card stacks), video explainer embedding and YouTube integration, podcast feed integration and background audio playback, push notification category configuration (major stories, topics, podcasts), newsletter integration and delivery, saved articles sync across devices, ad serving and consent framework (Vox Media advertising), dark mode and dynamic type support, accessibility features (VoiceOver, dynamic type), offline article caching, embedded interactive charts and data visualizations, Vox Media network cross-promotion (The Verge, Polygon, Eater, etc.), and Vox Media account integration.
...
Build an original mobile product inspired by Vox's public news workflow. The V1 clone focuses on explanatory journalism with in-depth articles and analysis, section navigation (Politics, Policy, Culture, Science, Technology, Climate, World, Business, Future Perfect, The Highlight, Even Better), card stacks (explainer cards for complex topics), video explainers (Vox on YouTube integration), podcast integration (Today Explained, The Weeds, Unexplainable, Future Perfect), push notification alerts for major stories, saved articles, newsletter integration, dark mode, and ad-supported with Vox Media advertising model.
...
- Preserve the functional job behind Vox while using original product naming, original UI, original sample data, and licensed integrations.
...
- Do not copy Vox branding, logos, screenshots, marketing copy, private APIs, proprietary datasets, plan names, UI trade dress, course libraries, textbook solutions, documents, school content, AI prompts, or protected media.
...
|---|---|---|---|
| Apple App Store | https://apps.apple.com/us/app/vox/id1572589474 | iOS listing, privacy labels, release notes, explanatory journalism claims, and support links | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
| Google Play | https://play.google.com/store/apps/details?id=com.voxmedia.vox | Android listing, data safety, news/explanatory journalism claims, and release cadence | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
| Official product site | https://www.vox.com/ | Vox explanatory journalism, policy, culture, and editorial positioning | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
| Official help | https://www.vox.com/contact | Vox app help, feedback, and troubleshooting | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
| Privacy policy | https://www.voxmedia.com/legal/privacy-notice | Vox Media data collection, advertising, and privacy disclosures | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
| Terms | https://www.voxmedia.com/legal/terms-of-use | Vox Media services, content licensing, and acceptable-use boundaries | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
...
- Manual blockers must remain launch-blocking until verified: Vox account and Vox Media policy, explanatory journalism article format rendering (long-form, card stacks), video explainer embedding and YouTube integration, podcast feed integration and background audio playback, push notification category configuration (major stories, topics, podcasts), newsletter integration and delivery, saved articles sync across devices, ad serving and consent framework (Vox Media advertising), dark mode and dynamic type support, accessibility features (VoiceOver, dynamic type), offline article caching, embedded interactive charts and data visualizations, Vox Media network cross-promotion (The Verge, Polygon, Eater, etc.), and Vox Media account integration.

## Core User Journeys

- User creates or restores a Vox-style account, completes role, school, subscription, or tenant checks, and reaches the dashboard.
...
- Monetization model: use original free/trial/paid/sponsored/school/provider/tenant entitlement logic; do not copy exact pricing, plan names, bundle names, promotional copy, school contracts, tenant offers, or partner offers from Vox.
...
- Manual verification tests for Vox account and Vox Media policy, explanatory journalism article format rendering (long-form, card stacks), video explainer embedding and YouTube integration, podcast feed integration and background audio playback, push notification category configuration (major stories, topics, podcasts), newsletter integration and delivery, saved articles sync across devices, ad serving and consent framework (Vox Media advertising), dark mode and dynamic type support, accessibility features (VoiceOver, dynamic type), offline article caching, embedded interactive charts and data visualizations, Vox Media network cross-promotion (The Verge, Polygon, Eater, etc.), and Vox Media account integration.
...
- Phase 4: Add app-specific safety controls for explanatory journalism with in-depth articles and analysis, section navigation (Politics, Policy, Culture, Science, Technology, Climate, World, Business, Future Perfect, The Highlight, Even Better), card stacks (explainer cards for complex topics), video explainers (Vox on YouTube integration), podcast integration (Today Explained, The Weeds, Unexplainable, Future Perfect), push notification alerts for major stories, saved articles, newsletter integration, dark mode, and ad-supported with Vox Media advertising model.
...
- Confirm legal/privacy retention behavior for Vox-style sensitive records and update API contracts before downstream implementation.
