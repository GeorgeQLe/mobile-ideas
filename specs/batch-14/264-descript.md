...
Build an original mobile video editing product inspired by Descript's public product and policy materials. V1 focuses on script-based media editing, transcription, overdub/avatar-style AI blockers, project collaboration, export/share, and subscription gates. The clone must use original branding, original UI copy, original sample media, licensed providers/assets, and explicit disclosures when a feature is inferred from public materials rather than verified hands-on behavior.
...
- Do not imply affiliation with Descript or its publisher.
...
|---|---|---|---|
| Official product | https://www.descript.com/ | Public Descript product positioning, workflow, feature surfaces, and account/subscription framing | Verified 2026-05-03 |
| Help/support | https://help.descript.com/ | Public support taxonomy for app usage, subscriptions, exports/playback, troubleshooting, and native behavior to verify | Verified 2026-05-03 |
| Privacy policy | https://www.descript.com/privacy | Media, account, device, analytics, provider, retention, rights, and user-rights handling | Verified 2026-05-03 |
| Terms/legal | https://www.descript.com/terms | User content, subscriptions, media/catalog tools, acceptable use, and legal boundaries | Verified 2026-05-03 |
