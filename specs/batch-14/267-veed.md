...
Build an original mobile video editing product inspired by VEED's public product and policy materials. V1 focuses on browser/mobile-oriented video editing, captions, templates, AI tools, brand kits, exports, collaboration, and subscription gates. The clone must use original branding, original UI copy, original sample media, licensed providers/assets, and explicit disclosures when a feature is inferred from public materials rather than verified hands-on behavior.
...
- Do not imply affiliation with VEED or its publisher.
...
|---|---|---|---|
| Official product | https://www.veed.io/ | Public VEED product positioning, workflow, feature surfaces, and account/subscription framing | Verified 2026-05-03 |
| Help/support | https://help.veed.io/ | Public support taxonomy for app usage, subscriptions, exports/playback, troubleshooting, and native behavior to verify | Verified 2026-05-03 |
| Privacy policy | https://www.veed.io/privacy-policy | Media, account, device, analytics, provider, retention, rights, and user-rights handling | Verified 2026-05-03 |
| Terms/legal | https://www.veed.io/terms-of-service | User content, subscriptions, media/catalog tools, acceptable use, and legal boundaries | Verified 2026-05-03 |
