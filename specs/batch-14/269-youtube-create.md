...
Build an original mobile video editing product inspired by YouTube Create's public product and policy materials. V1 focuses on mobile video editing for creators, Shorts/social exports, captions/audio/effects, YouTube account integration, and platform-policy gates. The clone must use original branding, original UI copy, original sample media, licensed providers/assets, and explicit disclosures when a feature is inferred from public materials rather than verified hands-on behavior.
...
- Do not imply affiliation with YouTube Create or its publisher.
...
|---|---|---|---|
| Official product | https://www.youtube.com/create/ | Public YouTube Create product positioning, workflow, feature surfaces, and account/subscription framing | Verified 2026-05-03 |
| Help/support | https://support.google.com/youtube/topic/15011245 | Public support taxonomy for app usage, subscriptions, exports/playback, troubleshooting, and native behavior to verify | Verified 2026-05-03 |
| Privacy policy | https://policies.google.com/privacy | Media, account, device, analytics, provider, retention, rights, and user-rights handling | Verified 2026-05-03 |
| Terms/legal | https://www.youtube.com/t/terms | User content, subscriptions, media/catalog tools, acceptable use, and legal boundaries | Verified 2026-05-03 |
