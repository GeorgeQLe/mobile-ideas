...
Build an original mobile video editing product inspired by OpusClip's public product and policy materials. V1 focuses on AI long-to-short video clipping, social captions, transcript-driven edits, scoring/ranking blockers, export/share, and subscription gates. The clone must use original branding, original UI copy, original sample media, licensed providers/assets, and explicit disclosures when a feature is inferred from public materials rather than verified hands-on behavior.
...
- Do not imply affiliation with OpusClip or its publisher.
...
|---|---|---|---|
| Official product | https://www.opus.pro/ | Public OpusClip product positioning, workflow, feature surfaces, and account/subscription framing | Verified 2026-05-03 |
| Help/support | https://help.opus.pro/ | Public support taxonomy for app usage, subscriptions, exports/playback, troubleshooting, and native behavior to verify | Verified 2026-05-03 |
| Privacy policy | https://www.opus.pro/privacy-policy | Media, account, device, analytics, provider, retention, rights, and user-rights handling | Verified 2026-05-03 |
| Terms/legal | https://www.opus.pro/terms-of-service | User content, subscriptions, media/catalog tools, acceptable use, and legal boundaries | Verified 2026-05-03 |
