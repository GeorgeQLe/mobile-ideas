...
Build an original mobile video editing product inspired by Adobe Premiere Rush's public product and policy materials. V1 focuses on mobile capture/editing, multitrack timeline, titles, color/audio tools, export/share, Adobe account gates, and discontinuation blockers. The clone must use original branding, original UI copy, original sample media, licensed providers/assets, and explicit disclosures when a feature is inferred from public materials rather than verified hands-on behavior.
...
- Support media import, recording, timeline editing, captions/transcripts, effect application, asset selection, preview, export, and share workflows with clear retry/recovery behavior.
...
- Document provider, asset, AI, media, subscription, copyright, captioning/transcription, music, child-safety, and marketplace risks before any implementation claim.

## Non-Goals

- Do not imply affiliation with Adobe Premiere Rush or its publisher.
...
|---|---|---|---|
| Official product | https://helpx.adobe.com/premiere-rush/premiere-rush-mobile-faq.html | Public Adobe Premiere Rush product positioning, workflow, feature surfaces, and account/subscription framing | Verified 2026-05-03 |
| Help/support | https://helpx.adobe.com/premiere-rush.html | Public support taxonomy for app usage, subscriptions, exports/playback, troubleshooting, and native behavior to verify | Verified 2026-05-03 |
| Privacy policy | https://www.adobe.com/privacy/policy.html | Media, account, device, analytics, provider, retention, rights, and user-rights handling | Verified 2026-05-03 |
| Terms/legal | https://www.adobe.com/legal/terms.html | User content, subscriptions, media/catalog tools, acceptable use, and legal boundaries | Verified 2026-05-03 |
...
- The create flow must support camera/photo-library/file import, crop/resize, timeline setup, clip trim/split/reorder, undo/redo, save draft, export, share, and delete controls.
- Editing must support non-destructive or explicitly confirmed destructive actions, playback preview, export format choices, watermark/metadata handling, and recoverable local/cloud drafts.
- Tool surfaces must model captions, transcripts, effects, text, stickers, templates, music/audio, AI/provider jobs where relevant, and locked/quota states.
...
- Analytics must avoid raw prompts, generated answers, uploaded media, face geometry, photos/videos, audio, transcripts, payment credentials, exact contacts, and child data.
...
- Uploaded person/product/media rights, AI commercial-use disclosures, captions/transcripts, music/audio licenses, batch media retention, subscription quotas, and export metadata require explicit controls.
- Manual verification required: native purchase/restore, exact permission prompts, background export/render, push notifications, store privacy labels, platform-specific share sheets, and creator-platform integrations.
...
- User imports or records content only after the relevant permission prompt and sees processing, failure, and removal states.
- User trims, splits, reorders, captions, styles, or renders clips and can undo, redo, duplicate, rename, or delete work.
- User applies a premium model, tool, preset, template, music asset, effect, or quota-limited feature and sees a clear entitlement state.
...
| Caption / Transcript | Captions, subtitles, script edits | record, transcribe, edit text | pending, generated, edited | language unsupported, consent missing |
