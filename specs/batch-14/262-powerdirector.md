...
Build an original mobile video editing product inspired by PowerDirector's public product and policy materials. V1 focuses on mobile video timeline editing, AI tools, effects, stock/template assets, captions, cloud/project handling, export/share, and subscription gates. The clone must use original branding, original UI copy, original sample media, licensed providers/assets, and explicit disclosures when a feature is inferred from public materials rather than verified hands-on behavior.
...
- Do not imply affiliation with PowerDirector or its publisher.
...
|---|---|---|---|
| Official product | https://www.cyberlink.com/products/powerdirector-video-editing-software-365/mobile_en_US.html | Public PowerDirector product positioning, workflow, feature surfaces, and account/subscription framing | Verified 2026-05-03 |
| Help/support | https://help.cyberlink.com/ | Public support taxonomy for app usage, subscriptions, exports/playback, troubleshooting, and native behavior to verify | Verified 2026-05-03 |
| Privacy policy | https://privacy.cyberlink.com/ | Media, account, device, analytics, provider, retention, rights, and user-rights handling | Verified 2026-05-03 |
| Terms/legal | https://www.cyberlink.com/stat/company/enu/tos.jsp | User content, subscriptions, media/catalog tools, acceptable use, and legal boundaries | Verified 2026-05-03 |
