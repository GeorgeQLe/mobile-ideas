...
Build an original mobile music/audio product inspired by Shazam's public product and policy materials. V1 focuses on music recognition, listening history, library saves, Apple Music handoff, notification/widgets, privacy controls, and platform gates. The clone must use original branding, original UI copy, original sample media, licensed providers/assets, and explicit disclosures when a feature is inferred from public materials rather than verified hands-on behavior.
...
- Do not imply affiliation with Shazam or its publisher.
...
|---|---|---|---|
| Official product | https://www.shazam.com/ | Public Shazam product positioning, workflow, feature surfaces, and account/subscription framing | Verified 2026-05-03 |
| Help/support | https://support.apple.com/shazam | Public support taxonomy for app usage, subscriptions, exports/playback, troubleshooting, and native behavior to verify | Verified 2026-05-03 |
| Privacy policy | https://www.apple.com/legal/privacy/ | Media, account, device, analytics, provider, retention, rights, and user-rights handling | Verified 2026-05-03 |
| Terms/legal | https://www.apple.com/legal/internet-services/itunes/ | User content, subscriptions, media/catalog tools, acceptable use, and legal boundaries | Verified 2026-05-03 |
