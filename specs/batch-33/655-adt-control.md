...
> - Manual verification blockers: professional installation, central monitoring, panel/user-code management, emergency dispatch, camera history, dealer variations, and contract/plan eligibility.
...
Build an original mobile product inspired by ADT Control's public smart-home security and device-control workflow. The V1 clone focuses on professionally monitored security dashboards, arm/disarm, zones, sensors, cameras, automation devices, alerts, user codes, scenes, and dealer/installation dependencies.
...
- Preserve the functional job behind ADT Control while using original product naming, original UI, original sample data, and licensed integrations.
...
- Do not copy ADT Control branding, logos, screenshots, marketing copy, private APIs, proprietary datasets, plan names, UI trade dress, or protected media.
...
|---|---|---|---|
| Apple App Store | https://apps.apple.com/us/app/adt-control/id1423764122 | iOS listing, privacy labels, release notes, and app support links | Verified public URL on 2026-05-05; hands-on native behavior still blocked. |
| Google Play | https://play.google.com/store/apps/details?id=com.adt.control | Android listing, data safety, install requirements, and release cadence | Verified public URL on 2026-05-05; hands-on native behavior still blocked. |
| Official product site | https://www.adt.com/adt-control | ADT Control app scope, monitored security, camera, automation, and service positioning | Verified public URL on 2026-05-05; hands-on native behavior still blocked. |
| Official support | https://help.adt.com/ | Account, app, sensors, panels, cameras, monitoring, automation, and troubleshooting docs | Verified public URL on 2026-05-05; hands-on native behavior still blocked. |
| Privacy policy | https://www.adt.com/about-adt/legal/privacy-policy | Security, account, location, device, video, marketing, and retention disclosures | Verified public URL on 2026-05-05; hands-on native behavior still blocked. |
| Terms | https://www.adt.com/about-adt/legal/terms-of-use | ADT service, account, content, monitoring, and legal-use terms | Verified public URL on 2026-05-05; hands-on native behavior still blocked. |
...
- Manual blockers must remain launch-blocking until verified: professional installation, central monitoring, panel/user-code management, emergency dispatch, camera history, dealer variations, and contract/plan eligibility.

## Core User Journeys

- User creates a home, pairs supported ADT Control-style devices, names rooms, grants only required permissions, and sees devices on the dashboard.
...
- Monetization model: use original free/trial/paid entitlement logic; do not copy exact pricing, plan names, bundle names, promotional copy, or partner offers from ADT Control.
...
- Manual verification tests for professional installation, central monitoring, panel/user-code management, emergency dispatch, camera history, dealer variations, and contract/plan eligibility.
...
- Phase 4: Add app-specific safety controls for professionally monitored security dashboards, arm/disarm, zones, sensors, cameras, automation devices, alerts, user codes, scenes, and dealer/installation dependencies.
...
- Confirm legal/privacy retention behavior for ADT Control-style sensitive records and update API contracts before downstream implementation.
