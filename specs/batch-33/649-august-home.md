...
> - Manual verification blockers: real lock/unlock safety, Bluetooth proximity, Auto-Unlock geofencing, door-sense calibration, bridge connectivity, guest access revocation, and emergency lockout recovery.
...
Build an original mobile product inspired by August Home's public smart-home security and device-control workflow. The V1 clone focuses on smart-lock setup, door status, lock/unlock controls, Auto-Unlock/Auto-Lock, guest keys, activity feed, keypad/bridge hardware, and security/account recovery.
...
- Preserve the functional job behind August Home while using original product naming, original UI, original sample data, and licensed integrations.
...
- Do not copy August Home branding, logos, screenshots, marketing copy, private APIs, proprietary datasets, plan names, UI trade dress, or protected media.
...
|---|---|---|---|
| Apple App Store | https://apps.apple.com/us/app/august-home/id648730592 | iOS listing, privacy labels, release notes, and app support links | Verified public URL on 2026-05-05; hands-on native behavior still blocked. |
| Google Play | https://play.google.com/store/apps/details?id=com.august.luna | Android listing, data safety, install requirements, and release cadence | Verified public URL on 2026-05-05; hands-on native behavior still blocked. |
| Official product site | https://august.com/ | Smart-lock products, account model, access sharing, compatibility, and security positioning | Verified public URL on 2026-05-05; hands-on native behavior still blocked. |
| Official support | https://support.august.com/ | Installation, lock calibration, guest access, Auto-Unlock, bridge, and troubleshooting docs | Verified public URL on 2026-05-05; hands-on native behavior still blocked. |
| Privacy policy | https://august.com/pages/privacy-policy | Location, lock activity, account, household sharing, analytics, and retention disclosures | Verified public URL on 2026-05-05; hands-on native behavior still blocked. |
| Terms | https://august.com/pages/terms-of-service | Service, account, access-sharing, hardware, support, and acceptable-use boundaries | Verified public URL on 2026-05-05; hands-on native behavior still blocked. |
...
- Manual blockers must remain launch-blocking until verified: real lock/unlock safety, Bluetooth proximity, Auto-Unlock geofencing, door-sense calibration, bridge connectivity, guest access revocation, and emergency lockout recovery.

## Core User Journeys

- User creates a home, pairs supported August Home-style devices, names rooms, grants only required permissions, and sees devices on the dashboard.
...
- Monetization model: use original free/trial/paid entitlement logic; do not copy exact pricing, plan names, bundle names, promotional copy, or partner offers from August Home.
...
- Manual verification tests for real lock/unlock safety, Bluetooth proximity, Auto-Unlock geofencing, door-sense calibration, bridge connectivity, guest access revocation, and emergency lockout recovery.
...
- Phase 4: Add app-specific safety controls for smart-lock setup, door status, lock/unlock controls, Auto-Unlock/Auto-Lock, guest keys, activity feed, keypad/bridge hardware, and security/account recovery.
...
- Confirm legal/privacy retention behavior for August Home-style sensitive records and update API contracts before downstream implementation.
