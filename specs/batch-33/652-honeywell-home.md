...
> - Manual verification blockers: HVAC safety, geofence behavior, Resideo account states, legacy device compatibility, water-leak/safety alerts, and camera/security hardware behavior.
...
Build an original mobile product inspired by Honeywell Home's public smart-home security and device-control workflow. The V1 clone focuses on thermostat, camera, water-leak, security, and connected-home control with locations, schedules, geofence modes, alerts, device sharing, and Resideo account boundaries.
...
- Preserve the functional job behind Honeywell Home while using original product naming, original UI, original sample data, and licensed integrations.
...
- Do not copy Honeywell Home branding, logos, screenshots, marketing copy, private APIs, proprietary datasets, plan names, UI trade dress, or protected media.
...
|---|---|---|---|
| Apple App Store | https://apps.apple.com/us/app/honeywell-home/id565912139 | iOS listing, privacy labels, release notes, and app support links | Verified public URL on 2026-05-05; hands-on native behavior still blocked. |
| Google Play | https://play.google.com/store/apps/details?id=com.honeywell.android.lyric | Android listing, data safety, install requirements, and release cadence | Verified public URL on 2026-05-05; hands-on native behavior still blocked. |
| Official product site | https://www.honeywellhome.com/ | Honeywell Home/Resideo products, device families, app scope, and compatibility | Verified public URL on 2026-05-05; hands-on native behavior still blocked. |
| Official support | https://support.honeywellhome.com/ | Setup, thermostat schedules, geofence, alerts, account, and troubleshooting docs | Verified public URL on 2026-05-05; hands-on native behavior still blocked. |
| Privacy policy | https://www.resideo.com/us/en/corporate/legal/privacy/ | Resideo account, home/device, location, analytics, marketing, and retention disclosures | Verified public URL on 2026-05-05; hands-on native behavior still blocked. |
| Terms | https://www.resideo.com/us/en/corporate/legal/terms-and-conditions/ | Service, product, account, warranty, subscriptions, and support boundaries | Verified public URL on 2026-05-05; hands-on native behavior still blocked. |
...
- Manual blockers must remain launch-blocking until verified: HVAC safety, geofence behavior, Resideo account states, legacy device compatibility, water-leak/safety alerts, and camera/security hardware behavior.

## Core User Journeys

- User creates a home, pairs supported Honeywell Home-style devices, names rooms, grants only required permissions, and sees devices on the dashboard.
...
- Monetization model: use original free/trial/paid entitlement logic; do not copy exact pricing, plan names, bundle names, promotional copy, or partner offers from Honeywell Home.
...
- Manual verification tests for HVAC safety, geofence behavior, Resideo account states, legacy device compatibility, water-leak/safety alerts, and camera/security hardware behavior.
...
- Phase 4: Add app-specific safety controls for thermostat, camera, water-leak, security, and connected-home control with locations, schedules, geofence modes, alerts, device sharing, and Resideo account boundaries.
...
- Confirm legal/privacy retention behavior for Honeywell Home-style sensitive records and update API contracts before downstream implementation.
