...
> - Manual verification blockers: HVAC safety, equipment compatibility, occupancy sensors, energy-report calculations, home monitoring, voice integrations, and real thermostat command timing.
...
Build an original mobile product inspired by Ecobee's public smart-home security and device-control workflow. The V1 clone focuses on thermostat dashboards, comfort settings, schedules, occupancy sensors, energy reports, home monitoring, camera/doorbell adjuncts, and subscription/service gates.
...
- Preserve the functional job behind Ecobee while using original product naming, original UI, original sample data, and licensed integrations.
...
- Do not copy Ecobee branding, logos, screenshots, marketing copy, private APIs, proprietary datasets, plan names, UI trade dress, or protected media.
...
|---|---|---|---|
| Apple App Store | https://apps.apple.com/us/app/ecobee/id916985674 | iOS listing, privacy labels, release notes, and app support links | Verified public URL on 2026-05-05; hands-on native behavior still blocked. |
| Google Play | https://play.google.com/store/apps/details?id=com.ecobee.athenamobile | Android listing, data safety, compatibility, and release cadence | Verified public URL on 2026-05-05; hands-on native behavior still blocked. |
| Official product site | https://www.ecobee.com/ | Thermostat, sensor, camera, monitoring, and energy-management product positioning | Verified public URL on 2026-05-05; hands-on native behavior still blocked. |
| Official support | https://support.ecobee.com/s/ | Setup, HVAC configuration, schedules, sensors, alerts, and troubleshooting docs | Verified public URL on 2026-05-05; hands-on native behavior still blocked. |
| Privacy policy | https://www.ecobee.com/en-us/privacy-policy/ | Home, occupancy, energy, device, account, analytics, and sharing disclosures | Verified public URL on 2026-05-05; hands-on native behavior still blocked. |
| Terms | https://www.ecobee.com/en-us/terms-of-use/ | Service terms, account, product, monitoring, subscriptions, and acceptable-use boundaries | Verified public URL on 2026-05-05; hands-on native behavior still blocked. |
...
- Manual blockers must remain launch-blocking until verified: HVAC safety, equipment compatibility, occupancy sensors, energy-report calculations, home monitoring, voice integrations, and real thermostat command timing.

## Core User Journeys

- User creates a home, pairs supported Ecobee-style devices, names rooms, grants only required permissions, and sees devices on the dashboard.
...
- Monetization model: use original free/trial/paid entitlement logic; do not copy exact pricing, plan names, bundle names, promotional copy, or partner offers from Ecobee.
...
- Manual verification tests for HVAC safety, equipment compatibility, occupancy sensors, energy-report calculations, home monitoring, voice integrations, and real thermostat command timing.
...
- Phase 4: Add app-specific safety controls for thermostat dashboards, comfort settings, schedules, occupancy sensors, energy reports, home monitoring, camera/doorbell adjuncts, and subscription/service gates.
...
- Confirm legal/privacy retention behavior for Ecobee-style sensitive records and update API contracts before downstream implementation.
