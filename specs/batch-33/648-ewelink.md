...
> - Manual verification blockers: LAN control behavior, third-party device compatibility, Sonoff firmware, premium feature gates, Matter/Alexa/Google integrations, and camera/audio payloads.
...
Build an original mobile product inspired by eWeLink's public smart-home security and device-control workflow. The V1 clone focuses on eWeLink homes, Sonoff-style device pairing, scenes, LAN control hints, timers, inching modes, energy monitoring, sharing, camera/doorbell alerts, and premium gates.
...
- Preserve the functional job behind eWeLink while using original product naming, original UI, original sample data, and licensed integrations.
...
- Do not copy eWeLink branding, logos, screenshots, marketing copy, private APIs, proprietary datasets, plan names, UI trade dress, or protected media.
...
|---|---|---|---|
| Apple App Store | https://apps.apple.com/us/app/ewelink-smart-home/id1035163158 | iOS listing, privacy labels, release notes, and app support links | Verified public URL on 2026-05-05; hands-on native behavior still blocked. |
| Google Play | https://play.google.com/store/apps/details?id=com.coolkit | Android listing, data safety, compatibility, and release cadence | Verified public URL on 2026-05-05; hands-on native behavior still blocked. |
| Official product site | https://ewelink.cc/ | eWeLink app, supported device ecosystem, premium features, and smart-home control model | Verified public URL on 2026-05-05; hands-on native behavior still blocked. |
| Official help | https://help.ewelink.cc/hc/en-us | Setup, sharing, scenes, timers, subscriptions, account, and troubleshooting docs | Verified public URL on 2026-05-05; hands-on native behavior still blocked. |
| Privacy policy | https://ewelink.cc/privacy-policy/ | Account, device, location, automation, analytics, sharing, and retention disclosures | Verified public URL on 2026-05-05; hands-on native behavior still blocked. |
| Terms | https://ewelink.cc/terms-of-use/ | Service terms, account, subscriptions, supported devices, and acceptable-use boundaries | Verified public URL on 2026-05-05; hands-on native behavior still blocked. |
...
- Manual blockers must remain launch-blocking until verified: LAN control behavior, third-party device compatibility, Sonoff firmware, premium feature gates, Matter/Alexa/Google integrations, and camera/audio payloads.

## Core User Journeys

- User creates a home, pairs supported eWeLink-style devices, names rooms, grants only required permissions, and sees devices on the dashboard.
...
- Monetization model: use original free/trial/paid entitlement logic; do not copy exact pricing, plan names, bundle names, promotional copy, or partner offers from eWeLink.
...
- Manual verification tests for LAN control behavior, third-party device compatibility, Sonoff firmware, premium feature gates, Matter/Alexa/Google integrations, and camera/audio payloads.
...
- Phase 4: Add app-specific safety controls for eWeLink homes, Sonoff-style device pairing, scenes, LAN control hints, timers, inching modes, energy monitoring, sharing, camera/doorbell alerts, and premium gates.
...
- Confirm legal/privacy retention behavior for eWeLink-style sensitive records and update API contracts before downstream implementation.
