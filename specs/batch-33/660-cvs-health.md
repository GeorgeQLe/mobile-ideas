...
> - Manual verification blockers: pharmacy account linking, prescription refill authority, HIPAA/PHI handling, MinuteClinic availability, insurance/Caremark/Aetna eligibility, pickup barcode behavior, payment, and store inventory accuracy.
...
Build an original mobile product inspired by CVS Health's public health, pharmacy, patient, or clinician workflow. The V1 clone focuses on CVS Health app pharmacy refills, prescription history, pickup barcode, ExtraCare offers, store shopping, MinuteClinic scheduling, vaccines, benefits cards, telehealth links, photos, and consumer-health privacy controls.
...
- Preserve the functional job behind CVS Health while using original product naming, original UI, original sample data, and licensed integrations.
...
- Do not copy CVS Health branding, logos, screenshots, marketing copy, private APIs, proprietary datasets, plan names, UI trade dress, or protected media.
...
|---|---|---|---|
| Apple App Store | https://apps.apple.com/us/app/cvs-health/id395545555 | iOS listing, privacy labels, release notes, category, and app feature claims | Verified public URL on 2026-05-05; hands-on native behavior still blocked. |
| Google Play | https://play.google.com/store/apps/details?id=com.cvs.launchers.cvs | Android listing, data safety, install requirements, and release cadence | Verified public URL on 2026-05-05; hands-on native behavior still blocked. |
| Official product site | https://www.cvs.com/mobile-cvs/apps | CVS app feature overview, pharmacy, deals, shopping, health services, and account surface | Verified public URL on 2026-05-05; hands-on native behavior still blocked. |
| Official help | https://www.cvs.com/help/help_index.jsp | Account, pharmacy, ExtraCare, orders, MinuteClinic, benefits, and troubleshooting help | Verified public URL on 2026-05-05; hands-on native behavior still blocked. |
| Privacy policy | https://www.cvs.com/retail/help/privacy_policy | CVS app, pharmacy, shopping, ExtraCare, health service, advertising, and consumer-health disclosures | Verified public URL on 2026-05-05; hands-on native behavior still blocked. |
| Terms | https://www.cvs.com/retail/help/terms_of_use | CVS app/site terms, health content, pharmacy, account, orders, and service boundaries | Verified public URL on 2026-05-05; hands-on native behavior still blocked. |
...
- Manual blockers must remain launch-blocking until verified: pharmacy account linking, prescription refill authority, HIPAA/PHI handling, MinuteClinic availability, insurance/Caremark/Aetna eligibility, pickup barcode behavior, payment, and store inventory accuracy.

## Core User Journeys

- User creates or restores a CVS Health-style account, completes consent and eligibility checks, and reaches a privacy-forward dashboard.
...
- Monetization model: use original free/trial/paid entitlement logic; do not copy exact pricing, plan names, bundle names, promotional copy, or partner offers from CVS Health.
...
- Manual verification tests for pharmacy account linking, prescription refill authority, HIPAA/PHI handling, MinuteClinic availability, insurance/Caremark/Aetna eligibility, pickup barcode behavior, payment, and store inventory accuracy.
...
- Phase 4: Add app-specific safety controls for CVS Health app pharmacy refills, prescription history, pickup barcode, ExtraCare offers, store shopping, MinuteClinic scheduling, vaccines, benefits cards, telehealth links, photos, and consumer-health privacy controls.
...
- Confirm legal/privacy retention behavior for CVS Health-style sensitive records and update API contracts before downstream implementation.
