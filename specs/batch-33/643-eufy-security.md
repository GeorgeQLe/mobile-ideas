...
> - Manual verification blockers: local encryption/storage claims, HomeBase firmware, AI/person/package detection, video history, activity zones, battery hardware, and third-party voice assistant behavior.
...
Build an original mobile product inspired by Eufy Security's public smart-home security and device-control workflow. The V1 clone focuses on security-camera home views, HomeBase/camera onboarding, local-storage versus cloud-storage choices, AI detection modes, activity zones, live view, alarm modes, and family sharing.
...
- Preserve the functional job behind Eufy Security while using original product naming, original UI, original sample data, and licensed integrations.
...
- Do not copy Eufy Security branding, logos, screenshots, marketing copy, private APIs, proprietary datasets, plan names, UI trade dress, or protected media.
...
|---|---|---|---|
| Apple App Store | https://apps.apple.com/us/app/eufy-security/id1424956516 | iOS listing, privacy labels, release notes, and app support links | Verified public URL on 2026-05-05; hands-on native behavior still blocked. |
| Google Play | https://play.google.com/store/apps/details?id=com.oceanwing.battery.cam | Android listing, data safety, ratings, and release cadence | Verified public URL on 2026-05-05; hands-on native behavior still blocked. |
| Official product site | https://www.eufy.com/security | Device families, HomeBase, storage model, subscription positioning, and compatibility | Verified public URL on 2026-05-05; hands-on native behavior still blocked. |
| Official support | https://support.eufy.com/ | Setup, troubleshooting, account, storage, notification, firmware, and security camera documentation | Verified public URL on 2026-05-05; hands-on native behavior still blocked. |
| Privacy policy | https://www.eufy.com/policies/privacy-policy | Video, audio, account, device, analytics, sharing, and retention disclosures | Verified public URL on 2026-05-05; hands-on native behavior still blocked. |
| Terms | https://www.eufy.com/policies/terms-of-service | Service, account, purchase, warranty, content, and acceptable-use boundaries | Verified public URL on 2026-05-05; hands-on native behavior still blocked. |
...
- Manual blockers must remain launch-blocking until verified: local encryption/storage claims, HomeBase firmware, AI/person/package detection, video history, activity zones, battery hardware, and third-party voice assistant behavior.

## Core User Journeys

- User creates a home, pairs supported Eufy Security-style devices, names rooms, grants only required permissions, and sees devices on the dashboard.
...
- Monetization model: use original free/trial/paid entitlement logic; do not copy exact pricing, plan names, bundle names, promotional copy, or partner offers from Eufy Security.
...
- Manual verification tests for local encryption/storage claims, HomeBase firmware, AI/person/package detection, video history, activity zones, battery hardware, and third-party voice assistant behavior.
...
- Phase 4: Add app-specific safety controls for security-camera home views, HomeBase/camera onboarding, local-storage versus cloud-storage choices, AI detection modes, activity zones, live view, alarm modes, and family sharing.
...
- Confirm legal/privacy retention behavior for Eufy Security-style sensitive records and update API contracts before downstream implementation.
