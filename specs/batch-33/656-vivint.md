# Vivint-Style Clone Spec

> Metadata
> - Inspiration app: Vivint
> - Category: Smart home
...
> - Manual verification blockers: professional monitoring, panel state, emergency dispatch, camera clips, smart-lock control, installation-specific hardware, and account/contract eligibility.
...
Build an original mobile product inspired by Vivint's public smart-home security and device-control workflow. The V1 clone focuses on integrated security and smart-home dashboards, cameras, door locks, thermostat/garage controls, scenes, alerts, professional monitoring, and panel/mobile synchronization.
...
- Preserve the functional job behind Vivint while using original product naming, original UI, original sample data, and licensed integrations.
...
- Do not copy Vivint branding, logos, screenshots, marketing copy, private APIs, proprietary datasets, plan names, UI trade dress, or protected media.
...
|---|---|---|---|
| Apple App Store | https://apps.apple.com/us/app/vivint/id1473006399 | iOS listing, privacy labels, release notes, and app support links | Verified public URL on 2026-05-05; hands-on native behavior still blocked. |
| Google Play | https://play.google.com/store/apps/details?id=com.vivint.vivintsky | Android listing, data safety, install requirements, and release cadence | Verified public URL on 2026-05-05; hands-on native behavior still blocked. |
| Official product site | https://www.vivint.com/ | Security/smart-home product families, professional monitoring, service model, and compatibility | Verified public URL on 2026-05-05; hands-on native behavior still blocked. |
| Official support | https://support.vivint.com/ | App, panel, cameras, locks, monitoring, account, and troubleshooting docs | Verified public URL on 2026-05-05; hands-on native behavior still blocked. |
| Privacy policy | https://www.vivint.com/company/policies/privacy-policy | Security, video/audio, device, account, location, analytics, and retention disclosures | Verified public URL on 2026-05-05; hands-on native behavior still blocked. |
| Terms | https://www.vivint.com/company/policies/terms-of-use | Service terms, accounts, monitoring, equipment, subscriptions, and acceptable-use boundaries | Verified public URL on 2026-05-05; hands-on native behavior still blocked. |
...
- Manual blockers must remain launch-blocking until verified: professional monitoring, panel state, emergency dispatch, camera clips, smart-lock control, installation-specific hardware, and account/contract eligibility.

## Core User Journeys

- User creates a home, pairs supported Vivint-style devices, names rooms, grants only required permissions, and sees devices on the dashboard.
...
- Monetization model: use original free/trial/paid entitlement logic; do not copy exact pricing, plan names, bundle names, promotional copy, or partner offers from Vivint.
...
- Manual verification tests for professional monitoring, panel state, emergency dispatch, camera clips, smart-lock control, installation-specific hardware, and account/contract eligibility.
...
- Phase 4: Add app-specific safety controls for integrated security and smart-home dashboards, cameras, door locks, thermostat/garage controls, scenes, alerts, professional monitoring, and panel/mobile synchronization.
...
- Confirm legal/privacy retention behavior for Vivint-style sensitive records and update API contracts before downstream implementation.
