...
> - Manual verification blockers: legacy versus current Kasa hardware, local network discovery, camera recording, away-mode randomization, smart-switch electrical safety, and TP-Link account migration.
...
Build an original mobile product inspired by Kasa Smart's public smart-home security and device-control workflow. The V1 clone focuses on Kasa plug, switch, bulb, strip, camera, and router-adjacent controls with rooms, schedules, scenes, away mode, camera events, firmware, and shared homes.
...
- Preserve the functional job behind Kasa Smart while using original product naming, original UI, original sample data, and licensed integrations.
...
- Do not copy Kasa Smart branding, logos, screenshots, marketing copy, private APIs, proprietary datasets, plan names, UI trade dress, or protected media.
...
|---|---|---|---|
| Apple App Store | https://apps.apple.com/us/app/kasa-smart/id1034035493 | iOS listing, privacy labels, release notes, and app support links | Verified public URL on 2026-05-05; hands-on native behavior still blocked. |
| Google Play | https://play.google.com/store/apps/details?id=com.tplink.kasa_android | Android listing, data safety, install requirements, and release cadence | Verified public URL on 2026-05-05; hands-on native behavior still blocked. |
| Official product site | https://www.kasasmart.com/ | Kasa product families, smart-home control model, subscription positioning, and compatibility | Verified public URL on 2026-05-05; hands-on native behavior still blocked. |
| Official support | https://www.kasasmart.com/us/support | Setup, troubleshooting, camera, firmware, account, and notification support | Verified public URL on 2026-05-05; hands-on native behavior still blocked. |
| Privacy policy | https://www.tp-link.com/us/privacy/ | TP-Link account, device, network, camera, location, analytics, and retention disclosures | Verified public URL on 2026-05-05; hands-on native behavior still blocked. |
| Terms | https://www.tp-link.com/us/terms/ | TP-Link service, account, product, warranty, and content terms | Verified public URL on 2026-05-05; hands-on native behavior still blocked. |
...
- Manual blockers must remain launch-blocking until verified: legacy versus current Kasa hardware, local network discovery, camera recording, away-mode randomization, smart-switch electrical safety, and TP-Link account migration.

## Core User Journeys

- User creates a home, pairs supported Kasa Smart-style devices, names rooms, grants only required permissions, and sees devices on the dashboard.
...
- Monetization model: use original free/trial/paid entitlement logic; do not copy exact pricing, plan names, bundle names, promotional copy, or partner offers from Kasa Smart.
...
- Manual verification tests for legacy versus current Kasa hardware, local network discovery, camera recording, away-mode randomization, smart-switch electrical safety, and TP-Link account migration.
...
- Phase 4: Add app-specific safety controls for Kasa plug, switch, bulb, strip, camera, and router-adjacent controls with rooms, schedules, scenes, away mode, camera events, firmware, and shared homes.
...
- Confirm legal/privacy retention behavior for Kasa Smart-style sensitive records and update API contracts before downstream implementation.
