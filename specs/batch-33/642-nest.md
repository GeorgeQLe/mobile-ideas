# Nest-Style Clone Spec

> Metadata
> - Inspiration app: Nest
> - Category: Smart home
...
> - Manual verification blockers: Google Home versus Nest app split, account migration, Nest Aware subscriptions, household sharing, live camera streams, thermostat HVAC safety, smoke/CO alarm behavior, and region/device availability.
...
Build an original mobile product inspired by Nest's public smart-home security and device-control workflow. The V1 clone focuses on Google Nest home dashboards, cameras, thermostats, doorbells, smoke alarms, home/away routines, household members, event history, Nest Aware gates, and Google-account migration boundaries.
...
- Preserve the functional job behind Nest while using original product naming, original UI, original sample data, and licensed integrations.
...
- Do not copy Nest branding, logos, screenshots, marketing copy, private APIs, proprietary datasets, plan names, UI trade dress, or protected media.
...
|---|---|---|---|
| Apple App Store | https://apps.apple.com/us/app/nest/id464988855 | iOS listing, privacy labels, release notes, and support links for the Nest app | Verified public URL on 2026-05-05; hands-on native behavior still blocked. |
| Google Play | https://play.google.com/store/apps/details?id=com.nest.android | Android listing, data safety, install requirements, and update cadence | Verified public URL on 2026-05-05; hands-on native behavior still blocked. |
| Official product site | https://store.google.com/category/nest | Nest device families, subscriptions, compatibility, and product positioning | Verified public URL on 2026-05-05; hands-on native behavior still blocked. |
| Official help | https://support.google.com/googlenest/ | Device setup, home membership, alerts, subscriptions, account migration, and troubleshooting | Verified public URL on 2026-05-05; hands-on native behavior still blocked. |
| Privacy policy | https://policies.google.com/privacy | Google account, device, location, activity, voice/video, advertising, and retention disclosures | Verified public URL on 2026-05-05; hands-on native behavior still blocked. |
| Terms | https://policies.google.com/terms | Google service terms, content, account, suspension, and service-change boundaries | Verified public URL on 2026-05-05; hands-on native behavior still blocked. |
...
- Manual blockers must remain launch-blocking until verified: Google Home versus Nest app split, account migration, Nest Aware subscriptions, household sharing, live camera streams, thermostat HVAC safety, smoke/CO alarm behavior, and region/device availability.

## Core User Journeys

- User creates a home, pairs supported Nest-style devices, names rooms, grants only required permissions, and sees devices on the dashboard.
...
- Monetization model: use original free/trial/paid entitlement logic; do not copy exact pricing, plan names, bundle names, promotional copy, or partner offers from Nest.
...
- Manual verification tests for Google Home versus Nest app split, account migration, Nest Aware subscriptions, household sharing, live camera streams, thermostat HVAC safety, smoke/CO alarm behavior, and region/device availability.
...
- Phase 4: Add app-specific safety controls for Google Nest home dashboards, cameras, thermostats, doorbells, smoke alarms, home/away routines, household members, event history, Nest Aware gates, and Google-account migration boundaries.
...
- Confirm legal/privacy retention behavior for Nest-style sensitive records and update API contracts before downstream implementation.
