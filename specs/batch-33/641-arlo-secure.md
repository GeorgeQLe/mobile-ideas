# Arlo Secure-Style Clone Spec

> Metadata
> - Inspiration app: Arlo Secure
> - Category: Smart home
...
> - Manual verification blockers: paid Arlo Secure plan states, live camera latency, emergency-response availability, HomeKit/Alexa/Google integrations, device firmware pairing, and camera/audio push payload behavior.
...
Build an original mobile product inspired by Arlo Secure's public smart-home security and device-control workflow. The V1 clone focuses on multi-location security dashboards, camera/doorbell/floodlight pairing, arm/disarm modes, activity zones, animated alerts, sirens, emergency-response gates, subscription video history, and shared household access.
...
- Preserve the functional job behind Arlo Secure while using original product naming, original UI, original sample data, and licensed integrations.
...
- Do not copy Arlo Secure branding, logos, screenshots, marketing copy, private APIs, proprietary datasets, plan names, UI trade dress, or protected media.
...
|---|---|---|---|
| Apple App Store | https://apps.apple.com/us/app/arlo-secure-home-security/id1459289784 | iOS listing, privacy labels, release notes, in-app purchase surface, support/developer links | Verified public URL on 2026-05-05; hands-on native behavior still blocked. |
| Google Play | https://play.google.com/store/apps/details?id=com.arlo.app | Android listing, install requirements, data safety, reviews, and release cadence | Verified public URL on 2026-05-05; hands-on native behavior still blocked. |
| Official product site | https://www.arlo.com/en-us/ | Product families, account model, camera/security terminology, subscription positioning, and regional availability | Verified public URL on 2026-05-05; hands-on native behavior still blocked. |
| Official support | https://www.arlo.com/en-us/support/ | Device setup, troubleshooting, subscription, account, notification, and camera-behavior help articles | Verified public URL on 2026-05-05; hands-on native behavior still blocked. |
| Privacy policy | https://www.arlo.com/en-us/about/privacy-policy/ | Camera, audio, location, account, analytics, sharing, and retention disclosures | Verified public URL on 2026-05-05; hands-on native behavior still blocked. |
| Terms | https://www.arlo.com/en-us/terms-and-conditions.html | Service terms, subscriptions, acceptable use, emergency limits, and warranty/support boundaries | Verified public URL on 2026-05-05; hands-on native behavior still blocked. |
...
- Manual blockers must remain launch-blocking until verified: paid Arlo Secure plan states, live camera latency, emergency-response availability, HomeKit/Alexa/Google integrations, device firmware pairing, and camera/audio push payload behavior.

## Core User Journeys

- User creates a home, pairs supported Arlo Secure-style devices, names rooms, grants only required permissions, and sees devices on the dashboard.
...
- Monetization model: use original free/trial/paid entitlement logic; do not copy exact pricing, plan names, bundle names, promotional copy, or partner offers from Arlo Secure.
...
- Manual verification tests for paid Arlo Secure plan states, live camera latency, emergency-response availability, HomeKit/Alexa/Google integrations, device firmware pairing, and camera/audio push payload behavior.
...
- Phase 4: Add app-specific safety controls for multi-location security dashboards, camera/doorbell/floodlight pairing, arm/disarm modes, activity zones, animated alerts, sirens, emergency-response gates, subscription video history, and shared household access.
...
- Confirm legal/privacy retention behavior for Arlo Secure-style sensitive records and update API contracts before downstream implementation.
