...
> - Manual verification blockers: real door/gate movement safety, obstruction sensors, delivery partner access, subscription video features, notification timing, and region/operator hardware compatibility.
...
Build an original mobile product inspired by myQ's public smart-home security and device-control workflow. The V1 clone focuses on garage-door and gate control, device onboarding, real-time door status, activity history, schedules, guest/household access, delivery integrations, and safety notifications.
...
- Preserve the functional job behind myQ while using original product naming, original UI, original sample data, and licensed integrations.
...
- Do not copy myQ branding, logos, screenshots, marketing copy, private APIs, proprietary datasets, plan names, UI trade dress, or protected media.
...
|---|---|---|---|
| Apple App Store | https://apps.apple.com/us/app/myq-garage-access-control/id456282559 | iOS listing, privacy labels, release notes, and app support links | Verified public URL on 2026-05-05; hands-on native behavior still blocked. |
| Google Play | https://play.google.com/store/apps/details?id=com.chamberlain.android.liftmaster.myq | Android listing, data safety, install requirements, and release cadence | Verified public URL on 2026-05-05; hands-on native behavior still blocked. |
| Official product site | https://www.myq.com/ | Garage/gate products, smart access features, subscriptions, partners, and compatibility | Verified public URL on 2026-05-05; hands-on native behavior still blocked. |
| Official support | https://support.chamberlaingroup.com/s/myq | Setup, troubleshooting, access sharing, notifications, subscriptions, and device support | Verified public URL on 2026-05-05; hands-on native behavior still blocked. |
| Privacy policy | https://www.myq.com/privacy-policy | Access activity, device, location, account, partner, analytics, and retention disclosures | Verified public URL on 2026-05-05; hands-on native behavior still blocked. |
| Terms | https://www.myq.com/terms-of-use | Service terms, smart access, subscriptions, accounts, and acceptable-use boundaries | Verified public URL on 2026-05-05; hands-on native behavior still blocked. |
...
- Manual blockers must remain launch-blocking until verified: real door/gate movement safety, obstruction sensors, delivery partner access, subscription video features, notification timing, and region/operator hardware compatibility.

## Core User Journeys

- User creates a home, pairs supported myQ-style devices, names rooms, grants only required permissions, and sees devices on the dashboard.
...
- Monetization model: use original free/trial/paid entitlement logic; do not copy exact pricing, plan names, bundle names, promotional copy, or partner offers from myQ.
...
- Manual verification tests for real door/gate movement safety, obstruction sensors, delivery partner access, subscription video features, notification timing, and region/operator hardware compatibility.
...
- Phase 4: Add app-specific safety controls for garage-door and gate control, device onboarding, real-time door status, activity history, schedules, guest/household access, delivery integrations, and safety notifications.
...
- Confirm legal/privacy retention behavior for myQ-style sensitive records and update API contracts before downstream implementation.
