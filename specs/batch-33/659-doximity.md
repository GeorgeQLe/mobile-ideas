...
> - Manual verification blockers: medical-professional identity verification, Dialer caller-ID behavior, telehealth/video compliance, fax/document handling, clinical privacy, CME eligibility, and healthcare advertising boundaries.
...
Build an original mobile product inspired by Doximity's public health, pharmacy, patient, or clinician workflow. The V1 clone focuses on clinician identity verification, professional profile, network/search, secure communication, news/feed, Dialer/video tools, fax/clinical document workflow, CME, and recruiter/industry boundaries.
...
- Preserve the functional job behind Doximity while using original product naming, original UI, original sample data, and licensed integrations.
...
- Do not copy Doximity branding, logos, screenshots, marketing copy, private APIs, proprietary datasets, plan names, UI trade dress, or protected media.
...
|---|---|---|---|
| Apple App Store | https://apps.apple.com/us/app/doximity/id472929854 | iOS listing, privacy labels, release notes, and app support links | Verified public URL on 2026-05-05; hands-on native behavior still blocked. |
| Google Play | https://play.google.com/store/apps/details?id=com.doximity.doximitydroid | Android listing, data safety, install requirements, and release cadence | Verified public URL on 2026-05-05; hands-on native behavior still blocked. |
| Official product site | https://www.doximity.com/ | Professional network, communication, Dialer, profile, news, and career/product positioning | Verified public URL on 2026-05-05; hands-on native behavior still blocked. |
| Official support | https://support.doximity.com/ | Account verification, Dialer, profile, fax, CME, messaging, and troubleshooting docs | Verified public URL on 2026-05-05; hands-on native behavior still blocked. |
| Privacy policy | https://www.doximity.com/about/privacy | Professional profile, health-care communication, analytics, advertising, and retention disclosures | Verified public URL on 2026-05-05; hands-on native behavior still blocked. |
| Terms | https://www.doximity.com/about/terms | Service, account, professional conduct, content, privacy, and acceptable-use boundaries | Verified public URL on 2026-05-05; hands-on native behavior still blocked. |
...
- Manual blockers must remain launch-blocking until verified: medical-professional identity verification, Dialer caller-ID behavior, telehealth/video compliance, fax/document handling, clinical privacy, CME eligibility, and healthcare advertising boundaries.

## Core User Journeys

- User creates or restores a Doximity-style account, completes consent and eligibility checks, and reaches a privacy-forward dashboard.
...
- Monetization model: use original free/trial/paid entitlement logic; do not copy exact pricing, plan names, bundle names, promotional copy, or partner offers from Doximity.
...
- Manual verification tests for medical-professional identity verification, Dialer caller-ID behavior, telehealth/video compliance, fax/document handling, clinical privacy, CME eligibility, and healthcare advertising boundaries.
...
- Phase 4: Add app-specific safety controls for clinician identity verification, professional profile, network/search, secure communication, news/feed, Dialer/video tools, fax/clinical document workflow, CME, and recruiter/industry boundaries.
...
- Confirm legal/privacy retention behavior for Doximity-style sensitive records and update API contracts before downstream implementation.
