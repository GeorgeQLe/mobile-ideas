...
> - Manual verification blockers: OEM device variance, AI assistant behavior, HealthKit-adjacent scale data, cloud-region behavior, third-party integrations, and unsupported device categories.
...
Build an original mobile product inspired by Tuya Smart's public smart-home security and device-control workflow. The V1 clone focuses on Tuya Smart device ecosystem controls, homes/rooms, one-tap scenes, conditional automations, member sharing, device alerts, AI assistant surfaces, and IoT cloud boundaries.
...
- Preserve the functional job behind Tuya Smart while using original product naming, original UI, original sample data, and licensed integrations.
...
- Do not copy Tuya Smart branding, logos, screenshots, marketing copy, private APIs, proprietary datasets, plan names, UI trade dress, or protected media.
...
|---|---|---|---|
| Apple App Store | https://apps.apple.com/us/app/tuya-smart/id1034649547 | iOS listing, privacy labels, release notes, and public app feature claims | Verified public URL on 2026-05-05; hands-on native behavior still blocked. |
| Google Play | https://play.google.com/store/apps/details?id=com.tuya.smart | Android listing, data safety, install requirements, and release cadence | Verified public URL on 2026-05-05; hands-on native behavior still blocked. |
| Official product site | https://www.tuya.com/ | Tuya ecosystem, IoT cloud, app platform, device categories, and regional service positioning | Verified public URL on 2026-05-05; hands-on native behavior still blocked. |
| Official support | https://support.tuya.com/en/help | Setup, pairing, automation, account, and troubleshooting documentation | Verified public URL on 2026-05-05; hands-on native behavior still blocked. |
| Privacy policy | https://www.tuya.com/privacy-policy | Corporate privacy disclosures for account, device, location, analytics, and cloud service data | Verified public URL on 2026-05-05; hands-on native behavior still blocked. |
| Terms | https://www.tuya.com/terms-of-service | Tuya service terms, platform boundaries, account, content, and acceptable-use terms | Verified public URL on 2026-05-05; hands-on native behavior still blocked. |
...
- Manual blockers must remain launch-blocking until verified: OEM device variance, AI assistant behavior, HealthKit-adjacent scale data, cloud-region behavior, third-party integrations, and unsupported device categories.

## Core User Journeys

- User creates a home, pairs supported Tuya Smart-style devices, names rooms, grants only required permissions, and sees devices on the dashboard.
...
- Monetization model: use original free/trial/paid entitlement logic; do not copy exact pricing, plan names, bundle names, promotional copy, or partner offers from Tuya Smart.
...
- Manual verification tests for OEM device variance, AI assistant behavior, HealthKit-adjacent scale data, cloud-region behavior, third-party integrations, and unsupported device categories.
...
- Phase 4: Add app-specific safety controls for Tuya Smart device ecosystem controls, homes/rooms, one-tap scenes, conditional automations, member sharing, device alerts, AI assistant surfaces, and IoT cloud boundaries.
...
- Confirm legal/privacy retention behavior for Tuya Smart-style sensitive records and update API contracts before downstream implementation.
