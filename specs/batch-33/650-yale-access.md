...
> - Manual verification blockers: real lock operation, access-code sync, bridge/module compatibility, Bluetooth/geofence behavior, guest revocation timing, and region-specific Yale/ASSA ABLOY legal pages.
...
Build an original mobile product inspired by Yale Access's public smart-home security and device-control workflow. The V1 clone focuses on Yale smart-lock onboarding, lock status, app unlock, guest access, access schedules, activity logs, keypad/bridge setup, and account security.
...
- Preserve the functional job behind Yale Access while using original product naming, original UI, original sample data, and licensed integrations.
...
- Do not copy Yale Access branding, logos, screenshots, marketing copy, private APIs, proprietary datasets, plan names, UI trade dress, or protected media.
...
|---|---|---|---|
| Apple App Store | https://apps.apple.com/us/app/yale-access/id1458313373 | iOS listing, privacy labels, release notes, and app support links | Verified public URL on 2026-05-05; hands-on native behavior still blocked. |
| Google Play | https://play.google.com/store/apps/details?id=com.assaabloy.yale | Android listing, data safety, install requirements, and release cadence | Verified public URL on 2026-05-05; hands-on native behavior still blocked. |
| Official product site | https://www.yalehome.com/us/en/yale-access | Yale Access app scope, lock families, modules, bridges, and compatibility | Verified public URL on 2026-05-05; hands-on native behavior still blocked. |
| Official support | https://support.shopyalehome.com/ | Installation, access sharing, lock calibration, guest keys, troubleshooting, and account docs | Verified public URL on 2026-05-05; hands-on native behavior still blocked. |
| Privacy center | https://www.yalehome.com/us/en/privacy-center | Privacy disclosures, data rights, account, device, location, and sharing information | Verified public URL on 2026-05-05; hands-on native behavior still blocked. |
| Terms | https://www.yalehome.com/us/en/terms-and-conditions | Terms, product/service boundaries, account, warranty, and support limitations | Verified public URL on 2026-05-05; hands-on native behavior still blocked. |
...
- Manual blockers must remain launch-blocking until verified: real lock operation, access-code sync, bridge/module compatibility, Bluetooth/geofence behavior, guest revocation timing, and region-specific Yale/ASSA ABLOY legal pages.

## Core User Journeys

- User creates a home, pairs supported Yale Access-style devices, names rooms, grants only required permissions, and sees devices on the dashboard.
...
- Monetization model: use original free/trial/paid entitlement logic; do not copy exact pricing, plan names, bundle names, promotional copy, or partner offers from Yale Access.
...
- Manual verification tests for real lock operation, access-code sync, bridge/module compatibility, Bluetooth/geofence behavior, guest revocation timing, and region-specific Yale/ASSA ABLOY legal pages.
...
- Phase 4: Add app-specific safety controls for Yale smart-lock onboarding, lock status, app unlock, guest access, access schedules, activity logs, keypad/bridge setup, and account security.
...
- Confirm legal/privacy retention behavior for Yale Access-style sensitive records and update API contracts before downstream implementation.
