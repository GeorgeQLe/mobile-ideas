# SimpliSafe-Style Clone Spec

> Metadata
> - Inspiration app: SimpliSafe
> - Category: Smart home
...
> - Manual verification blockers: professional monitoring dispatch, alarm handling, camera recordings, sensor hardware, account verification, subscriptions, and jurisdiction-specific emergency-service behavior.
...
Build an original mobile product inspired by SimpliSafe's public smart-home security and device-control workflow. The V1 clone focuses on security-system arming, sensor/camera status, alarm event handling, monitoring-plan gates, camera history, emergency dispatch boundaries, family access, and device setup.
...
- Preserve the functional job behind SimpliSafe while using original product naming, original UI, original sample data, and licensed integrations.
...
- Do not copy SimpliSafe branding, logos, screenshots, marketing copy, private APIs, proprietary datasets, plan names, UI trade dress, or protected media.
...
|---|---|---|---|
| Apple App Store | https://apps.apple.com/us/app/simplisafe-home-security-app/id555798051 | iOS listing, privacy labels, release notes, and in-app purchase/support links | Verified public URL on 2026-05-05; hands-on native behavior still blocked. |
| Google Play | https://play.google.com/store/apps/details?id=com.simplisafe.mobile | Android listing, data safety, compatibility, and release cadence | Verified public URL on 2026-05-05; hands-on native behavior still blocked. |
| Official product site | https://simplisafe.com/ | Security system products, monitoring plans, cameras, sensors, and service positioning | Verified public URL on 2026-05-05; hands-on native behavior still blocked. |
| Official support | https://support.simplisafe.com/ | Setup, monitoring, cameras, sensors, app, account, and troubleshooting docs | Verified public URL on 2026-05-05; hands-on native behavior still blocked. |
| Privacy policy | https://simplisafe.com/privacy-policy | Security events, camera/audio, account, device, location, monitoring, and retention disclosures | Verified public URL on 2026-05-05; hands-on native behavior still blocked. |
| Terms | https://simplisafe.com/terms-of-sale | Purchase, subscription, monitoring, equipment, warranty, and service boundaries | Verified public URL on 2026-05-05; hands-on native behavior still blocked. |
...
- Manual blockers must remain launch-blocking until verified: professional monitoring dispatch, alarm handling, camera recordings, sensor hardware, account verification, subscriptions, and jurisdiction-specific emergency-service behavior.

## Core User Journeys

- User creates a home, pairs supported SimpliSafe-style devices, names rooms, grants only required permissions, and sees devices on the dashboard.
...
- Monetization model: use original free/trial/paid entitlement logic; do not copy exact pricing, plan names, bundle names, promotional copy, or partner offers from SimpliSafe.
...
- Manual verification tests for professional monitoring dispatch, alarm handling, camera recordings, sensor hardware, account verification, subscriptions, and jurisdiction-specific emergency-service behavior.
...
- Phase 4: Add app-specific safety controls for security-system arming, sensor/camera status, alarm event handling, monitoring-plan gates, camera history, emergency dispatch boundaries, family access, and device setup.
...
- Confirm legal/privacy retention behavior for SimpliSafe-style sensitive records and update API contracts before downstream implementation.
