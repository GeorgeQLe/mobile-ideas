# Duolingo ABC-Style Clone Spec

> Metadata
> - Inspiration app: Duolingo ABC
> - Category: Education
...
> - Manual verification blockers: child privacy, COPPA-style consent, reading assessment accuracy, offline progress sync, no verified first-party Android parity, parent controls, and curriculum availability.
...
Build an original mobile product inspired by Duolingo ABC's public education workflow. The V1 clone focuses on early reading lessons, phonics, tracing, stories, kids progress, offline learning, parent controls, and age-appropriate literacy activities.
...
- Preserve the functional job behind Duolingo ABC while using original product naming, original UI, original sample data, and licensed integrations.
...
- Do not copy Duolingo ABC branding, logos, screenshots, marketing copy, private APIs, proprietary datasets, plan names, UI trade dress, course libraries, textbook solutions, documents, school content, AI prompts, or protected media.
...
|---|---|---|---|
| Apple App Store | https://apps.apple.com/us/app/learn-to-read-duolingo-abc/id1440502568 | iOS listing, privacy labels, age range, reading claims, and support links | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
| Google Play | Platform blocker: no verified first-party Google Play listing for Duolingo ABC | Android parity is blocked until a first-party listing is verified | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
| Official product site | https://abc.duolingo.com/ | Duolingo ABC reading app, phonics, stories, and child-learning positioning | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
| Official help | https://support.duolingo.com/ | Account, app, privacy, support, and troubleshooting | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
| Privacy policy | https://www.duolingo.com/privacy | Child, learner, account, analytics, advertising, and sharing disclosures | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
| Terms | https://www.duolingo.com/terms | Service terms, child use, account, content, and acceptable-use boundaries | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
...
- Manual blockers must remain launch-blocking until verified: child privacy, COPPA-style consent, reading assessment accuracy, offline progress sync, no verified first-party Android parity, parent controls, and curriculum availability.

## Core User Journeys

- User creates or restores a Duolingo ABC-style account, completes role, school, subscription, or tenant checks, and reaches the dashboard.
...
- Monetization model: use original free/trial/paid/sponsored/school/provider/tenant entitlement logic; do not copy exact pricing, plan names, bundle names, promotional copy, school contracts, tenant offers, or partner offers from Duolingo ABC.
...
- Manual verification tests for child privacy, COPPA-style consent, reading assessment accuracy, offline progress sync, no verified first-party Android parity, parent controls, and curriculum availability.
...
- Phase 4: Add app-specific safety controls for early reading lessons, phonics, tracing, stories, kids progress, offline learning, parent controls, and age-appropriate literacy activities.
...
- Confirm legal/privacy retention behavior for Duolingo ABC-style sensitive records and update API contracts before downstream implementation.
