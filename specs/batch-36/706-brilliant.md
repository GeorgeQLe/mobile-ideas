# Brilliant-Style Clone Spec

> Metadata
> - Inspiration app: Brilliant
> - Category: Education
...
> - Manual verification blockers: course content licensing, subscription restore, assessment correctness, progress sync, minors/student-data privacy, community/support paths, and app-store product naming variance.
...
Build an original mobile product inspired by Brilliant's public education workflow. The V1 clone focuses on interactive STEM courses, guided problem solving, streaks, quizzes, visual lessons, subscriptions, offline-ish progress, and learning-path personalization.
...
- Preserve the functional job behind Brilliant while using original product naming, original UI, original sample data, and licensed integrations.
...
- Do not copy Brilliant branding, logos, screenshots, marketing copy, private APIs, proprietary datasets, plan names, UI trade dress, course libraries, textbook solutions, documents, school content, AI prompts, or protected media.
...
|---|---|---|---|
| Apple App Store | https://apps.apple.com/us/app/apple-store/id913335252 | iOS listing, privacy labels, in-app purchases, and interactive learning claims | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
| Google Play | https://play.google.com/store/apps/details?id=org.brilliant.android | Android listing, data safety, feature claims, and release cadence | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
| Official product site | https://brilliant.org/ | Interactive STEM courses, learning paths, subscriptions, and product positioning | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
| Official support | https://support.brilliant.org/ | Account, subscription, courses, progress, and troubleshooting docs | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
| Privacy policy | https://brilliant.org/privacy/ | Learner, account, payment, analytics, advertising, and sharing disclosures | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
| Terms | https://brilliant.org/terms/ | Service, subscriptions, content, account, and acceptable-use boundaries | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
...
- Manual blockers must remain launch-blocking until verified: course content licensing, subscription restore, assessment correctness, progress sync, minors/student-data privacy, community/support paths, and app-store product naming variance.

## Core User Journeys

- User creates or restores a Brilliant-style account, completes role, school, subscription, or tenant checks, and reaches the dashboard.
...
- Monetization model: use original free/trial/paid/sponsored/school/provider/tenant entitlement logic; do not copy exact pricing, plan names, bundle names, promotional copy, school contracts, tenant offers, or partner offers from Brilliant.
...
- Manual verification tests for course content licensing, subscription restore, assessment correctness, progress sync, minors/student-data privacy, community/support paths, and app-store product naming variance.
...
- Phase 4: Add app-specific safety controls for interactive STEM courses, guided problem solving, streaks, quizzes, visual lessons, subscriptions, offline-ish progress, and learning-path personalization.
...
- Confirm legal/privacy retention behavior for Brilliant-style sensitive records and update API contracts before downstream implementation.
