# Memrise-Style Clone Spec

> Metadata
> - Inspiration app: Memrise
> - Category: Education
...
> - Manual verification blockers: course/content licensing, AI conversation accuracy, subscription restore, user-generated legacy content, ad tracking, minors privacy, and offline sync.
...
Build an original mobile product inspired by Memrise's public education workflow. The V1 clone focuses on language learning courses, vocabulary review, videos/native-speaker content, AI conversation practice, streaks, subscriptions, and offline progress.
...
- Preserve the functional job behind Memrise while using original product naming, original UI, original sample data, and licensed integrations.
...
- Do not copy Memrise branding, logos, screenshots, marketing copy, private APIs, proprietary datasets, plan names, UI trade dress, course libraries, textbook solutions, documents, school content, AI prompts, or protected media.
...
|---|---|---|---|
| Apple App Store | https://apps.apple.com/us/app/memrise-learn-languages/id635966718 | iOS listing, privacy labels, subscriptions, language and AI practice claims | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
| Google Play | https://play.google.com/store/apps/details?id=com.memrise.android.memrisecompanion | Android listing, data safety, feature claims, and release cadence | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
| Official product site | https://www.memrise.com/ | Language learning, videos, AI conversation, subscriptions, and product positioning | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
| Official support | https://memrise.zendesk.com/ | Account, subscriptions, courses, app, and troubleshooting | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
| Privacy policy | https://www.memrise.com/privacy | Learner, account, content, payment, analytics, and sharing disclosures | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
| Terms | https://www.memrise.com/terms | Service, subscriptions, course content, account, and acceptable-use terms | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
...
- Manual blockers must remain launch-blocking until verified: course/content licensing, AI conversation accuracy, subscription restore, user-generated legacy content, ad tracking, minors privacy, and offline sync.

## Core User Journeys

- User creates or restores a Memrise-style account, completes role, school, subscription, or tenant checks, and reaches the dashboard.
...
- Monetization model: use original free/trial/paid/sponsored/school/provider/tenant entitlement logic; do not copy exact pricing, plan names, bundle names, promotional copy, school contracts, tenant offers, or partner offers from Memrise.
...
- Manual verification tests for course/content licensing, AI conversation accuracy, subscription restore, user-generated legacy content, ad tracking, minors privacy, and offline sync.
...
- Phase 4: Add app-specific safety controls for language learning courses, vocabulary review, videos/native-speaker content, AI conversation practice, streaks, subscriptions, and offline progress.
...
- Confirm legal/privacy retention behavior for Memrise-style sensitive records and update API contracts before downstream implementation.
