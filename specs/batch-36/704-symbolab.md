# Symbolab-Style Clone Spec

> Metadata
> - Inspiration app: Symbolab
> - Category: Education
...
> - Manual verification blockers: OCR/math parsing accuracy, step-by-step correctness, copyrighted problem content, subscription restore, ad tracking, generated practice, and cheating-policy copy.
...
Build an original mobile product inspired by Symbolab's public education workflow. The V1 clone focuses on AI math solver, camera/text problem entry, step-by-step solutions, calculators, graphs, personalized practice, subscriptions, and academic-integrity disclaimers.
...
- Preserve the functional job behind Symbolab while using original product naming, original UI, original sample data, and licensed integrations.
...
- Do not copy Symbolab branding, logos, screenshots, marketing copy, private APIs, proprietary datasets, plan names, UI trade dress, course libraries, textbook solutions, documents, school content, AI prompts, or protected media.
...
|---|---|---|---|
| Apple App Store | https://apps.apple.com/us/app/symbolab-ai-math-solver/id876942533 | iOS listing, privacy labels, release notes, subscription and solver claims | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
| Google Play | https://play.google.com/store/apps/details?id=com.devsense.symbolab | Android listing, data safety, solver claims, privacy/terms links, and release cadence | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
| Official product site | https://www.symbolab.com/ | Math solver, calculators, graphing, practice, and subscription positioning | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
| Official help | https://www.symbolab.com/contact | Contact, account, product, and support path | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
| Privacy policy | https://www.symbolab.com/public/privacy.pdf | Account, problem input, photos, analytics, advertising, and sharing disclosures | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
| Terms | https://www.symbolab.com/public/terms.pdf | Service terms, content, subscriptions, academic use, and acceptable-use boundaries | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
...
- Manual blockers must remain launch-blocking until verified: OCR/math parsing accuracy, step-by-step correctness, copyrighted problem content, subscription restore, ad tracking, generated practice, and cheating-policy copy.

## Core User Journeys

- User creates or restores a Symbolab-style account, completes role, school, subscription, or tenant checks, and reaches the dashboard.
...
- Monetization model: use original free/trial/paid/sponsored/school/provider/tenant entitlement logic; do not copy exact pricing, plan names, bundle names, promotional copy, school contracts, tenant offers, or partner offers from Symbolab.
...
- Manual verification tests for OCR/math parsing accuracy, step-by-step correctness, copyrighted problem content, subscription restore, ad tracking, generated practice, and cheating-policy copy.
...
- Phase 4: Add app-specific safety controls for AI math solver, camera/text problem entry, step-by-step solutions, calculators, graphs, personalized practice, subscriptions, and academic-integrity disclaimers.
...
- Confirm legal/privacy retention behavior for Symbolab-style sensitive records and update API contracts before downstream implementation.
