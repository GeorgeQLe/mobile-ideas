# Pimsleur-Style Clone Spec

> Metadata
> - Inspiration app: Pimsleur
> - Category: Education
...
> - Manual verification blockers: audio course licensing, speech/voice coach accuracy, offline DRM, subscription restore, driving-mode safety, account migration, and regional course catalog availability.
...
Build an original mobile product inspired by Pimsleur's public education workflow. The V1 clone focuses on audio-first language courses, lessons, review, voice coach/speech practice, driving mode, offline downloads, subscriptions, and Simon & Schuster account/content licensing.
...
- Preserve the functional job behind Pimsleur while using original product naming, original UI, original sample data, and licensed integrations.
...
- Do not copy Pimsleur branding, logos, screenshots, marketing copy, private APIs, proprietary datasets, plan names, UI trade dress, course libraries, textbook solutions, documents, school content, AI prompts, or protected media.
...
|---|---|---|---|
| Apple App Store | https://apps.apple.com/us/app/pimsleur/id1405735469 | iOS listing, privacy labels, subscriptions, audio course claims, and support links | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
| Google Play | https://play.google.com/store/apps/details?id=com.simonandschuster.pimsleur.unified.android | Android listing, data safety, language-course claims, and release cadence | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
| Official product site | https://www.pimsleur.com/ | Language courses, app, subscriptions, audio method, and product positioning | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
| Official support | https://www.pimsleur.com/help | Account, subscriptions, app, downloads, courses, and troubleshooting | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
| Privacy policy | https://www.simonandschuster.com/p/privacy-policy | Account, purchase, audio usage, analytics, advertising, and sharing disclosures | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
| Terms | https://www.simonandschuster.com/p/terms-and-conditions | Service, subscriptions, content licensing, account, and acceptable-use terms | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
...
- Manual blockers must remain launch-blocking until verified: audio course licensing, speech/voice coach accuracy, offline DRM, subscription restore, driving-mode safety, account migration, and regional course catalog availability.

## Core User Journeys

- User creates or restores a Pimsleur-style account, completes role, school, subscription, or tenant checks, and reaches the dashboard.
...
- Monetization model: use original free/trial/paid/sponsored/school/provider/tenant entitlement logic; do not copy exact pricing, plan names, bundle names, promotional copy, school contracts, tenant offers, or partner offers from Pimsleur.
...
- Manual verification tests for audio course licensing, speech/voice coach accuracy, offline DRM, subscription restore, driving-mode safety, account migration, and regional course catalog availability.
...
- Phase 4: Add app-specific safety controls for audio-first language courses, lessons, review, voice coach/speech practice, driving mode, offline downloads, subscriptions, and Simon & Schuster account/content licensing.
...
- Confirm legal/privacy retention behavior for Pimsleur-style sensitive records and update API contracts before downstream implementation.
