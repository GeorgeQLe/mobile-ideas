# Mimo-Style Clone Spec

> Metadata
> - Inspiration app: Mimo
> - Category: Education
...
> - Manual verification blockers: coding exercise correctness, subscription restore, certificate claims, AI/project review, learner progress sync, ad tracking, and child/minor privacy.
...
Build an original mobile product inspired by Mimo's public education workflow. The V1 clone focuses on coding lessons, exercises, career paths, streaks, AI/project practice, certificates, subscriptions, mobile-first progress, and web handoff.
...
- Preserve the functional job behind Mimo while using original product naming, original UI, original sample data, and licensed integrations.
...
- Do not copy Mimo branding, logos, screenshots, marketing copy, private APIs, proprietary datasets, plan names, UI trade dress, course libraries, textbook solutions, documents, school content, AI prompts, or protected media.
...
|---|---|---|---|
| Apple App Store | https://apps.apple.com/us/app/mimo-learn-coding-programming/id1133960732 | iOS listing, privacy labels, release notes, subscriptions, and coding claims | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
| Google Play | https://play.google.com/store/apps/details?id=com.getmimo | Android listing, data safety, coding feature claims, and release cadence | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
| Official product site | https://mimo.org/ | Coding lessons, career paths, AI/project practice, and subscription positioning | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
| Official help | https://help.mimo.org/ | Account, subscriptions, learning, app, and support docs | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
| Privacy policy | https://mimo.org/privacy-policy | Learner, account, payment, analytics, advertising, and sharing disclosures | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
| Terms | https://mimo.org/terms-of-service | Service, subscriptions, course content, account, and acceptable-use terms | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
...
- Manual blockers must remain launch-blocking until verified: coding exercise correctness, subscription restore, certificate claims, AI/project review, learner progress sync, ad tracking, and child/minor privacy.

## Core User Journeys

- User creates or restores a Mimo-style account, completes role, school, subscription, or tenant checks, and reaches the dashboard.
...
- Monetization model: use original free/trial/paid/sponsored/school/provider/tenant entitlement logic; do not copy exact pricing, plan names, bundle names, promotional copy, school contracts, tenant offers, or partner offers from Mimo.
...
- Manual verification tests for coding exercise correctness, subscription restore, certificate claims, AI/project review, learner progress sync, ad tracking, and child/minor privacy.
...
- Phase 4: Add app-specific safety controls for coding lessons, exercises, career paths, streaks, AI/project practice, certificates, subscriptions, mobile-first progress, and web handoff.
...
- Confirm legal/privacy retention behavior for Mimo-style sensitive records and update API contracts before downstream implementation.
