# Microsoft 365-Style Clone Spec

> Metadata
> - Inspiration app: Microsoft 365
...
> - Manual verification blockers: Microsoft account and tenant policy, OneDrive sync conflicts, enterprise data loss prevention, Copilot eligibility, subscription restore, file-format fidelity, coauthoring, permissions, and regional compliance.
...
Build an original mobile product inspired by Microsoft 365's public productivity documents workflow. The V1 clone focuses on Office documents, Copilot/AI surfaces, OneDrive files, scan/create/edit, templates, PDF actions, search, sharing, sync/offline conflict handling, import/export, permissions, and Microsoft 365 subscriptions.
...
- Preserve the functional job behind Microsoft 365 while using original product naming, original UI, original sample data, and licensed integrations.
...
- Do not copy Microsoft 365 branding, logos, screenshots, marketing copy, private APIs, proprietary datasets, plan names, UI trade dress, course libraries, textbook solutions, documents, school content, AI prompts, or protected media.
...
|---|---|---|---|
| Apple App Store | https://apps.apple.com/us/app/microsoft-365-copilot/id541164041 | iOS listing, privacy labels, Copilot/Office claims, subscriptions, and support links | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
| Google Play | https://play.google.com/store/apps/details?id=com.microsoft.office.officehubrow | Android listing, data safety, Microsoft 365 feature claims, and release cadence | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
| Official product site | https://www.microsoft.com/microsoft-365 | Microsoft 365, Office apps, Copilot, OneDrive, subscriptions, and productivity positioning | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
| Official support | https://support.microsoft.com/microsoft-365 | Account, Office mobile, OneDrive, sharing, subscriptions, Copilot, and troubleshooting | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
...
- Manual blockers must remain launch-blocking until verified: Microsoft account and tenant policy, OneDrive sync conflicts, enterprise data loss prevention, Copilot eligibility, subscription restore, file-format fidelity, coauthoring, permissions, and regional compliance.

## Core User Journeys

- User creates or restores a Microsoft 365-style account, completes role, school, subscription, or tenant checks, and reaches the dashboard.
...
- Monetization model: use original free/trial/paid/sponsored/school/provider/tenant entitlement logic; do not copy exact pricing, plan names, bundle names, promotional copy, school contracts, tenant offers, or partner offers from Microsoft 365.
...
- Manual verification tests for Microsoft account and tenant policy, OneDrive sync conflicts, enterprise data loss prevention, Copilot eligibility, subscription restore, file-format fidelity, coauthoring, permissions, and regional compliance.
...
- Phase 4: Add app-specific safety controls for Office documents, Copilot/AI surfaces, OneDrive files, scan/create/edit, templates, PDF actions, search, sharing, sync/offline conflict handling, import/export, permissions, and Microsoft 365 subscriptions.
...
- Confirm legal/privacy retention behavior for Microsoft 365-style sensitive records and update API contracts before downstream implementation.
