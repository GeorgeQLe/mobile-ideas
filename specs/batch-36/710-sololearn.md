# Sololearn-Style Clone Spec

> Metadata
> - Inspiration app: Sololearn
> - Category: Education
...
> - Manual verification blockers: coding exercise correctness, community moderation, subscription restore, ad tracking, learner-generated code/content, profile privacy, and web/app parity.
...
Build an original mobile product inspired by Sololearn's public education workflow. The V1 clone focuses on mobile coding courses, practice challenges, community-driven learning, career tracks, streaks, subscriptions, code playground, and learner profile progress.
...
- Preserve the functional job behind Sololearn while using original product naming, original UI, original sample data, and licensed integrations.
...
- Do not copy Sololearn branding, logos, screenshots, marketing copy, private APIs, proprietary datasets, plan names, UI trade dress, course libraries, textbook solutions, documents, school content, AI prompts, or protected media.
...
|---|---|---|---|
| Apple App Store | https://apps.apple.com/us/app/sololearn-learn-to-code/id1210079064 | iOS listing, privacy labels, subscription/legal links, and coding-course claims | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
| Google Play | https://play.google.com/store/apps/details?id=com.sololearn | Android listing, data safety, feature claims, and release cadence | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
| Official product site | https://www.sololearn.com/ | Coding courses, practice, community, and subscription positioning | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
| Official support | https://www.sololearn.com/en/contact | Contact, support, account, subscription, and product paths | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
| Privacy policy | https://www.sololearn.com/en/privacy-policy/ | Learner, account, advertising, analytics, community, and sharing disclosures | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
| Terms | https://www.sololearn.com/en/terms-of-use | Service, subscriptions, content, code/community, and acceptable-use terms | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
...
- Manual blockers must remain launch-blocking until verified: coding exercise correctness, community moderation, subscription restore, ad tracking, learner-generated code/content, profile privacy, and web/app parity.

## Core User Journeys

- User creates or restores a Sololearn-style account, completes role, school, subscription, or tenant checks, and reaches the dashboard.
...
- Monetization model: use original free/trial/paid/sponsored/school/provider/tenant entitlement logic; do not copy exact pricing, plan names, bundle names, promotional copy, school contracts, tenant offers, or partner offers from Sololearn.
...
- Manual verification tests for coding exercise correctness, community moderation, subscription restore, ad tracking, learner-generated code/content, profile privacy, and web/app parity.
...
- Phase 4: Add app-specific safety controls for mobile coding courses, practice challenges, community-driven learning, career tracks, streaks, subscriptions, code playground, and learner profile progress.
...
- Confirm legal/privacy retention behavior for Sololearn-style sensitive records and update API contracts before downstream implementation.
