# Brainly-Style Clone Spec

> Metadata
> - Inspiration app: Brainly
> - Category: Education
...
> - Manual verification blockers: AI/expert answer accuracy, copyrighted textbook content, academic cheating policy, community moderation, ad tracking, subscriptions, age gating, and answer provenance.
...
Build an original mobile product inspired by Brainly's public education workflow. The V1 clone focuses on homework Q&A, AI tutor, answer search, community answers, expert help, image/question capture, explanations, subscriptions, and academic-integrity controls.
...
- Preserve the functional job behind Brainly while using original product naming, original UI, original sample data, and licensed integrations.
...
- Do not copy Brainly branding, logos, screenshots, marketing copy, private APIs, proprietary datasets, plan names, UI trade dress, course libraries, textbook solutions, documents, school content, AI prompts, or protected media.
...
|---|---|---|---|
| Apple App Store | https://apps.apple.com/us/app/brainly-your-personal-tutor/id745089947 | iOS listing, privacy labels, release notes, subscription/support/legal links | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
| Google Play | https://play.google.com/store/apps/details?id=co.brainly | Android listing, data safety, feature claims, and release cadence | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
| Official product site | https://brainly.com/ | Homework help, AI tutor, community answers, and product positioning | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
| Official support | https://brainly.com/contact | Contact, support, account, product, and safety pathways | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
| Privacy policy | https://brainly.com/pages/privacy_policy | Student, account, advertising, analytics, content, and sharing disclosures | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
| Terms | https://brainly.com/pages/terms_of_use | Service, community, academic conduct, content, subscriptions, and acceptable-use terms | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
...
- Manual blockers must remain launch-blocking until verified: AI/expert answer accuracy, copyrighted textbook content, academic cheating policy, community moderation, ad tracking, subscriptions, age gating, and answer provenance.

## Core User Journeys

- User creates or restores a Brainly-style account, completes role, school, subscription, or tenant checks, and reaches the dashboard.
...
- Monetization model: use original free/trial/paid/sponsored/school/provider/tenant entitlement logic; do not copy exact pricing, plan names, bundle names, promotional copy, school contracts, tenant offers, or partner offers from Brainly.
...
- Manual verification tests for AI/expert answer accuracy, copyrighted textbook content, academic cheating policy, community moderation, ad tracking, subscriptions, age gating, and answer provenance.
...
- Phase 4: Add app-specific safety controls for homework Q&A, AI tutor, answer search, community answers, expert help, image/question capture, explanations, subscriptions, and academic-integrity controls.
...
- Confirm legal/privacy retention behavior for Brainly-style sensitive records and update API contracts before downstream implementation.
