# Seesaw-Style Clone Spec

> Metadata
> - Inspiration app: Seesaw
> - Category: Education
...
> - Manual verification blockers: school roster import, teacher/student/family roles, COPPA/FERPA/GDPR claims, AI message assistant, assessment reporting, family messaging, push payloads, and district subscription availability.
...
Build an original mobile product inspired by Seesaw's public education workflow. The V1 clone focuses on elementary classroom portfolios, teacher assignments, multimodal student posts, formative assessments, family messaging, translation, progress reports, and school/family roles.
...
- Preserve the functional job behind Seesaw while using original product naming, original UI, original sample data, and licensed integrations.
...
- Do not copy Seesaw branding, logos, screenshots, marketing copy, private APIs, proprietary datasets, plan names, UI trade dress, course libraries, textbook solutions, documents, school content, AI prompts, or protected media.
...
|---|---|---|---|
| Apple App Store | https://apps.apple.com/us/app/seesaw/id930565184 | iOS listing, privacy labels, release notes, family messaging, and classroom feature claims | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
| Google Play | https://play.google.com/store/apps/details?id=seesaw.shadowpuppet.co.classroom | Android listing, data safety, classroom feature claims, and release cadence | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
| Official product site | https://seesaw.com/ | Classroom portfolio, instruction, assessment, messaging, and family engagement positioning | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
| Official help | https://help.seesaw.me/ | Teacher, student, family, activities, messages, assessment, and account docs | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
| Privacy policy | https://seesaw.com/privacy-policy/ | Student, teacher, family, school, content, analytics, and sharing disclosures | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
| Terms | https://seesaw.com/terms-of-service/ | Service, school, family, content, subscriptions, and acceptable-use boundaries | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
...
- Manual blockers must remain launch-blocking until verified: school roster import, teacher/student/family roles, COPPA/FERPA/GDPR claims, AI message assistant, assessment reporting, family messaging, push payloads, and district subscription availability.

## Core User Journeys

- User creates or restores a Seesaw-style account, completes role, school, subscription, or tenant checks, and reaches the dashboard.
...
- Monetization model: use original free/trial/paid/sponsored/school/provider/tenant entitlement logic; do not copy exact pricing, plan names, bundle names, promotional copy, school contracts, tenant offers, or partner offers from Seesaw.
...
- Manual verification tests for school roster import, teacher/student/family roles, COPPA/FERPA/GDPR claims, AI message assistant, assessment reporting, family messaging, push payloads, and district subscription availability.
...
- Phase 4: Add app-specific safety controls for elementary classroom portfolios, teacher assignments, multimodal student posts, formative assessments, family messaging, translation, progress reports, and school/family roles.
...
- Confirm legal/privacy retention behavior for Seesaw-style sensitive records and update API contracts before downstream implementation.
