# Udemy-Style Clone Spec

> Metadata
> - Inspiration app: Udemy
> - Category: Education
...
> - Manual verification blockers: course licensing, instructor marketplace content, offline DRM, certificate issuance, business account entitlements, refunds, AI role-play accuracy, and regional pricing/tax behavior.
...
Build an original mobile product inspired by Udemy's public education workflow. The V1 clone focuses on course marketplace, video lessons, offline downloads, AI skills guidance, career accelerators, quizzes, certificates, business account gates, subscriptions, and instructor content.
...
- Preserve the functional job behind Udemy while using original product naming, original UI, original sample data, and licensed integrations.
...
- Do not copy Udemy branding, logos, screenshots, marketing copy, private APIs, proprietary datasets, plan names, UI trade dress, course libraries, textbook solutions, documents, school content, AI prompts, or protected media.
...
|---|---|---|---|
| Apple App Store | https://apps.apple.com/us/app/udemy/id562413829 | iOS listing, privacy labels, in-app purchases, AI/course feature claims, and support links | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
| Google Play | https://play.google.com/store/apps/details?id=com.udemy.android | Android listing, data safety, course claims, and release cadence | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
| Official product site | https://www.udemy.com/ | Course marketplace, subscriptions, personal plan, career accelerators, and instructor positioning | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
| Official support | https://support.udemy.com/ | Learner, instructor, payments, refunds, business, and technical support | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
| Privacy policy | https://www.udemy.com/terms/privacy/ | Learner, instructor, search, purchase, analytics, advertising, and sharing disclosures | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
| Terms | https://www.udemy.com/terms/ | Marketplace terms, content, subscriptions, refunds, instructor/learner obligations, and acceptable use | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
...
- Manual blockers must remain launch-blocking until verified: course licensing, instructor marketplace content, offline DRM, certificate issuance, business account entitlements, refunds, AI role-play accuracy, and regional pricing/tax behavior.

## Core User Journeys

- User creates or restores a Udemy-style account, completes role, school, subscription, or tenant checks, and reaches the dashboard.
...
- Monetization model: use original free/trial/paid/sponsored/school/provider/tenant entitlement logic; do not copy exact pricing, plan names, bundle names, promotional copy, school contracts, tenant offers, or partner offers from Udemy.
...
- Manual verification tests for course licensing, instructor marketplace content, offline DRM, certificate issuance, business account entitlements, refunds, AI role-play accuracy, and regional pricing/tax behavior.
...
- Phase 4: Add app-specific safety controls for course marketplace, video lessons, offline downloads, AI skills guidance, career accelerators, quizzes, certificates, business account gates, subscriptions, and instructor content.
...
- Confirm legal/privacy retention behavior for Udemy-style sensitive records and update API contracts before downstream implementation.
