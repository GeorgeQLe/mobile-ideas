# Codecademy Go-Style Clone Spec

> Metadata
> - Inspiration app: Codecademy Go
> - Category: Education
...
> - Manual verification blockers: web/mobile feature parity, subscription entitlements, code practice correctness, OAuth, push reminders, course catalog availability, and Skillsoft/Codecademy account state.
...
Build an original mobile product inspired by Codecademy Go's public education workflow. The V1 clone focuses on mobile coding practice, flashcards, course enrollment, streaks, personalized recommendations, push reminders, in-app plan upgrades, and desktop-course handoff.
...
- Preserve the functional job behind Codecademy Go while using original product naming, original UI, original sample data, and licensed integrations.
...
- Do not copy Codecademy Go branding, logos, screenshots, marketing copy, private APIs, proprietary datasets, plan names, UI trade dress, course libraries, textbook solutions, documents, school content, AI prompts, or protected media.
...
|---|---|---|---|
| Apple App Store | https://apps.apple.com/us/app/codecademy-go/id1376029326 | iOS listing, privacy labels, release notes, subscriptions, and coding-practice claims | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
| Google Play | https://play.google.com/store/apps/details?id=com.ryzac.codecademygo | Android listing, data safety, course/practice claims, and release cadence | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
| Official product site | https://www.codecademy.com/mobile-app | Mobile app, practice, courses, subscriptions, and learning positioning | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
| Official help | https://help.codecademy.com/ | Account, billing, learning, app, and technical support | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
| Privacy policy | https://www.codecademy.com/policy | Learner, account, usage, payment, analytics, and sharing disclosures | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
| Terms | https://www.codecademy.com/terms | Service, subscriptions, content, account, and acceptable-use boundaries | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
...
- Manual blockers must remain launch-blocking until verified: web/mobile feature parity, subscription entitlements, code practice correctness, OAuth, push reminders, course catalog availability, and Skillsoft/Codecademy account state.

## Core User Journeys

- User creates or restores a Codecademy Go-style account, completes role, school, subscription, or tenant checks, and reaches the dashboard.
...
- Monetization model: use original free/trial/paid/sponsored/school/provider/tenant entitlement logic; do not copy exact pricing, plan names, bundle names, promotional copy, school contracts, tenant offers, or partner offers from Codecademy Go.
...
- Manual verification tests for web/mobile feature parity, subscription entitlements, code practice correctness, OAuth, push reminders, course catalog availability, and Skillsoft/Codecademy account state.
...
- Phase 4: Add app-specific safety controls for mobile coding practice, flashcards, course enrollment, streaks, personalized recommendations, push reminders, in-app plan upgrades, and desktop-course handoff.
...
- Confirm legal/privacy retention behavior for Codecademy Go-style sensitive records and update API contracts before downstream implementation.
