# LingQ-Style Clone Spec

> Metadata
> - Inspiration app: LingQ
> - Category: Education
...
> - Manual verification blockers: copyright/imported content, AI feature correctness, subscription restore, content library rights, audio/text sync, user-generated imports, and export/delete behavior.
...
Build an original mobile product inspired by LingQ's public education workflow. The V1 clone focuses on input-based language learning, reading/listening lessons, imported content, vocabulary LingQs, AI tools, playlists, subscriptions, and multi-language progress.
...
- Preserve the functional job behind LingQ while using original product naming, original UI, original sample data, and licensed integrations.
...
- Do not copy LingQ branding, logos, screenshots, marketing copy, private APIs, proprietary datasets, plan names, UI trade dress, course libraries, textbook solutions, documents, school content, AI prompts, or protected media.
...
|---|---|---|---|
| Apple App Store | https://apps.apple.com/us/app/lingq-learn-42-languages/id379385811 | iOS listing, privacy labels, subscriptions, AI/content claims, and support links | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
| Google Play | https://play.google.com/store/apps/details?id=com.linguist | Android listing, data safety, language-learning claims, and release cadence | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
| Official product site | https://www.lingq.com/ | Input-based language learning, imports, vocabulary, AI, and subscription positioning | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
| Official support | https://support.lingq.com/ | Account, subscriptions, lessons, import, vocabulary, and troubleshooting | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
| Privacy policy | https://www.lingq.com/en/privacy/ | Learner, account, content, imports, payment, analytics, and sharing disclosures | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
| Terms | https://www.lingq.com/en/terms/ | Service, subscriptions, imported content, account, and acceptable-use terms | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
...
- Manual blockers must remain launch-blocking until verified: copyright/imported content, AI feature correctness, subscription restore, content library rights, audio/text sync, user-generated imports, and export/delete behavior.

## Core User Journeys

- User creates or restores a LingQ-style account, completes role, school, subscription, or tenant checks, and reaches the dashboard.
...
- Monetization model: use original free/trial/paid/sponsored/school/provider/tenant entitlement logic; do not copy exact pricing, plan names, bundle names, promotional copy, school contracts, tenant offers, or partner offers from LingQ.
...
- Manual verification tests for copyright/imported content, AI feature correctness, subscription restore, content library rights, audio/text sync, user-generated imports, and export/delete behavior.
...
- Phase 4: Add app-specific safety controls for input-based language learning, reading/listening lessons, imported content, vocabulary LingQs, AI tools, playlists, subscriptions, and multi-language progress.
...
- Confirm legal/privacy retention behavior for LingQ-style sensitive records and update API contracts before downstream implementation.
