# Lingokids-Style Clone Spec

> Metadata
> - Inspiration app: Lingokids
> - Category: Education
...
> - Manual verification blockers: child profile privacy, COPPA/GDPR-K-style controls, Disney/Blippi/NASA/Oxford content licensing, subscription restore, offline content, ad-free claims, and parent community moderation.
...
Build an original mobile product inspired by Lingokids's public education workflow. The V1 clone focuses on kids playlearning activities, videos, games, parent progress reports, child profiles, offline access, subscriptions, branded licensed content, and kidSAFE/ad-free positioning.
...
- Preserve the functional job behind Lingokids while using original product naming, original UI, original sample data, and licensed integrations.
...
- Do not copy Lingokids branding, logos, screenshots, marketing copy, private APIs, proprietary datasets, plan names, UI trade dress, course libraries, textbook solutions, documents, school content, AI prompts, or protected media.
...
|---|---|---|---|
| Apple App Store | https://apps.apple.com/us/app/lingokids-play-and-learn/id1002043426 | iOS listing, privacy labels, subscription/legal links, kids content, and licensed-character claims | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
| Google Play | https://play.google.com/store/apps/details?id=es.monkimun.lingokids | Android listing, data safety, subscriptions, legal links, and kids learning claims | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
| Official product site | https://lingokids.com/ | Playlearning, kids content, parent progress, subscriptions, and product positioning | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
| Official help | https://help.lingokids.com/ | Account, subscriptions, child profiles, content, and troubleshooting | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
| Privacy policy | https://lingokids.com/privacy | Child, parent, subscription, analytics, advertising, and sharing disclosures | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
| Terms | https://www.lingokids.com/tos | Service, subscriptions, child content, licensed content, and acceptable-use terms | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
...
- Manual blockers must remain launch-blocking until verified: child profile privacy, COPPA/GDPR-K-style controls, Disney/Blippi/NASA/Oxford content licensing, subscription restore, offline content, ad-free claims, and parent community moderation.

## Core User Journeys

- User creates or restores a Lingokids-style account, completes role, school, subscription, or tenant checks, and reaches the dashboard.
...
|---|---|---|---|---|
| Welcome/Auth | Learner, parent, teacher, school, or subscription entry | email, SSO, invite, course, role | new, returning, role-bound, locked | SSO failed, underage blocked, region unavailable |
| Home/Learning | Courses, lessons, activities, documents, or workspace summary | tap, search, filter, resume | empty, loading, current, stale | offline, entitlement locked, content unavailable |
| Activity/Content | Lesson, assignment, solver, Q&A, course video, coding task, or document action | text, media, scan, answer, submit | draft, active, submitted, completed | wrong answer, upload failed, policy blocked |
| Progress/Records | Grades, streaks, certificates, portfolios, history, or file versions | filter, export, share, open | empty, loaded, delayed, exported | school-owned data, stale sync, certificate pending |
| Messages/Sharing | Teacher/family/community messages, comments, collaboration, or file sharing | compose, invite, comment, permission | unread, sent, shared, revoked | privacy leak, abuse, revocation delay |
| Settings/Privacy | Account, subscription, permissions, support, legal links, export, deletion | forms, restore, links, request | loaded, editing, requested | school/tenant-owned data, active subscription, legal hold |
...
- Treat student data, learner progress, child/minor privacy, school/institution ownership, teacher/family roles, academic integrity, copyrighted course/content libraries, user-generated answers, messages, subscriptions, and accessibility as launch-blocking review areas with owners, mitigations, and acceptance tests before implementation.
...
- Monetization model: use original free/trial/paid/sponsored/school/provider/tenant entitlement logic; do not copy exact pricing, plan names, bundle names, promotional copy, school contracts, tenant offers, or partner offers from Lingokids.
...
- Manual verification tests for child profile privacy, COPPA/GDPR-K-style controls, Disney/Blippi/NASA/Oxford content licensing, subscription restore, offline content, ad-free claims, and parent community moderation.
...
- Phase 4: Add app-specific safety controls for kids playlearning activities, videos, games, parent progress reports, child profiles, offline access, subscriptions, branded licensed content, and kidSAFE/ad-free positioning.
...
- Confirm legal/privacy retention behavior for Lingokids-style sensitive records and update API contracts before downstream implementation.
