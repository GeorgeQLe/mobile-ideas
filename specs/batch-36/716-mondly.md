# Mondly-Style Clone Spec

> Metadata
> - Inspiration app: Mondly
> - Category: Education
...
> - Manual verification blockers: speech-recognition accuracy, lesson content licensing, subscription restore, chatbot correctness, AR/VR platform differences, minors privacy, and Pearson account behavior.
...
Build an original mobile product inspired by Mondly's public education workflow. The V1 clone focuses on language courses, daily lessons, speech recognition, chatbot/AR/VR adjacent claims, vocabulary practice, progress, subscriptions, and Pearson ecosystem boundaries.
...
- Preserve the functional job behind Mondly while using original product naming, original UI, original sample data, and licensed integrations.
...
- Do not copy Mondly branding, logos, screenshots, marketing copy, private APIs, proprietary datasets, plan names, UI trade dress, course libraries, textbook solutions, documents, school content, AI prompts, or protected media.
...
|---|---|---|---|
| Apple App Store | https://apps.apple.com/us/app/mondly-learn-33-languages/id987873536 | iOS listing, privacy labels, subscriptions, speech/chatbot claims, and support links | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
| Google Play | https://play.google.com/store/apps/details?id=com.atistudios.mondly.languages | Android listing, data safety, language-learning claims, and release cadence | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
| Official product site | https://www.mondly.com/ | Language courses, speech recognition, chatbot, subscriptions, and product positioning | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
| Official support | https://mondlylanguages.zendesk.com/ | Account, subscriptions, languages, speech, and troubleshooting | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
| Privacy policy | https://www.mondly.com/privacy | Learner, account, audio, payment, analytics, and sharing disclosures | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
| Terms | https://www.mondly.com/terms | Service, subscriptions, content, account, and acceptable-use boundaries | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
...
- Manual blockers must remain launch-blocking until verified: speech-recognition accuracy, lesson content licensing, subscription restore, chatbot correctness, AR/VR platform differences, minors privacy, and Pearson account behavior.

## Core User Journeys

- User creates or restores a Mondly-style account, completes role, school, subscription, or tenant checks, and reaches the dashboard.
...
- Monetization model: use original free/trial/paid/sponsored/school/provider/tenant entitlement logic; do not copy exact pricing, plan names, bundle names, promotional copy, school contracts, tenant offers, or partner offers from Mondly.
...
- Manual verification tests for speech-recognition accuracy, lesson content licensing, subscription restore, chatbot correctness, AR/VR platform differences, minors privacy, and Pearson account behavior.
...
- Phase 4: Add app-specific safety controls for language courses, daily lessons, speech recognition, chatbot/AR/VR adjacent claims, vocabulary practice, progress, subscriptions, and Pearson ecosystem boundaries.
...
- Confirm legal/privacy retention behavior for Mondly-style sensitive records and update API contracts before downstream implementation.
