...
> - Manual verification blockers: course/provider licensing, verified certificates, payment/refund flows, partner institution rules, assessment integrity, transcript/credential claims, and regional catalog availability.
...
Build an original mobile product inspired by edX's public education workflow. The V1 clone focuses on university and partner courses, programs, video learning, assignments, quizzes, certificates, verified tracks, enterprise/degree pathways, and offline course progress.
...
- Preserve the functional job behind edX while using original product naming, original UI, original sample data, and licensed integrations.
...
- Do not copy edX branding, logos, screenshots, marketing copy, private APIs, proprietary datasets, plan names, UI trade dress, course libraries, textbook solutions, documents, school content, AI prompts, or protected media.
...
|---|---|---|---|
| Apple App Store | https://apps.apple.com/us/app/edx-online-learning/id945480667 | iOS listing, privacy labels, release notes, course and certificate claims | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
| Google Play | https://play.google.com/store/apps/details?id=org.edx.mobile | Android listing, data safety, course claims, and release cadence | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
| Official product site | https://www.edx.org/ | Courses, programs, certificates, degrees, and partner positioning | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
| Official support | https://support.edx.org/ | Account, courses, payments, certificates, app, and technical support | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
| Privacy policy | https://www.edx.org/edx-privacy-policy | Learner, course, partner, payment, analytics, and sharing disclosures | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
| Terms | https://www.edx.org/edx-terms-service | Service terms, course content, certificates, payments, and acceptable-use boundaries | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
...
- Manual blockers must remain launch-blocking until verified: course/provider licensing, verified certificates, payment/refund flows, partner institution rules, assessment integrity, transcript/credential claims, and regional catalog availability.

## Core User Journeys

- User creates or restores a edX-style account, completes role, school, subscription, or tenant checks, and reaches the dashboard.
...
- Monetization model: use original free/trial/paid/sponsored/school/provider/tenant entitlement logic; do not copy exact pricing, plan names, bundle names, promotional copy, school contracts, tenant offers, or partner offers from edX.
...
- Manual verification tests for course/provider licensing, verified certificates, payment/refund flows, partner institution rules, assessment integrity, transcript/credential claims, and regional catalog availability.
...
- Phase 4: Add app-specific safety controls for university and partner courses, programs, video learning, assignments, quizzes, certificates, verified tracks, enterprise/degree pathways, and offline course progress.
...
- Confirm legal/privacy retention behavior for edX-style sensitive records and update API contracts before downstream implementation.
