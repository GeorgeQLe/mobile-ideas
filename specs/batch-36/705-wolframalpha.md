# WolframAlpha-Style Clone Spec

> Metadata
> - Inspiration app: WolframAlpha
> - Category: Education
...
> - Manual verification blockers: computational answer accuracy, source/provenance limitations, photo input, Pro entitlement restore, academic-integrity copy, paid Android classic app differences, and domain coverage gaps.
...
Build an original mobile product inspired by WolframAlpha's public education workflow. The V1 clone focuses on computational knowledge queries, step-by-step solutions, photo input, input assistants, domains, Pro subscriptions, and reference answer provenance.
...
- Preserve the functional job behind WolframAlpha while using original product naming, original UI, original sample data, and licensed integrations.
...
- Do not copy WolframAlpha branding, logos, screenshots, marketing copy, private APIs, proprietary datasets, plan names, UI trade dress, course libraries, textbook solutions, documents, school content, AI prompts, or protected media.
...
|---|---|---|---|
| Apple App Store | https://apps.apple.com/us/app/wolframalpha/id548861535 | iOS listing, privacy labels, Pro subscription claims, photo input, and terms links | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
| Google Play | https://play.google.com/store/apps/details?id=com.wolfram.android.alpha | Android listing, data safety, paid app model, and feature claims | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
| Official product site | https://www.wolframalpha.com/ | Computational knowledge engine, examples, domains, and product positioning | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
| Official support | https://support.wolfram.com/ | Account, product, subscription, technical, and support documentation | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
| Privacy policy | https://www.wolfram.com/legal/privacy/wolfram | Query, account, subscription, analytics, and sharing disclosures | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
| Terms | https://www.wolframalpha.com/termsofuse | Service terms, query/content use, Pro subscriptions, and acceptable-use boundaries | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
...
- Manual blockers must remain launch-blocking until verified: computational answer accuracy, source/provenance limitations, photo input, Pro entitlement restore, academic-integrity copy, paid Android classic app differences, and domain coverage gaps.

## Core User Journeys

- User creates or restores a WolframAlpha-style account, completes role, school, subscription, or tenant checks, and reaches the dashboard.
...
- Monetization model: use original free/trial/paid/sponsored/school/provider/tenant entitlement logic; do not copy exact pricing, plan names, bundle names, promotional copy, school contracts, tenant offers, or partner offers from WolframAlpha.
...
- Manual verification tests for computational answer accuracy, source/provenance limitations, photo input, Pro entitlement restore, academic-integrity copy, paid Android classic app differences, and domain coverage gaps.
...
- Phase 4: Add app-specific safety controls for computational knowledge queries, step-by-step solutions, photo input, input assistants, domains, Pro subscriptions, and reference answer provenance.
...
- Confirm legal/privacy retention behavior for WolframAlpha-style sensitive records and update API contracts before downstream implementation.
