# Drops-Style Clone Spec

> Metadata
> - Inspiration app: Drops
> - Category: Education
...
> - Manual verification blockers: vocabulary/content licensing, script rendering, subscription restore, Kahoot account migration, ad tracking, offline access, minors privacy, and language availability by region.
...
Build an original mobile product inspired by Drops's public education workflow. The V1 clone focuses on visual vocabulary games, 55+ languages, scripts, goals, streaks, rewards, Premium subscriptions, Kahoot account boundaries, and language-learning progress.
...
- Preserve the functional job behind Drops while using original product naming, original UI, original sample data, and licensed integrations.
...
- Do not copy Drops branding, logos, screenshots, marketing copy, private APIs, proprietary datasets, plan names, UI trade dress, course libraries, textbook solutions, documents, school content, AI prompts, or protected media.
...
|---|---|---|---|
| Apple App Store | https://apps.apple.com/us/app/drops-language-learning-games/id939540371 | iOS listing, privacy labels, subscriptions, language claims, and support links | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
| Google Play | https://play.google.com/store/apps/details?id=com.languagedrops.drops.international | Android listing, data safety, language claims, and release cadence | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
| Official product site | https://languagedrops.com/ | Language games, vocabulary, Premium, and product positioning | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
| Official help | https://support.languagedrops.com/ | Account, subscriptions, languages, progress, and troubleshooting | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
| Privacy policy | https://languagedrops.com/privacypolicy.html | Learner, account, advertising, analytics, payment, and sharing disclosures | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
| Terms | https://languagedrops.com/termsofuse.html | Service, subscriptions, content, account, and acceptable-use terms | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
...
- Manual blockers must remain launch-blocking until verified: vocabulary/content licensing, script rendering, subscription restore, Kahoot account migration, ad tracking, offline access, minors privacy, and language availability by region.

## Core User Journeys

- User creates or restores a Drops-style account, completes role, school, subscription, or tenant checks, and reaches the dashboard.
...
- Monetization model: use original free/trial/paid/sponsored/school/provider/tenant entitlement logic; do not copy exact pricing, plan names, bundle names, promotional copy, school contracts, tenant offers, or partner offers from Drops.
...
- Manual verification tests for vocabulary/content licensing, script rendering, subscription restore, Kahoot account migration, ad tracking, offline access, minors privacy, and language availability by region.
...
- Phase 4: Add app-specific safety controls for visual vocabulary games, 55+ languages, scripts, goals, streaks, rewards, Premium subscriptions, Kahoot account boundaries, and language-learning progress.
...
- Confirm legal/privacy retention behavior for Drops-style sensitive records and update API contracts before downstream implementation.
