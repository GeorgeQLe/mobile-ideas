# Microsoft Lens-Style Clone Spec

> Metadata
> - Inspiration app: Microsoft Lens
...
> - Manual verification blockers: Microsoft account and tenant policy, camera permission and auto-detection accuracy, OCR accuracy and language support, export format fidelity to Word/PowerPoint/Excel, OneDrive/OneNote sync behavior, whiteboard enhancement quality, business card field extraction accuracy, tenant/enterprise compliance, and platform feature differences.
...
Build an original mobile product inspired by Microsoft Lens's public cloud files and identity workflow. The V1 clone focuses on document and whiteboard scanning with auto-edge detection, perspective correction, image enhancement, OCR, export to Word/PowerPoint/Excel/PDF/OneNote/OneDrive, whiteboard mode, business card capture, and Microsoft 365 account integration.
...
- Preserve the functional job behind Microsoft Lens while using original product naming, original UI, original sample data, and licensed integrations.
...
- Do not copy Microsoft Lens branding, logos, screenshots, marketing copy, private APIs, proprietary datasets, plan names, UI trade dress, course libraries, textbook solutions, documents, school content, AI prompts, or protected media.
...
|---|---|---|---|
| Apple App Store | https://apps.apple.com/us/app/microsoft-lens-pdf-scanner/id975925059 | iOS listing, privacy labels, release notes, scan/OCR/export claims, and support links | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
| Google Play | https://play.google.com/store/apps/details?id=com.microsoft.office.officelens | Android listing, data safety, scan/OCR/Office claims, and release cadence | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
| Official product site | https://www.microsoft.com/en-us/microsoft-365/microsoft-lens | Microsoft Lens scanning, OCR, Office integration, and product positioning | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
| Official support | https://support.microsoft.com/office/microsoft-lens | Microsoft Lens capture, OCR, export, sync, and troubleshooting | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
| Privacy statement | https://privacy.microsoft.com/privacystatement | Microsoft account, tenant, cloud, scans, analytics, and privacy disclosures | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
...
- Manual blockers must remain launch-blocking until verified: Microsoft account and tenant policy, camera permission and auto-detection accuracy, OCR accuracy and language support, export format fidelity to Word/PowerPoint/Excel, OneDrive/OneNote sync behavior, whiteboard enhancement quality, business card field extraction accuracy, tenant/enterprise compliance, and platform feature differences.

## Core User Journeys

- User creates or restores a Microsoft Lens-style account, completes role, school, subscription, or tenant checks, and reaches the dashboard.
...
- Monetization model: use original free/trial/paid/sponsored/school/provider/tenant entitlement logic; do not copy exact pricing, plan names, bundle names, promotional copy, school contracts, tenant offers, or partner offers from Microsoft Lens.
...
- Manual verification tests for Microsoft account and tenant policy, camera permission and auto-detection accuracy, OCR accuracy and language support, export format fidelity to Word/PowerPoint/Excel, OneDrive/OneNote sync behavior, whiteboard enhancement quality, business card field extraction accuracy, tenant/enterprise compliance, and platform feature differences.
...
- Phase 4: Add app-specific safety controls for document and whiteboard scanning with auto-edge detection, perspective correction, image enhancement, OCR, export to Word/PowerPoint/Excel/PDF/OneNote/OneDrive, whiteboard mode, business card capture, and Microsoft 365 account integration.
...
- Confirm legal/privacy retention behavior for Microsoft Lens-style sensitive records and update API contracts before downstream implementation.
