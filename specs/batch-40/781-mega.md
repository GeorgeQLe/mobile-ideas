# MEGA-Style Clone Spec

> Metadata
> - Inspiration app: MEGA
...
> - Manual verification blockers: account and encryption key policy, end-to-end encryption key derivation and recovery, selective sync behavior, camera upload background behavior, link sharing password/expiry enforcement, file versioning limits, rubbish bin retention, chat real-time behavior, subscription restore, and regional compliance.
...
Build an original mobile product inspired by MEGA's public cloud files and identity workflow. The V1 clone focuses on encrypted cloud storage with 20 GB free tier, end-to-end encryption, file/folder sync, camera uploads, selective sync, link sharing with optional password/expiry, file versioning, rubbish bin recovery, chat, contacts, and paid storage plan entitlements.
...
- Preserve the functional job behind MEGA while using original product naming, original UI, original sample data, and licensed integrations.
...
- Do not copy MEGA branding, logos, screenshots, marketing copy, private APIs, proprietary datasets, plan names, UI trade dress, course libraries, textbook solutions, documents, school content, AI prompts, or protected media.
...
|---|---|---|---|
| Apple App Store | https://apps.apple.com/us/app/mega/id706857885 | iOS listing, privacy labels, release notes, encrypted cloud storage claims, and support links | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
| Google Play | https://play.google.com/store/apps/details?id=mega.privacy.android.app | Android listing, data safety, encrypted storage/sync claims, and release cadence | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
| Official product site | https://mega.io/ | MEGA encrypted cloud storage, sync, sharing, chat, and product positioning | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
| Official help | https://help.mega.io/ | MEGA storage, sync, sharing, encryption, recovery, and troubleshooting | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
| Privacy policy | https://mega.io/privacy | Account, encryption, storage, analytics, and privacy disclosures | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
| Terms | https://mega.io/terms | Service, subscriptions, storage, encryption, content, and acceptable-use boundaries | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
...
- Manual blockers must remain launch-blocking until verified: account and encryption key policy, end-to-end encryption key derivation and recovery, selective sync behavior, camera upload background behavior, link sharing password/expiry enforcement, file versioning limits, rubbish bin retention, chat real-time behavior, subscription restore, and regional compliance.

## Core User Journeys

- User creates or restores a MEGA-style account, completes role, school, subscription, or tenant checks, and reaches the dashboard.
...
- Monetization model: use original free/trial/paid/sponsored/school/provider/tenant entitlement logic; do not copy exact pricing, plan names, bundle names, promotional copy, school contracts, tenant offers, or partner offers from MEGA.
...
- Manual verification tests for account and encryption key policy, end-to-end encryption key derivation and recovery, selective sync behavior, camera upload background behavior, link sharing password/expiry enforcement, file versioning limits, rubbish bin retention, chat real-time behavior, subscription restore, and regional compliance.
...
- Phase 4: Add app-specific safety controls for encrypted cloud storage with 20 GB free tier, end-to-end encryption, file/folder sync, camera uploads, selective sync, link sharing with optional password/expiry, file versioning, rubbish bin recovery, chat, contacts, and paid storage plan entitlements.
...
- Confirm legal/privacy retention behavior for MEGA-style sensitive records and update API contracts before downstream implementation.
