# Adobe Acrobat Reader-Style Clone Spec

> Metadata
> - Inspiration app: Adobe Acrobat Reader
...
> - Manual verification blockers: Adobe account and Creative Cloud policy, PDF rendering fidelity, annotation/markup persistence, form field detection, e-sign legal validity, scan OCR accuracy, page organization behavior, file combination limits, export format fidelity, cloud storage sync, share for review collaboration, subscription restore, and regional compliance.
...
Build an original mobile product inspired by Adobe Acrobat Reader's public cloud files and identity workflow. The V1 clone focuses on PDF viewing, annotation, commenting, form filling, e-signing, scan to PDF, organize pages, combine files, export to Word/Excel/PowerPoint, Adobe Cloud Storage integration, share for review, and subscription plan entitlements.
...
- Preserve the functional job behind Adobe Acrobat Reader while using original product naming, original UI, original sample data, and licensed integrations.
...
- Do not copy Adobe Acrobat Reader branding, logos, screenshots, marketing copy, private APIs, proprietary datasets, plan names, UI trade dress, course libraries, textbook solutions, documents, school content, AI prompts, or protected media.
...
|---|---|---|---|
| Apple App Store | https://apps.apple.com/us/app/adobe-acrobat-reader-edit-pdf/id469337564 | iOS listing, privacy labels, release notes, PDF/scan/sign claims, and support links | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
| Google Play | https://play.google.com/store/apps/details?id=com.adobe.reader | Android listing, data safety, PDF/annotation/sign claims, and release cadence | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
| Official product site | https://www.adobe.com/acrobat/mobile/acrobat-reader.html | Adobe Acrobat Reader PDF viewing, annotation, signing, and product positioning | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
| Official help | https://helpx.adobe.com/acrobat/using/mobile-app.html | Acrobat Reader mobile viewing, annotation, signing, scanning, and troubleshooting | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
| Privacy policy | https://www.adobe.com/privacy/policy.html | Adobe account, cloud, analytics, AI, and privacy disclosures | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
| Terms | https://www.adobe.com/legal/terms.html | Adobe services, subscriptions, content, cloud, and acceptable-use boundaries | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
...
- Manual blockers must remain launch-blocking until verified: Adobe account and Creative Cloud policy, PDF rendering fidelity, annotation/markup persistence, form field detection, e-sign legal validity, scan OCR accuracy, page organization behavior, file combination limits, export format fidelity, cloud storage sync, share for review collaboration, subscription restore, and regional compliance.

## Core User Journeys

- User creates or restores a Adobe Acrobat Reader-style account, completes role, school, subscription, or tenant checks, and reaches the dashboard.
...
|---|---|---|---|---|
| Welcome/Auth | Account creation, encryption key setup, SSO, subscription, and consent entry | email, SSO, key, restore | new, returning, encrypted, locked | key lost, SSO failed, region unavailable |
| Home/Files | File browser, recent files, search, favorites, shared folders, and upload actions | tap, search, upload, create | empty, loading, current, offline | sync conflict, quota full, file missing |
| File/Folder Detail | Preview, download, rename, move, copy, share link, versions, and delete | preview, share, move, delete | synced, downloading, shared, versioned | format unsupported, download failed, permission denied |
| Share/Collaborate | Share links, password/expiry settings, permissions, contacts, and transfer tracking | link, password, expiry, invite | private, shared, password-set, expired | link revoked, over-sharing, recipient limit |
| Sync/Transfers | Upload queue, download queue, camera uploads, selective sync, and conflict resolution | retry, pause, resolve, configure | queued, syncing, conflicted, complete | disk full, network timeout, quota exceeded |
| Settings/Privacy | Account, encryption, storage quota, subscription, privacy, support, export, deletion | forms, restore, links, request | loaded, editing, requested | active subscription, encryption key recovery, legal hold |
...
- Treat encrypted credentials, vault data, master passwords, encryption keys, biometric templates, cloud-synced files, scanned documents, OCR text, e-signatures, shared links, transfer metadata, breach monitoring results, TOTP secrets, backup encryption, subscription entitlements, device trust, multi-device sync state, and data exports as launch-blocking review areas with owners, mitigations, and acceptance tests before implementation.
...
- Monetization model: use original free/trial/paid/sponsored/school/provider/tenant entitlement logic; do not copy exact pricing, plan names, bundle names, promotional copy, school contracts, tenant offers, or partner offers from Adobe Acrobat Reader.
...
- Manual verification tests for Adobe account and Creative Cloud policy, PDF rendering fidelity, annotation/markup persistence, form field detection, e-sign legal validity, scan OCR accuracy, page organization behavior, file combination limits, export format fidelity, cloud storage sync, share for review collaboration, subscription restore, and regional compliance.
...
- Phase 4: Add app-specific safety controls for PDF viewing, annotation, commenting, form filling, e-signing, scan to PDF, organize pages, combine files, export to Word/Excel/PowerPoint, Adobe Cloud Storage integration, share for review, and subscription plan entitlements.
...
- Confirm legal/privacy retention behavior for Adobe Acrobat Reader-style sensitive records and update API contracts before downstream implementation.
