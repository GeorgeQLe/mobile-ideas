# Bitwarden-Style Clone Spec

> Metadata
> - Inspiration app: Bitwarden
...
> - Manual verification blockers: account and master password policy, vault encryption and key derivation (open-source verifiable), autofill integration behavior, TOTP generation accuracy, Send expiration/access enforcement, vault health report data sourcing, organization/collection permission model, self-host configuration parity, biometric unlock security model, subscription restore, and enterprise compliance.
...
Build an original mobile product inspired by Bitwarden's public cloud files and identity workflow. The V1 clone focuses on open-source password management with vault storage, login autofill, password generator, TOTP authenticator, secure notes, card/identity storage, Send (secure sharing), vault health reports, organizations/collections, biometric unlock, self-host option, and premium/family/enterprise plan entitlements.
...
- Preserve the functional job behind Bitwarden while using original product naming, original UI, original sample data, and licensed integrations.
...
- Do not copy Bitwarden branding, logos, screenshots, marketing copy, private APIs, proprietary datasets, plan names, UI trade dress, course libraries, textbook solutions, documents, school content, AI prompts, or protected media.
...
|---|---|---|---|
| Apple App Store | https://apps.apple.com/us/app/bitwarden-password-manager/id1137397744 | iOS listing, privacy labels, release notes, password manager claims, and support links | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
| Google Play | https://play.google.com/store/apps/details?id=com.x8bit.bitwarden | Android listing, data safety, password/TOTP claims, and release cadence | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
| Official product site | https://bitwarden.com/ | Bitwarden vault, autofill, Send, organizations, and product positioning | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
| Official help | https://bitwarden.com/help/ | Bitwarden vault, autofill, TOTP, Send, organizations, and troubleshooting | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
| Privacy policy | https://bitwarden.com/privacy/ | Account, vault, analytics, open-source, and privacy disclosures | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
| Terms | https://bitwarden.com/terms/ | Service, subscriptions, vault, organizations, and acceptable-use boundaries | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
...
- Manual blockers must remain launch-blocking until verified: account and master password policy, vault encryption and key derivation (open-source verifiable), autofill integration behavior, TOTP generation accuracy, Send expiration/access enforcement, vault health report data sourcing, organization/collection permission model, self-host configuration parity, biometric unlock security model, subscription restore, and enterprise compliance.

## Core User Journeys

- User creates or restores a Bitwarden-style account, completes role, school, subscription, or tenant checks, and reaches the dashboard.
...
- Monetization model: use original free/trial/paid/sponsored/school/provider/tenant entitlement logic; do not copy exact pricing, plan names, bundle names, promotional copy, school contracts, tenant offers, or partner offers from Bitwarden.
...
- Manual verification tests for account and master password policy, vault encryption and key derivation (open-source verifiable), autofill integration behavior, TOTP generation accuracy, Send expiration/access enforcement, vault health report data sourcing, organization/collection permission model, self-host configuration parity, biometric unlock security model, subscription restore, and enterprise compliance.
...
- Phase 4: Add app-specific safety controls for open-source password management with vault storage, login autofill, password generator, TOTP authenticator, secure notes, card/identity storage, Send (secure sharing), vault health reports, organizations/collections, biometric unlock, self-host option, and premium/family/enterprise plan entitlements.
...
- Confirm legal/privacy retention behavior for Bitwarden-style sensitive records and update API contracts before downstream implementation.
