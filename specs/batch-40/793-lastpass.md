# LastPass-Style Clone Spec

> Metadata
> - Inspiration app: LastPass
...
> - Manual verification blockers: account and master password policy, vault encryption and key derivation, autofill integration behavior, security dashboard scoring algorithm, dark web monitoring data sourcing, emergency access trust/wait mechanics, family sharing vault permissions, passwordless authentication flow, biometric unlock security model, subscription restore, and compliance certifications.
...
Build an original mobile product inspired by LastPass's public cloud files and identity workflow. The V1 clone focuses on password management with vault storage, login autofill, password generator, security dashboard, dark web monitoring, secure notes, form filling, emergency access, family sharing, passwordless login, biometric unlock, and premium/family plan entitlements.
...
- Preserve the functional job behind LastPass while using original product naming, original UI, original sample data, and licensed integrations.
...
- Do not copy LastPass branding, logos, screenshots, marketing copy, private APIs, proprietary datasets, plan names, UI trade dress, course libraries, textbook solutions, documents, school content, AI prompts, or protected media.
...
|---|---|---|---|
| Apple App Store | https://apps.apple.com/us/app/lastpass-password-manager/id324613447 | iOS listing, privacy labels, release notes, password manager claims, and support links | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
| Google Play | https://play.google.com/store/apps/details?id=com.lastpass.lpandroid | Android listing, data safety, password/autofill claims, and release cadence | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
| Official product site | https://www.lastpass.com/ | LastPass vault, autofill, monitoring, sharing, and product positioning | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
| Official help | https://support.lastpass.com/ | LastPass vault, autofill, security, sharing, and troubleshooting | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
| Privacy policy | https://www.lastpass.com/privacy | Account, vault, monitoring, analytics, and privacy disclosures | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
| Terms | https://www.lastpass.com/terms-of-service | Service, subscriptions, vault, sharing, and acceptable-use boundaries | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
...
- Manual blockers must remain launch-blocking until verified: account and master password policy, vault encryption and key derivation, autofill integration behavior, security dashboard scoring algorithm, dark web monitoring data sourcing, emergency access trust/wait mechanics, family sharing vault permissions, passwordless authentication flow, biometric unlock security model, subscription restore, and compliance certifications.

## Core User Journeys

- User creates or restores a LastPass-style account, completes role, school, subscription, or tenant checks, and reaches the dashboard.
...
|---|---|---|---|---|
| Welcome/Auth | Account creation, master password/key setup, biometric enrollment, and import | email, master-pass, biometric, import | new, returning, locked, recovering | master password lost, biometric failed, import error |
| Vault/Items | Login items, secure notes, cards, identities, folders/categories, and search | tap, search, create, organize | empty, loading, current, locked | vault locked timeout, sync conflict, item missing |
| Item Detail | Credentials, TOTP codes, notes, attachments, history, and sharing status | copy, edit, share, delete | view, editing, shared, expired | TOTP drift, attachment limit, permission denied |
| Autofill/Generate | Login autofill prompt, password generator, passkey creation, and fill history | fill, generate, passkey, configure | suggested, filled, generated, failed | no match, autofill blocked, site incompatible |
| Security/Health | Password health score, breach monitoring alerts, weak/reused/old passwords, and recommendations | scan, view, fix, dismiss | healthy, warnings, breaches, scanning | monitoring unavailable, false positive, stale data |
| Settings/Privacy | Account, encryption, biometrics, auto-lock, subscription, sharing, export, deletion | forms, restore, links, request | loaded, editing, requested | active subscription, key recovery, team policy |
...
- Monetization model: use original free/trial/paid/sponsored/school/provider/tenant entitlement logic; do not copy exact pricing, plan names, bundle names, promotional copy, school contracts, tenant offers, or partner offers from LastPass.
...
- Manual verification tests for account and master password policy, vault encryption and key derivation, autofill integration behavior, security dashboard scoring algorithm, dark web monitoring data sourcing, emergency access trust/wait mechanics, family sharing vault permissions, passwordless authentication flow, biometric unlock security model, subscription restore, and compliance certifications.
...
- Phase 4: Add app-specific safety controls for password management with vault storage, login autofill, password generator, security dashboard, dark web monitoring, secure notes, form filling, emergency access, family sharing, passwordless login, biometric unlock, and premium/family plan entitlements.
...
- Confirm legal/privacy retention behavior for LastPass-style sensitive records and update API contracts before downstream implementation.
