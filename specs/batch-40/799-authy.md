# Authy-Style Clone Spec

> Metadata
> - Inspiration app: Authy
...
> - Manual verification blockers: Twilio/Authy account policy, TOTP generation accuracy and time sync, encrypted backup key derivation and recovery, multi-device registration and deregistration, push authentication delivery and approval flow, biometric lock security model, token icon/service recognition, backup encryption without master password loss, and service continuity (Authy desktop EOL context).
...
Build an original mobile product inspired by Authy's public cloud files and identity workflow. The V1 clone focuses on two-factor authentication with TOTP code generation, encrypted cloud backup, multi-device sync, push authentication for supported services, biometric lock, token organization with icons/labels, and free service model.
...
- Preserve the functional job behind Authy while using original product naming, original UI, original sample data, and licensed integrations.
...
- Do not copy Authy branding, logos, screenshots, marketing copy, private APIs, proprietary datasets, plan names, UI trade dress, course libraries, textbook solutions, documents, school content, AI prompts, or protected media.
...
|---|---|---|---|
| Apple App Store | https://apps.apple.com/us/app/twilio-authy/id494168017 | iOS listing, privacy labels, release notes, 2FA/backup claims, and support links | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
| Google Play | https://play.google.com/store/apps/details?id=com.authy.authy | Android listing, data safety, 2FA/sync claims, and release cadence | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
| Official product site | https://authy.com/ | Authy 2FA, encrypted backups, multi-device, and product positioning | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
| Official help | https://support.authy.com/ | Authy tokens, backup, multi-device, recovery, and troubleshooting | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
| Privacy policy | https://www.twilio.com/legal/privacy | Twilio/Authy account, tokens, backup, analytics, and privacy disclosures | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
| Terms | https://www.twilio.com/legal/tos | Twilio/Authy service, accounts, and acceptable-use boundaries | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
...
- Manual blockers must remain launch-blocking until verified: Twilio/Authy account policy, TOTP generation accuracy and time sync, encrypted backup key derivation and recovery, multi-device registration and deregistration, push authentication delivery and approval flow, biometric lock security model, token icon/service recognition, backup encryption without master password loss, and service continuity (Authy desktop EOL context).

## Core User Journeys

- User creates or restores a Authy-style account, completes role, school, subscription, or tenant checks, and reaches the dashboard.
...
- Monetization model: use original free/trial/paid/sponsored/school/provider/tenant entitlement logic; do not copy exact pricing, plan names, bundle names, promotional copy, school contracts, tenant offers, or partner offers from Authy.
...
- Manual verification tests for Twilio/Authy account policy, TOTP generation accuracy and time sync, encrypted backup key derivation and recovery, multi-device registration and deregistration, push authentication delivery and approval flow, biometric lock security model, token icon/service recognition, backup encryption without master password loss, and service continuity (Authy desktop EOL context).
...
- Phase 4: Add app-specific safety controls for two-factor authentication with TOTP code generation, encrypted cloud backup, multi-device sync, push authentication for supported services, biometric lock, token organization with icons/labels, and free service model.
...
- Confirm legal/privacy retention behavior for Authy-style sensitive records and update API contracts before downstream implementation.
