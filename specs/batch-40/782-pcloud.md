# pCloud-Style Clone Spec

> Metadata
> - Inspiration app: pCloud
...
> - Manual verification blockers: account and sync policy, virtual drive mount behavior, crypto folder key management, camera upload background behavior, link sharing and file request branding, media player format support, file versioning retention, family plan sharing mechanics, subscription/lifetime restore, and regional compliance.
...
Build an original mobile product inspired by pCloud's public cloud files and identity workflow. The V1 clone focuses on cloud storage with virtual drive, file sync, camera uploads, link sharing, branded file requests, built-in media player, crypto folder (client-side encryption), file versioning, trash recovery, family sharing, and lifetime or subscription plan entitlements.
...
- Preserve the functional job behind pCloud while using original product naming, original UI, original sample data, and licensed integrations.
...
- Do not copy pCloud branding, logos, screenshots, marketing copy, private APIs, proprietary datasets, plan names, UI trade dress, course libraries, textbook solutions, documents, school content, AI prompts, or protected media.
...
|---|---|---|---|
| Apple App Store | https://apps.apple.com/us/app/pcloud-cloud-storage/id692002498 | iOS listing, privacy labels, release notes, cloud storage/sync claims, and support links | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
| Google Play | https://play.google.com/store/apps/details?id=com.pcloud.pcloud | Android listing, data safety, cloud storage/crypto claims, and release cadence | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
| Official product site | https://www.pcloud.com/ | pCloud storage, sync, crypto, media, sharing, and product positioning | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
| Official help | https://www.pcloud.com/help/ | pCloud storage, sync, crypto folder, sharing, and troubleshooting | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
| Privacy policy | https://www.pcloud.com/privacy_policy.html | Account, storage, crypto, analytics, and privacy disclosures | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
| Terms | https://www.pcloud.com/terms_and_conditions.html | Service, subscriptions, storage, crypto, content, and acceptable-use boundaries | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
...
- Manual blockers must remain launch-blocking until verified: account and sync policy, virtual drive mount behavior, crypto folder key management, camera upload background behavior, link sharing and file request branding, media player format support, file versioning retention, family plan sharing mechanics, subscription/lifetime restore, and regional compliance.

## Core User Journeys

- User creates or restores a pCloud-style account, completes role, school, subscription, or tenant checks, and reaches the dashboard.
...
- Monetization model: use original free/trial/paid/sponsored/school/provider/tenant entitlement logic; do not copy exact pricing, plan names, bundle names, promotional copy, school contracts, tenant offers, or partner offers from pCloud.
...
- Manual verification tests for account and sync policy, virtual drive mount behavior, crypto folder key management, camera upload background behavior, link sharing and file request branding, media player format support, file versioning retention, family plan sharing mechanics, subscription/lifetime restore, and regional compliance.
...
- Phase 4: Add app-specific safety controls for cloud storage with virtual drive, file sync, camera uploads, link sharing, branded file requests, built-in media player, crypto folder (client-side encryption), file versioning, trash recovery, family sharing, and lifetime or subscription plan entitlements.
...
- Confirm legal/privacy retention behavior for pCloud-style sensitive records and update API contracts before downstream implementation.
