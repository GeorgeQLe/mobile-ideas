# Sync.com-Style Clone Spec

> Metadata
> - Inspiration app: Sync.com
...
> - Manual verification blockers: account and zero-knowledge encryption policy, key derivation and recovery without server access, selective sync behavior, camera upload background behavior, link sharing password/expiry/limit enforcement, vault archive access, file versioning retention, deleted file recovery window, subscription restore, and regional compliance.
...
Build an original mobile product inspired by Sync.com's public cloud files and identity workflow. The V1 clone focuses on zero-knowledge encrypted cloud storage with file sync, selective sync, camera uploads, link sharing with password/expiry/download limits, file requests, vault (archive storage), file versioning, deleted file recovery, and paid plan entitlements.
...
- Preserve the functional job behind Sync.com while using original product naming, original UI, original sample data, and licensed integrations.
...
- Do not copy Sync.com branding, logos, screenshots, marketing copy, private APIs, proprietary datasets, plan names, UI trade dress, course libraries, textbook solutions, documents, school content, AI prompts, or protected media.
...
|---|---|---|---|
| Apple App Store | https://apps.apple.com/us/app/sync-com/id887941665 | iOS listing, privacy labels, release notes, encrypted cloud storage claims, and support links | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
| Google Play | https://play.google.com/store/apps/details?id=com.sync.mobileapp | Android listing, data safety, zero-knowledge encryption/sync claims, and release cadence | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
| Official product site | https://www.sync.com/ | Sync.com zero-knowledge encrypted storage, sync, sharing, and product positioning | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
| Official help | https://www.sync.com/help/ | Sync.com storage, encryption, sync, sharing, vault, and troubleshooting | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
| Privacy policy | https://www.sync.com/privacy/ | Account, encryption, storage, analytics, and privacy disclosures | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
| Terms | https://www.sync.com/terms/ | Service, subscriptions, storage, encryption, content, and acceptable-use boundaries | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
...
- Manual blockers must remain launch-blocking until verified: account and zero-knowledge encryption policy, key derivation and recovery without server access, selective sync behavior, camera upload background behavior, link sharing password/expiry/limit enforcement, vault archive access, file versioning retention, deleted file recovery window, subscription restore, and regional compliance.

## Core User Journeys

- User creates or restores a Sync.com-style account, completes role, school, subscription, or tenant checks, and reaches the dashboard.
...
- Monetization model: use original free/trial/paid/sponsored/school/provider/tenant entitlement logic; do not copy exact pricing, plan names, bundle names, promotional copy, school contracts, tenant offers, or partner offers from Sync.com.
...
- Manual verification tests for account and zero-knowledge encryption policy, key derivation and recovery without server access, selective sync behavior, camera upload background behavior, link sharing password/expiry/limit enforcement, vault archive access, file versioning retention, deleted file recovery window, subscription restore, and regional compliance.
...
- Phase 4: Add app-specific safety controls for zero-knowledge encrypted cloud storage with file sync, selective sync, camera uploads, link sharing with password/expiry/download limits, file requests, vault (archive storage), file versioning, deleted file recovery, and paid plan entitlements.
...
- Confirm legal/privacy retention behavior for Sync.com-style sensitive records and update API contracts before downstream implementation.
