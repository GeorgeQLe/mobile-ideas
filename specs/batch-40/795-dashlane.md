# Dashlane-Style Clone Spec

> Metadata
> - Inspiration app: Dashlane
...
> - Manual verification blockers: account and master password policy, vault encryption and key derivation, autofill integration behavior, Password Health scoring algorithm, dark web monitoring data sourcing, VPN integration and provider, sharing center permission model, emergency contact trust mechanics, identity dashboard data, subscription restore, and enterprise compliance.
...
Build an original mobile product inspired by Dashlane's public cloud files and identity workflow. The V1 clone focuses on password management with vault storage, login autofill, password generator, Password Health score, dark web monitoring, VPN, secure notes, payment storage, identity dashboard, sharing center, emergency contacts, and premium/family/business plan entitlements.
...
- Preserve the functional job behind Dashlane while using original product naming, original UI, original sample data, and licensed integrations.
...
- Do not copy Dashlane branding, logos, screenshots, marketing copy, private APIs, proprietary datasets, plan names, UI trade dress, course libraries, textbook solutions, documents, school content, AI prompts, or protected media.
...
|---|---|---|---|
| Apple App Store | https://apps.apple.com/us/app/dashlane-password-manager/id517914548 | iOS listing, privacy labels, release notes, password manager/VPN claims, and support links | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
| Google Play | https://play.google.com/store/apps/details?id=com.dashlane | Android listing, data safety, password/VPN/monitoring claims, and release cadence | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
| Official product site | https://www.dashlane.com/ | Dashlane vault, autofill, monitoring, VPN, and product positioning | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
| Official help | https://support.dashlane.com/ | Dashlane vault, autofill, VPN, sharing, and troubleshooting | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
| Privacy policy | https://www.dashlane.com/privacy | Account, vault, VPN, monitoring, analytics, and privacy disclosures | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
| Terms | https://www.dashlane.com/terms | Service, subscriptions, vault, VPN, and acceptable-use boundaries | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
...
- Manual blockers must remain launch-blocking until verified: account and master password policy, vault encryption and key derivation, autofill integration behavior, Password Health scoring algorithm, dark web monitoring data sourcing, VPN integration and provider, sharing center permission model, emergency contact trust mechanics, identity dashboard data, subscription restore, and enterprise compliance.

## Core User Journeys

- User creates or restores a Dashlane-style account, completes role, school, subscription, or tenant checks, and reaches the dashboard.
...
- Monetization model: use original free/trial/paid/sponsored/school/provider/tenant entitlement logic; do not copy exact pricing, plan names, bundle names, promotional copy, school contracts, tenant offers, or partner offers from Dashlane.
...
- Manual verification tests for account and master password policy, vault encryption and key derivation, autofill integration behavior, Password Health scoring algorithm, dark web monitoring data sourcing, VPN integration and provider, sharing center permission model, emergency contact trust mechanics, identity dashboard data, subscription restore, and enterprise compliance.
...
- Phase 4: Add app-specific safety controls for password management with vault storage, login autofill, password generator, Password Health score, dark web monitoring, VPN, secure notes, payment storage, identity dashboard, sharing center, emergency contacts, and premium/family/business plan entitlements.
...
- Confirm legal/privacy retention behavior for Dashlane-style sensitive records and update API contracts before downstream implementation.
