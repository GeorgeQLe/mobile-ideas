# 1Password-Style Clone Spec

> Metadata
> - Inspiration app: 1Password
...
> - Manual verification blockers: account and Secret Key policy, vault encryption and key derivation, autofill integration (iOS AutoFill, Android Autofill API), Watchtower breach data sourcing, Travel Mode vault hiding behavior, family/team vault sharing permissions, biometric unlock security model, browser extension mobile parity, subscription restore, and enterprise/team compliance.
...
Build an original mobile product inspired by 1Password's public cloud files and identity workflow. The V1 clone focuses on password management with vault organization, login autofill, password generator, secure notes, credit card storage, identity documents, Watchtower (breach monitoring), Travel Mode, family/team sharing, biometric unlock, browser extension integration, and subscription entitlements.
...
- Preserve the functional job behind 1Password while using original product naming, original UI, original sample data, and licensed integrations.
...
- Do not copy 1Password branding, logos, screenshots, marketing copy, private APIs, proprietary datasets, plan names, UI trade dress, course libraries, textbook solutions, documents, school content, AI prompts, or protected media.
...
|---|---|---|---|
| Apple App Store | https://apps.apple.com/us/app/1password-password-manager/id1511601750 | iOS listing, privacy labels, release notes, password manager claims, and support links | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
| Google Play | https://play.google.com/store/apps/details?id=com.onepassword.android | Android listing, data safety, password/autofill claims, and release cadence | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
| Official product site | https://1password.com/ | 1Password vaults, autofill, Watchtower, sharing, and product positioning | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
| Official help | https://support.1password.com/ | 1Password vaults, autofill, sharing, security, and troubleshooting | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
| Privacy policy | https://1password.com/legal/privacy/ | Account, vaults, Watchtower, analytics, and privacy disclosures | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
| Terms | https://1password.com/legal/terms-of-service/ | Service, subscriptions, vaults, sharing, and acceptable-use boundaries | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
...
- Manual blockers must remain launch-blocking until verified: account and Secret Key policy, vault encryption and key derivation, autofill integration (iOS AutoFill, Android Autofill API), Watchtower breach data sourcing, Travel Mode vault hiding behavior, family/team vault sharing permissions, biometric unlock security model, browser extension mobile parity, subscription restore, and enterprise/team compliance.

## Core User Journeys

- User creates or restores a 1Password-style account, completes role, school, subscription, or tenant checks, and reaches the dashboard.
...
- Monetization model: use original free/trial/paid/sponsored/school/provider/tenant entitlement logic; do not copy exact pricing, plan names, bundle names, promotional copy, school contracts, tenant offers, or partner offers from 1Password.
...
- Manual verification tests for account and Secret Key policy, vault encryption and key derivation, autofill integration (iOS AutoFill, Android Autofill API), Watchtower breach data sourcing, Travel Mode vault hiding behavior, family/team vault sharing permissions, biometric unlock security model, browser extension mobile parity, subscription restore, and enterprise/team compliance.
...
- Phase 4: Add app-specific safety controls for password management with vault organization, login autofill, password generator, secure notes, credit card storage, identity documents, Watchtower (breach monitoring), Travel Mode, family/team sharing, biometric unlock, browser extension integration, and subscription entitlements.
...
- Confirm legal/privacy retention behavior for 1Password-style sensitive records and update API contracts before downstream implementation.
