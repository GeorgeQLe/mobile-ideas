# Genius Scan-Style Clone Spec

> Metadata
> - Inspiration app: Genius Scan
...
> - Manual verification blockers: camera permission and real-time detection accuracy, batch scanning page ordering, OCR accuracy and language support, cloud export authentication and sync, PDF text layer fidelity, image filter quality, folder sync conflicts, purchase/subscription restore, and platform feature differences.
...
Build an original mobile product inspired by Genius Scan's public cloud files and identity workflow. The V1 clone focuses on document scanning with real-time edge detection, perspective correction, smart page detection, batch scanning, image filters, OCR, PDF export with selectable text, cloud export to iCloud/Dropbox/Google Drive/OneDrive/Box/Evernote/email, folder organization, and one-time purchase or subscription entitlements.
...
- Preserve the functional job behind Genius Scan while using original product naming, original UI, original sample data, and licensed integrations.
...
- Do not copy Genius Scan branding, logos, screenshots, marketing copy, private APIs, proprietary datasets, plan names, UI trade dress, course libraries, textbook solutions, documents, school content, AI prompts, or protected media.
...
|---|---|---|---|
| Apple App Store | https://apps.apple.com/us/app/genius-scan-pdf-scanner/id1098689460 | iOS listing, privacy labels, release notes, scan/OCR claims, and support links | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
| Google Play | https://play.google.com/store/apps/details?id=com.thegrizzlylabs.geniusscan.free | Android listing, data safety, scan/export claims, and release cadence | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
| Official product site | https://thegrizzlylabs.com/genius-scan/ | Genius Scan document scanning, OCR, export, and product positioning | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
| Official help | https://support.thegrizzlylabs.com/ | Genius Scan scanning, OCR, export, sync, and troubleshooting | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
| Privacy policy | https://thegrizzlylabs.com/privacy/ | Scans, cloud exports, analytics, and privacy disclosures | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
| Terms | https://thegrizzlylabs.com/terms/ | Purchase, subscriptions, content, and acceptable-use boundaries | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
...
- Manual blockers must remain launch-blocking until verified: camera permission and real-time detection accuracy, batch scanning page ordering, OCR accuracy and language support, cloud export authentication and sync, PDF text layer fidelity, image filter quality, folder sync conflicts, purchase/subscription restore, and platform feature differences.

## Core User Journeys

- User creates or restores a Genius Scan-style account, completes role, school, subscription, or tenant checks, and reaches the dashboard.
...
- Monetization model: use original free/trial/paid/sponsored/school/provider/tenant entitlement logic; do not copy exact pricing, plan names, bundle names, promotional copy, school contracts, tenant offers, or partner offers from Genius Scan.
...
- Manual verification tests for camera permission and real-time detection accuracy, batch scanning page ordering, OCR accuracy and language support, cloud export authentication and sync, PDF text layer fidelity, image filter quality, folder sync conflicts, purchase/subscription restore, and platform feature differences.
...
- Phase 4: Add app-specific safety controls for document scanning with real-time edge detection, perspective correction, smart page detection, batch scanning, image filters, OCR, PDF export with selectable text, cloud export to iCloud/Dropbox/Google Drive/OneDrive/Box/Evernote/email, folder organization, and one-time purchase or subscription entitlements.
...
- Confirm legal/privacy retention behavior for Genius Scan-style sensitive records and update API contracts before downstream implementation.
