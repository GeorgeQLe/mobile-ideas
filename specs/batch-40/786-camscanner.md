# CamScanner-Style Clone Spec

> Metadata
> - Inspiration app: CamScanner
...
> - Manual verification blockers: account and cloud sync policy, camera permission and auto-detection accuracy, OCR language support and accuracy, image enhancement quality, export format fidelity, cloud sync conflicts, fax delivery verification, e-sign legal validity, subscription restore, and regional compliance.
...
Build an original mobile product inspired by CamScanner's public cloud files and identity workflow. The V1 clone focuses on document scanning with auto-edge detection, perspective correction, image enhancement filters, OCR text recognition, PDF/JPEG export, cloud sync, folder organization, document sharing, fax sending, e-sign, and premium plan entitlements.
...
- Preserve the functional job behind CamScanner while using original product naming, original UI, original sample data, and licensed integrations.
...
- Do not copy CamScanner branding, logos, screenshots, marketing copy, private APIs, proprietary datasets, plan names, UI trade dress, course libraries, textbook solutions, documents, school content, AI prompts, or protected media.
...
|---|---|---|---|
| Apple App Store | https://apps.apple.com/us/app/camscanner-pdf-scanner-app/id388627783 | iOS listing, privacy labels, release notes, scan/OCR claims, and support links | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
| Google Play | https://play.google.com/store/apps/details?id=com.intsig.camscanner | Android listing, data safety, scan/OCR/fax claims, and release cadence | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
| Official product site | https://www.camscanner.com/ | CamScanner document scanning, OCR, cloud sync, and product positioning | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
| Official help | https://help.camscanner.com/ | CamScanner scanning, OCR, sync, export, and troubleshooting | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
| Privacy policy | https://www.camscanner.com/privacy | Account, scans, cloud, OCR, analytics, and privacy disclosures | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
| Terms | https://www.camscanner.com/agreement | Service, subscriptions, content, scans, and acceptable-use boundaries | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
...
- Manual blockers must remain launch-blocking until verified: account and cloud sync policy, camera permission and auto-detection accuracy, OCR language support and accuracy, image enhancement quality, export format fidelity, cloud sync conflicts, fax delivery verification, e-sign legal validity, subscription restore, and regional compliance.

## Core User Journeys

- User creates or restores a CamScanner-style account, completes role, school, subscription, or tenant checks, and reaches the dashboard.
...
- Monetization model: use original free/trial/paid/sponsored/school/provider/tenant entitlement logic; do not copy exact pricing, plan names, bundle names, promotional copy, school contracts, tenant offers, or partner offers from CamScanner.
...
- Manual verification tests for account and cloud sync policy, camera permission and auto-detection accuracy, OCR language support and accuracy, image enhancement quality, export format fidelity, cloud sync conflicts, fax delivery verification, e-sign legal validity, subscription restore, and regional compliance.
...
- Phase 4: Add app-specific safety controls for document scanning with auto-edge detection, perspective correction, image enhancement filters, OCR text recognition, PDF/JPEG export, cloud sync, folder organization, document sharing, fax sending, e-sign, and premium plan entitlements.
...
- Confirm legal/privacy retention behavior for CamScanner-style sensitive records and update API contracts before downstream implementation.
