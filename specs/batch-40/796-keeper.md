# Keeper-Style Clone Spec

> Metadata
> - Inspiration app: Keeper
...
> - Manual verification blockers: account and master password policy, vault zero-knowledge encryption and key derivation, autofill integration behavior, BreachWatch monitoring data sourcing, secure file storage encryption and limits, KeeperChat end-to-end encryption, emergency access trust/timer mechanics, shared folder permission model, role-based enforcement, biometric security model, subscription restore, and enterprise/compliance certifications (SOC 2, ISO 27001).
...
Build an original mobile product inspired by Keeper's public cloud files and identity workflow. The V1 clone focuses on password and secrets management with vault storage, login autofill, password generator, BreachWatch (dark web monitoring), secure file storage, KeeperChat (encrypted messaging), emergency access, shared folders, role-based access, biometric unlock, and personal/family/business plan entitlements.
...
- Preserve the functional job behind Keeper while using original product naming, original UI, original sample data, and licensed integrations.
...
- Do not copy Keeper branding, logos, screenshots, marketing copy, private APIs, proprietary datasets, plan names, UI trade dress, course libraries, textbook solutions, documents, school content, AI prompts, or protected media.
...
|---|---|---|---|
| Apple App Store | https://apps.apple.com/us/app/keeper-password-manager/id287170072 | iOS listing, privacy labels, release notes, password/secrets claims, and support links | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
| Google Play | https://play.google.com/store/apps/details?id=com.callpod.android_apps.keeper | Android listing, data safety, password/BreachWatch claims, and release cadence | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
| Official product site | https://www.keepersecurity.com/ | Keeper vault, autofill, BreachWatch, chat, and product positioning | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
| Official help | https://docs.keeper.io/ | Keeper vault, autofill, sharing, BreachWatch, and troubleshooting | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
| Privacy policy | https://www.keepersecurity.com/privacy.html | Account, vault, monitoring, analytics, and privacy disclosures | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
| Terms | https://www.keepersecurity.com/termsofuse.html | Service, subscriptions, vault, enterprise, and acceptable-use boundaries | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
...
- Manual blockers must remain launch-blocking until verified: account and master password policy, vault zero-knowledge encryption and key derivation, autofill integration behavior, BreachWatch monitoring data sourcing, secure file storage encryption and limits, KeeperChat end-to-end encryption, emergency access trust/timer mechanics, shared folder permission model, role-based enforcement, biometric security model, subscription restore, and enterprise/compliance certifications (SOC 2, ISO 27001).

## Core User Journeys

- User creates or restores a Keeper-style account, completes role, school, subscription, or tenant checks, and reaches the dashboard.
...
- Monetization model: use original free/trial/paid/sponsored/school/provider/tenant entitlement logic; do not copy exact pricing, plan names, bundle names, promotional copy, school contracts, tenant offers, or partner offers from Keeper.
...
- Manual verification tests for account and master password policy, vault zero-knowledge encryption and key derivation, autofill integration behavior, BreachWatch monitoring data sourcing, secure file storage encryption and limits, KeeperChat end-to-end encryption, emergency access trust/timer mechanics, shared folder permission model, role-based enforcement, biometric security model, subscription restore, and enterprise/compliance certifications (SOC 2, ISO 27001).
...
- Phase 4: Add app-specific safety controls for password and secrets management with vault storage, login autofill, password generator, BreachWatch (dark web monitoring), secure file storage, KeeperChat (encrypted messaging), emergency access, shared folders, role-based access, biometric unlock, and personal/family/business plan entitlements.
...
- Confirm legal/privacy retention behavior for Keeper-style sensitive records and update API contracts before downstream implementation.
