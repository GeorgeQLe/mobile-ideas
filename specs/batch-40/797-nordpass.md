# NordPass-Style Clone Spec

> Metadata
> - Inspiration app: NordPass
...
> - Manual verification blockers: account and master password policy, vault XChaCha20 encryption and key derivation, autofill integration behavior, Data Breach Scanner data sourcing, Password Health scoring, passkey creation and authentication flow, sharing permission model, emergency access trust mechanics, biometric security model, subscription restore, and enterprise compliance.
...
Build an original mobile product inspired by NordPass's public cloud files and identity workflow. The V1 clone focuses on password management with vault storage, login autofill, password generator, Data Breach Scanner, Password Health, secure notes, credit card storage, passkey support, sharing, emergency access, biometric unlock, and premium/family/business plan entitlements.
...
- Preserve the functional job behind NordPass while using original product naming, original UI, original sample data, and licensed integrations.
...
- Do not copy NordPass branding, logos, screenshots, marketing copy, private APIs, proprietary datasets, plan names, UI trade dress, course libraries, textbook solutions, documents, school content, AI prompts, or protected media.
...
|---|---|---|---|
| Apple App Store | https://apps.apple.com/us/app/nordpass-password-manager/id1486262998 | iOS listing, privacy labels, release notes, password manager claims, and support links | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
| Google Play | https://play.google.com/store/apps/details?id=com.nordpass.android.app.password.manager | Android listing, data safety, password/passkey claims, and release cadence | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
| Official product site | https://nordpass.com/ | NordPass vault, autofill, breach scanner, passkeys, and product positioning | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
| Official help | https://support.nordpass.com/ | NordPass vault, autofill, sharing, security, and troubleshooting | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
| Privacy policy | https://nordpass.com/privacy-policy/ | Account, vault, breach scanner, analytics, and privacy disclosures | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
| Terms | https://nordpass.com/terms-of-service/ | Service, subscriptions, vault, sharing, and acceptable-use boundaries | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
...
- Manual blockers must remain launch-blocking until verified: account and master password policy, vault XChaCha20 encryption and key derivation, autofill integration behavior, Data Breach Scanner data sourcing, Password Health scoring, passkey creation and authentication flow, sharing permission model, emergency access trust mechanics, biometric security model, subscription restore, and enterprise compliance.

## Core User Journeys

- User creates or restores a NordPass-style account, completes role, school, subscription, or tenant checks, and reaches the dashboard.
...
- Monetization model: use original free/trial/paid/sponsored/school/provider/tenant entitlement logic; do not copy exact pricing, plan names, bundle names, promotional copy, school contracts, tenant offers, or partner offers from NordPass.
...
- Manual verification tests for account and master password policy, vault XChaCha20 encryption and key derivation, autofill integration behavior, Data Breach Scanner data sourcing, Password Health scoring, passkey creation and authentication flow, sharing permission model, emergency access trust mechanics, biometric security model, subscription restore, and enterprise compliance.
...
- Phase 4: Add app-specific safety controls for password management with vault storage, login autofill, password generator, Data Breach Scanner, Password Health, secure notes, credit card storage, passkey support, sharing, emergency access, biometric unlock, and premium/family/business plan entitlements.
...
- Confirm legal/privacy retention behavior for NordPass-style sensitive records and update API contracts before downstream implementation.
