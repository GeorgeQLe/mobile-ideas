# Scanner Pro-Style Clone Spec

> Metadata
> - Inspiration app: Scanner Pro
...
> - Manual verification blockers: Apple-platform-only availability, no first-party Android listing, camera permission and auto-capture accuracy, OCR accuracy and language support, Smart Categories classification fidelity, workflow automation triggers, iCloud sync conflicts, PDF annotation persistence, subscription restore, and platform feature differences.
...
Build an original mobile product inspired by Scanner Pro's public cloud files and identity workflow. The V1 clone focuses on document scanning with auto-capture, edge detection, perspective correction, text recognition (OCR), Smart Categories, workflows (automated export), iCloud sync, PDF annotation, search within scans, share extensions, and subscription entitlements.
...
- Preserve the functional job behind Scanner Pro while using original product naming, original UI, original sample data, and licensed integrations.
...
- Do not copy Scanner Pro branding, logos, screenshots, marketing copy, private APIs, proprietary datasets, plan names, UI trade dress, course libraries, textbook solutions, documents, school content, AI prompts, or protected media.
...
|---|---|---|---|
| Apple App Store | https://apps.apple.com/us/app/scanner-pro-pdf-scanner-app/id333710667 | iOS listing, privacy labels, release notes, scan/OCR/workflow claims, and support links | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
| Google Play | Platform blocker: no verified first-party Google Play listing for Scanner Pro | Android parity is blocked until a first-party listing is verified | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
| Official product site | https://readdle.com/scannerpro | Scanner Pro scanning, OCR, workflows, iCloud, and product positioning | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
| Official help | https://support.readdle.com/scanner-pro | Scanner Pro scanning, OCR, workflows, sync, and troubleshooting | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
| Privacy policy | https://readdle.com/privacy | Scans, iCloud, analytics, and privacy disclosures | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
| Terms | https://readdle.com/terms | Purchase, subscriptions, content, and acceptable-use boundaries | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
...
- Manual blockers must remain launch-blocking until verified: Apple-platform-only availability, no first-party Android listing, camera permission and auto-capture accuracy, OCR accuracy and language support, Smart Categories classification fidelity, workflow automation triggers, iCloud sync conflicts, PDF annotation persistence, subscription restore, and platform feature differences.

## Core User Journeys

- User creates or restores a Scanner Pro-style account, completes role, school, subscription, or tenant checks, and reaches the dashboard.
...
- Monetization model: use original free/trial/paid/sponsored/school/provider/tenant entitlement logic; do not copy exact pricing, plan names, bundle names, promotional copy, school contracts, tenant offers, or partner offers from Scanner Pro.
...
- Manual verification tests for Apple-platform-only availability, no first-party Android listing, camera permission and auto-capture accuracy, OCR accuracy and language support, Smart Categories classification fidelity, workflow automation triggers, iCloud sync conflicts, PDF annotation persistence, subscription restore, and platform feature differences.
...
- Phase 4: Add app-specific safety controls for document scanning with auto-capture, edge detection, perspective correction, text recognition (OCR), Smart Categories, workflows (automated export), iCloud sync, PDF annotation, search within scans, share extensions, and subscription entitlements.
...
- Confirm legal/privacy retention behavior for Scanner Pro-style sensitive records and update API contracts before downstream implementation.
