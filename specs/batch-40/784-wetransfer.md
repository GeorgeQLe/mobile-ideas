# WeTransfer-Style Clone Spec

> Metadata
> - Inspiration app: WeTransfer
...
> - Manual verification blockers: account and transfer policy, file size and expiry enforcement, transfer tracking delivery receipts, portal collaboration behavior, review feedback workflow, paste board rendering, wallpaper/branding customization, subscription restore, and regional compliance.
...
Build an original mobile product inspired by WeTransfer's public cloud files and identity workflow. The V1 clone focuses on large file transfer with up to 2 GB free sends, transfer tracking, contact suggestions, wallpaper customization, portals (shared spaces), reviews (feedback collection), paste (presentation boards), and Pro/Premium plan entitlements.
...
- Preserve the functional job behind WeTransfer while using original product naming, original UI, original sample data, and licensed integrations.
...
- Do not copy WeTransfer branding, logos, screenshots, marketing copy, private APIs, proprietary datasets, plan names, UI trade dress, course libraries, textbook solutions, documents, school content, AI prompts, or protected media.
...
|---|---|---|---|
| Apple App Store | https://apps.apple.com/us/app/wetransfer-send-large-files/id765359021 | iOS listing, privacy labels, release notes, file transfer claims, and support links | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
| Google Play | https://play.google.com/store/apps/details?id=com.wetransfer.app | Android listing, data safety, file transfer/portal claims, and release cadence | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
| Official product site | https://wetransfer.com/ | WeTransfer file sending, portals, reviews, paste, and product positioning | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
| Official help | https://wetransfer.zendesk.com/ | WeTransfer transfers, portals, reviews, accounts, and troubleshooting | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
| Privacy policy | https://wetransfer.com/legal/privacy | Account, transfers, storage, analytics, and privacy disclosures | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
| Terms | https://wetransfer.com/legal/terms | Service, subscriptions, transfers, content, and acceptable-use boundaries | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
...
- Manual blockers must remain launch-blocking until verified: account and transfer policy, file size and expiry enforcement, transfer tracking delivery receipts, portal collaboration behavior, review feedback workflow, paste board rendering, wallpaper/branding customization, subscription restore, and regional compliance.

## Core User Journeys

- User creates or restores a WeTransfer-style account, completes role, school, subscription, or tenant checks, and reaches the dashboard.
...
- Monetization model: use original free/trial/paid/sponsored/school/provider/tenant entitlement logic; do not copy exact pricing, plan names, bundle names, promotional copy, school contracts, tenant offers, or partner offers from WeTransfer.
...
- Manual verification tests for account and transfer policy, file size and expiry enforcement, transfer tracking delivery receipts, portal collaboration behavior, review feedback workflow, paste board rendering, wallpaper/branding customization, subscription restore, and regional compliance.
...
- Phase 4: Add app-specific safety controls for large file transfer with up to 2 GB free sends, transfer tracking, contact suggestions, wallpaper customization, portals (shared spaces), reviews (feedback collection), paste (presentation boards), and Pro/Premium plan entitlements.
...
- Confirm legal/privacy retention behavior for WeTransfer-style sensitive records and update API contracts before downstream implementation.
