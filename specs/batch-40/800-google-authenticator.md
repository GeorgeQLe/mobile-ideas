# Google Authenticator-Style Clone Spec

> Metadata
> - Inspiration app: Google Authenticator
...
> - Manual verification blockers: Google account policy, TOTP/HOTP generation accuracy and time sync, Google Account cloud backup encryption model, QR code scanning accuracy, account transfer QR export security, multi-account token ordering, backup recovery without Google account access, and platform feature differences.
...
Build an original mobile product inspired by Google Authenticator's public cloud files and identity workflow. The V1 clone focuses on two-factor authentication with TOTP and HOTP code generation, QR code scanning for account setup, Google Account cloud sync/backup, token organization, transfer accounts between devices via QR export, and free service model.
...
- Preserve the functional job behind Google Authenticator while using original product naming, original UI, original sample data, and licensed integrations.
...
- Do not copy Google Authenticator branding, logos, screenshots, marketing copy, private APIs, proprietary datasets, plan names, UI trade dress, course libraries, textbook solutions, documents, school content, AI prompts, or protected media.
...
|---|---|---|---|
| Apple App Store | https://apps.apple.com/us/app/google-authenticator/id388497605 | iOS listing, privacy labels, release notes, 2FA claims, and support links | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
| Google Play | https://play.google.com/store/apps/details?id=com.google.android.apps.authenticator2 | Android listing, data safety, 2FA/backup claims, and release cadence | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
| Official product site | https://safety.google/authentication/ | Google Authenticator 2FA, backup, transfer, and product positioning | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
| Official help | https://support.google.com/accounts/answer/1066447 | Google Authenticator setup, transfer, backup, and troubleshooting | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
| Privacy policy | https://policies.google.com/privacy | Google account, cloud, analytics, and privacy disclosures | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
| Terms | https://policies.google.com/terms | Google services, accounts, content, and acceptable-use boundaries | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
...
- Manual blockers must remain launch-blocking until verified: Google account policy, TOTP/HOTP generation accuracy and time sync, Google Account cloud backup encryption model, QR code scanning accuracy, account transfer QR export security, multi-account token ordering, backup recovery without Google account access, and platform feature differences.

## Core User Journeys

- User creates or restores a Google Authenticator-style account, completes role, school, subscription, or tenant checks, and reaches the dashboard.
...
- Monetization model: use original free/trial/paid/sponsored/school/provider/tenant entitlement logic; do not copy exact pricing, plan names, bundle names, promotional copy, school contracts, tenant offers, or partner offers from Google Authenticator.
...
- Manual verification tests for Google account policy, TOTP/HOTP generation accuracy and time sync, Google Account cloud backup encryption model, QR code scanning accuracy, account transfer QR export security, multi-account token ordering, backup recovery without Google account access, and platform feature differences.
...
- Phase 4: Add app-specific safety controls for two-factor authentication with TOTP and HOTP code generation, QR code scanning for account setup, Google Account cloud sync/backup, token organization, transfer accounts between devices via QR export, and free service model.
...
- Confirm legal/privacy retention behavior for Google Authenticator-style sensitive records and update API contracts before downstream implementation.
