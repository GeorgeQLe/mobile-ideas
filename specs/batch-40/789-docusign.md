# DocuSign-Style Clone Spec

> Metadata
> - Inspiration app: DocuSign
...
> - Manual verification blockers: account and enterprise policy, e-sign legal validity across jurisdictions, envelope routing and notification delivery, signing field placement accuracy, in-person signing security, template management mobile parity, audit trail completeness, cloud integration authentication, subscription restore, and compliance certifications (eIDAS, UETA, ESIGN).
...
Build an original mobile product inspired by DocuSign's public cloud files and identity workflow. The V1 clone focuses on electronic signature with envelope creation, document upload, recipient routing, signing fields (signature, initials, date, text), in-person signing, template management, signing status tracking, audit trail, cloud storage integrations, and paid plan entitlements.
...
- Preserve the functional job behind DocuSign while using original product naming, original UI, original sample data, and licensed integrations.
...
- Do not copy DocuSign branding, logos, screenshots, marketing copy, private APIs, proprietary datasets, plan names, UI trade dress, course libraries, textbook solutions, documents, school content, AI prompts, or protected media.
...
|---|---|---|---|
| Apple App Store | https://apps.apple.com/us/app/docusign-upload-sign-docs/id474990205 | iOS listing, privacy labels, release notes, e-sign claims, and support links | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
| Google Play | https://play.google.com/store/apps/details?id=com.docusign.ink | Android listing, data safety, e-sign/envelope claims, and release cadence | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
| Official product site | https://www.docusign.com/ | DocuSign e-signature, envelopes, templates, integrations, and product positioning | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
| Official help | https://support.docusign.com/ | DocuSign signing, envelopes, templates, integrations, and troubleshooting | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
| Privacy policy | https://www.docusign.com/company/privacy-policy | Account, documents, signing, analytics, enterprise, and privacy disclosures | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
| Terms | https://www.docusign.com/company/terms-and-conditions | Service, subscriptions, signing, enterprise, and acceptable-use boundaries | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
...
- Manual blockers must remain launch-blocking until verified: account and enterprise policy, e-sign legal validity across jurisdictions, envelope routing and notification delivery, signing field placement accuracy, in-person signing security, template management mobile parity, audit trail completeness, cloud integration authentication, subscription restore, and compliance certifications (eIDAS, UETA, ESIGN).

## Core User Journeys

- User creates or restores a DocuSign-style account, completes role, school, subscription, or tenant checks, and reaches the dashboard.
...
|---|---|---|---|---|
| Welcome/Auth | Account creation, cloud connection, permissions primer, and consent entry | email, SSO, permission, restore | new, returning, connected, locked | SSO failed, permission denied, region unavailable |
| Camera/Capture | Document capture with auto-detection, edge overlay, manual crop, and batch mode | capture, crop, batch, retake | preview, detecting, captured, processing | low light, blur, edge missed, camera denied |
| Edit/Enhance | Perspective correction, filters, rotation, reorder pages, and OCR processing | filter, rotate, reorder, OCR | raw, enhanced, OCR-complete, failed | OCR language unsupported, image corrupt, processing timeout |
| Document Library | Scanned documents, folders, search within OCR text, and recent items | tap, search, organize, select | empty, loading, current, offline | sync conflict, storage full, file corrupt |
| Export/Share | PDF/JPEG export, cloud upload, email, print, e-sign, and fax sending | export, upload, email, sign | draft, exported, sent, signed | export failed, cloud auth expired, format error |
| Settings/Privacy | Account, cloud connections, OCR language, storage, subscription, privacy, support, deletion | forms, restore, links, request | loaded, editing, requested | active subscription, cloud disconnected, data retention |
...
- Monetization model: use original free/trial/paid/sponsored/school/provider/tenant entitlement logic; do not copy exact pricing, plan names, bundle names, promotional copy, school contracts, tenant offers, or partner offers from DocuSign.
...
- Manual verification tests for account and enterprise policy, e-sign legal validity across jurisdictions, envelope routing and notification delivery, signing field placement accuracy, in-person signing security, template management mobile parity, audit trail completeness, cloud integration authentication, subscription restore, and compliance certifications (eIDAS, UETA, ESIGN).
...
- Phase 4: Add app-specific safety controls for electronic signature with envelope creation, document upload, recipient routing, signing fields (signature, initials, date, text), in-person signing, template management, signing status tracking, audit trail, cloud storage integrations, and paid plan entitlements.
...
- Confirm legal/privacy retention behavior for DocuSign-style sensitive records and update API contracts before downstream implementation.
