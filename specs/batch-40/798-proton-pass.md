# Proton Pass-Style Clone Spec

> Metadata
> - Inspiration app: Proton Pass
...
> - Manual verification blockers: Proton account and encryption policy, vault end-to-end encryption and key sharing, autofill integration behavior, email alias generation and forwarding infrastructure, Proton Sentinel protection mechanics, integrated 2FA/TOTP accuracy, passkey creation and authentication flow, sharing permission model, subscription restore, and Proton ecosystem integration (Mail, VPN, Drive, Calendar).
...
Build an original mobile product inspired by Proton Pass's public cloud files and identity workflow. The V1 clone focuses on end-to-end encrypted password management with vault storage, login autofill, password generator, email aliases (hide-my-email), secure notes, credit card storage, passkey support, Proton Sentinel (account protection), integrated 2FA/TOTP, sharing, and free/paid plan entitlements.
...
- Preserve the functional job behind Proton Pass while using original product naming, original UI, original sample data, and licensed integrations.
...
- Do not copy Proton Pass branding, logos, screenshots, marketing copy, private APIs, proprietary datasets, plan names, UI trade dress, course libraries, textbook solutions, documents, school content, AI prompts, or protected media.
...
|---|---|---|---|
| Apple App Store | https://apps.apple.com/us/app/proton-pass-password-manager/id6443490629 | iOS listing, privacy labels, release notes, encrypted password manager claims, and support links | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
| Google Play | https://play.google.com/store/apps/details?id=proton.android.pass | Android listing, data safety, encrypted password/alias claims, and release cadence | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
| Official product site | https://proton.me/pass | Proton Pass encrypted vault, aliases, 2FA, sharing, and product positioning | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
| Official help | https://proton.me/support/pass | Proton Pass vault, autofill, aliases, sharing, and troubleshooting | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
| Privacy policy | https://proton.me/legal/privacy | Proton account, encryption, analytics, and privacy disclosures | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
| Terms | https://proton.me/legal/terms | Proton services, subscriptions, encryption, and acceptable-use boundaries | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
...
- Manual blockers must remain launch-blocking until verified: Proton account and encryption policy, vault end-to-end encryption and key sharing, autofill integration behavior, email alias generation and forwarding infrastructure, Proton Sentinel protection mechanics, integrated 2FA/TOTP accuracy, passkey creation and authentication flow, sharing permission model, subscription restore, and Proton ecosystem integration (Mail, VPN, Drive, Calendar).

## Core User Journeys

- User creates or restores a Proton Pass-style account, completes role, school, subscription, or tenant checks, and reaches the dashboard.
...
- Monetization model: use original free/trial/paid/sponsored/school/provider/tenant entitlement logic; do not copy exact pricing, plan names, bundle names, promotional copy, school contracts, tenant offers, or partner offers from Proton Pass.
...
- Manual verification tests for Proton account and encryption policy, vault end-to-end encryption and key sharing, autofill integration behavior, email alias generation and forwarding infrastructure, Proton Sentinel protection mechanics, integrated 2FA/TOTP accuracy, passkey creation and authentication flow, sharing permission model, subscription restore, and Proton ecosystem integration (Mail, VPN, Drive, Calendar).
...
- Phase 4: Add app-specific safety controls for end-to-end encrypted password management with vault storage, login autofill, password generator, email aliases (hide-my-email), secure notes, credit card storage, passkey support, Proton Sentinel (account protection), integrated 2FA/TOTP, sharing, and free/paid plan entitlements.
...
- Confirm legal/privacy retention behavior for Proton Pass-style sensitive records and update API contracts before downstream implementation.
