# Best Buy-Style Clone Spec

> Metadata
> - Inspiration app: Best Buy
...
Build an original mobile product inspired by Best Buy's public product and policy materials. V1 focuses on electronics catalog search, product details, store inventory, curbside pickup, delivery, marketplace seller disclosure, membership deals, price-match support, returns, reviews, and service appointments. The clone must use original branding, original UI copy, original sample data, licensed providers, and explicit disclosures when a feature is inferred from public materials rather than verified hands-on behavior.
...
- Support electronics catalog search, product details, store inventory, curbside pickup, delivery, marketplace seller disclosure, membership deals, price-match support, returns, reviews, and service appointments with clear retry, recovery, unavailable, region, entitlement, inventory, seller, and provider-aware states.
...
- Do not imply affiliation with Best Buy or its publisher.
...
|---|---|---|---|
| Official product | https://www.bestbuy.com/ | Public product positioning, shopping, delivery, catalog, marketplace, membership, account, and app behavior | Verified 2026-05-04 |
| Support/help center | https://www.bestbuy.com/site/help-topics/customer-service/pcmcat87800050001.c | Public support taxonomy for account, ordering, payment, pickup, shipping, returns, seller, loyalty, troubleshooting, and deletion/export flows | Verified 2026-05-04 |
| Privacy policy | https://www.bestbuy.com/site/help-topics/privacy-policy/pcmcat204400050062.c | Account, profile, order, listing, location, device, advertising, analytics, support, seller, and user-rights handling | Verified 2026-05-04 |
| Terms of service | https://www.bestbuy.com/site/help-topics/conditions-of-use/pcmcat204400050067.c | Service usage, licensed content, payments, returns, marketplace conduct, seller/buyer limits, prohibited goods, and legal boundaries | Verified 2026-05-04 |
| Rewards, membership, or seller program | https://www.bestbuy.com/site/memberships/my-best-buy-memberships/pcmcat1679668710293.c | Reward, membership, loyalty, seller, service, authenticity, or entitlement orientation where public | Verified 2026-05-04 |
| App Store listing | https://apps.apple.com/us/app/best-buy-shop-tech-deals/id314855255 | Canonical iOS listing, category, age rating, privacy label, compatibility, public feature claims, and native metadata | Verified 2026-05-04 |
| Google Play listing | https://play.google.com/store/apps/details?id=com.bestbuy.android | Canonical Android listing, feature blurbs, content rating, data safety, downloads, and native metadata | Verified 2026-05-04 |
...
- electronics catalog search, product details, store inventory, curbside pickup, delivery, marketplace seller disclosure, membership deals, price-match support, returns, reviews, and service appointments must be treated as launch-blocking behavior with owners, mitigations, acceptance tests, and manual-verification notes.
- inventory/price freshness, product sizing, launch/drop fairness, membership eligibility, coupon/loyalty correctness, store pickup, shipping, returns, review abuse, sustainability/claim substantiation, and support escalation must be treated as a launch-blocking risk area with owner, mitigation, and acceptance tests.
...
- `User`: owner, lifecycle state, authorization boundary, sync state, retention policy, deletion/export behavior, and audit metadata for Best Buy-inspired workflows.
- `AccountSession`: owner, lifecycle state, authorization boundary, sync state, retention policy, deletion/export behavior, and audit metadata for Best Buy-inspired workflows.
- `Store`: owner, lifecycle state, authorization boundary, sync state, retention policy, deletion/export behavior, and audit metadata for Best Buy-inspired workflows.
- `Address`: owner, lifecycle state, authorization boundary, sync state, retention policy, deletion/export behavior, and audit metadata for Best Buy-inspired workflows.
- `Product`: owner, lifecycle state, authorization boundary, sync state, retention policy, deletion/export behavior, and audit metadata for Best Buy-inspired workflows.
- `ProductVariant`: owner, lifecycle state, authorization boundary, sync state, retention policy, deletion/export behavior, and audit metadata for Best Buy-inspired workflows.
- `InventorySnapshot`: owner, lifecycle state, authorization boundary, sync state, retention policy, deletion/export behavior, and audit metadata for Best Buy-inspired workflows.
- `PriceOffer`: owner, lifecycle state, authorization boundary, sync state, retention policy, deletion/export behavior, and audit metadata for Best Buy-inspired workflows.
- `LoyaltyAccount`: owner, lifecycle state, authorization boundary, sync state, retention policy, deletion/export behavior, and audit metadata for Best Buy-inspired workflows.
- `Wishlist`: owner, lifecycle state, authorization boundary, sync state, retention policy, deletion/export behavior, and audit metadata for Best Buy-inspired workflows.
- `Cart`: owner, lifecycle state, authorization boundary, sync state, retention policy, deletion/export behavior, and audit metadata for Best Buy-inspired workflows.
- `PaymentInstrument`: owner, lifecycle state, authorization boundary, sync state, retention policy, deletion/export behavior, and audit metadata for Best Buy-inspired workflows.
- `Order`: owner, lifecycle state, authorization boundary, sync state, retention policy, deletion/export behavior, and audit metadata for Best Buy-inspired workflows.
- `Fulfillment`: owner, lifecycle state, authorization boundary, sync state, retention policy, deletion/export behavior, and audit metadata for Best Buy-inspired workflows.
- `ReturnCase`: owner, lifecycle state, authorization boundary, sync state, retention policy, deletion/export behavior, and audit metadata for Best Buy-inspired workflows.
- `Review`: owner, lifecycle state, authorization boundary, sync state, retention policy, deletion/export behavior, and audit metadata for Best Buy-inspired workflows.
- `ServiceAppointment`: owner, lifecycle state, authorization boundary, sync state, retention policy, deletion/export behavior, and audit metadata for Best Buy-inspired workflows.
- `AuditEvent`: owner, lifecycle state, authorization boundary, sync state, retention policy, deletion/export behavior, and audit metadata for Best Buy-inspired workflows.
- `LocalCacheRecord`: owner, lifecycle state, authorization boundary, sync state, retention policy, deletion/export behavior, and audit metadata for Best Buy-inspired workflows.
...
- Public API documentation must use original route names and domain models; never mimic private endpoint paths, request bodies, or proprietary provider schemas from Best Buy.
