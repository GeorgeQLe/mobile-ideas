# Habitica-Style Clone Spec

> Metadata
> - Inspiration app: Habitica
...
> - Manual verification blockers: account and sync policy, party/guild real-time behavior, quest damage mechanics, class balance, pet/mount collection state, challenge participation, gems/gold economy, subscription restore, child safety for gamification, and community moderation.
...
Build an original mobile product inspired by Habitica's public tasks and project management workflow. The V1 clone focuses on gamified task management with habits, dailies, to-dos, rewards, avatar customization, pet/mount collection, party quests, guilds, challenges, class system, and subscription entitlements.
...
- Preserve the functional job behind Habitica while using original product naming, original UI, original sample data, and licensed integrations.
...
- Do not copy Habitica branding, logos, screenshots, marketing copy, private APIs, proprietary datasets, plan names, UI trade dress, course libraries, textbook solutions, documents, school content, AI prompts, or protected media.
...
|---|---|---|---|
| Apple App Store | https://apps.apple.com/us/app/habitica-gamified-taskmanager/id994882113 | iOS listing, privacy labels, release notes, gamified task claims, and support links | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
| Google Play | https://play.google.com/store/apps/details?id=com.habitrpg.android.habitica | Android listing, data safety, gamified habit/task claims, and release cadence | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
| Official product site | https://habitica.com/ | Habitica gamified habits, tasks, avatar, social features, and product positioning | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
| Official help | https://habitica.fandom.com/wiki/Habitica_Wiki | Habitica wiki, tasks, classes, quests, guilds, economy, and troubleshooting | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
| Privacy policy | https://habitica.com/static/privacy | Account, content, social, analytics, and privacy disclosures | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
| Terms | https://habitica.com/static/terms | Service, subscriptions, content, community, and acceptable-use boundaries | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
...
- Manual blockers must remain launch-blocking until verified: account and sync policy, party/guild real-time behavior, quest damage mechanics, class balance, pet/mount collection state, challenge participation, gems/gold economy, subscription restore, child safety for gamification, and community moderation.

## Core User Journeys

- User creates or restores a Habitica-style account, completes role, school, subscription, or tenant checks, and reaches the dashboard.
...
- Monetization model: use original free/trial/paid/sponsored/school/provider/tenant entitlement logic; do not copy exact pricing, plan names, bundle names, promotional copy, school contracts, tenant offers, or partner offers from Habitica.
...
- Manual verification tests for account and sync policy, party/guild real-time behavior, quest damage mechanics, class balance, pet/mount collection state, challenge participation, gems/gold economy, subscription restore, child safety for gamification, and community moderation.
...
- Phase 4: Add app-specific safety controls for gamified task management with habits, dailies, to-dos, rewards, avatar customization, pet/mount collection, party quests, guilds, challenges, class system, and subscription entitlements.
...
- Confirm legal/privacy retention behavior for Habitica-style sensitive records and update API contracts before downstream implementation.
