# Monday.com-Style Clone Spec

> Metadata
> - Inspiration app: Monday.com
...
> - Manual verification blockers: account and workspace policy, automation execution behavior, integration permissions, board sync conflicts, workdoc mobile parity, timeline/Gantt rendering, guest access, sharing/permission states, subscription restore, and regional compliance.
...
Build an original mobile product inspired by Monday.com's public tasks and project management workflow. The V1 clone focuses on work management boards, items, timelines, dashboards, automations, integrations, workdocs, forms, Kanban, Gantt, calendar views, team collaboration, notifications, and paid plan entitlements.
...
- Preserve the functional job behind Monday.com while using original product naming, original UI, original sample data, and licensed integrations.
...
- Do not copy Monday.com branding, logos, screenshots, marketing copy, private APIs, proprietary datasets, plan names, UI trade dress, course libraries, textbook solutions, documents, school content, AI prompts, or protected media.
...
|---|---|---|---|
| Apple App Store | https://apps.apple.com/us/app/monday-com-work-management/id1290128888 | iOS listing, privacy labels, release notes, work management claims, and support links | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
| Google Play | https://play.google.com/store/apps/details?id=com.monday.monday | Android listing, data safety, board/automation claims, and release cadence | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
| Official product site | https://monday.com/ | Monday.com boards, automations, dashboards, integrations, and product positioning | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
| Official help | https://support.monday.com/ | Monday.com boards, items, automations, views, sharing, and troubleshooting | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
| Privacy policy | https://monday.com/privacy/privacy-policy | Account, content, workspace, analytics, integrations, and privacy disclosures | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
| Terms | https://monday.com/terms/tos | Service, subscriptions, content, workspaces, and acceptable-use boundaries | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
...
- Manual blockers must remain launch-blocking until verified: account and workspace policy, automation execution behavior, integration permissions, board sync conflicts, workdoc mobile parity, timeline/Gantt rendering, guest access, sharing/permission states, subscription restore, and regional compliance.

## Core User Journeys

- User creates or restores a Monday.com-style account, completes role, school, subscription, or tenant checks, and reaches the dashboard.
...
- Monetization model: use original free/trial/paid/sponsored/school/provider/tenant entitlement logic; do not copy exact pricing, plan names, bundle names, promotional copy, school contracts, tenant offers, or partner offers from Monday.com.
...
- Manual verification tests for account and workspace policy, automation execution behavior, integration permissions, board sync conflicts, workdoc mobile parity, timeline/Gantt rendering, guest access, sharing/permission states, subscription restore, and regional compliance.
...
- Phase 4: Add app-specific safety controls for work management boards, items, timelines, dashboards, automations, integrations, workdocs, forms, Kanban, Gantt, calendar views, team collaboration, notifications, and paid plan entitlements.
...
- Confirm legal/privacy retention behavior for Monday.com-style sensitive records and update API contracts before downstream implementation.
