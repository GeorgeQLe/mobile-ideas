# Remember The Milk-Style Clone Spec

> Metadata
> - Inspiration app: Remember The Milk
...
> - Manual verification blockers: account and sync policy, smart list query syntax, location-based reminder permissions, sharing/delegation behavior, integration token management, repeat pattern parsing, offline sync conflicts, subscription restore, and platform feature differences.
...
Build an original mobile product inspired by Remember The Milk's public tasks and project management workflow. The V1 clone focuses on smart task lists, tags, priorities, due dates, repeat patterns, smart lists with search operators, location-based reminders, sharing, subtasks, notes, integrations, and Pro plan entitlements.
...
- Preserve the functional job behind Remember The Milk while using original product naming, original UI, original sample data, and licensed integrations.
...
- Do not copy Remember The Milk branding, logos, screenshots, marketing copy, private APIs, proprietary datasets, plan names, UI trade dress, course libraries, textbook solutions, documents, school content, AI prompts, or protected media.
...
|---|---|---|---|
| Apple App Store | https://apps.apple.com/us/app/remember-the-milk-to-do-list/id293561396 | iOS listing, privacy labels, release notes, task/smart list claims, and support links | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
| Google Play | https://play.google.com/store/apps/details?id=com.rememberthemilk.MobileRTM | Android listing, data safety, task/reminder claims, and release cadence | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
| Official product site | https://www.rememberthemilk.com/ | Remember The Milk tasks, smart lists, reminders, and product positioning | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
| Official help | https://www.rememberthemilk.com/help/ | RTM tasks, lists, reminders, sharing, integrations, and troubleshooting | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
| Privacy policy | https://www.rememberthemilk.com/help/privacy.rtm | Account, content, sync, analytics, and privacy disclosures | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
| Terms | https://www.rememberthemilk.com/help/terms.rtm | Service, subscriptions, content, and acceptable-use boundaries | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
...
- Manual blockers must remain launch-blocking until verified: account and sync policy, smart list query syntax, location-based reminder permissions, sharing/delegation behavior, integration token management, repeat pattern parsing, offline sync conflicts, subscription restore, and platform feature differences.

## Core User Journeys

- User creates or restores a Remember The Milk-style account, completes role, school, subscription, or tenant checks, and reaches the dashboard.
...
- Monetization model: use original free/trial/paid/sponsored/school/provider/tenant entitlement logic; do not copy exact pricing, plan names, bundle names, promotional copy, school contracts, tenant offers, or partner offers from Remember The Milk.
...
- Manual verification tests for account and sync policy, smart list query syntax, location-based reminder permissions, sharing/delegation behavior, integration token management, repeat pattern parsing, offline sync conflicts, subscription restore, and platform feature differences.
...
- Phase 4: Add app-specific safety controls for smart task lists, tags, priorities, due dates, repeat patterns, smart lists with search operators, location-based reminders, sharing, subtasks, notes, integrations, and Pro plan entitlements.
...
- Confirm legal/privacy retention behavior for Remember The Milk-style sensitive records and update API contracts before downstream implementation.
