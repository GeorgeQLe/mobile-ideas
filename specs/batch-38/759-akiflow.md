# Akiflow-Style Clone Spec

> Metadata
> - Inspiration app: Akiflow
...
> - Manual verification blockers: account and workspace policy, calendar integration behavior, third-party task import token management, command bar mobile parity, time-blocking accuracy, notification aggregation, subscription restore, integration availability, and platform feature differences.
...
Build an original mobile product inspired by Akiflow's public tasks and project management workflow. The V1 clone focuses on unified task inbox with calendar time-blocking, command bar, task imports from Todoist/Asana/Jira/Linear/Notion/Slack/Gmail/GitHub, daily planning, recurring tasks, and subscription entitlements.
...
- Preserve the functional job behind Akiflow while using original product naming, original UI, original sample data, and licensed integrations.
...
- Do not copy Akiflow branding, logos, screenshots, marketing copy, private APIs, proprietary datasets, plan names, UI trade dress, course libraries, textbook solutions, documents, school content, AI prompts, or protected media.
...
|---|---|---|---|
| Apple App Store | https://apps.apple.com/us/app/akiflow-time-blocking-tasks/id1610705528 | iOS listing, privacy labels, release notes, task/calendar claims, and support links | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
| Google Play | https://play.google.com/store/apps/details?id=com.akiflow.android | Android listing, data safety, task/time-blocking claims, and release cadence | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
| Official product site | https://akiflow.com/ | Akiflow task inbox, time blocking, integrations, and product positioning | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
| Official help | https://help.akiflow.com/ | Akiflow tasks, calendar, integrations, planning, and troubleshooting | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
| Privacy policy | https://akiflow.com/privacy-policy | Account, content, integrations, analytics, and privacy disclosures | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
| Terms | https://akiflow.com/terms-of-service | Service, subscriptions, content, and acceptable-use boundaries | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
...
- Manual blockers must remain launch-blocking until verified: account and workspace policy, calendar integration behavior, third-party task import token management, command bar mobile parity, time-blocking accuracy, notification aggregation, subscription restore, integration availability, and platform feature differences.

## Core User Journeys

- User creates or restores a Akiflow-style account, completes role, school, subscription, or tenant checks, and reaches the dashboard.
...
- Monetization model: use original free/trial/paid/sponsored/school/provider/tenant entitlement logic; do not copy exact pricing, plan names, bundle names, promotional copy, school contracts, tenant offers, or partner offers from Akiflow.
...
- Manual verification tests for account and workspace policy, calendar integration behavior, third-party task import token management, command bar mobile parity, time-blocking accuracy, notification aggregation, subscription restore, integration availability, and platform feature differences.
...
- Phase 4: Add app-specific safety controls for unified task inbox with calendar time-blocking, command bar, task imports from Todoist/Asana/Jira/Linear/Notion/Slack/Gmail/GitHub, daily planning, recurring tasks, and subscription entitlements.
...
- Confirm legal/privacy retention behavior for Akiflow-style sensitive records and update API contracts before downstream implementation.
