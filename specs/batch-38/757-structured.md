# Structured-Style Clone Spec

> Metadata
> - Inspiration app: Structured
...
> - Manual verification blockers: account and iCloud sync policy, calendar integration behavior, timeline rendering accuracy, recurring routine scheduling, widget rendering, reminder delivery, offline sync conflicts, subscription restore, and platform feature differences.
...
Build an original mobile product inspired by Structured's public tasks and project management workflow. The V1 clone focuses on visual daily planner with timeline view, tasks, routines, calendar integration, reminders, subtasks, recurring plans, widgets, iCloud sync, and Pro plan entitlements.
...
- Preserve the functional job behind Structured while using original product naming, original UI, original sample data, and licensed integrations.
...
- Do not copy Structured branding, logos, screenshots, marketing copy, private APIs, proprietary datasets, plan names, UI trade dress, course libraries, textbook solutions, documents, school content, AI prompts, or protected media.
...
|---|---|---|---|
| Apple App Store | https://apps.apple.com/us/app/structured-daily-planner/id1499198946 | iOS listing, privacy labels, release notes, planner/timeline claims, and support links | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
| Google Play | https://play.google.com/store/apps/details?id=com.structured.app | Android listing, data safety, planner/routine claims, and release cadence | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
| Official product site | https://structured.app/ | Structured daily planner, timeline, routines, and product positioning | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
| Official help | https://structured.app/support/ | Structured planner, tasks, calendar, sync, and troubleshooting | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
| Privacy policy | https://structured.app/privacy/ | Account, content, iCloud, analytics, and privacy disclosures | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
| Terms | https://structured.app/terms/ | Service, subscriptions, content, and acceptable-use boundaries | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
...
- Manual blockers must remain launch-blocking until verified: account and iCloud sync policy, calendar integration behavior, timeline rendering accuracy, recurring routine scheduling, widget rendering, reminder delivery, offline sync conflicts, subscription restore, and platform feature differences.

## Core User Journeys

- User creates or restores a Structured-style account, completes role, school, subscription, or tenant checks, and reaches the dashboard.
...
- Monetization model: use original free/trial/paid/sponsored/school/provider/tenant entitlement logic; do not copy exact pricing, plan names, bundle names, promotional copy, school contracts, tenant offers, or partner offers from Structured.
...
- Manual verification tests for account and iCloud sync policy, calendar integration behavior, timeline rendering accuracy, recurring routine scheduling, widget rendering, reminder delivery, offline sync conflicts, subscription restore, and platform feature differences.
...
- Phase 4: Add app-specific safety controls for visual daily planner with timeline view, tasks, routines, calendar integration, reminders, subtasks, recurring plans, widgets, iCloud sync, and Pro plan entitlements.
...
- Confirm legal/privacy retention behavior for Structured-style sensitive records and update API contracts before downstream implementation.
