# Streaks-Style Clone Spec

> Metadata
> - Inspiration app: Streaks
...
> - Manual verification blockers: Apple-platform-only availability, no first-party Android listing, Apple Health integration permissions, Shortcuts/automation behavior, widget/complication rendering, streak calculation on missed days, iCloud sync conflicts, purchase restore, and platform feature differences.
...
Build an original mobile product inspired by Streaks's public tasks and project management workflow. The V1 clone focuses on daily habit tracking with up to 24 tasks, streak counters, flexible scheduling, Apple Health integration, Shortcuts support, widgets, Apple Watch complications, themes, and one-time purchase model.
...
- Preserve the functional job behind Streaks while using original product naming, original UI, original sample data, and licensed integrations.
...
- Do not copy Streaks branding, logos, screenshots, marketing copy, private APIs, proprietary datasets, plan names, UI trade dress, course libraries, textbook solutions, documents, school content, AI prompts, or protected media.
...
|---|---|---|---|
| Apple App Store | https://apps.apple.com/us/app/streaks/id963034692 | iOS listing, privacy labels, release notes, habit/streak claims, and support links | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
| Google Play | Platform blocker: no verified first-party Google Play listing for Streaks | Android parity is blocked until a first-party listing is verified | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
| Official product site | https://streaksapp.com/ | Streaks daily habits, Apple Health, widgets, and product positioning | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
| Official help | https://streaksapp.com/help/ | Streaks habits, scheduling, Health, widgets, sync, and troubleshooting | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
| Privacy policy | https://streaksapp.com/privacy/ | Content, Health data, iCloud, analytics, and privacy disclosures | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
| Terms | https://streaksapp.com/terms/ | Purchase, content, and acceptable-use boundaries | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
...
- Manual blockers must remain launch-blocking until verified: Apple-platform-only availability, no first-party Android listing, Apple Health integration permissions, Shortcuts/automation behavior, widget/complication rendering, streak calculation on missed days, iCloud sync conflicts, purchase restore, and platform feature differences.

## Core User Journeys

- User creates or restores a Streaks-style account, completes role, school, subscription, or tenant checks, and reaches the dashboard.
...
- Monetization model: use original free/trial/paid/sponsored/school/provider/tenant entitlement logic; do not copy exact pricing, plan names, bundle names, promotional copy, school contracts, tenant offers, or partner offers from Streaks.
...
- Manual verification tests for Apple-platform-only availability, no first-party Android listing, Apple Health integration permissions, Shortcuts/automation behavior, widget/complication rendering, streak calculation on missed days, iCloud sync conflicts, purchase restore, and platform feature differences.
...
- Phase 4: Add app-specific safety controls for daily habit tracking with up to 24 tasks, streak counters, flexible scheduling, Apple Health integration, Shortcuts support, widgets, Apple Watch complications, themes, and one-time purchase model.
...
- Confirm legal/privacy retention behavior for Streaks-style sensitive records and update API contracts before downstream implementation.
