# Wrike-Style Clone Spec

> Metadata
> - Inspiration app: Wrike
...
> - Manual verification blockers: account and workspace policy, Gantt chart mobile rendering, proofing/annotation mobile parity, automation execution, cross-tagging behavior, custom field types, time tracking accuracy, guest access, subscription restore, and tenant/SSO compliance.
...
Build an original mobile product inspired by Wrike's public tasks and project management workflow. The V1 clone focuses on work management with tasks, folders, projects, Gantt charts, dashboards, request forms, time tracking, proofing, automations, cross-tagging, custom workflows, and enterprise plan entitlements.
...
- Preserve the functional job behind Wrike while using original product naming, original UI, original sample data, and licensed integrations.
...
- Do not copy Wrike branding, logos, screenshots, marketing copy, private APIs, proprietary datasets, plan names, UI trade dress, course libraries, textbook solutions, documents, school content, AI prompts, or protected media.
...
|---|---|---|---|
| Apple App Store | https://apps.apple.com/us/app/wrike-manage-projects-work/id890000607 | iOS listing, privacy labels, release notes, project management claims, and support links | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
| Google Play | https://play.google.com/store/apps/details?id=com.wrike | Android listing, data safety, task/project claims, and release cadence | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
| Official product site | https://www.wrike.com/ | Wrike project management, Gantt, dashboards, automations, and product positioning | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
| Official help | https://help.wrike.com/ | Wrike tasks, projects, views, automations, sharing, and troubleshooting | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
| Privacy policy | https://www.wrike.com/privacy/ | Account, content, workspace, analytics, enterprise, and privacy disclosures | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
| Terms | https://www.wrike.com/terms/ | Service, subscriptions, content, workspaces, enterprise, and acceptable-use boundaries | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
...
- Manual blockers must remain launch-blocking until verified: account and workspace policy, Gantt chart mobile rendering, proofing/annotation mobile parity, automation execution, cross-tagging behavior, custom field types, time tracking accuracy, guest access, subscription restore, and tenant/SSO compliance.

## Core User Journeys

- User creates or restores a Wrike-style account, completes role, school, subscription, or tenant checks, and reaches the dashboard.
...
- Monetization model: use original free/trial/paid/sponsored/school/provider/tenant entitlement logic; do not copy exact pricing, plan names, bundle names, promotional copy, school contracts, tenant offers, or partner offers from Wrike.
...
- Manual verification tests for account and workspace policy, Gantt chart mobile rendering, proofing/annotation mobile parity, automation execution, cross-tagging behavior, custom field types, time tracking accuracy, guest access, subscription restore, and tenant/SSO compliance.
...
- Phase 4: Add app-specific safety controls for work management with tasks, folders, projects, Gantt charts, dashboards, request forms, time tracking, proofing, automations, cross-tagging, custom workflows, and enterprise plan entitlements.
...
- Confirm legal/privacy retention behavior for Wrike-style sensitive records and update API contracts before downstream implementation.
