# OmniFocus-Style Clone Spec

> Metadata
> - Inspiration app: OmniFocus
...
> - Manual verification blockers: Apple-platform-only availability, no first-party Android listing, OmniSync server behavior, Shortcuts/automation behavior, perspective custom views, review cycle state, subscription/license restore, iCloud conflicts, and platform feature differences.
...
Build an original mobile product inspired by OmniFocus's public tasks and project management workflow. The V1 clone focuses on GTD-style task management with inbox, projects, contexts/tags, perspectives, forecast, review, defer/due dates, repeating tasks, OmniSync, Shortcuts integration, and Pro upgrade entitlements.
...
- Preserve the functional job behind OmniFocus while using original product naming, original UI, original sample data, and licensed integrations.
...
- Do not copy OmniFocus branding, logos, screenshots, marketing copy, private APIs, proprietary datasets, plan names, UI trade dress, course libraries, textbook solutions, documents, school content, AI prompts, or protected media.
...
|---|---|---|---|
| Apple App Store | https://apps.apple.com/us/app/omnifocus-4/id1542143627 | iOS listing, privacy labels, release notes, GTD/task claims, and support links | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
| Google Play | Platform blocker: no verified first-party Google Play listing for OmniFocus | Android parity is blocked until a first-party listing is verified | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
| Official product site | https://www.omnigroup.com/omnifocus/ | OmniFocus GTD, projects, perspectives, sync, and product positioning | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
| Official help | https://support.omnigroup.com/omnifocus/ | OmniFocus setup, tasks, projects, sync, perspectives, and troubleshooting | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
| Privacy policy | https://www.omnigroup.com/privacy/ | Account, sync, analytics, and privacy disclosures | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
| Terms | https://www.omnigroup.com/terms/ | Service, subscriptions, licenses, content, and acceptable-use boundaries | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
...
- Manual blockers must remain launch-blocking until verified: Apple-platform-only availability, no first-party Android listing, OmniSync server behavior, Shortcuts/automation behavior, perspective custom views, review cycle state, subscription/license restore, iCloud conflicts, and platform feature differences.

## Core User Journeys

- User creates or restores a OmniFocus-style account, completes role, school, subscription, or tenant checks, and reaches the dashboard.
...
- Monetization model: use original free/trial/paid/sponsored/school/provider/tenant entitlement logic; do not copy exact pricing, plan names, bundle names, promotional copy, school contracts, tenant offers, or partner offers from OmniFocus.
...
- Manual verification tests for Apple-platform-only availability, no first-party Android listing, OmniSync server behavior, Shortcuts/automation behavior, perspective custom views, review cycle state, subscription/license restore, iCloud conflicts, and platform feature differences.
...
- Phase 4: Add app-specific safety controls for GTD-style task management with inbox, projects, contexts/tags, perspectives, forecast, review, defer/due dates, repeating tasks, OmniSync, Shortcuts integration, and Pro upgrade entitlements.
...
- Confirm legal/privacy retention behavior for OmniFocus-style sensitive records and update API contracts before downstream implementation.
