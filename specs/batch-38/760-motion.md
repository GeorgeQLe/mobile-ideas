# Motion-Style Clone Spec

> Metadata
> - Inspiration app: Motion
...
> - Manual verification blockers: account and workspace policy, AI scheduling algorithm behavior, calendar integration accuracy, auto-rescheduling edge cases, meeting scheduler availability, deadline/priority conflict resolution, subscription restore, integration availability, and platform feature differences.
...
Build an original mobile product inspired by Motion's public tasks and project management workflow. The V1 clone focuses on AI-powered auto-scheduling with tasks, projects, calendar integration, deadlines, priorities, time estimates, meeting scheduling, workspace collaboration, and subscription entitlements.
...
- Preserve the functional job behind Motion while using original product naming, original UI, original sample data, and licensed integrations.
...
- Do not copy Motion branding, logos, screenshots, marketing copy, private APIs, proprietary datasets, plan names, UI trade dress, course libraries, textbook solutions, documents, school content, AI prompts, or protected media.
...
|---|---|---|---|
| Apple App Store | https://apps.apple.com/us/app/motion-calendar-task-manager/id1553184503 | iOS listing, privacy labels, release notes, AI scheduling claims, and support links | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
| Google Play | https://play.google.com/store/apps/details?id=com.usemotion.motion | Android listing, data safety, AI scheduling/calendar claims, and release cadence | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
| Official product site | https://www.usemotion.com/ | Motion AI scheduling, tasks, calendar, meetings, and product positioning | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
| Official help | https://help.usemotion.com/ | Motion tasks, scheduling, calendar, projects, and troubleshooting | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
| Privacy policy | https://www.usemotion.com/privacy | Account, content, calendar, AI, analytics, and privacy disclosures | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
| Terms | https://www.usemotion.com/terms | Service, subscriptions, content, AI, and acceptable-use boundaries | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
...
- Manual blockers must remain launch-blocking until verified: account and workspace policy, AI scheduling algorithm behavior, calendar integration accuracy, auto-rescheduling edge cases, meeting scheduler availability, deadline/priority conflict resolution, subscription restore, integration availability, and platform feature differences.

## Core User Journeys

- User creates or restores a Motion-style account, completes role, school, subscription, or tenant checks, and reaches the dashboard.
...
- Monetization model: use original free/trial/paid/sponsored/school/provider/tenant entitlement logic; do not copy exact pricing, plan names, bundle names, promotional copy, school contracts, tenant offers, or partner offers from Motion.
...
- Manual verification tests for account and workspace policy, AI scheduling algorithm behavior, calendar integration accuracy, auto-rescheduling edge cases, meeting scheduler availability, deadline/priority conflict resolution, subscription restore, integration availability, and platform feature differences.
...
- Phase 4: Add app-specific safety controls for AI-powered auto-scheduling with tasks, projects, calendar integration, deadlines, priorities, time estimates, meeting scheduling, workspace collaboration, and subscription entitlements.
...
- Confirm legal/privacy retention behavior for Motion-style sensitive records and update API contracts before downstream implementation.
