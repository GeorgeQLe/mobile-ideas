# Airtable-Style Clone Spec

> Metadata
> - Inspiration app: Airtable
...
> - Manual verification blockers: account and workspace policy, automation execution behavior, sync conflicts, interface designer mobile parity, extension permissions, attachment storage, formula fidelity, sharing/permission states, subscription restore, and regional compliance.
...
Build an original mobile product inspired by Airtable's public productivity documents workflow. The V1 clone focuses on relational databases with grid, kanban, calendar, gallery, and form views, automations, interface designer, extensions, sync, real-time collaboration, comments, sharing, and paid plan entitlements.
...
- Preserve the functional job behind Airtable while using original product naming, original UI, original sample data, and licensed integrations.
...
- Do not copy Airtable branding, logos, screenshots, marketing copy, private APIs, proprietary datasets, plan names, UI trade dress, course libraries, textbook solutions, documents, school content, AI prompts, or protected media.
...
|---|---|---|---|
| Apple App Store | https://apps.apple.com/us/app/airtable/id914172636 | iOS listing, privacy labels, release notes, database/view claims, and support links | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
| Google Play | https://play.google.com/store/apps/details?id=com.formagrid.airtable | Android listing, data safety, database/automations claims, and release cadence | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
| Official product site | https://www.airtable.com/ | Airtable databases, views, automations, interfaces, and product positioning | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
| Official help | https://support.airtable.com/ | Airtable bases, views, automations, sync, sharing, and troubleshooting | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
| Privacy policy | https://www.airtable.com/company/privacy | Account, content, workspace, analytics, integrations, and privacy disclosures | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
| Terms | https://www.airtable.com/company/tos | Service, subscriptions, content, workspaces, and acceptable-use boundaries | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
...
- Manual blockers must remain launch-blocking until verified: account and workspace policy, automation execution behavior, sync conflicts, interface designer mobile parity, extension permissions, attachment storage, formula fidelity, sharing/permission states, subscription restore, and regional compliance.

## Core User Journeys

- User creates or restores a Airtable-style account, completes role, school, subscription, or tenant checks, and reaches the dashboard.
...
- Monetization model: use original free/trial/paid/sponsored/school/provider/tenant entitlement logic; do not copy exact pricing, plan names, bundle names, promotional copy, school contracts, tenant offers, or partner offers from Airtable.
...
- Manual verification tests for account and workspace policy, automation execution behavior, sync conflicts, interface designer mobile parity, extension permissions, attachment storage, formula fidelity, sharing/permission states, subscription restore, and regional compliance.
...
- Phase 4: Add app-specific safety controls for relational databases with grid, kanban, calendar, gallery, and form views, automations, interface designer, extensions, sync, real-time collaboration, comments, sharing, and paid plan entitlements.
...
- Confirm legal/privacy retention behavior for Airtable-style sensitive records and update API contracts before downstream implementation.
