# Basecamp-Style Clone Spec

> Metadata
> - Inspiration app: Basecamp
...
> - Manual verification blockers: account and project policy, Hill Chart rendering, card table mobile parity, campfire real-time behavior, check-in scheduling, file storage limits, notification preferences, guest access, subscription restore, and client/admin permission states.
...
Build an original mobile product inspired by Basecamp's public tasks and project management workflow. The V1 clone focuses on project organization with message boards, to-dos, schedules, docs/files, campfire chat, check-ins, card tables, Hill Charts, notifications, and per-project or account-level access controls.
...
- Preserve the functional job behind Basecamp while using original product naming, original UI, original sample data, and licensed integrations.
...
- Do not copy Basecamp branding, logos, screenshots, marketing copy, private APIs, proprietary datasets, plan names, UI trade dress, course libraries, textbook solutions, documents, school content, AI prompts, or protected media.
...
|---|---|---|---|
| Apple App Store | https://apps.apple.com/us/app/basecamp-project-management/id1015603248 | iOS listing, privacy labels, release notes, project management claims, and support links | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
| Google Play | https://play.google.com/store/apps/details?id=com.basecamp.bc3 | Android listing, data safety, project/chat claims, and release cadence | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
| Official product site | https://basecamp.com/ | Basecamp project tools, communication, to-dos, scheduling, and product positioning | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
| Official help | https://basecamp.com/support | Basecamp projects, to-dos, messages, schedule, files, chat, and troubleshooting | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
| Privacy policy | https://basecamp.com/about/policies/privacy | Account, projects, content, analytics, and privacy disclosures | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
| Terms | https://basecamp.com/about/policies/terms | Service, subscriptions, content, projects, and acceptable-use boundaries | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
...
- Manual blockers must remain launch-blocking until verified: account and project policy, Hill Chart rendering, card table mobile parity, campfire real-time behavior, check-in scheduling, file storage limits, notification preferences, guest access, subscription restore, and client/admin permission states.

## Core User Journeys

- User creates or restores a Basecamp-style account, completes role, school, subscription, or tenant checks, and reaches the dashboard.
...
- Monetization model: use original free/trial/paid/sponsored/school/provider/tenant entitlement logic; do not copy exact pricing, plan names, bundle names, promotional copy, school contracts, tenant offers, or partner offers from Basecamp.
...
- Manual verification tests for account and project policy, Hill Chart rendering, card table mobile parity, campfire real-time behavior, check-in scheduling, file storage limits, notification preferences, guest access, subscription restore, and client/admin permission states.
...
- Phase 4: Add app-specific safety controls for project organization with message boards, to-dos, schedules, docs/files, campfire chat, check-ins, card tables, Hill Charts, notifications, and per-project or account-level access controls.
...
- Confirm legal/privacy retention behavior for Basecamp-style sensitive records and update API contracts before downstream implementation.
