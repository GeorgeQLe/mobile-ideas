# Any.do-Style Clone Spec

> Metadata
> - Inspiration app: Any.do
...
> - Manual verification blockers: account and sync policy, calendar integration behavior, location-based reminder permissions, WhatsApp integration availability, AI assistant eligibility, widget rendering, shared list conflicts, recurring task behavior, subscription restore, and regional compliance.
...
Build an original mobile product inspired by Any.do's public tasks and project management workflow. The V1 clone focuses on task lists, daily planner, calendar integration, reminders, sub-tasks, tags, shared lists, widgets, location-based reminders, WhatsApp integration, AI assistant, and premium plan entitlements.
...
- Preserve the functional job behind Any.do while using original product naming, original UI, original sample data, and licensed integrations.
...
- Do not copy Any.do branding, logos, screenshots, marketing copy, private APIs, proprietary datasets, plan names, UI trade dress, course libraries, textbook solutions, documents, school content, AI prompts, or protected media.
...
|---|---|---|---|
| Apple App Store | https://apps.apple.com/us/app/any-do-to-do-list-planner/id497328576 | iOS listing, privacy labels, release notes, task/planner claims, and support links | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
| Google Play | https://play.google.com/store/apps/details?id=com.anydo | Android listing, data safety, task/calendar/AI claims, and release cadence | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
| Official product site | https://www.any.do/ | Any.do tasks, planner, calendar, reminders, and product positioning | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
| Official help | https://support.any.do/ | Any.do tasks, lists, calendar, reminders, sharing, and troubleshooting | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
| Privacy policy | https://www.any.do/privacy | Account, content, sync, analytics, location, and privacy disclosures | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
| Terms | https://www.any.do/legal/terms-of-use | Service, subscriptions, content, and acceptable-use boundaries | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
...
- Manual blockers must remain launch-blocking until verified: account and sync policy, calendar integration behavior, location-based reminder permissions, WhatsApp integration availability, AI assistant eligibility, widget rendering, shared list conflicts, recurring task behavior, subscription restore, and regional compliance.

## Core User Journeys

- User creates or restores a Any.do-style account, completes role, school, subscription, or tenant checks, and reaches the dashboard.
...
- Monetization model: use original free/trial/paid/sponsored/school/provider/tenant entitlement logic; do not copy exact pricing, plan names, bundle names, promotional copy, school contracts, tenant offers, or partner offers from Any.do.
...
- Manual verification tests for account and sync policy, calendar integration behavior, location-based reminder permissions, WhatsApp integration availability, AI assistant eligibility, widget rendering, shared list conflicts, recurring task behavior, subscription restore, and regional compliance.
...
- Phase 4: Add app-specific safety controls for task lists, daily planner, calendar integration, reminders, sub-tasks, tags, shared lists, widgets, location-based reminders, WhatsApp integration, AI assistant, and premium plan entitlements.
...
- Confirm legal/privacy retention behavior for Any.do-style sensitive records and update API contracts before downstream implementation.
