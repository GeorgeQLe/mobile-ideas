# TickTick-Style Clone Spec

> Metadata
> - Inspiration app: TickTick
...
> - Manual verification blockers: account and sync policy, calendar integration behavior, Pomodoro/timer accuracy, habit tracker state, widget rendering, recurring task parsing, natural language input, attachment limits, shared list conflicts, subscription restore, and regional compliance.
...
Build an original mobile product inspired by TickTick's public tasks and project management workflow. The V1 clone focuses on task management with lists, tags, priorities, calendar, Kanban, timeline, Pomodoro timer, habit tracker, Eisenhower matrix, smart lists, reminders, widgets, and premium plan entitlements.
...
- Preserve the functional job behind TickTick while using original product naming, original UI, original sample data, and licensed integrations.
...
- Do not copy TickTick branding, logos, screenshots, marketing copy, private APIs, proprietary datasets, plan names, UI trade dress, course libraries, textbook solutions, documents, school content, AI prompts, or protected media.
...
|---|---|---|---|
| Apple App Store | https://apps.apple.com/us/app/ticktick-to-do-list-planner/id626144601 | iOS listing, privacy labels, release notes, task/calendar/habit claims, and support links | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
| Google Play | https://play.google.com/store/apps/details?id=com.ticktick.task | Android listing, data safety, task/Pomodoro/habit claims, and release cadence | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
| Official product site | https://ticktick.com/ | TickTick tasks, calendar, habits, Pomodoro, and product positioning | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
| Official help | https://support.ticktick.com/ | TickTick tasks, lists, calendar, habits, sharing, and troubleshooting | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
| Privacy policy | https://ticktick.com/about/privacy | Account, content, sync, analytics, and privacy disclosures | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
| Terms | https://ticktick.com/about/tos | Service, subscriptions, content, and acceptable-use boundaries | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
...
- Manual blockers must remain launch-blocking until verified: account and sync policy, calendar integration behavior, Pomodoro/timer accuracy, habit tracker state, widget rendering, recurring task parsing, natural language input, attachment limits, shared list conflicts, subscription restore, and regional compliance.

## Core User Journeys

- User creates or restores a TickTick-style account, completes role, school, subscription, or tenant checks, and reaches the dashboard.
...
- Monetization model: use original free/trial/paid/sponsored/school/provider/tenant entitlement logic; do not copy exact pricing, plan names, bundle names, promotional copy, school contracts, tenant offers, or partner offers from TickTick.
...
- Manual verification tests for account and sync policy, calendar integration behavior, Pomodoro/timer accuracy, habit tracker state, widget rendering, recurring task parsing, natural language input, attachment limits, shared list conflicts, subscription restore, and regional compliance.
...
- Phase 4: Add app-specific safety controls for task management with lists, tags, priorities, calendar, Kanban, timeline, Pomodoro timer, habit tracker, Eisenhower matrix, smart lists, reminders, widgets, and premium plan entitlements.
...
- Confirm legal/privacy retention behavior for TickTick-style sensitive records and update API contracts before downstream implementation.
