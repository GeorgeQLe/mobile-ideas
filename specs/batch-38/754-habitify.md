# Habitify-Style Clone Spec

> Metadata
> - Inspiration app: Habitify
...
> - Manual verification blockers: account and sync policy, Apple Health integration permissions, streak calculation edge cases, reminder delivery, widget rendering, mood/journal data privacy, statistics accuracy, subscription restore, and platform feature differences.
...
Build an original mobile product inspired by Habitify's public tasks and project management workflow. The V1 clone focuses on habit tracking with streaks, reminders, detailed statistics, journal notes, mood tracking, time-of-day grouping, widget support, Apple Health integration, and premium plan entitlements.
...
- Preserve the functional job behind Habitify while using original product naming, original UI, original sample data, and licensed integrations.
...
- Do not copy Habitify branding, logos, screenshots, marketing copy, private APIs, proprietary datasets, plan names, UI trade dress, course libraries, textbook solutions, documents, school content, AI prompts, or protected media.
...
|---|---|---|---|
| Apple App Store | https://apps.apple.com/us/app/habitify-habit-tracker/id1111447047 | iOS listing, privacy labels, release notes, habit tracking claims, and support links | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
| Google Play | https://play.google.com/store/apps/details?id=co.unstatic.habitify | Android listing, data safety, habit/streak claims, and release cadence | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
| Official product site | https://www.habitify.me/ | Habitify habit tracking, streaks, statistics, and product positioning | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
| Official help | https://support.habitify.me/ | Habitify habits, reminders, statistics, sync, and troubleshooting | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
| Privacy policy | https://www.habitify.me/privacy | Account, content, health data, analytics, and privacy disclosures | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
| Terms | https://www.habitify.me/terms | Service, subscriptions, content, and acceptable-use boundaries | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
...
- Manual blockers must remain launch-blocking until verified: account and sync policy, Apple Health integration permissions, streak calculation edge cases, reminder delivery, widget rendering, mood/journal data privacy, statistics accuracy, subscription restore, and platform feature differences.

## Core User Journeys

- User creates or restores a Habitify-style account, completes role, school, subscription, or tenant checks, and reaches the dashboard.
...
- Monetization model: use original free/trial/paid/sponsored/school/provider/tenant entitlement logic; do not copy exact pricing, plan names, bundle names, promotional copy, school contracts, tenant offers, or partner offers from Habitify.
...
- Manual verification tests for account and sync policy, Apple Health integration permissions, streak calculation edge cases, reminder delivery, widget rendering, mood/journal data privacy, statistics accuracy, subscription restore, and platform feature differences.
...
- Phase 4: Add app-specific safety controls for habit tracking with streaks, reminders, detailed statistics, journal notes, mood tracking, time-of-day grouping, widget support, Apple Health integration, and premium plan entitlements.
...
- Confirm legal/privacy retention behavior for Habitify-style sensitive records and update API contracts before downstream implementation.
