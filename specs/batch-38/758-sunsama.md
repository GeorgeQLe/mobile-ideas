# Sunsama-Style Clone Spec

> Metadata
> - Inspiration app: Sunsama
...
> - Manual verification blockers: account and workspace policy, calendar integration behavior, third-party task import token management, timeboxing accuracy, daily shutdown ritual timing, weekly review scheduling, focus mode behavior, subscription restore, and integration availability.
...
Build an original mobile product inspired by Sunsama's public tasks and project management workflow. The V1 clone focuses on daily planning with timeboxing, calendar integration, task imports from Trello/Asana/Jira/Linear/GitHub/Notion/Todoist/Slack, daily shutdown ritual, weekly review, focus mode, and subscription entitlements.
...
- Preserve the functional job behind Sunsama while using original product naming, original UI, original sample data, and licensed integrations.
...
- Do not copy Sunsama branding, logos, screenshots, marketing copy, private APIs, proprietary datasets, plan names, UI trade dress, course libraries, textbook solutions, documents, school content, AI prompts, or protected media.
...
|---|---|---|---|
| Apple App Store | https://apps.apple.com/us/app/sunsama-daily-planner/id1575958944 | iOS listing, privacy labels, release notes, daily planner claims, and support links | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
| Google Play | https://play.google.com/store/apps/details?id=com.sunsama.app | Android listing, data safety, planner/integration claims, and release cadence | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
| Official product site | https://www.sunsama.com/ | Sunsama daily planning, timeboxing, integrations, and product positioning | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
| Official help | https://help.sunsama.com/ | Sunsama planning, calendar, integrations, rituals, and troubleshooting | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
| Privacy policy | https://www.sunsama.com/privacy | Account, content, integrations, analytics, and privacy disclosures | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
| Terms | https://www.sunsama.com/terms | Service, subscriptions, content, and acceptable-use boundaries | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
...
- Manual blockers must remain launch-blocking until verified: account and workspace policy, calendar integration behavior, third-party task import token management, timeboxing accuracy, daily shutdown ritual timing, weekly review scheduling, focus mode behavior, subscription restore, and integration availability.

## Core User Journeys

- User creates or restores a Sunsama-style account, completes role, school, subscription, or tenant checks, and reaches the dashboard.
...
- Monetization model: use original free/trial/paid/sponsored/school/provider/tenant entitlement logic; do not copy exact pricing, plan names, bundle names, promotional copy, school contracts, tenant offers, or partner offers from Sunsama.
...
- Manual verification tests for account and workspace policy, calendar integration behavior, third-party task import token management, timeboxing accuracy, daily shutdown ritual timing, weekly review scheduling, focus mode behavior, subscription restore, and integration availability.
...
- Phase 4: Add app-specific safety controls for daily planning with timeboxing, calendar integration, task imports from Trello/Asana/Jira/Linear/GitHub/Notion/Todoist/Slack, daily shutdown ritual, weekly review, focus mode, and subscription entitlements.
...
- Confirm legal/privacy retention behavior for Sunsama-style sensitive records and update API contracts before downstream implementation.
