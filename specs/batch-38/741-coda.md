# Coda-Style Clone Spec

> Metadata
> - Inspiration app: Coda
...
> - Manual verification blockers: account and workspace policy, automation execution behavior, pack/integration permissions, real-time sync conflicts, offline edit merge behavior, formula fidelity, template licensing, sharing/permission states, subscription restore, and regional compliance.
...
Build an original mobile product inspired by Coda's public productivity documents workflow. The V1 clone focuses on collaborative docs with tables, views, buttons, automations, packs, formulas, templates, team workspaces, real-time editing, comments, sharing, notifications, and paid plan entitlements.
...
- Preserve the functional job behind Coda while using original product naming, original UI, original sample data, and licensed integrations.
...
- Do not copy Coda branding, logos, screenshots, marketing copy, private APIs, proprietary datasets, plan names, UI trade dress, course libraries, textbook solutions, documents, school content, AI prompts, or protected media.
...
|---|---|---|---|
| Apple App Store | https://apps.apple.com/us/app/coda-docs-tables-and-teams/id1397891897 | iOS listing, privacy labels, release notes, docs/tables claims, and support links | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
| Google Play | https://play.google.com/store/apps/details?id=io.coda.codaapp | Android listing, data safety, docs/tables/automations claims, and release cadence | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
| Official product site | https://coda.io/ | Coda docs, tables, automations, packs, templates, and product positioning | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
| Official help | https://help.coda.io/ | Coda docs, tables, formulas, automations, packs, sharing, and troubleshooting | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
| Privacy policy | https://coda.io/trust/privacy | Account, content, workspace, analytics, integrations, and privacy disclosures | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
| Terms | https://coda.io/trust/terms | Service, subscriptions, content, workspaces, packs, and acceptable-use boundaries | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
...
- Manual blockers must remain launch-blocking until verified: account and workspace policy, automation execution behavior, pack/integration permissions, real-time sync conflicts, offline edit merge behavior, formula fidelity, template licensing, sharing/permission states, subscription restore, and regional compliance.

## Core User Journeys

- User creates or restores a Coda-style account, completes role, school, subscription, or tenant checks, and reaches the dashboard.
...
- Monetization model: use original free/trial/paid/sponsored/school/provider/tenant entitlement logic; do not copy exact pricing, plan names, bundle names, promotional copy, school contracts, tenant offers, or partner offers from Coda.
...
- Manual verification tests for account and workspace policy, automation execution behavior, pack/integration permissions, real-time sync conflicts, offline edit merge behavior, formula fidelity, template licensing, sharing/permission states, subscription restore, and regional compliance.
...
- Phase 4: Add app-specific safety controls for collaborative docs with tables, views, buttons, automations, packs, formulas, templates, team workspaces, real-time editing, comments, sharing, notifications, and paid plan entitlements.
...
- Confirm legal/privacy retention behavior for Coda-style sensitive records and update API contracts before downstream implementation.
