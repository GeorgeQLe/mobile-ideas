# Microsoft To Do-Style Clone Spec

> Metadata
> - Inspiration app: Microsoft To Do
...
> - Manual verification blockers: Microsoft account and tenant policy, Outlook Tasks sync behavior, shared list conflicts, reminder delivery, widget behavior, recurring task edge cases, file attachment limits, guest/shared access, subscription restore, and tenant compliance.
...
Build an original mobile product inspired by Microsoft To Do's public tasks and project management workflow. The V1 clone focuses on task lists, My Day, smart lists, steps, reminders, due dates, recurring tasks, file attachments, list sharing, Outlook Tasks sync, Microsoft 365 integration, widgets, and account entitlements.
...
- Preserve the functional job behind Microsoft To Do while using original product naming, original UI, original sample data, and licensed integrations.
...
- Do not copy Microsoft To Do branding, logos, screenshots, marketing copy, private APIs, proprietary datasets, plan names, UI trade dress, course libraries, textbook solutions, documents, school content, AI prompts, or protected media.
...
|---|---|---|---|
| Apple App Store | https://apps.apple.com/us/app/microsoft-to-do/id1212616790 | iOS listing, privacy labels, release notes, task/list claims, and support links | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
| Google Play | https://play.google.com/store/apps/details?id=com.microsoft.todos | Android listing, data safety, task/reminder claims, and release cadence | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
| Official product site | https://todo.microsoft.com/ | Microsoft To Do lists, My Day, reminders, sharing, and product positioning | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
| Official support | https://support.microsoft.com/to-do | To Do tasks, lists, My Day, sharing, sync, and troubleshooting | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
...
- Manual blockers must remain launch-blocking until verified: Microsoft account and tenant policy, Outlook Tasks sync behavior, shared list conflicts, reminder delivery, widget behavior, recurring task edge cases, file attachment limits, guest/shared access, subscription restore, and tenant compliance.

## Core User Journeys

- User creates or restores a Microsoft To Do-style account, completes role, school, subscription, or tenant checks, and reaches the dashboard.
...
- Monetization model: use original free/trial/paid/sponsored/school/provider/tenant entitlement logic; do not copy exact pricing, plan names, bundle names, promotional copy, school contracts, tenant offers, or partner offers from Microsoft To Do.
...
- Manual verification tests for Microsoft account and tenant policy, Outlook Tasks sync behavior, shared list conflicts, reminder delivery, widget behavior, recurring task edge cases, file attachment limits, guest/shared access, subscription restore, and tenant compliance.
...
- Phase 4: Add app-specific safety controls for task lists, My Day, smart lists, steps, reminders, due dates, recurring tasks, file attachments, list sharing, Outlook Tasks sync, Microsoft 365 integration, widgets, and account entitlements.
...
- Confirm legal/privacy retention behavior for Microsoft To Do-style sensitive records and update API contracts before downstream implementation.
