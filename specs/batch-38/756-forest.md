...
> - Manual verification blockers: account and sync policy, real tree planting partner verification, friend/leaderboard real-time behavior, focus timer accuracy and background behavior, widget rendering, coin/reward economy, device-lock mode, subscription restore, and child safety for gamification.
...
Build an original mobile product inspired by Forest's public tasks and project management workflow. The V1 clone focuses on focus timer with virtual tree planting, focus sessions, tags, timeline, statistics, friend leaderboards, real tree planting partnership, widget support, and Pro plan entitlements.
...
- Preserve the functional job behind Forest while using original product naming, original UI, original sample data, and licensed integrations.
...
- Do not copy Forest branding, logos, screenshots, marketing copy, private APIs, proprietary datasets, plan names, UI trade dress, course libraries, textbook solutions, documents, school content, AI prompts, or protected media.
...
|---|---|---|---|
| Apple App Store | https://apps.apple.com/us/app/forest-focus-for-productivity/id866450515 | iOS listing, privacy labels, release notes, focus/tree claims, and support links | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
| Google Play | https://play.google.com/store/apps/details?id=cc.forestapp | Android listing, data safety, focus timer/tree claims, and release cadence | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
| Official product site | https://www.forestapp.cc/ | Forest focus timer, tree planting, social features, and product positioning | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
| Official help | https://support.forestapp.cc/ | Forest timer, trees, friends, planting, sync, and troubleshooting | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
| Privacy policy | https://www.forestapp.cc/privacy-policy | Account, content, social, analytics, and privacy disclosures | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
| Terms | https://www.forestapp.cc/terms-of-service | Service, subscriptions, content, and acceptable-use boundaries | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
...
- Manual blockers must remain launch-blocking until verified: account and sync policy, real tree planting partner verification, friend/leaderboard real-time behavior, focus timer accuracy and background behavior, widget rendering, coin/reward economy, device-lock mode, subscription restore, and child safety for gamification.

## Core User Journeys

- User creates or restores a Forest-style account, completes role, school, subscription, or tenant checks, and reaches the dashboard.
...
- Monetization model: use original free/trial/paid/sponsored/school/provider/tenant entitlement logic; do not copy exact pricing, plan names, bundle names, promotional copy, school contracts, tenant offers, or partner offers from Forest.
...
- Manual verification tests for account and sync policy, real tree planting partner verification, friend/leaderboard real-time behavior, focus timer accuracy and background behavior, widget rendering, coin/reward economy, device-lock mode, subscription restore, and child safety for gamification.
...
- Phase 4: Add app-specific safety controls for focus timer with virtual tree planting, focus sessions, tags, timeline, statistics, friend leaderboards, real tree planting partnership, widget support, and Pro plan entitlements.
...
- Confirm legal/privacy retention behavior for Forest-style sensitive records and update API contracts before downstream implementation.
