# Moovit-Style Clone Spec

> Metadata
> - Inspiration app: Moovit
...
> - Manual verification blockers: ticket purchase/validation, AR wayfinding, real-time arrival freshness, community reporting, offline maps, push alerts, subscription/ad states, and agency/city coverage require lawful test evidence before one-for-one native parity claims.
> - Legal scope: functional parity only; use original code, brand, copy, iconography, sample data, media, policies, and integrations.

## Overview

Build an original mobile product inspired by Moovit's public user-facing workflow. The clone focus is urban transit route planning, real-time arrivals, alerts, live navigation, ticketing where available, AR wayfinding, community reports, offline maps, and subscription/ad controls. This public-source V1 spec is implementation-ready for an original build, but every behavior marked `Manual verification required` must remain behind a documented blocker until lawful hands-on evidence confirms the exact native behavior.
...
- Do not copy Moovit branding, logos, screenshots, marketing copy, private APIs, proprietary datasets, ranking systems, route algorithms, or protected media.
...
|---|---|---|---|
| Apple App Store listing | https://apps.apple.com/us/app/moovit-bus-transit-tracker/id498477945 | iOS listing, category, age rating, privacy labels, release notes, support links | Public source verified |
| Google Play listing | https://play.google.com/store/apps/details?id=com.tranzmate | Android listing, content rating, data safety, feature blurbs, update cadence | Public source verified |
| Official product site | https://moovitapp.com/ | Public product orientation for urban transit route planning, real-time arrivals, alerts, live navigation, ticketing where available, AR wayfinding, community reports, offline maps, and subscription/ad controls | Public source verified |
| Help/support center | https://support.moovitapp.com/hc/en-us | Support taxonomy, account, booking, cancellation, refund, ticketing, trip, and recovery flows | Public source verified |
| Privacy policy | https://moovitapp.com/en-us/legal/privacy-policy-en | Personal data, location, payment, analytics, retention, export, deletion, and regional privacy rights | Public source verified |
| Terms/legal terms | https://moovitapp.com/en-us/legal/terms-of-service-en | Eligibility, acceptable use, booking/payment terms, cancellation, liability, content, and regional service constraints | Public source verified |
...
- Manual verification required: ticket purchase/validation, AR wayfinding, real-time arrival freshness, community reporting, offline maps, push alerts, subscription/ad states, and agency/city coverage.
...
|---|---|---|---|---|
| Home Transit | Core discovery and decision flow | taps, forms, filters, map gestures, deep links, permissions | empty, loading, loaded, signed-out, saved, unavailable | denied permission, stale inventory, offline, region-locked, provider error, blocked entitlement |
...
| Arrival Board | Core discovery and decision flow | taps, forms, filters, map gestures, deep links, permissions | empty, loading, loaded, signed-out, saved, unavailable | denied permission, stale inventory, offline, region-locked, provider error, blocked entitlement |
...
| Live Navigation | Transaction, live state, or management flow | taps, forms, filters, map gestures, deep links, permissions | empty, loading, loaded, signed-out, saved, unavailable | denied permission, stale inventory, offline, region-locked, provider error, blocked entitlement |
| Ticketing | Transaction, live state, or management flow | taps, forms, filters, map gestures, deep links, permissions | empty, loading, loaded, signed-out, saved, unavailable | denied permission, stale inventory, offline, region-locked, provider error, blocked entitlement |
| AR Wayfinder | Transaction, live state, or management flow | taps, forms, filters, map gestures, deep links, permissions | empty, loading, loaded, signed-out, saved, unavailable | denied permission, stale inventory, offline, region-locked, provider error, blocked entitlement |
| Service Alerts | Transaction, live state, or management flow | taps, forms, filters, map gestures, deep links, permissions | empty, loading, loaded, signed-out, saved, unavailable | denied permission, stale inventory, offline, region-locked, provider error, blocked entitlement |
| Favorites | Trust, account, recovery, or support flow | taps, forms, filters, map gestures, deep links, permissions | empty, loading, loaded, signed-out, saved, unavailable | denied permission, stale inventory, offline, region-locked, provider error, blocked entitlement |
| Offline Maps | Trust, account, recovery, or support flow | taps, forms, filters, map gestures, deep links, permissions | empty, loading, loaded, signed-out, saved, unavailable | denied permission, stale inventory, offline, region-locked, provider error, blocked entitlement |
...
- `Agency`: stores lifecycle state, ownership, source provenance, authorization rules, sync status, deletion/export treatment, and audit metadata for Moovit-style workflows.
- `Line`: stores lifecycle state, ownership, source provenance, authorization rules, sync status, deletion/export treatment, and audit metadata for Moovit-style workflows.
- `Stop`: stores lifecycle state, ownership, source provenance, authorization rules, sync status, deletion/export treatment, and audit metadata for Moovit-style workflows.
- `Arrival`: stores lifecycle state, ownership, source provenance, authorization rules, sync status, deletion/export treatment, and audit metadata for Moovit-style workflows.
- `RouteOption`: stores lifecycle state, ownership, source provenance, authorization rules, sync status, deletion/export treatment, and audit metadata for Moovit-style workflows.
- `Ticket`: stores lifecycle state, ownership, source provenance, authorization rules, sync status, deletion/export treatment, and audit metadata for Moovit-style workflows.
- `ServiceAlert`: stores lifecycle state, ownership, source provenance, authorization rules, sync status, deletion/export treatment, and audit metadata for Moovit-style workflows.
- `CommunityReport`: stores lifecycle state, ownership, source provenance, authorization rules, sync status, deletion/export treatment, and audit metadata for Moovit-style workflows.
- `OfflineMap`: stores lifecycle state, ownership, source provenance, authorization rules, sync status, deletion/export treatment, and audit metadata for Moovit-style workflows.
- `Entitlement`: stores lifecycle state, ownership, source provenance, authorization rules, sync status, deletion/export treatment, and audit metadata for Moovit-style workflows.
...
- Manual verification checklist tests for ticket purchase/validation, AR wayfinding, real-time arrival freshness, community reporting, offline maps, push alerts, subscription/ad states, and agency/city coverage.
...
- Phase 7: Conduct lawful hands-on verification for ticket purchase/validation, AR wayfinding, real-time arrival freshness, community reporting, offline maps, push alerts, subscription/ad states, and agency/city coverage, then update this spec with evidence before any one-for-one parity claim.
