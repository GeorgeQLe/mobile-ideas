# Bolt-Style Clone Spec

> Metadata
> - Inspiration app: Bolt
...
> - Manual verification blockers: driver dispatch, scooter/e-bike availability, safety/emergency assist, audio trip recording, payment/cash/tip states, cancellation fees, location prompts, and country/city availability require lawful test evidence before one-for-one native parity claims.
> - Legal scope: functional parity only; use original code, brand, copy, iconography, sample data, media, policies, and integrations.

## Overview

Build an original mobile product inspired by Bolt's public user-facing workflow. The clone focus is ride request, multimodal mobility, upfront pricing, driver tracking, payment methods, safety toolkit, emergency assist, audio recording where available, receipts, and market availability. This public-source V1 spec is implementation-ready for an original build, but every behavior marked `Manual verification required` must remain behind a documented blocker until lawful hands-on evidence confirms the exact native behavior.
...
- Do not copy Bolt branding, logos, screenshots, marketing copy, private APIs, proprietary datasets, ranking systems, route algorithms, or protected media.
...
|---|---|---|---|
| Apple App Store listing | https://apps.apple.com/us/app/bolt-request-a-ride/id675033630 | iOS listing, category, age rating, privacy labels, release notes, support links | Public source verified |
| Google Play listing | https://play.google.com/store/apps/details?id=ee.mtakso.client | Android listing, content rating, data safety, feature blurbs, update cadence | Public source verified |
| Official product site | https://bolt.eu/ | Public product orientation for ride request, multimodal mobility, upfront pricing, driver tracking, payment methods, safety toolkit, emergency assist, audio recording where available, receipts, and market availability | Public source verified |
| Help/support center | https://bolt.eu/en/support/ | Support taxonomy, account, booking, cancellation, refund, ticketing, trip, and recovery flows | Public source verified |
| Privacy policy | https://bolt.eu/en/legal/privacy-for-riders/ | Personal data, location, payment, analytics, retention, export, deletion, and regional privacy rights | Public source verified |
| Terms/legal terms | https://bolt.eu/en/legal/terms-for-riders/ | Eligibility, acceptable use, booking/payment terms, cancellation, liability, content, and regional service constraints | Public source verified |
...
- Manual verification required: driver dispatch, scooter/e-bike availability, safety/emergency assist, audio trip recording, payment/cash/tip states, cancellation fees, location prompts, and country/city availability.
...
| Ride Types | Core discovery and decision flow | taps, forms, filters, map gestures, deep links, permissions | empty, loading, loaded, signed-out, saved, unavailable | denied permission, stale inventory, offline, region-locked, provider error, blocked entitlement |
...
| Safety Toolkit | Transaction, live state, or management flow | taps, forms, filters, map gestures, deep links, permissions | empty, loading, loaded, signed-out, saved, unavailable | denied permission, stale inventory, offline, region-locked, provider error, blocked entitlement |
...
| Promotions | Trust, account, recovery, or support flow | taps, forms, filters, map gestures, deep links, permissions | empty, loading, loaded, signed-out, saved, unavailable | denied permission, stale inventory, offline, region-locked, provider error, blocked entitlement |
...
- `RideRequest`: stores lifecycle state, ownership, source provenance, authorization rules, sync status, deletion/export treatment, and audit metadata for Bolt-style workflows.
- `RideType`: stores lifecycle state, ownership, source provenance, authorization rules, sync status, deletion/export treatment, and audit metadata for Bolt-style workflows.
- `Driver`: stores lifecycle state, ownership, source provenance, authorization rules, sync status, deletion/export treatment, and audit metadata for Bolt-style workflows.
- `Vehicle`: stores lifecycle state, ownership, source provenance, authorization rules, sync status, deletion/export treatment, and audit metadata for Bolt-style workflows.
- `FareQuote`: stores lifecycle state, ownership, source provenance, authorization rules, sync status, deletion/export treatment, and audit metadata for Bolt-style workflows.
- `PaymentMethod`: stores lifecycle state, ownership, source provenance, authorization rules, sync status, deletion/export treatment, and audit metadata for Bolt-style workflows.
- `SafetyEvent`: stores lifecycle state, ownership, source provenance, authorization rules, sync status, deletion/export treatment, and audit metadata for Bolt-style workflows.
- `Receipt`: stores lifecycle state, ownership, source provenance, authorization rules, sync status, deletion/export treatment, and audit metadata for Bolt-style workflows.
- `Promotion`: stores lifecycle state, ownership, source provenance, authorization rules, sync status, deletion/export treatment, and audit metadata for Bolt-style workflows.
- `Market`: stores lifecycle state, ownership, source provenance, authorization rules, sync status, deletion/export treatment, and audit metadata for Bolt-style workflows.
...
- Manual verification checklist tests for driver dispatch, scooter/e-bike availability, safety/emergency assist, audio trip recording, payment/cash/tip states, cancellation fees, location prompts, and country/city availability.
...
- Phase 7: Conduct lawful hands-on verification for driver dispatch, scooter/e-bike availability, safety/emergency assist, audio trip recording, payment/cash/tip states, cancellation fees, location prompts, and country/city availability, then update this spec with evidence before any one-for-one parity claim.
