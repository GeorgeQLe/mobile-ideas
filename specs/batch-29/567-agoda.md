# Agoda-Style Clone Spec

> Metadata
> - Inspiration app: Agoda
...
> - Manual verification blockers: voucher retrieval, booking edit/cancel flows, payment/refund states, host/property messaging, member offers, local taxes/fees, support chat, and regional inventory/language behavior require lawful test evidence before one-for-one native parity claims.
> - Legal scope: functional parity only; use original code, brand, copy, iconography, sample data, media, policies, and integrations.

## Overview

Build an original mobile product inspired by Agoda's public user-facing workflow. The clone focus is hotel, flight, home, and activity booking, multilingual/currency localization, voucher wallet, booking management, member offers, host handoff, support, and refund workflows. This public-source V1 spec is implementation-ready for an original build, but every behavior marked `Manual verification required` must remain behind a documented blocker until lawful hands-on evidence confirms the exact native behavior.
...
- Do not copy Agoda branding, logos, screenshots, marketing copy, private APIs, proprietary datasets, ranking systems, route algorithms, or protected media.
...
|---|---|---|---|
| Apple App Store listing | https://apps.apple.com/us/app/agoda-cheap-flights-hotels/id440676901 | iOS listing, category, age rating, privacy labels, release notes, support links | Public source verified |
| Google Play listing | https://play.google.com/store/apps/details?id=com.agoda.mobile.consumer | Android listing, content rating, data safety, feature blurbs, update cadence | Public source verified |
| Official product site | https://www.agoda.com/ | Public product orientation for hotel, flight, home, and activity booking, multilingual/currency localization, voucher wallet, booking management, member offers, host handoff, support, and refund workflows | Public source verified |
| Help/support center | https://www.agoda.com/info/contact.html | Support taxonomy, account, booking, cancellation, refund, ticketing, trip, and recovery flows | Public source verified |
| Privacy policy | https://www.agoda.com/info/privacy.html | Personal data, location, payment, analytics, retention, export, deletion, and regional privacy rights | Public source verified |
| Terms/legal terms | https://www.agoda.com/info/termsofuse.html | Eligibility, acceptable use, booking/payment terms, cancellation, liability, content, and regional service constraints | Public source verified |
...
- Manual verification required: voucher retrieval, booking edit/cancel flows, payment/refund states, host/property messaging, member offers, local taxes/fees, support chat, and regional inventory/language behavior.
...
|---|---|---|---|---|
| Home Search | Core discovery and decision flow | taps, forms, filters, map gestures, deep links, permissions | empty, loading, loaded, signed-out, saved, unavailable | denied permission, stale inventory, offline, region-locked, provider error, blocked entitlement |
| Accommodation Results | Core discovery and decision flow | taps, forms, filters, map gestures, deep links, permissions | empty, loading, loaded, signed-out, saved, unavailable | denied permission, stale inventory, offline, region-locked, provider error, blocked entitlement |
...
| Room Selection | Core discovery and decision flow | taps, forms, filters, map gestures, deep links, permissions | empty, loading, loaded, signed-out, saved, unavailable | denied permission, stale inventory, offline, region-locked, provider error, blocked entitlement |
| Flight Search | Transaction, live state, or management flow | taps, forms, filters, map gestures, deep links, permissions | empty, loading, loaded, signed-out, saved, unavailable | denied permission, stale inventory, offline, region-locked, provider error, blocked entitlement |
| Booking Checkout | Transaction, live state, or management flow | taps, forms, filters, map gestures, deep links, permissions | empty, loading, loaded, signed-out, saved, unavailable | denied permission, stale inventory, offline, region-locked, provider error, blocked entitlement |
| Voucher Wallet | Transaction, live state, or management flow | taps, forms, filters, map gestures, deep links, permissions | empty, loading, loaded, signed-out, saved, unavailable | denied permission, stale inventory, offline, region-locked, provider error, blocked entitlement |
| Booking Manage | Transaction, live state, or management flow | taps, forms, filters, map gestures, deep links, permissions | empty, loading, loaded, signed-out, saved, unavailable | denied permission, stale inventory, offline, region-locked, provider error, blocked entitlement |
| Host Messages | Trust, account, recovery, or support flow | taps, forms, filters, map gestures, deep links, permissions | empty, loading, loaded, signed-out, saved, unavailable | denied permission, stale inventory, offline, region-locked, provider error, blocked entitlement |
| Member Offers | Trust, account, recovery, or support flow | taps, forms, filters, map gestures, deep links, permissions | empty, loading, loaded, signed-out, saved, unavailable | denied permission, stale inventory, offline, region-locked, provider error, blocked entitlement |
...
- `SearchQuery`: stores lifecycle state, ownership, source provenance, authorization rules, sync status, deletion/export treatment, and audit metadata for Agoda-style workflows.
- `Property`: stores lifecycle state, ownership, source provenance, authorization rules, sync status, deletion/export treatment, and audit metadata for Agoda-style workflows.
- `RoomOffer`: stores lifecycle state, ownership, source provenance, authorization rules, sync status, deletion/export treatment, and audit metadata for Agoda-style workflows.
- `FlightOffer`: stores lifecycle state, ownership, source provenance, authorization rules, sync status, deletion/export treatment, and audit metadata for Agoda-style workflows.
- `Booking`: stores lifecycle state, ownership, source provenance, authorization rules, sync status, deletion/export treatment, and audit metadata for Agoda-style workflows.
- `Voucher`: stores lifecycle state, ownership, source provenance, authorization rules, sync status, deletion/export treatment, and audit metadata for Agoda-style workflows.
- `PaymentIntent`: stores lifecycle state, ownership, source provenance, authorization rules, sync status, deletion/export treatment, and audit metadata for Agoda-style workflows.
- `HostMessage`: stores lifecycle state, ownership, source provenance, authorization rules, sync status, deletion/export treatment, and audit metadata for Agoda-style workflows.
- `MemberOffer`: stores lifecycle state, ownership, source provenance, authorization rules, sync status, deletion/export treatment, and audit metadata for Agoda-style workflows.
- `SupportCase`: stores lifecycle state, ownership, source provenance, authorization rules, sync status, deletion/export treatment, and audit metadata for Agoda-style workflows.
...
- Manual verification checklist tests for voucher retrieval, booking edit/cancel flows, payment/refund states, host/property messaging, member offers, local taxes/fees, support chat, and regional inventory/language behavior.
...
- Phase 7: Conduct lawful hands-on verification for voucher retrieval, booking edit/cancel flows, payment/refund states, host/property messaging, member offers, local taxes/fees, support chat, and regional inventory/language behavior, then update this spec with evidence before any one-for-one parity claim.
