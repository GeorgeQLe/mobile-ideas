# Getaround-Style Clone Spec

> Metadata
> - Inspiration app: Getaround
...
> - Manual verification blockers: identity/driver eligibility, app unlock or key handoff, vehicle inspection, owner listing and payout flows, insurance/claims, payment/refund states, business rentals, and country availability require lawful test evidence before one-for-one native parity claims.
> - Legal scope: functional parity only; use original code, brand, copy, iconography, sample data, media, policies, and integrations.

## Overview

Build an original mobile product inspired by Getaround's public user-facing workflow. The clone focus is peer-to-peer car rental search, hourly/day/month booking, owner listing, app unlock, insurance, business rentals, receipts, support, and European market availability. This public-source V1 spec is implementation-ready for an original build, but every behavior marked `Manual verification required` must remain behind a documented blocker until lawful hands-on evidence confirms the exact native behavior.
...
- Do not copy Getaround branding, logos, screenshots, marketing copy, private APIs, proprietary datasets, ranking systems, route algorithms, or protected media.
...
|---|---|---|---|
| Apple App Store listing | https://apps.apple.com/us/app/getaround-car-rental/id492238016 | iOS listing, category, age rating, privacy labels, release notes, support links | Public source verified |
| Google Play listing | https://play.google.com/store/apps/details?id=com.c4mprod.voiturelib | Android listing, content rating, data safety, feature blurbs, update cadence | Public source verified |
| Official product site | https://www.getaround.com/ | Public product orientation for peer-to-peer car rental search, hourly/day/month booking, owner listing, app unlock, insurance, business rentals, receipts, support, and European market availability | Public source verified |
| Help/support center | https://getaround.com/help | Support taxonomy, account, booking, cancellation, refund, ticketing, trip, and recovery flows | Public source verified |
| Privacy policy | https://www.getaround.com/privacy | Personal data, location, payment, analytics, retention, export, deletion, and regional privacy rights | Public source verified |
| Terms/legal terms | https://www.getaround.com/terms | Eligibility, acceptable use, booking/payment terms, cancellation, liability, content, and regional service constraints | Public source verified |
...
- Manual verification required: identity/driver eligibility, app unlock or key handoff, vehicle inspection, owner listing and payout flows, insurance/claims, payment/refund states, business rentals, and country availability.
...
|---|---|---|---|---|
| Search Map | Core discovery and decision flow | taps, forms, filters, map gestures, deep links, permissions | empty, loading, loaded, signed-out, saved, unavailable | denied permission, stale inventory, offline, region-locked, provider error, blocked entitlement |
...
| Identity Check | Transaction, live state, or management flow | taps, forms, filters, map gestures, deep links, permissions | empty, loading, loaded, signed-out, saved, unavailable | denied permission, stale inventory, offline, region-locked, provider error, blocked entitlement |
| Pickup/Unlock | Transaction, live state, or management flow | taps, forms, filters, map gestures, deep links, permissions | empty, loading, loaded, signed-out, saved, unavailable | denied permission, stale inventory, offline, region-locked, provider error, blocked entitlement |
...
| Return/Inspection | Transaction, live state, or management flow | taps, forms, filters, map gestures, deep links, permissions | empty, loading, loaded, signed-out, saved, unavailable | denied permission, stale inventory, offline, region-locked, provider error, blocked entitlement |
| Owner Listing | Trust, account, recovery, or support flow | taps, forms, filters, map gestures, deep links, permissions | empty, loading, loaded, signed-out, saved, unavailable | denied permission, stale inventory, offline, region-locked, provider error, blocked entitlement |
| Business Rental | Trust, account, recovery, or support flow | taps, forms, filters, map gestures, deep links, permissions | empty, loading, loaded, signed-out, saved, unavailable | denied permission, stale inventory, offline, region-locked, provider error, blocked entitlement |
...
- `Renter`: stores lifecycle state, ownership, source provenance, authorization rules, sync status, deletion/export treatment, and audit metadata for Getaround-style workflows.
- `Owner`: stores lifecycle state, ownership, source provenance, authorization rules, sync status, deletion/export treatment, and audit metadata for Getaround-style workflows.
- `Vehicle`: stores lifecycle state, ownership, source provenance, authorization rules, sync status, deletion/export treatment, and audit metadata for Getaround-style workflows.
- `VehicleLocation`: stores lifecycle state, ownership, source provenance, authorization rules, sync status, deletion/export treatment, and audit metadata for Getaround-style workflows.
- `Availability`: stores lifecycle state, ownership, source provenance, authorization rules, sync status, deletion/export treatment, and audit metadata for Getaround-style workflows.
- `Reservation`: stores lifecycle state, ownership, source provenance, authorization rules, sync status, deletion/export treatment, and audit metadata for Getaround-style workflows.
- `UnlockSession`: stores lifecycle state, ownership, source provenance, authorization rules, sync status, deletion/export treatment, and audit metadata for Getaround-style workflows.
- `InspectionReport`: stores lifecycle state, ownership, source provenance, authorization rules, sync status, deletion/export treatment, and audit metadata for Getaround-style workflows.
- `InsuranceCase`: stores lifecycle state, ownership, source provenance, authorization rules, sync status, deletion/export treatment, and audit metadata for Getaround-style workflows.
- `Payout`: stores lifecycle state, ownership, source provenance, authorization rules, sync status, deletion/export treatment, and audit metadata for Getaround-style workflows.
...
- Manual verification checklist tests for identity/driver eligibility, app unlock or key handoff, vehicle inspection, owner listing and payout flows, insurance/claims, payment/refund states, business rentals, and country availability.
...
- Phase 7: Conduct lawful hands-on verification for identity/driver eligibility, app unlock or key handoff, vehicle inspection, owner listing and payout flows, insurance/claims, payment/refund states, business rentals, and country availability, then update this spec with evidence before any one-for-one parity claim.
