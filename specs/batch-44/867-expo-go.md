# Expo Go-Style Clone Spec

> Metadata
> - Inspiration app: Expo Go
...
> - Manual verification blockers: Expo account and organization policy, project owner/developer/viewer role model, development server discovery and LAN/tunnel connection, QR code scanning and deep-link URL parsing, JavaScript bundle download size and execution performance, native module availability per Expo SDK version, live reload WebSocket connection stability, error overlay stack trace symbolication, Expo SDK API permission requirements (camera, location, notifications, contacts, media library), push notification token registration and delivery testing, EAS Update channel and runtime version compatibility, device shake gesture detection and developer menu, project history persistence and recently-opened ordering, Expo Go version compatibility with SDK versions (breaking changes), team project access and organization membership, push notification delivery for build/update events, offline project caching limitations, and Expo account authentication.
...
Build an original mobile product inspired by Expo Go's public developer tools workflow. The V1 clone focuses on React Native development client with QR code project loading, live reload and fast refresh during development, JavaScript bundle downloading and execution, native module bridge for camera/location/sensors/haptics, project history and recently opened list, development server connection management, error overlay and LogBox for debugging, Expo SDK API playground, push notification testing (Expo Push), over-the-air update preview (EAS Update), device shake menu for developer tools, push notifications for build/update completion, and Expo account integration for team projects.
...
- Preserve the functional job behind Expo Go while using original product naming, original UI, original sample data, and licensed integrations.
...
- Do not copy Expo Go branding, logos, screenshots, marketing copy, private APIs, proprietary datasets, plan names, UI trade dress, course libraries, textbook solutions, documents, school content, AI prompts, or protected media.
...
|---|---|---|---|
| Apple App Store | https://apps.apple.com/us/app/expo-go/id982107779 | iOS listing, privacy labels, release notes, React Native development claims, and support links | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
| Google Play | https://play.google.com/store/apps/details?id=host.exp.exponent | Android listing, data safety, React Native/Expo development claims, and release cadence | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
| Official product site | https://expo.dev/ | Expo development platform, Expo Go, EAS, and product positioning | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
| Official help | https://docs.expo.dev/ | Expo documentation, Expo Go setup, SDK APIs, and troubleshooting | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
| Privacy policy | https://expo.dev/privacy | Expo account, project data, analytics, and privacy disclosures | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
| Terms | https://expo.dev/terms | Expo services, subscriptions, and acceptable-use boundaries | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
...
- Manual blockers must remain launch-blocking until verified: Expo account and organization policy, project owner/developer/viewer role model, development server discovery and LAN/tunnel connection, QR code scanning and deep-link URL parsing, JavaScript bundle download size and execution performance, native module availability per Expo SDK version, live reload WebSocket connection stability, error overlay stack trace symbolication, Expo SDK API permission requirements (camera, location, notifications, contacts, media library), push notification token registration and delivery testing, EAS Update channel and runtime version compatibility, device shake gesture detection and developer menu, project history persistence and recently-opened ordering, Expo Go version compatibility with SDK versions (breaking changes), team project access and organization membership, push notification delivery for build/update events, offline project caching limitations, and Expo account authentication.

## Core User Journeys

- User creates or restores a Expo Go-style account, completes role, school, subscription, or tenant checks, and reaches the dashboard.
...
- Monetization model: use original free/trial/paid/sponsored/school/provider/tenant entitlement logic; do not copy exact pricing, plan names, bundle names, promotional copy, school contracts, tenant offers, or partner offers from Expo Go.
...
- Manual verification tests for Expo account and organization policy, project owner/developer/viewer role model, development server discovery and LAN/tunnel connection, QR code scanning and deep-link URL parsing, JavaScript bundle download size and execution performance, native module availability per Expo SDK version, live reload WebSocket connection stability, error overlay stack trace symbolication, Expo SDK API permission requirements (camera, location, notifications, contacts, media library), push notification token registration and delivery testing, EAS Update channel and runtime version compatibility, device shake gesture detection and developer menu, project history persistence and recently-opened ordering, Expo Go version compatibility with SDK versions (breaking changes), team project access and organization membership, push notification delivery for build/update events, offline project caching limitations, and Expo account authentication.
...
- Phase 4: Add app-specific safety controls for React Native development client with QR code project loading, live reload and fast refresh during development, JavaScript bundle downloading and execution, native module bridge for camera/location/sensors/haptics, project history and recently opened list, development server connection management, error overlay and LogBox for debugging, Expo SDK API playground, push notification testing (Expo Push), over-the-air update preview (EAS Update), device shake menu for developer tools, push notifications for build/update completion, and Expo account integration for team projects.
...
- Confirm legal/privacy retention behavior for Expo Go-style sensitive records and update API contracts before downstream implementation.
