...
> - Manual verification blockers: NPR account and member station association, live radio stream availability and station geo-detection, podcast catalog and RSS feed integration, audio playback continuity (background, lock screen, CarPlay, AirPlay, Bluetooth), news article content loading and freshness, push notification category management (breaking, shows, stations), station selection and local content personalization, saved stories and listening queue sync, audio briefing scheduling and notification, sleep timer and playback controls, offline podcast download management and storage, ad/sponsorship insertion for podcasts, dark mode and dynamic type support, accessibility features (VoiceOver, audio descriptions), CarPlay/Android Auto integration, embedded audio player behavior, and member station donation/support flow.
...
Build an original mobile product inspired by NPR's public news workflow. The V1 clone focuses on public radio and news with live radio streaming (NPR and member stations), podcast discovery and playback, news articles and stories, section navigation (News, Culture, Music, Politics, Science, Health, Business), audio news briefings (Up First, hourly newscast), personalized station selection, saved stories and listening queue, push notification alerts for breaking news, sleep timer, car play and AirPlay support, offline podcast downloads, dark mode, and publicly funded (listener-supported with sponsorship).
...
- Preserve the functional job behind NPR while using original product naming, original UI, original sample data, and licensed integrations.
...
- Do not copy NPR branding, logos, screenshots, marketing copy, private APIs, proprietary datasets, plan names, UI trade dress, course libraries, textbook solutions, documents, school content, AI prompts, or protected media.
...
|---|---|---|---|
| Apple App Store | https://apps.apple.com/us/app/npr/id324906251 | iOS listing, privacy labels, release notes, radio/podcast/news claims, and support links | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
| Google Play | https://play.google.com/store/apps/details?id=org.npr.android.news | Android listing, data safety, radio/podcast/news claims, and release cadence | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
| Official product site | https://www.npr.org/ | NPR news, radio, podcasts, and editorial positioning | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
| Official help | https://help.npr.org/ | NPR app help, station, account, and troubleshooting | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
| Privacy policy | https://www.npr.org/about-npr/179878450/privacy-policy | NPR data collection, analytics, sponsorship, and privacy disclosures | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
| Terms | https://www.npr.org/about-npr/179876898/terms-of-use | NPR services, content, and acceptable-use boundaries | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
...
- Manual blockers must remain launch-blocking until verified: NPR account and member station association, live radio stream availability and station geo-detection, podcast catalog and RSS feed integration, audio playback continuity (background, lock screen, CarPlay, AirPlay, Bluetooth), news article content loading and freshness, push notification category management (breaking, shows, stations), station selection and local content personalization, saved stories and listening queue sync, audio briefing scheduling and notification, sleep timer and playback controls, offline podcast download management and storage, ad/sponsorship insertion for podcasts, dark mode and dynamic type support, accessibility features (VoiceOver, audio descriptions), CarPlay/Android Auto integration, embedded audio player behavior, and member station donation/support flow.

## Core User Journeys

- User creates or restores a NPR-style account, completes role, school, subscription, or tenant checks, and reaches the dashboard.
...
- Monetization model: use original free/trial/paid/sponsored/school/provider/tenant entitlement logic; do not copy exact pricing, plan names, bundle names, promotional copy, school contracts, tenant offers, or partner offers from NPR.
...
- Manual verification tests for NPR account and member station association, live radio stream availability and station geo-detection, podcast catalog and RSS feed integration, audio playback continuity (background, lock screen, CarPlay, AirPlay, Bluetooth), news article content loading and freshness, push notification category management (breaking, shows, stations), station selection and local content personalization, saved stories and listening queue sync, audio briefing scheduling and notification, sleep timer and playback controls, offline podcast download management and storage, ad/sponsorship insertion for podcasts, dark mode and dynamic type support, accessibility features (VoiceOver, audio descriptions), CarPlay/Android Auto integration, embedded audio player behavior, and member station donation/support flow.
...
- Phase 4: Add app-specific safety controls for public radio and news with live radio streaming (NPR and member stations), podcast discovery and playback, news articles and stories, section navigation (News, Culture, Music, Politics, Science, Health, Business), audio news briefings (Up First, hourly newscast), personalized station selection, saved stories and listening queue, push notification alerts for breaking news, sleep timer, car play and AirPlay support, offline podcast downloads, dark mode, and publicly funded (listener-supported with sponsorship).
...
- Confirm legal/privacy retention behavior for NPR-style sensitive records and update API contracts before downstream implementation.
