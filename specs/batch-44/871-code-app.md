# Code App-Style Clone Spec

> Metadata
> - Inspiration app: Code App
...
> - Manual verification blockers: Code App purchase and feature availability, multi-language syntax highlighting engine and grammar loading, terminal emulator compatibility and command execution sandbox, Git operations (clone, commit, push, pull, branch, merge) and credential storage, file system access (local, iCloud, SSH remote) and sandboxing limitations, Node.js/Python/C/PHP runtime bundling and execution constraints on iOS, extension loading and compatibility with VS Code extension API subset, SSH connection management and key authentication, SFTP directory browsing and file transfer, split editor layout and tab management on various screen sizes, Vim mode keybinding accuracy and mode switching, theme and font customization and preview, Markdown preview rendering and live update, regex search performance on large files, code completion suggestion source and language server availability, iCloud sync conflict resolution, offline editing and sync queue, and iOS storage and memory constraints for large projects.
...
Build an original mobile product inspired by Code App's public developer tools workflow. The V1 clone focuses on mobile code editor with multi-language syntax highlighting, integrated terminal (local and SSH), Git integration (clone, commit, push, pull, branch), file and folder management, Node.js/Python/C/PHP runtime execution, extension support, SSH remote connection for editing server files, SFTP file browsing, split editor and multi-tab interface, Vim mode, customizable themes and fonts, built-in Markdown preview, search and replace with regex, code completion and IntelliSense-style suggestions, iCloud and local file storage, and one-time purchase model.
...
- Preserve the functional job behind Code App while using original product naming, original UI, original sample data, and licensed integrations.
...
- Do not copy Code App branding, logos, screenshots, marketing copy, private APIs, proprietary datasets, plan names, UI trade dress, course libraries, textbook solutions, documents, school content, AI prompts, or protected media.
...
|---|---|---|---|
| Apple App Store | https://apps.apple.com/us/app/code-app/id1512938504 | iOS listing, privacy labels, release notes, code editor claims, and support links | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
| Official product site | https://code.thebaselab.com/ | Code App mobile code editor, terminal, Git, and product positioning | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
| Official help | https://code.thebaselab.com/documentation | Code App documentation, editor setup, Git, terminal, and troubleshooting | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
| Privacy policy | https://code.thebaselab.com/privacy | Code App data handling, iCloud sync, and privacy disclosures | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
| Terms | https://code.thebaselab.com/terms | Code App services, purchases, and acceptable-use boundaries | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
...
- Manual blockers must remain launch-blocking until verified: Code App purchase and feature availability, multi-language syntax highlighting engine and grammar loading, terminal emulator compatibility and command execution sandbox, Git operations (clone, commit, push, pull, branch, merge) and credential storage, file system access (local, iCloud, SSH remote) and sandboxing limitations, Node.js/Python/C/PHP runtime bundling and execution constraints on iOS, extension loading and compatibility with VS Code extension API subset, SSH connection management and key authentication, SFTP directory browsing and file transfer, split editor layout and tab management on various screen sizes, Vim mode keybinding accuracy and mode switching, theme and font customization and preview, Markdown preview rendering and live update, regex search performance on large files, code completion suggestion source and language server availability, iCloud sync conflict resolution, offline editing and sync queue, and iOS storage and memory constraints for large projects.

## Core User Journeys

- User creates or restores a Code App-style account, completes role, school, subscription, or tenant checks, and reaches the dashboard.
...
- Monetization model: use original free/trial/paid/sponsored/school/provider/tenant entitlement logic; do not copy exact pricing, plan names, bundle names, promotional copy, school contracts, tenant offers, or partner offers from Code App.
...
- Manual verification tests for Code App purchase and feature availability, multi-language syntax highlighting engine and grammar loading, terminal emulator compatibility and command execution sandbox, Git operations (clone, commit, push, pull, branch, merge) and credential storage, file system access (local, iCloud, SSH remote) and sandboxing limitations, Node.js/Python/C/PHP runtime bundling and execution constraints on iOS, extension loading and compatibility with VS Code extension API subset, SSH connection management and key authentication, SFTP directory browsing and file transfer, split editor layout and tab management on various screen sizes, Vim mode keybinding accuracy and mode switching, theme and font customization and preview, Markdown preview rendering and live update, regex search performance on large files, code completion suggestion source and language server availability, iCloud sync conflict resolution, offline editing and sync queue, and iOS storage and memory constraints for large projects.
...
- Phase 4: Add app-specific safety controls for mobile code editor with multi-language syntax highlighting, integrated terminal (local and SSH), Git integration (clone, commit, push, pull, branch), file and folder management, Node.js/Python/C/PHP runtime execution, extension support, SSH remote connection for editing server files, SFTP file browsing, split editor and multi-tab interface, Vim mode, customizable themes and fonts, built-in Markdown preview, search and replace with regex, code completion and IntelliSense-style suggestions, iCloud and local file storage, and one-time purchase model.
...
- Confirm legal/privacy retention behavior for Code App-style sensitive records and update API contracts before downstream implementation.
