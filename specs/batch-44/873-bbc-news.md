# BBC News-Style Clone Spec

> Metadata
> - Inspiration app: BBC News
> - Category: News
...
> - Manual verification blockers: BBC account (BBC ID) and regional availability policy, content geo-restrictions and regional edition selection, live radio/TV streaming and iPlayer authentication for UK users, video content rights and adaptive bitrate delivery, push notification category management (breaking, sport, topics), My News topic selection and personalization algorithm, offline article download and storage management, BBC Live real-time update delivery mechanism, regional language content availability, accessibility features (dynamic type, VoiceOver labels, reduced motion), dark mode implementation, ad serving for international users and consent framework, content update frequency and freshness, embedded media player behavior, story sharing deep-link generation, and BBC ID account sync across devices.
...
Build an original mobile product inspired by BBC News's public news workflow. The V1 clone focuses on global news coverage with top stories and editor's picks, topic-based sections (World, UK, Business, Tech, Science, Health, Entertainment, Sport), BBC Live (real-time event coverage), video and audio clips, live radio streaming (BBC World Service), personalized My News feed with topic following, offline reading mode, push notification alerts for breaking news, accessibility features (text size, screen reader), dark mode, story sharing, regional editions and language support, and publicly funded (no ads for UK users, ad-supported internationally).
...
- Deliver a mobile-first news experience with onboarding, dashboard, primary workflow, reminders or notifications, settings, support, and recovery flows.
- Preserve the functional job behind BBC News while using original product naming, original UI, original sample data, and licensed integrations.
...
- Do not copy BBC News branding, logos, screenshots, marketing copy, private APIs, proprietary datasets, plan names, UI trade dress, course libraries, textbook solutions, documents, school content, AI prompts, or protected media.
...
|---|---|---|---|
| Apple App Store | https://apps.apple.com/us/app/bbc-news/id377382255 | iOS listing, privacy labels, release notes, news app claims, and support links | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
| Google Play | https://play.google.com/store/apps/details?id=bbc.mobile.news.ww | Android listing, data safety, global news/live claims, and release cadence | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
| Official product site | https://www.bbc.com/news | BBC News global coverage, live, video, and editorial positioning | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
| Official help | https://www.bbc.co.uk/contact/questions/apps | BBC News app help, account, settings, and troubleshooting | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
| Privacy policy | https://www.bbc.com/usingthebbc/privacy/ | BBC data collection, cookies, personalization, and privacy disclosures | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
| Terms | https://www.bbc.com/usingthebbc/terms/ | BBC services, content, and acceptable-use boundaries | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
...
- Manual blockers must remain launch-blocking until verified: BBC account (BBC ID) and regional availability policy, content geo-restrictions and regional edition selection, live radio/TV streaming and iPlayer authentication for UK users, video content rights and adaptive bitrate delivery, push notification category management (breaking, sport, topics), My News topic selection and personalization algorithm, offline article download and storage management, BBC Live real-time update delivery mechanism, regional language content availability, accessibility features (dynamic type, VoiceOver labels, reduced motion), dark mode implementation, ad serving for international users and consent framework, content update frequency and freshness, embedded media player behavior, story sharing deep-link generation, and BBC ID account sync across devices.

## Core User Journeys

- User creates or restores a BBC News-style account, completes role, school, subscription, or tenant checks, and reaches the dashboard.
...
|---|---|---|---|---|
| Welcome/Auth | Account login or creation, subscription verification, topic/section preference selection, and notification opt-in | email, OAuth, subscribe, select-topics, allow-notifications | new, returning, subscriber, free-tier, expired | auth failed, subscription lapsed, region unavailable, network error |
| Feed/Headlines | Top stories, breaking news, section-based navigation, personalized feed, and live/developing story indicators | scroll, pull-refresh, section-tap, topic-filter, search | loading, loaded, breaking, developing, empty | feed stale, network error, content unavailable, region-blocked |
| Article/Story | Full article reading with inline media, related stories, author info, sharing, saving, and text size adjustment | read, scroll, share, save, adjust-text, play-media | loading, loaded, saved, paywalled, offline-cached | paywall hit, media failed, article removed, offline stale |
| Live/Video/Audio | Live TV/radio streaming, video clips, podcasts, audio articles, and playback controls with background audio | play, pause, seek, pip, cast, download, queue | playing, paused, buffering, ended, downloading | stream unavailable, DRM error, region-blocked, download failed, background interrupted |
| Saved/Personalized | Saved articles, reading history, followed topics/authors, watchlist (market data), and personalized recommendations | view, remove, follow, unfollow, reorder, clear-history | populated, empty, syncing, offline | sync failed, article expired, topic unavailable, storage full |
| Settings/Privacy | Account, subscription, notification preferences, display (dark mode, text size), privacy, support, and data management | forms, toggle, subscribe, restore, request-export | loaded, editing, syncing | subscription error, notification denied, export pending, account locked |
...
- Treat user reading history and behavioral patterns, subscription and payment information, personalization preferences and followed topics, saved articles and bookmarks, push notification tokens and delivery preferences, account credentials and session tokens, location data for regional content, advertising identifiers and consent records, audio/video playback history, offline cached content, newsletter subscription data, and reader engagement analytics as launch-blocking review areas with owners, mitigations, and acceptance tests before implementation.
...
- Monetization model: use original free/trial/paid/sponsored/school/provider/tenant entitlement logic; do not copy exact pricing, plan names, bundle names, promotional copy, school contracts, tenant offers, or partner offers from BBC News.
...
- Manual verification tests for BBC account (BBC ID) and regional availability policy, content geo-restrictions and regional edition selection, live radio/TV streaming and iPlayer authentication for UK users, video content rights and adaptive bitrate delivery, push notification category management (breaking, sport, topics), My News topic selection and personalization algorithm, offline article download and storage management, BBC Live real-time update delivery mechanism, regional language content availability, accessibility features (dynamic type, VoiceOver labels, reduced motion), dark mode implementation, ad serving for international users and consent framework, content update frequency and freshness, embedded media player behavior, story sharing deep-link generation, and BBC ID account sync across devices.
...
- Phase 4: Add app-specific safety controls for global news coverage with top stories and editor's picks, topic-based sections (World, UK, Business, Tech, Science, Health, Entertainment, Sport), BBC Live (real-time event coverage), video and audio clips, live radio streaming (BBC World Service), personalized My News feed with topic following, offline reading mode, push notification alerts for breaking news, accessibility features (text size, screen reader), dark mode, story sharing, regional editions and language support, and publicly funded (no ads for UK users, ad-supported internationally).
...
- Confirm legal/privacy retention behavior for BBC News-style sensitive records and update API contracts before downstream implementation.
