# Reuters-Style Clone Spec

> Metadata
> - Inspiration app: Reuters
> - Category: News
...
> - Manual verification blockers: Reuters account and subscription policy (free tier vs Reuters.com subscriber vs Professional), content access and paywall enforcement, market data licensing and real-time vs delayed quotes, push notification category management (breaking, markets, topics), personalization algorithm and followed-topic feed, saved articles sync and offline access, video content delivery and adaptive streaming, company/ticker association and earnings calendar, regional content availability, ad serving and consent framework, dark mode and dynamic type support, accessibility features, embedded interactive charts and data visualizations, content freshness and update frequency, and Reuters Professional entitlement integration.
...
Build an original mobile product inspired by Reuters's public news workflow. The V1 clone focuses on global business and financial news with real-time market data, top stories and breaking news alerts, section navigation (Business, Markets, World, Legal, Technology, Science, Sports, Lifestyle), market data widgets (indices, currencies, commodities), company news and earnings, video reports and live coverage, personalized news feed and topic following, saved articles, push notification alerts for breaking/market news, dark mode, and subscription model (Reuters.com access, Reuters Professional).
...
- Preserve the functional job behind Reuters while using original product naming, original UI, original sample data, and licensed integrations.
...
- Do not copy Reuters branding, logos, screenshots, marketing copy, private APIs, proprietary datasets, plan names, UI trade dress, course libraries, textbook solutions, documents, school content, AI prompts, or protected media.
...
|---|---|---|---|
| Apple App Store | https://apps.apple.com/us/app/reuters-news/id602660809 | iOS listing, privacy labels, release notes, news/market data claims, and support links | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
| Google Play | https://play.google.com/store/apps/details?id=com.thomsonreuters.reuters | Android listing, data safety, business/market news claims, and release cadence | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
| Official product site | https://www.reuters.com/ | Reuters global news, markets, business, and editorial positioning | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
| Official help | https://www.reuters.com/info-pages/contact-us/ | Reuters app help, account, subscription, and troubleshooting | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
| Privacy policy | https://www.thomsonreuters.com/en/privacy-statement.html | Thomson Reuters/Reuters data collection, analytics, and privacy disclosures | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
| Terms | https://www.reuters.com/info-pages/terms-of-use/ | Reuters services, content licensing, and acceptable-use boundaries | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
...
- Manual blockers must remain launch-blocking until verified: Reuters account and subscription policy (free tier vs Reuters.com subscriber vs Professional), content access and paywall enforcement, market data licensing and real-time vs delayed quotes, push notification category management (breaking, markets, topics), personalization algorithm and followed-topic feed, saved articles sync and offline access, video content delivery and adaptive streaming, company/ticker association and earnings calendar, regional content availability, ad serving and consent framework, dark mode and dynamic type support, accessibility features, embedded interactive charts and data visualizations, content freshness and update frequency, and Reuters Professional entitlement integration.

## Core User Journeys

- User creates or restores a Reuters-style account, completes role, school, subscription, or tenant checks, and reaches the dashboard.
...
- Monetization model: use original free/trial/paid/sponsored/school/provider/tenant entitlement logic; do not copy exact pricing, plan names, bundle names, promotional copy, school contracts, tenant offers, or partner offers from Reuters.
...
- Manual verification tests for Reuters account and subscription policy (free tier vs Reuters.com subscriber vs Professional), content access and paywall enforcement, market data licensing and real-time vs delayed quotes, push notification category management (breaking, markets, topics), personalization algorithm and followed-topic feed, saved articles sync and offline access, video content delivery and adaptive streaming, company/ticker association and earnings calendar, regional content availability, ad serving and consent framework, dark mode and dynamic type support, accessibility features, embedded interactive charts and data visualizations, content freshness and update frequency, and Reuters Professional entitlement integration.
...
- Phase 4: Add app-specific safety controls for global business and financial news with real-time market data, top stories and breaking news alerts, section navigation (Business, Markets, World, Legal, Technology, Science, Sports, Lifestyle), market data widgets (indices, currencies, commodities), company news and earnings, video reports and live coverage, personalized news feed and topic following, saved articles, push notification alerts for breaking/market news, dark mode, and subscription model (Reuters.com access, Reuters Professional).
...
- Confirm legal/privacy retention behavior for Reuters-style sensitive records and update API contracts before downstream implementation.
