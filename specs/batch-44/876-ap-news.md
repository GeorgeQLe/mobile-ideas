# AP News-Style Clone Spec

> Metadata
> - Inspiration app: AP News
> - Category: News
...
> - Manual verification blockers: AP News content delivery and feed freshness, section and topic taxonomy updates, AP Live real-time update mechanism, video/photo gallery loading and rights attribution, push notification category configuration (breaking, topics, elections), saved stories persistence and sync, personalization algorithm and topic following, fact-check article formatting and labeling, election results data source and real-time updates, ad serving and consent framework, dark mode and dynamic type support, accessibility features (VoiceOver, captions), offline story caching, embedded media rendering, content sharing deep-link generation, and regional content availability.
...
Build an original mobile product inspired by AP News's public news workflow. The V1 clone focuses on factual journalism with top stories feed, section navigation (US News, World, Politics, Sports, Entertainment, Business, Science, Health, Technology, Climate, Religion, Oddities), AP Live (real-time event coverage), video and photo galleries, push notification alerts for breaking news, saved stories, personalized topic following, fact-check articles, election results and data, dark mode, text size adjustment, sharing, and free ad-supported model.
...
- Preserve the functional job behind AP News while using original product naming, original UI, original sample data, and licensed integrations.
...
- Do not copy AP News branding, logos, screenshots, marketing copy, private APIs, proprietary datasets, plan names, UI trade dress, course libraries, textbook solutions, documents, school content, AI prompts, or protected media.
...
|---|---|---|---|
| Apple App Store | https://apps.apple.com/us/app/ap-news/id364677107 | iOS listing, privacy labels, release notes, news app claims, and support links | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
| Google Play | https://play.google.com/store/apps/details?id=mnn.Android | Android listing, data safety, AP News claims, and release cadence | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
| Official product site | https://apnews.com/ | AP News factual journalism, coverage, and editorial positioning | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
| Official help | https://apnews.com/contact-us | AP News app help, feedback, and troubleshooting | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
| Privacy policy | https://apnews.com/privacy | AP News data collection, advertising, and privacy disclosures | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
| Terms | https://apnews.com/termsofservice | AP News services, content, and acceptable-use boundaries | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
...
- Manual blockers must remain launch-blocking until verified: AP News content delivery and feed freshness, section and topic taxonomy updates, AP Live real-time update mechanism, video/photo gallery loading and rights attribution, push notification category configuration (breaking, topics, elections), saved stories persistence and sync, personalization algorithm and topic following, fact-check article formatting and labeling, election results data source and real-time updates, ad serving and consent framework, dark mode and dynamic type support, accessibility features (VoiceOver, captions), offline story caching, embedded media rendering, content sharing deep-link generation, and regional content availability.

## Core User Journeys

- User creates or restores a AP News-style account, completes role, school, subscription, or tenant checks, and reaches the dashboard.
...
- Monetization model: use original free/trial/paid/sponsored/school/provider/tenant entitlement logic; do not copy exact pricing, plan names, bundle names, promotional copy, school contracts, tenant offers, or partner offers from AP News.
...
- Manual verification tests for AP News content delivery and feed freshness, section and topic taxonomy updates, AP Live real-time update mechanism, video/photo gallery loading and rights attribution, push notification category configuration (breaking, topics, elections), saved stories persistence and sync, personalization algorithm and topic following, fact-check article formatting and labeling, election results data source and real-time updates, ad serving and consent framework, dark mode and dynamic type support, accessibility features (VoiceOver, captions), offline story caching, embedded media rendering, content sharing deep-link generation, and regional content availability.
...
- Phase 4: Add app-specific safety controls for factual journalism with top stories feed, section navigation (US News, World, Politics, Sports, Entertainment, Business, Science, Health, Technology, Climate, Religion, Oddities), AP Live (real-time event coverage), video and photo galleries, push notification alerts for breaking news, saved stories, personalized topic following, fact-check articles, election results and data, dark mode, text size adjustment, sharing, and free ad-supported model.
...
- Confirm legal/privacy retention behavior for AP News-style sensitive records and update API contracts before downstream implementation.
