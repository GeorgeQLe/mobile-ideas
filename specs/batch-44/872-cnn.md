...
> - Manual verification blockers: CNN account and subscription policy, content geo-restrictions and regional editions, live TV streaming authentication and cable provider sign-in (TV Everywhere), video content DRM and adaptive bitrate streaming, push notification category configuration (breaking, developing, personalized, alerts), article content loading and paywall enforcement, personalization algorithm and topic preference learning, saved articles sync across devices, audio briefing scheduling and background playback, live story update polling/push frequency, ad serving and tracking consent (GDPR, CCPA), embedded media player behavior (autoplay, mute, PiP), dark mode and dynamic type support, offline article caching, accessibility (VoiceOver, captions for video), regional content availability, and subscription/entitlement management.
...
Build an original mobile product inspired by CNN's public news workflow. The V1 clone focuses on breaking news and live coverage with top stories feed, section-based navigation (US, World, Politics, Business, Health, Entertainment, Tech, Science, Sports), live TV streaming, video clips and on-demand shows, push notification alerts for breaking news, article reading with inline media, personalized news feed, saved articles and reading list, audio news briefings, live story updates and developing coverage, dark mode, accessibility features, push notifications for breaking/developing/personalized stories, and ad-supported with optional subscription (CNN+/CNN Max).
...
- Preserve the functional job behind CNN while using original product naming, original UI, original sample data, and licensed integrations.
...
- Do not copy CNN branding, logos, screenshots, marketing copy, private APIs, proprietary datasets, plan names, UI trade dress, course libraries, textbook solutions, documents, school content, AI prompts, or protected media.
...
|---|---|---|---|
| Apple App Store | https://apps.apple.com/us/app/cnn-breaking-us-world-news/id331786748 | iOS listing, privacy labels, release notes, news app claims, and support links | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
| Google Play | https://play.google.com/store/apps/details?id=com.cnn.mobile.android.phone | Android listing, data safety, news/live TV claims, and release cadence | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
| Official product site | https://www.cnn.com/ | CNN news coverage, live TV, video, and editorial positioning | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
| Official help | https://help.cnn.com/ | CNN app help, account, subscription, and troubleshooting | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
| Privacy policy | https://www.cnn.com/privacy | CNN/Warner Bros. Discovery data collection, advertising, and privacy disclosures | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
| Terms | https://www.cnn.com/terms | CNN services, content licensing, and acceptable-use boundaries | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
...
- Manual blockers must remain launch-blocking until verified: CNN account and subscription policy, content geo-restrictions and regional editions, live TV streaming authentication and cable provider sign-in (TV Everywhere), video content DRM and adaptive bitrate streaming, push notification category configuration (breaking, developing, personalized, alerts), article content loading and paywall enforcement, personalization algorithm and topic preference learning, saved articles sync across devices, audio briefing scheduling and background playback, live story update polling/push frequency, ad serving and tracking consent (GDPR, CCPA), embedded media player behavior (autoplay, mute, PiP), dark mode and dynamic type support, offline article caching, accessibility (VoiceOver, captions for video), regional content availability, and subscription/entitlement management.

## Core User Journeys

- User creates or restores a CNN-style account, completes role, school, subscription, or tenant checks, and reaches the dashboard.
...
- Monetization model: use original free/trial/paid/sponsored/school/provider/tenant entitlement logic; do not copy exact pricing, plan names, bundle names, promotional copy, school contracts, tenant offers, or partner offers from CNN.
...
- Manual verification tests for CNN account and subscription policy, content geo-restrictions and regional editions, live TV streaming authentication and cable provider sign-in (TV Everywhere), video content DRM and adaptive bitrate streaming, push notification category configuration (breaking, developing, personalized, alerts), article content loading and paywall enforcement, personalization algorithm and topic preference learning, saved articles sync across devices, audio briefing scheduling and background playback, live story update polling/push frequency, ad serving and tracking consent (GDPR, CCPA), embedded media player behavior (autoplay, mute, PiP), dark mode and dynamic type support, offline article caching, accessibility (VoiceOver, captions for video), regional content availability, and subscription/entitlement management.
...
- Confirm legal/privacy retention behavior for CNN-style sensitive records and update API contracts before downstream implementation.
