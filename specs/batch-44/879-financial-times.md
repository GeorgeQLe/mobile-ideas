# Financial Times-Style Clone Spec

> Metadata
> - Inspiration app: Financial Times
> - Category: News
...
> - Manual verification blockers: FT account and subscription policy (metered access, Standard vs Premium vs Team), paywall enforcement and entitlement verification, myFT topic/author/company following and personalization, live market data licensing and portfolio tracker, FT Edit daily curation algorithm and notification, push notification category management (breaking, myFT, markets, alerts), audio article generation and playback, podcast feed and background audio, interactive chart and graphic rendering, saved articles sync and reading history, gift article allowance and sharing mechanism, ad serving and consent framework (subscriber ad experience), dark mode and dynamic type support, accessibility features (VoiceOver, dynamic type, reduced motion), offline article caching for subscribers, corporate/team subscription SSO and license management, regional content and currency display, and FT Live event integration.
...
Build an original mobile product inspired by Financial Times's public news workflow. The V1 clone focuses on global business and economic journalism with myFT personalized feed, top stories and editor's picks, section navigation (World, US, Companies, Tech, Markets, Climate, Opinion, Life & Arts), live market data and portfolio tracker, FT Edit (curated daily selection), article reading with charts and interactive graphics, audio articles (text-to-speech), podcasts and video, saved articles and reading history, push notification alerts for breaking/market news, gift article sharing, dark mode, and premium subscription model (Standard, Premium, Team/Enterprise).
...
- Preserve the functional job behind Financial Times while using original product naming, original UI, original sample data, and licensed integrations.
...
- Do not copy Financial Times branding, logos, screenshots, marketing copy, private APIs, proprietary datasets, plan names, UI trade dress, course libraries, textbook solutions, documents, school content, AI prompts, or protected media.
...
|---|---|---|---|
| Apple App Store | https://apps.apple.com/us/app/financial-times/id1200842933 | iOS listing, privacy labels, release notes, business/market news claims, and support links | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
| Google Play | https://play.google.com/store/apps/details?id=com.ft.news | Android listing, data safety, business/economic news claims, and release cadence | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
| Official product site | https://www.ft.com/ | Financial Times global business journalism, markets, and editorial positioning | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
| Official help | https://help.ft.com/ | FT app help, account, subscription, and troubleshooting | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
| Privacy policy | https://help.ft.com/legal-privacy/privacy-policy/ | FT data collection, advertising, analytics, and privacy disclosures | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
| Terms | https://help.ft.com/legal-privacy/terms-and-conditions/ | FT services, content licensing, and acceptable-use boundaries | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
...
- Manual blockers must remain launch-blocking until verified: FT account and subscription policy (metered access, Standard vs Premium vs Team), paywall enforcement and entitlement verification, myFT topic/author/company following and personalization, live market data licensing and portfolio tracker, FT Edit daily curation algorithm and notification, push notification category management (breaking, myFT, markets, alerts), audio article generation and playback, podcast feed and background audio, interactive chart and graphic rendering, saved articles sync and reading history, gift article allowance and sharing mechanism, ad serving and consent framework (subscriber ad experience), dark mode and dynamic type support, accessibility features (VoiceOver, dynamic type, reduced motion), offline article caching for subscribers, corporate/team subscription SSO and license management, regional content and currency display, and FT Live event integration.

## Core User Journeys

- User creates or restores a Financial Times-style account, completes role, school, subscription, or tenant checks, and reaches the dashboard.
...
- Monetization model: use original free/trial/paid/sponsored/school/provider/tenant entitlement logic; do not copy exact pricing, plan names, bundle names, promotional copy, school contracts, tenant offers, or partner offers from Financial Times.
...
- Manual verification tests for FT account and subscription policy (metered access, Standard vs Premium vs Team), paywall enforcement and entitlement verification, myFT topic/author/company following and personalization, live market data licensing and portfolio tracker, FT Edit daily curation algorithm and notification, push notification category management (breaking, myFT, markets, alerts), audio article generation and playback, podcast feed and background audio, interactive chart and graphic rendering, saved articles sync and reading history, gift article allowance and sharing mechanism, ad serving and consent framework (subscriber ad experience), dark mode and dynamic type support, accessibility features (VoiceOver, dynamic type, reduced motion), offline article caching for subscribers, corporate/team subscription SSO and license management, regional content and currency display, and FT Live event integration.
...
- Phase 4: Add app-specific safety controls for global business and economic journalism with myFT personalized feed, top stories and editor's picks, section navigation (World, US, Companies, Tech, Markets, Climate, Opinion, Life & Arts), live market data and portfolio tracker, FT Edit (curated daily selection), article reading with charts and interactive graphics, audio articles (text-to-speech), podcasts and video, saved articles and reading history, push notification alerts for breaking/market news, gift article sharing, dark mode, and premium subscription model (Standard, Premium, Team/Enterprise).
...
- Confirm legal/privacy retention behavior for Financial Times-style sensitive records and update API contracts before downstream implementation.
