# The Guardian-Style Clone Spec

> Metadata
> - Inspiration app: The Guardian
> - Category: News
...
> - Manual verification blockers: Guardian account and subscription/supporter tier policy, content access (open vs supporter-only vs subscriber-only), Editions daily issue download and offline availability, live blog real-time update delivery and pagination, push notification category configuration (breaking, sport, football, topics), personalization and topic following algorithm, saved articles sync across devices, crossword puzzle rendering and progress persistence, contributor profile and byline linking, ad serving and consent framework (TCF/GDPR compliance), embedded media and interactive content rendering, dark mode and dynamic type support, offline article caching and storage limits, subscription/supporter entitlement verification and restoration, regional edition availability, accessibility (VoiceOver, dynamic type, contrast), and Guardian ID account management.
...
Build an original mobile product inspired by The Guardian's public news workflow. The V1 clone focuses on independent journalism with live feed of latest stories, section navigation (Headlines, UK, World, Opinion, Sport, Culture, Lifestyle, Business, Environment), Guardian Live blog coverage, article reading with rich media, Editions (daily curated digital newspaper), crosswords and puzzles, saved articles and bookmarks, push notification alerts for breaking news, personalized topic following, contributor profiles, dark mode, text size adjustment, offline reading, supporter/subscriber features (ad-free, Editions access), and reader-funded model with optional subscription (Guardian Supporter, Digital, All-access).
...
- Preserve the functional job behind The Guardian while using original product naming, original UI, original sample data, and licensed integrations.
...
- Do not copy The Guardian branding, logos, screenshots, marketing copy, private APIs, proprietary datasets, plan names, UI trade dress, course libraries, textbook solutions, documents, school content, AI prompts, or protected media.
...
|---|---|---|---|
| Apple App Store | https://apps.apple.com/us/app/the-guardian-live-world-news/id409128287 | iOS listing, privacy labels, release notes, news/Editions claims, and support links | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
| Google Play | https://play.google.com/store/apps/details?id=com.guardian | Android listing, data safety, news/live blog claims, and release cadence | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
| Official product site | https://www.theguardian.com/ | The Guardian news coverage, Editions, support, and editorial positioning | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
| Official help | https://manage.theguardian.com/help-centre | Guardian app help, account, subscription, and troubleshooting | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
| Privacy policy | https://www.theguardian.com/help/privacy-policy | Guardian data collection, advertising, and privacy disclosures | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
| Terms | https://www.theguardian.com/help/terms-of-service | Guardian services, content, and acceptable-use boundaries | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
...
- Manual blockers must remain launch-blocking until verified: Guardian account and subscription/supporter tier policy, content access (open vs supporter-only vs subscriber-only), Editions daily issue download and offline availability, live blog real-time update delivery and pagination, push notification category configuration (breaking, sport, football, topics), personalization and topic following algorithm, saved articles sync across devices, crossword puzzle rendering and progress persistence, contributor profile and byline linking, ad serving and consent framework (TCF/GDPR compliance), embedded media and interactive content rendering, dark mode and dynamic type support, offline article caching and storage limits, subscription/supporter entitlement verification and restoration, regional edition availability, accessibility (VoiceOver, dynamic type, contrast), and Guardian ID account management.

## Core User Journeys

- User creates or restores a The Guardian-style account, completes role, school, subscription, or tenant checks, and reaches the dashboard.
...
- Monetization model: use original free/trial/paid/sponsored/school/provider/tenant entitlement logic; do not copy exact pricing, plan names, bundle names, promotional copy, school contracts, tenant offers, or partner offers from The Guardian.
...
- Manual verification tests for Guardian account and subscription/supporter tier policy, content access (open vs supporter-only vs subscriber-only), Editions daily issue download and offline availability, live blog real-time update delivery and pagination, push notification category configuration (breaking, sport, football, topics), personalization and topic following algorithm, saved articles sync across devices, crossword puzzle rendering and progress persistence, contributor profile and byline linking, ad serving and consent framework (TCF/GDPR compliance), embedded media and interactive content rendering, dark mode and dynamic type support, offline article caching and storage limits, subscription/supporter entitlement verification and restoration, regional edition availability, accessibility (VoiceOver, dynamic type, contrast), and Guardian ID account management.
...
- Phase 4: Add app-specific safety controls for independent journalism with live feed of latest stories, section navigation (Headlines, UK, World, Opinion, Sport, Culture, Lifestyle, Business, Environment), Guardian Live blog coverage, article reading with rich media, Editions (daily curated digital newspaper), crosswords and puzzles, saved articles and bookmarks, push notification alerts for breaking news, personalized topic following, contributor profiles, dark mode, text size adjustment, offline reading, supporter/subscriber features (ad-free, Editions access), and reader-funded model with optional subscription (Guardian Supporter, Digital, All-access).
...
- Confirm legal/privacy retention behavior for The Guardian-style sensitive records and update API contracts before downstream implementation.
