# The Washington Post-Style Clone Spec

> Metadata
> - Inspiration app: The Washington Post
> - Category: News
...
> - Manual verification blockers: Washington Post account and subscription policy (metered access, digital vs premium), paywall enforcement and entitlement verification, push notification category management (breaking, politics, sports, opinions, alerts), personalization algorithm and topic/author following, saved articles sync and reading history, live blog real-time update delivery, podcast playback and background audio (Post Reports), video content delivery and adaptive streaming, ad serving and consent framework (subscriber ad-light experience), dark mode and dynamic type support, accessibility features (VoiceOver, dynamic type, reduced motion, captions), offline article caching for subscribers, gift/shared subscription management, embedded interactive graphics and data visualizations, regional and election-specific content, and Amazon/Bezos ownership transparency disclosures.
...
Build an original mobile product inspired by The Washington Post's public news workflow. The V1 clone focuses on national and political journalism with top stories and breaking alerts, section navigation (Politics, National, World, Business, Technology, Climate, Health, Education, Sports, Opinions, Style, Investigations), live blogs and developing coverage, article reading with rich multimedia, video reports, podcasts (Post Reports), saved articles, push notification alerts for breaking/political news, personalized feed and topic following, dark mode, text size adjustment, accessibility features, and subscription model (Digital, Premium, shared/gift).
...
- Preserve the functional job behind The Washington Post while using original product naming, original UI, original sample data, and licensed integrations.
...
- Do not copy The Washington Post branding, logos, screenshots, marketing copy, private APIs, proprietary datasets, plan names, UI trade dress, course libraries, textbook solutions, documents, school content, AI prompts, or protected media.
...
|---|---|---|---|
| Apple App Store | https://apps.apple.com/us/app/washington-post/id352509417 | iOS listing, privacy labels, release notes, news app claims, and support links | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
| Google Play | https://play.google.com/store/apps/details?id=com.washingtonpost.android | Android listing, data safety, news/politics claims, and release cadence | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
| Official product site | https://www.washingtonpost.com/ | Washington Post journalism, investigations, and editorial positioning | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
| Official help | https://helpcenter.washingtonpost.com/ | Washington Post app help, account, subscription, and troubleshooting | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
| Privacy policy | https://www.washingtonpost.com/privacy-policy/ | Washington Post data collection, advertising, and privacy disclosures | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
| Terms | https://www.washingtonpost.com/terms-of-service/ | Washington Post services, content, and acceptable-use boundaries | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
...
- Manual blockers must remain launch-blocking until verified: Washington Post account and subscription policy (metered access, digital vs premium), paywall enforcement and entitlement verification, push notification category management (breaking, politics, sports, opinions, alerts), personalization algorithm and topic/author following, saved articles sync and reading history, live blog real-time update delivery, podcast playback and background audio (Post Reports), video content delivery and adaptive streaming, ad serving and consent framework (subscriber ad-light experience), dark mode and dynamic type support, accessibility features (VoiceOver, dynamic type, reduced motion, captions), offline article caching for subscribers, gift/shared subscription management, embedded interactive graphics and data visualizations, regional and election-specific content, and Amazon/Bezos ownership transparency disclosures.

## Core User Journeys

- User creates or restores a The Washington Post-style account, completes role, school, subscription, or tenant checks, and reaches the dashboard.
...
- Monetization model: use original free/trial/paid/sponsored/school/provider/tenant entitlement logic; do not copy exact pricing, plan names, bundle names, promotional copy, school contracts, tenant offers, or partner offers from The Washington Post.
...
- Manual verification tests for Washington Post account and subscription policy (metered access, digital vs premium), paywall enforcement and entitlement verification, push notification category management (breaking, politics, sports, opinions, alerts), personalization algorithm and topic/author following, saved articles sync and reading history, live blog real-time update delivery, podcast playback and background audio (Post Reports), video content delivery and adaptive streaming, ad serving and consent framework (subscriber ad-light experience), dark mode and dynamic type support, accessibility features (VoiceOver, dynamic type, reduced motion, captions), offline article caching for subscribers, gift/shared subscription management, embedded interactive graphics and data visualizations, regional and election-specific content, and Amazon/Bezos ownership transparency disclosures.
...
- Phase 4: Add app-specific safety controls for national and political journalism with top stories and breaking alerts, section navigation (Politics, National, World, Business, Technology, Climate, Health, Education, Sports, Opinions, Style, Investigations), live blogs and developing coverage, article reading with rich multimedia, video reports, podcasts (Post Reports), saved articles, push notification alerts for breaking/political news, personalized feed and topic following, dark mode, text size adjustment, accessibility features, and subscription model (Digital, Premium, shared/gift).
...
- Confirm legal/privacy retention behavior for The Washington Post-style sensitive records and update API contracts before downstream implementation.
