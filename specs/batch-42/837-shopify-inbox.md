# Shopify Inbox-Style Clone Spec

> Metadata
> - Inspiration app: Shopify Inbox
...
> - Manual verification blockers: Shopify store and account policy, staff role and chat permission model, real-time message delivery and WebSocket reliability, automated response and instant answer configuration, product recommendation relevance and catalog sync, order status lookup and privacy in chat, chat availability schedule and timezone handling, conversation assignment and routing rules, customer context data loading and privacy, chat metrics calculation and reporting, Shopify admin integration and store connection, push notification delivery for conversation events, offline conversation access, and Shopify plan feature gating.
...
Build an original mobile product inspired by Shopify Inbox's public enterprise operations workflow. The V1 clone focuses on business chat with real-time customer conversations, automated responses and instant answers, product recommendations in chat, order status sharing, chat availability scheduling, conversation assignment and collaboration, customer context (order history, cart contents), chat metrics and response time tracking, integration with Shopify admin, push notifications for new conversations, and Shopify store plan requirements.
...
- Preserve the functional job behind Shopify Inbox while using original product naming, original UI, original sample data, and licensed integrations.
...
- Do not copy Shopify Inbox branding, logos, screenshots, marketing copy, private APIs, proprietary datasets, plan names, UI trade dress, course libraries, textbook solutions, documents, school content, AI prompts, or protected media.
...
|---|---|---|---|
| Apple App Store | https://apps.apple.com/us/app/shopify-inbox/id1aboratorylocation27301156 | iOS listing, privacy labels, release notes, business chat claims, and support links | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
| Google Play | https://play.google.com/store/apps/details?id=com.shopify.ping | Android listing, data safety, business chat/messaging claims, and release cadence | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
| Official product site | https://www.shopify.com/inbox | Shopify Inbox business chat, automated responses, and product positioning | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
| Official help | https://help.shopify.com/en/manual/inbox | Shopify Inbox setup, chat, automated responses, and troubleshooting | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
| Privacy policy | https://www.shopify.com/legal/privacy | Shopify account, chat data, customer data, analytics, and privacy disclosures | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
| Terms | https://www.shopify.com/legal/terms | Shopify services, chat, and acceptable-use boundaries | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
...
- Manual blockers must remain launch-blocking until verified: Shopify store and account policy, staff role and chat permission model, real-time message delivery and WebSocket reliability, automated response and instant answer configuration, product recommendation relevance and catalog sync, order status lookup and privacy in chat, chat availability schedule and timezone handling, conversation assignment and routing rules, customer context data loading and privacy, chat metrics calculation and reporting, Shopify admin integration and store connection, push notification delivery for conversation events, offline conversation access, and Shopify plan feature gating.

## Core User Journeys

- User creates or restores a Shopify Inbox-style account, completes role, school, subscription, or tenant checks, and reaches the dashboard.
...
- Monetization model: use original free/trial/paid/sponsored/school/provider/tenant entitlement logic; do not copy exact pricing, plan names, bundle names, promotional copy, school contracts, tenant offers, or partner offers from Shopify Inbox.
...
- Manual verification tests for Shopify store and account policy, staff role and chat permission model, real-time message delivery and WebSocket reliability, automated response and instant answer configuration, product recommendation relevance and catalog sync, order status lookup and privacy in chat, chat availability schedule and timezone handling, conversation assignment and routing rules, customer context data loading and privacy, chat metrics calculation and reporting, Shopify admin integration and store connection, push notification delivery for conversation events, offline conversation access, and Shopify plan feature gating.
...
- Phase 4: Add app-specific safety controls for business chat with real-time customer conversations, automated responses and instant answers, product recommendations in chat, order status sharing, chat availability scheduling, conversation assignment and collaboration, customer context (order history, cart contents), chat metrics and response time tracking, integration with Shopify admin, push notifications for new conversations, and Shopify store plan requirements.
...
- Confirm legal/privacy retention behavior for Shopify Inbox-style sensitive records and update API contracts before downstream implementation.
