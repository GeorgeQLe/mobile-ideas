# ADP Mobile-Style Clone Spec

> Metadata
> - Inspiration app: ADP Mobile
...
> - Manual verification blockers: ADP client code and registration policy, employee/manager/practitioner role model, pay statement access and payroll schedule, W-2 and tax document availability and delivery timing, direct deposit account verification, time and attendance configuration per client, time-off policy and accrual rules per employer, benefits enrollment window and plan eligibility, retirement plan provider integration, tax withholding calculation and form submission, directory visibility per client configuration, manager approval authority and delegation, ADP marketplace app provisioning, push notification delivery for payroll/benefits/time events, offline access scope, multi-client-code switching and registration, and SSO/federation per employer.
...
Build an original mobile product inspired by ADP Mobile's public enterprise operations workflow. The V1 clone focuses on payroll and HR with pay statements and W-2s, direct deposit management, time and attendance (clock in/out, timecards), time-off requests and balances, benefits enrollment and plan details, retirement savings (401k) overview, tax withholding management, employee directory, company news and alerts, manager approvals, ADP marketplace integrations, push notifications for pay/benefits/approvals, and client-code-based multi-employer switching.
...
- Preserve the functional job behind ADP Mobile while using original product naming, original UI, original sample data, and licensed integrations.
...
- Do not copy ADP Mobile branding, logos, screenshots, marketing copy, private APIs, proprietary datasets, plan names, UI trade dress, course libraries, textbook solutions, documents, school content, AI prompts, or protected media.
...
|---|---|---|---|
| Apple App Store | https://apps.apple.com/us/app/adp-mobile-solutions/id444553167 | iOS listing, privacy labels, release notes, payroll/HR claims, and support links | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
| Google Play | https://play.google.com/store/apps/details?id=com.adp.mobile.solutions | Android listing, data safety, payroll/time tracking claims, and release cadence | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
| Official product site | https://www.adp.com/what-we-offer/products/adp-mobile-solutions.aspx | ADP Mobile payroll, HR, time, benefits, and product positioning | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
| Official help | https://support.adp.com/ | ADP Mobile setup, registration, payroll, time, and troubleshooting | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
| Privacy policy | https://www.adp.com/privacy.aspx | ADP account, payroll data, analytics, and privacy disclosures | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
| Terms | https://www.adp.com/legal.aspx | ADP services, enterprise, and acceptable-use boundaries | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
...
- Manual blockers must remain launch-blocking until verified: ADP client code and registration policy, employee/manager/practitioner role model, pay statement access and payroll schedule, W-2 and tax document availability and delivery timing, direct deposit account verification, time and attendance configuration per client, time-off policy and accrual rules per employer, benefits enrollment window and plan eligibility, retirement plan provider integration, tax withholding calculation and form submission, directory visibility per client configuration, manager approval authority and delegation, ADP marketplace app provisioning, push notification delivery for payroll/benefits/time events, offline access scope, multi-client-code switching and registration, and SSO/federation per employer.

## Core User Journeys

- User creates or restores a ADP Mobile-style account, completes role, school, subscription, or tenant checks, and reaches the dashboard.
...
- Monetization model: use original free/trial/paid/sponsored/school/provider/tenant entitlement logic; do not copy exact pricing, plan names, bundle names, promotional copy, school contracts, tenant offers, or partner offers from ADP Mobile.
...
- Manual verification tests for ADP client code and registration policy, employee/manager/practitioner role model, pay statement access and payroll schedule, W-2 and tax document availability and delivery timing, direct deposit account verification, time and attendance configuration per client, time-off policy and accrual rules per employer, benefits enrollment window and plan eligibility, retirement plan provider integration, tax withholding calculation and form submission, directory visibility per client configuration, manager approval authority and delegation, ADP marketplace app provisioning, push notification delivery for payroll/benefits/time events, offline access scope, multi-client-code switching and registration, and SSO/federation per employer.
...
- Phase 4: Add app-specific safety controls for payroll and HR with pay statements and W-2s, direct deposit management, time and attendance (clock in/out, timecards), time-off requests and balances, benefits enrollment and plan details, retirement savings (401k) overview, tax withholding management, employee directory, company news and alerts, manager approvals, ADP marketplace integrations, push notifications for pay/benefits/approvals, and client-code-based multi-employer switching.
...
- Confirm legal/privacy retention behavior for ADP Mobile-style sensitive records and update API contracts before downstream implementation.
