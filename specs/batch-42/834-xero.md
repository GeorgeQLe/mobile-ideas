# Xero-Style Clone Spec

> Metadata
> - Inspiration app: Xero
...
> - Manual verification blockers: Xero account and organization policy, owner/advisor/standard/invoice-only role and permission model, invoice creation and online payment acceptance, quote-to-invoice conversion, receipt capture and Hubdoc OCR accuracy, bank feed connection and reconciliation matching rules, categorization and bank rules configuration, P&L and balance sheet compliance per jurisdiction, cash flow dashboard methodology, bill creation and batch payment processing, fixed asset depreciation calculation and disposal, project time tracking and profitability, inventory tracking and COGS method, payroll processing availability and jurisdiction support, multi-currency account and exchange rate handling, contact merging and statement generation, custom report builder, Hubdoc document extraction accuracy, advisor invite and practice manager integration, push notification delivery for invoice/bill/bank events, offline access scope, and SSO provisioning.
...
Build an original mobile product inspired by Xero's public enterprise operations workflow. The V1 clone focuses on cloud accounting with invoicing and quotes, expense claims and receipt capture, bank connections and bank reconciliation, income and expense categorization, profit and loss reporting, balance sheet, cash flow tracking, bill management and payments, fixed asset management, project tracking with time and costs, inventory tracking, payroll (Xero Payroll in supported regions), multi-currency, contacts management, reporting dashboard, Hubdoc (document capture), advisor collaboration, push notifications for invoices/bills/bank feeds, and plan-gated feature enforcement (Starter, Standard, Premium).
...
- Preserve the functional job behind Xero while using original product naming, original UI, original sample data, and licensed integrations.
...
- Do not copy Xero branding, logos, screenshots, marketing copy, private APIs, proprietary datasets, plan names, UI trade dress, course libraries, textbook solutions, documents, school content, AI prompts, or protected media.
...
|---|---|---|---|
| Apple App Store | https://apps.apple.com/us/app/xero-accounting/id441aboratory80130 | iOS listing, privacy labels, release notes, accounting/invoicing claims, and support links | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
| Google Play | https://play.google.com/store/apps/details?id=com.xero.touch | Android listing, data safety, accounting/reconciliation claims, and release cadence | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
| Official product site | https://www.xero.com/ | Xero cloud accounting, invoicing, bank reconciliation, and product positioning | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
| Official help | https://central.xero.com/ | Xero setup, accounting, invoicing, bank feeds, payroll, and troubleshooting | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
| Privacy policy | https://www.xero.com/legal/privacy/ | Xero account, financial data, analytics, AI, and privacy disclosures | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
| Terms | https://www.xero.com/legal/terms/ | Xero services, subscriptions, and acceptable-use boundaries | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
...
- Manual blockers must remain launch-blocking until verified: Xero account and organization policy, owner/advisor/standard/invoice-only role and permission model, invoice creation and online payment acceptance, quote-to-invoice conversion, receipt capture and Hubdoc OCR accuracy, bank feed connection and reconciliation matching rules, categorization and bank rules configuration, P&L and balance sheet compliance per jurisdiction, cash flow dashboard methodology, bill creation and batch payment processing, fixed asset depreciation calculation and disposal, project time tracking and profitability, inventory tracking and COGS method, payroll processing availability and jurisdiction support, multi-currency account and exchange rate handling, contact merging and statement generation, custom report builder, Hubdoc document extraction accuracy, advisor invite and practice manager integration, push notification delivery for invoice/bill/bank events, offline access scope, and SSO provisioning.

## Core User Journeys

- User creates or restores a Xero-style account, completes role, school, subscription, or tenant checks, and reaches the dashboard.
...
- Monetization model: use original free/trial/paid/sponsored/school/provider/tenant entitlement logic; do not copy exact pricing, plan names, bundle names, promotional copy, school contracts, tenant offers, or partner offers from Xero.
...
- Manual verification tests for Xero account and organization policy, owner/advisor/standard/invoice-only role and permission model, invoice creation and online payment acceptance, quote-to-invoice conversion, receipt capture and Hubdoc OCR accuracy, bank feed connection and reconciliation matching rules, categorization and bank rules configuration, P&L and balance sheet compliance per jurisdiction, cash flow dashboard methodology, bill creation and batch payment processing, fixed asset depreciation calculation and disposal, project time tracking and profitability, inventory tracking and COGS method, payroll processing availability and jurisdiction support, multi-currency account and exchange rate handling, contact merging and statement generation, custom report builder, Hubdoc document extraction accuracy, advisor invite and practice manager integration, push notification delivery for invoice/bill/bank events, offline access scope, and SSO provisioning.
...
- Phase 4: Add app-specific safety controls for cloud accounting with invoicing and quotes, expense claims and receipt capture, bank connections and bank reconciliation, income and expense categorization, profit and loss reporting, balance sheet, cash flow tracking, bill management and payments, fixed asset management, project tracking with time and costs, inventory tracking, payroll (Xero Payroll in supported regions), multi-currency, contacts management, reporting dashboard, Hubdoc (document capture), advisor collaboration, push notifications for invoices/bills/bank feeds, and plan-gated feature enforcement (Starter, Standard, Premium).
...
- Confirm legal/privacy retention behavior for Xero-style sensitive records and update API contracts before downstream implementation.
