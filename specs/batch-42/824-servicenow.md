# ServiceNow-Style Clone Spec

> Metadata
> - Inspiration app: ServiceNow
...
> - Manual verification blockers: ServiceNow instance and tenant policy, admin/ITIL/ESS role and ACL model, incident/request/change/problem CRUD and mandatory field validation, service catalog item and variable set configuration, change management approval and CAB workflow, CMDB CI relationship and dependency mapping, virtual agent topic and conversation design, agent workspace list and form rendering, approval workflow delegation and escalation, SLA definition and breach calculation, notification rules and email/push delivery, Performance Analytics dashboard rendering, employee center portal configuration, Now Mobile agent vs self-service mode, offline record caching, instance upgrade and version-specific behavior, and enterprise SSO/SAML/MFA provisioning.
...
Build an original mobile product inspired by ServiceNow's public enterprise operations workflow. The V1 clone focuses on enterprise service management with incident management, service catalog and request fulfillment, change management, problem management, knowledge management, CMDB (configuration management database), virtual agent (AI chatbot), agent workspace, approval workflows, SLA management, notifications and alerts, dashboard and reporting, employee center portal, Now Mobile agent and self-service, and enterprise instance configuration.
...
- Preserve the functional job behind ServiceNow while using original product naming, original UI, original sample data, and licensed integrations.
...
- Do not copy ServiceNow branding, logos, screenshots, marketing copy, private APIs, proprietary datasets, plan names, UI trade dress, course libraries, textbook solutions, documents, school content, AI prompts, or protected media.
...
|---|---|---|---|
| Apple App Store | https://apps.apple.com/us/app/now-mobile/id1469616608 | iOS listing, privacy labels, release notes, ITSM/service management claims, and support links | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
| Google Play | https://play.google.com/store/apps/details?id=com.servicenow.requestor | Android listing, data safety, ITSM/virtual agent claims, and release cadence | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
| Official product site | https://www.servicenow.com/products/itsm.html | ServiceNow ITSM, service catalog, virtual agent, and product positioning | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
| Official help | https://docs.servicenow.com/ | ServiceNow documentation, ITSM, mobile, virtual agent, and troubleshooting | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
| Privacy policy | https://www.servicenow.com/privacy-statement.html | ServiceNow account, instance data, AI, analytics, and privacy disclosures | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
| Terms | https://www.servicenow.com/terms-of-use.html | ServiceNow services, subscriptions, enterprise, and acceptable-use boundaries | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
...
- Manual blockers must remain launch-blocking until verified: ServiceNow instance and tenant policy, admin/ITIL/ESS role and ACL model, incident/request/change/problem CRUD and mandatory field validation, service catalog item and variable set configuration, change management approval and CAB workflow, CMDB CI relationship and dependency mapping, virtual agent topic and conversation design, agent workspace list and form rendering, approval workflow delegation and escalation, SLA definition and breach calculation, notification rules and email/push delivery, Performance Analytics dashboard rendering, employee center portal configuration, Now Mobile agent vs self-service mode, offline record caching, instance upgrade and version-specific behavior, and enterprise SSO/SAML/MFA provisioning.

## Core User Journeys

- User creates or restores a ServiceNow-style account, completes role, school, subscription, or tenant checks, and reaches the dashboard.
...
- Monetization model: use original free/trial/paid/sponsored/school/provider/tenant entitlement logic; do not copy exact pricing, plan names, bundle names, promotional copy, school contracts, tenant offers, or partner offers from ServiceNow.
...
- Manual verification tests for ServiceNow instance and tenant policy, admin/ITIL/ESS role and ACL model, incident/request/change/problem CRUD and mandatory field validation, service catalog item and variable set configuration, change management approval and CAB workflow, CMDB CI relationship and dependency mapping, virtual agent topic and conversation design, agent workspace list and form rendering, approval workflow delegation and escalation, SLA definition and breach calculation, notification rules and email/push delivery, Performance Analytics dashboard rendering, employee center portal configuration, Now Mobile agent vs self-service mode, offline record caching, instance upgrade and version-specific behavior, and enterprise SSO/SAML/MFA provisioning.
...
- Phase 4: Add app-specific safety controls for enterprise service management with incident management, service catalog and request fulfillment, change management, problem management, knowledge management, CMDB (configuration management database), virtual agent (AI chatbot), agent workspace, approval workflows, SLA management, notifications and alerts, dashboard and reporting, employee center portal, Now Mobile agent and self-service, and enterprise instance configuration.
...
- Confirm legal/privacy retention behavior for ServiceNow-style sensitive records and update API contracts before downstream implementation.
