# Deel-Style Clone Spec

> Metadata
> - Inspiration app: Deel
...
> - Manual verification blockers: Deel company and worker account policy, EOR/contractor/direct-employee contract type differences, pay slip access and payroll calendar per entity/country, invoice generation and approval for contractors, time-off policy per contract type and country, expense policy and approval chain, equipment ordering availability and shipping logistics, Deel Card issuance and banking partner limits, withdrawal method availability per country and provider, tax document generation per jurisdiction, compliance document e-signature and validity, directory visibility per entity/team, push notification delivery for payment/contract/compliance events, offline access scope, multi-entity and multi-currency handling, and country-specific labor law compliance.
...
Build an original mobile product inspired by Deel's public enterprise operations workflow. The V1 clone focuses on global payroll and contractor management with pay slips and invoices, contract management (EOR, contractor, direct employee), time-off requests and balances, expense submissions, equipment ordering and tracking, Deel Card (prepaid card for contractors), withdrawal methods (bank transfer, crypto, PayPal, Wise, Payoneer, Revolut), tax document management, compliance documents and e-signatures, employee directory, push notifications for payments/contracts/tasks, and multi-entity/multi-country workforce management.
...
- Deliver a mobile-first enterprise operations experience with onboarding, dashboard, primary workflow, reminders or notifications, settings, support, and recovery flows.
- Preserve the functional job behind Deel while using original product naming, original UI, original sample data, and licensed integrations.
...
- Do not copy Deel branding, logos, screenshots, marketing copy, private APIs, proprietary datasets, plan names, UI trade dress, course libraries, textbook solutions, documents, school content, AI prompts, or protected media.
...
|---|---|---|---|
| Apple App Store | https://apps.apple.com/us/app/deel-hr-platform/id1497974207 | iOS listing, privacy labels, release notes, payroll/contractor claims, and support links | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
| Google Play | https://play.google.com/store/apps/details?id=com.deel.contractor | Android listing, data safety, payroll/global HR claims, and release cadence | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
| Official product site | https://www.deel.com/ | Deel global payroll, EOR, contractor management, and product positioning | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
| Official help | https://help.deel.com/ | Deel setup, contracts, payments, compliance, and troubleshooting | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
| Privacy policy | https://www.deel.com/privacy | Deel account, payroll data, financial data, analytics, and privacy disclosures | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
| Terms | https://www.deel.com/terms | Deel services, contracts, payments, and acceptable-use boundaries | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
...
- Manual blockers must remain launch-blocking until verified: Deel company and worker account policy, EOR/contractor/direct-employee contract type differences, pay slip access and payroll calendar per entity/country, invoice generation and approval for contractors, time-off policy per contract type and country, expense policy and approval chain, equipment ordering availability and shipping logistics, Deel Card issuance and banking partner limits, withdrawal method availability per country and provider, tax document generation per jurisdiction, compliance document e-signature and validity, directory visibility per entity/team, push notification delivery for payment/contract/compliance events, offline access scope, multi-entity and multi-currency handling, and country-specific labor law compliance.

## Core User Journeys

- User creates or restores a Deel-style account, completes role, school, subscription, or tenant checks, and reaches the dashboard.
...
|---|---|---|---|---|
| Welcome/Auth | Account login, employer/tenant selection, SSO/SAML, employee verification, and permission primers | email, SSO, employer-select, verify | new, returning, multi-employer, locked | SSO failed, employer unavailable, not enrolled, auth timeout |
| Home/Dashboard | Employee dashboard with pay summary, upcoming time off, pending tasks, announcements, and quick actions | tap, search, navigate, refresh | empty, loading, current, offline | sync failed, data stale, employer config missing, permission denied |
| Pay/Compensation | Pay stubs, earnings breakdown, tax documents (W-2, 1099), direct deposit settings, and pay history | view, download, configure, search | current, historical, loading, unavailable | pay stub not ready, document unavailable, deposit change pending, payroll not processed |
| Time/Attendance | Clock in/out, timecards, time-off requests and balances, schedule, and approval status | clock, request, view, approve | clocked-in, clocked-out, pending, approved, denied | geofence violation, overtime alert, balance insufficient, approval timeout |
| Benefits/HR | Benefits enrollment, plan details, life events, employee directory, org chart, and HR documents | enroll, view, search, upload | enrolled, eligible, ineligible, open-enrollment | enrollment closed, plan unavailable, document upload failed, directory restricted |
| Settings/Privacy | Account, notification preferences, personal info, emergency contacts, privacy, support, and data export | forms, toggle, update, request | loaded, editing, syncing | employer policy override, field locked, SSO required, export pending |
...
- Treat employee PII and identity documents, pay stubs and compensation data, tax documents (W-2, 1099), bank account and direct deposit details, benefits enrollment and health plan data, time-off balances and attendance records, performance review data, employee directory and org chart, HR documents and e-signatures, payroll calculation data, retirement account details, employer tenant configuration, and SSO/SAML credentials as launch-blocking review areas with owners, mitigations, and acceptance tests before implementation.
...
- Monetization model: use original free/trial/paid/sponsored/school/provider/tenant entitlement logic; do not copy exact pricing, plan names, bundle names, promotional copy, school contracts, tenant offers, or partner offers from Deel.
...
- Manual verification tests for Deel company and worker account policy, EOR/contractor/direct-employee contract type differences, pay slip access and payroll calendar per entity/country, invoice generation and approval for contractors, time-off policy per contract type and country, expense policy and approval chain, equipment ordering availability and shipping logistics, Deel Card issuance and banking partner limits, withdrawal method availability per country and provider, tax document generation per jurisdiction, compliance document e-signature and validity, directory visibility per entity/team, push notification delivery for payment/contract/compliance events, offline access scope, multi-entity and multi-currency handling, and country-specific labor law compliance.
...
- Phase 4: Add app-specific safety controls for global payroll and contractor management with pay slips and invoices, contract management (EOR, contractor, direct employee), time-off requests and balances, expense submissions, equipment ordering and tracking, Deel Card (prepaid card for contractors), withdrawal methods (bank transfer, crypto, PayPal, Wise, Payoneer, Revolut), tax document management, compliance documents and e-signatures, employee directory, push notifications for payments/contracts/tasks, and multi-entity/multi-country workforce management.
...
- Confirm legal/privacy retention behavior for Deel-style sensitive records and update API contracts before downstream implementation.
