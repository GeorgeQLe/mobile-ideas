# PayPal Business-Style Clone Spec

> Metadata
> - Inspiration app: PayPal Business
...
> - Manual verification blockers: PayPal business account and verification policy, owner/admin/staff role and permission model, transaction search and filtering, invoice creation and online payment acceptance, payment request and link generation, money transfer limits and regulatory compliance, balance hold and reserve policies, PayPal Checkout integration and SDK behavior, QR code payment generation and scanning, Zettle card reader Bluetooth pairing and payment processing, dispute resolution timeline and evidence submission, customer record and payment method management, recurring payment and subscription billing, multi-currency conversion and cross-border fees, business debit card issuance and spending controls, reporting dashboard and data export, push notification delivery for payment/invoice/dispute events, offline access scope, multi-account switching, and regulatory/AML compliance.
...
Build an original mobile product inspired by PayPal Business's public enterprise operations workflow. The V1 clone focuses on business payment management with transaction monitoring and search, invoicing and estimates, payment requests and payment links, money transfers and payouts, balance management and withdrawals, PayPal Checkout integration, QR code payments, card reader (Zettle) integration, dispute and chargeback management, customer management, recurring payments and subscriptions, multi-currency and cross-border payments, business debit card, reporting and analytics, push notifications for payments/invoices/disputes, and business account feature enforcement.
...
- Preserve the functional job behind PayPal Business while using original product naming, original UI, original sample data, and licensed integrations.
...
- Do not copy PayPal Business branding, logos, screenshots, marketing copy, private APIs, proprietary datasets, plan names, UI trade dress, course libraries, textbook solutions, documents, school content, AI prompts, or protected media.
...
|---|---|---|---|
| Apple App Store | https://apps.apple.com/us/app/paypal-business/id1209884153 | iOS listing, privacy labels, release notes, business payment claims, and support links | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
| Google Play | https://play.google.com/store/apps/details?id=com.paypal.merchant.client | Android listing, data safety, business payment/invoice claims, and release cadence | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
| Official product site | https://www.paypal.com/business | PayPal Business payments, invoicing, checkout, and product positioning | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
| Official help | https://www.paypal.com/us/business/support | PayPal Business setup, payments, invoicing, disputes, and troubleshooting | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
| Privacy policy | https://www.paypal.com/legalhub/privacy-full | PayPal account, payment data, analytics, and privacy disclosures | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
| Terms | https://www.paypal.com/legalhub/useragreement-full | PayPal services, payments, business, and acceptable-use boundaries | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
...
- Manual blockers must remain launch-blocking until verified: PayPal business account and verification policy, owner/admin/staff role and permission model, transaction search and filtering, invoice creation and online payment acceptance, payment request and link generation, money transfer limits and regulatory compliance, balance hold and reserve policies, PayPal Checkout integration and SDK behavior, QR code payment generation and scanning, Zettle card reader Bluetooth pairing and payment processing, dispute resolution timeline and evidence submission, customer record and payment method management, recurring payment and subscription billing, multi-currency conversion and cross-border fees, business debit card issuance and spending controls, reporting dashboard and data export, push notification delivery for payment/invoice/dispute events, offline access scope, multi-account switching, and regulatory/AML compliance.

## Core User Journeys

- User creates or restores a PayPal Business-style account, completes role, school, subscription, or tenant checks, and reaches the dashboard.
...
- Monetization model: use original free/trial/paid/sponsored/school/provider/tenant entitlement logic; do not copy exact pricing, plan names, bundle names, promotional copy, school contracts, tenant offers, or partner offers from PayPal Business.
...
- Manual verification tests for PayPal business account and verification policy, owner/admin/staff role and permission model, transaction search and filtering, invoice creation and online payment acceptance, payment request and link generation, money transfer limits and regulatory compliance, balance hold and reserve policies, PayPal Checkout integration and SDK behavior, QR code payment generation and scanning, Zettle card reader Bluetooth pairing and payment processing, dispute resolution timeline and evidence submission, customer record and payment method management, recurring payment and subscription billing, multi-currency conversion and cross-border fees, business debit card issuance and spending controls, reporting dashboard and data export, push notification delivery for payment/invoice/dispute events, offline access scope, multi-account switching, and regulatory/AML compliance.
...
- Phase 4: Add app-specific safety controls for business payment management with transaction monitoring and search, invoicing and estimates, payment requests and payment links, money transfers and payouts, balance management and withdrawals, PayPal Checkout integration, QR code payments, card reader (Zettle) integration, dispute and chargeback management, customer management, recurring payments and subscriptions, multi-currency and cross-border payments, business debit card, reporting and analytics, push notifications for payments/invoices/disputes, and business account feature enforcement.
...
- Confirm legal/privacy retention behavior for PayPal Business-style sensitive records and update API contracts before downstream implementation.
