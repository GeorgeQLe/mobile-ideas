# Square POS-Style Clone Spec

> Metadata
> - Inspiration app: Square POS
...
> - Manual verification blockers: Square account and business verification policy, seller/team-member/manager role and permission model, payment processing and card brand acceptance, Square hardware (Reader, Terminal, Register) Bluetooth/USB pairing and firmware, item catalog sync and variant management, inventory count and low-stock alerts, customer directory and loyalty program configuration, invoice creation and online payment collection, team timecard tracking and overtime rules, reporting dashboard data freshness and drill-down, digital receipt delivery (email, SMS), discount and modifier stacking rules, order management and kitchen display integration, online ordering and fulfillment workflow, gift card issuance and redemption, cash drawer management, tap to pay NFC enrollment on iOS/Android, push notification delivery for payments/orders/team events, offline payment processing and sync, multi-location management, and regulatory payment compliance.
...
Build an original mobile product inspired by Square POS's public enterprise operations workflow. The V1 clone focuses on point-of-sale with in-person and remote payment acceptance, item library and catalog management, inventory tracking, customer directory and loyalty, invoicing and estimates, team management (roles, permissions, timecards), reporting and analytics, Square Register/Terminal/Reader hardware integration, digital receipts, discounts and modifiers, order management, online ordering, gift cards, cash management, tap to pay on phone, and plan-gated feature enforcement (Free, Plus, Premium).
...
- Preserve the functional job behind Square POS while using original product naming, original UI, original sample data, and licensed integrations.
...
- Do not copy Square POS branding, logos, screenshots, marketing copy, private APIs, proprietary datasets, plan names, UI trade dress, course libraries, textbook solutions, documents, school content, AI prompts, or protected media.
...
|---|---|---|---|
| Apple App Store | https://apps.apple.com/us/app/square-point-of-sale-pos/id335393788 | iOS listing, privacy labels, release notes, POS/payment claims, and support links | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
| Google Play | https://play.google.com/store/apps/details?id=com.squareup | Android listing, data safety, POS/payment/inventory claims, and release cadence | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
| Official product site | https://squareup.com/ | Square POS, payments, hardware, invoicing, and product positioning | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
| Official help | https://squareup.com/help/us/en | Square POS setup, payments, hardware, inventory, and troubleshooting | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
| Privacy policy | https://squareup.com/legal/privacy | Square account, payment data, analytics, and privacy disclosures | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
| Terms | https://squareup.com/legal/general/ua | Square services, payment processing, and acceptable-use boundaries | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
...
- Manual blockers must remain launch-blocking until verified: Square account and business verification policy, seller/team-member/manager role and permission model, payment processing and card brand acceptance, Square hardware (Reader, Terminal, Register) Bluetooth/USB pairing and firmware, item catalog sync and variant management, inventory count and low-stock alerts, customer directory and loyalty program configuration, invoice creation and online payment collection, team timecard tracking and overtime rules, reporting dashboard data freshness and drill-down, digital receipt delivery (email, SMS), discount and modifier stacking rules, order management and kitchen display integration, online ordering and fulfillment workflow, gift card issuance and redemption, cash drawer management, tap to pay NFC enrollment on iOS/Android, push notification delivery for payments/orders/team events, offline payment processing and sync, multi-location management, and regulatory payment compliance.

## Core User Journeys

- User creates or restores a Square POS-style account, completes role, school, subscription, or tenant checks, and reaches the dashboard.
...
|---|---|---|---|---|
| Welcome/Auth | Account login, store/business selection, role assignment, SSO, and permission primers | email, SSO, store-select, verify | new, returning, multi-store, locked | SSO failed, store unavailable, account restricted, auth timeout |
| Dashboard/Home | Sales summary, recent orders/transactions, revenue metrics, alerts, and quick actions | tap, search, navigate, refresh | empty, loading, current, offline | sync failed, data stale, payout delayed, permission denied |
| Orders/Transactions | Order list, transaction details, payment status, refunds, disputes, and fulfillment tracking | view, search, filter, refund, fulfill | pending, paid, shipped, delivered, refunded, disputed | payment failed, refund error, dispute deadline, fulfillment error |
| Products/Catalog | Product management, inventory tracking, pricing, variants, categories, and catalog search | create, edit, search, archive, adjust-stock | active, draft, archived, out-of-stock | variant limit, image upload failed, inventory sync error, price conflict |
| Customers/Marketing | Customer directory, segmentation, email campaigns, loyalty, analytics, and engagement tracking | view, segment, create-campaign, send | active, subscribed, unsubscribed, bounced | campaign send failed, segment empty, unsubscribe processed, compliance block |
| Settings/Privacy | Account, store/business, payment methods, notifications, integrations, privacy, and data export | forms, toggle, connect, request | loaded, editing, syncing | payment method expired, integration error, policy override, export pending |
...
- Treat payment card and transaction data, customer PII and purchase history, product catalog and pricing, inventory levels, order and fulfillment data, payout and settlement information, dispute and chargeback evidence, subscription billing data, marketing audience and segmentation data, email campaign content and analytics, API keys and webhook secrets, PCI-scoped credentials, and marketplace/platform seller data as launch-blocking review areas with owners, mitigations, and acceptance tests before implementation.
...
- Monetization model: use original free/trial/paid/sponsored/school/provider/tenant entitlement logic; do not copy exact pricing, plan names, bundle names, promotional copy, school contracts, tenant offers, or partner offers from Square POS.
...
- Manual verification tests for Square account and business verification policy, seller/team-member/manager role and permission model, payment processing and card brand acceptance, Square hardware (Reader, Terminal, Register) Bluetooth/USB pairing and firmware, item catalog sync and variant management, inventory count and low-stock alerts, customer directory and loyalty program configuration, invoice creation and online payment collection, team timecard tracking and overtime rules, reporting dashboard data freshness and drill-down, digital receipt delivery (email, SMS), discount and modifier stacking rules, order management and kitchen display integration, online ordering and fulfillment workflow, gift card issuance and redemption, cash drawer management, tap to pay NFC enrollment on iOS/Android, push notification delivery for payments/orders/team events, offline payment processing and sync, multi-location management, and regulatory payment compliance.
...
- Phase 4: Add app-specific safety controls for point-of-sale with in-person and remote payment acceptance, item library and catalog management, inventory tracking, customer directory and loyalty, invoicing and estimates, team management (roles, permissions, timecards), reporting and analytics, Square Register/Terminal/Reader hardware integration, digital receipts, discounts and modifiers, order management, online ordering, gift cards, cash management, tap to pay on phone, and plan-gated feature enforcement (Free, Plus, Premium).
...
- Confirm legal/privacy retention behavior for Square POS-style sensitive records and update API contracts before downstream implementation.
