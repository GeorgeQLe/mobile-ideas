# Intercom-Style Clone Spec

> Metadata
> - Inspiration app: Intercom
...
> - Manual verification blockers: Intercom workspace and app policy, teammate/admin role and permission model, conversation CRUD and custom attribute validation, Fin AI agent behavior and escalation rules, inbox routing and assignment logic, proactive message targeting and scheduling, product tour rendering and step tracking, help center article indexing and search relevance, customer data platform people/company profile merging, custom bot and workflow builder logic, SLA policy configuration and breach behavior, conversation tagging and snoozing, reporting dashboard rendering and custom reports, push notification delivery for conversations/assignments/mentions, offline conversation viewing, sandbox vs production workspace behavior, and enterprise SSO/SCIM provisioning.
...
Build an original mobile product inspired by Intercom's public enterprise operations workflow. The V1 clone focuses on customer messaging platform with inbox for conversations (chat, email, social), Fin AI agent, ticket management, proactive messaging and banners, product tours and tooltips, help center articles, customer data platform (people/companies), custom bots and workflows, conversation routing and assignment, SLA management, reporting and analytics, push notifications for new conversations/assignments, team collaboration with notes and mentions, and plan-gated feature enforcement.
...
- Preserve the functional job behind Intercom while using original product naming, original UI, original sample data, and licensed integrations.
...
- Do not copy Intercom branding, logos, screenshots, marketing copy, private APIs, proprietary datasets, plan names, UI trade dress, course libraries, textbook solutions, documents, school content, AI prompts, or protected media.
...
|---|---|---|---|
| Apple App Store | https://apps.apple.com/us/app/intercom-conversations/id1145047440 | iOS listing, privacy labels, release notes, messaging/inbox claims, and support links | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
| Google Play | https://play.google.com/store/apps/details?id=io.intercom.android | Android listing, data safety, messaging/Fin AI claims, and release cadence | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
| Official product site | https://www.intercom.com/ | Intercom messenger, Fin AI, inbox, help center, and product positioning | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
| Official help | https://www.intercom.com/help | Intercom setup, inbox, bots, workflows, reporting, and troubleshooting | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
| Privacy policy | https://www.intercom.com/legal/privacy | Intercom account, conversation data, AI, analytics, and privacy disclosures | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
| Terms | https://www.intercom.com/legal/terms-of-service | Intercom services, subscriptions, enterprise, and acceptable-use boundaries | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
...
- Manual blockers must remain launch-blocking until verified: Intercom workspace and app policy, teammate/admin role and permission model, conversation CRUD and custom attribute validation, Fin AI agent behavior and escalation rules, inbox routing and assignment logic, proactive message targeting and scheduling, product tour rendering and step tracking, help center article indexing and search relevance, customer data platform people/company profile merging, custom bot and workflow builder logic, SLA policy configuration and breach behavior, conversation tagging and snoozing, reporting dashboard rendering and custom reports, push notification delivery for conversations/assignments/mentions, offline conversation viewing, sandbox vs production workspace behavior, and enterprise SSO/SCIM provisioning.

## Core User Journeys

- User creates or restores a Intercom-style account, completes role, school, subscription, or tenant checks, and reaches the dashboard.
...
|---|---|---|---|---|
| Welcome/Auth | Account login, workspace/subdomain selection, SSO/SAML, agent role assignment, and permission primers | email, SSO, workspace-select, biometric | new, returning, multi-workspace, locked | SSO failed, workspace unavailable, license expired, auth timeout |
| Inbox/Views | Ticket or conversation inbox, views and filters, search, priority/status indicators, and bulk actions | tap, search, filter, sort, bulk-select | empty, loading, filtered, unread | view empty, filter mismatch, sync failed, offline stale |
| Ticket/Conversation Detail | Ticket or conversation thread, customer context, internal notes, macros/canned responses, SLA timer, and status transitions | reply, note, macro, escalate, resolve | open, pending, on-hold, solved, closed | SLA breached, merge conflict, assignment collision, reply failed |
| Knowledge Base | Article search and suggestions, article viewer, category browsing, and article linking to tickets | search, browse, link, suggest | loading, results, empty, linked | article missing, search failed, stale suggestions, permission denied |
| Reporting/Analytics | Dashboard metrics, ticket volume, SLA performance, agent performance, CSAT scores, and drill-down | view, filter, drill-down, export | loading, loaded, filtered, empty | data stale, report timeout, export failed, permission denied |
| Settings/Privacy | Account, workspace, notification preferences, signature, availability, privacy, support, and data export | forms, toggle, configure, request | loaded, editing, syncing | workspace policy override, SSO required, role restricted |
...
- Treat customer ticket and conversation data, agent internal notes, customer PII, SLA configuration, macro and automation rules, knowledge base content, CSAT survey responses, workspace/organization policies, SSO/SCIM credentials, API keys, webhook payloads, audit logs, and agent performance metrics as launch-blocking review areas with owners, mitigations, and acceptance tests before implementation.
...
- Monetization model: use original free/trial/paid/sponsored/school/provider/tenant entitlement logic; do not copy exact pricing, plan names, bundle names, promotional copy, school contracts, tenant offers, or partner offers from Intercom.
...
- Manual verification tests for Intercom workspace and app policy, teammate/admin role and permission model, conversation CRUD and custom attribute validation, Fin AI agent behavior and escalation rules, inbox routing and assignment logic, proactive message targeting and scheduling, product tour rendering and step tracking, help center article indexing and search relevance, customer data platform people/company profile merging, custom bot and workflow builder logic, SLA policy configuration and breach behavior, conversation tagging and snoozing, reporting dashboard rendering and custom reports, push notification delivery for conversations/assignments/mentions, offline conversation viewing, sandbox vs production workspace behavior, and enterprise SSO/SCIM provisioning.
...
- Phase 4: Add app-specific safety controls for customer messaging platform with inbox for conversations (chat, email, social), Fin AI agent, ticket management, proactive messaging and banners, product tours and tooltips, help center articles, customer data platform (people/companies), custom bots and workflows, conversation routing and assignment, SLA management, reporting and analytics, push notifications for new conversations/assignments, team collaboration with notes and mentions, and plan-gated feature enforcement.
...
- Confirm legal/privacy retention behavior for Intercom-style sensitive records and update API contracts before downstream implementation.
