# BambooHR-Style Clone Spec

> Metadata
> - Inspiration app: BambooHR
...
> - Manual verification blockers: BambooHR account and company domain policy, employee/manager/admin access level model, time-off type configuration and accrual rules, time tracking project/task setup, pay stub visibility and payroll integration, benefits enrollment and deduction configuration, onboarding checklist template and task assignment, performance review cycle and feedback workflow, document category permissions and e-signature workflow, company announcement targeting, approval chain configuration, ATS job posting and candidate pipeline, report builder field and filter access, push notification delivery for approvals/requests/announcements, offline access scope, API integration with payroll providers, and SSO/SAML provisioning.
...
Build an original mobile product inspired by BambooHR's public enterprise operations workflow. The V1 clone focuses on HR platform with employee self-service, employee directory and org chart, time-off requests and approvals, time tracking with clock in/out, pay stubs and compensation, benefits administration, onboarding checklists, performance management (goals, reviews, feedback), employee documents and e-signatures, company announcements, approval workflows, hiring and ATS (applicant tracking), reporting and analytics, and plan-gated feature enforcement.
...
- Preserve the functional job behind BambooHR while using original product naming, original UI, original sample data, and licensed integrations.
...
- Do not copy BambooHR branding, logos, screenshots, marketing copy, private APIs, proprietary datasets, plan names, UI trade dress, course libraries, textbook solutions, documents, school content, AI prompts, or protected media.
...
|---|---|---|---|
| Apple App Store | https://apps.apple.com/us/app/bamboohr/id1071739748 | iOS listing, privacy labels, release notes, HR/employee self-service claims, and support links | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
| Google Play | https://play.google.com/store/apps/details?id=com.bamboohr.mobile | Android listing, data safety, HR/time tracking claims, and release cadence | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
| Official product site | https://www.bamboohr.com/ | BambooHR HR platform, payroll, time tracking, hiring, and product positioning | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
| Official help | https://help.bamboohr.com/ | BambooHR setup, employee management, time off, payroll, and troubleshooting | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
| Privacy policy | https://www.bamboohr.com/privacy-policy | BambooHR account, employee data, analytics, and privacy disclosures | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
| Terms | https://www.bamboohr.com/terms-of-service | BambooHR services, subscriptions, enterprise, and acceptable-use boundaries | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
...
- Manual blockers must remain launch-blocking until verified: BambooHR account and company domain policy, employee/manager/admin access level model, time-off type configuration and accrual rules, time tracking project/task setup, pay stub visibility and payroll integration, benefits enrollment and deduction configuration, onboarding checklist template and task assignment, performance review cycle and feedback workflow, document category permissions and e-signature workflow, company announcement targeting, approval chain configuration, ATS job posting and candidate pipeline, report builder field and filter access, push notification delivery for approvals/requests/announcements, offline access scope, API integration with payroll providers, and SSO/SAML provisioning.

## Core User Journeys

- User creates or restores a BambooHR-style account, completes role, school, subscription, or tenant checks, and reaches the dashboard.
...
- Monetization model: use original free/trial/paid/sponsored/school/provider/tenant entitlement logic; do not copy exact pricing, plan names, bundle names, promotional copy, school contracts, tenant offers, or partner offers from BambooHR.
...
- Manual verification tests for BambooHR account and company domain policy, employee/manager/admin access level model, time-off type configuration and accrual rules, time tracking project/task setup, pay stub visibility and payroll integration, benefits enrollment and deduction configuration, onboarding checklist template and task assignment, performance review cycle and feedback workflow, document category permissions and e-signature workflow, company announcement targeting, approval chain configuration, ATS job posting and candidate pipeline, report builder field and filter access, push notification delivery for approvals/requests/announcements, offline access scope, API integration with payroll providers, and SSO/SAML provisioning.
...
- Phase 4: Add app-specific safety controls for HR platform with employee self-service, employee directory and org chart, time-off requests and approvals, time tracking with clock in/out, pay stubs and compensation, benefits administration, onboarding checklists, performance management (goals, reviews, feedback), employee documents and e-signatures, company announcements, approval workflows, hiring and ATS (applicant tracking), reporting and analytics, and plan-gated feature enforcement.
...
- Confirm legal/privacy retention behavior for BambooHR-style sensitive records and update API contracts before downstream implementation.
