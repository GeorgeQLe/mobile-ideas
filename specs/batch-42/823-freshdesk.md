# Freshdesk-Style Clone Spec

> Metadata
> - Inspiration app: Freshdesk
...
> - Manual verification blockers: Freshdesk account and portal policy, agent/admin role and permission model, ticket CRUD and field validation, omnichannel routing configuration, SLA policy and escalation rules, Freddy AI auto-triage accuracy and model availability, canned response placeholder resolution, knowledge base article SEO and search, team inbox shared ownership and collision detection, time tracking entry and billing integration, CSAT survey delivery and scoring, scenario automation conditions and actions, parent-child ticket linking and status propagation, reporting dashboard rendering, push notification delivery for ticket events, offline ticket access, sandbox environment, and enterprise SSO/SCIM provisioning.
...
Build an original mobile product inspired by Freshdesk's public enterprise operations workflow. The V1 clone focuses on helpdesk with ticket management, omnichannel support (email, phone, chat, social, WhatsApp), ticket views and filters, canned responses and templates, SLA policies and escalation, Freddy AI (auto-triage, suggested responses, sentiment), knowledge base with article categories, team collaboration with private notes and shared ownership, time tracking, customer satisfaction surveys, scenario automations, reporting and analytics, parent-child ticketing, and plan-gated feature enforcement.
...
- Preserve the functional job behind Freshdesk while using original product naming, original UI, original sample data, and licensed integrations.
...
- Do not copy Freshdesk branding, logos, screenshots, marketing copy, private APIs, proprietary datasets, plan names, UI trade dress, course libraries, textbook solutions, documents, school content, AI prompts, or protected media.
...
|---|---|---|---|
| Apple App Store | https://apps.apple.com/us/app/freshdesk/id691location397855 | iOS listing, privacy labels, release notes, helpdesk/ticketing claims, and support links | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
| Google Play | https://play.google.com/store/apps/details?id=com.freshdesk.helpdesk | Android listing, data safety, helpdesk/Freddy AI claims, and release cadence | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
| Official product site | https://www.freshworks.com/freshdesk/ | Freshdesk helpdesk, omnichannel, Freddy AI, and product positioning | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
| Official help | https://support.freshdesk.com/support/home | Freshdesk setup, ticketing, automations, SLA, and troubleshooting | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
| Privacy policy | https://www.freshworks.com/privacy/ | Freshworks account, ticket data, AI, analytics, and privacy disclosures | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
| Terms | https://www.freshworks.com/terms/ | Freshworks services, subscriptions, enterprise, and acceptable-use boundaries | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
...
- Manual blockers must remain launch-blocking until verified: Freshdesk account and portal policy, agent/admin role and permission model, ticket CRUD and field validation, omnichannel routing configuration, SLA policy and escalation rules, Freddy AI auto-triage accuracy and model availability, canned response placeholder resolution, knowledge base article SEO and search, team inbox shared ownership and collision detection, time tracking entry and billing integration, CSAT survey delivery and scoring, scenario automation conditions and actions, parent-child ticket linking and status propagation, reporting dashboard rendering, push notification delivery for ticket events, offline ticket access, sandbox environment, and enterprise SSO/SCIM provisioning.

## Core User Journeys

- User creates or restores a Freshdesk-style account, completes role, school, subscription, or tenant checks, and reaches the dashboard.
...
- Monetization model: use original free/trial/paid/sponsored/school/provider/tenant entitlement logic; do not copy exact pricing, plan names, bundle names, promotional copy, school contracts, tenant offers, or partner offers from Freshdesk.
...
- Manual verification tests for Freshdesk account and portal policy, agent/admin role and permission model, ticket CRUD and field validation, omnichannel routing configuration, SLA policy and escalation rules, Freddy AI auto-triage accuracy and model availability, canned response placeholder resolution, knowledge base article SEO and search, team inbox shared ownership and collision detection, time tracking entry and billing integration, CSAT survey delivery and scoring, scenario automation conditions and actions, parent-child ticket linking and status propagation, reporting dashboard rendering, push notification delivery for ticket events, offline ticket access, sandbox environment, and enterprise SSO/SCIM provisioning.
...
- Phase 4: Add app-specific safety controls for helpdesk with ticket management, omnichannel support (email, phone, chat, social, WhatsApp), ticket views and filters, canned responses and templates, SLA policies and escalation, Freddy AI (auto-triage, suggested responses, sentiment), knowledge base with article categories, team collaboration with private notes and shared ownership, time tracking, customer satisfaction surveys, scenario automations, reporting and analytics, parent-child ticketing, and plan-gated feature enforcement.
...
- Confirm legal/privacy retention behavior for Freshdesk-style sensitive records and update API contracts before downstream implementation.
