# Gusto Wallet-Style Clone Spec

> Metadata
> - Inspiration app: Gusto Wallet
...
> - Manual verification blockers: Gusto employer and employee account policy, Gusto Cash Account banking partner and FDIC coverage, direct deposit split configuration and verification, Cashout (pay-on-demand) eligibility and employer opt-in, savings goal automation and transfer timing, financial health insight data sourcing, tax document availability and delivery schedule, benefits plan visibility per employer configuration, time-off balance and accrual per employer policy, directory visibility settings, push notification delivery for pay/deposit/savings events, offline access scope, employer-employee account linking and invitation flow, and banking regulatory compliance.
...
Build an original mobile product inspired by Gusto Wallet's public enterprise operations workflow. The V1 clone focuses on employee financial wellness with pay stubs and earnings breakdown, Gusto Cash Account (spending and savings), direct deposit split management, pay-on-demand (Gusto Cashout), savings goals and automatic transfers, financial health insights, tax documents (W-2, 1099), benefits overview, time-off balances, employee directory, push notifications for payday/deposits/goals, and employer-linked account provisioning.
...
- Preserve the functional job behind Gusto Wallet while using original product naming, original UI, original sample data, and licensed integrations.
...
- Do not copy Gusto Wallet branding, logos, screenshots, marketing copy, private APIs, proprietary datasets, plan names, UI trade dress, course libraries, textbook solutions, documents, school content, AI prompts, or protected media.
...
|---|---|---|---|
| Apple App Store | https://apps.apple.com/us/app/gusto-wallet/id1477169234 | iOS listing, privacy labels, release notes, payroll/wallet claims, and support links | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
| Google Play | https://play.google.com/store/apps/details?id=com.gustowallet.app | Android listing, data safety, payroll/cash account claims, and release cadence | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
| Official product site | https://gusto.com/wallet | Gusto Wallet employee financial wellness, cash account, and product positioning | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
| Official help | https://support.gusto.com/ | Gusto Wallet setup, cash account, direct deposit, and troubleshooting | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
| Privacy policy | https://gusto.com/about/privacy | Gusto account, payroll data, financial data, analytics, and privacy disclosures | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
| Terms | https://gusto.com/about/terms | Gusto services, wallet, banking, and acceptable-use boundaries | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
...
- Manual blockers must remain launch-blocking until verified: Gusto employer and employee account policy, Gusto Cash Account banking partner and FDIC coverage, direct deposit split configuration and verification, Cashout (pay-on-demand) eligibility and employer opt-in, savings goal automation and transfer timing, financial health insight data sourcing, tax document availability and delivery schedule, benefits plan visibility per employer configuration, time-off balance and accrual per employer policy, directory visibility settings, push notification delivery for pay/deposit/savings events, offline access scope, employer-employee account linking and invitation flow, and banking regulatory compliance.

## Core User Journeys

- User creates or restores a Gusto Wallet-style account, completes role, school, subscription, or tenant checks, and reaches the dashboard.
...
- Monetization model: use original free/trial/paid/sponsored/school/provider/tenant entitlement logic; do not copy exact pricing, plan names, bundle names, promotional copy, school contracts, tenant offers, or partner offers from Gusto Wallet.
...
- Manual verification tests for Gusto employer and employee account policy, Gusto Cash Account banking partner and FDIC coverage, direct deposit split configuration and verification, Cashout (pay-on-demand) eligibility and employer opt-in, savings goal automation and transfer timing, financial health insight data sourcing, tax document availability and delivery schedule, benefits plan visibility per employer configuration, time-off balance and accrual per employer policy, directory visibility settings, push notification delivery for pay/deposit/savings events, offline access scope, employer-employee account linking and invitation flow, and banking regulatory compliance.
...
- Phase 4: Add app-specific safety controls for employee financial wellness with pay stubs and earnings breakdown, Gusto Cash Account (spending and savings), direct deposit split management, pay-on-demand (Gusto Cashout), savings goals and automatic transfers, financial health insights, tax documents (W-2, 1099), benefits overview, time-off balances, employee directory, push notifications for payday/deposits/goals, and employer-linked account provisioning.
...
- Confirm legal/privacy retention behavior for Gusto Wallet-style sensitive records and update API contracts before downstream implementation.
