# Zendesk-Style Clone Spec

> Metadata
> - Inspiration app: Zendesk
...
> - Manual verification blockers: Zendesk account and subdomain policy, agent/admin role and permission model, ticket CRUD and field validation rules, omnichannel routing (email, chat, social, voice) channel integration, SLA policy configuration and breach behavior, macro execution and placeholder resolution, CSAT survey delivery and response collection, knowledge base article indexing and suggestion relevance, side conversation privacy and threading, ticket merge/link data integrity, trigger and automation evaluation order, custom field and form conditional logic, reporting dashboard rendering and drill-down, agent workspace layout and context panel data loading, push notification delivery for ticket assignments/updates/SLA breaches, offline ticket viewing, sandbox vs production environment behavior, and enterprise SSO/SCIM provisioning.
...
Build an original mobile product inspired by Zendesk's public enterprise operations workflow. The V1 clone focuses on customer support with ticket management, omnichannel inbox (email, chat, social, voice), ticket views and macros, SLA tracking and escalation, agent workspace with context panel, canned responses and dynamic content, customer satisfaction (CSAT) surveys, knowledge base article suggestions, side conversations, ticket merging and linking, custom fields and forms, triggers and automations, reporting and analytics dashboards, and plan-gated feature enforcement.
...
- Preserve the functional job behind Zendesk while using original product naming, original UI, original sample data, and licensed integrations.
...
- Do not copy Zendesk branding, logos, screenshots, marketing copy, private APIs, proprietary datasets, plan names, UI trade dress, course libraries, textbook solutions, documents, school content, AI prompts, or protected media.
...
|---|---|---|---|
| Apple App Store | https://apps.apple.com/us/app/zendesk-support/id1174276185 | iOS listing, privacy labels, release notes, support/ticketing claims, and support links | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
| Google Play | https://play.google.com/store/apps/details?id=com.zendesk.android | Android listing, data safety, support/omnichannel claims, and release cadence | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
| Official product site | https://www.zendesk.com/ | Zendesk support suite, omnichannel, AI, analytics, and product positioning | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
| Official help | https://support.zendesk.com/hc/en-us | Zendesk setup, ticketing, routing, macros, SLA, and troubleshooting | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
| Privacy policy | https://www.zendesk.com/company/agreements-and-terms/privacy-notice/ | Zendesk account, ticket data, analytics, AI, and privacy disclosures | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
| Terms | https://www.zendesk.com/company/agreements-and-terms/master-subscription-agreement/ | Zendesk services, subscriptions, enterprise, and acceptable-use boundaries | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
...
- Manual blockers must remain launch-blocking until verified: Zendesk account and subdomain policy, agent/admin role and permission model, ticket CRUD and field validation rules, omnichannel routing (email, chat, social, voice) channel integration, SLA policy configuration and breach behavior, macro execution and placeholder resolution, CSAT survey delivery and response collection, knowledge base article indexing and suggestion relevance, side conversation privacy and threading, ticket merge/link data integrity, trigger and automation evaluation order, custom field and form conditional logic, reporting dashboard rendering and drill-down, agent workspace layout and context panel data loading, push notification delivery for ticket assignments/updates/SLA breaches, offline ticket viewing, sandbox vs production environment behavior, and enterprise SSO/SCIM provisioning.

## Core User Journeys

- User creates or restores a Zendesk-style account, completes role, school, subscription, or tenant checks, and reaches the dashboard.
...
- Monetization model: use original free/trial/paid/sponsored/school/provider/tenant entitlement logic; do not copy exact pricing, plan names, bundle names, promotional copy, school contracts, tenant offers, or partner offers from Zendesk.
...
- Manual verification tests for Zendesk account and subdomain policy, agent/admin role and permission model, ticket CRUD and field validation rules, omnichannel routing (email, chat, social, voice) channel integration, SLA policy configuration and breach behavior, macro execution and placeholder resolution, CSAT survey delivery and response collection, knowledge base article indexing and suggestion relevance, side conversation privacy and threading, ticket merge/link data integrity, trigger and automation evaluation order, custom field and form conditional logic, reporting dashboard rendering and drill-down, agent workspace layout and context panel data loading, push notification delivery for ticket assignments/updates/SLA breaches, offline ticket viewing, sandbox vs production environment behavior, and enterprise SSO/SCIM provisioning.
...
- Phase 4: Add app-specific safety controls for customer support with ticket management, omnichannel inbox (email, chat, social, voice), ticket views and macros, SLA tracking and escalation, agent workspace with context panel, canned responses and dynamic content, customer satisfaction (CSAT) surveys, knowledge base article suggestions, side conversations, ticket merging and linking, custom fields and forms, triggers and automations, reporting and analytics dashboards, and plan-gated feature enforcement.
...
- Confirm legal/privacy retention behavior for Zendesk-style sensitive records and update API contracts before downstream implementation.
