# QuickBooks-Style Clone Spec

> Metadata
> - Inspiration app: QuickBooks
...
> - Manual verification blockers: Intuit/QuickBooks account and company policy, owner/admin/accountant/employee role and access model, invoice creation and payment acceptance (QuickBooks Payments), estimate-to-invoice conversion workflow, receipt capture OCR accuracy, bank feed connection and transaction matching, categorization rule and auto-categorization accuracy, P&L and balance sheet GAAP compliance, cash flow forecast methodology, mileage tracking GPS accuracy, sales tax rate lookup and filing jurisdiction, recurring transaction scheduling, customer/vendor profile and transaction history, project profitability tracking and billable time, inventory tracking and COGS calculation, payroll processing and tax filing integration, accountant invite and books review workflow, push notification delivery for invoice/payment/bank events, offline access scope, multi-currency and multi-company handling, and enterprise SSO provisioning.
...
Build an original mobile product inspired by QuickBooks's public enterprise operations workflow. The V1 clone focuses on small business accounting with invoicing and estimates, expense tracking and receipt capture, bank and credit card connections (bank feeds), income and expense categorization, profit and loss reporting, balance sheet, cash flow tracking, mileage tracking, sales tax management, recurring transactions, customer and vendor management, project tracking, inventory management, payroll (QuickBooks Payroll add-on), accountant collaboration, push notifications for invoices/payments/bank feeds, and plan-gated feature enforcement (Simple Start, Essentials, Plus, Advanced).
...
- Preserve the functional job behind QuickBooks while using original product naming, original UI, original sample data, and licensed integrations.
...
- Do not copy QuickBooks branding, logos, screenshots, marketing copy, private APIs, proprietary datasets, plan names, UI trade dress, course libraries, textbook solutions, documents, school content, AI prompts, or protected media.
...
|---|---|---|---|
| Apple App Store | https://apps.apple.com/us/app/quickbooks-accounting/id584148244 | iOS listing, privacy labels, release notes, accounting/invoicing claims, and support links | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
| Google Play | https://play.google.com/store/apps/details?id=com.intuit.quickbooks | Android listing, data safety, accounting/receipt claims, and release cadence | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
| Official product site | https://quickbooks.intuit.com/ | QuickBooks small business accounting, invoicing, payroll, and product positioning | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
| Official help | https://quickbooks.intuit.com/learn-support/ | QuickBooks setup, accounting, invoicing, bank feeds, and troubleshooting | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
| Privacy policy | https://www.intuit.com/privacy/statement/ | Intuit/QuickBooks account, financial data, analytics, AI, and privacy disclosures | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
| Terms | https://accounts.intuit.com/terms-of-service | Intuit/QuickBooks services, subscriptions, and acceptable-use boundaries | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
...
- Manual blockers must remain launch-blocking until verified: Intuit/QuickBooks account and company policy, owner/admin/accountant/employee role and access model, invoice creation and payment acceptance (QuickBooks Payments), estimate-to-invoice conversion workflow, receipt capture OCR accuracy, bank feed connection and transaction matching, categorization rule and auto-categorization accuracy, P&L and balance sheet GAAP compliance, cash flow forecast methodology, mileage tracking GPS accuracy, sales tax rate lookup and filing jurisdiction, recurring transaction scheduling, customer/vendor profile and transaction history, project profitability tracking and billable time, inventory tracking and COGS calculation, payroll processing and tax filing integration, accountant invite and books review workflow, push notification delivery for invoice/payment/bank events, offline access scope, multi-currency and multi-company handling, and enterprise SSO provisioning.

## Core User Journeys

- User creates or restores a QuickBooks-style account, completes role, school, subscription, or tenant checks, and reaches the dashboard.
...
- Monetization model: use original free/trial/paid/sponsored/school/provider/tenant entitlement logic; do not copy exact pricing, plan names, bundle names, promotional copy, school contracts, tenant offers, or partner offers from QuickBooks.
...
- Manual verification tests for Intuit/QuickBooks account and company policy, owner/admin/accountant/employee role and access model, invoice creation and payment acceptance (QuickBooks Payments), estimate-to-invoice conversion workflow, receipt capture OCR accuracy, bank feed connection and transaction matching, categorization rule and auto-categorization accuracy, P&L and balance sheet GAAP compliance, cash flow forecast methodology, mileage tracking GPS accuracy, sales tax rate lookup and filing jurisdiction, recurring transaction scheduling, customer/vendor profile and transaction history, project profitability tracking and billable time, inventory tracking and COGS calculation, payroll processing and tax filing integration, accountant invite and books review workflow, push notification delivery for invoice/payment/bank events, offline access scope, multi-currency and multi-company handling, and enterprise SSO provisioning.
...
- Phase 4: Add app-specific safety controls for small business accounting with invoicing and estimates, expense tracking and receipt capture, bank and credit card connections (bank feeds), income and expense categorization, profit and loss reporting, balance sheet, cash flow tracking, mileage tracking, sales tax management, recurring transactions, customer and vendor management, project tracking, inventory management, payroll (QuickBooks Payroll add-on), accountant collaboration, push notifications for invoices/payments/bank feeds, and plan-gated feature enforcement (Simple Start, Essentials, Plus, Advanced).
...
- Confirm legal/privacy retention behavior for QuickBooks-style sensitive records and update API contracts before downstream implementation.
