# Mailchimp-Style Clone Spec

> Metadata
> - Inspiration app: Mailchimp
...
> - Manual verification blockers: Mailchimp/Intuit account and audience policy, owner/admin/author/viewer role and permission model, campaign creation and content editor rendering on mobile, audience list management and GDPR/CAN-SPAM compliance, email template gallery and custom HTML, automation workflow trigger and action configuration, landing page builder and hosting, signup form embedding and double opt-in, A/B test split methodology and winner selection, report metrics calculation and attribution, contact import validation and duplicate handling, tag and segment builder field logic, social media platform API integration, postcard design and print/mail fulfillment, customer journey builder condition and branching, predicted demographics and send time optimization model accuracy, push notification delivery for campaign/audience events, offline access scope, multi-audience management, and transactional email (Mandrill) integration.
...
Build an original mobile product inspired by Mailchimp's public enterprise operations workflow. The V1 clone focuses on email marketing platform with campaign creation and editing, audience management and segmentation, email templates and drag-and-drop editor, automation workflows (customer journeys), landing pages and signup forms, A/B testing, reporting and analytics (opens, clicks, revenue), contact import and tagging, social media posting, postcards, customer journey builder, predicted demographics and send time optimization, push notifications for campaign stats/audience growth, and plan-gated feature enforcement (Free, Essentials, Standard, Premium).
...
- Preserve the functional job behind Mailchimp while using original product naming, original UI, original sample data, and licensed integrations.
...
- Do not copy Mailchimp branding, logos, screenshots, marketing copy, private APIs, proprietary datasets, plan names, UI trade dress, course libraries, textbook solutions, documents, school content, AI prompts, or protected media.
...
|---|---|---|---|
| Apple App Store | https://apps.apple.com/us/app/mailchimp-email-marketing/id666900020 | iOS listing, privacy labels, release notes, email marketing/automation claims, and support links | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
| Google Play | https://play.google.com/store/apps/details?id=com.mailchimp.mailchimp | Android listing, data safety, email marketing/audience claims, and release cadence | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
| Official product site | https://mailchimp.com/ | Mailchimp email marketing, automation, audience, and product positioning | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
| Official help | https://mailchimp.com/help/ | Mailchimp setup, campaigns, audiences, automations, and troubleshooting | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
| Privacy policy | https://www.intuit.com/privacy/statement/ | Intuit/Mailchimp account, audience data, analytics, AI, and privacy disclosures | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
| Terms | https://mailchimp.com/legal/terms/ | Mailchimp services, subscriptions, email, and acceptable-use boundaries | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
...
- Manual blockers must remain launch-blocking until verified: Mailchimp/Intuit account and audience policy, owner/admin/author/viewer role and permission model, campaign creation and content editor rendering on mobile, audience list management and GDPR/CAN-SPAM compliance, email template gallery and custom HTML, automation workflow trigger and action configuration, landing page builder and hosting, signup form embedding and double opt-in, A/B test split methodology and winner selection, report metrics calculation and attribution, contact import validation and duplicate handling, tag and segment builder field logic, social media platform API integration, postcard design and print/mail fulfillment, customer journey builder condition and branching, predicted demographics and send time optimization model accuracy, push notification delivery for campaign/audience events, offline access scope, multi-audience management, and transactional email (Mandrill) integration.

## Core User Journeys

- User creates or restores a Mailchimp-style account, completes role, school, subscription, or tenant checks, and reaches the dashboard.
...
- Monetization model: use original free/trial/paid/sponsored/school/provider/tenant entitlement logic; do not copy exact pricing, plan names, bundle names, promotional copy, school contracts, tenant offers, or partner offers from Mailchimp.
...
- Manual verification tests for Mailchimp/Intuit account and audience policy, owner/admin/author/viewer role and permission model, campaign creation and content editor rendering on mobile, audience list management and GDPR/CAN-SPAM compliance, email template gallery and custom HTML, automation workflow trigger and action configuration, landing page builder and hosting, signup form embedding and double opt-in, A/B test split methodology and winner selection, report metrics calculation and attribution, contact import validation and duplicate handling, tag and segment builder field logic, social media platform API integration, postcard design and print/mail fulfillment, customer journey builder condition and branching, predicted demographics and send time optimization model accuracy, push notification delivery for campaign/audience events, offline access scope, multi-audience management, and transactional email (Mandrill) integration.
...
- Phase 4: Add app-specific safety controls for email marketing platform with campaign creation and editing, audience management and segmentation, email templates and drag-and-drop editor, automation workflows (customer journeys), landing pages and signup forms, A/B testing, reporting and analytics (opens, clicks, revenue), contact import and tagging, social media posting, postcards, customer journey builder, predicted demographics and send time optimization, push notifications for campaign stats/audience growth, and plan-gated feature enforcement (Free, Essentials, Standard, Premium).
...
- Confirm legal/privacy retention behavior for Mailchimp-style sensitive records and update API contracts before downstream implementation.
