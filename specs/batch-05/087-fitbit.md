...
## Overview
Build an original mobile product inspired by Fitbit's user-facing workflow, not its brand identity or proprietary implementation.
The clone target is: Activity dashboard, sleep tracking, heart metrics, goals, badges, device sync, and health insights.
...
- Implement the app-specific focus: Activity dashboard, sleep tracking, heart metrics, goals, badges, device sync, and health insights.
...
## Non-Goals
- Do not copy Fitbit branding, trade dress, logos, app icons, screenshots, marketing copy, or proprietary media.
...
## Research Sources
- App Store source-discovery link: https://apps.apple.com/us/search?term=Fitbit
- Google Play source-discovery link: https://play.google.com/store/search?q=Fitbit&c=apps
- Official help/privacy source-discovery link: https://www.google.com/search?q=Fitbit%20official%20app%20help%20privacy
