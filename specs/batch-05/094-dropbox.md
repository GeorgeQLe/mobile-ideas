# Dropbox-Style Clone Spec

> Metadata
> - Inspiration app: Dropbox
> - Category: Cloud storage, file sync, backup, sharing, document scanning, transfer, file requests, password/vault-style security, teams, and admin controls
...
> - Manual verification blockers: signup/login, camera upload permission, scan quality, large upload/download, offline file behavior, share-link settings, file request submission by non-users, transfer expiry, version restore, deleted-file recovery, paid storage checkout, team admin restrictions, API OAuth, data export, account deletion, and support escalation still require lawful test devices/accounts, provider approvals, paid plans, hardware where applicable, and regional access before one-for-one parity claims.
...
Build an original mobile app inspired by Dropbox's public workflow: cloud files, folders, camera uploads, offline files, previews, sharing links, permissions, file requests, transfer, scanning PDFs, version history, deleted file recovery, team folders, admin sharing controls, and storage subscriptions.

The clone must not copy Dropbox branding, screenshots, marketing copy, protected UI artwork, proprietary assets, private APIs, internal ranking systems, unreleased behavior, paid content, or support scripts. Functional parity should be expressed through original product language, original or licensed assets, documented provider contracts, and explicit privacy/security boundaries.
...
- Provide a mobile-first Dropbox-inspired experience for cloud files, folders, camera uploads, offline files, previews, sharing links, permissions, file requests, transfer, scanning PDFs, version history, deleted file recovery, team folders, admin sharing controls, and storage subscriptions.
...
- Preserve category trust expectations around cloud file privacy, link exposure, team admin access, camera roll backup, document scans, deleted-file retention, legal requests, storage limits, and third-party integrations.
...
- Do not build a Dropbox-branded product or imply affiliation with the inspiration app, its parent company, marketplace operators, creators, or integration partners.
...
|---|---|---|---|
| Apple App Store | https://apps.apple.com/us/app/dropbox-cloud-storage-backup/id327630330 | Official iOS listing, developer, category, age rating, platform support, privacy labels, in-app purchase disclosure, app positioning, and release context | Verified 2026-04-19 |
| Google Play | https://play.google.com/store/apps/details?id=com.dropbox.android | Official Android listing, package id, install/rating scale, data safety, in-app purchase disclosure where applicable, device support, and app positioning | Verified 2026-04-19 |
| Help Center | https://help.dropbox.com/ | First-party support paths, feature docs, troubleshooting, account controls, and implementation blockers | Verified 2026-04-19 |
| Privacy Policy | https://www.dropbox.com/privacy | Personal data, content data, privacy controls, deletion/export, analytics, security, and regional disclosure requirements | Verified 2026-04-19 |
| Terms | https://www.dropbox.com/terms | User obligations, subscription/payment terms, acceptable use, content ownership, service limitations, and dispute/legal requirements | Verified 2026-04-19 |
| Sharing Help | https://help.dropbox.com/share | Public product, developer, pricing, AI, security, or feature documentation used to scope V1 requirements | Verified 2026-04-19 |
| File Requests | https://help.dropbox.com/share/create-file-request | Public product, developer, pricing, AI, security, or feature documentation used to scope V1 requirements | Verified 2026-04-19 |
| Privacy FAQ | https://help.dropbox.com/view-edit/privacy-settings-dropbox-ai | Public product, developer, pricing, AI, security, or feature documentation used to scope V1 requirements | Verified 2026-04-19 |
| Developers | https://www.dropbox.com/developers | Public product, developer, pricing, AI, security, or feature documentation used to scope V1 requirements | Verified 2026-04-19 |

## Detailed Design

### Source-Backed Product Requirements

- V1 must support files/folders, upload/download, preview for common types, offline pins, camera uploads, scanner-to-PDF, recent/important files, and search.
- Sharing must include direct invites, shared links, link permissions, passwords/expiry where entitled, external sharing controls, and unshare/revoke flows.
- File requests and transfer-style packages must allow non-user upload/download workflows with quota, deadline, access, and malware/abuse checks.
- Version history and deleted-file recovery require plan-aware retention windows, audit events, and irreversible-delete warnings.
- Team and admin behavior must separate personal files, team folders, external sharing policies, legal request notices, and organization-managed accounts.
...
- Phase 1: implement auth shell, Files Home, Folder Detail, settings/privacy, seed data, and exact-source legal links with no proprietary assets.
- Phase 2: implement core objects (FileObject, Folder, Revision, SharedLink, PermissionGrant), CRUD routes, search, notifications, offline cache, and permission-denied fallbacks.
...
- Phase 4: implement category-specific advanced surfaces for cloud files, folders, camera uploads, offline files, previews, sharing links, permissions, file requests, transfer, scanning PDFs, version history, deleted file recovery, team folders, admin sharing controls, and storage subscriptions behind feature flags and manual-verification blockers.
...
- New user installs the app, creates or signs into an account, accepts required terms, grants only action-triggered permissions, and reaches the primary Dropbox home surface.
- Returning user opens the app, resumes the latest cloud files context, completes the core action, and confirms sync state.
...
|---|---|---|---|---|
| Files Home | Dropbox-specific workflow for files home | taps, forms, deep links, permissions, account context | empty, loading, loaded, offline, read-only, signed-out | permission denied, stale sync, entitlement blocked, deleted object, provider error |
| Folder Detail | Dropbox-specific workflow for folder detail | taps, forms, deep links, permissions, account context | empty, loading, loaded, offline, read-only, signed-out | permission denied, stale sync, entitlement blocked, deleted object, provider error |
| File Preview | Dropbox-specific workflow for file preview | taps, forms, deep links, permissions, account context | empty, loading, loaded, offline, read-only, signed-out | permission denied, stale sync, entitlement blocked, deleted object, provider error |
| Upload/Scan | Dropbox-specific workflow for upload/scan | taps, forms, deep links, permissions, account context | empty, loading, loaded, offline, read-only, signed-out | permission denied, stale sync, entitlement blocked, deleted object, provider error |
| Camera Uploads | Dropbox-specific workflow for camera uploads | taps, forms, deep links, permissions, account context | empty, loading, loaded, offline, read-only, signed-out | permission denied, stale sync, entitlement blocked, deleted object, provider error |
| Share Link | Dropbox-specific workflow for share link | taps, forms, deep links, permissions, account context | empty, loading, loaded, offline, read-only, signed-out | permission denied, stale sync, entitlement blocked, deleted object, provider error |
| File Request | Dropbox-specific workflow for file request | taps, forms, deep links, permissions, account context | empty, loading, loaded, offline, read-only, signed-out | permission denied, stale sync, entitlement blocked, deleted object, provider error |
| Transfer | Dropbox-specific workflow for transfer | taps, forms, deep links, permissions, account context | empty, loading, loaded, offline, read-only, signed-out | permission denied, stale sync, entitlement blocked, deleted object, provider error |
| Offline Files | Dropbox-specific workflow for offline files | taps, forms, deep links, permissions, account context | empty, loading, loaded, offline, read-only, signed-out | permission denied, stale sync, entitlement blocked, deleted object, provider error |
| Team/Admin Settings | Dropbox-specific workflow for team/admin settings | taps, forms, deep links, permissions, account context | empty, loading, loaded, offline, read-only, signed-out | permission denied, stale sync, entitlement blocked, deleted object, provider error |
...
- `FileObject`: Dropbox-specific object with owner, lifecycle, authorization, sync version, privacy classification, and audit metadata.
- `Folder`: Dropbox-specific object with owner, lifecycle, authorization, sync version, privacy classification, and audit metadata.
- `Revision`: Dropbox-specific object with owner, lifecycle, authorization, sync version, privacy classification, and audit metadata.
- `SharedLink`: Dropbox-specific object with owner, lifecycle, authorization, sync version, privacy classification, and audit metadata.
- `PermissionGrant`: Dropbox-specific object with owner, lifecycle, authorization, sync version, privacy classification, and audit metadata.
- `FileRequest`: Dropbox-specific object with owner, lifecycle, authorization, sync version, privacy classification, and audit metadata.
- `TransferPackage`: Dropbox-specific object with owner, lifecycle, authorization, sync version, privacy classification, and audit metadata.
- `ScanDocument`: Dropbox-specific object with owner, lifecycle, authorization, sync version, privacy classification, and audit metadata.
- `OfflinePin`: Dropbox-specific object with owner, lifecycle, authorization, sync version, privacy classification, and audit metadata.
- `TeamFolder`: Dropbox-specific object with owner, lifecycle, authorization, sync version, privacy classification, and audit metadata.
- `StorageQuota`: Dropbox-specific object with owner, lifecycle, authorization, sync version, privacy classification, and audit metadata.
- `SyncJob`: Dropbox-specific object with owner, lifecycle, authorization, sync version, privacy classification, and audit metadata.
...
- `GET /files`, `POST /files`, `PATCH /files/:id`, `DELETE /files/:id`: Dropbox files lifecycle with pagination, validation, authorization, idempotency keys, stale-data indicators, and audit metadata.
- `GET /folders`, `POST /folders`, `PATCH /folders/:id`, `DELETE /folders/:id`: Dropbox folders lifecycle with pagination, validation, authorization, idempotency keys, stale-data indicators, and audit metadata.
- `GET /uploads`, `POST /uploads`, `PATCH /uploads/:id`, `DELETE /uploads/:id`: Dropbox uploads lifecycle with pagination, validation, authorization, idempotency keys, stale-data indicators, and audit metadata.
- `GET /previews`, `POST /previews`, `PATCH /previews/:id`, `DELETE /previews/:id`: Dropbox previews lifecycle with pagination, validation, authorization, idempotency keys, stale-data indicators, and audit metadata.
- `GET /sharing`, `POST /sharing`, `PATCH /sharing/:id`, `DELETE /sharing/:id`: Dropbox sharing lifecycle with pagination, validation, authorization, idempotency keys, stale-data indicators, and audit metadata.
- `GET /requests`, `POST /requests`, `PATCH /requests/:id`, `DELETE /requests/:id`: Dropbox requests lifecycle with pagination, validation, authorization, idempotency keys, stale-data indicators, and audit metadata.
- `GET /transfer`, `POST /transfer`, `PATCH /transfer/:id`, `DELETE /transfer/:id`: Dropbox transfer lifecycle with pagination, validation, authorization, idempotency keys, stale-data indicators, and audit metadata.
- `GET /offline`, `POST /offline`, `PATCH /offline/:id`, `DELETE /offline/:id`: Dropbox offline lifecycle with pagination, validation, authorization, idempotency keys, stale-data indicators, and audit metadata.
- `GET /revisions`, `POST /revisions`, `PATCH /revisions/:id`, `DELETE /revisions/:id`: Dropbox revisions lifecycle with pagination, validation, authorization, idempotency keys, stale-data indicators, and audit metadata.
- `GET /team-admin`, `POST /team-admin`, `PATCH /team-admin/:id`, `DELETE /team-admin/:id`: Dropbox team admin lifecycle with pagination, validation, authorization, idempotency keys, stale-data indicators, and audit metadata.
...
- Server-owned state changes for cloud files, folders, camera uploads, offline files, previews, sharing links, permissions, file requests, transfer, scanning PDFs, version history, deleted file recovery, team folders, admin sharing controls, and storage subscriptions must reconcile through websocket, SSE, push-triggered refetch, or polling fallback with missed-event recovery.
...
- Treat cloud file privacy, link exposure, team admin access, camera roll backup, document scans, deleted-file retention, legal requests, storage limits, and third-party integrations as launch-blocking privacy and security review areas with named owners before implementation starts.
...
- Launch owners: privacy owner for user content and data rights; security owner for permissions, sharing, auth, and integrations; category owner for cloud files, folders, camera uploads, offline files, previews, sharing links, permissions, file requests, transfer, scanning PDFs, version history, deleted file recovery, team folders, admin sharing controls, and storage subscriptions; billing owner for entitlements; legal owner for content/licensing/terms; accessibility owner for mobile interaction parity.
...
- Manual verification tests: signup/login, camera upload permission, scan quality, large upload/download, offline file behavior, share-link settings, file request submission by non-users, transfer expiry, version restore, deleted-file recovery, paid storage checkout, team admin restrictions, API OAuth, data export, account deletion, and support escalation.

## Acceptance Criteria

- Exact source links in this spec remain current or are refreshed before implementation starts.
- A downstream team can build the V1 without proprietary Dropbox assets, private APIs, network traces, protected templates/media, internal ranking systems, or brand copy.
- New and returning users can complete onboarding, reach the primary home surface, perform the core action for cloud files, folders, camera uploads, offline files, previews, sharing links, permissions, file requests, transfer, scanning PDFs, version history, deleted file recovery, team folders, admin sharing controls, and storage subscriptions, recover from offline or provider failure, and confirm server state after reconnect.
...
- Category risks around cloud file privacy, link exposure, team admin access, camera roll backup, document scans, deleted-file retention, legal requests, storage limits, and third-party integrations are either implemented with mitigations or launch-blocked with owners.
...
- Which V1 features are intentionally mobile-native versus web/provider handoff for Dropbox?
