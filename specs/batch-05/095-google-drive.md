...
## Overview
Build an original mobile product inspired by Google Drive's user-facing workflow, not its brand identity or proprietary implementation.
The clone target is: Drive file hierarchy, shared files, previews, comments, offline access, scanner, and account switching.
...
## Goals
- Deliver a mobile-first cloud storage experience with complete onboarding, core action, settings, and recovery flows.
- Implement the app-specific focus: Drive file hierarchy, shared files, previews, comments, offline access, scanner, and account switching.
...
## Non-Goals
- Do not copy Google Drive branding, trade dress, logos, app icons, screenshots, marketing copy, or proprietary media.
...
## Research Sources
- App Store source-discovery link: https://apps.apple.com/us/search?term=Google%20Drive
- Google Play source-discovery link: https://play.google.com/store/search?q=Google%20Drive&c=apps
- Official help/privacy source-discovery link: https://www.google.com/search?q=Google%20Drive%20official%20app%20help%20privacy
...
## Detailed Design
- Onboarding: support guest, signup, returning-user, permission-primer, and blocked-region or blocked-account states as appropriate for cloud storage.
