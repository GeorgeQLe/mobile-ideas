...
## Overview
Build an original mobile product inspired by Notion's user-facing workflow, not its brand identity or proprietary implementation.
The clone target is: Workspace pages, blocks, databases, templates, comments, sharing, search, and offline editing.
...
- Implement the app-specific focus: Workspace pages, blocks, databases, templates, comments, sharing, search, and offline editing.
...
## Non-Goals
- Do not copy Notion branding, trade dress, logos, app icons, screenshots, marketing copy, or proprietary media.
...
## Research Sources
- App Store source-discovery link: https://apps.apple.com/us/search?term=Notion
- Google Play source-discovery link: https://play.google.com/store/search?q=Notion&c=apps
- Official help/privacy source-discovery link: https://www.google.com/search?q=Notion%20official%20app%20help%20privacy
