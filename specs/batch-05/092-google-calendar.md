...
## Overview
Build an original mobile product inspired by Google Calendar's user-facing workflow, not its brand identity or proprietary implementation.
The clone target is: Calendar views, event creation, reminders, invites, shared calendars, tasks, and schedule search.
...
- Implement the app-specific focus: Calendar views, event creation, reminders, invites, shared calendars, tasks, and schedule search.
...
## Non-Goals
- Do not copy Google Calendar branding, trade dress, logos, app icons, screenshots, marketing copy, or proprietary media.
...
## Research Sources
- App Store source-discovery link: https://apps.apple.com/us/search?term=Google%20Calendar
- Google Play source-discovery link: https://play.google.com/store/search?q=Google%20Calendar&c=apps
- Official help/privacy source-discovery link: https://www.google.com/search?q=Google%20Calendar%20official%20app%20help%20privacy
