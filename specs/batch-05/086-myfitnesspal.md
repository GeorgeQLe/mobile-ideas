...
## Overview
Build an original mobile product inspired by MyFitnessPal's user-facing workflow, not its brand identity or proprietary implementation.
The clone target is: Food diary, barcode scanning, nutrition goals, recipe import, weight tracking, and streaks.
...
## Goals
- Deliver a mobile-first health tracking experience with complete onboarding, core action, settings, and recovery flows.
- Implement the app-specific focus: Food diary, barcode scanning, nutrition goals, recipe import, weight tracking, and streaks.
...
## Non-Goals
- Do not copy MyFitnessPal branding, trade dress, logos, app icons, screenshots, marketing copy, or proprietary media.
...
## Research Sources
- App Store source-discovery link: https://apps.apple.com/us/search?term=MyFitnessPal
- Google Play source-discovery link: https://play.google.com/store/search?q=MyFitnessPal&c=apps
- Official help/privacy source-discovery link: https://www.google.com/search?q=MyFitnessPal%20official%20app%20help%20privacy
...
## Detailed Design
- Onboarding: support guest, signup, returning-user, permission-primer, and blocked-region or blocked-account states as appropriate for health tracking.
