...
## Overview
Build an original mobile product inspired by Photomath's user-facing workflow, not its brand identity or proprietary implementation.
The clone target is: Camera math capture, step-by-step solution flow, graphing, explanations, history, and premium solution details.
...
## Goals
- Deliver a mobile-first education utility experience with complete onboarding, core action, settings, and recovery flows.
- Implement the app-specific focus: Camera math capture, step-by-step solution flow, graphing, explanations, history, and premium solution details.
...
## Non-Goals
- Do not copy Photomath branding, trade dress, logos, app icons, screenshots, marketing copy, or proprietary media.
...
## Research Sources
- App Store source-discovery link: https://apps.apple.com/us/search?term=Photomath
- Google Play source-discovery link: https://play.google.com/store/search?q=Photomath&c=apps
- Official help/privacy source-discovery link: https://www.google.com/search?q=Photomath%20official%20app%20help%20privacy
...
## Detailed Design
- Onboarding: support guest, signup, returning-user, permission-primer, and blocked-region or blocked-account states as appropriate for education utility.
