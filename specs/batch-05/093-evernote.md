# Evernote-Style Clone Spec

> Metadata
> - Inspiration app: Evernote
> - Category: Productivity, notes, notebooks, tasks, calendar integration, document scanning, web clipping, AI notes, search, and shared spaces
...
> - Manual verification blockers: account signup/login, note editing, scans, handwriting/OCR, audio recording/transcription, AI assistant outputs, calendar connection, web clipper handoff, offline notebooks, subscription checkout, shared spaces, push payloads, export formats, account deletion, and support requests still require lawful test devices/accounts, provider approvals, paid plans, hardware where applicable, and regional access before one-for-one parity claims.
...
Build an original mobile app inspired by Evernote's public workflow: notes, notebooks, tags, tasks, Home dashboard, calendar connections, web clipping, document scan, attachments, OCR/search, audio/transcription, AI assistant, shared notebooks/spaces, offline notebooks, and subscription gates.

The clone must not copy Evernote branding, screenshots, marketing copy, protected UI artwork, proprietary assets, private APIs, internal ranking systems, unreleased behavior, paid content, or support scripts. Functional parity should be expressed through original product language, original or licensed assets, documented provider contracts, and explicit privacy/security boundaries.
...
- Provide a mobile-first Evernote-inspired experience for notes, notebooks, tags, tasks, Home dashboard, calendar connections, web clipping, document scan, attachments, OCR/search, audio/transcription, AI assistant, shared notebooks/spaces, offline notebooks, and subscription gates.
...
- Preserve category trust expectations around private notes, scanned documents, audio recordings, OCR, AI/transcription, calendar connections, shared notebooks/spaces, ads/subscriptions, and data export/delete.
...
- Do not build a Evernote-branded product or imply affiliation with the inspiration app, its parent company, marketplace operators, creators, or integration partners.
...
|---|---|---|---|
| Apple App Store | https://apps.apple.com/us/app/evernote-notes-organizer/id281796108 | Official iOS listing, developer, category, age rating, platform support, privacy labels, in-app purchase disclosure, app positioning, and release context | Verified 2026-04-19 |
| Google Play | https://play.google.com/store/apps/details?id=com.evernote | Official Android listing, package id, install/rating scale, data safety, in-app purchase disclosure where applicable, device support, and app positioning | Verified 2026-04-19 |
| Help Center | https://help.evernote.com/hc/en-us | First-party support paths, feature docs, troubleshooting, account controls, and implementation blockers | Verified 2026-04-19 |
| Privacy Policy | https://evernote.com/en-us/privacy/policy | Personal data, content data, privacy controls, deletion/export, analytics, security, and regional disclosure requirements | Verified 2026-04-19 |
| Terms | https://evernote.com/legal/tos.php | User obligations, subscription/payment terms, acceptable use, content ownership, service limitations, and dispute/legal requirements | Verified 2026-04-19 |
| Privacy Data Use Help | https://help.evernote.com/hc/en-us/articles/208313518-How-does-Evernote-use-my-personal-information-and-data | Public product, developer, pricing, AI, security, or feature documentation used to scope V1 requirements | Verified 2026-04-19 |
| Commercial Terms | https://evernote.com/legal/commercial-terms | Public product, developer, pricing, AI, security, or feature documentation used to scope V1 requirements | Verified 2026-04-19 |
| Plans | https://evernote.com/compare-plans | Public product, developer, pricing, AI, security, or feature documentation used to scope V1 requirements | Verified 2026-04-19 |
| Security | https://evernote.com/security | Public product, developer, pricing, AI, security, or feature documentation used to scope V1 requirements | Verified 2026-04-19 |

## Detailed Design

### Source-Backed Product Requirements

- V1 must support searchable notes with rich text, attachments, notebooks, stacks, tags, tasks, reminders, and a customizable dashboard.
- Capture flows must include camera scanning, file attachment, audio recording, and web-clip/import placeholders with source provenance and permissions.
- Search must cover titles, body content, tags, attachments, OCR text, and semantic/AI results while clearly separating unverified AI behavior.
- Calendar and task features require provider authorization, note-event linking, due dates, reminders, and revoked-provider recovery.
- Shared notebooks/spaces and business contexts need explicit role models, content ownership, account lifecycle, and export/delete consequences.
...
- Phase 1: implement auth shell, Home Dashboard, Notes List, settings/privacy, seed data, and exact-source legal links with no proprietary assets.
- Phase 2: implement core objects (Note, Notebook, Stack, Tag, Task), CRUD routes, search, notifications, offline cache, and permission-denied fallbacks.
...
- Phase 4: implement category-specific advanced surfaces for notes, notebooks, tags, tasks, Home dashboard, calendar connections, web clipping, document scan, attachments, OCR/search, audio/transcription, AI assistant, shared notebooks/spaces, offline notebooks, and subscription gates behind feature flags and manual-verification blockers.
...
- New user installs the app, creates or signs into an account, accepts required terms, grants only action-triggered permissions, and reaches the primary Evernote home surface.
- Returning user opens the app, resumes the latest notes context, completes the core action, and confirms sync state.
...
|---|---|---|---|---|
| Home Dashboard | Evernote-specific workflow for home dashboard | taps, forms, deep links, permissions, account context | empty, loading, loaded, offline, read-only, signed-out | permission denied, stale sync, entitlement blocked, deleted object, provider error |
| Notes List | Evernote-specific workflow for notes list | taps, forms, deep links, permissions, account context | empty, loading, loaded, offline, read-only, signed-out | permission denied, stale sync, entitlement blocked, deleted object, provider error |
| Note Editor | Evernote-specific workflow for note editor | taps, forms, deep links, permissions, account context | empty, loading, loaded, offline, read-only, signed-out | permission denied, stale sync, entitlement blocked, deleted object, provider error |
| Notebook/Stack | Evernote-specific workflow for notebook/stack | taps, forms, deep links, permissions, account context | empty, loading, loaded, offline, read-only, signed-out | permission denied, stale sync, entitlement blocked, deleted object, provider error |
| Task Detail | Evernote-specific workflow for task detail | taps, forms, deep links, permissions, account context | empty, loading, loaded, offline, read-only, signed-out | permission denied, stale sync, entitlement blocked, deleted object, provider error |
| Calendar Panel | Evernote-specific workflow for calendar panel | taps, forms, deep links, permissions, account context | empty, loading, loaded, offline, read-only, signed-out | permission denied, stale sync, entitlement blocked, deleted object, provider error |
| Scanner | Evernote-specific workflow for scanner | taps, forms, deep links, permissions, account context | empty, loading, loaded, offline, read-only, signed-out | permission denied, stale sync, entitlement blocked, deleted object, provider error |
| Search/OCR | Evernote-specific workflow for search/ocr | taps, forms, deep links, permissions, account context | empty, loading, loaded, offline, read-only, signed-out | permission denied, stale sync, entitlement blocked, deleted object, provider error |
| Shared Space | Evernote-specific workflow for shared space | taps, forms, deep links, permissions, account context | empty, loading, loaded, offline, read-only, signed-out | permission denied, stale sync, entitlement blocked, deleted object, provider error |
| Settings/Billing | Evernote-specific workflow for settings/billing | taps, forms, deep links, permissions, account context | empty, loading, loaded, offline, read-only, signed-out | permission denied, stale sync, entitlement blocked, deleted object, provider error |
...
- `Note`: Evernote-specific object with owner, lifecycle, authorization, sync version, privacy classification, and audit metadata.
- `Notebook`: Evernote-specific object with owner, lifecycle, authorization, sync version, privacy classification, and audit metadata.
- `Stack`: Evernote-specific object with owner, lifecycle, authorization, sync version, privacy classification, and audit metadata.
- `Tag`: Evernote-specific object with owner, lifecycle, authorization, sync version, privacy classification, and audit metadata.
- `Task`: Evernote-specific object with owner, lifecycle, authorization, sync version, privacy classification, and audit metadata.
- `Reminder`: Evernote-specific object with owner, lifecycle, authorization, sync version, privacy classification, and audit metadata.
- `Attachment`: Evernote-specific object with owner, lifecycle, authorization, sync version, privacy classification, and audit metadata.
- `Scan`: Evernote-specific object with owner, lifecycle, authorization, sync version, privacy classification, and audit metadata.
- `AudioRecording`: Evernote-specific object with owner, lifecycle, authorization, sync version, privacy classification, and audit metadata.
- `Transcription`: Evernote-specific object with owner, lifecycle, authorization, sync version, privacy classification, and audit metadata.
- `CalendarLink`: Evernote-specific object with owner, lifecycle, authorization, sync version, privacy classification, and audit metadata.
- `ShareGrant`: Evernote-specific object with owner, lifecycle, authorization, sync version, privacy classification, and audit metadata.
...
- `GET /notes`, `POST /notes`, `PATCH /notes/:id`, `DELETE /notes/:id`: Evernote notes lifecycle with pagination, validation, authorization, idempotency keys, stale-data indicators, and audit metadata.
- `GET /notebooks`, `POST /notebooks`, `PATCH /notebooks/:id`, `DELETE /notebooks/:id`: Evernote notebooks lifecycle with pagination, validation, authorization, idempotency keys, stale-data indicators, and audit metadata.
- `GET /tasks`, `POST /tasks`, `PATCH /tasks/:id`, `DELETE /tasks/:id`: Evernote tasks lifecycle with pagination, validation, authorization, idempotency keys, stale-data indicators, and audit metadata.
- `GET /calendar`, `POST /calendar`, `PATCH /calendar/:id`, `DELETE /calendar/:id`: Evernote calendar lifecycle with pagination, validation, authorization, idempotency keys, stale-data indicators, and audit metadata.
- `GET /scan`, `POST /scan`, `PATCH /scan/:id`, `DELETE /scan/:id`: Evernote scan lifecycle with pagination, validation, authorization, idempotency keys, stale-data indicators, and audit metadata.
- `GET /attachments`, `POST /attachments`, `PATCH /attachments/:id`, `DELETE /attachments/:id`: Evernote attachments lifecycle with pagination, validation, authorization, idempotency keys, stale-data indicators, and audit metadata.
- `GET /search`, `POST /search`, `PATCH /search/:id`, `DELETE /search/:id`: Evernote search lifecycle with pagination, validation, authorization, idempotency keys, stale-data indicators, and audit metadata.
- `GET /share`, `POST /share`, `PATCH /share/:id`, `DELETE /share/:id`: Evernote share lifecycle with pagination, validation, authorization, idempotency keys, stale-data indicators, and audit metadata.
- `GET /ai`, `POST /ai`, `PATCH /ai/:id`, `DELETE /ai/:id`: Evernote ai lifecycle with pagination, validation, authorization, idempotency keys, stale-data indicators, and audit metadata.
- `GET /exports`, `POST /exports`, `PATCH /exports/:id`, `DELETE /exports/:id`: Evernote exports lifecycle with pagination, validation, authorization, idempotency keys, stale-data indicators, and audit metadata.
...
- Server-owned state changes for notes, notebooks, tags, tasks, Home dashboard, calendar connections, web clipping, document scan, attachments, OCR/search, audio/transcription, AI assistant, shared notebooks/spaces, offline notebooks, and subscription gates must reconcile through websocket, SSE, push-triggered refetch, or polling fallback with missed-event recovery.
...
- Treat private notes, scanned documents, audio recordings, OCR, AI/transcription, calendar connections, shared notebooks/spaces, ads/subscriptions, and data export/delete as launch-blocking privacy and security review areas with named owners before implementation starts.
...
- Launch owners: privacy owner for user content and data rights; security owner for permissions, sharing, auth, and integrations; category owner for notes, notebooks, tags, tasks, Home dashboard, calendar connections, web clipping, document scan, attachments, OCR/search, audio/transcription, AI assistant, shared notebooks/spaces, offline notebooks, and subscription gates; billing owner for entitlements; legal owner for content/licensing/terms; accessibility owner for mobile interaction parity.
...
- Manual verification tests: account signup/login, note editing, scans, handwriting/OCR, audio recording/transcription, AI assistant outputs, calendar connection, web clipper handoff, offline notebooks, subscription checkout, shared spaces, push payloads, export formats, account deletion, and support requests.

## Acceptance Criteria

- Exact source links in this spec remain current or are refreshed before implementation starts.
- A downstream team can build the V1 without proprietary Evernote assets, private APIs, network traces, protected templates/media, internal ranking systems, or brand copy.
- New and returning users can complete onboarding, reach the primary home surface, perform the core action for notes, notebooks, tags, tasks, Home dashboard, calendar connections, web clipping, document scan, attachments, OCR/search, audio/transcription, AI assistant, shared notebooks/spaces, offline notebooks, and subscription gates, recover from offline or provider failure, and confirm server state after reconnect.
...
- Category risks around private notes, scanned documents, audio recordings, OCR, AI/transcription, calendar connections, shared notebooks/spaces, ads/subscriptions, and data export/delete are either implemented with mitigations or launch-blocked with owners.
...
- Which V1 features are intentionally mobile-native versus web/provider handoff for Evernote?
