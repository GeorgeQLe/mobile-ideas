...
## Overview
Build an original mobile product inspired by Audible's user-facing workflow, not its brand identity or proprietary implementation.
The clone target is: Audiobook library, chapter playback, bookmarks, sleep timer, credits, samples, reviews, and offline listening.
...
## Goals
- Deliver a mobile-first audiobooks experience with complete onboarding, core action, settings, and recovery flows.
- Implement the app-specific focus: Audiobook library, chapter playback, bookmarks, sleep timer, credits, samples, reviews, and offline listening.
...
## Non-Goals
- Do not copy Audible branding, trade dress, logos, app icons, screenshots, marketing copy, or proprietary media.
...
## Research Sources
- App Store source-discovery link: https://apps.apple.com/us/search?term=Audible
- Google Play source-discovery link: https://play.google.com/store/search?q=Audible&c=apps
- Official help/privacy source-discovery link: https://www.google.com/search?q=Audible%20official%20app%20help%20privacy
...
## Detailed Design
- Onboarding: support guest, signup, returning-user, permission-primer, and blocked-region or blocked-account states as appropriate for audiobooks.
