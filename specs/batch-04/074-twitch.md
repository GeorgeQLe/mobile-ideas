...
## Overview
Build an original mobile product inspired by Twitch's user-facing workflow, not its brand identity or proprietary implementation.
The clone target is: Live channels, chat, follows, subscriptions, clips, stream categories, moderation, and streamer profile pages.
...
## Goals
- Deliver a mobile-first live streaming experience with complete onboarding, core action, settings, and recovery flows.
- Implement the app-specific focus: Live channels, chat, follows, subscriptions, clips, stream categories, moderation, and streamer profile pages.
...
## Non-Goals
- Do not copy Twitch branding, trade dress, logos, app icons, screenshots, marketing copy, or proprietary media.
...
## Research Sources
- App Store source-discovery link: https://apps.apple.com/us/search?term=Twitch
- Google Play source-discovery link: https://play.google.com/store/search?q=Twitch&c=apps
- Official help/privacy source-discovery link: https://www.google.com/search?q=Twitch%20official%20app%20help%20privacy
...
## Detailed Design
- Onboarding: support guest, signup, returning-user, permission-primer, and blocked-region or blocked-account states as appropriate for live streaming.
