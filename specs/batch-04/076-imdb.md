...
> - Category: Entertainment database
...
## Overview
Build an original mobile product inspired by IMDb's user-facing workflow, not its brand identity or proprietary implementation.
The clone target is: Searchable film/TV database, cast pages, watchlist, ratings, trailers, showtimes links, and news.
...
## Goals
- Deliver a mobile-first entertainment database experience with complete onboarding, core action, settings, and recovery flows.
- Implement the app-specific focus: Searchable film/TV database, cast pages, watchlist, ratings, trailers, showtimes links, and news.
...
## Non-Goals
- Do not copy IMDb branding, trade dress, logos, app icons, screenshots, marketing copy, or proprietary media.
...
## Research Sources
- App Store source-discovery link: https://apps.apple.com/us/search?term=IMDb
- Google Play source-discovery link: https://play.google.com/store/search?q=IMDb&c=apps
- Official help/privacy source-discovery link: https://www.google.com/search?q=IMDb%20official%20app%20help%20privacy
...
## Detailed Design
- Onboarding: support guest, signup, returning-user, permission-primer, and blocked-region or blocked-account states as appropriate for entertainment database.
