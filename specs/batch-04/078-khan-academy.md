...
## Overview
Build an original mobile product inspired by Khan Academy's user-facing workflow, not its brand identity or proprietary implementation.
The clone target is: Course catalog, video lessons, practice exercises, mastery progress, bookmarks, and learner profile.
...
- Implement the app-specific focus: Course catalog, video lessons, practice exercises, mastery progress, bookmarks, and learner profile.
...
## Non-Goals
- Do not copy Khan Academy branding, trade dress, logos, app icons, screenshots, marketing copy, or proprietary media.
...
## Research Sources
- App Store source-discovery link: https://apps.apple.com/us/search?term=Khan%20Academy
- Google Play source-discovery link: https://play.google.com/store/search?q=Khan%20Academy&c=apps
- Official help/privacy source-discovery link: https://www.google.com/search?q=Khan%20Academy%20official%20app%20help%20privacy
