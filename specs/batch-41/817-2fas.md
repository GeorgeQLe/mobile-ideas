# 2FAS-Style Clone Spec

> Metadata
> - Inspiration app: 2FAS
...
> - Manual verification blockers: no-account architecture and local-only storage model, TOTP/HOTP generation accuracy and time sync, QR code scanning accuracy, browser extension pairing and push delivery, token organization group/icon/color persistence, iCloud/Google Drive backup encryption and recovery, import compatibility (Google Authenticator, Aegis, Raivo, etc.), widget TOTP display and refresh, biometric lock security model, open-source code audit alignment, and platform feature differences.
...
Build an original mobile product inspired by 2FAS's public security and vpn workflow. The V1 clone focuses on open-source two-factor authentication with TOTP/HOTP code generation, QR code and manual entry setup, push-based browser extension pairing, token organization with groups/icons/colors, iCloud/Google Drive backup, import/export, widget support, biometric lock, and free service model with no account required.
...
- Preserve the functional job behind 2FAS while using original product naming, original UI, original sample data, and licensed integrations.
...
- Do not copy 2FAS branding, logos, screenshots, marketing copy, private APIs, proprietary datasets, plan names, UI trade dress, course libraries, textbook solutions, documents, school content, AI prompts, or protected media.
...
|---|---|---|---|
| Apple App Store | https://apps.apple.com/us/app/2fas-auth/id1217793794 | iOS listing, privacy labels, release notes, 2FA/open-source claims, and support links | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
| Google Play | https://play.google.com/store/apps/details?id=com.twofasapp | Android listing, data safety, 2FA/backup claims, and release cadence | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
| Official product site | https://2fas.com/ | 2FAS open-source 2FA, browser extension, backup, and product positioning | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
| Official help | https://support.2fas.com/ | 2FAS setup, tokens, browser extension, backup, import, and troubleshooting | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
| Privacy policy | https://2fas.com/privacy-policy/ | No-account, local storage, backup, analytics, and privacy disclosures | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
| Terms | https://2fas.com/terms-of-service/ | Service, open-source license, backup, and acceptable-use boundaries | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
...
- Manual blockers must remain launch-blocking until verified: no-account architecture and local-only storage model, TOTP/HOTP generation accuracy and time sync, QR code scanning accuracy, browser extension pairing and push delivery, token organization group/icon/color persistence, iCloud/Google Drive backup encryption and recovery, import compatibility (Google Authenticator, Aegis, Raivo, etc.), widget TOTP display and refresh, biometric lock security model, open-source code audit alignment, and platform feature differences.

## Core User Journeys

- User creates or restores a 2FAS-style account, completes role, school, subscription, or tenant checks, and reaches the dashboard.
...
- Monetization model: use original free/trial/paid/sponsored/school/provider/tenant entitlement logic; do not copy exact pricing, plan names, bundle names, promotional copy, school contracts, tenant offers, or partner offers from 2FAS.
...
- Manual verification tests for no-account architecture and local-only storage model, TOTP/HOTP generation accuracy and time sync, QR code scanning accuracy, browser extension pairing and push delivery, token organization group/icon/color persistence, iCloud/Google Drive backup encryption and recovery, import compatibility (Google Authenticator, Aegis, Raivo, etc.), widget TOTP display and refresh, biometric lock security model, open-source code audit alignment, and platform feature differences.
...
- Phase 4: Add app-specific safety controls for open-source two-factor authentication with TOTP/HOTP code generation, QR code and manual entry setup, push-based browser extension pairing, token organization with groups/icons/colors, iCloud/Google Drive backup, import/export, widget support, biometric lock, and free service model with no account required.
...
- Confirm legal/privacy retention behavior for 2FAS-style sensitive records and update API contracts before downstream implementation.
