# McAfee Security-Style Clone Spec

> Metadata
> - Inspiration app: McAfee Security
...
> - Manual verification blockers: McAfee account and subscription policy, antivirus scan engine and signature behavior, Safe Browsing URL classification accuracy, Wi-Fi security threat detection, VPN tunnel establishment, identity monitoring data sourcing and alert accuracy, True Key password vault encryption, app privacy check analysis scope, system security scan coverage, anti-theft remote lock/wipe/locate behavior, subscription restore, and platform-specific feature availability.
...
Build an original mobile product inspired by McAfee Security's public security and vpn workflow. The V1 clone focuses on mobile security with antivirus scan, web protection (Safe Browsing), Wi-Fi security scan, identity monitoring, VPN (McAfee Secure VPN), password manager (McAfee True Key), app privacy check, system security scan, anti-theft, and subscription plan entitlements.
...
- Preserve the functional job behind McAfee Security while using original product naming, original UI, original sample data, and licensed integrations.
...
- Do not copy McAfee Security branding, logos, screenshots, marketing copy, private APIs, proprietary datasets, plan names, UI trade dress, course libraries, textbook solutions, documents, school content, AI prompts, or protected media.
...
|---|---|---|---|
| Apple App Store | https://apps.apple.com/us/app/mcafee-security-vpn/id1435606602 | iOS listing, privacy labels, release notes, security/VPN/identity claims, and support links | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
| Google Play | https://play.google.com/store/apps/details?id=com.wsandroid.suite | Android listing, data safety, antivirus/VPN/identity claims, and release cadence | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
| Official product site | https://www.mcafee.com/ | McAfee security, VPN, identity monitoring, and product positioning | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
| Official help | https://www.mcafee.com/support/ | McAfee setup, scanning, VPN, identity, and troubleshooting | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
| Privacy policy | https://www.mcafee.com/consumer-support/policy/legal.html | McAfee account, scanning, VPN, identity, analytics, and privacy disclosures | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
| Terms | https://www.mcafee.com/consumer-support/policy/legal.html#tab-license-agreement | McAfee services, subscriptions, scanning, VPN, and acceptable-use boundaries | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
...
- Manual blockers must remain launch-blocking until verified: McAfee account and subscription policy, antivirus scan engine and signature behavior, Safe Browsing URL classification accuracy, Wi-Fi security threat detection, VPN tunnel establishment, identity monitoring data sourcing and alert accuracy, True Key password vault encryption, app privacy check analysis scope, system security scan coverage, anti-theft remote lock/wipe/locate behavior, subscription restore, and platform-specific feature availability.

## Core User Journeys

- User creates or restores a McAfee Security-style account, completes role, school, subscription, or tenant checks, and reaches the dashboard.
...
- Monetization model: use original free/trial/paid/sponsored/school/provider/tenant entitlement logic; do not copy exact pricing, plan names, bundle names, promotional copy, school contracts, tenant offers, or partner offers from McAfee Security.
...
- Manual verification tests for McAfee account and subscription policy, antivirus scan engine and signature behavior, Safe Browsing URL classification accuracy, Wi-Fi security threat detection, VPN tunnel establishment, identity monitoring data sourcing and alert accuracy, True Key password vault encryption, app privacy check analysis scope, system security scan coverage, anti-theft remote lock/wipe/locate behavior, subscription restore, and platform-specific feature availability.
...
- Phase 4: Add app-specific safety controls for mobile security with antivirus scan, web protection (Safe Browsing), Wi-Fi security scan, identity monitoring, VPN (McAfee Secure VPN), password manager (McAfee True Key), app privacy check, system security scan, anti-theft, and subscription plan entitlements.
...
- Confirm legal/privacy retention behavior for McAfee Security-style sensitive records and update API contracts before downstream implementation.
