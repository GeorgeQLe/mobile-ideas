# Avast One-Style Clone Spec

> Metadata
> - Inspiration app: Avast One
...
> - Manual verification blockers: Avast/Gen account and subscription policy, malware scan engine and signature behavior, web shield URL classification accuracy, Wi-Fi inspector network vulnerability detection, VPN tunnel establishment and server selection, data breach monitoring credential sourcing, email guardian scanning scope, performance tool optimization claims, photo vault encryption, subscription restore, and platform-specific feature availability.
...
Build an original mobile product inspired by Avast One's public security and vpn workflow. The V1 clone focuses on mobile security suite with malware scan, web shield (phishing/malicious site blocking), Wi-Fi inspector, VPN, data breach monitoring, email guardian, performance tools, photo vault, and free/premium plan entitlements.
...
- Preserve the functional job behind Avast One while using original product naming, original UI, original sample data, and licensed integrations.
...
- Do not copy Avast One branding, logos, screenshots, marketing copy, private APIs, proprietary datasets, plan names, UI trade dress, course libraries, textbook solutions, documents, school content, AI prompts, or protected media.
...
|---|---|---|---|
| Apple App Store | https://apps.apple.com/us/app/avast-one-privacy-security/id1557912837 | iOS listing, privacy labels, release notes, security/VPN/breach claims, and support links | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
| Google Play | https://play.google.com/store/apps/details?id=com.avast.android.vpn | Android listing, data safety, security/VPN/breach claims, and release cadence | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
| Official product site | https://www.avast.com/avast-one | Avast One security, VPN, breach monitoring, and product positioning | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
| Official help | https://support.avast.com/ | Avast One setup, scanning, VPN, breach monitoring, and troubleshooting | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
| Privacy policy | https://www.avast.com/privacy-policy | Avast/Gen account, scanning, VPN, analytics, and privacy disclosures | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
| Terms | https://www.avast.com/eula | Avast services, subscriptions, scanning, VPN, and acceptable-use boundaries | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
...
- Manual blockers must remain launch-blocking until verified: Avast/Gen account and subscription policy, malware scan engine and signature behavior, web shield URL classification accuracy, Wi-Fi inspector network vulnerability detection, VPN tunnel establishment and server selection, data breach monitoring credential sourcing, email guardian scanning scope, performance tool optimization claims, photo vault encryption, subscription restore, and platform-specific feature availability.

## Core User Journeys

- User creates or restores a Avast One-style account, completes role, school, subscription, or tenant checks, and reaches the dashboard.
...
- Monetization model: use original free/trial/paid/sponsored/school/provider/tenant entitlement logic; do not copy exact pricing, plan names, bundle names, promotional copy, school contracts, tenant offers, or partner offers from Avast One.
...
- Manual verification tests for Avast/Gen account and subscription policy, malware scan engine and signature behavior, web shield URL classification accuracy, Wi-Fi inspector network vulnerability detection, VPN tunnel establishment and server selection, data breach monitoring credential sourcing, email guardian scanning scope, performance tool optimization claims, photo vault encryption, subscription restore, and platform-specific feature availability.
...
- Phase 4: Add app-specific safety controls for mobile security suite with malware scan, web shield (phishing/malicious site blocking), Wi-Fi inspector, VPN, data breach monitoring, email guardian, performance tools, photo vault, and free/premium plan entitlements.
...
- Confirm legal/privacy retention behavior for Avast One-style sensitive records and update API contracts before downstream implementation.
