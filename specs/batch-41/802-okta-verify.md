# Okta Verify-Style Clone Spec

> Metadata
> - Inspiration app: Okta Verify
...
> - Manual verification blockers: Okta tenant and organization policy, push notification delivery and approval timing, TOTP generation accuracy, FastPass device-bound key enrollment and platform authenticator integration, biometric verification security model, device trust signal reporting to Okta admin, multi-organization account switching, MDM/EMM managed enrollment, jailbreak/root detection, and enterprise admin-configured feature availability.
...
Build an original mobile product inspired by Okta Verify's public cloud files and identity workflow. The V1 clone focuses on multi-factor authentication with push notifications, TOTP code generation, Okta FastPass (passwordless device-bound authentication), biometric verification, device trust and compliance signals, multiple account/organization enrollment, and enterprise SSO integration.
...
- Preserve the functional job behind Okta Verify while using original product naming, original UI, original sample data, and licensed integrations.
...
- Do not copy Okta Verify branding, logos, screenshots, marketing copy, private APIs, proprietary datasets, plan names, UI trade dress, course libraries, textbook solutions, documents, school content, AI prompts, or protected media.
...
|---|---|---|---|
| Apple App Store | https://apps.apple.com/us/app/okta-verify/id490179405 | iOS listing, privacy labels, release notes, MFA/FastPass claims, and support links | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
| Google Play | https://play.google.com/store/apps/details?id=com.okta.android.auth | Android listing, data safety, MFA/device-trust claims, and release cadence | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
| Official product site | https://www.okta.com/integrations/okta-verify/ | Okta Verify MFA, FastPass, device trust, and product positioning | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
| Official help | https://help.okta.com/en-us/content/topics/mobile/okta-verify-overview.htm | Okta Verify setup, MFA methods, FastPass, device trust, and troubleshooting | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
| Privacy policy | https://www.okta.com/privacy-policy/ | Okta account, tenant, device signals, analytics, and privacy disclosures | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
| Terms | https://www.okta.com/terms-of-service/ | Okta services, enterprise agreements, and acceptable-use boundaries | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
...
- Manual blockers must remain launch-blocking until verified: Okta tenant and organization policy, push notification delivery and approval timing, TOTP generation accuracy, FastPass device-bound key enrollment and platform authenticator integration, biometric verification security model, device trust signal reporting to Okta admin, multi-organization account switching, MDM/EMM managed enrollment, jailbreak/root detection, and enterprise admin-configured feature availability.

## Core User Journeys

- User creates or restores a Okta Verify-style account, completes role, school, subscription, or tenant checks, and reaches the dashboard.
...
- Monetization model: use original free/trial/paid/sponsored/school/provider/tenant entitlement logic; do not copy exact pricing, plan names, bundle names, promotional copy, school contracts, tenant offers, or partner offers from Okta Verify.
...
- Manual verification tests for Okta tenant and organization policy, push notification delivery and approval timing, TOTP generation accuracy, FastPass device-bound key enrollment and platform authenticator integration, biometric verification security model, device trust signal reporting to Okta admin, multi-organization account switching, MDM/EMM managed enrollment, jailbreak/root detection, and enterprise admin-configured feature availability.
...
- Confirm legal/privacy retention behavior for Okta Verify-style sensitive records and update API contracts before downstream implementation.
