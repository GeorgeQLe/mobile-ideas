# Surfshark-Style Clone Spec

> Metadata
> - Inspiration app: Surfshark
...
> - Manual verification blockers: account and subscription policy, VPN tunnel establishment and protocol negotiation, unlimited device session management, MultiHop chained server routing, CleanWeb filtering accuracy, Bypasser split tunneling configuration, kill switch enforcement on iOS/Android, NoBorders mode activation and detection, static/dedicated IP assignment, auto-connect network detection, DNS leak prevention, subscription restore, and regional server availability.
...
Build an original mobile product inspired by Surfshark's public security and vpn workflow. The V1 clone focuses on VPN with one-tap connect, unlimited simultaneous devices, MultiHop (double VPN), CleanWeb (ad/tracker/malware blocking), Bypasser (split tunneling), kill switch, NoBorders mode, static/dedicated IP, auto-connect on untrusted networks, protocol selection (WireGuard/OpenVPN/IKEv2), and subscription plan entitlements.
...
- Preserve the functional job behind Surfshark while using original product naming, original UI, original sample data, and licensed integrations.
...
- Do not copy Surfshark branding, logos, screenshots, marketing copy, private APIs, proprietary datasets, plan names, UI trade dress, course libraries, textbook solutions, documents, school content, AI prompts, or protected media.
...
|---|---|---|---|
| Apple App Store | https://apps.apple.com/us/app/surfshark-vpn-proxy/id1391782046 | iOS listing, privacy labels, release notes, VPN/CleanWeb claims, and support links | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
| Google Play | https://play.google.com/store/apps/details?id=com.surfshark.vpnclient.android | Android listing, data safety, VPN/MultiHop claims, and release cadence | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
| Official product site | https://surfshark.com/ | Surfshark features, servers, CleanWeb, MultiHop, and product positioning | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
| Official help | https://support.surfshark.com/ | Surfshark setup, protocols, kill switch, Bypasser, and troubleshooting | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
| Privacy policy | https://surfshark.com/privacy-policy | Account, VPN no-logs policy, analytics, and privacy disclosures | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
| Terms | https://surfshark.com/terms-of-service | Service, subscriptions, VPN usage, and acceptable-use boundaries | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
...
- Manual blockers must remain launch-blocking until verified: account and subscription policy, VPN tunnel establishment and protocol negotiation, unlimited device session management, MultiHop chained server routing, CleanWeb filtering accuracy, Bypasser split tunneling configuration, kill switch enforcement on iOS/Android, NoBorders mode activation and detection, static/dedicated IP assignment, auto-connect network detection, DNS leak prevention, subscription restore, and regional server availability.

## Core User Journeys

- User creates or restores a Surfshark-style account, completes role, school, subscription, or tenant checks, and reaches the dashboard.
...
- Monetization model: use original free/trial/paid/sponsored/school/provider/tenant entitlement logic; do not copy exact pricing, plan names, bundle names, promotional copy, school contracts, tenant offers, or partner offers from Surfshark.
...
- Manual verification tests for account and subscription policy, VPN tunnel establishment and protocol negotiation, unlimited device session management, MultiHop chained server routing, CleanWeb filtering accuracy, Bypasser split tunneling configuration, kill switch enforcement on iOS/Android, NoBorders mode activation and detection, static/dedicated IP assignment, auto-connect network detection, DNS leak prevention, subscription restore, and regional server availability.
...
- Phase 4: Add app-specific safety controls for VPN with one-tap connect, unlimited simultaneous devices, MultiHop (double VPN), CleanWeb (ad/tracker/malware blocking), Bypasser (split tunneling), kill switch, NoBorders mode, static/dedicated IP, auto-connect on untrusted networks, protocol selection (WireGuard/OpenVPN/IKEv2), and subscription plan entitlements.
...
- Confirm legal/privacy retention behavior for Surfshark-style sensitive records and update API contracts before downstream implementation.
