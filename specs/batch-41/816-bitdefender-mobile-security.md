# Bitdefender Mobile Security-Style Clone Spec

> Metadata
> - Inspiration app: Bitdefender Mobile Security
...
> - Manual verification blockers: Bitdefender account and subscription policy, malware scanner engine and signature behavior, web protection URL classification accuracy, anti-phishing browser integration, app anomaly detection heuristics, scam alert chat/SMS scanning permissions and accuracy, VPN tunnel establishment and daily limit on free tier, account privacy breach data sourcing, anti-theft device admin permissions and remote command delivery, subscription restore, and platform-specific feature availability.
...
Build an original mobile product inspired by Bitdefender Mobile Security's public security and vpn workflow. The V1 clone focuses on mobile security with malware scanner, web protection, anti-phishing, app anomaly detection, scam alert (chat/SMS link scanning), VPN (Bitdefender VPN), account privacy (breach check), anti-theft (remote lock/locate/wipe), and subscription plan entitlements.
...
- Preserve the functional job behind Bitdefender Mobile Security while using original product naming, original UI, original sample data, and licensed integrations.
...
- Do not copy Bitdefender Mobile Security branding, logos, screenshots, marketing copy, private APIs, proprietary datasets, plan names, UI trade dress, course libraries, textbook solutions, documents, school content, AI prompts, or protected media.
...
|---|---|---|---|
| Apple App Store | https://apps.apple.com/us/app/bitdefender-mobile-security/id1255893012 | iOS listing, privacy labels, release notes, security/VPN/scam claims, and support links | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
| Google Play | https://play.google.com/store/apps/details?id=com.bitdefender.security | Android listing, data safety, malware/VPN/anti-theft claims, and release cadence | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
| Official product site | https://www.bitdefender.com/solutions/mobile-security-android.html | Bitdefender Mobile Security features, VPN, anti-theft, and product positioning | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
| Official help | https://www.bitdefender.com/consumer/support/ | Bitdefender setup, scanning, VPN, anti-theft, and troubleshooting | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
| Privacy policy | https://www.bitdefender.com/site/view/legal-privacy.html | Bitdefender account, scanning, VPN, analytics, and privacy disclosures | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
| Terms | https://www.bitdefender.com/site/view/legal-eula.html | Bitdefender services, subscriptions, scanning, VPN, and acceptable-use boundaries | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
...
- Manual blockers must remain launch-blocking until verified: Bitdefender account and subscription policy, malware scanner engine and signature behavior, web protection URL classification accuracy, anti-phishing browser integration, app anomaly detection heuristics, scam alert chat/SMS scanning permissions and accuracy, VPN tunnel establishment and daily limit on free tier, account privacy breach data sourcing, anti-theft device admin permissions and remote command delivery, subscription restore, and platform-specific feature availability.

## Core User Journeys

- User creates or restores a Bitdefender Mobile Security-style account, completes role, school, subscription, or tenant checks, and reaches the dashboard.
...
|---|---|---|---|---|
| Welcome/Auth | Account creation, subscription activation, permission primers (device admin, accessibility, VPN), and consent entry | email, code, permission, restore | new, returning, trial, expired | auth failed, subscription invalid, permissions denied |
| Dashboard/Status | Security status summary, scan results, protection status indicators, threat count, and quick actions | scan, view, fix, dismiss | safe, threats-found, scanning, outdated | scan failed, definitions outdated, protection disabled, feature unavailable |
| Scan/Protect | Malware scan, web protection toggle, Wi-Fi security check, app audit, and real-time protection status | start-scan, toggle, check, review | idle, scanning, clean, threats-detected | scan timeout, signature update failed, protection conflict, low storage |
| Threats/Alerts | Detected threats, phishing alerts, breach notifications, scam warnings, and remediation actions | view, resolve, quarantine, dismiss | empty, new-alerts, resolved, quarantined | false positive, remediation failed, breach data stale, alert flood |
| Identity/Monitoring | Dark web monitoring, breach alerts, password health, identity protection status, and VPN status | check, view, enable, configure | monitoring, alert, clean, disabled | monitoring unavailable on plan, breach source lag, VPN tunnel failed |
| Settings/Privacy | Account, subscription, scan schedule, protection preferences, notifications, privacy, support, and deletion | forms, toggle, schedule, request | loaded, editing, scheduled | active scan during change, enterprise policy, subscription required |
...
- Treat malware scan results, threat signatures, device security state, web browsing protection data, Wi-Fi network analysis, dark web monitoring credentials, identity theft monitoring PII, VPN tunnel credentials, app permission audit data, call/SMS metadata, photo vault contents, anti-theft device location, subscription entitlements, and security compliance status as launch-blocking review areas with owners, mitigations, and acceptance tests before implementation.
...
- Monetization model: use original free/trial/paid/sponsored/school/provider/tenant entitlement logic; do not copy exact pricing, plan names, bundle names, promotional copy, school contracts, tenant offers, or partner offers from Bitdefender Mobile Security.
...
- Manual verification tests for Bitdefender account and subscription policy, malware scanner engine and signature behavior, web protection URL classification accuracy, anti-phishing browser integration, app anomaly detection heuristics, scam alert chat/SMS scanning permissions and accuracy, VPN tunnel establishment and daily limit on free tier, account privacy breach data sourcing, anti-theft device admin permissions and remote command delivery, subscription restore, and platform-specific feature availability.
...
- Phase 4: Add app-specific safety controls for mobile security with malware scanner, web protection, anti-phishing, app anomaly detection, scam alert (chat/SMS link scanning), VPN (Bitdefender VPN), account privacy (breach check), anti-theft (remote lock/locate/wipe), and subscription plan entitlements.
...
- Confirm legal/privacy retention behavior for Bitdefender Mobile Security-style sensitive records and update API contracts before downstream implementation.
