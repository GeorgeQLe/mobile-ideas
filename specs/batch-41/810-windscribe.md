# Windscribe-Style Clone Spec

> Metadata
> - Inspiration app: Windscribe
...
> - Manual verification blockers: account and subscription policy, VPN tunnel establishment and protocol negotiation, free tier 10 GB tracking and enforcement, R.O.B.E.R.T. domain blocking configuration and accuracy, firewall kill switch enforcement on iOS/Android, split tunneling configuration, static IP assignment, port forwarding assignment, Stealth protocol obfuscation effectiveness, auto-connect network detection, custom plan builder logic, DNS leak prevention, subscription restore, and regional server availability.
...
Build an original mobile product inspired by Windscribe's public security and vpn workflow. The V1 clone focuses on VPN with generous free tier (10 GB/month with email), R.O.B.E.R.T. (server-side domain/IP blocking for ads/malware/trackers), firewall (kill switch), split tunneling, static IPs, port forwarding, protocol selection (WireGuard/OpenVPN/IKEv2/Stealth), auto-connect, custom plans (build-a-plan), and free/pro plan entitlements.
...
- Preserve the functional job behind Windscribe while using original product naming, original UI, original sample data, and licensed integrations.
...
- Do not copy Windscribe branding, logos, screenshots, marketing copy, private APIs, proprietary datasets, plan names, UI trade dress, course libraries, textbook solutions, documents, school content, AI prompts, or protected media.
...
|---|---|---|---|
| Apple App Store | https://apps.apple.com/us/app/windscribe-vpn/id1129435228 | iOS listing, privacy labels, release notes, VPN/R.O.B.E.R.T. claims, and support links | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
| Google Play | https://play.google.com/store/apps/details?id=com.windscribe.vpn | Android listing, data safety, VPN/firewall claims, and release cadence | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
| Official product site | https://windscribe.com/ | Windscribe features, R.O.B.E.R.T., free tier, build-a-plan, and product positioning | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
| Official help | https://windscribe.com/knowledge-base/ | Windscribe setup, R.O.B.E.R.T., firewall, split tunneling, and troubleshooting | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
| Privacy policy | https://windscribe.com/privacy | Account, VPN no-logs policy, analytics, and privacy disclosures | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
| Terms | https://windscribe.com/terms | Service, subscriptions, VPN usage, and acceptable-use boundaries | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
...
- Manual blockers must remain launch-blocking until verified: account and subscription policy, VPN tunnel establishment and protocol negotiation, free tier 10 GB tracking and enforcement, R.O.B.E.R.T. domain blocking configuration and accuracy, firewall kill switch enforcement on iOS/Android, split tunneling configuration, static IP assignment, port forwarding assignment, Stealth protocol obfuscation effectiveness, auto-connect network detection, custom plan builder logic, DNS leak prevention, subscription restore, and regional server availability.

## Core User Journeys

- User creates or restores a Windscribe-style account, completes role, school, subscription, or tenant checks, and reaches the dashboard.
...
- Monetization model: use original free/trial/paid/sponsored/school/provider/tenant entitlement logic; do not copy exact pricing, plan names, bundle names, promotional copy, school contracts, tenant offers, or partner offers from Windscribe.
...
- Manual verification tests for account and subscription policy, VPN tunnel establishment and protocol negotiation, free tier 10 GB tracking and enforcement, R.O.B.E.R.T. domain blocking configuration and accuracy, firewall kill switch enforcement on iOS/Android, split tunneling configuration, static IP assignment, port forwarding assignment, Stealth protocol obfuscation effectiveness, auto-connect network detection, custom plan builder logic, DNS leak prevention, subscription restore, and regional server availability.
...
- Phase 4: Add app-specific safety controls for VPN with generous free tier (10 GB/month with email), R.O.B.E.R.T. (server-side domain/IP blocking for ads/malware/trackers), firewall (kill switch), split tunneling, static IPs, port forwarding, protocol selection (WireGuard/OpenVPN/IKEv2/Stealth), auto-connect, custom plans (build-a-plan), and free/pro plan entitlements.
...
- Confirm legal/privacy retention behavior for Windscribe-style sensitive records and update API contracts before downstream implementation.
