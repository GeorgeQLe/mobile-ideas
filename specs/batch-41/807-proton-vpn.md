# Proton VPN-Style Clone Spec

> Metadata
> - Inspiration app: Proton VPN
...
> - Manual verification blockers: Proton account and subscription policy, VPN tunnel establishment and protocol negotiation, free tier server/speed limitations, Secure Core multi-hop routing, NetShield filtering accuracy, kill switch enforcement on iOS/Android, split tunneling configuration, VPN Accelerator performance optimization, port forwarding assignment, Tor over VPN circuit behavior, auto-connect network detection, DNS leak prevention, Proton ecosystem (Mail, Drive, Pass, Calendar) integration, subscription restore, and regional server availability.
...
Build an original mobile product inspired by Proton VPN's public security and vpn workflow. The V1 clone focuses on VPN with free tier, Secure Core (multi-hop through privacy-friendly countries), NetShield (ad/tracker/malware blocking), kill switch, split tunneling, VPN Accelerator, port forwarding, Tor over VPN, auto-connect, protocol selection (WireGuard/OpenVPN/IKEv2), Proton ecosystem integration, and free/paid plan entitlements.
...
- Preserve the functional job behind Proton VPN while using original product naming, original UI, original sample data, and licensed integrations.
...
- Do not copy Proton VPN branding, logos, screenshots, marketing copy, private APIs, proprietary datasets, plan names, UI trade dress, course libraries, textbook solutions, documents, school content, AI prompts, or protected media.
...
|---|---|---|---|
| Apple App Store | https://apps.apple.com/us/app/proton-vpn-fast-secure/id1437005085 | iOS listing, privacy labels, release notes, VPN/Secure Core claims, and support links | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
| Google Play | https://play.google.com/store/apps/details?id=ch.protonvpn.android | Android listing, data safety, VPN/NetShield claims, and release cadence | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
| Official product site | https://protonvpn.com/ | Proton VPN features, Secure Core, NetShield, free tier, and product positioning | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
| Official help | https://protonvpn.com/support/ | Proton VPN setup, protocols, kill switch, split tunneling, and troubleshooting | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
| Privacy policy | https://proton.me/legal/privacy | Proton account, VPN no-logs policy, analytics, and privacy disclosures | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
| Terms | https://proton.me/legal/terms | Proton services, subscriptions, VPN usage, and acceptable-use boundaries | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
...
- Manual blockers must remain launch-blocking until verified: Proton account and subscription policy, VPN tunnel establishment and protocol negotiation, free tier server/speed limitations, Secure Core multi-hop routing, NetShield filtering accuracy, kill switch enforcement on iOS/Android, split tunneling configuration, VPN Accelerator performance optimization, port forwarding assignment, Tor over VPN circuit behavior, auto-connect network detection, DNS leak prevention, Proton ecosystem (Mail, Drive, Pass, Calendar) integration, subscription restore, and regional server availability.

## Core User Journeys

- User creates or restores a Proton VPN-style account, completes role, school, subscription, or tenant checks, and reaches the dashboard.
...
- Monetization model: use original free/trial/paid/sponsored/school/provider/tenant entitlement logic; do not copy exact pricing, plan names, bundle names, promotional copy, school contracts, tenant offers, or partner offers from Proton VPN.
...
- Manual verification tests for Proton account and subscription policy, VPN tunnel establishment and protocol negotiation, free tier server/speed limitations, Secure Core multi-hop routing, NetShield filtering accuracy, kill switch enforcement on iOS/Android, split tunneling configuration, VPN Accelerator performance optimization, port forwarding assignment, Tor over VPN circuit behavior, auto-connect network detection, DNS leak prevention, Proton ecosystem (Mail, Drive, Pass, Calendar) integration, subscription restore, and regional server availability.
...
- Phase 4: Add app-specific safety controls for VPN with free tier, Secure Core (multi-hop through privacy-friendly countries), NetShield (ad/tracker/malware blocking), kill switch, split tunneling, VPN Accelerator, port forwarding, Tor over VPN, auto-connect, protocol selection (WireGuard/OpenVPN/IKEv2), Proton ecosystem integration, and free/paid plan entitlements.
...
- Confirm legal/privacy retention behavior for Proton VPN-style sensitive records and update API contracts before downstream implementation.
