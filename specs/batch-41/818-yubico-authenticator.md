# Yubico Authenticator-Style Clone Spec

> Metadata
> - Inspiration app: Yubico Authenticator
...
> - Manual verification blockers: YubiKey hardware dependency (NFC/USB-C/Lightning), OATH applet credential storage limits, NFC tap reliability and session timing on iOS/Android, USB-C/Lightning connection handling, TOTP/HOTP generation accuracy from hardware clock, fingerprint verification on YubiKey Bio series, PIN management and lockout behavior, multi-key credential sync limitations, credential add/delete via hardware applet, firmware version feature differences, and platform-specific NFC/USB behavior.
...
Build an original mobile product inspired by Yubico Authenticator's public security and vpn workflow. The V1 clone focuses on hardware-bound two-factor authentication with TOTP/HOTP codes stored on YubiKey, NFC and USB-C YubiKey communication, OATH credential management, fingerprint-protected credentials (YubiKey Bio), PIN protection, multiple YubiKey support, credential organization, and free service model tied to hardware token.
...
- Preserve the functional job behind Yubico Authenticator while using original product naming, original UI, original sample data, and licensed integrations.
...
- Do not copy Yubico Authenticator branding, logos, screenshots, marketing copy, private APIs, proprietary datasets, plan names, UI trade dress, course libraries, textbook solutions, documents, school content, AI prompts, or protected media.
...
|---|---|---|---|
| Apple App Store | https://apps.apple.com/us/app/yubico-authenticator/id1476679808 | iOS listing, privacy labels, release notes, YubiKey/OATH claims, and support links | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
| Google Play | https://play.google.com/store/apps/details?id=com.yubico.yubioath | Android listing, data safety, YubiKey/NFC/USB claims, and release cadence | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
| Official product site | https://www.yubico.com/products/yubico-authenticator/ | Yubico Authenticator features, YubiKey integration, OATH, and product positioning | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
| Official help | https://support.yubico.com/hc/en-us/categories/360003410279-Yubico-Authenticator | Yubico Authenticator setup, YubiKey pairing, OATH, and troubleshooting | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
| Privacy policy | https://www.yubico.com/support/terms-conditions/privacy-notice/ | Yubico account, hardware tokens, analytics, and privacy disclosures | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
| Terms | https://www.yubico.com/support/terms-conditions/ | Yubico services, hardware, OATH, and acceptable-use boundaries | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
...
- Manual blockers must remain launch-blocking until verified: YubiKey hardware dependency (NFC/USB-C/Lightning), OATH applet credential storage limits, NFC tap reliability and session timing on iOS/Android, USB-C/Lightning connection handling, TOTP/HOTP generation accuracy from hardware clock, fingerprint verification on YubiKey Bio series, PIN management and lockout behavior, multi-key credential sync limitations, credential add/delete via hardware applet, firmware version feature differences, and platform-specific NFC/USB behavior.

## Core User Journeys

- User creates or restores a Yubico Authenticator-style account, completes role, school, subscription, or tenant checks, and reaches the dashboard.
...
- Monetization model: use original free/trial/paid/sponsored/school/provider/tenant entitlement logic; do not copy exact pricing, plan names, bundle names, promotional copy, school contracts, tenant offers, or partner offers from Yubico Authenticator.
...
- Manual verification tests for YubiKey hardware dependency (NFC/USB-C/Lightning), OATH applet credential storage limits, NFC tap reliability and session timing on iOS/Android, USB-C/Lightning connection handling, TOTP/HOTP generation accuracy from hardware clock, fingerprint verification on YubiKey Bio series, PIN management and lockout behavior, multi-key credential sync limitations, credential add/delete via hardware applet, firmware version feature differences, and platform-specific NFC/USB behavior.
...
- Phase 4: Add app-specific safety controls for hardware-bound two-factor authentication with TOTP/HOTP codes stored on YubiKey, NFC and USB-C YubiKey communication, OATH credential management, fingerprint-protected credentials (YubiKey Bio), PIN protection, multiple YubiKey support, credential organization, and free service model tied to hardware token.
...
- Confirm legal/privacy retention behavior for Yubico Authenticator-style sensitive records and update API contracts before downstream implementation.
