# TunnelBear-Style Clone Spec

> Metadata
> - Inspiration app: TunnelBear
...
> - Manual verification blockers: account and subscription policy, VPN tunnel establishment and protocol negotiation, GhostBear obfuscation effectiveness, VigilantBear kill switch enforcement on iOS/Android, SplitBear split tunneling configuration, closest tunnel selection algorithm, free tier 500 MB tracking and enforcement, independent audit transparency, auto-connect behavior, DNS leak prevention, subscription restore, and regional server availability.
...
Build an original mobile product inspired by TunnelBear's public security and vpn workflow. The V1 clone focuses on VPN with bear-themed UI, one-tap connect, GhostBear (obfuscation for restrictive networks), VigilantBear (kill switch), SplitBear (split tunneling), closest tunnel auto-selection, 500 MB/month free tier, independent security audits, and subscription plan entitlements.
...
- Preserve the functional job behind TunnelBear while using original product naming, original UI, original sample data, and licensed integrations.
...
- Do not copy TunnelBear branding, logos, screenshots, marketing copy, private APIs, proprietary datasets, plan names, UI trade dress, course libraries, textbook solutions, documents, school content, AI prompts, or protected media.
...
|---|---|---|---|
| Apple App Store | https://apps.apple.com/us/app/tunnelbear-secure-vpn-wifi/id564842283 | iOS listing, privacy labels, release notes, VPN/GhostBear claims, and support links | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
| Google Play | https://play.google.com/store/apps/details?id=com.tunnelbear.android | Android listing, data safety, VPN/VigilantBear claims, and release cadence | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
| Official product site | https://www.tunnelbear.com/ | TunnelBear features, GhostBear, VigilantBear, audits, and product positioning | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
| Official help | https://help.tunnelbear.com/ | TunnelBear setup, features, GhostBear, troubleshooting, and FAQ | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
| Privacy policy | https://www.tunnelbear.com/privacy-policy | Account, VPN no-logs policy, analytics, and privacy disclosures | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
| Terms | https://www.tunnelbear.com/terms-of-service | Service, subscriptions, VPN usage, and acceptable-use boundaries | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
...
- Manual blockers must remain launch-blocking until verified: account and subscription policy, VPN tunnel establishment and protocol negotiation, GhostBear obfuscation effectiveness, VigilantBear kill switch enforcement on iOS/Android, SplitBear split tunneling configuration, closest tunnel selection algorithm, free tier 500 MB tracking and enforcement, independent audit transparency, auto-connect behavior, DNS leak prevention, subscription restore, and regional server availability.

## Core User Journeys

- User creates or restores a TunnelBear-style account, completes role, school, subscription, or tenant checks, and reaches the dashboard.
...
- Monetization model: use original free/trial/paid/sponsored/school/provider/tenant entitlement logic; do not copy exact pricing, plan names, bundle names, promotional copy, school contracts, tenant offers, or partner offers from TunnelBear.
...
- Manual verification tests for account and subscription policy, VPN tunnel establishment and protocol negotiation, GhostBear obfuscation effectiveness, VigilantBear kill switch enforcement on iOS/Android, SplitBear split tunneling configuration, closest tunnel selection algorithm, free tier 500 MB tracking and enforcement, independent audit transparency, auto-connect behavior, DNS leak prevention, subscription restore, and regional server availability.
...
- Phase 4: Add app-specific safety controls for VPN with bear-themed UI, one-tap connect, GhostBear (obfuscation for restrictive networks), VigilantBear (kill switch), SplitBear (split tunneling), closest tunnel auto-selection, 500 MB/month free tier, independent security audits, and subscription plan entitlements.
...
- Confirm legal/privacy retention behavior for TunnelBear-style sensitive records and update API contracts before downstream implementation.
