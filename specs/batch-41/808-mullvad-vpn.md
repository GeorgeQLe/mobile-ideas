# Mullvad VPN-Style Clone Spec

> Metadata
> - Inspiration app: Mullvad VPN
...
> - Manual verification blockers: anonymous account policy (number-only, no email recovery), VPN tunnel establishment and WireGuard negotiation, multihop server chaining, kill switch always-on enforcement on iOS/Android, split tunneling configuration, DNS content blocking accuracy, DAITA traffic-shaping behavior, port forwarding assignment, auto-connect network detection, DNS leak prevention, payment methods (cash, cryptocurrency, card), account time balance tracking, and regional server availability.
...
Build an original mobile product inspired by Mullvad VPN's public security and vpn workflow. The V1 clone focuses on privacy-focused VPN with anonymous account numbers (no email/phone), one-tap connect, WireGuard-first protocol, multihop, kill switch (always-on VPN), split tunneling, DNS content blocking, custom DNS, DAITA (defense against AI-guided traffic analysis), port forwarding, auto-connect, and flat-rate subscription with no tiers.
...
- Preserve the functional job behind Mullvad VPN while using original product naming, original UI, original sample data, and licensed integrations.
...
- Do not copy Mullvad VPN branding, logos, screenshots, marketing copy, private APIs, proprietary datasets, plan names, UI trade dress, course libraries, textbook solutions, documents, school content, AI prompts, or protected media.
...
|---|---|---|---|
| Apple App Store | https://apps.apple.com/us/app/mullvad-vpn/id1488466513 | iOS listing, privacy labels, release notes, VPN/privacy claims, and support links | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
| Google Play | https://play.google.com/store/apps/details?id=net.mullvad.mullvadvpn | Android listing, data safety, VPN/WireGuard claims, and release cadence | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
| Official product site | https://mullvad.net/ | Mullvad VPN features, privacy, WireGuard, DAITA, and product positioning | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
| Official help | https://mullvad.net/help/ | Mullvad VPN setup, protocols, kill switch, split tunneling, and troubleshooting | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
| Privacy policy | https://mullvad.net/help/privacy-policy | Anonymous account, VPN no-logs policy, and privacy disclosures | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
| Terms | https://mullvad.net/help/terms-of-service | Service, subscriptions, VPN usage, and acceptable-use boundaries | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
...
- Manual blockers must remain launch-blocking until verified: anonymous account policy (number-only, no email recovery), VPN tunnel establishment and WireGuard negotiation, multihop server chaining, kill switch always-on enforcement on iOS/Android, split tunneling configuration, DNS content blocking accuracy, DAITA traffic-shaping behavior, port forwarding assignment, auto-connect network detection, DNS leak prevention, payment methods (cash, cryptocurrency, card), account time balance tracking, and regional server availability.

## Core User Journeys

- User creates or restores a Mullvad VPN-style account, completes role, school, subscription, or tenant checks, and reaches the dashboard.
...
- Monetization model: use original free/trial/paid/sponsored/school/provider/tenant entitlement logic; do not copy exact pricing, plan names, bundle names, promotional copy, school contracts, tenant offers, or partner offers from Mullvad VPN.
...
- Manual verification tests for anonymous account policy (number-only, no email recovery), VPN tunnel establishment and WireGuard negotiation, multihop server chaining, kill switch always-on enforcement on iOS/Android, split tunneling configuration, DNS content blocking accuracy, DAITA traffic-shaping behavior, port forwarding assignment, auto-connect network detection, DNS leak prevention, payment methods (cash, cryptocurrency, card), account time balance tracking, and regional server availability.
...
- Phase 4: Add app-specific safety controls for privacy-focused VPN with anonymous account numbers (no email/phone), one-tap connect, WireGuard-first protocol, multihop, kill switch (always-on VPN), split tunneling, DNS content blocking, custom DNS, DAITA (defense against AI-guided traffic analysis), port forwarding, auto-connect, and flat-rate subscription with no tiers.
...
- Confirm legal/privacy retention behavior for Mullvad VPN-style sensitive records and update API contracts before downstream implementation.
