# Norton 360-Style Clone Spec

> Metadata
> - Inspiration app: Norton 360
...
> - Manual verification blockers: Norton account and subscription policy, device security scan engine and signature behavior, Safe Web URL classification accuracy, Wi-Fi security network analysis, VPN tunnel establishment and server selection, dark web monitoring credential sourcing, password manager vault encryption, call blocking caller-ID integration, identity theft monitoring scope, parental controls child profile management, cloud backup storage and encryption, subscription restore, and platform-specific feature availability.
...
Build an original mobile product inspired by Norton 360's public security and vpn workflow. The V1 clone focuses on mobile security suite with device security scan, web protection (Safe Web), Wi-Fi security, VPN (Norton Secure VPN), dark web monitoring, password manager (Norton Password Manager), call blocking, identity theft protection, parental controls (Norton Family), cloud backup, and subscription plan entitlements.
...
- Preserve the functional job behind Norton 360 while using original product naming, original UI, original sample data, and licensed integrations.
...
- Do not copy Norton 360 branding, logos, screenshots, marketing copy, private APIs, proprietary datasets, plan names, UI trade dress, course libraries, textbook solutions, documents, school content, AI prompts, or protected media.
...
|---|---|---|---|
| Apple App Store | https://apps.apple.com/us/app/norton-360-mobile-security/id684917661 | iOS listing, privacy labels, release notes, security/VPN/identity claims, and support links | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
| Google Play | https://play.google.com/store/apps/details?id=com.symantec.mobilesecurity | Android listing, data safety, security scan/VPN/dark web claims, and release cadence | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
| Official product site | https://us.norton.com/products/norton-360 | Norton 360 security suite, VPN, dark web, identity, and product positioning | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
| Official help | https://support.norton.com/ | Norton 360 setup, security, VPN, password manager, and troubleshooting | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
| Privacy policy | https://www.nortonlifelock.com/us/en/privacy/ | Norton/Gen account, security scans, VPN, identity, analytics, and privacy disclosures | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
| Terms | https://www.nortonlifelock.com/us/en/legal/license-services-agreement/ | Norton services, subscriptions, security, VPN, and acceptable-use boundaries | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
...
- Manual blockers must remain launch-blocking until verified: Norton account and subscription policy, device security scan engine and signature behavior, Safe Web URL classification accuracy, Wi-Fi security network analysis, VPN tunnel establishment and server selection, dark web monitoring credential sourcing, password manager vault encryption, call blocking caller-ID integration, identity theft monitoring scope, parental controls child profile management, cloud backup storage and encryption, subscription restore, and platform-specific feature availability.

## Core User Journeys

- User creates or restores a Norton 360-style account, completes role, school, subscription, or tenant checks, and reaches the dashboard.
...
- Monetization model: use original free/trial/paid/sponsored/school/provider/tenant entitlement logic; do not copy exact pricing, plan names, bundle names, promotional copy, school contracts, tenant offers, or partner offers from Norton 360.
...
- Manual verification tests for Norton account and subscription policy, device security scan engine and signature behavior, Safe Web URL classification accuracy, Wi-Fi security network analysis, VPN tunnel establishment and server selection, dark web monitoring credential sourcing, password manager vault encryption, call blocking caller-ID integration, identity theft monitoring scope, parental controls child profile management, cloud backup storage and encryption, subscription restore, and platform-specific feature availability.
...
- Phase 4: Add app-specific safety controls for mobile security suite with device security scan, web protection (Safe Web), Wi-Fi security, VPN (Norton Secure VPN), dark web monitoring, password manager (Norton Password Manager), call blocking, identity theft protection, parental controls (Norton Family), cloud backup, and subscription plan entitlements.
...
- Confirm legal/privacy retention behavior for Norton 360-style sensitive records and update API contracts before downstream implementation.
