# HubSpot-Style Clone Spec

> Metadata
> - Inspiration app: HubSpot
...
> - Manual verification blockers: HubSpot account and portal/hub policy, contact/company/deal CRUD and property validation, deal pipeline stage and automation triggers, activity logging and association rules, email tracking open/click accuracy, meeting scheduler calendar integration, live chat routing and bot handoff, calling VoIP/PSTN integration and recording, document tracking view notifications, quote generation and e-sign, ticket pipeline and SLA behavior, marketing email send limits and deliverability, dashboard rendering and custom report builder, push notification delivery for record changes/emails/chats, multi-portal switching, HubSpot marketplace integrations, and plan-gated feature enforcement.
...
Build an original mobile product inspired by HubSpot's public enterprise operations workflow. The V1 clone focuses on mobile CRM with contact and company management, deal pipeline and tracking, task and activity logging, email tracking and templates, meeting scheduler, live chat and conversations inbox, calling with logging, document sharing and tracking, quotes, tickets (service hub), marketing email and forms, dashboards and reports, push notifications for deal/email/chat activity, and free/starter/professional/enterprise plan entitlements.
...
- Preserve the functional job behind HubSpot while using original product naming, original UI, original sample data, and licensed integrations.
...
- Do not copy HubSpot branding, logos, screenshots, marketing copy, private APIs, proprietary datasets, plan names, UI trade dress, course libraries, textbook solutions, documents, school content, AI prompts, or protected media.
...
|---|---|---|---|
| Apple App Store | https://apps.apple.com/us/app/hubspot-crm/id1107711722 | iOS listing, privacy labels, release notes, CRM/sales/service claims, and support links | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
| Google Play | https://play.google.com/store/apps/details?id=com.hubspot.android | Android listing, data safety, CRM/email/chat claims, and release cadence | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
| Official product site | https://www.hubspot.com/products/mobile | HubSpot Mobile CRM, sales, service, marketing, and product positioning | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
| Official help | https://knowledge.hubspot.com/mobile | HubSpot Mobile setup, CRM, calling, notifications, and troubleshooting | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
| Privacy policy | https://legal.hubspot.com/privacy-policy | HubSpot account, portal data, analytics, AI, and privacy disclosures | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
| Terms | https://legal.hubspot.com/terms-of-service | HubSpot services, subscriptions, enterprise, and acceptable-use boundaries | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
...
- Manual blockers must remain launch-blocking until verified: HubSpot account and portal/hub policy, contact/company/deal CRUD and property validation, deal pipeline stage and automation triggers, activity logging and association rules, email tracking open/click accuracy, meeting scheduler calendar integration, live chat routing and bot handoff, calling VoIP/PSTN integration and recording, document tracking view notifications, quote generation and e-sign, ticket pipeline and SLA behavior, marketing email send limits and deliverability, dashboard rendering and custom report builder, push notification delivery for record changes/emails/chats, multi-portal switching, HubSpot marketplace integrations, and plan-gated feature enforcement.

## Core User Journeys

- User creates or restores a HubSpot-style account, completes role, school, subscription, or tenant checks, and reaches the dashboard.
...
- Monetization model: use original free/trial/paid/sponsored/school/provider/tenant entitlement logic; do not copy exact pricing, plan names, bundle names, promotional copy, school contracts, tenant offers, or partner offers from HubSpot.
...
- Manual verification tests for HubSpot account and portal/hub policy, contact/company/deal CRUD and property validation, deal pipeline stage and automation triggers, activity logging and association rules, email tracking open/click accuracy, meeting scheduler calendar integration, live chat routing and bot handoff, calling VoIP/PSTN integration and recording, document tracking view notifications, quote generation and e-sign, ticket pipeline and SLA behavior, marketing email send limits and deliverability, dashboard rendering and custom report builder, push notification delivery for record changes/emails/chats, multi-portal switching, HubSpot marketplace integrations, and plan-gated feature enforcement.
...
- Confirm legal/privacy retention behavior for HubSpot-style sensitive records and update API contracts before downstream implementation.
