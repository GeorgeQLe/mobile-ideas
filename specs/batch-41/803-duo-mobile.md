# Duo Mobile-Style Clone Spec

> Metadata
> - Inspiration app: Duo Mobile
...
> - Manual verification blockers: Duo Security admin and organization policy, Duo Push delivery and approval timing, Verified Push number-matching flow, TOTP/HOTP generation accuracy and time sync, biometric verification security model, Trusted Endpoints device health reporting, third-party account QR enrollment, backup encryption and cross-device restore, MDM-managed enrollment, jailbreak/root detection, and enterprise admin-configured authentication policies.
...
Build an original mobile product inspired by Duo Mobile's public cloud files and identity workflow. The V1 clone focuses on multi-factor authentication with Duo Push approval, TOTP/HOTP passcode generation, biometric verification, Duo Verified Push (number matching), Trusted Endpoints device health checks, third-party account support (Google, Facebook, etc.), backup and restore, and enterprise Duo Security/Cisco integration.
...
- Preserve the functional job behind Duo Mobile while using original product naming, original UI, original sample data, and licensed integrations.
...
- Do not copy Duo Mobile branding, logos, screenshots, marketing copy, private APIs, proprietary datasets, plan names, UI trade dress, course libraries, textbook solutions, documents, school content, AI prompts, or protected media.
...
|---|---|---|---|
| Apple App Store | https://apps.apple.com/us/app/duo-mobile/id422663827 | iOS listing, privacy labels, release notes, MFA/push claims, and support links | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
| Google Play | https://play.google.com/store/apps/details?id=com.duosecurity.duomobile | Android listing, data safety, MFA/device-health claims, and release cadence | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
| Official product site | https://duo.com/product/multi-factor-authentication-mfa/duo-mobile-app | Duo Mobile MFA, push, device trust, and product positioning | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
| Official help | https://guide.duo.com/duo-mobile | Duo Mobile setup, push, passcodes, backup, restore, and troubleshooting | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
| Privacy policy | https://www.cisco.com/c/en/us/about/legal/privacy-full.html | Cisco/Duo account, device signals, analytics, and privacy disclosures | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
| Terms | https://www.cisco.com/c/en/us/about/legal/terms-conditions.html | Cisco/Duo services agreement, enterprise, and acceptable-use boundaries | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
...
- Manual blockers must remain launch-blocking until verified: Duo Security admin and organization policy, Duo Push delivery and approval timing, Verified Push number-matching flow, TOTP/HOTP generation accuracy and time sync, biometric verification security model, Trusted Endpoints device health reporting, third-party account QR enrollment, backup encryption and cross-device restore, MDM-managed enrollment, jailbreak/root detection, and enterprise admin-configured authentication policies.

## Core User Journeys

- User creates or restores a Duo Mobile-style account, completes role, school, subscription, or tenant checks, and reaches the dashboard.
...
- Monetization model: use original free/trial/paid/sponsored/school/provider/tenant entitlement logic; do not copy exact pricing, plan names, bundle names, promotional copy, school contracts, tenant offers, or partner offers from Duo Mobile.
...
- Manual verification tests for Duo Security admin and organization policy, Duo Push delivery and approval timing, Verified Push number-matching flow, TOTP/HOTP generation accuracy and time sync, biometric verification security model, Trusted Endpoints device health reporting, third-party account QR enrollment, backup encryption and cross-device restore, MDM-managed enrollment, jailbreak/root detection, and enterprise admin-configured authentication policies.
...
- Phase 4: Add app-specific safety controls for multi-factor authentication with Duo Push approval, TOTP/HOTP passcode generation, biometric verification, Duo Verified Push (number matching), Trusted Endpoints device health checks, third-party account support (Google, Facebook, etc.), backup and restore, and enterprise Duo Security/Cisco integration.
...
- Confirm legal/privacy retention behavior for Duo Mobile-style sensitive records and update API contracts before downstream implementation.
