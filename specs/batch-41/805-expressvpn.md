# ExpressVPN-Style Clone Spec

> Metadata
> - Inspiration app: ExpressVPN
...
> - Manual verification blockers: account and subscription policy, VPN tunnel establishment and Lightway protocol negotiation, server selection and smart location algorithm, Network Lock kill switch enforcement on iOS/Android, split tunneling configuration, Threat Manager filtering accuracy, private DNS leak prevention, auto-connect network detection, speed test methodology, subscription restore, and regional server availability.
...
Build an original mobile product inspired by ExpressVPN's public security and vpn workflow. The V1 clone focuses on VPN with one-tap connect, smart location selection, 105+ country server network, Lightway protocol, Network Lock (kill switch), split tunneling, private DNS, Threat Manager (tracker/malware blocking), auto-connect on untrusted Wi-Fi, speed test, and subscription plan entitlements.
...
- Preserve the functional job behind ExpressVPN while using original product naming, original UI, original sample data, and licensed integrations.
...
- Do not copy ExpressVPN branding, logos, screenshots, marketing copy, private APIs, proprietary datasets, plan names, UI trade dress, course libraries, textbook solutions, documents, school content, AI prompts, or protected media.
...
|---|---|---|---|
| Apple App Store | https://apps.apple.com/us/app/expressvpn-vpn-fast-secure/id886492891 | iOS listing, privacy labels, release notes, VPN/Lightway claims, and support links | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
| Google Play | https://play.google.com/store/apps/details?id=com.expressvpn.vpn | Android listing, data safety, VPN/Threat Manager claims, and release cadence | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
| Official product site | https://www.expressvpn.com/ | ExpressVPN features, servers, Lightway, Threat Manager, and product positioning | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
| Official help | https://www.expressvpn.com/support/ | ExpressVPN setup, protocols, kill switch, split tunneling, and troubleshooting | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
| Privacy policy | https://www.expressvpn.com/privacy-policy | Account, VPN no-logs policy, analytics, and privacy disclosures | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
| Terms | https://www.expressvpn.com/tos | Service, subscriptions, VPN usage, and acceptable-use boundaries | Verified public URL or explicit platform blocker on 2026-05-05; hands-on native behavior still blocked. |
...
- Manual blockers must remain launch-blocking until verified: account and subscription policy, VPN tunnel establishment and Lightway protocol negotiation, server selection and smart location algorithm, Network Lock kill switch enforcement on iOS/Android, split tunneling configuration, Threat Manager filtering accuracy, private DNS leak prevention, auto-connect network detection, speed test methodology, subscription restore, and regional server availability.

## Core User Journeys

- User creates or restores a ExpressVPN-style account, completes role, school, subscription, or tenant checks, and reaches the dashboard.
...
- Monetization model: use original free/trial/paid/sponsored/school/provider/tenant entitlement logic; do not copy exact pricing, plan names, bundle names, promotional copy, school contracts, tenant offers, or partner offers from ExpressVPN.
...
- Manual verification tests for account and subscription policy, VPN tunnel establishment and Lightway protocol negotiation, server selection and smart location algorithm, Network Lock kill switch enforcement on iOS/Android, split tunneling configuration, Threat Manager filtering accuracy, private DNS leak prevention, auto-connect network detection, speed test methodology, subscription restore, and regional server availability.
...
- Phase 4: Add app-specific safety controls for VPN with one-tap connect, smart location selection, 105+ country server network, Lightway protocol, Network Lock (kill switch), split tunneling, private DNS, Threat Manager (tracker/malware blocking), auto-connect on untrusted Wi-Fi, speed test, and subscription plan entitlements.
...
- Confirm legal/privacy retention behavior for ExpressVPN-style sensitive records and update API contracts before downstream implementation.
