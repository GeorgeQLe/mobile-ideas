# PNC Mobile-Style Clone Spec

> Metadata
> - Inspiration app: PNC Mobile
...
Build an original mobile product inspired by PNC Mobile's public product and policy materials. V1 focuses on secure sign-in, account dashboard, transfers, bill pay, mobile deposit blockers, card controls, alerts, statements, money-management surfaces, purchase-payback/rewards states, support, and compliance blockers. The clone must use original branding, original UI copy, original sample data, licensed providers, and explicit disclosures when a feature is inferred from public materials rather than verified hands-on behavior.
...
- Support secure sign-in, account dashboard, transfers, bill pay, mobile deposit blockers, card controls, alerts, statements, money-management surfaces, purchase-payback/rewards states, support, and compliance blockers with clear retry, recovery, unavailable, region, entitlement, inventory, seller, and provider-aware states.
...
- Do not imply affiliation with PNC Mobile or its publisher.
...
|---|---|---|---|
| Official product | https://www.pnc.com/en/personal-banking/banking/online-and-mobile-banking/mobile-banking.html | Public product positioning, shopping, delivery, catalog, marketplace, membership, account, and app behavior | Verified 2026-05-04 |
| Support/help center | https://www.pnc.com/en/customer-service.html | Public support taxonomy for account, ordering, payment, pickup, shipping, returns, seller, loyalty, troubleshooting, and deletion/export flows | Verified 2026-05-04 |
| Privacy policy | https://www.pnc.com/en/privacy-policy.html | Account, profile, order, listing, location, device, advertising, analytics, support, seller, and user-rights handling | Verified 2026-05-04 |
| Terms of service | https://www.pnc.com/en/terms-and-conditions.html | Service usage, licensed content, payments, returns, marketplace conduct, seller/buyer limits, prohibited goods, and legal boundaries | Verified 2026-05-04 |
| Rewards, membership, or seller program | https://www.pnc.com/en/personal-banking/banking/services/pnc-purchase-payback.html | Reward, membership, loyalty, seller, service, authenticity, or entitlement orientation where public | Verified 2026-05-04 |
| App Store listing | https://apps.apple.com/us/app/pnc-mobile-banking/id303113127 | Canonical iOS listing, category, age rating, privacy label, compatibility, public feature claims, and native metadata | Verified 2026-05-04 |
| Google Play listing | https://play.google.com/store/apps/details?id=com.pnc.ecommerce.mobile | Canonical Android listing, feature blurbs, content rating, data safety, downloads, and native metadata | Verified 2026-05-04 |
...
- secure sign-in, account dashboard, transfers, bill pay, mobile deposit blockers, card controls, alerts, statements, money-management surfaces, purchase-payback/rewards states, support, and compliance blockers must be treated as launch-blocking behavior with owners, mitigations, acceptance tests, and manual-verification notes.
...
- `User`: owner, lifecycle state, authorization boundary, sync state, retention policy, deletion/export behavior, and audit metadata for PNC Mobile-inspired workflows.
- `AccountSession`: owner, lifecycle state, authorization boundary, sync state, retention policy, deletion/export behavior, and audit metadata for PNC Mobile-inspired workflows.
- `IdentityCheck`: owner, lifecycle state, authorization boundary, sync state, retention policy, deletion/export behavior, and audit metadata for PNC Mobile-inspired workflows.
- `BankAccount`: owner, lifecycle state, authorization boundary, sync state, retention policy, deletion/export behavior, and audit metadata for PNC Mobile-inspired workflows.
- `CardAccount`: owner, lifecycle state, authorization boundary, sync state, retention policy, deletion/export behavior, and audit metadata for PNC Mobile-inspired workflows.
- `BalanceSnapshot`: owner, lifecycle state, authorization boundary, sync state, retention policy, deletion/export behavior, and audit metadata for PNC Mobile-inspired workflows.
- `Transaction`: owner, lifecycle state, authorization boundary, sync state, retention policy, deletion/export behavior, and audit metadata for PNC Mobile-inspired workflows.
- `Transfer`: owner, lifecycle state, authorization boundary, sync state, retention policy, deletion/export behavior, and audit metadata for PNC Mobile-inspired workflows.
- `BillPayment`: owner, lifecycle state, authorization boundary, sync state, retention policy, deletion/export behavior, and audit metadata for PNC Mobile-inspired workflows.
- `MobileDeposit`: owner, lifecycle state, authorization boundary, sync state, retention policy, deletion/export behavior, and audit metadata for PNC Mobile-inspired workflows.
- `CardControl`: owner, lifecycle state, authorization boundary, sync state, retention policy, deletion/export behavior, and audit metadata for PNC Mobile-inspired workflows.
- `AlertPreference`: owner, lifecycle state, authorization boundary, sync state, retention policy, deletion/export behavior, and audit metadata for PNC Mobile-inspired workflows.
- `Statement`: owner, lifecycle state, authorization boundary, sync state, retention policy, deletion/export behavior, and audit metadata for PNC Mobile-inspired workflows.
- `RewardAccount`: owner, lifecycle state, authorization boundary, sync state, retention policy, deletion/export behavior, and audit metadata for PNC Mobile-inspired workflows.
- `DisputeCase`: owner, lifecycle state, authorization boundary, sync state, retention policy, deletion/export behavior, and audit metadata for PNC Mobile-inspired workflows.
- `FraudCase`: owner, lifecycle state, authorization boundary, sync state, retention policy, deletion/export behavior, and audit metadata for PNC Mobile-inspired workflows.
- `SupportCase`: owner, lifecycle state, authorization boundary, sync state, retention policy, deletion/export behavior, and audit metadata for PNC Mobile-inspired workflows.
- `AuditEvent`: owner, lifecycle state, authorization boundary, sync state, retention policy, deletion/export behavior, and audit metadata for PNC Mobile-inspired workflows.
- `LocalCacheRecord`: owner, lifecycle state, authorization boundary, sync state, retention policy, deletion/export behavior, and audit metadata for PNC Mobile-inspired workflows.
...
- Public API documentation must use original route names and domain models; never mimic private endpoint paths, request bodies, or proprietary provider schemas from PNC Mobile.
