# Rakuten-Style Clone Spec

> Metadata
> - Inspiration app: Rakuten
...
Build an original mobile product inspired by Rakuten's public product and policy materials. V1 focuses on cash-back store discovery, offer activation, shopping handoff attribution, rewards balance, payout methods, referral/member states, missing-cashback support, ad-tech disclosure, and privacy controls. The clone must use original branding, original UI copy, original sample data, licensed providers, and explicit disclosures when a feature is inferred from public materials rather than verified hands-on behavior.
...
- Support cash-back store discovery, offer activation, shopping handoff attribution, rewards balance, payout methods, referral/member states, missing-cashback support, ad-tech disclosure, and privacy controls with clear retry, recovery, unavailable, region, entitlement, inventory, seller, and provider-aware states.
- Preserve boundaries between member, store, offer, click attribution, shopping trip, cash-back ledger, payout, referral, support, advertising, and privacy-preference data.
...
- Do not imply affiliation with Rakuten or its publisher.
...
|---|---|---|---|
| Official product | https://www.rakuten.com/ | Public product positioning, shopping, delivery, catalog, marketplace, membership, account, and app behavior | Verified 2026-05-04 |
| Support/help center | https://www.rakuten.com/help | Public support taxonomy for account, ordering, payment, pickup, shipping, returns, seller, loyalty, troubleshooting, and deletion/export flows | Verified 2026-05-04 |
| Privacy policy | https://www.rakuten.com/help/article/privacy-policy-360002101688 | Account, profile, order, listing, location, device, advertising, analytics, support, seller, and user-rights handling | Verified 2026-05-04 |
| Terms of service | https://www.rakuten.com/help/article/terms-conditions-360002101348 | Service usage, licensed content, payments, returns, marketplace conduct, seller/buyer limits, prohibited goods, and legal boundaries | Verified 2026-05-04 |
| Rewards, membership, or seller program | https://www.rakuten.com/referral/default.do | Reward, membership, loyalty, seller, service, authenticity, or entitlement orientation where public | Verified 2026-05-04 |
| App Store listing | https://apps.apple.com/us/app/rakuten-cash-back-deals/id723134859 | Canonical iOS listing, category, age rating, privacy label, compatibility, public feature claims, and native metadata | Verified 2026-05-04 |
| Google Play listing | https://play.google.com/store/apps/details?id=com.ebates | Canonical Android listing, feature blurbs, content rating, data safety, downloads, and native metadata | Verified 2026-05-04 |
...
- cash-back store discovery, offer activation, shopping handoff attribution, rewards balance, payout methods, referral/member states, missing-cashback support, ad-tech disclosure, and privacy controls must be treated as launch-blocking behavior with owners, mitigations, acceptance tests, and manual-verification notes.
- cash-back attribution, ad-tech disclosure, missing-trip disputes, payout timing, referral abuse, store offer accuracy, browser/app handoff tracking, privacy preferences, and rewards liability must be treated as a launch-blocking risk area with owner, mitigation, and acceptance tests.
...
- `User`: owner, lifecycle state, authorization boundary, sync state, retention policy, deletion/export behavior, and audit metadata for Rakuten-inspired workflows.
- `AccountSession`: owner, lifecycle state, authorization boundary, sync state, retention policy, deletion/export behavior, and audit metadata for Rakuten-inspired workflows.
- `Store`: owner, lifecycle state, authorization boundary, sync state, retention policy, deletion/export behavior, and audit metadata for Rakuten-inspired workflows.
- `Offer`: owner, lifecycle state, authorization boundary, sync state, retention policy, deletion/export behavior, and audit metadata for Rakuten-inspired workflows.
- `ShoppingTrip`: owner, lifecycle state, authorization boundary, sync state, retention policy, deletion/export behavior, and audit metadata for Rakuten-inspired workflows.
- `AttributionEvent`: owner, lifecycle state, authorization boundary, sync state, retention policy, deletion/export behavior, and audit metadata for Rakuten-inspired workflows.
- `CashbackLedgerEntry`: owner, lifecycle state, authorization boundary, sync state, retention policy, deletion/export behavior, and audit metadata for Rakuten-inspired workflows.
- `PayoutInstrument`: owner, lifecycle state, authorization boundary, sync state, retention policy, deletion/export behavior, and audit metadata for Rakuten-inspired workflows.
- `Referral`: owner, lifecycle state, authorization boundary, sync state, retention policy, deletion/export behavior, and audit metadata for Rakuten-inspired workflows.
- `MissingCashbackCase`: owner, lifecycle state, authorization boundary, sync state, retention policy, deletion/export behavior, and audit metadata for Rakuten-inspired workflows.
- `PrivacyPreference`: owner, lifecycle state, authorization boundary, sync state, retention policy, deletion/export behavior, and audit metadata for Rakuten-inspired workflows.
- `SupportCase`: owner, lifecycle state, authorization boundary, sync state, retention policy, deletion/export behavior, and audit metadata for Rakuten-inspired workflows.
- `AuditEvent`: owner, lifecycle state, authorization boundary, sync state, retention policy, deletion/export behavior, and audit metadata for Rakuten-inspired workflows.
- `LocalCacheRecord`: owner, lifecycle state, authorization boundary, sync state, retention policy, deletion/export behavior, and audit metadata for Rakuten-inspired workflows.
...
- Public API documentation must use original route names and domain models; never mimic private endpoint paths, request bodies, or proprietary provider schemas from Rakuten.
