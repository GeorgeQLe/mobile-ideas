# FanDuel Sportsbook-Style Clone Spec

> Metadata
> - Inspiration app: FanDuel Sportsbook
...
Build an original mobile sports and fitness product inspired by FanDuel Sportsbook's public product and policy materials. V1 focuses on regulated sportsbook discovery, account eligibility, geolocation, odds boards, bet-slip-adjacent education, responsible-gaming controls, wallet blockers, promotional offer gates, and support/escalation flows without enabling real-money wagering in public-source V1. The clone must use original branding, original UI copy, original sample data, licensed sports/fitness/media providers, and explicit disclosures when a feature is inferred from public materials rather than verified hands-on behavior.
...
- Do not imply affiliation with FanDuel Sportsbook or its publisher.
...
|---|---|---|---|
| Official product | https://sportsbook.fanduel.com/ | Public product positioning, core surfaces, availability framing, account, catalog/feed, subscription, and app behavior | Verified 2026-05-04 |
| Support/help center | https://support.fanduel.com/s/ | Public support taxonomy for account, playback/activity/scoring, billing, devices, permissions, troubleshooting, and deletion/export flows | Verified 2026-05-04 |
| Privacy policy | https://www.fanduel.com/privacy | Account, profile, media/activity/history, device, advertising, analytics, support, children/profile, location, health, and user-rights handling | Verified 2026-05-04 |
| Terms of service | https://www.fanduel.com/terms | Service usage, licensed content, subscriptions, user conduct, provider limits, regulated-flow boundaries, and legal boundaries | Verified 2026-05-04 |
| App Store listing | https://apps.apple.com/us/app/fanduel-sportsbook-casino/id1413891970 | Canonical iOS listing, category, age rating, privacy label, compatibility, in-app purchases where public, and native metadata | Verified 2026-05-04 |
| Google Play listing | https://play.google.com/store/apps/details?id=com.fanduel.sportsbook | Canonical Android listing, feature blurbs, content rating, data safety, downloads, and native metadata | Verified 2026-05-04 |
...
- `User`: owner, lifecycle state, authorization boundary, sync state, retention policy, deletion/export behavior, and audit metadata for FanDuel Sportsbook-inspired sports and fitness workflows.
- `AccountSession`: owner, lifecycle state, authorization boundary, sync state, retention policy, deletion/export behavior, and audit metadata for FanDuel Sportsbook-inspired sports and fitness workflows.
- `EligibilityProfile`: owner, lifecycle state, authorization boundary, sync state, retention policy, deletion/export behavior, and audit metadata for FanDuel Sportsbook-inspired sports and fitness workflows.
- `GeoFenceCheck`: owner, lifecycle state, authorization boundary, sync state, retention policy, deletion/export behavior, and audit metadata for FanDuel Sportsbook-inspired sports and fitness workflows.
- `SportsbookMarket`: owner, lifecycle state, authorization boundary, sync state, retention policy, deletion/export behavior, and audit metadata for FanDuel Sportsbook-inspired sports and fitness workflows.
- `OddsLine`: owner, lifecycle state, authorization boundary, sync state, retention policy, deletion/export behavior, and audit metadata for FanDuel Sportsbook-inspired sports and fitness workflows.
- `SelectionIntent`: owner, lifecycle state, authorization boundary, sync state, retention policy, deletion/export behavior, and audit metadata for FanDuel Sportsbook-inspired sports and fitness workflows.
- `ResponsibleGamingLimit`: owner, lifecycle state, authorization boundary, sync state, retention policy, deletion/export behavior, and audit metadata for FanDuel Sportsbook-inspired sports and fitness workflows.
- `Promotion`: owner, lifecycle state, authorization boundary, sync state, retention policy, deletion/export behavior, and audit metadata for FanDuel Sportsbook-inspired sports and fitness workflows.
- `WalletBlocker`: owner, lifecycle state, authorization boundary, sync state, retention policy, deletion/export behavior, and audit metadata for FanDuel Sportsbook-inspired sports and fitness workflows.
- `SupportCase`: owner, lifecycle state, authorization boundary, sync state, retention policy, deletion/export behavior, and audit metadata for FanDuel Sportsbook-inspired sports and fitness workflows.
- `AuditEvent`: owner, lifecycle state, authorization boundary, sync state, retention policy, deletion/export behavior, and audit metadata for FanDuel Sportsbook-inspired sports and fitness workflows.
- `LocalCacheRecord`: owner, lifecycle state, authorization boundary, sync state, retention policy, deletion/export behavior, and audit metadata for FanDuel Sportsbook-inspired sports and fitness workflows.
