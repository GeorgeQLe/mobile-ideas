# DraftKings Sportsbook-Style Clone Spec

> Metadata
> - Inspiration app: DraftKings Sportsbook
...
Build an original mobile sports and fitness product inspired by DraftKings Sportsbook's public product and policy materials. V1 focuses on regulated sportsbook discovery, account eligibility, geolocation, odds boards, bet-slip-adjacent education, responsible-gaming controls, wallet blockers, promotional offer gates, and support/escalation flows without enabling real-money wagering in public-source V1. The clone must use original branding, original UI copy, original sample data, licensed sports/fitness/media providers, and explicit disclosures when a feature is inferred from public materials rather than verified hands-on behavior.
...
- Support regulated sportsbook discovery, account eligibility, geolocation, odds boards, bet-slip-adjacent education, responsible-gaming controls, wallet blockers, promotional offer gates, and support/escalation flows without enabling real-money wagering in public-source V1 with clear retry, recovery, unavailable, region, entitlement, and provider-aware states.
...
- Do not imply affiliation with DraftKings Sportsbook or its publisher.
...
|---|---|---|---|
| Official product | https://sportsbook.draftkings.com/ | Public product positioning, core surfaces, availability framing, account, catalog/feed, subscription, and app behavior | Verified 2026-05-04 |
| Support/help center | https://help.draftkings.com/hc/en-us | Public support taxonomy for account, playback/activity/scoring, billing, devices, permissions, troubleshooting, and deletion/export flows | Verified 2026-05-04 |
| Privacy policy | https://www.draftkings.com/help/privacynotice | Account, profile, media/activity/history, device, advertising, analytics, support, children/profile, location, health, and user-rights handling | Verified 2026-05-04 |
| Terms of service | https://www.draftkings.com/help/terms | Service usage, licensed content, subscriptions, user conduct, provider limits, regulated-flow boundaries, and legal boundaries | Verified 2026-05-04 |
| App Store listing | https://apps.apple.com/us/app/draftkings-sportsbook-casino/id1375031369 | Canonical iOS listing, category, age rating, privacy label, compatibility, in-app purchases where public, and native metadata | Verified 2026-05-04 |
| Google Play listing | https://play.google.com/store/apps/details?id=com.draftkings.sportsbook | Canonical Android listing, feature blurbs, content rating, data safety, downloads, and native metadata | Verified 2026-05-04 |
...
- age and identity eligibility must be treated as a launch-blocking risk area with owner, mitigation, acceptance tests, and manual-verification notes.
- state-by-state geolocation and regulator availability must be treated as a launch-blocking risk area with owner, mitigation, acceptance tests, and manual-verification notes.
- responsible-gaming limits and self-exclusion must be treated as a launch-blocking risk area with owner, mitigation, acceptance tests, and manual-verification notes.
- wallet/payment/KYC/AML handling must be treated as a launch-blocking risk area with owner, mitigation, acceptance tests, and manual-verification notes.
- odds feed licensing and stale-line display must be treated as a launch-blocking risk area with owner, mitigation, acceptance tests, and manual-verification notes.
- promotional offer disclosure and dark-pattern avoidance must be treated as a launch-blocking risk area with owner, mitigation, acceptance tests, and manual-verification notes.
- no real-money wager placement in public-source V1 must be treated as a launch-blocking risk area with owner, mitigation, acceptance tests, and manual-verification notes.
- support escalation for account lockouts and responsible-gaming distress must be treated as a launch-blocking risk area with owner, mitigation, acceptance tests, and manual-verification notes.
...
|---|---|---|---|---|
| Welcome / Eligibility | Defines the welcome / eligibility workflow for DraftKings Sportsbook-inspired sports and fitness behavior | taps, forms, search, filters, deep links, media controls, sensor/device permissions | empty, loading, loaded, signed-out, offline, entitlement-aware | permission denied, stale state, entitlement blocked, rights unavailable, provider failed, region unavailable, eligibility blocked |
| Age And Location Gate | Defines the age and location gate workflow for DraftKings Sportsbook-inspired sports and fitness behavior | taps, forms, search, filters, deep links, media controls, sensor/device permissions | empty, loading, loaded, signed-out, offline, entitlement-aware | permission denied, stale state, entitlement blocked, rights unavailable, provider failed, region unavailable, eligibility blocked |
| Home / Sportsbook Lobby | Defines the home / sportsbook lobby workflow for DraftKings Sportsbook-inspired sports and fitness behavior | taps, forms, search, filters, deep links, media controls, sensor/device permissions | empty, loading, loaded, signed-out, offline, entitlement-aware | permission denied, stale state, entitlement blocked, rights unavailable, provider failed, region unavailable, eligibility blocked |
| Odds Board | Defines the odds board workflow for DraftKings Sportsbook-inspired sports and fitness behavior | taps, forms, search, filters, deep links, media controls, sensor/device permissions | empty, loading, loaded, signed-out, offline, entitlement-aware | permission denied, stale state, entitlement blocked, rights unavailable, provider failed, region unavailable, eligibility blocked |
| Event Detail | Defines the event detail workflow for DraftKings Sportsbook-inspired sports and fitness behavior | taps, forms, search, filters, deep links, media controls, sensor/device permissions | empty, loading, loaded, signed-out, offline, entitlement-aware | permission denied, stale state, entitlement blocked, rights unavailable, provider failed, region unavailable, eligibility blocked |
| Bet Slip Education | Defines the bet slip education workflow for DraftKings Sportsbook-inspired sports and fitness behavior | taps, forms, search, filters, deep links, media controls, sensor/device permissions | empty, loading, loaded, signed-out, offline, entitlement-aware | permission denied, stale state, entitlement blocked, rights unavailable, provider failed, region unavailable, eligibility blocked |
| Responsible Gaming | Defines the responsible gaming workflow for DraftKings Sportsbook-inspired sports and fitness behavior | taps, forms, search, filters, deep links, media controls, sensor/device permissions | empty, loading, loaded, signed-out, offline, entitlement-aware | permission denied, stale state, entitlement blocked, rights unavailable, provider failed, region unavailable, eligibility blocked |
| Promotions | Defines the promotions workflow for DraftKings Sportsbook-inspired sports and fitness behavior | taps, forms, search, filters, deep links, media controls, sensor/device permissions | empty, loading, loaded, signed-out, offline, entitlement-aware | permission denied, stale state, entitlement blocked, rights unavailable, provider failed, region unavailable, eligibility blocked |
| Wallet Blocker | Defines the wallet blocker workflow for DraftKings Sportsbook-inspired sports and fitness behavior | taps, forms, search, filters, deep links, media controls, sensor/device permissions | empty, loading, loaded, signed-out, offline, entitlement-aware | permission denied, stale state, entitlement blocked, rights unavailable, provider failed, region unavailable, eligibility blocked |
...
- `User`: owner, lifecycle state, authorization boundary, sync state, retention policy, deletion/export behavior, and audit metadata for DraftKings Sportsbook-inspired sports and fitness workflows.
- `AccountSession`: owner, lifecycle state, authorization boundary, sync state, retention policy, deletion/export behavior, and audit metadata for DraftKings Sportsbook-inspired sports and fitness workflows.
- `EligibilityProfile`: owner, lifecycle state, authorization boundary, sync state, retention policy, deletion/export behavior, and audit metadata for DraftKings Sportsbook-inspired sports and fitness workflows.
- `GeoFenceCheck`: owner, lifecycle state, authorization boundary, sync state, retention policy, deletion/export behavior, and audit metadata for DraftKings Sportsbook-inspired sports and fitness workflows.
- `SportsbookMarket`: owner, lifecycle state, authorization boundary, sync state, retention policy, deletion/export behavior, and audit metadata for DraftKings Sportsbook-inspired sports and fitness workflows.
- `OddsLine`: owner, lifecycle state, authorization boundary, sync state, retention policy, deletion/export behavior, and audit metadata for DraftKings Sportsbook-inspired sports and fitness workflows.
- `SelectionIntent`: owner, lifecycle state, authorization boundary, sync state, retention policy, deletion/export behavior, and audit metadata for DraftKings Sportsbook-inspired sports and fitness workflows.
- `ResponsibleGamingLimit`: owner, lifecycle state, authorization boundary, sync state, retention policy, deletion/export behavior, and audit metadata for DraftKings Sportsbook-inspired sports and fitness workflows.
- `Promotion`: owner, lifecycle state, authorization boundary, sync state, retention policy, deletion/export behavior, and audit metadata for DraftKings Sportsbook-inspired sports and fitness workflows.
- `WalletBlocker`: owner, lifecycle state, authorization boundary, sync state, retention policy, deletion/export behavior, and audit metadata for DraftKings Sportsbook-inspired sports and fitness workflows.
- `SupportCase`: owner, lifecycle state, authorization boundary, sync state, retention policy, deletion/export behavior, and audit metadata for DraftKings Sportsbook-inspired sports and fitness workflows.
- `AuditEvent`: owner, lifecycle state, authorization boundary, sync state, retention policy, deletion/export behavior, and audit metadata for DraftKings Sportsbook-inspired sports and fitness workflows.
- `LocalCacheRecord`: owner, lifecycle state, authorization boundary, sync state, retention policy, deletion/export behavior, and audit metadata for DraftKings Sportsbook-inspired sports and fitness workflows.

## API And Backend Contracts

- POST /auth/session and DELETE /auth/session for account lifecycle.
- POST /eligibility/check, POST /geofence/check, and GET /regulated-states for blocked eligibility state without enabling wager placement.
- GET /sports, GET /events, GET /events/:id/markets, and GET /odds-lines with stale-line and provider attribution metadata.
- POST /selection-intents and DELETE /selection-intents/:id for non-wager educational bet-slip modeling behind a no-real-money feature flag.
- GET /responsible-gaming/limits, PATCH /responsible-gaming/limits, and POST /responsible-gaming/self-exclusion-request for blockers and support routing.
- GET /promotions with jurisdiction, age, and disclosure gates.
- GET /wallet/status returning blocked, unavailable, verified, and manual-review states; no production money movement in V1.
