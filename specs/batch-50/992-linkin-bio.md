# Linkin.bio-Style Clone Spec

> Metadata
> - Inspiration app: Linkin.bio
> - Category: Business
...
> - Manual verification blockers: Later/Linkin.bio account creation and Instagram account connection (Instagram API, OAuth), Instagram grid mirroring and post-to-link mapping (Instagram Graph API, media sync), Shopify and e-commerce product tagging integration (Shopify API, product catalog sync), landing page builder with banner, bio, featured links, and link blocks, analytics data aggregation (link clicks, page views, revenue attribution, referrer tracking), Later social media scheduling platform integration, TikTok and additional social platform connection and feed support, Google Analytics and UTM tracking parameter configuration, email collection form and subscriber management, custom branding and button styling, mobile-responsive page rendering, Instagram API rate limits and media sync freshness, e-commerce product availability and price sync, Later plan entitlement enforcement, and Linkin.bio/Later account integration.
...
Build an original mobile product inspired by Linkin.bio's public business workflow. The V1 clone focuses on Later's link-in-bio tool that transforms an Instagram feed into a clickable, shoppable landing page, Instagram grid mirroring with clickable posts linking to products, blog posts, or any URL, Shopify and e-commerce integration for direct product tagging and shopping, customizable landing page with banner, bio, and featured links, link blocks for additional links beyond Instagram posts, analytics with link clicks, page views, and revenue attribution, scheduling integration with Later's social media scheduling platform, TikTok and other social platform support, Google Analytics and UTM tracking integration, email collection forms, custom button styling and branding, mobile-optimized responsive pages, and included in Later's social media management plans (Free, Starter, Growth, Advanced).
...
- Preserve the functional job behind Linkin.bio while using original product naming, original UI, original sample data, and licensed integrations.
...
- Do not copy Linkin.bio branding, logos, screenshots, marketing copy, private APIs, proprietary datasets, plan names, UI trade dress, course libraries, textbook solutions, documents, school content, AI prompts, or protected media.
...
|---|---|---|---|
| Apple App Store | https://apps.apple.com/us/app/later-social-media-scheduler/id784907999 | iOS listing (Later), privacy labels, release notes, social scheduling/link-in-bio claims, and support links | Verified public URL or explicit platform blocker on 2026-05-06; hands-on native behavior still blocked. |
| Google Play | https://play.google.com/store/apps/details?id=me.latergram.latergramme | Android listing (Later), data safety, social media management/Linkin.bio claims, and release cadence | Verified public URL or explicit platform blocker on 2026-05-06; hands-on native behavior still blocked. |
| Official product site | https://later.com/linkin-bio/ | Linkin.bio link-in-bio, shoppable landing page, and product positioning | Verified public URL or explicit platform blocker on 2026-05-06; hands-on native behavior still blocked. |
| Official help | https://help.later.com/ | Later/Linkin.bio app help, setup, and troubleshooting | Verified public URL or explicit platform blocker on 2026-05-06; hands-on native behavior still blocked. |
| Privacy policy | https://later.com/privacy-policy/ | Later/Linkin.bio data collection, social data, and privacy disclosures | Verified public URL or explicit platform blocker on 2026-05-06; hands-on native behavior still blocked. |
| Terms | https://later.com/terms-of-service/ | Later services, Linkin.bio terms, and acceptable-use boundaries | Verified public URL or explicit platform blocker on 2026-05-06; hands-on native behavior still blocked. |
...
- Manual blockers must remain launch-blocking until verified: Later/Linkin.bio account creation and Instagram account connection (Instagram API, OAuth), Instagram grid mirroring and post-to-link mapping (Instagram Graph API, media sync), Shopify and e-commerce product tagging integration (Shopify API, product catalog sync), landing page builder with banner, bio, featured links, and link blocks, analytics data aggregation (link clicks, page views, revenue attribution, referrer tracking), Later social media scheduling platform integration, TikTok and additional social platform connection and feed support, Google Analytics and UTM tracking parameter configuration, email collection form and subscriber management, custom branding and button styling, mobile-responsive page rendering, Instagram API rate limits and media sync freshness, e-commerce product availability and price sync, Later plan entitlement enforcement, and Linkin.bio/Later account integration.

## Core User Journeys

- User creates or restores a Linkin.bio-style account, completes role, school, subscription, or tenant checks, and reaches the dashboard.
...
- Monetization model: use original free/trial/paid/sponsored/school/provider/tenant entitlement logic; do not copy exact pricing, plan names, bundle names, promotional copy, school contracts, tenant offers, or partner offers from Linkin.bio.
...
- Manual verification tests for Later/Linkin.bio account creation and Instagram account connection (Instagram API, OAuth), Instagram grid mirroring and post-to-link mapping (Instagram Graph API, media sync), Shopify and e-commerce product tagging integration (Shopify API, product catalog sync), landing page builder with banner, bio, featured links, and link blocks, analytics data aggregation (link clicks, page views, revenue attribution, referrer tracking), Later social media scheduling platform integration, TikTok and additional social platform connection and feed support, Google Analytics and UTM tracking parameter configuration, email collection form and subscriber management, custom branding and button styling, mobile-responsive page rendering, Instagram API rate limits and media sync freshness, e-commerce product availability and price sync, Later plan entitlement enforcement, and Linkin.bio/Later account integration.
...
- Phase 4: Add app-specific safety controls for Later's link-in-bio tool that transforms an Instagram feed into a clickable, shoppable landing page, Instagram grid mirroring with clickable posts linking to products, blog posts, or any URL, Shopify and e-commerce integration for direct product tagging and shopping, customizable landing page with banner, bio, and featured links, link blocks for additional links beyond Instagram posts, analytics with link clicks, page views, and revenue attribution, scheduling integration with Later's social media scheduling platform, TikTok and other social platform support, Google Analytics and UTM tracking integration, email collection forms, custom button styling and branding, mobile-optimized responsive pages, and included in Later's social media management plans (Free, Starter, Growth, Advanced).
...
- Confirm legal/privacy retention behavior for Linkin.bio-style sensitive records and update API contracts before downstream implementation.
