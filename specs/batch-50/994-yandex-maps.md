# Yandex Maps-Style Clone Spec

> Metadata
> - Inspiration app: Yandex Maps
> - Category: Navigation
...
> - Manual verification blockers: Yandex account creation and region configuration, map tile rendering and data sourcing (Yandex proprietary map data, OpenStreetMap contributions), real-time traffic data aggregation and congestion visualization, turn-by-turn navigation engine with voice guidance (Russian and multi-language TTS), public transit data integration (GTFS, real-time arrival APIs, multi-modal routing across bus, metro, tram, trolleybus, suburban rail), Yandex Panoramas street-level imagery viewer, POI search and business data (reviews, ratings, photos, hours, contact info), indoor map data for malls and airports, offline map download and tile caching by region, Yandex Taxi ride-hailing integration and booking, fuel price data sourcing and gas station search, speed camera database and road event crowd-sourced reporting, parking availability data integration, route sharing and collaborative trip planning, weather data overlay, Yandex Plus subscription entitlement, Russia/CIS regional data availability and compliance, and Yandex account integration.
...
Build an original mobile product inspired by Yandex Maps's public navigation workflow. The V1 clone focuses on comprehensive mapping and navigation platform dominant in Russia and CIS countries with detailed city maps, real-time traffic conditions and congestion visualization, turn-by-turn driving navigation with voice guidance, public transit routing with schedules, live arrival times, and multi-modal planning, walking and cycling navigation, Yandex Navigator integration for advanced driving features, panoramic street-level imagery (Yandex Panoramas), business and POI search with reviews, ratings, photos, and hours, indoor maps for malls and airports, offline map downloads for regions, Yandex Taxi and ride-hailing integration, fuel price tracking and gas station search, speed camera and road event warnings, parking availability information, route sharing and collaborative trip planning, weather overlay on maps, and free model with Yandex Plus subscription for enhanced features.
...
- Preserve the functional job behind Yandex Maps while using original product naming, original UI, original sample data, and licensed integrations.
...
- Do not copy Yandex Maps branding, logos, screenshots, marketing copy, private APIs, proprietary datasets, plan names, UI trade dress, course libraries, textbook solutions, documents, school content, AI prompts, or protected media.
...
|---|---|---|---|
| Apple App Store | https://apps.apple.com/us/app/yandex-maps-navigator/id313877526 | iOS listing, privacy labels, release notes, mapping/navigation claims, and support links | Verified public URL or explicit platform blocker on 2026-05-06; hands-on native behavior still blocked. |
| Google Play | https://play.google.com/store/apps/details?id=ru.yandex.yandexmaps | Android listing, data safety, maps/transit/navigation claims, and release cadence | Verified public URL or explicit platform blocker on 2026-05-06; hands-on native behavior still blocked. |
| Official product site | https://yandex.com/maps/ | Yandex Maps navigation, transit, and product positioning | Verified public URL or explicit platform blocker on 2026-05-06; hands-on native behavior still blocked. |
| Official help | https://yandex.com/support/maps/ | Yandex Maps app help, navigation, and troubleshooting | Verified public URL or explicit platform blocker on 2026-05-06; hands-on native behavior still blocked. |
| Privacy policy | https://yandex.com/legal/privacy/ | Yandex data collection, location data, and privacy disclosures | Verified public URL or explicit platform blocker on 2026-05-06; hands-on native behavior still blocked. |
| Terms | https://yandex.com/legal/maps_termsofuse/ | Yandex Maps services, usage terms, and acceptable-use boundaries | Verified public URL or explicit platform blocker on 2026-05-06; hands-on native behavior still blocked. |
...
- Manual blockers must remain launch-blocking until verified: Yandex account creation and region configuration, map tile rendering and data sourcing (Yandex proprietary map data, OpenStreetMap contributions), real-time traffic data aggregation and congestion visualization, turn-by-turn navigation engine with voice guidance (Russian and multi-language TTS), public transit data integration (GTFS, real-time arrival APIs, multi-modal routing across bus, metro, tram, trolleybus, suburban rail), Yandex Panoramas street-level imagery viewer, POI search and business data (reviews, ratings, photos, hours, contact info), indoor map data for malls and airports, offline map download and tile caching by region, Yandex Taxi ride-hailing integration and booking, fuel price data sourcing and gas station search, speed camera database and road event crowd-sourced reporting, parking availability data integration, route sharing and collaborative trip planning, weather data overlay, Yandex Plus subscription entitlement, Russia/CIS regional data availability and compliance, and Yandex account integration.

## Core User Journeys

- User creates or restores a Yandex Maps-style account, completes role, school, subscription, or tenant checks, and reaches the dashboard.
...
- Monetization model: use original free/trial/paid/sponsored/school/provider/tenant entitlement logic; do not copy exact pricing, plan names, bundle names, promotional copy, school contracts, tenant offers, or partner offers from Yandex Maps.
...
- Manual verification tests for Yandex account creation and region configuration, map tile rendering and data sourcing (Yandex proprietary map data, OpenStreetMap contributions), real-time traffic data aggregation and congestion visualization, turn-by-turn navigation engine with voice guidance (Russian and multi-language TTS), public transit data integration (GTFS, real-time arrival APIs, multi-modal routing across bus, metro, tram, trolleybus, suburban rail), Yandex Panoramas street-level imagery viewer, POI search and business data (reviews, ratings, photos, hours, contact info), indoor map data for malls and airports, offline map download and tile caching by region, Yandex Taxi ride-hailing integration and booking, fuel price data sourcing and gas station search, speed camera database and road event crowd-sourced reporting, parking availability data integration, route sharing and collaborative trip planning, weather data overlay, Yandex Plus subscription entitlement, Russia/CIS regional data availability and compliance, and Yandex account integration.
...
- Phase 4: Add app-specific safety controls for comprehensive mapping and navigation platform dominant in Russia and CIS countries with detailed city maps, real-time traffic conditions and congestion visualization, turn-by-turn driving navigation with voice guidance, public transit routing with schedules, live arrival times, and multi-modal planning, walking and cycling navigation, Yandex Navigator integration for advanced driving features, panoramic street-level imagery (Yandex Panoramas), business and POI search with reviews, ratings, photos, and hours, indoor maps for malls and airports, offline map downloads for regions, Yandex Taxi and ride-hailing integration, fuel price tracking and gas station search, speed camera and road event warnings, parking availability information, route sharing and collaborative trip planning, weather overlay on maps, and free model with Yandex Plus subscription for enhanced features.
...
- Confirm legal/privacy retention behavior for Yandex Maps-style sensitive records and update API contracts before downstream implementation.
