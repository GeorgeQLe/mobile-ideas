# Beacons-Style Clone Spec

> Metadata
> - Inspiration app: Beacons
> - Category: Business
...
> - Manual verification blockers: Beacons account creation and creator onboarding, link-in-bio page builder with customizable blocks (links, embeds, products, media), online store with digital product creation, membership configuration, and custom request forms, email marketing system (broadcasts, automations, segmentation, templates), AI content generation and branding tools (LLM integration, design suggestions), media kit generator with audience analytics aggregation from social platforms, invoicing system for sponsorships and brand deals (creation, tracking, payment), tip jar and donation collection (Stripe/PayPal), social platform integration (Instagram, TikTok, YouTube, Twitch data/embeds), analytics dashboard (link clicks, store revenue, audience demographics, traffic), custom domain DNS configuration, payment processing (Stripe, PayPal, multi-currency), plan entitlement enforcement (Free tier limitations, paid tier features), and Beacons account integration.
...
Build an original mobile product inspired by Beacons's public business workflow. The V1 clone focuses on AI-powered link-in-bio and creator business platform combining landing page builder with integrated store, email marketing, invoicing, and media kit, customizable link-in-bio with blocks for links, embeds, products, and content, online store for digital products, memberships, and custom requests, email marketing with broadcasts, automations, and audience segmentation, AI-generated content suggestions and branding tools, media kit generator with audience analytics for brand deals, invoicing and payment tracking for sponsorships, tip jar and donation collection, integration with social platforms (Instagram, TikTok, YouTube, Twitch), analytics with link clicks, store revenue, and audience demographics, custom domain support, mobile-optimized pages, Stripe and PayPal payment integration, and freemium model (Free, Creator Pro, Store Pro, Business Pro tiers).
...
- Deliver a mobile-first business experience with onboarding, dashboard, primary workflow, reminders or notifications, settings, support, and recovery flows.
- Preserve the functional job behind Beacons while using original product naming, original UI, original sample data, and licensed integrations.
...
- Do not copy Beacons branding, logos, screenshots, marketing copy, private APIs, proprietary datasets, plan names, UI trade dress, course libraries, textbook solutions, documents, school content, AI prompts, or protected media.
...
|---|---|---|---|
| Apple App Store | https://apps.apple.com/us/app/beacons-link-in-bio/id1583216440 | iOS listing, privacy labels, release notes, creator platform/link-in-bio claims, and support links | Verified public URL or explicit platform blocker on 2026-05-06; hands-on native behavior still blocked. |
| Google Play | https://play.google.com/store/apps/details?id=com.beacons.app | Android listing, data safety, creator business/store claims, and release cadence | Verified public URL or explicit platform blocker on 2026-05-06; hands-on native behavior still blocked. |
| Official product site | https://beacons.ai/ | Beacons AI creator platform, link-in-bio, store, and product positioning | Verified public URL or explicit platform blocker on 2026-05-06; hands-on native behavior still blocked. |
| Official help | https://help.beacons.ai/ | Beacons app help, creator setup, and troubleshooting | Verified public URL or explicit platform blocker on 2026-05-06; hands-on native behavior still blocked. |
| Privacy policy | https://beacons.ai/privacy | Beacons data collection, creator data, payment data, and privacy disclosures | Verified public URL or explicit platform blocker on 2026-05-06; hands-on native behavior still blocked. |
| Terms | https://beacons.ai/terms | Beacons services, creator terms, and acceptable-use boundaries | Verified public URL or explicit platform blocker on 2026-05-06; hands-on native behavior still blocked. |
...
- Manual blockers must remain launch-blocking until verified: Beacons account creation and creator onboarding, link-in-bio page builder with customizable blocks (links, embeds, products, media), online store with digital product creation, membership configuration, and custom request forms, email marketing system (broadcasts, automations, segmentation, templates), AI content generation and branding tools (LLM integration, design suggestions), media kit generator with audience analytics aggregation from social platforms, invoicing system for sponsorships and brand deals (creation, tracking, payment), tip jar and donation collection (Stripe/PayPal), social platform integration (Instagram, TikTok, YouTube, Twitch data/embeds), analytics dashboard (link clicks, store revenue, audience demographics, traffic), custom domain DNS configuration, payment processing (Stripe, PayPal, multi-currency), plan entitlement enforcement (Free tier limitations, paid tier features), and Beacons account integration.

## Core User Journeys

- User creates or restores a Beacons-style account, completes role, school, subscription, or tenant checks, and reaches the dashboard.
...
- Monetization model: use original free/trial/paid/sponsored/school/provider/tenant entitlement logic; do not copy exact pricing, plan names, bundle names, promotional copy, school contracts, tenant offers, or partner offers from Beacons.
...
- Manual verification tests for Beacons account creation and creator onboarding, link-in-bio page builder with customizable blocks (links, embeds, products, media), online store with digital product creation, membership configuration, and custom request forms, email marketing system (broadcasts, automations, segmentation, templates), AI content generation and branding tools (LLM integration, design suggestions), media kit generator with audience analytics aggregation from social platforms, invoicing system for sponsorships and brand deals (creation, tracking, payment), tip jar and donation collection (Stripe/PayPal), social platform integration (Instagram, TikTok, YouTube, Twitch data/embeds), analytics dashboard (link clicks, store revenue, audience demographics, traffic), custom domain DNS configuration, payment processing (Stripe, PayPal, multi-currency), plan entitlement enforcement (Free tier limitations, paid tier features), and Beacons account integration.
...
- Phase 4: Add app-specific safety controls for AI-powered link-in-bio and creator business platform combining landing page builder with integrated store, email marketing, invoicing, and media kit, customizable link-in-bio with blocks for links, embeds, products, and content, online store for digital products, memberships, and custom requests, email marketing with broadcasts, automations, and audience segmentation, AI-generated content suggestions and branding tools, media kit generator with audience analytics for brand deals, invoicing and payment tracking for sponsorships, tip jar and donation collection, integration with social platforms (Instagram, TikTok, YouTube, Twitch), analytics with link clicks, store revenue, and audience demographics, custom domain support, mobile-optimized pages, Stripe and PayPal payment integration, and freemium model (Free, Creator Pro, Store Pro, Business Pro tiers).
...
- Confirm legal/privacy retention behavior for Beacons-style sensitive records and update API contracts before downstream implementation.
