# Thinkific-Style Clone Spec

> Metadata
> - Inspiration app: Thinkific
> - Category: Business
...
> - Manual verification blockers: Thinkific account creation and creator plan subscription, course builder with multimedia lesson types (video hosting, presentations, quizzes, surveys, assignments, downloads), site builder theme customization and branded portal editor, student management tools (enrollment, progress, engagement, certificates, exports), Thinkific Communities setup and moderation, membership and subscription product configuration with tiered access, digital download delivery and access management, Thinkific Payments checkout processing (Stripe, PayPal, multi-currency, tax), coupon engine and promotion scheduling, course completion certificate template and generation, drip scheduling and prerequisite enforcement logic, student analytics data aggregation (completion, engagement, revenue), affiliate program tracking and commission payouts, Thinkific App Store integration framework and third-party app management, branded mobile app (Thinkific Branded Mobile) provisioning and customization, bulk enrollment and group sales pricing, creator plan entitlement enforcement, and Thinkific account integration.
...
Build an original mobile product inspired by Thinkific's public business workflow. The V1 clone focuses on course creation and knowledge commerce platform with drag-and-drop course builder supporting video, presentations, quizzes, surveys, assignments, and downloads, site builder with customizable themes for branded learning portals, student management and engagement tools, Thinkific Communities for student interaction and discussion, membership and subscription products, digital download delivery, integrated checkout with Thinkific Payments (Stripe-based), coupon and promotion management, course completion certificates, drip and prerequisite content scheduling, student progress tracking and analytics, affiliate program, Thinkific App Store for third-party integrations, white-label branded mobile app (Thinkific Branded Mobile), bulk student enrollment and group sales, and tiered plans (Free, Basic, Start, Grow, Expand).
...
- Preserve the functional job behind Thinkific while using original product naming, original UI, original sample data, and licensed integrations.
...
- Do not copy Thinkific branding, logos, screenshots, marketing copy, private APIs, proprietary datasets, plan names, UI trade dress, course libraries, textbook solutions, documents, school content, AI prompts, or protected media.
...
|---|---|---|---|
| Apple App Store | https://apps.apple.com/us/app/thinkific/id1573486498 | iOS listing, privacy labels, release notes, course/student claims, and support links | Verified public URL or explicit platform blocker on 2026-05-06; hands-on native behavior still blocked. |
| Google Play | https://play.google.com/store/apps/details?id=com.thinkific.android | Android listing, data safety, knowledge commerce/course claims, and release cadence | Verified public URL or explicit platform blocker on 2026-05-06; hands-on native behavior still blocked. |
| Official product site | https://www.thinkific.com/ | Thinkific course creation, knowledge commerce, and product positioning | Verified public URL or explicit platform blocker on 2026-05-06; hands-on native behavior still blocked. |
| Official help | https://support.thinkific.com/ | Thinkific app help, course building, and troubleshooting | Verified public URL or explicit platform blocker on 2026-05-06; hands-on native behavior still blocked. |
| Privacy policy | https://www.thinkific.com/privacy-policy/ | Thinkific data collection, student data, payment data, and privacy disclosures | Verified public URL or explicit platform blocker on 2026-05-06; hands-on native behavior still blocked. |
| Terms | https://www.thinkific.com/terms-of-use/ | Thinkific services, creator/student terms, and acceptable-use boundaries | Verified public URL or explicit platform blocker on 2026-05-06; hands-on native behavior still blocked. |
...
- Manual blockers must remain launch-blocking until verified: Thinkific account creation and creator plan subscription, course builder with multimedia lesson types (video hosting, presentations, quizzes, surveys, assignments, downloads), site builder theme customization and branded portal editor, student management tools (enrollment, progress, engagement, certificates, exports), Thinkific Communities setup and moderation, membership and subscription product configuration with tiered access, digital download delivery and access management, Thinkific Payments checkout processing (Stripe, PayPal, multi-currency, tax), coupon engine and promotion scheduling, course completion certificate template and generation, drip scheduling and prerequisite enforcement logic, student analytics data aggregation (completion, engagement, revenue), affiliate program tracking and commission payouts, Thinkific App Store integration framework and third-party app management, branded mobile app (Thinkific Branded Mobile) provisioning and customization, bulk enrollment and group sales pricing, creator plan entitlement enforcement, and Thinkific account integration.

## Core User Journeys

- User creates or restores a Thinkific-style account, completes role, school, subscription, or tenant checks, and reaches the dashboard.
...
- Monetization model: use original free/trial/paid/sponsored/school/provider/tenant entitlement logic; do not copy exact pricing, plan names, bundle names, promotional copy, school contracts, tenant offers, or partner offers from Thinkific.
...
- Manual verification tests for Thinkific account creation and creator plan subscription, course builder with multimedia lesson types (video hosting, presentations, quizzes, surveys, assignments, downloads), site builder theme customization and branded portal editor, student management tools (enrollment, progress, engagement, certificates, exports), Thinkific Communities setup and moderation, membership and subscription product configuration with tiered access, digital download delivery and access management, Thinkific Payments checkout processing (Stripe, PayPal, multi-currency, tax), coupon engine and promotion scheduling, course completion certificate template and generation, drip scheduling and prerequisite enforcement logic, student analytics data aggregation (completion, engagement, revenue), affiliate program tracking and commission payouts, Thinkific App Store integration framework and third-party app management, branded mobile app (Thinkific Branded Mobile) provisioning and customization, bulk enrollment and group sales pricing, creator plan entitlement enforcement, and Thinkific account integration.
...
- Phase 4: Add app-specific safety controls for course creation and knowledge commerce platform with drag-and-drop course builder supporting video, presentations, quizzes, surveys, assignments, and downloads, site builder with customizable themes for branded learning portals, student management and engagement tools, Thinkific Communities for student interaction and discussion, membership and subscription products, digital download delivery, integrated checkout with Thinkific Payments (Stripe-based), coupon and promotion management, course completion certificates, drip and prerequisite content scheduling, student progress tracking and analytics, affiliate program, Thinkific App Store for third-party integrations, white-label branded mobile app (Thinkific Branded Mobile), bulk student enrollment and group sales, and tiered plans (Free, Basic, Start, Grow, Expand).
...
- Confirm legal/privacy retention behavior for Thinkific-style sensitive records and update API contracts before downstream implementation.
