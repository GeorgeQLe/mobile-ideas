# Skool-Style Clone Spec

> Metadata
> - Inspiration app: Skool
...
> - Manual verification blockers: Skool account creation and community group setup, community feed with post creation, commenting, threading, and reactions, course builder with module and lesson structure, video hosting, and action items, gamification engine (points for engagement, levels, leaderboard ranking algorithm), member directory with profiles and search, calendar with event creation, RSVP, and scheduling, direct messaging system between members, course navigation with module progression and completion tracking, about page editor and community description, integrated payment processing for paid communities (Stripe), affiliate program tracking and referral commission management, search indexing across community posts and course content, email notification system (activity digest, mentions, replies), mobile app experience and push notifications, content moderation and community management tools, member import and invitation management, and Skool account integration.
...
Build an original mobile product inspired by Skool's public social networking workflow. The V1 clone focuses on community and course platform combining gamified community engagement with structured courses, community feed with posts, comments, and reactions, course modules with video lessons and action items, gamification with points, levels, and leaderboard driving member engagement, member directory and profiles, calendar with community events and scheduling, direct messaging between members, classroom-style course navigation with module and lesson progression, about page with community description and membership details, integrated payments for paid communities (Stripe), affiliate program for member referrals, simple pricing model (single flat monthly fee per group), search across community posts and course content, email notifications and digest, mobile-optimized web experience with native app, and flat $99/month creator pricing with no tiered plans.
...
- Preserve the functional job behind Skool while using original product naming, original UI, original sample data, and licensed integrations.
...
- Do not copy Skool branding, logos, screenshots, marketing copy, private APIs, proprietary datasets, plan names, UI trade dress, course libraries, textbook solutions, documents, school content, AI prompts, or protected media.
...
|---|---|---|---|
| Apple App Store | https://apps.apple.com/us/app/skool-community/id1614575498 | iOS listing, privacy labels, release notes, community/course claims, and support links | Verified public URL or explicit platform blocker on 2026-05-06; hands-on native behavior still blocked. |
| Google Play | https://play.google.com/store/apps/details?id=com.skool.android | Android listing, data safety, gamified community/course claims, and release cadence | Verified public URL or explicit platform blocker on 2026-05-06; hands-on native behavior still blocked. |
| Official product site | https://www.skool.com/ | Skool community platform, courses, gamification, and product positioning | Verified public URL or explicit platform blocker on 2026-05-06; hands-on native behavior still blocked. |
| Official help | https://www.skool.com/help | Skool app help, community setup, and troubleshooting | Verified public URL or explicit platform blocker on 2026-05-06; hands-on native behavior still blocked. |
| Privacy policy | https://www.skool.com/privacy | Skool data collection, community data, payment data, and privacy disclosures | Verified public URL or explicit platform blocker on 2026-05-06; hands-on native behavior still blocked. |
| Terms | https://www.skool.com/terms | Skool services, creator/member terms, and acceptable-use boundaries | Verified public URL or explicit platform blocker on 2026-05-06; hands-on native behavior still blocked. |
...
- Manual blockers must remain launch-blocking until verified: Skool account creation and community group setup, community feed with post creation, commenting, threading, and reactions, course builder with module and lesson structure, video hosting, and action items, gamification engine (points for engagement, levels, leaderboard ranking algorithm), member directory with profiles and search, calendar with event creation, RSVP, and scheduling, direct messaging system between members, course navigation with module progression and completion tracking, about page editor and community description, integrated payment processing for paid communities (Stripe), affiliate program tracking and referral commission management, search indexing across community posts and course content, email notification system (activity digest, mentions, replies), mobile app experience and push notifications, content moderation and community management tools, member import and invitation management, and Skool account integration.

## Core User Journeys

- User creates or restores a Skool-style account, completes role, school, subscription, or tenant checks, and reaches the dashboard.
...
- Monetization model: use original free/trial/paid/sponsored/school/provider/tenant entitlement logic; do not copy exact pricing, plan names, bundle names, promotional copy, school contracts, tenant offers, or partner offers from Skool.
...
- Manual verification tests for Skool account creation and community group setup, community feed with post creation, commenting, threading, and reactions, course builder with module and lesson structure, video hosting, and action items, gamification engine (points for engagement, levels, leaderboard ranking algorithm), member directory with profiles and search, calendar with event creation, RSVP, and scheduling, direct messaging system between members, course navigation with module progression and completion tracking, about page editor and community description, integrated payment processing for paid communities (Stripe), affiliate program tracking and referral commission management, search indexing across community posts and course content, email notification system (activity digest, mentions, replies), mobile app experience and push notifications, content moderation and community management tools, member import and invitation management, and Skool account integration.
...
- Phase 4: Add app-specific safety controls for community and course platform combining gamified community engagement with structured courses, community feed with posts, comments, and reactions, course modules with video lessons and action items, gamification with points, levels, and leaderboard driving member engagement, member directory and profiles, calendar with community events and scheduling, direct messaging between members, classroom-style course navigation with module and lesson progression, about page with community description and membership details, integrated payments for paid communities (Stripe), affiliate program for member referrals, simple pricing model (single flat monthly fee per group), search across community posts and course content, email notifications and digest, mobile-optimized web experience with native app, and flat $99/month creator pricing with no tiered plans.
...
- Confirm legal/privacy retention behavior for Skool-style sensitive records and update API contracts before downstream implementation.
