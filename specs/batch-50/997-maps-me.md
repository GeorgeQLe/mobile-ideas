# MAPS.ME-Style Clone Spec

> Metadata
> - Inspiration app: MAPS.ME
> - Category: Navigation
...
> - Manual verification blockers: MAPS.ME account creation and map download region selection, OpenStreetMap data processing and tile rendering pipeline, offline map packaging, compression, and download by country/region, turn-by-turn offline navigation engine (driving, walking, cycling routing without network), POI search with offline index (restaurants, hotels, ATMs, attractions), public transit routing data for supported cities, Guides travel content curation and display, hotel and activity booking integration (Booking.com, partner APIs), offline address lookup and geocoding, hiking trail data and elevation profile rendering, OpenStreetMap editing and contribution submission, bookmark and saved places management with list categorization, multi-stop route planning, daily map update pipeline and incremental download infrastructure, crowd-sourced map correction submission and moderation, speed camera warning database, cross-device bookmark sync, advertising integration, and MAPS.ME account integration.
...
Build an original mobile product inspired by MAPS.ME's public navigation workflow. The V1 clone focuses on offline-first mapping and navigation app built on OpenStreetMap data with fast offline maps for every country, turn-by-turn driving, walking, and cycling navigation fully offline, detailed POI search including restaurants, hotels, ATMs, and attractions, public transit routing in supported cities, travel guides and curated place collections (Guides), hotel and activity booking integration, offline search and address lookup, hiking and trail maps with elevation profiles, map editing contributions back to OpenStreetMap, bookmarks and saved places with lists and categories, route planning with multiple stops, daily updated map data with incremental downloads, crowd-sourced map corrections, speed camera warnings, cross-device bookmark sync, and free model with advertising and booking referrals.
...
- Preserve the functional job behind MAPS.ME while using original product naming, original UI, original sample data, and licensed integrations.
...
- Do not copy MAPS.ME branding, logos, screenshots, marketing copy, private APIs, proprietary datasets, plan names, UI trade dress, course libraries, textbook solutions, documents, school content, AI prompts, or protected media.
...
|---|---|---|---|
| Apple App Store | https://apps.apple.com/us/app/maps-me-offline-map-nav/id510623322 | iOS listing, privacy labels, release notes, offline maps/navigation claims, and support links | Verified public URL or explicit platform blocker on 2026-05-06; hands-on native behavior still blocked. |
| Google Play | https://play.google.com/store/apps/details?id=com.mapswithme.maps.pro | Android listing, data safety, offline maps/OSM claims, and release cadence | Verified public URL or explicit platform blocker on 2026-05-06; hands-on native behavior still blocked. |
| Official product site | https://maps.me/ | MAPS.ME offline maps, navigation, travel, and product positioning | Verified public URL or explicit platform blocker on 2026-05-06; hands-on native behavior still blocked. |
| Official help | https://support.maps.me/ | MAPS.ME app help, offline maps, and troubleshooting | Verified public URL or explicit platform blocker on 2026-05-06; hands-on native behavior still blocked. |
| Privacy policy | https://maps.me/privacy/ | MAPS.ME data collection, location data, and privacy disclosures | Verified public URL or explicit platform blocker on 2026-05-06; hands-on native behavior still blocked. |
| Terms | https://maps.me/terms/ | MAPS.ME services, usage terms, and acceptable-use boundaries | Verified public URL or explicit platform blocker on 2026-05-06; hands-on native behavior still blocked. |
...
- Manual blockers must remain launch-blocking until verified: MAPS.ME account creation and map download region selection, OpenStreetMap data processing and tile rendering pipeline, offline map packaging, compression, and download by country/region, turn-by-turn offline navigation engine (driving, walking, cycling routing without network), POI search with offline index (restaurants, hotels, ATMs, attractions), public transit routing data for supported cities, Guides travel content curation and display, hotel and activity booking integration (Booking.com, partner APIs), offline address lookup and geocoding, hiking trail data and elevation profile rendering, OpenStreetMap editing and contribution submission, bookmark and saved places management with list categorization, multi-stop route planning, daily map update pipeline and incremental download infrastructure, crowd-sourced map correction submission and moderation, speed camera warning database, cross-device bookmark sync, advertising integration, and MAPS.ME account integration.

## Core User Journeys

- User creates or restores a MAPS.ME-style account, completes role, school, subscription, or tenant checks, and reaches the dashboard.
...
- Monetization model: use original free/trial/paid/sponsored/school/provider/tenant entitlement logic; do not copy exact pricing, plan names, bundle names, promotional copy, school contracts, tenant offers, or partner offers from MAPS.ME.
...
- Manual verification tests for MAPS.ME account creation and map download region selection, OpenStreetMap data processing and tile rendering pipeline, offline map packaging, compression, and download by country/region, turn-by-turn offline navigation engine (driving, walking, cycling routing without network), POI search with offline index (restaurants, hotels, ATMs, attractions), public transit routing data for supported cities, Guides travel content curation and display, hotel and activity booking integration (Booking.com, partner APIs), offline address lookup and geocoding, hiking trail data and elevation profile rendering, OpenStreetMap editing and contribution submission, bookmark and saved places management with list categorization, multi-stop route planning, daily map update pipeline and incremental download infrastructure, crowd-sourced map correction submission and moderation, speed camera warning database, cross-device bookmark sync, advertising integration, and MAPS.ME account integration.
...
- Phase 4: Add app-specific safety controls for offline-first mapping and navigation app built on OpenStreetMap data with fast offline maps for every country, turn-by-turn driving, walking, and cycling navigation fully offline, detailed POI search including restaurants, hotels, ATMs, and attractions, public transit routing in supported cities, travel guides and curated place collections (Guides), hotel and activity booking integration, offline search and address lookup, hiking and trail maps with elevation profiles, map editing contributions back to OpenStreetMap, bookmarks and saved places with lists and categories, route planning with multiple stops, daily updated map data with incremental downloads, crowd-sourced map corrections, speed camera warnings, cross-device bookmark sync, and free model with advertising and booking referrals.
...
- Confirm legal/privacy retention behavior for MAPS.ME-style sensitive records and update API contracts before downstream implementation.
