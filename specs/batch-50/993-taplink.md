# Taplink-Style Clone Spec

> Metadata
> - Inspiration app: Taplink
> - Category: Business
...
> - Manual verification blockers: Taplink account creation and page setup, content block system (links, text, images, video, FAQ, forms, timers, social feeds, payment blocks), payment acceptance integration (Stripe, PayPal, direct payments, product catalog), CRM with lead collection forms and customer management, messaging integration setup (WhatsApp, Telegram, Facebook Messenger, Viber deep links and chat widgets), email and SMS marketing tools (broadcasts, automations, subscriber management), theme customization and advanced design editor, multi-page support and page navigation, analytics data aggregation (page views, block clicks, conversion tracking), custom domain DNS configuration, SEO metadata editor and optimization tools, pop-up and notification bar builder with trigger conditions, appointment scheduling calendar integration, third-party marketing integration (Mailchimp, Google Analytics, Facebook Pixel), QR code generation and tracking, mobile-responsive rendering, plan entitlement enforcement (Free tier block limits, paid features), and Taplink account integration.
...
Build an original mobile product inspired by Taplink's public business workflow. The V1 clone focuses on micro-landing page and link-in-bio builder with rich content blocks for links, text, images, video, FAQ, forms, timers, and social feeds, integrated payment acceptance (Stripe, PayPal, direct payments) for selling digital and physical products, built-in CRM with lead collection and customer management, messaging integration (WhatsApp, Telegram, Facebook Messenger, Viber), email and SMS marketing tools, customizable themes and advanced design options, multi-page support for complex landing pages, analytics with page views, clicks, and conversion tracking, custom domain support, SEO optimization tools, pop-ups and notification bars, appointment scheduling, integration with marketing tools (Mailchimp, Google Analytics, Facebook Pixel), QR code generation, mobile-optimized responsive design, and tiered plans (Free, Pro, Business).
...
- Preserve the functional job behind Taplink while using original product naming, original UI, original sample data, and licensed integrations.
...
- Do not copy Taplink branding, logos, screenshots, marketing copy, private APIs, proprietary datasets, plan names, UI trade dress, course libraries, textbook solutions, documents, school content, AI prompts, or protected media.
...
|---|---|---|---|
| Apple App Store | https://apps.apple.com/us/app/taplink-link-in-bio-builder/id1468621432 | iOS listing, privacy labels, release notes, link-in-bio/landing page claims, and support links | Verified public URL or explicit platform blocker on 2026-05-06; hands-on native behavior still blocked. |
| Google Play | https://play.google.com/store/apps/details?id=com.nicepage.taplink | Android listing, data safety, micro-landing page/payment claims, and release cadence | Verified public URL or explicit platform blocker on 2026-05-06; hands-on native behavior still blocked. |
| Official product site | https://taplink.at/ | Taplink micro-landing page, link-in-bio, payments, and product positioning | Verified public URL or explicit platform blocker on 2026-05-06; hands-on native behavior still blocked. |
| Official help | https://taplink.at/help/ | Taplink app help, page setup, and troubleshooting | Verified public URL or explicit platform blocker on 2026-05-06; hands-on native behavior still blocked. |
| Privacy policy | https://taplink.at/en/privacy/ | Taplink data collection, payment data, CRM data, and privacy disclosures | Verified public URL or explicit platform blocker on 2026-05-06; hands-on native behavior still blocked. |
| Terms | https://taplink.at/en/terms/ | Taplink services, creator terms, and acceptable-use boundaries | Verified public URL or explicit platform blocker on 2026-05-06; hands-on native behavior still blocked. |
...
- Manual blockers must remain launch-blocking until verified: Taplink account creation and page setup, content block system (links, text, images, video, FAQ, forms, timers, social feeds, payment blocks), payment acceptance integration (Stripe, PayPal, direct payments, product catalog), CRM with lead collection forms and customer management, messaging integration setup (WhatsApp, Telegram, Facebook Messenger, Viber deep links and chat widgets), email and SMS marketing tools (broadcasts, automations, subscriber management), theme customization and advanced design editor, multi-page support and page navigation, analytics data aggregation (page views, block clicks, conversion tracking), custom domain DNS configuration, SEO metadata editor and optimization tools, pop-up and notification bar builder with trigger conditions, appointment scheduling calendar integration, third-party marketing integration (Mailchimp, Google Analytics, Facebook Pixel), QR code generation and tracking, mobile-responsive rendering, plan entitlement enforcement (Free tier block limits, paid features), and Taplink account integration.

## Core User Journeys

- User creates or restores a Taplink-style account, completes role, school, subscription, or tenant checks, and reaches the dashboard.
...
- Monetization model: use original free/trial/paid/sponsored/school/provider/tenant entitlement logic; do not copy exact pricing, plan names, bundle names, promotional copy, school contracts, tenant offers, or partner offers from Taplink.
...
- Manual verification tests for Taplink account creation and page setup, content block system (links, text, images, video, FAQ, forms, timers, social feeds, payment blocks), payment acceptance integration (Stripe, PayPal, direct payments, product catalog), CRM with lead collection forms and customer management, messaging integration setup (WhatsApp, Telegram, Facebook Messenger, Viber deep links and chat widgets), email and SMS marketing tools (broadcasts, automations, subscriber management), theme customization and advanced design editor, multi-page support and page navigation, analytics data aggregation (page views, block clicks, conversion tracking), custom domain DNS configuration, SEO metadata editor and optimization tools, pop-up and notification bar builder with trigger conditions, appointment scheduling calendar integration, third-party marketing integration (Mailchimp, Google Analytics, Facebook Pixel), QR code generation and tracking, mobile-responsive rendering, plan entitlement enforcement (Free tier block limits, paid features), and Taplink account integration.
...
- Phase 4: Add app-specific safety controls for micro-landing page and link-in-bio builder with rich content blocks for links, text, images, video, FAQ, forms, timers, and social feeds, integrated payment acceptance (Stripe, PayPal, direct payments) for selling digital and physical products, built-in CRM with lead collection and customer management, messaging integration (WhatsApp, Telegram, Facebook Messenger, Viber), email and SMS marketing tools, customizable themes and advanced design options, multi-page support for complex landing pages, analytics with page views, clicks, and conversion tracking, custom domain support, SEO optimization tools, pop-ups and notification bars, appointment scheduling, integration with marketing tools (Mailchimp, Google Analytics, Facebook Pixel), QR code generation, mobile-optimized responsive design, and tiered plans (Free, Pro, Business).
...
- Confirm legal/privacy retention behavior for Taplink-style sensitive records and update API contracts before downstream implementation.
