# HERE WeGo-Style Clone Spec

> Metadata
> - Inspiration app: HERE WeGo
> - Category: Navigation
...
> - Manual verification blockers: HERE account creation and preferences setup, HERE Technologies map tile rendering and data sourcing (proprietary HERE map data), offline map download and storage management for 100+ countries, real-time traffic data integration and route optimization, public transit data aggregation (schedules, line maps, fare info, multi-city coverage), turn-by-turn driving navigation engine with voice guidance (multi-language TTS), POI search with category, rating, and contact data, car-sharing and ride-hailing service aggregation and booking (third-party API integrations), taxi fare estimation algorithm and data sources, map layer rendering (satellite, terrain, traffic overlays), route alternative calculation with ETA and distance, HERE indoor map data for airports, malls, and venues, speed limit data sourcing and camera warning database, route sharing link generation, HERE platform service integration, and HERE account integration.
...
Build an original mobile product inspired by HERE WeGo's public navigation workflow. The V1 clone focuses on multi-modal navigation app powered by HERE Technologies mapping platform with driving, walking, cycling, and public transit routing, offline maps for over 100 countries, real-time traffic information and route optimization, public transit integration with schedules, line maps, and fare information, turn-by-turn voice navigation for driving, detailed POI search with categories, ratings, and contact information, car-sharing and ride-hailing service comparison and booking, taxi fare estimation, map layers including satellite, terrain, and traffic, route alternatives with ETA and distance comparison, HERE indoor maps for airports, malls, and venues, speed limit display and camera warnings, route sharing via link, integration with HERE platform services, and free model with no subscription required.
...
- Preserve the functional job behind HERE WeGo while using original product naming, original UI, original sample data, and licensed integrations.
...
- Do not copy HERE WeGo branding, logos, screenshots, marketing copy, private APIs, proprietary datasets, plan names, UI trade dress, course libraries, textbook solutions, documents, school content, AI prompts, or protected media.
...
|---|---|---|---|
| Apple App Store | https://apps.apple.com/us/app/here-wego-maps-navigation/id955837609 | iOS listing, privacy labels, release notes, navigation/offline maps claims, and support links | Verified public URL or explicit platform blocker on 2026-05-06; hands-on native behavior still blocked. |
| Google Play | https://play.google.com/store/apps/details?id=com.here.app.maps | Android listing, data safety, multi-modal navigation/offline claims, and release cadence | Verified public URL or explicit platform blocker on 2026-05-06; hands-on native behavior still blocked. |
| Official product site | https://wego.here.com/ | HERE WeGo navigation, offline maps, and product positioning | Verified public URL or explicit platform blocker on 2026-05-06; hands-on native behavior still blocked. |
| Official help | https://help.here.com/ | HERE WeGo app help, navigation, and troubleshooting | Verified public URL or explicit platform blocker on 2026-05-06; hands-on native behavior still blocked. |
| Privacy policy | https://legal.here.com/privacy | HERE data collection, location data, and privacy disclosures | Verified public URL or explicit platform blocker on 2026-05-06; hands-on native behavior still blocked. |
| Terms | https://legal.here.com/terms | HERE services, usage terms, and acceptable-use boundaries | Verified public URL or explicit platform blocker on 2026-05-06; hands-on native behavior still blocked. |
...
- Manual blockers must remain launch-blocking until verified: HERE account creation and preferences setup, HERE Technologies map tile rendering and data sourcing (proprietary HERE map data), offline map download and storage management for 100+ countries, real-time traffic data integration and route optimization, public transit data aggregation (schedules, line maps, fare info, multi-city coverage), turn-by-turn driving navigation engine with voice guidance (multi-language TTS), POI search with category, rating, and contact data, car-sharing and ride-hailing service aggregation and booking (third-party API integrations), taxi fare estimation algorithm and data sources, map layer rendering (satellite, terrain, traffic overlays), route alternative calculation with ETA and distance, HERE indoor map data for airports, malls, and venues, speed limit data sourcing and camera warning database, route sharing link generation, HERE platform service integration, and HERE account integration.

## Core User Journeys

- User creates or restores a HERE WeGo-style account, completes role, school, subscription, or tenant checks, and reaches the dashboard.
...
- Monetization model: use original free/trial/paid/sponsored/school/provider/tenant entitlement logic; do not copy exact pricing, plan names, bundle names, promotional copy, school contracts, tenant offers, or partner offers from HERE WeGo.
...
- Manual verification tests for HERE account creation and preferences setup, HERE Technologies map tile rendering and data sourcing (proprietary HERE map data), offline map download and storage management for 100+ countries, real-time traffic data integration and route optimization, public transit data aggregation (schedules, line maps, fare info, multi-city coverage), turn-by-turn driving navigation engine with voice guidance (multi-language TTS), POI search with category, rating, and contact data, car-sharing and ride-hailing service aggregation and booking (third-party API integrations), taxi fare estimation algorithm and data sources, map layer rendering (satellite, terrain, traffic overlays), route alternative calculation with ETA and distance, HERE indoor map data for airports, malls, and venues, speed limit data sourcing and camera warning database, route sharing link generation, HERE platform service integration, and HERE account integration.
...
- Phase 4: Add app-specific safety controls for multi-modal navigation app powered by HERE Technologies mapping platform with driving, walking, cycling, and public transit routing, offline maps for over 100 countries, real-time traffic information and route optimization, public transit integration with schedules, line maps, and fare information, turn-by-turn voice navigation for driving, detailed POI search with categories, ratings, and contact information, car-sharing and ride-hailing service comparison and booking, taxi fare estimation, map layers including satellite, terrain, and traffic, route alternatives with ETA and distance comparison, HERE indoor maps for airports, malls, and venues, speed limit display and camera warnings, route sharing via link, integration with HERE platform services, and free model with no subscription required.
...
- Confirm legal/privacy retention behavior for HERE WeGo-style sensitive records and update API contracts before downstream implementation.
