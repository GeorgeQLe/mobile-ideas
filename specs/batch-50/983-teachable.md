# Teachable-Style Clone Spec

> Metadata
> - Inspiration app: Teachable
> - Category: Business
...
> - Manual verification blockers: Teachable account creation and creator plan subscription, course builder with video hosting (Wistia integration), lesson ordering, drip scheduling, quiz and assessment creation, coaching product milestone and session management, sales page builder and checkout customization, Teachable Payments processing (Stripe integration, PayPal, multi-currency, tax handling), coupon engine and promotion scheduling, affiliate program tracking and commission management, email marketing automation (student engagement triggers, sequences), course completion certificate generation and delivery, student management dashboard (enrollment, progress, grades, exports), analytics data aggregation (revenue, enrollment trends, completion rates, engagement), custom domain DNS configuration and SSL provisioning, Teachable mobile app student experience (course playback, downloads, progress sync), bundled product and subscription billing lifecycle, creator plan entitlement enforcement (Free tier limitations, paid tier features), and Teachable account integration.
...
Build an original mobile product inspired by Teachable's public business workflow. The V1 clone focuses on online course and coaching platform with drag-and-drop course builder supporting video, text, quizzes, and file uploads, drip content scheduling, student progress tracking, coaching product with milestone management, sales pages and checkout builder, integrated payment processing (Teachable Payments via Stripe), coupon and promotion management, affiliate marketing program, email marketing with student engagement automations, course completion certificates, student management dashboard, analytics with revenue, enrollment, and completion metrics, custom domain and branding, Teachable iOS and Android apps for student course consumption, bundled and subscription pricing, and tiered creator plans (Free, Basic, Pro, Pro+, Business).
...
- Preserve the functional job behind Teachable while using original product naming, original UI, original sample data, and licensed integrations.
...
- Do not copy Teachable branding, logos, screenshots, marketing copy, private APIs, proprietary datasets, plan names, UI trade dress, course libraries, textbook solutions, documents, school content, AI prompts, or protected media.
...
|---|---|---|---|
| Apple App Store | https://apps.apple.com/us/app/teachable-online-courses/id1506506740 | iOS listing, privacy labels, release notes, course consumption claims, and support links | Verified public URL or explicit platform blocker on 2026-05-06; hands-on native behavior still blocked. |
| Google Play | https://play.google.com/store/apps/details?id=com.teachable.android | Android listing, data safety, online course/student claims, and release cadence | Verified public URL or explicit platform blocker on 2026-05-06; hands-on native behavior still blocked. |
| Official product site | https://teachable.com/ | Teachable online courses, coaching, and product positioning | Verified public URL or explicit platform blocker on 2026-05-06; hands-on native behavior still blocked. |
| Official help | https://support.teachable.com/ | Teachable app help, course building, and troubleshooting | Verified public URL or explicit platform blocker on 2026-05-06; hands-on native behavior still blocked. |
| Privacy policy | https://teachable.com/privacy-policy | Teachable data collection, student data, payment data, and privacy disclosures | Verified public URL or explicit platform blocker on 2026-05-06; hands-on native behavior still blocked. |
| Terms | https://teachable.com/terms-of-use | Teachable services, creator/student terms, and acceptable-use boundaries | Verified public URL or explicit platform blocker on 2026-05-06; hands-on native behavior still blocked. |
...
- Manual blockers must remain launch-blocking until verified: Teachable account creation and creator plan subscription, course builder with video hosting (Wistia integration), lesson ordering, drip scheduling, quiz and assessment creation, coaching product milestone and session management, sales page builder and checkout customization, Teachable Payments processing (Stripe integration, PayPal, multi-currency, tax handling), coupon engine and promotion scheduling, affiliate program tracking and commission management, email marketing automation (student engagement triggers, sequences), course completion certificate generation and delivery, student management dashboard (enrollment, progress, grades, exports), analytics data aggregation (revenue, enrollment trends, completion rates, engagement), custom domain DNS configuration and SSL provisioning, Teachable mobile app student experience (course playback, downloads, progress sync), bundled product and subscription billing lifecycle, creator plan entitlement enforcement (Free tier limitations, paid tier features), and Teachable account integration.

## Core User Journeys

- User creates or restores a Teachable-style account, completes role, school, subscription, or tenant checks, and reaches the dashboard.
...
- Monetization model: use original free/trial/paid/sponsored/school/provider/tenant entitlement logic; do not copy exact pricing, plan names, bundle names, promotional copy, school contracts, tenant offers, or partner offers from Teachable.
...
- Manual verification tests for Teachable account creation and creator plan subscription, course builder with video hosting (Wistia integration), lesson ordering, drip scheduling, quiz and assessment creation, coaching product milestone and session management, sales page builder and checkout customization, Teachable Payments processing (Stripe integration, PayPal, multi-currency, tax handling), coupon engine and promotion scheduling, affiliate program tracking and commission management, email marketing automation (student engagement triggers, sequences), course completion certificate generation and delivery, student management dashboard (enrollment, progress, grades, exports), analytics data aggregation (revenue, enrollment trends, completion rates, engagement), custom domain DNS configuration and SSL provisioning, Teachable mobile app student experience (course playback, downloads, progress sync), bundled product and subscription billing lifecycle, creator plan entitlement enforcement (Free tier limitations, paid tier features), and Teachable account integration.
...
- Phase 4: Add app-specific safety controls for online course and coaching platform with drag-and-drop course builder supporting video, text, quizzes, and file uploads, drip content scheduling, student progress tracking, coaching product with milestone management, sales pages and checkout builder, integrated payment processing (Teachable Payments via Stripe), coupon and promotion management, affiliate marketing program, email marketing with student engagement automations, course completion certificates, student management dashboard, analytics with revenue, enrollment, and completion metrics, custom domain and branding, Teachable iOS and Android apps for student course consumption, bundled and subscription pricing, and tiered creator plans (Free, Basic, Pro, Pro+, Business).
...
- Confirm legal/privacy retention behavior for Teachable-style sensitive records and update API contracts before downstream implementation.
