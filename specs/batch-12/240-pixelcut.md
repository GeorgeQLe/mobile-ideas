# Pixelcut-Style Clone Spec

> Metadata
> - Inspiration app: Pixelcut
...
Build an original mobile photo editing product inspired by Pixelcut's public product and policy materials. V1 focuses on AI product photo editor, background removal, magic eraser, templates, upscaling, batch/business workflows, export/share, and subscription gates. The clone must use original branding, original UI copy, original sample content, licensed providers/assets, and explicit disclosures when a feature is inferred from public materials rather than verified hands-on behavior.
...
- Do not imply affiliation with Pixelcut or its publisher.
...
|---|---|---|---|
| Official product | https://www.pixelcut.ai/ | Public Pixelcut product surface, AI photo tools, background removal, product photos, and plan positioning | Verified 2026-05-03 |
| Help center | https://help.pixelcut.ai/ | Public support taxonomy for app usage, subscriptions, exports, and troubleshooting | Verified 2026-05-03 |
| Privacy policy | https://www.pixelcut.ai/privacy | Media, account, device, analytics, and retention handling | Verified 2026-05-03 |
| Terms of service | https://www.pixelcut.ai/terms | User content, subscriptions, AI tools, and legal boundaries | Verified 2026-05-03 |
...
- Uploaded product/person image rights, AI commercial-use disclosures, background/object edits, batch media retention, subscription quotas, and export metadata require explicit controls.
