# PhotoRoom-Style Clone Spec

> Metadata
> - Inspiration app: PhotoRoom
...
Build an original mobile photo editing product inspired by PhotoRoom's public product and policy materials. V1 focuses on background removal, product photo creation, templates, AI image tools, batch editing, brand/business exports, and subscription gates. The clone must use original branding, original UI copy, original sample content, licensed providers/assets, and explicit disclosures when a feature is inferred from public materials rather than verified hands-on behavior.
...
- Do not imply affiliation with PhotoRoom or its publisher.
...
|---|---|---|---|
| Official product | https://www.photoroom.com/ | Public PhotoRoom product surface, background removal, AI tools, business/photo workflows, and plan positioning | Verified 2026-05-03 |
| Help center | https://help.photoroom.com/ | Public support taxonomy for app usage, subscriptions, teams, exports, and troubleshooting | Verified 2026-05-03 |
| Privacy policy | https://www.photoroom.com/legal/privacy-policy | Media, account, team, device, analytics, and retention handling | Verified 2026-05-03 |
| Terms of service | https://www.photoroom.com/legal/terms-and-conditions | User content, subscriptions, teams, AI features, and legal boundaries | Verified 2026-05-03 |
...
- Product/person image rights, background-removal privacy, AI-generated commercial assets, team permissions, batch uploads, and subscription quotas require explicit controls.
