# Facetune-Style Clone Spec

> Metadata
> - Inspiration app: Facetune
...
Build an original mobile photo editing product inspired by Facetune's public product and policy materials. V1 focuses on portrait retouching, selfie editing, AI enhancement, background/object edits, presets, export/share, and subscription gates. The clone must use original branding, original UI copy, original sample content, licensed providers/assets, and explicit disclosures when a feature is inferred from public materials rather than verified hands-on behavior.
...
- Do not imply affiliation with Facetune or its publisher.
...
|---|---|---|---|
| Official product | https://www.facetuneapp.com/ | Public Facetune product surface, retouching, AI tools, and subscription positioning | Verified 2026-05-03 |
| Lightricks support | https://support.lightricks.com/ | Public support taxonomy for Lightricks apps, subscriptions, and troubleshooting | Verified 2026-05-03 |
| Privacy policy | https://static.lightricks.com/legal/privacy-policy.pdf | Media, face-related inputs, account, device, analytics, and retention handling | Verified 2026-05-03 |
| Terms of use | https://static.lightricks.com/legal/terms-of-use.pdf | User content, subscriptions, AI tools, and legal boundaries | Verified 2026-05-03 |
...
- Face/skin/body retouch safety, identity and consent, beauty-filter harms, AI-generated edits, subscription restore, and export disclosure require explicit controls.
