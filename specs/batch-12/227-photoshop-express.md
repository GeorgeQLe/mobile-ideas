# Photoshop Express-Style Clone Spec

> Metadata
> - Inspiration app: Photoshop Express
...
Build an original mobile photo editing product inspired by Photoshop Express's public product and policy materials. V1 focuses on mobile photo editing, retouching, collage, filters/effects, healing/cutout tools, cloud account sync, export/share, and premium gates. The clone must use original branding, original UI copy, original sample content, licensed providers/assets, and explicit disclosures when a feature is inferred from public materials rather than verified hands-on behavior.
...
- Do not imply affiliation with Photoshop Express or its publisher.
...
|---|---|---|---|
| Official product | https://www.adobe.com/products/photoshop-express.html | Public Photoshop Express mobile editor surface, retouching, collage, and premium positioning | Verified 2026-05-03 |
| Help center | https://helpx.adobe.com/photoshop-express.html | Public support taxonomy for Photoshop Express app, editing, subscriptions, and troubleshooting | Verified 2026-05-03 |
| Privacy policy | https://www.adobe.com/privacy/policy.html | Adobe account, media, cloud, analytics, device, and retention handling | Verified 2026-05-03 |
| Terms of use | https://www.adobe.com/legal/terms.html | Adobe service terms, subscriptions, user content, and legal boundaries | Verified 2026-05-03 |
...
- Face/retouch tools, cloud media sync, premium effect licensing, EXIF handling, export quality, and Adobe account/subscription gates require explicit controls.
