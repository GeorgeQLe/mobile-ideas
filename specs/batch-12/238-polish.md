# Polish-Style Clone Spec

> Metadata
> - Inspiration app: Polish
...
Build an original mobile photo editing product inspired by Polish's public product and policy materials. V1 focuses on photo editor, filters/effects, collage, background/object tools, stickers/text, AI features where offered, export/share, and premium gates. The clone must use original branding, original UI copy, original sample content, licensed providers/assets, and explicit disclosures when a feature is inferred from public materials rather than verified hands-on behavior.
...
- Do not imply affiliation with Polish or its publisher.
...
|---|---|---|---|
| Publisher product | https://www.inshot.com/ | InShot publisher surface and product portfolio context for mobile creative apps | Verified 2026-05-03 |
| Google Play listing | https://play.google.com/store/apps/details?id=photo.editor.photoeditor.photoeditorpro | Official Android listing for Polish-style editor features, subscriptions, and data-safety signals | Verified 2026-05-03 |
| Privacy policy | https://inshotapp.com/website/policy.html | Media, device, ads, analytics, subscription, and retention handling | Verified 2026-05-03 |
| Terms of use | https://inshotapp.com/website/terms.html | User content, services, subscriptions, ads, and legal boundaries | Verified 2026-05-03 |
...
- Publisher/app identity verification, ad SDKs, local media permissions, AI/object edits, template licensing, subscription restore, and export metadata require explicit controls.
