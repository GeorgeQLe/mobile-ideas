# Adobe Express-Style Clone Spec

> Metadata
> - Inspiration app: Adobe Express
...
Build an original mobile photo editing product inspired by Adobe Express's public product and policy materials. V1 focuses on template-based design, photo/video editing, generative tools, brand kits, stock assets, cloud projects, export/share, and premium gates. The clone must use original branding, original UI copy, original sample content, licensed providers/assets, and explicit disclosures when a feature is inferred from public materials rather than verified hands-on behavior.
...
- Support media import, canvas editing, effect application, asset selection, export, and share workflows with offline-safe drafts and clear retry/recovery behavior.
...
- Do not imply affiliation with Adobe Express or its publisher.
...
|---|---|---|---|
| Official product | https://www.adobe.com/express/ | Public Adobe Express product surface, templates, generative tools, brand, and plan positioning | Verified 2026-05-03 |
| Help center | https://helpx.adobe.com/express.html | Public support taxonomy for Adobe Express editor, mobile, projects, subscriptions, and troubleshooting | Verified 2026-05-03 |
| Privacy policy | https://www.adobe.com/privacy/policy.html | Adobe account, cloud content, AI, analytics, device, and retention handling | Verified 2026-05-03 |
| Terms of use | https://www.adobe.com/legal/terms.html | Adobe service terms, subscriptions, content, generative AI, and legal boundaries | Verified 2026-05-03 |
| Firefly terms | https://www.adobe.com/legal/licenses-terms/adobe-gen-ai-user-guidelines.html | Generative AI user guidelines and content-safety expectations | Verified 2026-05-03 |
...
- The create flow must support camera/photo-library/file import, crop/resize, layers or edit stack, effects/tools, undo/redo, save draft, export, share, and delete controls.
- Editing must support non-destructive or explicitly confirmed destructive actions, preview quality, export format choices, watermark/metadata handling, and recoverable local/cloud drafts.
...
- Stock/template licensing, generative AI content controls, brand-kit permissions, cloud-project retention, commercial-use claims, and Adobe account gates require explicit controls.
