# Procreate Pocket-Style Clone Spec

> Metadata
> - Inspiration app: Procreate Pocket
...
Build an original mobile photo editing product inspired by Procreate Pocket's public product and policy materials. V1 focuses on mobile illustration canvas, brushes, layers, time-lapse replay, color tools, imports, exports, and local project recovery. The clone must use original branding, original UI copy, original sample content, licensed providers/assets, and explicit disclosures when a feature is inferred from public materials rather than verified hands-on behavior.
...
- Do not imply affiliation with Procreate Pocket or its publisher.
...
|---|---|---|---|
| Official product | https://procreate.com/pocket | Public Procreate Pocket product surface, brush/canvas/layer/export positioning | Verified 2026-05-03 |
| Help center | https://help.procreate.com/ | Public support taxonomy for Procreate products, files, brushes, gestures, and troubleshooting | Verified 2026-05-03 |
| Privacy policy | https://procreate.com/privacy | Account/site/support, app, device, analytics, and retention handling | Verified 2026-05-03 |
| Terms | https://procreate.com/terms | Legal, copyright, software, and service boundaries | Verified 2026-05-03 |
...
- Local artwork ownership, brush/import licensing, time-lapse privacy, file export integrity, iCloud/device backup assumptions, and no-cloud-loss recovery require explicit controls.
