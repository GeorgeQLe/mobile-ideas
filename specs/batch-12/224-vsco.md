# VSCO-Style Clone Spec

> Metadata
> - Inspiration app: VSCO
...
Build an original mobile photo editing product inspired by VSCO's public product and policy materials. V1 focuses on camera/editor, presets, studio drafts, profile publishing, community feed, messages, location/privacy settings, and membership gates. The clone must use original branding, original UI copy, original sample content, licensed providers/assets, and explicit disclosures when a feature is inferred from public materials rather than verified hands-on behavior.
...
- Do not imply affiliation with VSCO or its publisher.
...
|---|---|---|---|
| Official product | https://www.vsco.co/ | Public creator community, editor, presets, studio, and membership positioning | Verified 2026-05-03 |
| Support center | https://support.vsco.co/hc/en-us | Public support taxonomy for editor, studio, account, membership, settings, privacy, and data | Verified 2026-05-03 |
| Settings help | https://support.vsco.co/hc/en-us/articles/202631874-How-Do-I-Access-My-VSCO-Settings | Public settings, privacy/data, draft export, delete account, and location controls | Verified 2026-05-03 |
| Privacy policy | https://www.vsco.co/about/privacy_policy | Account, media, location, contacts, analytics, and retention handling | Verified 2026-05-03 |
| Terms of use | https://www.vsco.co/about/terms_of_use | User content, memberships, community, and legal boundaries | Verified 2026-05-03 |
...
- Draft/media privacy, location metadata, community publishing, creator messaging, preset licensing, membership gates, and account delete/export require explicit controls.
