# SNOW-Style Clone Spec

> Metadata
> - Inspiration app: SNOW
...
Build an original mobile photo editing product inspired by SNOW's public product and policy materials. V1 focuses on camera filters, AR stickers, beauty effects, photo/video capture, editing, profile/account surfaces, export/share, and paid assets. The clone must use original branding, original UI copy, original sample content, licensed providers/assets, and explicit disclosures when a feature is inferred from public materials rather than verified hands-on behavior.
...
- Do not imply affiliation with SNOW or its publisher.
...
|---|---|---|---|
| Official product | https://snowcorp.com/en/snow/ | Public SNOW product surface and camera/filter positioning | Verified 2026-05-03 |
| SNOW Corporation | https://snowcorp.com/en/ | Publisher identity and public product portfolio context | Verified 2026-05-03 |
| Privacy policy | https://snowcorp.com/en/privacy/ | Media, face-related inputs, account, device, analytics, ads, and retention handling | Verified 2026-05-03 |
| Terms of use | https://snowcorp.com/en/terms/ | User content, services, paid items, and legal boundaries | Verified 2026-05-03 |
...
- AR/face effects, camera privacy, minors/teen safety, ad/analytics SDKs, asset ownership, cross-app account linkage, and paid-item restore require explicit controls.
