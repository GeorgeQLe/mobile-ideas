# Snapseed-Style Clone Spec

> Metadata
> - Inspiration app: Snapseed
...
Build an original mobile photo editing product inspired by Snapseed's public product and policy materials. V1 focuses on local-first photo import, non-destructive editing stack, filters/tools, selective edits, looks, export/share, and offline draft behavior. The clone must use original branding, original UI copy, original sample content, licensed providers/assets, and explicit disclosures when a feature is inferred from public materials rather than verified hands-on behavior.
...
- Do not imply affiliation with Snapseed or its publisher.
...
|---|---|---|---|
| Google Play listing | https://play.google.com/store/apps/details?id=com.niksoftware.snapseed | Official Android listing, editor features, rating, privacy/data-safety, and platform metadata | Verified 2026-05-03 |
| App Store listing | https://apps.apple.com/us/app/snapseed/id439438619 | Official iOS listing, editor features, age rating, privacy labels, and release notes | Verified 2026-05-03 |
| Google Privacy Policy | https://policies.google.com/privacy | Google account, device, media, service, diagnostics, and retention framework | Verified 2026-05-03 |
| Google Terms | https://policies.google.com/terms | Service-wide legal and acceptable-use boundaries | Verified 2026-05-03 |
...
- Local photo permissions, EXIF retention/removal, offline-only expectations, destructive export mistakes, and Google service-policy boundaries require explicit controls.
