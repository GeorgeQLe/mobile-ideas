# ibis Paint X-Style Clone Spec

> Metadata
> - Inspiration app: ibis Paint X
...
Build an original mobile photo editing product inspired by ibis Paint X's public product and policy materials. V1 focuses on drawing canvas, brushes, layers, screen-tone/comic tools, process video, online gallery, ads/subscriptions, and cloud backup gates. The clone must use original branding, original UI copy, original sample content, licensed providers/assets, and explicit disclosures when a feature is inferred from public materials rather than verified hands-on behavior.
...
- Do not imply affiliation with ibis Paint X or its publisher.
...
|---|---|---|---|
| Official product | https://ibispaint.com/ | Public ibis Paint product surface, drawing tools, gallery, and platform positioning | Verified 2026-05-03 |
| Help / FAQ | https://ibispaint.com/faq.jsp | Public FAQ and support material for tools, subscriptions, cloud, and troubleshooting | Verified 2026-05-03 |
| Privacy policy | https://ibispaint.com/privacy.jsp | Account, artwork, ads, analytics, device, and retention handling | Verified 2026-05-03 |
| Terms of service | https://ibispaint.com/terms.jsp | User content, online gallery, subscriptions, ads, and legal boundaries | Verified 2026-05-03 |
...
- Process-video privacy, online-gallery moderation, ad SDKs, cloud storage, brush/material licensing, and child/teen creator safety require explicit controls.
