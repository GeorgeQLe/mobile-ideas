# Sketchbook-Style Clone Spec

> Metadata
> - Inspiration app: Sketchbook
...
Build an original mobile photo editing product inspired by Sketchbook's public product and policy materials. V1 focuses on drawing canvas, brushes, layers, guides, image import, gallery/project storage, export/share, and optional account or premium gates. The clone must use original branding, original UI copy, original sample content, licensed providers/assets, and explicit disclosures when a feature is inferred from public materials rather than verified hands-on behavior.
...
- Do not imply affiliation with Sketchbook or its publisher.
...
|---|---|---|---|
| Official product | https://www.sketchbook.com/ | Public Sketchbook product surface, drawing tools, platforms, and feature positioning | Verified 2026-05-03 |
| Support | https://help.sketchbook.com/ | Public support taxonomy for tools, files, account, purchases, and troubleshooting | Verified 2026-05-03 |
| Privacy policy | https://www.sketchbook.com/privacy | Account, support, device, analytics, and retention handling | Verified 2026-05-03 |
| Terms of use | https://www.sketchbook.com/terms | Software/service legal boundaries, user content, and acceptable use | Verified 2026-05-03 |
...
- Local project storage, brush licensing, gallery backup assumptions, export formats, purchase restore, and stylus/gesture native behavior require explicit controls.
