# Prequel-Style Clone Spec

> Metadata
> - Inspiration app: Prequel
...
Build an original mobile photo editing product inspired by Prequel's public product and policy materials. V1 focuses on photo/video filters, effects, AI avatars/effects where offered, camera capture, templates, export/share, and subscription gates. The clone must use original branding, original UI copy, original sample content, licensed providers/assets, and explicit disclosures when a feature is inferred from public materials rather than verified hands-on behavior.
...
- Do not imply affiliation with Prequel or its publisher.
...
|---|---|---|---|
| Official product | https://prequel.app/ | Public Prequel app product surface, filters/effects, photo/video editing, and plan positioning | Verified 2026-05-03 |
| Support | https://support.prequel.app/ | Public support taxonomy for account, subscriptions, app usage, and troubleshooting | Verified 2026-05-03 |
| Privacy policy | https://prequel.app/privacy-policy | Media, face-related inputs where applicable, account, device, analytics, and retention handling | Verified 2026-05-03 |
| Terms of use | https://prequel.app/terms-of-use | User content, subscriptions, effects/assets, and legal boundaries | Verified 2026-05-03 |
...
- Face/effect processing, AI avatar consent, beauty/body filters, export metadata, subscription paywalls, and minors/teen safety require explicit controls.
