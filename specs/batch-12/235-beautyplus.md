# BeautyPlus-Style Clone Spec

> Metadata
> - Inspiration app: BeautyPlus
...
Build an original mobile photo editing product inspired by BeautyPlus's public product and policy materials. V1 focuses on selfie camera, beauty retouching, filters, makeup effects, AI/background tools, stickers/templates, export/share, and subscriptions. The clone must use original branding, original UI copy, original sample content, licensed providers/assets, and explicit disclosures when a feature is inferred from public materials rather than verified hands-on behavior.
...
- Do not imply affiliation with BeautyPlus or its publisher.
...
|---|---|---|---|
| Official product | https://www.beautyplus.com/ | Public BeautyPlus product surface, selfie camera, retouching, filters, and AI tools | Verified 2026-05-03 |
| Support | https://support.beautyplus.com/ | Public support path for product, account, and subscription questions | Verified 2026-05-03 |
| Privacy policy | https://www.beautyplus.com/privacy-policy | Media, face-related inputs, account, device, analytics, ads, and retention handling | Verified 2026-05-03 |
| Terms of service | https://www.beautyplus.com/terms-of-service | User content, subscriptions, effects/assets, and legal boundaries | Verified 2026-05-03 |
...
- Face/beauty processing, makeup/body edits, teen safety, ad SDKs, asset licensing, export metadata, and subscription states require explicit controls.
