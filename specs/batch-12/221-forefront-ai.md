...
Build an original mobile ai assistant product inspired by Forefront AI's public product and policy materials. V1 focuses on assistant chat, model selection, personas/characters, prompt history, file context where supported, team/workspace controls, and subscription gates. The clone must use original branding, original UI copy, original sample content, licensed providers/assets, and explicit disclosures when a feature is inferred from public materials rather than verified hands-on behavior.
...
- Do not imply affiliation with Forefront AI or its publisher.
...
|---|---|---|---|
| Official product | https://www.forefront.ai/ | Public AI assistant product surface, model access, persona/chat positioning, and account entry | Verified 2026-05-03 |
| Privacy policy | https://www.forefront.ai/privacy | Account, prompt, usage, device, analytics, and support data handling | Verified 2026-05-03 |
| Terms of service | https://www.forefront.ai/terms | Acceptable use, subscriptions, generated output, and legal boundaries | Verified 2026-05-03 |
| Support/contact | https://www.forefront.ai/contact | Public support and contact path for account or product questions | Verified 2026-05-03 |
...
- AI safety, model/provider routing, persona moderation, prompt and file retention, team/workspace permissions, generated-output attribution, and quota transparency require explicit controls.
