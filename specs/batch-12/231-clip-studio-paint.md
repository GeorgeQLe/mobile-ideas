# Clip Studio Paint-Style Clone Spec

> Metadata
> - Inspiration app: Clip Studio Paint
...
Build an original mobile photo editing product inspired by Clip Studio Paint's public product and policy materials. V1 focuses on illustration/comic/animation workspace, brushes, layers, 3D/material assets, cloud sync, marketplace assets, export, and plan gates. The clone must use original branding, original UI copy, original sample content, licensed providers/assets, and explicit disclosures when a feature is inferred from public materials rather than verified hands-on behavior.
...
- Do not imply affiliation with Clip Studio Paint or its publisher.
...
|---|---|---|---|
| Official product | https://www.clipstudio.net/en/ | Public Clip Studio Paint product surface, illustration/comic/animation features, and plan positioning | Verified 2026-05-03 |
| Support | https://support.clip-studio.com/en-us | Public support taxonomy for app usage, accounts, plans, cloud, materials, and troubleshooting | Verified 2026-05-03 |
| Privacy policy | https://www.celsys.com/en/information/csp/ | CELSYS privacy and service-information path for Clip Studio products | Verified 2026-05-03 |
| Terms of service | https://www.clipstudio.net/en/terms/ | Service, software, material, subscription, and legal boundaries | Verified 2026-05-03 |
...
- Marketplace material licensing, 3D asset rights, cloud sync conflicts, subscription/device activation, animation export size, and creator-content moderation require explicit controls.
