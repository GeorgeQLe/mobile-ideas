# Bazaart-Style Clone Spec

> Metadata
> - Inspiration app: Bazaart
...
Build an original mobile photo editing product inspired by Bazaart's public product and policy materials. V1 focuses on cutout/collage design, background removal, templates, stickers, AI design tools, brand/social exports, and premium gates. The clone must use original branding, original UI copy, original sample content, licensed providers/assets, and explicit disclosures when a feature is inferred from public materials rather than verified hands-on behavior.
...
- Do not imply affiliation with Bazaart or its publisher.
...
|---|---|---|---|
| Official product | https://www.bazaart.me/ | Public Bazaart editor product surface, cutout/design/template positioning | Verified 2026-05-03 |
| Support | https://support.bazaart.me/ | Public support taxonomy for app usage, subscriptions, exports, and troubleshooting | Verified 2026-05-03 |
| Privacy policy | https://www.bazaart.me/privacy | Account, media, device, analytics, subscription, and retention handling | Verified 2026-05-03 |
| Terms of use | https://www.bazaart.me/terms | User content, subscriptions, templates/assets, and legal boundaries | Verified 2026-05-03 |
...
- Cutout/background-removal privacy, template/stock licensing, face/person imagery, subscription restore, social export metadata, and AI-generated asset disclosures require explicit controls.
