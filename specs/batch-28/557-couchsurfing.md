# Couchsurfing-Style Clone Spec

> Metadata
> - Inspiration app: Couchsurfing
...
Build an original mobile product inspired by Couchsurfing's public product, support, policy, and marketplace materials. V1 focuses on member onboarding, profile and verification placeholders, host/surfer search, hosting/surfing request flow, messaging, references, event or hangout discovery where public, subscriptions/payments, trust/safety, moderation, privacy, and accessibility. The clone must use original branding, original UI copy, synthetic data, licensed providers, and explicit manual blockers for behavior that requires account, reservation, route, property, supplier, document, payment, location, or regulated verification.
...
- Support member onboarding, profile and verification placeholders, host/surfer search, hosting/surfing request flow, messaging, references, event or hangout discovery where public, subscriptions/payments, trust/safety, moderation, privacy, and accessibility.
...
- Require personal safety, identity/profile privacy, location privacy, messaging abuse, harassment, reference integrity, subscription/payment handling, moderation, law-enforcement/legal requests, minors and vulnerable users, support, and regional availability review before launch.
- Keep downstream scaffold repositories private and avoid parity claims until manual blockers are resolved.

## Non-Goals

- Do not imply affiliation with Couchsurfing or its publisher.
...
|---|---|---|---|
| Official product/app page | https://www.couchsurfing.com/mobile | Public product positioning, primary mobile workflows, account/reservation surfaces, support entry points, and app capability claims | Verified 2026-05-04 |
| Support/help center | https://support.couchsurfing.org/ | Public support taxonomy for account, booking, payments, refunds/cancellations, loyalty or membership, accessibility, privacy, and recovery flows | Verified 2026-05-04 |
| Privacy policy | https://www.couchsurfing.com/privacy | Account, traveler/guest/passenger, payment, location, device, analytics, support, retention, and privacy-rights handling | Verified 2026-05-04 |
| Terms / program rules | https://www.couchsurfing.com/about/terms-of-use/ | Service usage, booking/payment obligations, cancellation/refund limits, conduct, liability, and legal boundaries | Verified 2026-05-04 |
| Loyalty, membership, or supplier program | https://www.couchsurfing.com/about/verification/ | Public loyalty, member, host, supplier, or partner-program orientation and entitlement constraints | Verified 2026-05-04 |
| App Store listing | https://apps.apple.com/us/app/couchsurfing-travel-app/id525642917 | Canonical iOS listing, category, age rating, privacy label, compatibility, release notes, public feature claims, and native metadata | Verified 2026-05-04 |
| Google Play listing | https://play.google.com/store/apps/details?id=com.couchsurfing.mobile.android | Canonical Android listing, feature blurbs, content rating, data safety, downloads, and native metadata | Verified 2026-05-04 |
...
| Profile / Verification | profile / verification workflow for the combined mobile experience | taps, forms, search, filters, deep links, permissions, provider state | empty, loading, loaded, signed-out, stale, offline | denied permission, provider outage, unavailable region, payment failed, account locked, stale provider data |
| Search Hosts | search hosts workflow for the mobile experience | taps, forms, search, filters, deep links, permissions, provider state | empty, loading, loaded, signed-out, stale, offline | denied permission, provider outage, unavailable region, payment failed, account locked, stale provider data |
| Host Detail | host detail workflow for the mobile experience | taps, forms, search, filters, deep links, permissions, provider state | empty, loading, loaded, signed-out, stale, offline | denied permission, provider outage, unavailable region, payment failed, account locked, stale provider data |
| Request Stay | request stay workflow for the mobile experience | taps, forms, search, filters, deep links, permissions, provider state | empty, loading, loaded, signed-out, stale, offline | denied permission, provider outage, unavailable region, payment failed, account locked, stale provider data |
| Messages | messages workflow for the mobile experience | taps, forms, search, filters, deep links, permissions, provider state | empty, loading, loaded, signed-out, stale, offline | denied permission, provider outage, unavailable region, payment failed, account locked, stale provider data |
| References | references workflow for the mobile experience | taps, forms, search, filters, deep links, permissions, provider state | empty, loading, loaded, signed-out, stale, offline | denied permission, provider outage, unavailable region, payment failed, account locked, stale provider data |
| Events / Hangouts | events / hangouts workflow for the combined mobile experience | taps, forms, search, filters, deep links, permissions, provider state | empty, loading, loaded, signed-out, stale, offline | denied permission, provider outage, unavailable region, payment failed, account locked, stale provider data |
| Subscription / Payment | subscription / payment workflow for the combined mobile experience | taps, forms, search, filters, deep links, permissions, provider state | empty, loading, loaded, signed-out, stale, offline | denied permission, provider outage, unavailable region, payment failed, account locked, stale provider data |
| Safety Center | safety center workflow for the mobile experience | taps, forms, search, filters, deep links, permissions, provider state | empty, loading, loaded, signed-out, stale, offline | denied permission, provider outage, unavailable region, payment failed, account locked, stale provider data |
| Reports / Support | reports / support workflow for the combined mobile experience | taps, forms, search, filters, deep links, permissions, provider state | empty, loading, loaded, signed-out, stale, offline | denied permission, provider outage, unavailable region, payment failed, account locked, stale provider data |
...
| Data Export / Delete | data export / delete workflow for the combined mobile experience | taps, forms, search, filters, deep links, permissions, provider state | empty, loading, loaded, signed-out, stale, offline | denied permission, provider outage, unavailable region, payment failed, account locked, stale provider data |
...
- `MemberProfile`: lifecycle state, authorization boundary, provider owner, retention class, export/delete behavior, and audit metadata for memberprofile records.
- `VerificationState`: lifecycle state, authorization boundary, provider owner, retention class, export/delete behavior, and audit metadata for verificationstate records.
- `LocationPreference`: lifecycle state, authorization boundary, provider owner, retention class, export/delete behavior, and audit metadata for locationpreference records.
- `HostListing`: lifecycle state, authorization boundary, provider owner, retention class, export/delete behavior, and audit metadata for hostlisting records.
- `StayRequest`: lifecycle state, authorization boundary, provider owner, retention class, export/delete behavior, and audit metadata for stayrequest records.
...
- `Reference`: lifecycle state, authorization boundary, provider owner, retention class, export/delete behavior, and audit metadata for reference records.
- `EventListing`: lifecycle state, authorization boundary, provider owner, retention class, export/delete behavior, and audit metadata for eventlisting records.
- `SubscriptionState`: lifecycle state, authorization boundary, provider owner, retention class, export/delete behavior, and audit metadata for subscriptionstate records.
...
- `ModerationCase`: lifecycle state, authorization boundary, provider owner, retention class, export/delete behavior, and audit metadata for moderationcase records.
...
- Public API documentation must use original route names and domain models; never mimic private endpoint paths, request bodies, pricing logic, loyalty logic, or proprietary schemas from Couchsurfing.
...
- Category risks for personal safety, identity/profile privacy, location privacy, messaging abuse, harassment, reference integrity, subscription/payment handling, moderation, law-enforcement/legal requests, minors and vulnerable users, support, and regional availability have owners and tests.
