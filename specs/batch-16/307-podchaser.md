# Podchaser-Style Clone Spec

> Metadata
> - Inspiration app: Podchaser
...
Build an original mobile podcast directory product inspired by Podchaser's public product and policy materials. V1 focuses on podcast database discovery, reviews/ratings, creator and brand profiles, lists, credits, mobile PWA behavior, API/pro tools, and public-profile privacy controls. The clone must use original branding, original UI copy, original sample media, licensed providers/assets, and explicit disclosures when a feature is inferred from public materials rather than verified hands-on behavior.
...
- Support podcast database discovery, reviews/ratings, creator and brand profiles, lists, credits, mobile PWA behavior, API/pro tools, and public-profile privacy controls with clear retry, recovery, unavailable, region, and rights-aware states.
...
- Do not imply affiliation with Podchaser or its publisher.
...
|---|---|---|---|
| Official product | https://www.podchaser.com/ | Public podcast database, reviews, profiles, charts, lists, and discovery surfaces | Verified 2026-05-04 |
| Help center | https://support.podchaser.com/ | Public support taxonomy for profiles, privacy, feeds, reviews, and PWA/mobile behavior | Verified 2026-05-04 |
| App/PWA help | https://support.podchaser.com/en/articles/4913147-does-podchaser-have-an-app | Public statement that Podchaser uses a mobile-friendly PWA rather than native app store apps | Verified 2026-05-04 |
| Privacy policy | https://www.podchaser.com/privacy.html | Account, public user content, profile data, social sign-in, API/customer sharing, analytics, and user-rights handling | Verified 2026-05-04 |
| Terms of service | https://www.podchaser.com/terms.html | User content, podcast database, API/platform services, acceptable use, and legal boundaries | Verified 2026-05-04 |
...
- Onboarding must support signed-out preview, account creation or restore, blocked-account state, unavailable-region state, and entitlement-unavailable state for podcast directory workflows.
- Home must expose the latest meaningful podcast directory state, search/discovery, saved items, settings, and degraded offline/account variants.
...
|---|---|---|---|---|
| Welcome / Auth | Defines the welcome / auth workflow for Podchaser-inspired podcast directory behavior | taps, forms, search, deep links, media controls, permissions | empty, loading, loaded, signed-out, offline | permission denied, stale state, entitlement blocked, rights unavailable |
| Home / Discover | Defines the home / discover workflow for Podchaser-inspired podcast directory behavior | taps, forms, search, deep links, media controls, permissions | empty, loading, loaded, signed-out, offline | permission denied, stale state, entitlement blocked, rights unavailable |
| Search | Defines the search workflow for Podchaser-inspired podcast directory behavior | taps, forms, search, deep links, media controls, permissions | empty, loading, loaded, signed-out, offline | permission denied, stale state, entitlement blocked, rights unavailable |
| Podcast Detail | Defines the podcast detail workflow for Podchaser-inspired podcast directory behavior | taps, forms, search, deep links, media controls, permissions | empty, loading, loaded, signed-out, offline | permission denied, stale state, entitlement blocked, rights unavailable |
| Episode Detail | Defines the episode detail workflow for Podchaser-inspired podcast directory behavior | taps, forms, search, deep links, media controls, permissions | empty, loading, loaded, signed-out, offline | permission denied, stale state, entitlement blocked, rights unavailable |
| Profile | Defines the profile workflow for Podchaser-inspired podcast directory behavior | taps, forms, search, deep links, media controls, permissions | empty, loading, loaded, signed-out, offline | permission denied, stale state, entitlement blocked, rights unavailable |
| Lists / Collections | Defines the lists / collections workflow for Podchaser-inspired podcast directory behavior | taps, forms, search, deep links, media controls, permissions | empty, loading, loaded, signed-out, offline | permission denied, stale state, entitlement blocked, rights unavailable |
| Reviews / Ratings | Defines the reviews / ratings workflow for Podchaser-inspired podcast directory behavior | taps, forms, search, deep links, media controls, permissions | empty, loading, loaded, signed-out, offline | permission denied, stale state, entitlement blocked, rights unavailable |
| Activity Feed | Defines the activity feed workflow for Podchaser-inspired podcast directory behavior | taps, forms, search, deep links, media controls, permissions | empty, loading, loaded, signed-out, offline | permission denied, stale state, entitlement blocked, rights unavailable |
| Player Handoff | Defines the player handoff workflow for Podchaser-inspired podcast directory behavior | taps, forms, search, deep links, media controls, permissions | empty, loading, loaded, signed-out, offline | permission denied, stale state, entitlement blocked, rights unavailable |
| Notifications | Defines the notifications workflow for Podchaser-inspired podcast directory behavior | taps, forms, search, deep links, media controls, permissions | empty, loading, loaded, signed-out, offline | permission denied, stale state, entitlement blocked, rights unavailable |
| Settings / Privacy | Defines the settings / privacy workflow for Podchaser-inspired podcast directory behavior | taps, forms, search, deep links, media controls, permissions | empty, loading, loaded, signed-out, offline | permission denied, stale state, entitlement blocked, rights unavailable |
| Support | Defines the support workflow for Podchaser-inspired podcast directory behavior | taps, forms, search, deep links, media controls, permissions | empty, loading, loaded, signed-out, offline | permission denied, stale state, entitlement blocked, rights unavailable |
| Reports | Defines the reports workflow for Podchaser-inspired podcast directory behavior | taps, forms, search, deep links, media controls, permissions | empty, loading, loaded, signed-out, offline | permission denied, stale state, entitlement blocked, rights unavailable |

## Data Model

- `User`: owner, lifecycle state, authorization boundary, sync state, retention policy, deletion/export behavior, and audit metadata for Podchaser-inspired podcast directory workflows.
- `AccountSession`: owner, lifecycle state, authorization boundary, sync state, retention policy, deletion/export behavior, and audit metadata for Podchaser-inspired podcast directory workflows.
- `Profile`: owner, lifecycle state, authorization boundary, sync state, retention policy, deletion/export behavior, and audit metadata for Podchaser-inspired podcast directory workflows.
- `CatalogOrFeedItem`: owner, lifecycle state, authorization boundary, sync state, retention policy, deletion/export behavior, and audit metadata for Podchaser-inspired podcast directory workflows.
- `CreatorOrPublisher`: owner, lifecycle state, authorization boundary, sync state, retention policy, deletion/export behavior, and audit metadata for Podchaser-inspired podcast directory workflows.
- `EpisodeOrTitle`: owner, lifecycle state, authorization boundary, sync state, retention policy, deletion/export behavior, and audit metadata for Podchaser-inspired podcast directory workflows.
- `PlaybackSession`: owner, lifecycle state, authorization boundary, sync state, retention policy, deletion/export behavior, and audit metadata for Podchaser-inspired podcast directory workflows.
- `QueueOrWatchlist`: owner, lifecycle state, authorization boundary, sync state, retention policy, deletion/export behavior, and audit metadata for Podchaser-inspired podcast directory workflows.
- `Download`: owner, lifecycle state, authorization boundary, sync state, retention policy, deletion/export behavior, and audit metadata for Podchaser-inspired podcast directory workflows.
- `ImportOrUpload`: owner, lifecycle state, authorization boundary, sync state, retention policy, deletion/export behavior, and audit metadata for Podchaser-inspired podcast directory workflows.
- `ProviderJob`: owner, lifecycle state, authorization boundary, sync state, retention policy, deletion/export behavior, and audit metadata for Podchaser-inspired podcast directory workflows.
- `Entitlement`: owner, lifecycle state, authorization boundary, sync state, retention policy, deletion/export behavior, and audit metadata for Podchaser-inspired podcast directory workflows.
- `AdOrSponsorshipSlot`: owner, lifecycle state, authorization boundary, sync state, retention policy, deletion/export behavior, and audit metadata for Podchaser-inspired podcast directory workflows.
- `NotificationPreference`: owner, lifecycle state, authorization boundary, sync state, retention policy, deletion/export behavior, and audit metadata for Podchaser-inspired podcast directory workflows.
- `RightsOrSafetyReport`: owner, lifecycle state, authorization boundary, sync state, retention policy, deletion/export behavior, and audit metadata for Podchaser-inspired podcast directory workflows.
- `SupportCase`: owner, lifecycle state, authorization boundary, sync state, retention policy, deletion/export behavior, and audit metadata for Podchaser-inspired podcast directory workflows.
- `AuditEvent`: owner, lifecycle state, authorization boundary, sync state, retention policy, deletion/export behavior, and audit metadata for Podchaser-inspired podcast directory workflows.
- `LocalCacheRecord`: owner, lifecycle state, authorization boundary, sync state, retention policy, deletion/export behavior, and audit metadata for Podchaser-inspired podcast directory workflows.
