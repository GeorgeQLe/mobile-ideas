# NPR One-Style Clone Spec

> Metadata
> - Inspiration app: NPR One
...
Build an original mobile publisher audio product inspired by NPR One's public product and policy materials. V1 focuses on personalized NPR/local-station audio, live and on-demand listening, station selection, topic recommendations, donations/support prompts, and public-media privacy boundaries. The clone must use original branding, original UI copy, original sample media, licensed providers/assets, and explicit disclosures when a feature is inferred from public materials rather than verified hands-on behavior.
...
- Support personalized NPR/local-station audio, live and on-demand listening, station selection, topic recommendations, donations/support prompts, and public-media privacy boundaries with clear retry, recovery, unavailable, region, and rights-aware states.
...
- Do not imply affiliation with NPR One or its publisher.
...
|---|---|---|---|
| Official product | https://www.npr.org/about/products/npr-one/ | Public NPR One product positioning, local station, personalized listening, and app surfaces | Verified 2026-05-04 |
| NPR app listing | https://apps.apple.com/us/app/npr/id324906251 | Canonical NPR iOS listing, privacy label, app behavior, and native metadata for the current app successor path | Verified 2026-05-04 |
| Help/contact | https://help.npr.org/ | Public NPR help, account, app, station, sponsorship, and support routing | Verified 2026-05-04 |
| Privacy policy | https://www.npr.org/about-npr/179876898/privacy-policy | NPR personal data, device, listening, sponsorship, analytics, and user-choice handling | Verified 2026-05-04 |
| Terms of use | https://www.npr.org/about-npr/179881519/terms-of-use | NPR service, content, public-media, app, and legal boundaries | Verified 2026-05-04 |
...
|---|---|---|---|---|
| Welcome / Consent | Defines the welcome / consent workflow for NPR One-inspired publisher audio behavior | taps, forms, search, deep links, media controls, permissions | empty, loading, loaded, signed-out, offline | permission denied, stale state, entitlement blocked, rights unavailable |
| Home / Listen | Defines the home / listen workflow for NPR One-inspired publisher audio behavior | taps, forms, search, deep links, media controls, permissions | empty, loading, loaded, signed-out, offline | permission denied, stale state, entitlement blocked, rights unavailable |
| Station / Source Picker | Defines the station / source picker workflow for NPR One-inspired publisher audio behavior | taps, forms, search, deep links, media controls, permissions | empty, loading, loaded, signed-out, offline | permission denied, stale state, entitlement blocked, rights unavailable |
| Live Player | Defines the live player workflow for NPR One-inspired publisher audio behavior | taps, forms, search, deep links, media controls, permissions | empty, loading, loaded, signed-out, offline | permission denied, stale state, entitlement blocked, rights unavailable |
| Podcast / Show Detail | Defines the podcast / show detail workflow for NPR One-inspired publisher audio behavior | taps, forms, search, deep links, media controls, permissions | empty, loading, loaded, signed-out, offline | permission denied, stale state, entitlement blocked, rights unavailable |
| Episode Detail | Defines the episode detail workflow for NPR One-inspired publisher audio behavior | taps, forms, search, deep links, media controls, permissions | empty, loading, loaded, signed-out, offline | permission denied, stale state, entitlement blocked, rights unavailable |
| Queue / Continue Listening | Defines the queue / continue listening workflow for NPR One-inspired publisher audio behavior | taps, forms, search, deep links, media controls, permissions | empty, loading, loaded, signed-out, offline | permission denied, stale state, entitlement blocked, rights unavailable |
| Library / Followed Shows | Defines the library / followed shows workflow for NPR One-inspired publisher audio behavior | taps, forms, search, deep links, media controls, permissions | empty, loading, loaded, signed-out, offline | permission denied, stale state, entitlement blocked, rights unavailable |
| Downloads | Defines the downloads workflow for NPR One-inspired publisher audio behavior | taps, forms, search, deep links, media controls, permissions | empty, loading, loaded, signed-out, offline | permission denied, stale state, entitlement blocked, rights unavailable |
| Local / Region Gate | Defines the local / region gate workflow for NPR One-inspired publisher audio behavior | taps, forms, search, deep links, media controls, permissions | empty, loading, loaded, signed-out, offline | permission denied, stale state, entitlement blocked, rights unavailable |
| Donation / Membership Prompt | Defines the donation / membership prompt workflow for NPR One-inspired publisher audio behavior | taps, forms, search, deep links, media controls, permissions | empty, loading, loaded, signed-out, offline | permission denied, stale state, entitlement blocked, rights unavailable |
| Notifications | Defines the notifications workflow for NPR One-inspired publisher audio behavior | taps, forms, search, deep links, media controls, permissions | empty, loading, loaded, signed-out, offline | permission denied, stale state, entitlement blocked, rights unavailable |
| Settings / Privacy | Defines the settings / privacy workflow for NPR One-inspired publisher audio behavior | taps, forms, search, deep links, media controls, permissions | empty, loading, loaded, signed-out, offline | permission denied, stale state, entitlement blocked, rights unavailable |
| Support | Defines the support workflow for NPR One-inspired publisher audio behavior | taps, forms, search, deep links, media controls, permissions | empty, loading, loaded, signed-out, offline | permission denied, stale state, entitlement blocked, rights unavailable |

## Data Model

- `User`: owner, lifecycle state, authorization boundary, sync state, retention policy, deletion/export behavior, and audit metadata for NPR One-inspired publisher audio workflows.
- `AccountSession`: owner, lifecycle state, authorization boundary, sync state, retention policy, deletion/export behavior, and audit metadata for NPR One-inspired publisher audio workflows.
- `Profile`: owner, lifecycle state, authorization boundary, sync state, retention policy, deletion/export behavior, and audit metadata for NPR One-inspired publisher audio workflows.
- `CatalogOrFeedItem`: owner, lifecycle state, authorization boundary, sync state, retention policy, deletion/export behavior, and audit metadata for NPR One-inspired publisher audio workflows.
- `CreatorOrPublisher`: owner, lifecycle state, authorization boundary, sync state, retention policy, deletion/export behavior, and audit metadata for NPR One-inspired publisher audio workflows.
- `EpisodeOrTitle`: owner, lifecycle state, authorization boundary, sync state, retention policy, deletion/export behavior, and audit metadata for NPR One-inspired publisher audio workflows.
- `PlaybackSession`: owner, lifecycle state, authorization boundary, sync state, retention policy, deletion/export behavior, and audit metadata for NPR One-inspired publisher audio workflows.
- `QueueOrWatchlist`: owner, lifecycle state, authorization boundary, sync state, retention policy, deletion/export behavior, and audit metadata for NPR One-inspired publisher audio workflows.
- `Download`: owner, lifecycle state, authorization boundary, sync state, retention policy, deletion/export behavior, and audit metadata for NPR One-inspired publisher audio workflows.
- `ImportOrUpload`: owner, lifecycle state, authorization boundary, sync state, retention policy, deletion/export behavior, and audit metadata for NPR One-inspired publisher audio workflows.
- `ProviderJob`: owner, lifecycle state, authorization boundary, sync state, retention policy, deletion/export behavior, and audit metadata for NPR One-inspired publisher audio workflows.
- `Entitlement`: owner, lifecycle state, authorization boundary, sync state, retention policy, deletion/export behavior, and audit metadata for NPR One-inspired publisher audio workflows.
- `AdOrSponsorshipSlot`: owner, lifecycle state, authorization boundary, sync state, retention policy, deletion/export behavior, and audit metadata for NPR One-inspired publisher audio workflows.
- `NotificationPreference`: owner, lifecycle state, authorization boundary, sync state, retention policy, deletion/export behavior, and audit metadata for NPR One-inspired publisher audio workflows.
- `RightsOrSafetyReport`: owner, lifecycle state, authorization boundary, sync state, retention policy, deletion/export behavior, and audit metadata for NPR One-inspired publisher audio workflows.
- `SupportCase`: owner, lifecycle state, authorization boundary, sync state, retention policy, deletion/export behavior, and audit metadata for NPR One-inspired publisher audio workflows.
- `AuditEvent`: owner, lifecycle state, authorization boundary, sync state, retention policy, deletion/export behavior, and audit metadata for NPR One-inspired publisher audio workflows.
- `LocalCacheRecord`: owner, lifecycle state, authorization boundary, sync state, retention policy, deletion/export behavior, and audit metadata for NPR One-inspired publisher audio workflows.
