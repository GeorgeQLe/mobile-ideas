# Libsyn-Style Clone Spec

> Metadata
> - Inspiration app: Libsyn
...
Build an original mobile podcast creator platform product inspired by Libsyn's public product and policy materials. V1 focuses on podcast hosting, episode publishing, RSS distribution, mobile stats/dashboards, monetization, ad campaigns, creator accounts, and feed ownership controls. The clone must use original branding, original UI copy, original sample media, licensed providers/assets, and explicit disclosures when a feature is inferred from public materials rather than verified hands-on behavior.
...
- Support podcast hosting, episode publishing, RSS distribution, mobile stats/dashboards, monetization, ad campaigns, creator accounts, and feed ownership controls with clear retry, recovery, unavailable, region, and rights-aware states.
...
- Do not imply affiliation with Libsyn or its publisher.
...
|---|---|---|---|
| Official product | https://libsyn.com/ | Public Libsyn podcast hosting, distribution, monetization, analytics, and creator product surfaces | Verified 2026-05-04 |
| Support center | https://help.libsynsupport.com/ | Public support taxonomy for hosting, publishing, destinations, stats, advertising, and account workflows | Verified 2026-05-04 |
| Privacy policy | https://libsyn.com/privacy-policy/ | Account, creator, listener, analytics, cookies, vendor, retention, and user-rights handling | Verified 2026-05-04 |
| Terms and conditions | https://libsyn.com/terms-and-conditions/ | Hosting, content, billing, acceptable use, feeds, and legal boundaries | Verified 2026-05-04 |
...
|---|---|---|---|---|
| Welcome / Creator Auth | Defines the welcome / creator auth workflow for Libsyn-inspired podcast creator platform behavior | taps, forms, search, deep links, media controls, permissions | empty, loading, loaded, signed-out, offline | permission denied, stale state, entitlement blocked, rights unavailable |
| Creator Dashboard | Defines the creator dashboard workflow for Libsyn-inspired podcast creator platform behavior | taps, forms, search, deep links, media controls, permissions | empty, loading, loaded, signed-out, offline | permission denied, stale state, entitlement blocked, rights unavailable |
| Podcast Setup | Defines the podcast setup workflow for Libsyn-inspired podcast creator platform behavior | taps, forms, search, deep links, media controls, permissions | empty, loading, loaded, signed-out, offline | permission denied, stale state, entitlement blocked, rights unavailable |
| Episode Editor | Defines the episode editor workflow for Libsyn-inspired podcast creator platform behavior | taps, forms, search, deep links, media controls, permissions | empty, loading, loaded, signed-out, offline | permission denied, stale state, entitlement blocked, rights unavailable |
| Upload / Import | Defines the upload / import workflow for Libsyn-inspired podcast creator platform behavior | taps, forms, search, deep links, media controls, permissions | empty, loading, loaded, signed-out, offline | permission denied, stale state, entitlement blocked, rights unavailable |
| RSS Distribution | Defines the rss distribution workflow for Libsyn-inspired podcast creator platform behavior | taps, forms, search, deep links, media controls, permissions | empty, loading, loaded, signed-out, offline | permission denied, stale state, entitlement blocked, rights unavailable |
| Analytics | Defines the analytics workflow for Libsyn-inspired podcast creator platform behavior | taps, forms, search, deep links, media controls, permissions | empty, loading, loaded, signed-out, offline | permission denied, stale state, entitlement blocked, rights unavailable |
| Monetization | Defines the monetization workflow for Libsyn-inspired podcast creator platform behavior | taps, forms, search, deep links, media controls, permissions | empty, loading, loaded, signed-out, offline | permission denied, stale state, entitlement blocked, rights unavailable |
| Listener Discovery | Defines the listener discovery workflow for Libsyn-inspired podcast creator platform behavior | taps, forms, search, deep links, media controls, permissions | empty, loading, loaded, signed-out, offline | permission denied, stale state, entitlement blocked, rights unavailable |
| Comments / Reviews | Defines the comments / reviews workflow for Libsyn-inspired podcast creator platform behavior | taps, forms, search, deep links, media controls, permissions | empty, loading, loaded, signed-out, offline | permission denied, stale state, entitlement blocked, rights unavailable |
| Subscription / Payouts | Defines the subscription / payouts workflow for Libsyn-inspired podcast creator platform behavior | taps, forms, search, deep links, media controls, permissions | empty, loading, loaded, signed-out, offline | permission denied, stale state, entitlement blocked, rights unavailable |
| Settings / Privacy | Defines the settings / privacy workflow for Libsyn-inspired podcast creator platform behavior | taps, forms, search, deep links, media controls, permissions | empty, loading, loaded, signed-out, offline | permission denied, stale state, entitlement blocked, rights unavailable |
| Support | Defines the support workflow for Libsyn-inspired podcast creator platform behavior | taps, forms, search, deep links, media controls, permissions | empty, loading, loaded, signed-out, offline | permission denied, stale state, entitlement blocked, rights unavailable |
| Rights / Reports | Defines the rights / reports workflow for Libsyn-inspired podcast creator platform behavior | taps, forms, search, deep links, media controls, permissions | empty, loading, loaded, signed-out, offline | permission denied, stale state, entitlement blocked, rights unavailable |

## Data Model

- `User`: owner, lifecycle state, authorization boundary, sync state, retention policy, deletion/export behavior, and audit metadata for Libsyn-inspired podcast creator platform workflows.
- `AccountSession`: owner, lifecycle state, authorization boundary, sync state, retention policy, deletion/export behavior, and audit metadata for Libsyn-inspired podcast creator platform workflows.
- `Profile`: owner, lifecycle state, authorization boundary, sync state, retention policy, deletion/export behavior, and audit metadata for Libsyn-inspired podcast creator platform workflows.
- `CatalogOrFeedItem`: owner, lifecycle state, authorization boundary, sync state, retention policy, deletion/export behavior, and audit metadata for Libsyn-inspired podcast creator platform workflows.
- `CreatorOrPublisher`: owner, lifecycle state, authorization boundary, sync state, retention policy, deletion/export behavior, and audit metadata for Libsyn-inspired podcast creator platform workflows.
- `EpisodeOrTitle`: owner, lifecycle state, authorization boundary, sync state, retention policy, deletion/export behavior, and audit metadata for Libsyn-inspired podcast creator platform workflows.
- `PlaybackSession`: owner, lifecycle state, authorization boundary, sync state, retention policy, deletion/export behavior, and audit metadata for Libsyn-inspired podcast creator platform workflows.
- `QueueOrWatchlist`: owner, lifecycle state, authorization boundary, sync state, retention policy, deletion/export behavior, and audit metadata for Libsyn-inspired podcast creator platform workflows.
- `Download`: owner, lifecycle state, authorization boundary, sync state, retention policy, deletion/export behavior, and audit metadata for Libsyn-inspired podcast creator platform workflows.
- `ImportOrUpload`: owner, lifecycle state, authorization boundary, sync state, retention policy, deletion/export behavior, and audit metadata for Libsyn-inspired podcast creator platform workflows.
- `ProviderJob`: owner, lifecycle state, authorization boundary, sync state, retention policy, deletion/export behavior, and audit metadata for Libsyn-inspired podcast creator platform workflows.
- `Entitlement`: owner, lifecycle state, authorization boundary, sync state, retention policy, deletion/export behavior, and audit metadata for Libsyn-inspired podcast creator platform workflows.
- `AdOrSponsorshipSlot`: owner, lifecycle state, authorization boundary, sync state, retention policy, deletion/export behavior, and audit metadata for Libsyn-inspired podcast creator platform workflows.
- `NotificationPreference`: owner, lifecycle state, authorization boundary, sync state, retention policy, deletion/export behavior, and audit metadata for Libsyn-inspired podcast creator platform workflows.
- `RightsOrSafetyReport`: owner, lifecycle state, authorization boundary, sync state, retention policy, deletion/export behavior, and audit metadata for Libsyn-inspired podcast creator platform workflows.
- `SupportCase`: owner, lifecycle state, authorization boundary, sync state, retention policy, deletion/export behavior, and audit metadata for Libsyn-inspired podcast creator platform workflows.
- `AuditEvent`: owner, lifecycle state, authorization boundary, sync state, retention policy, deletion/export behavior, and audit metadata for Libsyn-inspired podcast creator platform workflows.
- `LocalCacheRecord`: owner, lifecycle state, authorization boundary, sync state, retention policy, deletion/export behavior, and audit metadata for Libsyn-inspired podcast creator platform workflows.
