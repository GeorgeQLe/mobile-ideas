# Prime Video-Style Clone Spec

> Metadata
> - Inspiration app: Prime Video
...
Build an original mobile streaming video product inspired by Prime Video's public product and policy materials. V1 focuses on Prime/member and standalone video streaming, rentals/purchases, channels, profiles, downloads/offline, ads, X-Ray-style metadata, and marketplace billing boundaries. The clone must use original branding, original UI copy, original sample media, licensed providers/assets, and explicit disclosures when a feature is inferred from public materials rather than verified hands-on behavior.
...
- Support Prime/member and standalone video streaming, rentals/purchases, channels, profiles, downloads/offline, ads, X-Ray-style metadata, and marketplace billing boundaries with clear retry, recovery, unavailable, region, and rights-aware states.
...
- Do not imply affiliation with Prime Video or its publisher.
...
|---|---|---|---|
| Official product | https://www.primevideo.com/ | Public Prime Video product, catalog, rentals, channels, account, and app surfaces | Verified 2026-05-04 |
| Help center | https://www.primevideo.com/help | Public support taxonomy for playback, profiles, captions, devices, purchases, rentals, and troubleshooting | Verified 2026-05-04 |
| Prime Video legal | https://www.primevideo.com/ww-av-legal-home | Public Prime Video legal notices and terms entry point | Verified 2026-05-04 |
| Amazon privacy notice | https://www.amazon.com/gp/help/customer/display.html?nodeId=468496 | Amazon account, viewing, device, advertising, purchase, and privacy-rights handling | Verified 2026-05-04 |
| Amazon conditions of use | https://www.amazon.com/gp/help/customer/display.html?nodeId=508088 | Amazon service/account purchase, digital content, and legal boundaries | Verified 2026-05-04 |
...
|---|---|---|---|---|
| Welcome / Auth | Defines the welcome / auth workflow for Prime Video-inspired streaming video behavior | taps, forms, search, deep links, media controls, permissions | empty, loading, loaded, signed-out, offline | permission denied, stale state, entitlement blocked, rights unavailable |
| Plan / Bundle Gate | Defines the plan / bundle gate workflow for Prime Video-inspired streaming video behavior | taps, forms, search, deep links, media controls, permissions | empty, loading, loaded, signed-out, offline | permission denied, stale state, entitlement blocked, rights unavailable |
| Home / For You | Defines the home / for you workflow for Prime Video-inspired streaming video behavior | taps, forms, search, deep links, media controls, permissions | empty, loading, loaded, signed-out, offline | permission denied, stale state, entitlement blocked, rights unavailable |
| Search / Browse | Defines the search / browse workflow for Prime Video-inspired streaming video behavior | taps, forms, search, deep links, media controls, permissions | empty, loading, loaded, signed-out, offline | permission denied, stale state, entitlement blocked, rights unavailable |
| Title Detail | Defines the title detail workflow for Prime Video-inspired streaming video behavior | taps, forms, search, deep links, media controls, permissions | empty, loading, loaded, signed-out, offline | permission denied, stale state, entitlement blocked, rights unavailable |
| Episode / Season Detail | Defines the episode / season detail workflow for Prime Video-inspired streaming video behavior | taps, forms, search, deep links, media controls, permissions | empty, loading, loaded, signed-out, offline | permission denied, stale state, entitlement blocked, rights unavailable |
| Player | Defines the player workflow for Prime Video-inspired streaming video behavior | taps, forms, search, deep links, media controls, permissions | empty, loading, loaded, signed-out, offline | permission denied, stale state, entitlement blocked, rights unavailable |
| Profiles / Kids Profile | Defines the profiles / kids profile workflow for Prime Video-inspired streaming video behavior | taps, forms, search, deep links, media controls, permissions | empty, loading, loaded, signed-out, offline | permission denied, stale state, entitlement blocked, rights unavailable |
| Watchlist | Defines the watchlist workflow for Prime Video-inspired streaming video behavior | taps, forms, search, deep links, media controls, permissions | empty, loading, loaded, signed-out, offline | permission denied, stale state, entitlement blocked, rights unavailable |
| Downloads / Offline | Defines the downloads / offline workflow for Prime Video-inspired streaming video behavior | taps, forms, search, deep links, media controls, permissions | empty, loading, loaded, signed-out, offline | permission denied, stale state, entitlement blocked, rights unavailable |
| Live / Channels | Defines the live / channels workflow for Prime Video-inspired streaming video behavior | taps, forms, search, deep links, media controls, permissions | empty, loading, loaded, signed-out, offline | permission denied, stale state, entitlement blocked, rights unavailable |
| Billing / Entitlement | Defines the billing / entitlement workflow for Prime Video-inspired streaming video behavior | taps, forms, search, deep links, media controls, permissions | empty, loading, loaded, signed-out, offline | permission denied, stale state, entitlement blocked, rights unavailable |
| Notifications | Defines the notifications workflow for Prime Video-inspired streaming video behavior | taps, forms, search, deep links, media controls, permissions | empty, loading, loaded, signed-out, offline | permission denied, stale state, entitlement blocked, rights unavailable |
| Settings / Privacy | Defines the settings / privacy workflow for Prime Video-inspired streaming video behavior | taps, forms, search, deep links, media controls, permissions | empty, loading, loaded, signed-out, offline | permission denied, stale state, entitlement blocked, rights unavailable |
| Support / Reports | Defines the support / reports workflow for Prime Video-inspired streaming video behavior | taps, forms, search, deep links, media controls, permissions | empty, loading, loaded, signed-out, offline | permission denied, stale state, entitlement blocked, rights unavailable |

## Data Model

- `User`: owner, lifecycle state, authorization boundary, sync state, retention policy, deletion/export behavior, and audit metadata for Prime Video-inspired streaming video workflows.
- `AccountSession`: owner, lifecycle state, authorization boundary, sync state, retention policy, deletion/export behavior, and audit metadata for Prime Video-inspired streaming video workflows.
- `Profile`: owner, lifecycle state, authorization boundary, sync state, retention policy, deletion/export behavior, and audit metadata for Prime Video-inspired streaming video workflows.
- `CatalogOrFeedItem`: owner, lifecycle state, authorization boundary, sync state, retention policy, deletion/export behavior, and audit metadata for Prime Video-inspired streaming video workflows.
- `CreatorOrPublisher`: owner, lifecycle state, authorization boundary, sync state, retention policy, deletion/export behavior, and audit metadata for Prime Video-inspired streaming video workflows.
- `EpisodeOrTitle`: owner, lifecycle state, authorization boundary, sync state, retention policy, deletion/export behavior, and audit metadata for Prime Video-inspired streaming video workflows.
- `PlaybackSession`: owner, lifecycle state, authorization boundary, sync state, retention policy, deletion/export behavior, and audit metadata for Prime Video-inspired streaming video workflows.
- `QueueOrWatchlist`: owner, lifecycle state, authorization boundary, sync state, retention policy, deletion/export behavior, and audit metadata for Prime Video-inspired streaming video workflows.
- `Download`: owner, lifecycle state, authorization boundary, sync state, retention policy, deletion/export behavior, and audit metadata for Prime Video-inspired streaming video workflows.
- `ImportOrUpload`: owner, lifecycle state, authorization boundary, sync state, retention policy, deletion/export behavior, and audit metadata for Prime Video-inspired streaming video workflows.
- `ProviderJob`: owner, lifecycle state, authorization boundary, sync state, retention policy, deletion/export behavior, and audit metadata for Prime Video-inspired streaming video workflows.
- `Entitlement`: owner, lifecycle state, authorization boundary, sync state, retention policy, deletion/export behavior, and audit metadata for Prime Video-inspired streaming video workflows.
- `AdOrSponsorshipSlot`: owner, lifecycle state, authorization boundary, sync state, retention policy, deletion/export behavior, and audit metadata for Prime Video-inspired streaming video workflows.
- `NotificationPreference`: owner, lifecycle state, authorization boundary, sync state, retention policy, deletion/export behavior, and audit metadata for Prime Video-inspired streaming video workflows.
- `RightsOrSafetyReport`: owner, lifecycle state, authorization boundary, sync state, retention policy, deletion/export behavior, and audit metadata for Prime Video-inspired streaming video workflows.
- `SupportCase`: owner, lifecycle state, authorization boundary, sync state, retention policy, deletion/export behavior, and audit metadata for Prime Video-inspired streaming video workflows.
- `AuditEvent`: owner, lifecycle state, authorization boundary, sync state, retention policy, deletion/export behavior, and audit metadata for Prime Video-inspired streaming video workflows.
- `LocalCacheRecord`: owner, lifecycle state, authorization boundary, sync state, retention policy, deletion/export behavior, and audit metadata for Prime Video-inspired streaming video workflows.
