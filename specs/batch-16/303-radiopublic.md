# RadioPublic-Style Clone Spec

> Metadata
> - Inspiration app: RadioPublic
...
Build an original mobile podcast creator platform product inspired by RadioPublic's public product and policy materials. V1 focuses on podcast listening, show discovery, episode pages, web/mobile playback, paid-listen legacy surfaces, creator attribution, and Acast-era privacy/rights boundaries. The clone must use original branding, original UI copy, original sample media, licensed providers/assets, and explicit disclosures when a feature is inferred from public materials rather than verified hands-on behavior.
...
- Support podcast listening, show discovery, episode pages, web/mobile playback, paid-listen legacy surfaces, creator attribution, and Acast-era privacy/rights boundaries with clear retry, recovery, unavailable, region, and rights-aware states.
...
- Do not imply affiliation with RadioPublic or its publisher.
...
|---|---|---|---|
| Official product | https://radiopublic.com/ | Public RadioPublic podcast discovery, show, episode, and listening surfaces | Verified 2026-05-04 |
| Company/about | https://about.radiopublic.com/ | Public RadioPublic/Acast context, podcast program materials, and product history | Verified 2026-05-04 |
| Privacy policy | https://about.radiopublic.com/2016/11/08/radiopublic-privacy-policy/ | Listener/podcaster privacy practices under Acast, services, mobile applications, products, and content | Verified 2026-05-04 |
| Terms of service | https://about.radiopublic.com/2016/11/08/radiopublic-terms-of-service/ | Service usage, content, paid-listen program links, and legal boundaries | Verified 2026-05-04 |
...
- Home must expose the latest meaningful podcast creator platform state, search/discovery, saved items, settings, and degraded offline/account variants.
...
- Podcast/feed ingestion must preserve RSS ownership, GUID stability, episode takedowns, dynamic ad markers, transcript/caption rights, explicit labels, and private-feed tokens.
- Queue and download behavior must handle stale feeds, duplicate episodes, removed files, expired downloads, background restrictions, and cross-device sync conflicts.
- Creator publishing must require explicit ownership or license confirmation for audio, cover art, music, transcripts, show metadata, and paid subscriber content.
- Creator analytics and monetization must separate listener personal data, aggregate reporting, ad-tech identifiers, payouts, tax/billing records, and public claims.
...
|---|---|---|---|---|
| Welcome / Creator Auth | Defines the welcome / creator auth workflow for RadioPublic-inspired podcast creator platform behavior | taps, forms, search, deep links, media controls, permissions | empty, loading, loaded, signed-out, offline | permission denied, stale state, entitlement blocked, rights unavailable |
| Creator Dashboard | Defines the creator dashboard workflow for RadioPublic-inspired podcast creator platform behavior | taps, forms, search, deep links, media controls, permissions | empty, loading, loaded, signed-out, offline | permission denied, stale state, entitlement blocked, rights unavailable |
| Podcast Setup | Defines the podcast setup workflow for RadioPublic-inspired podcast creator platform behavior | taps, forms, search, deep links, media controls, permissions | empty, loading, loaded, signed-out, offline | permission denied, stale state, entitlement blocked, rights unavailable |
| Episode Editor | Defines the episode editor workflow for RadioPublic-inspired podcast creator platform behavior | taps, forms, search, deep links, media controls, permissions | empty, loading, loaded, signed-out, offline | permission denied, stale state, entitlement blocked, rights unavailable |
| Upload / Import | Defines the upload / import workflow for RadioPublic-inspired podcast creator platform behavior | taps, forms, search, deep links, media controls, permissions | empty, loading, loaded, signed-out, offline | permission denied, stale state, entitlement blocked, rights unavailable |
| RSS Distribution | Defines the rss distribution workflow for RadioPublic-inspired podcast creator platform behavior | taps, forms, search, deep links, media controls, permissions | empty, loading, loaded, signed-out, offline | permission denied, stale state, entitlement blocked, rights unavailable |
| Analytics | Defines the analytics workflow for RadioPublic-inspired podcast creator platform behavior | taps, forms, search, deep links, media controls, permissions | empty, loading, loaded, signed-out, offline | permission denied, stale state, entitlement blocked, rights unavailable |
| Monetization | Defines the monetization workflow for RadioPublic-inspired podcast creator platform behavior | taps, forms, search, deep links, media controls, permissions | empty, loading, loaded, signed-out, offline | permission denied, stale state, entitlement blocked, rights unavailable |
| Listener Discovery | Defines the listener discovery workflow for RadioPublic-inspired podcast creator platform behavior | taps, forms, search, deep links, media controls, permissions | empty, loading, loaded, signed-out, offline | permission denied, stale state, entitlement blocked, rights unavailable |
| Comments / Reviews | Defines the comments / reviews workflow for RadioPublic-inspired podcast creator platform behavior | taps, forms, search, deep links, media controls, permissions | empty, loading, loaded, signed-out, offline | permission denied, stale state, entitlement blocked, rights unavailable |
| Subscription / Payouts | Defines the subscription / payouts workflow for RadioPublic-inspired podcast creator platform behavior | taps, forms, search, deep links, media controls, permissions | empty, loading, loaded, signed-out, offline | permission denied, stale state, entitlement blocked, rights unavailable |
| Settings / Privacy | Defines the settings / privacy workflow for RadioPublic-inspired podcast creator platform behavior | taps, forms, search, deep links, media controls, permissions | empty, loading, loaded, signed-out, offline | permission denied, stale state, entitlement blocked, rights unavailable |
| Support | Defines the support workflow for RadioPublic-inspired podcast creator platform behavior | taps, forms, search, deep links, media controls, permissions | empty, loading, loaded, signed-out, offline | permission denied, stale state, entitlement blocked, rights unavailable |
| Rights / Reports | Defines the rights / reports workflow for RadioPublic-inspired podcast creator platform behavior | taps, forms, search, deep links, media controls, permissions | empty, loading, loaded, signed-out, offline | permission denied, stale state, entitlement blocked, rights unavailable |

## Data Model

- `User`: owner, lifecycle state, authorization boundary, sync state, retention policy, deletion/export behavior, and audit metadata for RadioPublic-inspired podcast creator platform workflows.
- `AccountSession`: owner, lifecycle state, authorization boundary, sync state, retention policy, deletion/export behavior, and audit metadata for RadioPublic-inspired podcast creator platform workflows.
- `Profile`: owner, lifecycle state, authorization boundary, sync state, retention policy, deletion/export behavior, and audit metadata for RadioPublic-inspired podcast creator platform workflows.
- `CatalogOrFeedItem`: owner, lifecycle state, authorization boundary, sync state, retention policy, deletion/export behavior, and audit metadata for RadioPublic-inspired podcast creator platform workflows.
- `CreatorOrPublisher`: owner, lifecycle state, authorization boundary, sync state, retention policy, deletion/export behavior, and audit metadata for RadioPublic-inspired podcast creator platform workflows.
- `EpisodeOrTitle`: owner, lifecycle state, authorization boundary, sync state, retention policy, deletion/export behavior, and audit metadata for RadioPublic-inspired podcast creator platform workflows.
- `PlaybackSession`: owner, lifecycle state, authorization boundary, sync state, retention policy, deletion/export behavior, and audit metadata for RadioPublic-inspired podcast creator platform workflows.
- `QueueOrWatchlist`: owner, lifecycle state, authorization boundary, sync state, retention policy, deletion/export behavior, and audit metadata for RadioPublic-inspired podcast creator platform workflows.
- `Download`: owner, lifecycle state, authorization boundary, sync state, retention policy, deletion/export behavior, and audit metadata for RadioPublic-inspired podcast creator platform workflows.
- `ImportOrUpload`: owner, lifecycle state, authorization boundary, sync state, retention policy, deletion/export behavior, and audit metadata for RadioPublic-inspired podcast creator platform workflows.
- `ProviderJob`: owner, lifecycle state, authorization boundary, sync state, retention policy, deletion/export behavior, and audit metadata for RadioPublic-inspired podcast creator platform workflows.
- `Entitlement`: owner, lifecycle state, authorization boundary, sync state, retention policy, deletion/export behavior, and audit metadata for RadioPublic-inspired podcast creator platform workflows.
- `AdOrSponsorshipSlot`: owner, lifecycle state, authorization boundary, sync state, retention policy, deletion/export behavior, and audit metadata for RadioPublic-inspired podcast creator platform workflows.
- `NotificationPreference`: owner, lifecycle state, authorization boundary, sync state, retention policy, deletion/export behavior, and audit metadata for RadioPublic-inspired podcast creator platform workflows.
- `RightsOrSafetyReport`: owner, lifecycle state, authorization boundary, sync state, retention policy, deletion/export behavior, and audit metadata for RadioPublic-inspired podcast creator platform workflows.
- `SupportCase`: owner, lifecycle state, authorization boundary, sync state, retention policy, deletion/export behavior, and audit metadata for RadioPublic-inspired podcast creator platform workflows.
- `AuditEvent`: owner, lifecycle state, authorization boundary, sync state, retention policy, deletion/export behavior, and audit metadata for RadioPublic-inspired podcast creator platform workflows.
- `LocalCacheRecord`: owner, lifecycle state, authorization boundary, sync state, retention policy, deletion/export behavior, and audit metadata for RadioPublic-inspired podcast creator platform workflows.
