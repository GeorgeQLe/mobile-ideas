# Storytel-Style Clone Spec

> Metadata
> - Inspiration app: Storytel
...
Build an original mobile audiobook and ebook streaming product inspired by Storytel's public product and policy materials. V1 focuses on audiobook and ebook subscription listening/reading, library saves, reviews/profiles, downloads/offline, kids/family modes, and regional catalog rights. The clone must use original branding, original UI copy, original sample media, licensed providers/assets, and explicit disclosures when a feature is inferred from public materials rather than verified hands-on behavior.
...
- Support audiobook and ebook subscription listening/reading, library saves, reviews/profiles, downloads/offline, kids/family modes, and regional catalog rights with clear retry, recovery, unavailable, region, and rights-aware states.
...
- Do not imply affiliation with Storytel or its publisher.
...
|---|---|---|---|
| Official product | https://www.storytel.com/ | Public Storytel audiobook/ebook subscription, app, catalog, and account surfaces | Verified 2026-05-04 |
| App page | https://www.storytel.com/es/es/app | Public app workflow for download, sign-in, finding books, library, and playback/reading | Verified 2026-05-04 |
| Help center | https://support.storytel.com/ | Public support taxonomy for app usage, account, subscriptions, privacy settings, and troubleshooting | Verified 2026-05-04 |
| Privacy/account help | https://support.storytel.com/hc/en-001/articles/360010376300-How-do-I-change-my-registered-information-and-privacy-settings | Public profile/privacy settings and marketing-consent management | Verified 2026-05-04 |
| Privacy policy | https://www.storytel.com/privacy-policy | Account, app, reading/listening, payments, marketing, retention, and rights handling | Verified 2026-05-04 |
| Terms of use | https://www.storytel.com/terms-and-conditions | Subscription, content, account, app use, cancellation, and legal boundaries | Verified 2026-05-04 |
...
- Onboarding must support signed-out preview, account creation or restore, blocked-account state, unavailable-region state, and entitlement-unavailable state for audiobook and ebook streaming workflows.
- Home must expose the latest meaningful audiobook and ebook streaming state, search/discovery, saved items, settings, and degraded offline/account variants.
...
- Serialized story, audiobook, and ebook catalogs must track chapter/episode unlocks, coin/subscription gates, refund state, age ratings, and licensed territorial rights.
- Reviews, profiles, family/kids controls, and recommendations must avoid exposing child profiles, private libraries, or sensitive listening history.
...
|---|---|---|---|---|
| Welcome / Auth | Defines the welcome / auth workflow for Storytel-inspired audiobook and ebook streaming behavior | taps, forms, search, deep links, media controls, permissions | empty, loading, loaded, signed-out, offline | permission denied, stale state, entitlement blocked, rights unavailable |
| Home / Recommendations | Defines the home / recommendations workflow for Storytel-inspired audiobook and ebook streaming behavior | taps, forms, search, deep links, media controls, permissions | empty, loading, loaded, signed-out, offline | permission denied, stale state, entitlement blocked, rights unavailable |
| Search / Browse | Defines the search / browse workflow for Storytel-inspired audiobook and ebook streaming behavior | taps, forms, search, deep links, media controls, permissions | empty, loading, loaded, signed-out, offline | permission denied, stale state, entitlement blocked, rights unavailable |
| Series / Book Detail | Defines the series / book detail workflow for Storytel-inspired audiobook and ebook streaming behavior | taps, forms, search, deep links, media controls, permissions | empty, loading, loaded, signed-out, offline | permission denied, stale state, entitlement blocked, rights unavailable |
| Episode / Chapter Detail | Defines the episode / chapter detail workflow for Storytel-inspired audiobook and ebook streaming behavior | taps, forms, search, deep links, media controls, permissions | empty, loading, loaded, signed-out, offline | permission denied, stale state, entitlement blocked, rights unavailable |
| Player / Reader | Defines the player / reader workflow for Storytel-inspired audiobook and ebook streaming behavior | taps, forms, search, deep links, media controls, permissions | empty, loading, loaded, signed-out, offline | permission denied, stale state, entitlement blocked, rights unavailable |
| Library | Defines the library workflow for Storytel-inspired audiobook and ebook streaming behavior | taps, forms, search, deep links, media controls, permissions | empty, loading, loaded, signed-out, offline | permission denied, stale state, entitlement blocked, rights unavailable |
| Downloads / Offline | Defines the downloads / offline workflow for Storytel-inspired audiobook and ebook streaming behavior | taps, forms, search, deep links, media controls, permissions | empty, loading, loaded, signed-out, offline | permission denied, stale state, entitlement blocked, rights unavailable |
| Reviews / Profile | Defines the reviews / profile workflow for Storytel-inspired audiobook and ebook streaming behavior | taps, forms, search, deep links, media controls, permissions | empty, loading, loaded, signed-out, offline | permission denied, stale state, entitlement blocked, rights unavailable |
| Coins / Subscription | Defines the coins / subscription workflow for Storytel-inspired audiobook and ebook streaming behavior | taps, forms, search, deep links, media controls, permissions | empty, loading, loaded, signed-out, offline | permission denied, stale state, entitlement blocked, rights unavailable |
| Kids / Family Mode | Defines the kids / family mode workflow for Storytel-inspired audiobook and ebook streaming behavior | taps, forms, search, deep links, media controls, permissions | empty, loading, loaded, signed-out, offline | permission denied, stale state, entitlement blocked, rights unavailable |
| Notifications | Defines the notifications workflow for Storytel-inspired audiobook and ebook streaming behavior | taps, forms, search, deep links, media controls, permissions | empty, loading, loaded, signed-out, offline | permission denied, stale state, entitlement blocked, rights unavailable |
| Settings / Privacy | Defines the settings / privacy workflow for Storytel-inspired audiobook and ebook streaming behavior | taps, forms, search, deep links, media controls, permissions | empty, loading, loaded, signed-out, offline | permission denied, stale state, entitlement blocked, rights unavailable |
| Support / Reports | Defines the support / reports workflow for Storytel-inspired audiobook and ebook streaming behavior | taps, forms, search, deep links, media controls, permissions | empty, loading, loaded, signed-out, offline | permission denied, stale state, entitlement blocked, rights unavailable |

## Data Model

- `User`: owner, lifecycle state, authorization boundary, sync state, retention policy, deletion/export behavior, and audit metadata for Storytel-inspired audiobook and ebook streaming workflows.
- `AccountSession`: owner, lifecycle state, authorization boundary, sync state, retention policy, deletion/export behavior, and audit metadata for Storytel-inspired audiobook and ebook streaming workflows.
- `Profile`: owner, lifecycle state, authorization boundary, sync state, retention policy, deletion/export behavior, and audit metadata for Storytel-inspired audiobook and ebook streaming workflows.
- `CatalogOrFeedItem`: owner, lifecycle state, authorization boundary, sync state, retention policy, deletion/export behavior, and audit metadata for Storytel-inspired audiobook and ebook streaming workflows.
- `CreatorOrPublisher`: owner, lifecycle state, authorization boundary, sync state, retention policy, deletion/export behavior, and audit metadata for Storytel-inspired audiobook and ebook streaming workflows.
- `EpisodeOrTitle`: owner, lifecycle state, authorization boundary, sync state, retention policy, deletion/export behavior, and audit metadata for Storytel-inspired audiobook and ebook streaming workflows.
- `PlaybackSession`: owner, lifecycle state, authorization boundary, sync state, retention policy, deletion/export behavior, and audit metadata for Storytel-inspired audiobook and ebook streaming workflows.
- `QueueOrWatchlist`: owner, lifecycle state, authorization boundary, sync state, retention policy, deletion/export behavior, and audit metadata for Storytel-inspired audiobook and ebook streaming workflows.
- `Download`: owner, lifecycle state, authorization boundary, sync state, retention policy, deletion/export behavior, and audit metadata for Storytel-inspired audiobook and ebook streaming workflows.
- `ImportOrUpload`: owner, lifecycle state, authorization boundary, sync state, retention policy, deletion/export behavior, and audit metadata for Storytel-inspired audiobook and ebook streaming workflows.
- `ProviderJob`: owner, lifecycle state, authorization boundary, sync state, retention policy, deletion/export behavior, and audit metadata for Storytel-inspired audiobook and ebook streaming workflows.
- `Entitlement`: owner, lifecycle state, authorization boundary, sync state, retention policy, deletion/export behavior, and audit metadata for Storytel-inspired audiobook and ebook streaming workflows.
- `AdOrSponsorshipSlot`: owner, lifecycle state, authorization boundary, sync state, retention policy, deletion/export behavior, and audit metadata for Storytel-inspired audiobook and ebook streaming workflows.
- `NotificationPreference`: owner, lifecycle state, authorization boundary, sync state, retention policy, deletion/export behavior, and audit metadata for Storytel-inspired audiobook and ebook streaming workflows.
- `RightsOrSafetyReport`: owner, lifecycle state, authorization boundary, sync state, retention policy, deletion/export behavior, and audit metadata for Storytel-inspired audiobook and ebook streaming workflows.
- `SupportCase`: owner, lifecycle state, authorization boundary, sync state, retention policy, deletion/export behavior, and audit metadata for Storytel-inspired audiobook and ebook streaming workflows.
- `AuditEvent`: owner, lifecycle state, authorization boundary, sync state, retention policy, deletion/export behavior, and audit metadata for Storytel-inspired audiobook and ebook streaming workflows.
- `LocalCacheRecord`: owner, lifecycle state, authorization boundary, sync state, retention policy, deletion/export behavior, and audit metadata for Storytel-inspired audiobook and ebook streaming workflows.
