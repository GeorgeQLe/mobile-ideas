# Pocket FM-Style Clone Spec

> Metadata
> - Inspiration app: Pocket FM
...
Build an original mobile serialized audio listening product inspired by Pocket FM's public product and policy materials. V1 focuses on serialized audio stories, paid coin unlocks, recommendations, library saves, creator/story rights, offline listening, and regional content/subscription states. The clone must use original branding, original UI copy, original sample media, licensed providers/assets, and explicit disclosures when a feature is inferred from public materials rather than verified hands-on behavior.
...
- Support serialized audio stories, paid coin unlocks, recommendations, library saves, creator/story rights, offline listening, and regional content/subscription states with clear retry, recovery, unavailable, region, and rights-aware states.
...
- Do not imply affiliation with Pocket FM or its publisher.
...
|---|---|---|---|
| Official product | https://www.pocketfm.com/ | Public Pocket FM audio-series product, catalog, app, creator, and listening surfaces | Verified 2026-05-04 |
| App Store listing | https://apps.apple.com/us/app/pocket-fm-audio-series/id1538433480 | Canonical iOS listing, in-app purchases, privacy label, age, compatibility, and native metadata | Verified 2026-05-04 |
| Privacy policy | https://www.pocketfm.com/privacy-policy | Account, app, listening, purchase, advertising, analytics, retention, and user-rights handling | Verified 2026-05-04 |
| Terms and conditions | https://www.pocketfm.com/terms-and-conditions | Service usage, coins/purchases, user content, licensed audio, acceptable use, and legal boundaries | Verified 2026-05-04 |
...
- Onboarding must support signed-out preview, account creation or restore, blocked-account state, unavailable-region state, and entitlement-unavailable state for serialized audio listening workflows.
- Home must expose the latest meaningful serialized audio listening state, search/discovery, saved items, settings, and degraded offline/account variants.
...
|---|---|---|---|---|
| Welcome / Auth | Defines the welcome / auth workflow for Pocket FM-inspired serialized audio listening behavior | taps, forms, search, deep links, media controls, permissions | empty, loading, loaded, signed-out, offline | permission denied, stale state, entitlement blocked, rights unavailable |
| Home / Recommendations | Defines the home / recommendations workflow for Pocket FM-inspired serialized audio listening behavior | taps, forms, search, deep links, media controls, permissions | empty, loading, loaded, signed-out, offline | permission denied, stale state, entitlement blocked, rights unavailable |
| Search / Browse | Defines the search / browse workflow for Pocket FM-inspired serialized audio listening behavior | taps, forms, search, deep links, media controls, permissions | empty, loading, loaded, signed-out, offline | permission denied, stale state, entitlement blocked, rights unavailable |
| Series / Book Detail | Defines the series / book detail workflow for Pocket FM-inspired serialized audio listening behavior | taps, forms, search, deep links, media controls, permissions | empty, loading, loaded, signed-out, offline | permission denied, stale state, entitlement blocked, rights unavailable |
| Episode / Chapter Detail | Defines the episode / chapter detail workflow for Pocket FM-inspired serialized audio listening behavior | taps, forms, search, deep links, media controls, permissions | empty, loading, loaded, signed-out, offline | permission denied, stale state, entitlement blocked, rights unavailable |
| Player / Reader | Defines the player / reader workflow for Pocket FM-inspired serialized audio listening behavior | taps, forms, search, deep links, media controls, permissions | empty, loading, loaded, signed-out, offline | permission denied, stale state, entitlement blocked, rights unavailable |
| Library | Defines the library workflow for Pocket FM-inspired serialized audio listening behavior | taps, forms, search, deep links, media controls, permissions | empty, loading, loaded, signed-out, offline | permission denied, stale state, entitlement blocked, rights unavailable |
| Downloads / Offline | Defines the downloads / offline workflow for Pocket FM-inspired serialized audio listening behavior | taps, forms, search, deep links, media controls, permissions | empty, loading, loaded, signed-out, offline | permission denied, stale state, entitlement blocked, rights unavailable |
| Reviews / Profile | Defines the reviews / profile workflow for Pocket FM-inspired serialized audio listening behavior | taps, forms, search, deep links, media controls, permissions | empty, loading, loaded, signed-out, offline | permission denied, stale state, entitlement blocked, rights unavailable |
| Coins / Subscription | Defines the coins / subscription workflow for Pocket FM-inspired serialized audio listening behavior | taps, forms, search, deep links, media controls, permissions | empty, loading, loaded, signed-out, offline | permission denied, stale state, entitlement blocked, rights unavailable |
| Kids / Family Mode | Defines the kids / family mode workflow for Pocket FM-inspired serialized audio listening behavior | taps, forms, search, deep links, media controls, permissions | empty, loading, loaded, signed-out, offline | permission denied, stale state, entitlement blocked, rights unavailable |
| Notifications | Defines the notifications workflow for Pocket FM-inspired serialized audio listening behavior | taps, forms, search, deep links, media controls, permissions | empty, loading, loaded, signed-out, offline | permission denied, stale state, entitlement blocked, rights unavailable |
| Settings / Privacy | Defines the settings / privacy workflow for Pocket FM-inspired serialized audio listening behavior | taps, forms, search, deep links, media controls, permissions | empty, loading, loaded, signed-out, offline | permission denied, stale state, entitlement blocked, rights unavailable |
| Support / Reports | Defines the support / reports workflow for Pocket FM-inspired serialized audio listening behavior | taps, forms, search, deep links, media controls, permissions | empty, loading, loaded, signed-out, offline | permission denied, stale state, entitlement blocked, rights unavailable |

## Data Model

- `User`: owner, lifecycle state, authorization boundary, sync state, retention policy, deletion/export behavior, and audit metadata for Pocket FM-inspired serialized audio listening workflows.
- `AccountSession`: owner, lifecycle state, authorization boundary, sync state, retention policy, deletion/export behavior, and audit metadata for Pocket FM-inspired serialized audio listening workflows.
- `Profile`: owner, lifecycle state, authorization boundary, sync state, retention policy, deletion/export behavior, and audit metadata for Pocket FM-inspired serialized audio listening workflows.
- `CatalogOrFeedItem`: owner, lifecycle state, authorization boundary, sync state, retention policy, deletion/export behavior, and audit metadata for Pocket FM-inspired serialized audio listening workflows.
- `CreatorOrPublisher`: owner, lifecycle state, authorization boundary, sync state, retention policy, deletion/export behavior, and audit metadata for Pocket FM-inspired serialized audio listening workflows.
- `EpisodeOrTitle`: owner, lifecycle state, authorization boundary, sync state, retention policy, deletion/export behavior, and audit metadata for Pocket FM-inspired serialized audio listening workflows.
- `PlaybackSession`: owner, lifecycle state, authorization boundary, sync state, retention policy, deletion/export behavior, and audit metadata for Pocket FM-inspired serialized audio listening workflows.
- `QueueOrWatchlist`: owner, lifecycle state, authorization boundary, sync state, retention policy, deletion/export behavior, and audit metadata for Pocket FM-inspired serialized audio listening workflows.
- `Download`: owner, lifecycle state, authorization boundary, sync state, retention policy, deletion/export behavior, and audit metadata for Pocket FM-inspired serialized audio listening workflows.
- `ImportOrUpload`: owner, lifecycle state, authorization boundary, sync state, retention policy, deletion/export behavior, and audit metadata for Pocket FM-inspired serialized audio listening workflows.
- `ProviderJob`: owner, lifecycle state, authorization boundary, sync state, retention policy, deletion/export behavior, and audit metadata for Pocket FM-inspired serialized audio listening workflows.
- `Entitlement`: owner, lifecycle state, authorization boundary, sync state, retention policy, deletion/export behavior, and audit metadata for Pocket FM-inspired serialized audio listening workflows.
- `AdOrSponsorshipSlot`: owner, lifecycle state, authorization boundary, sync state, retention policy, deletion/export behavior, and audit metadata for Pocket FM-inspired serialized audio listening workflows.
- `NotificationPreference`: owner, lifecycle state, authorization boundary, sync state, retention policy, deletion/export behavior, and audit metadata for Pocket FM-inspired serialized audio listening workflows.
- `RightsOrSafetyReport`: owner, lifecycle state, authorization boundary, sync state, retention policy, deletion/export behavior, and audit metadata for Pocket FM-inspired serialized audio listening workflows.
- `SupportCase`: owner, lifecycle state, authorization boundary, sync state, retention policy, deletion/export behavior, and audit metadata for Pocket FM-inspired serialized audio listening workflows.
- `AuditEvent`: owner, lifecycle state, authorization boundary, sync state, retention policy, deletion/export behavior, and audit metadata for Pocket FM-inspired serialized audio listening workflows.
- `LocalCacheRecord`: owner, lifecycle state, authorization boundary, sync state, retention policy, deletion/export behavior, and audit metadata for Pocket FM-inspired serialized audio listening workflows.
