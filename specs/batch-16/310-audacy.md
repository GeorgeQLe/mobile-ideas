# Audacy-Style Clone Spec

> Metadata
> - Inspiration app: Audacy
...
Build an original mobile radio and podcast streaming product inspired by Audacy's public product and policy materials. V1 focuses on live radio, sports talk, podcasts, station discovery, favorites, background playback, advertising, location-aware content, and account/privacy controls. The clone must use original branding, original UI copy, original sample media, licensed providers/assets, and explicit disclosures when a feature is inferred from public materials rather than verified hands-on behavior.
...
- Support live radio, sports talk, podcasts, station discovery, favorites, background playback, advertising, location-aware content, and account/privacy controls with clear retry, recovery, unavailable, region, and rights-aware states.
...
- Do not imply affiliation with Audacy or its publisher.
...
|---|---|---|---|
| Official product | https://www.audacy.com/ | Public Audacy live radio, podcasts, sports, news, station, and app surfaces | Verified 2026-05-04 |
| Support center | https://support.audacy.com/hc/en-us | Public support taxonomy for app playback, accounts, stations, downloads, and troubleshooting | Verified 2026-05-04 |
| Background playback help | https://support.audacy.com/hc/en-us/articles/13833590461083-What-if-the-Audacy-App-Won-t-Play-in-the-Background-on-my-Android | Public Android background playback constraints and settings guidance | Verified 2026-05-04 |
| Privacy policy | https://audacyinc.com/privacy-policy/ | Location, app, advertising, identifiers, analytics, account, and user-rights handling | Verified 2026-05-04 |
| Terms of use | https://audacyinc.com/terms-and-conditions/ | Service usage, content, accounts, advertising, and legal boundaries | Verified 2026-05-04 |
...
- Onboarding must support signed-out preview, account creation or restore, blocked-account state, unavailable-region state, and entitlement-unavailable state for radio and podcast streaming workflows.
- Home must expose the latest meaningful radio and podcast streaming state, search/discovery, saved items, settings, and degraded offline/account variants.
...
|---|---|---|---|---|
| Welcome / Consent | Defines the welcome / consent workflow for Audacy-inspired radio and podcast streaming behavior | taps, forms, search, deep links, media controls, permissions | empty, loading, loaded, signed-out, offline | permission denied, stale state, entitlement blocked, rights unavailable |
| Home / Listen | Defines the home / listen workflow for Audacy-inspired radio and podcast streaming behavior | taps, forms, search, deep links, media controls, permissions | empty, loading, loaded, signed-out, offline | permission denied, stale state, entitlement blocked, rights unavailable |
| Station / Source Picker | Defines the station / source picker workflow for Audacy-inspired radio and podcast streaming behavior | taps, forms, search, deep links, media controls, permissions | empty, loading, loaded, signed-out, offline | permission denied, stale state, entitlement blocked, rights unavailable |
| Live Player | Defines the live player workflow for Audacy-inspired radio and podcast streaming behavior | taps, forms, search, deep links, media controls, permissions | empty, loading, loaded, signed-out, offline | permission denied, stale state, entitlement blocked, rights unavailable |
| Podcast / Show Detail | Defines the podcast / show detail workflow for Audacy-inspired radio and podcast streaming behavior | taps, forms, search, deep links, media controls, permissions | empty, loading, loaded, signed-out, offline | permission denied, stale state, entitlement blocked, rights unavailable |
| Episode Detail | Defines the episode detail workflow for Audacy-inspired radio and podcast streaming behavior | taps, forms, search, deep links, media controls, permissions | empty, loading, loaded, signed-out, offline | permission denied, stale state, entitlement blocked, rights unavailable |
| Queue / Continue Listening | Defines the queue / continue listening workflow for Audacy-inspired radio and podcast streaming behavior | taps, forms, search, deep links, media controls, permissions | empty, loading, loaded, signed-out, offline | permission denied, stale state, entitlement blocked, rights unavailable |
| Library / Followed Shows | Defines the library / followed shows workflow for Audacy-inspired radio and podcast streaming behavior | taps, forms, search, deep links, media controls, permissions | empty, loading, loaded, signed-out, offline | permission denied, stale state, entitlement blocked, rights unavailable |
| Downloads | Defines the downloads workflow for Audacy-inspired radio and podcast streaming behavior | taps, forms, search, deep links, media controls, permissions | empty, loading, loaded, signed-out, offline | permission denied, stale state, entitlement blocked, rights unavailable |
| Local / Region Gate | Defines the local / region gate workflow for Audacy-inspired radio and podcast streaming behavior | taps, forms, search, deep links, media controls, permissions | empty, loading, loaded, signed-out, offline | permission denied, stale state, entitlement blocked, rights unavailable |
| Donation / Membership Prompt | Defines the donation / membership prompt workflow for Audacy-inspired radio and podcast streaming behavior | taps, forms, search, deep links, media controls, permissions | empty, loading, loaded, signed-out, offline | permission denied, stale state, entitlement blocked, rights unavailable |
| Notifications | Defines the notifications workflow for Audacy-inspired radio and podcast streaming behavior | taps, forms, search, deep links, media controls, permissions | empty, loading, loaded, signed-out, offline | permission denied, stale state, entitlement blocked, rights unavailable |
| Settings / Privacy | Defines the settings / privacy workflow for Audacy-inspired radio and podcast streaming behavior | taps, forms, search, deep links, media controls, permissions | empty, loading, loaded, signed-out, offline | permission denied, stale state, entitlement blocked, rights unavailable |
| Support | Defines the support workflow for Audacy-inspired radio and podcast streaming behavior | taps, forms, search, deep links, media controls, permissions | empty, loading, loaded, signed-out, offline | permission denied, stale state, entitlement blocked, rights unavailable |

## Data Model

- `User`: owner, lifecycle state, authorization boundary, sync state, retention policy, deletion/export behavior, and audit metadata for Audacy-inspired radio and podcast streaming workflows.
- `AccountSession`: owner, lifecycle state, authorization boundary, sync state, retention policy, deletion/export behavior, and audit metadata for Audacy-inspired radio and podcast streaming workflows.
- `Profile`: owner, lifecycle state, authorization boundary, sync state, retention policy, deletion/export behavior, and audit metadata for Audacy-inspired radio and podcast streaming workflows.
- `CatalogOrFeedItem`: owner, lifecycle state, authorization boundary, sync state, retention policy, deletion/export behavior, and audit metadata for Audacy-inspired radio and podcast streaming workflows.
- `CreatorOrPublisher`: owner, lifecycle state, authorization boundary, sync state, retention policy, deletion/export behavior, and audit metadata for Audacy-inspired radio and podcast streaming workflows.
- `EpisodeOrTitle`: owner, lifecycle state, authorization boundary, sync state, retention policy, deletion/export behavior, and audit metadata for Audacy-inspired radio and podcast streaming workflows.
- `PlaybackSession`: owner, lifecycle state, authorization boundary, sync state, retention policy, deletion/export behavior, and audit metadata for Audacy-inspired radio and podcast streaming workflows.
- `QueueOrWatchlist`: owner, lifecycle state, authorization boundary, sync state, retention policy, deletion/export behavior, and audit metadata for Audacy-inspired radio and podcast streaming workflows.
- `Download`: owner, lifecycle state, authorization boundary, sync state, retention policy, deletion/export behavior, and audit metadata for Audacy-inspired radio and podcast streaming workflows.
- `ImportOrUpload`: owner, lifecycle state, authorization boundary, sync state, retention policy, deletion/export behavior, and audit metadata for Audacy-inspired radio and podcast streaming workflows.
- `ProviderJob`: owner, lifecycle state, authorization boundary, sync state, retention policy, deletion/export behavior, and audit metadata for Audacy-inspired radio and podcast streaming workflows.
- `Entitlement`: owner, lifecycle state, authorization boundary, sync state, retention policy, deletion/export behavior, and audit metadata for Audacy-inspired radio and podcast streaming workflows.
- `AdOrSponsorshipSlot`: owner, lifecycle state, authorization boundary, sync state, retention policy, deletion/export behavior, and audit metadata for Audacy-inspired radio and podcast streaming workflows.
- `NotificationPreference`: owner, lifecycle state, authorization boundary, sync state, retention policy, deletion/export behavior, and audit metadata for Audacy-inspired radio and podcast streaming workflows.
- `RightsOrSafetyReport`: owner, lifecycle state, authorization boundary, sync state, retention policy, deletion/export behavior, and audit metadata for Audacy-inspired radio and podcast streaming workflows.
- `SupportCase`: owner, lifecycle state, authorization boundary, sync state, retention policy, deletion/export behavior, and audit metadata for Audacy-inspired radio and podcast streaming workflows.
- `AuditEvent`: owner, lifecycle state, authorization boundary, sync state, retention policy, deletion/export behavior, and audit metadata for Audacy-inspired radio and podcast streaming workflows.
- `LocalCacheRecord`: owner, lifecycle state, authorization boundary, sync state, retention policy, deletion/export behavior, and audit metadata for Audacy-inspired radio and podcast streaming workflows.
