# Player FM-Style Clone Spec

> Metadata
> - Inspiration app: Player FM
...
Build an original mobile podcast playback product inspired by Player FM's public product and policy materials. V1 focuses on podcast discovery, topic onboarding, subscriptions, playlists, bookmarks, downloads/offline, cross-device sync, CarPlay/watch surfaces, and Premium gates. The clone must use original branding, original UI copy, original sample media, licensed providers/assets, and explicit disclosures when a feature is inferred from public materials rather than verified hands-on behavior.
...
- Support podcast discovery, topic onboarding, subscriptions, playlists, bookmarks, downloads/offline, cross-device sync, CarPlay/watch surfaces, and Premium gates with clear retry, recovery, unavailable, region, and rights-aware states.
...
- Do not imply affiliation with Player FM or its publisher.
...
|---|---|---|---|
| Official product | https://player.fm/ | Public Player FM web app, premium feature positioning, discovery, sync, playlists, downloads, and account surfaces | Verified 2026-05-04 |
| Help center | https://support.player.fm/hc/en-us | Public support taxonomy for app usage, accounts, subscriptions, downloads, and troubleshooting | Verified 2026-05-04 |
| FAQ | https://docs.player.fm/full/faq/ | Public app behavior, official install sources, region availability, downloads, sync, and feature constraints | Verified 2026-05-04 |
| Privacy policy | https://player.fm/privacy | Account, usage, device, podcast, advertising, retention, and privacy-rights handling | Verified 2026-05-04 |
| Terms of service | https://player.fm/terms | Service usage, account, subscription, content, and legal boundaries | Verified 2026-05-04 |
...
- Onboarding must support signed-out preview, account creation or restore, blocked-account state, unavailable-region state, and entitlement-unavailable state for podcast playback workflows.
- Home must expose the latest meaningful podcast playback state, search/discovery, saved items, settings, and degraded offline/account variants.
...
|---|---|---|---|---|
| Welcome / Import | Defines the welcome / import workflow for Player FM-inspired podcast playback behavior | taps, forms, search, deep links, media controls, permissions | empty, loading, loaded, signed-out, offline | permission denied, stale state, entitlement blocked, rights unavailable |
| Home / Inbox | Defines the home / inbox workflow for Player FM-inspired podcast playback behavior | taps, forms, search, deep links, media controls, permissions | empty, loading, loaded, signed-out, offline | permission denied, stale state, entitlement blocked, rights unavailable |
| Discover / Search | Defines the discover / search workflow for Player FM-inspired podcast playback behavior | taps, forms, search, deep links, media controls, permissions | empty, loading, loaded, signed-out, offline | permission denied, stale state, entitlement blocked, rights unavailable |
| Podcast Detail | Defines the podcast detail workflow for Player FM-inspired podcast playback behavior | taps, forms, search, deep links, media controls, permissions | empty, loading, loaded, signed-out, offline | permission denied, stale state, entitlement blocked, rights unavailable |
| Episode Detail | Defines the episode detail workflow for Player FM-inspired podcast playback behavior | taps, forms, search, deep links, media controls, permissions | empty, loading, loaded, signed-out, offline | permission denied, stale state, entitlement blocked, rights unavailable |
| Queue / Playlist | Defines the queue / playlist workflow for Player FM-inspired podcast playback behavior | taps, forms, search, deep links, media controls, permissions | empty, loading, loaded, signed-out, offline | permission denied, stale state, entitlement blocked, rights unavailable |
| Now Playing | Defines the now playing workflow for Player FM-inspired podcast playback behavior | taps, forms, search, deep links, media controls, permissions | empty, loading, loaded, signed-out, offline | permission denied, stale state, entitlement blocked, rights unavailable |
| Downloads | Defines the downloads workflow for Player FM-inspired podcast playback behavior | taps, forms, search, deep links, media controls, permissions | empty, loading, loaded, signed-out, offline | permission denied, stale state, entitlement blocked, rights unavailable |
| Filters / Automation | Defines the filters / automation workflow for Player FM-inspired podcast playback behavior | taps, forms, search, deep links, media controls, permissions | empty, loading, loaded, signed-out, offline | permission denied, stale state, entitlement blocked, rights unavailable |
| Subscription / Premium | Defines the subscription / premium workflow for Player FM-inspired podcast playback behavior | taps, forms, search, deep links, media controls, permissions | empty, loading, loaded, signed-out, offline | permission denied, stale state, entitlement blocked, rights unavailable |
| Notifications | Defines the notifications workflow for Player FM-inspired podcast playback behavior | taps, forms, search, deep links, media controls, permissions | empty, loading, loaded, signed-out, offline | permission denied, stale state, entitlement blocked, rights unavailable |
| Settings / Privacy | Defines the settings / privacy workflow for Player FM-inspired podcast playback behavior | taps, forms, search, deep links, media controls, permissions | empty, loading, loaded, signed-out, offline | permission denied, stale state, entitlement blocked, rights unavailable |
| Support | Defines the support workflow for Player FM-inspired podcast playback behavior | taps, forms, search, deep links, media controls, permissions | empty, loading, loaded, signed-out, offline | permission denied, stale state, entitlement blocked, rights unavailable |
| Data Export / Delete | Defines the data export / delete workflow for Player FM-inspired podcast playback behavior | taps, forms, search, deep links, media controls, permissions | empty, loading, loaded, signed-out, offline | permission denied, stale state, entitlement blocked, rights unavailable |

## Data Model

- `User`: owner, lifecycle state, authorization boundary, sync state, retention policy, deletion/export behavior, and audit metadata for Player FM-inspired podcast playback workflows.
- `AccountSession`: owner, lifecycle state, authorization boundary, sync state, retention policy, deletion/export behavior, and audit metadata for Player FM-inspired podcast playback workflows.
- `Profile`: owner, lifecycle state, authorization boundary, sync state, retention policy, deletion/export behavior, and audit metadata for Player FM-inspired podcast playback workflows.
- `CatalogOrFeedItem`: owner, lifecycle state, authorization boundary, sync state, retention policy, deletion/export behavior, and audit metadata for Player FM-inspired podcast playback workflows.
- `CreatorOrPublisher`: owner, lifecycle state, authorization boundary, sync state, retention policy, deletion/export behavior, and audit metadata for Player FM-inspired podcast playback workflows.
- `EpisodeOrTitle`: owner, lifecycle state, authorization boundary, sync state, retention policy, deletion/export behavior, and audit metadata for Player FM-inspired podcast playback workflows.
- `PlaybackSession`: owner, lifecycle state, authorization boundary, sync state, retention policy, deletion/export behavior, and audit metadata for Player FM-inspired podcast playback workflows.
- `QueueOrWatchlist`: owner, lifecycle state, authorization boundary, sync state, retention policy, deletion/export behavior, and audit metadata for Player FM-inspired podcast playback workflows.
- `Download`: owner, lifecycle state, authorization boundary, sync state, retention policy, deletion/export behavior, and audit metadata for Player FM-inspired podcast playback workflows.
- `ImportOrUpload`: owner, lifecycle state, authorization boundary, sync state, retention policy, deletion/export behavior, and audit metadata for Player FM-inspired podcast playback workflows.
- `ProviderJob`: owner, lifecycle state, authorization boundary, sync state, retention policy, deletion/export behavior, and audit metadata for Player FM-inspired podcast playback workflows.
- `Entitlement`: owner, lifecycle state, authorization boundary, sync state, retention policy, deletion/export behavior, and audit metadata for Player FM-inspired podcast playback workflows.
- `AdOrSponsorshipSlot`: owner, lifecycle state, authorization boundary, sync state, retention policy, deletion/export behavior, and audit metadata for Player FM-inspired podcast playback workflows.
- `NotificationPreference`: owner, lifecycle state, authorization boundary, sync state, retention policy, deletion/export behavior, and audit metadata for Player FM-inspired podcast playback workflows.
- `RightsOrSafetyReport`: owner, lifecycle state, authorization boundary, sync state, retention policy, deletion/export behavior, and audit metadata for Player FM-inspired podcast playback workflows.
- `SupportCase`: owner, lifecycle state, authorization boundary, sync state, retention policy, deletion/export behavior, and audit metadata for Player FM-inspired podcast playback workflows.
- `AuditEvent`: owner, lifecycle state, authorization boundary, sync state, retention policy, deletion/export behavior, and audit metadata for Player FM-inspired podcast playback workflows.
- `LocalCacheRecord`: owner, lifecycle state, authorization boundary, sync state, retention policy, deletion/export behavior, and audit metadata for Player FM-inspired podcast playback workflows.
