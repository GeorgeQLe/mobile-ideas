# Castbox-Style Clone Spec

> Metadata
> - Inspiration app: Castbox
...
Build an original mobile podcast playback product inspired by Castbox's public product and policy materials. V1 focuses on podcast discovery, subscriptions, playlists, downloads/offline, comments/community, in-audio search, smart-device surfaces, ads, and subscription gates. The clone must use original branding, original UI copy, original sample media, licensed providers/assets, and explicit disclosures when a feature is inferred from public materials rather than verified hands-on behavior.
...
- Support podcast discovery, subscriptions, playlists, downloads/offline, comments/community, in-audio search, smart-device surfaces, ads, and subscription gates with clear retry, recovery, unavailable, region, and rights-aware states.
...
- Do not imply affiliation with Castbox or its publisher.
...
|---|---|---|---|
| Official product | https://castbox.fm/ | Public Castbox catalog, player, podcast discovery, app, and creator/listener surfaces | Verified 2026-05-04 |
| Help center | https://helpcenter.castbox.fm/ | Public support taxonomy for accounts, listening, subscriptions, uploads, and troubleshooting | Verified 2026-05-04 |
| Privacy policy | https://castbox.fm/policy.html | Guru Network/Castbox site and app data collection, advertising, analytics, app/device, and user-rights handling | Verified 2026-05-04 |
| Terms of service | https://castbox.fm/termsofservice.html | Service usage, user content, subscriptions, acceptable use, and legal boundaries | Verified 2026-05-04 |
| App Store listing | https://apps.apple.com/app/apple-store/id1243410543 | Canonical iOS listing, privacy label, ratings, compatibility, and native metadata to verify | Verified 2026-05-04 |
...
|---|---|---|---|---|
| Welcome / Import | Defines the welcome / import workflow for Castbox-inspired podcast playback behavior | taps, forms, search, deep links, media controls, permissions | empty, loading, loaded, signed-out, offline | permission denied, stale state, entitlement blocked, rights unavailable |
| Home / Inbox | Defines the home / inbox workflow for Castbox-inspired podcast playback behavior | taps, forms, search, deep links, media controls, permissions | empty, loading, loaded, signed-out, offline | permission denied, stale state, entitlement blocked, rights unavailable |
| Discover / Search | Defines the discover / search workflow for Castbox-inspired podcast playback behavior | taps, forms, search, deep links, media controls, permissions | empty, loading, loaded, signed-out, offline | permission denied, stale state, entitlement blocked, rights unavailable |
| Podcast Detail | Defines the podcast detail workflow for Castbox-inspired podcast playback behavior | taps, forms, search, deep links, media controls, permissions | empty, loading, loaded, signed-out, offline | permission denied, stale state, entitlement blocked, rights unavailable |
| Episode Detail | Defines the episode detail workflow for Castbox-inspired podcast playback behavior | taps, forms, search, deep links, media controls, permissions | empty, loading, loaded, signed-out, offline | permission denied, stale state, entitlement blocked, rights unavailable |
| Queue / Playlist | Defines the queue / playlist workflow for Castbox-inspired podcast playback behavior | taps, forms, search, deep links, media controls, permissions | empty, loading, loaded, signed-out, offline | permission denied, stale state, entitlement blocked, rights unavailable |
| Now Playing | Defines the now playing workflow for Castbox-inspired podcast playback behavior | taps, forms, search, deep links, media controls, permissions | empty, loading, loaded, signed-out, offline | permission denied, stale state, entitlement blocked, rights unavailable |
| Downloads | Defines the downloads workflow for Castbox-inspired podcast playback behavior | taps, forms, search, deep links, media controls, permissions | empty, loading, loaded, signed-out, offline | permission denied, stale state, entitlement blocked, rights unavailable |
| Filters / Automation | Defines the filters / automation workflow for Castbox-inspired podcast playback behavior | taps, forms, search, deep links, media controls, permissions | empty, loading, loaded, signed-out, offline | permission denied, stale state, entitlement blocked, rights unavailable |
| Subscription / Premium | Defines the subscription / premium workflow for Castbox-inspired podcast playback behavior | taps, forms, search, deep links, media controls, permissions | empty, loading, loaded, signed-out, offline | permission denied, stale state, entitlement blocked, rights unavailable |
| Notifications | Defines the notifications workflow for Castbox-inspired podcast playback behavior | taps, forms, search, deep links, media controls, permissions | empty, loading, loaded, signed-out, offline | permission denied, stale state, entitlement blocked, rights unavailable |
| Settings / Privacy | Defines the settings / privacy workflow for Castbox-inspired podcast playback behavior | taps, forms, search, deep links, media controls, permissions | empty, loading, loaded, signed-out, offline | permission denied, stale state, entitlement blocked, rights unavailable |
| Support | Defines the support workflow for Castbox-inspired podcast playback behavior | taps, forms, search, deep links, media controls, permissions | empty, loading, loaded, signed-out, offline | permission denied, stale state, entitlement blocked, rights unavailable |
| Data Export / Delete | Defines the data export / delete workflow for Castbox-inspired podcast playback behavior | taps, forms, search, deep links, media controls, permissions | empty, loading, loaded, signed-out, offline | permission denied, stale state, entitlement blocked, rights unavailable |

## Data Model

- `User`: owner, lifecycle state, authorization boundary, sync state, retention policy, deletion/export behavior, and audit metadata for Castbox-inspired podcast playback workflows.
- `AccountSession`: owner, lifecycle state, authorization boundary, sync state, retention policy, deletion/export behavior, and audit metadata for Castbox-inspired podcast playback workflows.
- `Profile`: owner, lifecycle state, authorization boundary, sync state, retention policy, deletion/export behavior, and audit metadata for Castbox-inspired podcast playback workflows.
- `CatalogOrFeedItem`: owner, lifecycle state, authorization boundary, sync state, retention policy, deletion/export behavior, and audit metadata for Castbox-inspired podcast playback workflows.
- `CreatorOrPublisher`: owner, lifecycle state, authorization boundary, sync state, retention policy, deletion/export behavior, and audit metadata for Castbox-inspired podcast playback workflows.
- `EpisodeOrTitle`: owner, lifecycle state, authorization boundary, sync state, retention policy, deletion/export behavior, and audit metadata for Castbox-inspired podcast playback workflows.
- `PlaybackSession`: owner, lifecycle state, authorization boundary, sync state, retention policy, deletion/export behavior, and audit metadata for Castbox-inspired podcast playback workflows.
- `QueueOrWatchlist`: owner, lifecycle state, authorization boundary, sync state, retention policy, deletion/export behavior, and audit metadata for Castbox-inspired podcast playback workflows.
- `Download`: owner, lifecycle state, authorization boundary, sync state, retention policy, deletion/export behavior, and audit metadata for Castbox-inspired podcast playback workflows.
- `ImportOrUpload`: owner, lifecycle state, authorization boundary, sync state, retention policy, deletion/export behavior, and audit metadata for Castbox-inspired podcast playback workflows.
- `ProviderJob`: owner, lifecycle state, authorization boundary, sync state, retention policy, deletion/export behavior, and audit metadata for Castbox-inspired podcast playback workflows.
- `Entitlement`: owner, lifecycle state, authorization boundary, sync state, retention policy, deletion/export behavior, and audit metadata for Castbox-inspired podcast playback workflows.
- `AdOrSponsorshipSlot`: owner, lifecycle state, authorization boundary, sync state, retention policy, deletion/export behavior, and audit metadata for Castbox-inspired podcast playback workflows.
- `NotificationPreference`: owner, lifecycle state, authorization boundary, sync state, retention policy, deletion/export behavior, and audit metadata for Castbox-inspired podcast playback workflows.
- `RightsOrSafetyReport`: owner, lifecycle state, authorization boundary, sync state, retention policy, deletion/export behavior, and audit metadata for Castbox-inspired podcast playback workflows.
- `SupportCase`: owner, lifecycle state, authorization boundary, sync state, retention policy, deletion/export behavior, and audit metadata for Castbox-inspired podcast playback workflows.
- `AuditEvent`: owner, lifecycle state, authorization boundary, sync state, retention policy, deletion/export behavior, and audit metadata for Castbox-inspired podcast playback workflows.
- `LocalCacheRecord`: owner, lifecycle state, authorization boundary, sync state, retention policy, deletion/export behavior, and audit metadata for Castbox-inspired podcast playback workflows.
