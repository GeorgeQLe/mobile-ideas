# BBC Sounds-Style Clone Spec

> Metadata
> - Inspiration app: BBC Sounds
...
Build an original mobile publisher audio product inspired by BBC Sounds's public product and policy materials. V1 focuses on BBC radio, podcasts, music mixes, live listening, signed-in personalization, downloads/offline, regional availability, and public-service content rights. The clone must use original branding, original UI copy, original sample media, licensed providers/assets, and explicit disclosures when a feature is inferred from public materials rather than verified hands-on behavior.
...
- Support BBC radio, podcasts, music mixes, live listening, signed-in personalization, downloads/offline, regional availability, and public-service content rights with clear retry, recovery, unavailable, region, and rights-aware states.
...
- Do not imply affiliation with BBC Sounds or its publisher.
...
|---|---|---|---|
| Official product | https://www.bbc.co.uk/sounds | Public BBC Sounds web product, live radio, podcasts, music, search, and account surfaces | Verified 2026-05-04 |
| Help center | https://www.bbc.co.uk/sounds/help | Public support taxonomy for BBC Sounds app, downloads, accounts, playback, and availability | Verified 2026-05-04 |
| BBC account help | https://www.bbc.co.uk/usingthebbc/account/ | Public signed-in account behavior, privacy settings, and data management routes | Verified 2026-05-04 |
| Privacy policy | https://www.bbc.co.uk/usingthebbc/privacy/ | BBC account, app, device, content usage, cookies, retention, and user-rights handling | Verified 2026-05-04 |
| Terms of use | https://www.bbc.co.uk/usingthebbc/terms/ | BBC online service usage, content rights, account, and legal boundaries | Verified 2026-05-04 |
...
- Onboarding must support signed-out preview, account creation or restore, blocked-account state, unavailable-region state, and entitlement-unavailable state for publisher audio workflows.
- Home must expose the latest meaningful publisher audio state, search/discovery, saved items, settings, and degraded offline/account variants.
...
|---|---|---|---|---|
| Welcome / Consent | Defines the welcome / consent workflow for BBC Sounds-inspired publisher audio behavior | taps, forms, search, deep links, media controls, permissions | empty, loading, loaded, signed-out, offline | permission denied, stale state, entitlement blocked, rights unavailable |
| Home / Listen | Defines the home / listen workflow for BBC Sounds-inspired publisher audio behavior | taps, forms, search, deep links, media controls, permissions | empty, loading, loaded, signed-out, offline | permission denied, stale state, entitlement blocked, rights unavailable |
| Station / Source Picker | Defines the station / source picker workflow for BBC Sounds-inspired publisher audio behavior | taps, forms, search, deep links, media controls, permissions | empty, loading, loaded, signed-out, offline | permission denied, stale state, entitlement blocked, rights unavailable |
| Live Player | Defines the live player workflow for BBC Sounds-inspired publisher audio behavior | taps, forms, search, deep links, media controls, permissions | empty, loading, loaded, signed-out, offline | permission denied, stale state, entitlement blocked, rights unavailable |
| Podcast / Show Detail | Defines the podcast / show detail workflow for BBC Sounds-inspired publisher audio behavior | taps, forms, search, deep links, media controls, permissions | empty, loading, loaded, signed-out, offline | permission denied, stale state, entitlement blocked, rights unavailable |
| Episode Detail | Defines the episode detail workflow for BBC Sounds-inspired publisher audio behavior | taps, forms, search, deep links, media controls, permissions | empty, loading, loaded, signed-out, offline | permission denied, stale state, entitlement blocked, rights unavailable |
| Queue / Continue Listening | Defines the queue / continue listening workflow for BBC Sounds-inspired publisher audio behavior | taps, forms, search, deep links, media controls, permissions | empty, loading, loaded, signed-out, offline | permission denied, stale state, entitlement blocked, rights unavailable |
| Library / Followed Shows | Defines the library / followed shows workflow for BBC Sounds-inspired publisher audio behavior | taps, forms, search, deep links, media controls, permissions | empty, loading, loaded, signed-out, offline | permission denied, stale state, entitlement blocked, rights unavailable |
| Downloads | Defines the downloads workflow for BBC Sounds-inspired publisher audio behavior | taps, forms, search, deep links, media controls, permissions | empty, loading, loaded, signed-out, offline | permission denied, stale state, entitlement blocked, rights unavailable |
| Local / Region Gate | Defines the local / region gate workflow for BBC Sounds-inspired publisher audio behavior | taps, forms, search, deep links, media controls, permissions | empty, loading, loaded, signed-out, offline | permission denied, stale state, entitlement blocked, rights unavailable |
| Donation / Membership Prompt | Defines the donation / membership prompt workflow for BBC Sounds-inspired publisher audio behavior | taps, forms, search, deep links, media controls, permissions | empty, loading, loaded, signed-out, offline | permission denied, stale state, entitlement blocked, rights unavailable |
| Notifications | Defines the notifications workflow for BBC Sounds-inspired publisher audio behavior | taps, forms, search, deep links, media controls, permissions | empty, loading, loaded, signed-out, offline | permission denied, stale state, entitlement blocked, rights unavailable |
| Settings / Privacy | Defines the settings / privacy workflow for BBC Sounds-inspired publisher audio behavior | taps, forms, search, deep links, media controls, permissions | empty, loading, loaded, signed-out, offline | permission denied, stale state, entitlement blocked, rights unavailable |
| Support | Defines the support workflow for BBC Sounds-inspired publisher audio behavior | taps, forms, search, deep links, media controls, permissions | empty, loading, loaded, signed-out, offline | permission denied, stale state, entitlement blocked, rights unavailable |

## Data Model

- `User`: owner, lifecycle state, authorization boundary, sync state, retention policy, deletion/export behavior, and audit metadata for BBC Sounds-inspired publisher audio workflows.
- `AccountSession`: owner, lifecycle state, authorization boundary, sync state, retention policy, deletion/export behavior, and audit metadata for BBC Sounds-inspired publisher audio workflows.
- `Profile`: owner, lifecycle state, authorization boundary, sync state, retention policy, deletion/export behavior, and audit metadata for BBC Sounds-inspired publisher audio workflows.
- `CatalogOrFeedItem`: owner, lifecycle state, authorization boundary, sync state, retention policy, deletion/export behavior, and audit metadata for BBC Sounds-inspired publisher audio workflows.
- `CreatorOrPublisher`: owner, lifecycle state, authorization boundary, sync state, retention policy, deletion/export behavior, and audit metadata for BBC Sounds-inspired publisher audio workflows.
- `EpisodeOrTitle`: owner, lifecycle state, authorization boundary, sync state, retention policy, deletion/export behavior, and audit metadata for BBC Sounds-inspired publisher audio workflows.
- `PlaybackSession`: owner, lifecycle state, authorization boundary, sync state, retention policy, deletion/export behavior, and audit metadata for BBC Sounds-inspired publisher audio workflows.
- `QueueOrWatchlist`: owner, lifecycle state, authorization boundary, sync state, retention policy, deletion/export behavior, and audit metadata for BBC Sounds-inspired publisher audio workflows.
- `Download`: owner, lifecycle state, authorization boundary, sync state, retention policy, deletion/export behavior, and audit metadata for BBC Sounds-inspired publisher audio workflows.
- `ImportOrUpload`: owner, lifecycle state, authorization boundary, sync state, retention policy, deletion/export behavior, and audit metadata for BBC Sounds-inspired publisher audio workflows.
- `ProviderJob`: owner, lifecycle state, authorization boundary, sync state, retention policy, deletion/export behavior, and audit metadata for BBC Sounds-inspired publisher audio workflows.
- `Entitlement`: owner, lifecycle state, authorization boundary, sync state, retention policy, deletion/export behavior, and audit metadata for BBC Sounds-inspired publisher audio workflows.
- `AdOrSponsorshipSlot`: owner, lifecycle state, authorization boundary, sync state, retention policy, deletion/export behavior, and audit metadata for BBC Sounds-inspired publisher audio workflows.
- `NotificationPreference`: owner, lifecycle state, authorization boundary, sync state, retention policy, deletion/export behavior, and audit metadata for BBC Sounds-inspired publisher audio workflows.
- `RightsOrSafetyReport`: owner, lifecycle state, authorization boundary, sync state, retention policy, deletion/export behavior, and audit metadata for BBC Sounds-inspired publisher audio workflows.
- `SupportCase`: owner, lifecycle state, authorization boundary, sync state, retention policy, deletion/export behavior, and audit metadata for BBC Sounds-inspired publisher audio workflows.
- `AuditEvent`: owner, lifecycle state, authorization boundary, sync state, retention policy, deletion/export behavior, and audit metadata for BBC Sounds-inspired publisher audio workflows.
- `LocalCacheRecord`: owner, lifecycle state, authorization boundary, sync state, retention policy, deletion/export behavior, and audit metadata for BBC Sounds-inspired publisher audio workflows.
