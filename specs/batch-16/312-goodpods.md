# Goodpods-Style Clone Spec

> Metadata
> - Inspiration app: Goodpods
...
Build an original mobile social podcast discovery product inspired by Goodpods's public product and policy materials. V1 focuses on social podcast discovery, follows, lists, reviews, courses, queues, recommendations, app profiles, and public/private sharing controls. The clone must use original branding, original UI copy, original sample media, licensed providers/assets, and explicit disclosures when a feature is inferred from public materials rather than verified hands-on behavior.
...
- Support social podcast discovery, follows, lists, reviews, courses, queues, recommendations, app profiles, and public/private sharing controls with clear retry, recovery, unavailable, region, and rights-aware states.
...
- Do not imply affiliation with Goodpods or its publisher.
...
|---|---|---|---|
| Official product | https://www.goodpods.com/ | Public Goodpods podcast discovery, social recommendations, follows, lists, courses, and app surfaces | Verified 2026-05-04 |
| App Store listing | https://apps.apple.com/us/app/goodpods-podcast-player-app/id1483407582 | Canonical iOS listing, app behavior, privacy label, age rating, and native metadata | Verified 2026-05-04 |
| Privacy policy | https://goodpods.com/privacy | Current Goodpods privacy policy for subscriptions, queues, episode data, account, logs, retention, and deletion | Verified 2026-05-04 |
| Terms of use | https://goodpods.com/terms | Application terms, age gates, account, user content, and legal boundaries | Verified 2026-05-04 |
| Company privacy archive | https://www.about.goodpods.com/goodpods-privacy-policy | Public older privacy/legal context for the Goodpods app and site | Verified 2026-05-04 |
...
- Onboarding must support signed-out preview, account creation or restore, blocked-account state, unavailable-region state, and entitlement-unavailable state for social podcast discovery workflows.
- Home must expose the latest meaningful social podcast discovery state, search/discovery, saved items, settings, and degraded offline/account variants.
...
|---|---|---|---|---|
| Welcome / Auth | Defines the welcome / auth workflow for Goodpods-inspired social podcast discovery behavior | taps, forms, search, deep links, media controls, permissions | empty, loading, loaded, signed-out, offline | permission denied, stale state, entitlement blocked, rights unavailable |
| Home / Discover | Defines the home / discover workflow for Goodpods-inspired social podcast discovery behavior | taps, forms, search, deep links, media controls, permissions | empty, loading, loaded, signed-out, offline | permission denied, stale state, entitlement blocked, rights unavailable |
| Search | Defines the search workflow for Goodpods-inspired social podcast discovery behavior | taps, forms, search, deep links, media controls, permissions | empty, loading, loaded, signed-out, offline | permission denied, stale state, entitlement blocked, rights unavailable |
| Podcast Detail | Defines the podcast detail workflow for Goodpods-inspired social podcast discovery behavior | taps, forms, search, deep links, media controls, permissions | empty, loading, loaded, signed-out, offline | permission denied, stale state, entitlement blocked, rights unavailable |
| Episode Detail | Defines the episode detail workflow for Goodpods-inspired social podcast discovery behavior | taps, forms, search, deep links, media controls, permissions | empty, loading, loaded, signed-out, offline | permission denied, stale state, entitlement blocked, rights unavailable |
| Profile | Defines the profile workflow for Goodpods-inspired social podcast discovery behavior | taps, forms, search, deep links, media controls, permissions | empty, loading, loaded, signed-out, offline | permission denied, stale state, entitlement blocked, rights unavailable |
| Lists / Collections | Defines the lists / collections workflow for Goodpods-inspired social podcast discovery behavior | taps, forms, search, deep links, media controls, permissions | empty, loading, loaded, signed-out, offline | permission denied, stale state, entitlement blocked, rights unavailable |
| Reviews / Ratings | Defines the reviews / ratings workflow for Goodpods-inspired social podcast discovery behavior | taps, forms, search, deep links, media controls, permissions | empty, loading, loaded, signed-out, offline | permission denied, stale state, entitlement blocked, rights unavailable |
| Activity Feed | Defines the activity feed workflow for Goodpods-inspired social podcast discovery behavior | taps, forms, search, deep links, media controls, permissions | empty, loading, loaded, signed-out, offline | permission denied, stale state, entitlement blocked, rights unavailable |
| Player Handoff | Defines the player handoff workflow for Goodpods-inspired social podcast discovery behavior | taps, forms, search, deep links, media controls, permissions | empty, loading, loaded, signed-out, offline | permission denied, stale state, entitlement blocked, rights unavailable |
| Notifications | Defines the notifications workflow for Goodpods-inspired social podcast discovery behavior | taps, forms, search, deep links, media controls, permissions | empty, loading, loaded, signed-out, offline | permission denied, stale state, entitlement blocked, rights unavailable |
| Settings / Privacy | Defines the settings / privacy workflow for Goodpods-inspired social podcast discovery behavior | taps, forms, search, deep links, media controls, permissions | empty, loading, loaded, signed-out, offline | permission denied, stale state, entitlement blocked, rights unavailable |
| Support | Defines the support workflow for Goodpods-inspired social podcast discovery behavior | taps, forms, search, deep links, media controls, permissions | empty, loading, loaded, signed-out, offline | permission denied, stale state, entitlement blocked, rights unavailable |
| Reports | Defines the reports workflow for Goodpods-inspired social podcast discovery behavior | taps, forms, search, deep links, media controls, permissions | empty, loading, loaded, signed-out, offline | permission denied, stale state, entitlement blocked, rights unavailable |

## Data Model

- `User`: owner, lifecycle state, authorization boundary, sync state, retention policy, deletion/export behavior, and audit metadata for Goodpods-inspired social podcast discovery workflows.
- `AccountSession`: owner, lifecycle state, authorization boundary, sync state, retention policy, deletion/export behavior, and audit metadata for Goodpods-inspired social podcast discovery workflows.
- `Profile`: owner, lifecycle state, authorization boundary, sync state, retention policy, deletion/export behavior, and audit metadata for Goodpods-inspired social podcast discovery workflows.
- `CatalogOrFeedItem`: owner, lifecycle state, authorization boundary, sync state, retention policy, deletion/export behavior, and audit metadata for Goodpods-inspired social podcast discovery workflows.
- `CreatorOrPublisher`: owner, lifecycle state, authorization boundary, sync state, retention policy, deletion/export behavior, and audit metadata for Goodpods-inspired social podcast discovery workflows.
- `EpisodeOrTitle`: owner, lifecycle state, authorization boundary, sync state, retention policy, deletion/export behavior, and audit metadata for Goodpods-inspired social podcast discovery workflows.
- `PlaybackSession`: owner, lifecycle state, authorization boundary, sync state, retention policy, deletion/export behavior, and audit metadata for Goodpods-inspired social podcast discovery workflows.
- `QueueOrWatchlist`: owner, lifecycle state, authorization boundary, sync state, retention policy, deletion/export behavior, and audit metadata for Goodpods-inspired social podcast discovery workflows.
- `Download`: owner, lifecycle state, authorization boundary, sync state, retention policy, deletion/export behavior, and audit metadata for Goodpods-inspired social podcast discovery workflows.
- `ImportOrUpload`: owner, lifecycle state, authorization boundary, sync state, retention policy, deletion/export behavior, and audit metadata for Goodpods-inspired social podcast discovery workflows.
- `ProviderJob`: owner, lifecycle state, authorization boundary, sync state, retention policy, deletion/export behavior, and audit metadata for Goodpods-inspired social podcast discovery workflows.
- `Entitlement`: owner, lifecycle state, authorization boundary, sync state, retention policy, deletion/export behavior, and audit metadata for Goodpods-inspired social podcast discovery workflows.
- `AdOrSponsorshipSlot`: owner, lifecycle state, authorization boundary, sync state, retention policy, deletion/export behavior, and audit metadata for Goodpods-inspired social podcast discovery workflows.
- `NotificationPreference`: owner, lifecycle state, authorization boundary, sync state, retention policy, deletion/export behavior, and audit metadata for Goodpods-inspired social podcast discovery workflows.
- `RightsOrSafetyReport`: owner, lifecycle state, authorization boundary, sync state, retention policy, deletion/export behavior, and audit metadata for Goodpods-inspired social podcast discovery workflows.
- `SupportCase`: owner, lifecycle state, authorization boundary, sync state, retention policy, deletion/export behavior, and audit metadata for Goodpods-inspired social podcast discovery workflows.
- `AuditEvent`: owner, lifecycle state, authorization boundary, sync state, retention policy, deletion/export behavior, and audit metadata for Goodpods-inspired social podcast discovery workflows.
- `LocalCacheRecord`: owner, lifecycle state, authorization boundary, sync state, retention policy, deletion/export behavior, and audit metadata for Goodpods-inspired social podcast discovery workflows.
