# iVoox-Style Clone Spec

> Metadata
> - Inspiration app: iVoox
...
Build an original mobile podcast creator platform product inspired by iVoox's public product and policy materials. V1 focuses on Spanish-language podcasts, radio, audiobooks, subscriptions, episode uploads, creator channels, fan payments, downloads/offline, and community discovery. The clone must use original branding, original UI copy, original sample media, licensed providers/assets, and explicit disclosures when a feature is inferred from public materials rather than verified hands-on behavior.
...
- Support Spanish-language podcasts, radio, audiobooks, subscriptions, episode uploads, creator channels, fan payments, downloads/offline, and community discovery with clear retry, recovery, unavailable, region, and rights-aware states.
...
- Do not imply affiliation with iVoox or its publisher.
...
|---|---|---|---|
| Official product | https://www.ivoox.com/ | Public iVoox podcast/radio/audiobook catalog, channel, listening, and creator surfaces | Verified 2026-05-04 |
| Help center | https://ivoox.zendesk.com/hc/ | Public support taxonomy for listening, uploads, subscriptions, accounts, and troubleshooting | Verified 2026-05-04 |
| Legal information | https://www.ivoox.com/informacion-legal_il.html | Public privacy, cookies, legal notice, intellectual property, and terms entry point | Verified 2026-05-04 |
| Premium/subscription | https://www.ivoox.com/premium/ | Public paid subscription, ad-free/download/offline, and premium-listening positioning | Verified 2026-05-04 |
...
|---|---|---|---|---|
| Welcome / Creator Auth | Defines the welcome / creator auth workflow for iVoox-inspired podcast creator platform behavior | taps, forms, search, deep links, media controls, permissions | empty, loading, loaded, signed-out, offline | permission denied, stale state, entitlement blocked, rights unavailable |
| Creator Dashboard | Defines the creator dashboard workflow for iVoox-inspired podcast creator platform behavior | taps, forms, search, deep links, media controls, permissions | empty, loading, loaded, signed-out, offline | permission denied, stale state, entitlement blocked, rights unavailable |
| Podcast Setup | Defines the podcast setup workflow for iVoox-inspired podcast creator platform behavior | taps, forms, search, deep links, media controls, permissions | empty, loading, loaded, signed-out, offline | permission denied, stale state, entitlement blocked, rights unavailable |
| Episode Editor | Defines the episode editor workflow for iVoox-inspired podcast creator platform behavior | taps, forms, search, deep links, media controls, permissions | empty, loading, loaded, signed-out, offline | permission denied, stale state, entitlement blocked, rights unavailable |
| Upload / Import | Defines the upload / import workflow for iVoox-inspired podcast creator platform behavior | taps, forms, search, deep links, media controls, permissions | empty, loading, loaded, signed-out, offline | permission denied, stale state, entitlement blocked, rights unavailable |
| RSS Distribution | Defines the rss distribution workflow for iVoox-inspired podcast creator platform behavior | taps, forms, search, deep links, media controls, permissions | empty, loading, loaded, signed-out, offline | permission denied, stale state, entitlement blocked, rights unavailable |
| Analytics | Defines the analytics workflow for iVoox-inspired podcast creator platform behavior | taps, forms, search, deep links, media controls, permissions | empty, loading, loaded, signed-out, offline | permission denied, stale state, entitlement blocked, rights unavailable |
| Monetization | Defines the monetization workflow for iVoox-inspired podcast creator platform behavior | taps, forms, search, deep links, media controls, permissions | empty, loading, loaded, signed-out, offline | permission denied, stale state, entitlement blocked, rights unavailable |
| Listener Discovery | Defines the listener discovery workflow for iVoox-inspired podcast creator platform behavior | taps, forms, search, deep links, media controls, permissions | empty, loading, loaded, signed-out, offline | permission denied, stale state, entitlement blocked, rights unavailable |
| Comments / Reviews | Defines the comments / reviews workflow for iVoox-inspired podcast creator platform behavior | taps, forms, search, deep links, media controls, permissions | empty, loading, loaded, signed-out, offline | permission denied, stale state, entitlement blocked, rights unavailable |
| Subscription / Payouts | Defines the subscription / payouts workflow for iVoox-inspired podcast creator platform behavior | taps, forms, search, deep links, media controls, permissions | empty, loading, loaded, signed-out, offline | permission denied, stale state, entitlement blocked, rights unavailable |
| Settings / Privacy | Defines the settings / privacy workflow for iVoox-inspired podcast creator platform behavior | taps, forms, search, deep links, media controls, permissions | empty, loading, loaded, signed-out, offline | permission denied, stale state, entitlement blocked, rights unavailable |
| Support | Defines the support workflow for iVoox-inspired podcast creator platform behavior | taps, forms, search, deep links, media controls, permissions | empty, loading, loaded, signed-out, offline | permission denied, stale state, entitlement blocked, rights unavailable |
| Rights / Reports | Defines the rights / reports workflow for iVoox-inspired podcast creator platform behavior | taps, forms, search, deep links, media controls, permissions | empty, loading, loaded, signed-out, offline | permission denied, stale state, entitlement blocked, rights unavailable |

## Data Model

- `User`: owner, lifecycle state, authorization boundary, sync state, retention policy, deletion/export behavior, and audit metadata for iVoox-inspired podcast creator platform workflows.
- `AccountSession`: owner, lifecycle state, authorization boundary, sync state, retention policy, deletion/export behavior, and audit metadata for iVoox-inspired podcast creator platform workflows.
- `Profile`: owner, lifecycle state, authorization boundary, sync state, retention policy, deletion/export behavior, and audit metadata for iVoox-inspired podcast creator platform workflows.
- `CatalogOrFeedItem`: owner, lifecycle state, authorization boundary, sync state, retention policy, deletion/export behavior, and audit metadata for iVoox-inspired podcast creator platform workflows.
- `CreatorOrPublisher`: owner, lifecycle state, authorization boundary, sync state, retention policy, deletion/export behavior, and audit metadata for iVoox-inspired podcast creator platform workflows.
- `EpisodeOrTitle`: owner, lifecycle state, authorization boundary, sync state, retention policy, deletion/export behavior, and audit metadata for iVoox-inspired podcast creator platform workflows.
- `PlaybackSession`: owner, lifecycle state, authorization boundary, sync state, retention policy, deletion/export behavior, and audit metadata for iVoox-inspired podcast creator platform workflows.
- `QueueOrWatchlist`: owner, lifecycle state, authorization boundary, sync state, retention policy, deletion/export behavior, and audit metadata for iVoox-inspired podcast creator platform workflows.
- `Download`: owner, lifecycle state, authorization boundary, sync state, retention policy, deletion/export behavior, and audit metadata for iVoox-inspired podcast creator platform workflows.
- `ImportOrUpload`: owner, lifecycle state, authorization boundary, sync state, retention policy, deletion/export behavior, and audit metadata for iVoox-inspired podcast creator platform workflows.
- `ProviderJob`: owner, lifecycle state, authorization boundary, sync state, retention policy, deletion/export behavior, and audit metadata for iVoox-inspired podcast creator platform workflows.
- `Entitlement`: owner, lifecycle state, authorization boundary, sync state, retention policy, deletion/export behavior, and audit metadata for iVoox-inspired podcast creator platform workflows.
- `AdOrSponsorshipSlot`: owner, lifecycle state, authorization boundary, sync state, retention policy, deletion/export behavior, and audit metadata for iVoox-inspired podcast creator platform workflows.
- `NotificationPreference`: owner, lifecycle state, authorization boundary, sync state, retention policy, deletion/export behavior, and audit metadata for iVoox-inspired podcast creator platform workflows.
- `RightsOrSafetyReport`: owner, lifecycle state, authorization boundary, sync state, retention policy, deletion/export behavior, and audit metadata for iVoox-inspired podcast creator platform workflows.
- `SupportCase`: owner, lifecycle state, authorization boundary, sync state, retention policy, deletion/export behavior, and audit metadata for iVoox-inspired podcast creator platform workflows.
- `AuditEvent`: owner, lifecycle state, authorization boundary, sync state, retention policy, deletion/export behavior, and audit metadata for iVoox-inspired podcast creator platform workflows.
- `LocalCacheRecord`: owner, lifecycle state, authorization boundary, sync state, retention policy, deletion/export behavior, and audit metadata for iVoox-inspired podcast creator platform workflows.
