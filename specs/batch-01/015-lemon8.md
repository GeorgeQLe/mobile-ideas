# Lemon8-Style Clone Spec

> Metadata
> - Inspiration app: Lemon8
...
Build an original mobile product inspired by Lemon8's public workflow: lifestyle community discovery, For You recommendations, topic/category feeds, photo/video editor, templates/stickers/fonts, hashtags, campaigns/challenges, comments, creator profiles, TikTok linkage blockers, and ByteDance-family privacy/safety controls.

The clone must not copy Lemon8 branding, screenshots, marketing copy, protected UI artwork, ranking systems, private APIs, proprietary data, marketplace assets, moderation tooling, or paid-plan names. The implementation can reproduce comparable user jobs and interaction patterns with original product language and licensed or first-party providers.
...
- Do not build a Lemon8-branded app or imply affiliation with Lemon8 or its owner.
...
|---|---|---|---|
| Apple App Store | https://apps.apple.com/us/app/lemon8-lifestyle-community/id1498607143 | Official iOS listing, category, age rating, supported devices, privacy labels, in-app purchases, version notes, and support/privacy links | Verified 2026-04-17 |
| Google Play | https://play.google.com/store/apps/details?id=com.bd.nproject | Official Android listing, package id, content rating, downloads, data safety, in-app purchases/ads, support contact, and public feature claims | Verified 2026-04-17 |
| Lemon8 Product Site | https://www.lemon8-app.com/ | Public product and community positioning | Verified 2026-04-17 |
| Lemon8 Privacy Policy | https://www.lemon8-app.com/privacy | Public privacy policy reference for account, content, recommendation, and data controls | Verified 2026-04-17 |
| Lemon8 Terms | https://www.lemon8-app.com/terms | Public service terms and account/content obligations | Verified 2026-04-17 |
| Lemon8 Contact Email From App Store | https://apps.apple.com/us/app/lemon8-lifestyle-community/id1498607143 | Official App Store contact and listing metadata | Verified 2026-04-17 |
| TikTok Privacy Policy | https://www.tiktok.com/legal/page/us/privacy-policy/en | Related ByteDance-family privacy reference where Lemon8 links or ownership require review | Verified 2026-04-17 |
| TikTok Community Guidelines | https://www.tiktok.com/community-guidelines/en | Related ByteDance-family safety reference where Lemon8 moderation policy requires review | Verified 2026-04-17 |

## Detailed Design

### Source-Backed Product Requirements

- The public listings position Lemon8 as a TikTok-powered lifestyle community for beauty, fashion, travel, food, photo/video posts, templates, stickers, filters, fonts, hashtags, campaigns, search, creator discovery, comments, and personalized For You recommendations.
- Home and category feeds must support For You personalization, following, topics, search, hashtags, campaigns/challenges, ads where present, hidden content, unavailable posts, and deterministic test ranking.
- Creation must support photo/video import, templates, stickers, filters, fonts, text composition, hashtag suggestions, draft recovery, publish, delete, report, and creator attribution.
- Campaign/challenge systems must support rules, eligibility, leaderboard or ranking state where present, moderation review, fraud prevention, appeal, and support escalation.
- Creator profiles must support posts, saved/bookmarked content, comments, follows, blocks, report, profile edit, and safety visibility states.
- TikTok account linking, data sharing, recommendation transfer, and ByteDance-family policy inheritance must remain explicit blockers until first-party documentation and hands-on verification confirm current behavior.
- Privacy settings must cover personalization, ads, contacts, push, data access, deletion, account closure, report/block, and minors/age controls.
- Manual verification remains required for exact native navigation, editor tools, campaigns, TikTok linkage, account deletion, push payloads, data export, and region availability.
...
| For You Feed | For You Feed workflow and recovery states | taps, text, media, permissions, deep links | empty, loading, loaded, signed-out, restricted | denied permission, offline, stale data, blocked entitlement, unavailable content |
| Category Feed | Category Feed workflow and recovery states | taps, text, media, permissions, deep links | empty, loading, loaded, signed-out, restricted | denied permission, offline, stale data, blocked entitlement, unavailable content |
...
| Create/Edit | Create/Edit workflow and recovery states | taps, text, media, permissions, deep links | empty, loading, loaded, signed-out, restricted | denied permission, offline, stale data, blocked entitlement, unavailable content |
| Templates | Templates workflow and recovery states | taps, text, media, permissions, deep links | empty, loading, loaded, signed-out, restricted | denied permission, offline, stale data, blocked entitlement, unavailable content |
| Campaigns | Campaigns workflow and recovery states | taps, text, media, permissions, deep links | empty, loading, loaded, signed-out, restricted | denied permission, offline, stale data, blocked entitlement, unavailable content |
...
- - `Profile`: Lemon8-specific lifecycle, ownership, authorization, sync, visibility, moderation, and deletion/export metadata.
- - `Post`: Lemon8-specific lifecycle, ownership, authorization, sync, visibility, moderation, and deletion/export metadata.
- - `MediaAsset`: Lemon8-specific lifecycle, ownership, authorization, sync, visibility, moderation, and deletion/export metadata.
- - `Template`: Lemon8-specific lifecycle, ownership, authorization, sync, visibility, moderation, and deletion/export metadata.
- - `Sticker`: Lemon8-specific lifecycle, ownership, authorization, sync, visibility, moderation, and deletion/export metadata.
- - `Topic`: Lemon8-specific lifecycle, ownership, authorization, sync, visibility, moderation, and deletion/export metadata.
- - `Hashtag`: Lemon8-specific lifecycle, ownership, authorization, sync, visibility, moderation, and deletion/export metadata.
- - `Campaign`: Lemon8-specific lifecycle, ownership, authorization, sync, visibility, moderation, and deletion/export metadata.
- - `Comment`: Lemon8-specific lifecycle, ownership, authorization, sync, visibility, moderation, and deletion/export metadata.
- - `Reaction`: Lemon8-specific lifecycle, ownership, authorization, sync, visibility, moderation, and deletion/export metadata.
- - `RecommendationSignal`: Lemon8-specific lifecycle, ownership, authorization, sync, visibility, moderation, and deletion/export metadata.
...
- Treat creator harassment as a launch-blocking review area with owner, mitigation, test coverage, and manual-verification status.
- Treat campaign fraud as a launch-blocking review area with owner, mitigation, test coverage, and manual-verification status.
...
- Treat recommendation opacity as a launch-blocking review area with owner, mitigation, test coverage, and manual-verification status.
- Treat ByteDance-family data linkage as a launch-blocking review area with owner, mitigation, test coverage, and manual-verification status.
- Treat regional availability as a launch-blocking review area with owner, mitigation, test coverage, and manual-verification status.
...
- A downstream team can build the V1 without proprietary Lemon8 assets, private APIs, network traffic, brand copy, ranking systems, or moderation tooling.
