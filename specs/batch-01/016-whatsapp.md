...
## Overview
Build an original mobile product inspired by WhatsApp's user-facing workflow, not its brand identity or proprietary implementation.
The clone target is: Phone-number onboarding, encrypted-style chat UX, groups, communities, voice notes, calls, media sharing, and backup settings.
...
- Implement the app-specific focus: Phone-number onboarding, encrypted-style chat UX, groups, communities, voice notes, calls, media sharing, and backup settings.
...
## Non-Goals
- Do not copy WhatsApp branding, trade dress, logos, app icons, screenshots, marketing copy, or proprietary media.
...
## Research Sources
- App Store source-discovery link: https://apps.apple.com/us/search?term=WhatsApp
- Google Play source-discovery link: https://play.google.com/store/search?q=WhatsApp&c=apps
- Official help/privacy source-discovery link: https://www.google.com/search?q=WhatsApp%20official%20app%20help%20privacy
