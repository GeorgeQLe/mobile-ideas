...
## Overview
Build an original mobile product inspired by Character.AI's user-facing workflow, not its brand identity or proprietary implementation.
The clone target is: Character directory, persona chat, voice calls, roleplay safety controls, creator tools, and conversation memory.
...
## Goals
- Deliver a mobile-first ai companion experience with complete onboarding, core action, settings, and recovery flows.
- Implement the app-specific focus: Character directory, persona chat, voice calls, roleplay safety controls, creator tools, and conversation memory.
...
## Non-Goals
- Do not copy Character.AI branding, trade dress, logos, app icons, screenshots, marketing copy, or proprietary media.
...
## Research Sources
- App Store source-discovery link: https://apps.apple.com/us/search?term=Character.AI
- Google Play source-discovery link: https://play.google.com/store/search?q=Character.AI&c=apps
- Official help/privacy source-discovery link: https://www.google.com/search?q=Character.AI%20official%20app%20help%20privacy
...
## Detailed Design
- Onboarding: support guest, signup, returning-user, permission-primer, and blocked-region or blocked-account states as appropriate for ai companion.
