...
## Overview
Build an original mobile product inspired by Bluesky's user-facing workflow, not its brand identity or proprietary implementation.
The clone target is: Federated-feeling microblog client with custom feeds, starter packs, moderation labels, and portable identity concepts.
...
- Implement the app-specific focus: Federated-feeling microblog client with custom feeds, starter packs, moderation labels, and portable identity concepts.
...
## Non-Goals
- Do not copy Bluesky branding, trade dress, logos, app icons, screenshots, marketing copy, or proprietary media.
...
## Research Sources
- App Store source-discovery link: https://apps.apple.com/us/search?term=Bluesky
- Google Play source-discovery link: https://play.google.com/store/search?q=Bluesky&c=apps
- Official help/privacy source-discovery link: https://www.google.com/search?q=Bluesky%20official%20app%20help%20privacy
