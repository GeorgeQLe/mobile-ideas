# Bluesky-Style Clone Spec

> Metadata
> - Inspiration app: Bluesky
...
Build an original mobile product inspired by Bluesky's public workflow: decentralized microblogging, AT Protocol-style identity, following/discover/custom feeds, starter packs, moderation lists, labels, DMs, verification, bookmarks, contact-based friend finding, and portability controls.

The clone must not copy Bluesky branding, screenshots, marketing copy, protected UI artwork, ranking systems, private APIs, proprietary data, marketplace assets, moderation tooling, or paid-plan names. The implementation can reproduce comparable user jobs and interaction patterns with original product language and licensed or first-party providers.
...
- Do not build a Bluesky-branded app or imply affiliation with Bluesky or its owner.
...
|---|---|---|---|
| Apple App Store | https://apps.apple.com/us/app/bluesky-social/id6444370199 | Official iOS listing, category, age rating, supported devices, privacy labels, in-app purchases, version notes, and support/privacy links | Verified 2026-04-17 |
| Google Play | https://play.google.com/store/apps/details?id=xyz.blueskyweb.app | Official Android listing, package id, content rating, downloads, data safety, in-app purchases/ads, support contact, and public feature claims | Verified 2026-04-17 |
| Bluesky Support | https://bsky.social/about/support | Public support entry point for account, moderation, privacy, and product documentation | Verified 2026-04-17 |
| Bluesky Terms | https://bsky.social/about/support/tos | Service terms and AT Protocol relationship | Verified 2026-04-17 |
| Bluesky Privacy Policy | https://bsky.social/about/support/privacy-policy | Personal data, public-by-design activity, age verification, privacy rights, and retention | Verified 2026-04-17 |
| Bluesky Community Guidelines | https://bsky.social/about/support/community-guidelines | Safety, harassment, authenticity, legal, and enforcement rules | Verified 2026-04-17 |
| Find Friends Privacy Policy | https://www.bsky.social/about/support/find-friends-privacy-policy | Contact matching and privacy for Find Friends | Verified 2026-04-17 |
| AT Protocol | https://atproto.com/ | Public protocol orientation for identity, repositories, lexicons, and portability concepts | Verified 2026-04-17 |

## Detailed Design

### Source-Backed Product Requirements

- The public listings position Bluesky as a social app for public conversation, following/discover feeds, custom feeds, starter packs, moderation controls, content filters, contact-based friend finding, DMs, bookmarks, verification, and AT Protocol portability.
- Identity must separate handle, DID-like stable identity, profile, service host, session, recovery, and migration state so portability can be tested without copying Bluesky infrastructure.
- Feeds must support following, discover, pinned custom feeds, feed generators, list exclusions, search/explore, show-more/show-less signals, and stale/degraded feed states.
- Posting must support text, images/video where included, embeds, replies, reposts, quote-style posts, labels, alt text, language, delete, report, and detached quote controls where included.
- Moderation must support mutes, blocks, moderation lists, labels, content filters, report categories, hidden replies, appeal states, and third-party labeler/provider boundaries.
- Find Friends/contact matching must be opt-in, reversible, mutual or privacy-preserving, and isolated from normal address-book upload assumptions.
- AT Protocol compatibility is an architectural inspiration only; any real federation requires protocol/legal review and conformance tests before launch.
- Manual verification remains required for exact native navigation, current feed controls, DMs, verification, contact matching, age assurance, push payloads, and account portability.
...
| Custom Feeds | Custom Feeds workflow and recovery states | taps, text, media, permissions, deep links | empty, loading, loaded, signed-out, restricted | denied permission, offline, stale data, blocked entitlement, unavailable content |
...
| Composer | Composer workflow and recovery states | taps, text, media, permissions, deep links | empty, loading, loaded, signed-out, restricted | denied permission, offline, stale data, blocked entitlement, unavailable content |
...
| Starter Packs | Starter Packs workflow and recovery states | taps, text, media, permissions, deep links | empty, loading, loaded, signed-out, restricted | denied permission, offline, stale data, blocked entitlement, unavailable content |
| DM Inbox | DM Inbox workflow and recovery states | taps, text, media, permissions, deep links | empty, loading, loaded, signed-out, restricted | denied permission, offline, stale data, blocked entitlement, unavailable content |
| Moderation Controls | Moderation Controls workflow and recovery states | taps, text, media, permissions, deep links | empty, loading, loaded, signed-out, restricted | denied permission, offline, stale data, blocked entitlement, unavailable content |
| Find Friends | Find Friends workflow and recovery states | taps, text, media, permissions, deep links | empty, loading, loaded, signed-out, restricted | denied permission, offline, stale data, blocked entitlement, unavailable content |
...
- - `PortableIdentity`: Bluesky-specific lifecycle, ownership, authorization, sync, visibility, moderation, and deletion/export metadata.
- - `Profile`: Bluesky-specific lifecycle, ownership, authorization, sync, visibility, moderation, and deletion/export metadata.
- - `Post`: Bluesky-specific lifecycle, ownership, authorization, sync, visibility, moderation, and deletion/export metadata.
- - `MediaAsset`: Bluesky-specific lifecycle, ownership, authorization, sync, visibility, moderation, and deletion/export metadata.
- - `Feed`: Bluesky-specific lifecycle, ownership, authorization, sync, visibility, moderation, and deletion/export metadata.
- - `FeedGenerator`: Bluesky-specific lifecycle, ownership, authorization, sync, visibility, moderation, and deletion/export metadata.
- - `ModerationLabel`: Bluesky-specific lifecycle, ownership, authorization, sync, visibility, moderation, and deletion/export metadata.
- - `List`: Bluesky-specific lifecycle, ownership, authorization, sync, visibility, moderation, and deletion/export metadata.
- - `DirectThread`: Bluesky-specific lifecycle, ownership, authorization, sync, visibility, moderation, and deletion/export metadata.
- - `ContactMatch`: Bluesky-specific lifecycle, ownership, authorization, sync, visibility, moderation, and deletion/export metadata.
...
- Treat public-by-design privacy as a launch-blocking review area with owner, mitigation, test coverage, and manual-verification status.
- Treat federation abuse as a launch-blocking review area with owner, mitigation, test coverage, and manual-verification status.
- Treat moderation labels as a launch-blocking review area with owner, mitigation, test coverage, and manual-verification status.
- Treat contact privacy as a launch-blocking review area with owner, mitigation, test coverage, and manual-verification status.
- Treat age assurance as a launch-blocking review area with owner, mitigation, test coverage, and manual-verification status.
- Treat third-party app boundaries as a launch-blocking review area with owner, mitigation, test coverage, and manual-verification status.
- Treat account portability as a launch-blocking review area with owner, mitigation, test coverage, and manual-verification status.
...
- A downstream team can build the V1 without proprietary Bluesky assets, private APIs, network traffic, brand copy, ranking systems, or moderation tooling.
