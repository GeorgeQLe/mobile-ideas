...
## Overview
Build an original mobile product inspired by BeReal's user-facing workflow, not its brand identity or proprietary implementation.
The clone target is: Daily simultaneous front/back camera prompt, time-limited posting, friend-only feed, reactions, and late-post indicators.
...
- Implement the app-specific focus: Daily simultaneous front/back camera prompt, time-limited posting, friend-only feed, reactions, and late-post indicators.
...
## Non-Goals
- Do not copy BeReal branding, trade dress, logos, app icons, screenshots, marketing copy, or proprietary media.
...
## Research Sources
- App Store source-discovery link: https://apps.apple.com/us/search?term=BeReal
- Google Play source-discovery link: https://play.google.com/store/search?q=BeReal&c=apps
- Official help/privacy source-discovery link: https://www.google.com/search?q=BeReal%20official%20app%20help%20privacy
