...
## Overview
Build an original mobile product inspired by Telegram's user-facing workflow, not its brand identity or proprietary implementation.
The clone target is: Cloud chat, channels, bots, large groups, pinned messages, reactions, folders, and media-rich message actions.
...
- Implement the app-specific focus: Cloud chat, channels, bots, large groups, pinned messages, reactions, folders, and media-rich message actions.
...
## Non-Goals
- Do not copy Telegram branding, trade dress, logos, app icons, screenshots, marketing copy, or proprietary media.
...
## Research Sources
- App Store source-discovery link: https://apps.apple.com/us/search?term=Telegram
- Google Play source-discovery link: https://play.google.com/store/search?q=Telegram&c=apps
- Official help/privacy source-discovery link: https://www.google.com/search?q=Telegram%20official%20app%20help%20privacy
