...
## Overview
Build an original mobile product inspired by Replika's user-facing workflow, not its brand identity or proprietary implementation.
The clone target is: Relationship-oriented AI avatar with mood tracking, diary-style memory, coaching prompts, and subscription gates.
...
- Implement the app-specific focus: Relationship-oriented AI avatar with mood tracking, diary-style memory, coaching prompts, and subscription gates.
...
## Non-Goals
- Do not copy Replika branding, trade dress, logos, app icons, screenshots, marketing copy, or proprietary media.
...
## Research Sources
- App Store source-discovery link: https://apps.apple.com/us/search?term=Replika
- Google Play source-discovery link: https://play.google.com/store/search?q=Replika&c=apps
- Official help/privacy source-discovery link: https://www.google.com/search?q=Replika%20official%20app%20help%20privacy
