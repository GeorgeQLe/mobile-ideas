# Instagram-Style Clone Spec

> Metadata
> - Inspiration app: Instagram
...
Build an original mobile product inspired by Instagram's public workflow: home feed, stories, reels, creator profiles, explore, DMs, comments, likes, saves, creator monetization, account privacy, teen controls, data controls, and reporting.

The clone must not copy Instagram branding, screenshots, marketing copy, protected UI artwork, ranking systems, private APIs, proprietary data, marketplace assets, moderation tooling, or paid-plan names. The implementation can reproduce comparable user jobs and interaction patterns with original product language and licensed or first-party providers.
...
- Do not build a Instagram-branded app or imply affiliation with Instagram or its owner.
...
|---|---|---|---|
| Apple App Store | https://apps.apple.com/us/app/instagram/id389801252 | Official iOS listing, category, age rating, supported devices, privacy labels, in-app purchases, version notes, and support/privacy links | Verified 2026-04-17 |
| Google Play | https://play.google.com/store/apps/details?id=com.instagram.android | Official Android listing, package id, content rating, downloads, data safety, in-app purchases/ads, support contact, and public feature claims | Verified 2026-04-17 |
| Instagram Help Center | https://help.instagram.com/ | Public support entry point for account, sharing, messaging, privacy, safety, and app behavior | Verified 2026-04-17 |
| Instagram Terms And Policies | https://help.instagram.com/581066165581870 | Terms, policies, privacy, community, and legal support path | Verified 2026-04-17 |
| Instagram Community Guidelines | https://help.instagram.com/477434105621119 | Community safety and content policy categories | Verified 2026-04-17 |
| Instagram Safety Center | https://about.instagram.com/safety | Safety controls, teen/family guidance, reporting, and wellbeing positioning | Verified 2026-04-17 |
| Meta Privacy Policy | https://privacycenter.instagram.com/policy | Personal data processing, privacy rights, and Meta account controls | Verified 2026-04-17 |
| Meta Accounts Center Help | https://www.facebook.com/help/accountscenter | Cross-account settings, data, identity, and connected account management | Verified 2026-04-17 |

## Detailed Design

### Source-Backed Product Requirements

- The public listings position Instagram around photo/video sharing, reels, stories, messaging, creator profiles, explore/discovery, shopping-adjacent surfaces, ads, badges, verified subscriptions, and age-managed content.
- Feed and reels ranking must use original algorithms and expose deterministic test modes for following, recommended, fresh, hidden, sensitive, and unavailable content.
- Creation must support camera/library import, editing, captions, mentions, tags, location, alt text, draft recovery, audience/privacy controls, and publish/delete states.
- Stories must support ephemeral media, viewer lists, replies, close-friends-style audiences, highlights, muting, and expiration without copying Instagram UI assets.
- DMs must support one-to-one and group threads, media sharing, message requests, block/report controls, notification preferences, and privacy-safe push payloads.
- Creator and monetization surfaces must be original and must separate creator tools, badges/subscriptions, branded content disclosure, insights, and payout blockers.
- Teen/minor controls, sensitive-content controls, report/block/restrict, account privacy, data download, account deletion, and community guideline enforcement are launch-blocking areas.
- Manual verification remains required for exact native navigation, current teen controls, app-store purchases, push payloads, private-account edge cases, creator tools, and cross-Meta account behavior.
...
| Reels | Reels workflow and recovery states | taps, text, media, permissions, deep links | empty, loading, loaded, signed-out, restricted | denied permission, offline, stale data, blocked entitlement, unavailable content |
| Stories Viewer | Stories Viewer workflow and recovery states | taps, text, media, permissions, deep links | empty, loading, loaded, signed-out, restricted | denied permission, offline, stale data, blocked entitlement, unavailable content |
...
| Explore | Explore workflow and recovery states | taps, text, media, permissions, deep links | empty, loading, loaded, signed-out, restricted | denied permission, offline, stale data, blocked entitlement, unavailable content |
...
| Settings And Privacy | Settings And Privacy workflow and recovery states | taps, text, media, permissions, deep links | empty, loading, loaded, signed-out, restricted | denied permission, offline, stale data, blocked entitlement, unavailable content |
| Reports And Support | Reports And Support workflow and recovery states | taps, text, media, permissions, deep links | empty, loading, loaded, signed-out, restricted | denied permission, offline, stale data, blocked entitlement, unavailable content |
| Monetization | Account, policy, support, and recovery controls | taps, text, media, permissions, deep links | empty, loading, loaded, signed-out, restricted | denied permission, offline, stale data, blocked entitlement, unavailable content |

## Data Model

- - `User`: identity, age gate, locale, region, account status, consent state, deletion/export state.
- - `Profile`: Instagram-specific lifecycle, ownership, authorization, sync, visibility, moderation, and deletion/export metadata.
- - `Post`: Instagram-specific lifecycle, ownership, authorization, sync, visibility, moderation, and deletion/export metadata.
- - `MediaAsset`: Instagram-specific lifecycle, ownership, authorization, sync, visibility, moderation, and deletion/export metadata.
- - `Story`: Instagram-specific lifecycle, ownership, authorization, sync, visibility, moderation, and deletion/export metadata.
- - `Reel`: Instagram-specific lifecycle, ownership, authorization, sync, visibility, moderation, and deletion/export metadata.
- - `Comment`: Instagram-specific lifecycle, ownership, authorization, sync, visibility, moderation, and deletion/export metadata.
- - `Reaction`: Instagram-specific lifecycle, ownership, authorization, sync, visibility, moderation, and deletion/export metadata.
- - `Follow`: Instagram-specific lifecycle, ownership, authorization, sync, visibility, moderation, and deletion/export metadata.
- - `DirectThread`: Instagram-specific lifecycle, ownership, authorization, sync, visibility, moderation, and deletion/export metadata.
- - `Notification`: Instagram-specific lifecycle, ownership, authorization, sync, visibility, moderation, and deletion/export metadata.
- - `ModerationCase`: Instagram-specific lifecycle, ownership, authorization, sync, visibility, moderation, and deletion/export metadata.
...
- Treat body image and wellbeing as a launch-blocking review area with owner, mitigation, test coverage, and manual-verification status.
...
- Treat ads and creator monetization as a launch-blocking review area with owner, mitigation, test coverage, and manual-verification status.
- Treat privacy leakage as a launch-blocking review area with owner, mitigation, test coverage, and manual-verification status.
- Treat recommendation abuse as a launch-blocking review area with owner, mitigation, test coverage, and manual-verification status.
...
- A downstream team can build the V1 without proprietary Instagram assets, private APIs, network traffic, brand copy, ranking systems, or moderation tooling.
