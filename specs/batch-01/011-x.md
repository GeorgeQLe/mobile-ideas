...
## Overview
Build an original mobile product inspired by X's user-facing workflow, not its brand identity or proprietary implementation.
The clone target is: Real-time text feed, replies, reposts, quote posts, trends, lists, spaces-like audio rooms, and creator subscriptions.
...
- Implement the app-specific focus: Real-time text feed, replies, reposts, quote posts, trends, lists, spaces-like audio rooms, and creator subscriptions.
...
## Non-Goals
- Do not copy X branding, trade dress, logos, app icons, screenshots, marketing copy, or proprietary media.
...
## Research Sources
- App Store source-discovery link: https://apps.apple.com/us/search?term=X
- Google Play source-discovery link: https://play.google.com/store/search?q=X&c=apps
- Official help/privacy source-discovery link: https://www.google.com/search?q=X%20official%20app%20help%20privacy
