...
## Overview
Build an original mobile product inspired by Signal's user-facing workflow, not its brand identity or proprietary implementation.
The clone target is: Privacy-centered messenger with registration lock, disappearing messages, safety numbers, voice/video calls, and sealed-sender-like UX.
...
## Goals
- Deliver a mobile-first messaging experience with complete onboarding, core action, settings, and recovery flows.
- Implement the app-specific focus: Privacy-centered messenger with registration lock, disappearing messages, safety numbers, voice/video calls, and sealed-sender-like UX.
...
## Non-Goals
- Do not copy Signal branding, trade dress, logos, app icons, screenshots, marketing copy, or proprietary media.
...
## Research Sources
- App Store source-discovery link: https://apps.apple.com/us/search?term=Signal
- Google Play source-discovery link: https://play.google.com/store/search?q=Signal&c=apps
- Official help/privacy source-discovery link: https://www.google.com/search?q=Signal%20official%20app%20help%20privacy
...
## Detailed Design
- Onboarding: support guest, signup, returning-user, permission-primer, and blocked-region or blocked-account states as appropriate for messaging.
