...
- [ ] Step 8.3: Promote IDs 101-1000 from Draft 1 to implementation-ready public-source V1 (absorbs Phase 7 Step 7.3; scope = 900 specs). Run in category-coherent batches. See archived Phase 7 Step 7.3 detail in `tasks/phases/phase-7.md` for the full operation: exact-URL replacement, verified-vs-inferred discipline, depth expansion, Manual verification blockers per app, and category risk review. Validation: every promoted spec's `Readiness status` line reads `Implementation-ready for a lawful public-source V1 clone as of YYYY-MM-DD.`; no residual `Source discovery -- pending exact URL verification` strings in promoted specs. Progress through 2026-05-04: IDs 101-460 promoted; post-slice audit reports 460 implementation-ready specs and 1,620 remaining placeholder rows across 540 files. Latest slice completed: IDs 441-460 (`Mr D Food` through `Mercari`) promoted as a delivery marketplace, electronics, home improvement, furniture, department store, beauty, athletic retail, fashion, resale, and marketplace category batch with product/catalog licensing, inventory/price freshness, store/merchant privacy, payment/refund/returns, membership/loyalty, resale authenticity/fraud, regional availability, safety, privacy, and provider risk blockers. Next concrete slice: promote IDs 461-480 (`Vinted` through `AroundMe`) as the next retail marketplace, ticketing/events, travel, hotel, airline, car rental, transit, parking, EV charging, maps, weather, and local services category batch from `tasks/ideas.md`, replacing source-discovery placeholders with exact first-party URLs and preserving ticket/event rights, travel supplier/regional availability, booking/payment/refund rules, identity/account safety, location privacy, map/weather data licensing, local-business content, accessibility, support, and provider risk blockers where applicable.
