...
- [ ] Replace App Store, Google Play, and official help/privacy source-discovery links in the remaining 94 specs with exact first-party URLs.
...
## Next Runnable Step: Upgrade `046-amazon.md`

### Scope

- Archive the current Draft 1 file at `specs/batch-03/046-amazon.md` under `docs/history/archive/2026-04-17/`.
- Rewrite `specs/batch-03/046-amazon.md` to implementation-ready public-source V1 status using the structure and evidence depth now present in `specs/batch-01/001-chatgpt.md`, `specs/batch-01/006-tiktok.md`, `specs/batch-01/016-whatsapp.md`, `specs/batch-02/026-google-maps.md`, `specs/batch-02/033-airbnb.md`, and `specs/batch-02/038-doordash.md`.
...
- Replace App Store, Google Play, and official help/privacy source-discovery links with exact first-party Amazon URLs.
- Prioritize public sources for product search, category browsing, product detail pages, variations, cart, checkout, delivery promises, order tracking, returns/refunds/replacements, customer service, reviews/ratings, wish lists, recommendations, Prime membership, Subscribe & Save, marketplace seller flows, gift cards, ads/sponsored listings, household/family controls, accessibility, privacy controls, data/account deletion, and platform terms.
...
- Treat payment security, marketplace fraud, counterfeit/unsafe goods, seller/customer trust, reviews abuse, returns/refunds, subscriptions, recommendations/ads, household controls, regulated items, privacy, accessibility claims, and regional availability as category risk areas.
- Do not claim exact native parity for checkout, payments, Prime, Subscribe & Save, returns/refunds, order tracking, seller tools, review moderation, recommendations, push payloads, account deletion, or support/dispute flows until verified.

### Validation

- Confirm the upgraded spec has exactly one H1 and all canonical sections.
- Confirm source-discovery links are gone from `046-amazon.md`.
- Confirm readiness counts and next-step references advance from DoorDash completion to Amazon completion and then Cash App.
