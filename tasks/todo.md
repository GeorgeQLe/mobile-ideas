...
- [ ] Step 8.3: Promote IDs 101-1000 from Draft 1 to implementation-ready public-source V1 (absorbs Phase 7 Step 7.3; scope = 900 specs). Run in category-coherent batches. See archived Phase 7 Step 7.3 detail in `tasks/phases/phase-7.md` for the full operation: exact-URL replacement, verified-vs-inferred discipline, depth expansion, Manual verification blockers per app, and category risk review. Validation: every promoted spec's `Readiness status` line reads `Implementation-ready for a lawful public-source V1 clone as of YYYY-MM-DD.`; no residual `Source discovery -- pending exact URL verification` strings in promoted specs. Progress through 2026-05-05: IDs 101-700 promoted; post-slice audit reports 700 implementation-ready specs and 900 remaining placeholder rows across 300 files. Latest slice completed: IDs 681-700 (`Google Fit` through `Schoology`) promoted as a health/medical, parenting/family-safety, and education category batch. The slice preserved health-data/device-sync, sleep/audio, pregnancy/family/minor privacy, parental controls/location safety, private family media, childcare/search/provider freshness, classroom/LMS/student-data privacy, school/institution ownership, accessibility, and region/provider/school availability blockers. Next concrete slice: promote IDs 701-720 (`Seesaw` through `Microsoft 365`) as an education plus productivity-documents category batch from `tasks/ideas.md`, replacing source-discovery placeholders with exact first-party URLs and preserving classroom/LMS/student-data privacy, assessment integrity, learner/minor gates, content/course subscriptions, document/workspace sharing, sync/offline conflict handling, import/export, permissions, accessibility, and school/provider/subscription availability blockers.
