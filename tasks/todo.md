...
- [ ] Replace App Store, Google Play, and official help/privacy source-discovery links in the remaining 96 specs with exact first-party URLs.
...
## Next Runnable Step: Upgrade `033-airbnb.md`

### Scope

- Archive the current Draft 1 file at `specs/batch-02/033-airbnb.md` under `docs/history/archive/2026-04-16/`.
- Rewrite `specs/batch-02/033-airbnb.md` to implementation-ready public-source V1 status using the structure and evidence depth now present in `specs/batch-01/001-chatgpt.md`, `specs/batch-01/006-tiktok.md`, `specs/batch-01/016-whatsapp.md`, and `specs/batch-02/026-google-maps.md`.
...
- Replace App Store, Google Play, and official help/privacy source-discovery links with exact first-party Airbnb URLs.
- Prioritize public sources for marketplace search, listings, wishlists, trip booking, checkout, cancellation/refunds, fees/taxes, host profiles, guest/host messaging, reviews, identity verification, payments/payouts, trust and safety, anti-discrimination, damage/dispute handling, accessibility, privacy controls, data/account deletion, hosting tools, and platform terms.
...
- Treat marketplace trust, housing discrimination, identity verification, fraud, payment disputes, host/guest safety, regulated lodging/taxes, accessibility claims, reviews, messaging abuse, cancellations/refunds, and regional availability as category risk areas.
- Do not claim exact native parity for booking checkout, payments, refunds, identity verification, host onboarding, messaging, push payloads, account deletion, or dispute flows until verified.

### Validation

- Confirm the upgraded spec has exactly one H1 and all canonical sections.
- Confirm source-discovery links are gone from `033-airbnb.md`.
- Confirm readiness counts and next-step references advance from Google Maps completion to Airbnb completion and then DoorDash.
