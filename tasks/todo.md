...
- [ ] Step 8.3: Promote IDs 101-1000 from Draft 1 to implementation-ready public-source V1 (absorbs Phase 7 Step 7.3; scope = 900 specs). Run in category-coherent batches. See archived Phase 7 Step 7.3 detail in `tasks/phases/phase-7.md` for the full operation: exact-URL replacement, verified-vs-inferred discipline, depth expansion, Manual verification blockers per app, and category risk review. Validation: every promoted spec's `Readiness status` line reads `Implementation-ready for a lawful public-source V1 clone as of YYYY-MM-DD.`; no residual `Source discovery -- pending exact URL verification` strings in promoted specs. Progress through 2026-05-04: IDs 101-500 promoted; post-slice audit reports 500 implementation-ready specs and 1,500 remaining placeholder rows across 500 files. Latest slice completed: IDs 481-500 (`TD Bank` through `Remitly`) promoted as a banking, credit union, fintech, brokerage, trading, digital banking, wallet, and remittance category batch with account/security, KYC/AML, financial licensing, money movement, market-data/provider licensing, payment/payout/remittance rules, sanctions/regional availability, fraud/scam controls, privacy, accessibility, support, and regulator-facing audit blockers. Next concrete slice: promote IDs 501-520 (`WorldRemit` through `Klarna`) as the next remittance, crypto exchange, self-custody wallet, hardware-wallet companion, fiat/crypto on-ramp, neobank/cash-advance, earned-wage access, and BNPL category batch from `tasks/ideas.md`, replacing source-discovery placeholders with exact first-party URLs and preserving KYC/AML, sanctions screening, travel-rule/provider licensing, private-key custody boundaries, money movement, repayment/credit disclosures, payment/payout/remittance rules, fraud/scam controls, regional availability, privacy, accessibility, support, and regulator-facing audit blockers where applicable.
