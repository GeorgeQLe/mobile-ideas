...
- [ ] Step 8.3: Promote IDs 101-1000 from Draft 1 to implementation-ready public-source V1 (absorbs Phase 7 Step 7.3; scope = 900 specs). Run in category-coherent batches. See archived Phase 7 Step 7.3 detail in `tasks/phases/phase-7.md` for the full operation: exact-URL replacement, verified-vs-inferred discipline, depth expansion, Manual verification blockers per app, and category risk review. Validation: every promoted spec's `Readiness status` line reads `Implementation-ready for a lawful public-source V1 clone as of YYYY-MM-DD.`; no residual `Source discovery -- pending exact URL verification` strings in promoted specs. Progress through 2026-05-04: IDs 101-480 promoted; post-slice audit reports 480 implementation-ready specs and 1,560 remaining placeholder rows across 520 files. Latest slice completed: IDs 461-480 (`Vinted` through `PNC Mobile`) promoted as a resale/classifieds, cross-border/regional marketplace, cash-back, electronics retail, and banking/card servicing category batch with listing/catalog licensing, seller/buyer trust, payment/payout, returns/disputes, ad-tech attribution, account security, KYC/AML, money movement, card fraud, rewards correctness, financial privacy, regional availability, safety, accessibility, support, and provider risk blockers. Next concrete slice: promote IDs 481-500 (`TD Bank` through `Remitly`) as the next banking, credit union, fintech, brokerage, trading, digital banking, wallet, and remittance category batch from `tasks/ideas.md`, replacing source-discovery placeholders with exact first-party URLs and preserving account/security, KYC/AML, financial licensing, money movement, market-data/provider licensing, payment/payout/remittance rules, sanctions/regional availability, fraud/scam controls, privacy, accessibility, support, and regulator-facing audit blockers where applicable.
