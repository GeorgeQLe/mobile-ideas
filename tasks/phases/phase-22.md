...
- [x] Lesson flow, progress tracking, and assessment features functional across variants or explicitly blocked.
- [x] Category-specific risk review for education, child-directed (COPPA), and academic integrity features is documented.
